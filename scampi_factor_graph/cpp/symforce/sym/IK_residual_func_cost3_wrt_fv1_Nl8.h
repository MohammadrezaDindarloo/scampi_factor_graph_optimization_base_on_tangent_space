...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl8(
  ...
  const Scalar _tmp94 = _tmp37 * (_tmp28 * _tmp93 - _tmp56 * _tmp92);
  const Scalar _tmp95 = _tmp40 * _tmp77 - _tmp67 * (_tmp40 * _tmp76 + _tmp73) - _tmp72;
  const Scalar _tmp96 = _tmp83 * (-_tmp38 + _tmp40 * _tmp52 - _tmp82 * _tmp95) + _tmp95;
  const Scalar _tmp97 = -_tmp40 - _tmp86 * _tmp96;
  const Scalar _tmp98 = _tmp63 * fh1;
  const Scalar _tmp99 = _tmp55 * _tmp64;
  const Scalar _tmp100 = _tmp51 * _tmp92;
  ...
  _res(0, 0) = 0;
  _res(1, 0) =
      -_tmp94 * std::exp(_tmp37 * _tmp64 * (_tmp28 * _tmp55 - _tmp41 * _tmp55 * _tmp56) +
                         _tmp37 * _tmp88 * (_tmp56 * _tmp87 + _tmp84 * _tmp85) +
                         _tmp37 * _tmp98 * (_tmp56 * _tmp97 + _tmp85 * _tmp96 + Scalar(1.0)) +
                         _tmp89 * _tmp94);
  _res(2, 0) = -_tmp100 * std::exp(_tmp100 * _tmp89 + _tmp41 * _tmp51 * _tmp99 -
                                   _tmp51 * _tmp87 * _tmp88 - _tmp51 * _tmp97 * _tmp98);
  _res(3, 0) = _tmp93 * std::exp(-_tmp81 * _tmp84 * _tmp88 - _tmp81 * _tmp96 * _tmp98 -
                                 _tmp89 * _tmp93 - _tmp99);
