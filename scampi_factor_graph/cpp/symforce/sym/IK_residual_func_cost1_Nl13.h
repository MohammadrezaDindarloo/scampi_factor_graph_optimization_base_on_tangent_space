...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl13(
  ...
  const Scalar _tmp20 = -2 * std::pow(_tmp3, Scalar(2));
  const Scalar _tmp21 = Scalar(0.20999999999999999) * _tmp15 + Scalar(0.20999999999999999) * _tmp20;
  const Scalar _tmp22 = Scalar(0.20999999999999999) * _tmp4 + Scalar(0.20999999999999999) * _tmp7;
  ...
  const Scalar _tmp32 = -Scalar(0.010999999999999999) * _tmp14 -
  ...
  const Scalar _tmp51 = _tmp21 + _tmp37;
  ...
  const Scalar _tmp60 = _tmp50 * _tmp58 + _tmp51 * _tmp58 - _tmp54 * _tmp59;
  const Scalar _tmp61 = _tmp40 * _tmp48;
  const Scalar _tmp62 = Scalar(1.0) / (_tmp58 * _tmp61 - _tmp59);
  const Scalar _tmp63 = _tmp61 * _tmp62;
  const Scalar _tmp64 = _tmp32 - _tmp33;
  const Scalar _tmp65 = _tmp31 + _tmp64;
  const Scalar _tmp66 = -_tmp31;
  const Scalar _tmp67 = _tmp64 + _tmp66;
  const Scalar _tmp68 = _tmp58 * _tmp67;
  const Scalar _tmp69 = _tmp59 * _tmp65 - _tmp61 * _tmp68;
  const Scalar _tmp70 = _tmp61 * _tmp67 + _tmp63 * _tmp69;
  ...
  const Scalar _tmp75 = _tmp73 * (-_tmp54 + _tmp74);
  const Scalar _tmp76 = -_tmp58 * _tmp65 + _tmp68;
  const Scalar _tmp77 = _tmp63 * _tmp76 - _tmp67 - _tmp70 * _tmp75;
  const Scalar _tmp78 = _tmp17 + _tmp41;
  const Scalar _tmp79 = _tmp78 + p_init0;
  const Scalar _tmp80 = _tmp79 + Scalar(-2.5202214700000001);
  const Scalar _tmp81 = _tmp27 + _tmp36;
  ...
  const Scalar _tmp87 = _tmp61 * _tmp86 - _tmp85;
  const Scalar _tmp88 = _tmp62 * _tmp87;
  const Scalar _tmp89 = _tmp34 + _tmp66;
  const Scalar _tmp90 = _tmp67 * _tmp86;
  const Scalar _tmp91 = -_tmp61 * _tmp90 - _tmp69 * _tmp88 + _tmp85 * _tmp89;
  const Scalar _tmp92 = -_tmp75 * _tmp91 - _tmp76 * _tmp88 - _tmp86 * _tmp89 + _tmp90;
  const Scalar _tmp93 = Scalar(1.0) / (_tmp92);
  const Scalar _tmp94 = _tmp50 * _tmp86 - _tmp60 * _tmp88 - _tmp78 * _tmp85 + _tmp81 * _tmp86;
  const Scalar _tmp95 = _tmp93 * _tmp94;
  const Scalar _tmp96 = Scalar(1.0) / (_tmp94);
  const Scalar _tmp97 = _tmp92 * _tmp96;
  const Scalar _tmp98 = _tmp97 * (-_tmp50 + _tmp60 * _tmp63 - _tmp77 * _tmp95);
  const Scalar _tmp99 = _tmp72 + _tmp81;
  const Scalar _tmp100 = _tmp75 * _tmp99;
  const Scalar _tmp101 = Scalar(1.0) / (-_tmp100 + _tmp74 - _tmp78);
  const Scalar _tmp102 = _tmp101 * _tmp99;
  const Scalar _tmp103 = _tmp77 + _tmp98;
  const Scalar _tmp104 = _tmp91 * _tmp93;
  const Scalar _tmp105 = _tmp102 * _tmp98 - _tmp103 * _tmp104 + _tmp70;
  const Scalar _tmp106 = Scalar(1.0) * _tmp73;
  const Scalar _tmp107 = Scalar(1.0) * _tmp101;
  const Scalar _tmp108 = _tmp19 + Scalar(-2.71799795);
  const Scalar _tmp109 = _tmp29 + Scalar(-4.7752063900000001);
  ...
  const Scalar _tmp114 = _tmp107 * _tmp97;
  const Scalar _tmp115 = -_tmp113 * _tmp91 + _tmp114 * _tmp99;
  const Scalar _tmp116 = _tmp109 * _tmp110;
  const Scalar _tmp117 = fh1 * (-_tmp111 * _tmp28 + _tmp116 * _tmp18);
  const Scalar _tmp118 = _tmp35 * fh1;
  const Scalar _tmp119 = _tmp111 * _tmp118 + Scalar(3.29616) * _tmp12 + _tmp18 * fv1;
  const Scalar _tmp120 = _tmp73 * _tmp99;
  const Scalar _tmp121 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp122 = _tmp71 * _tmp75 + _tmp74;
  const Scalar _tmp123 = 0;
  const Scalar _tmp124 = _tmp101 * _tmp122;
  const Scalar _tmp125 = -_tmp104 * _tmp123 - _tmp124 * _tmp99 + _tmp72;
  const Scalar _tmp126 = -_tmp116 * _tmp118 - Scalar(3.29616) * _tmp25 - _tmp28 * fv1;
  const Scalar _tmp127 = _tmp100 * _tmp107 + Scalar(1.0);
  const Scalar _tmp128 = _tmp107 * _tmp75;
  const Scalar _tmp129 = Scalar(1.0) * _tmp62;
  const Scalar _tmp130 = _tmp129 * _tmp69;
  const Scalar _tmp131 = -_tmp129 * _tmp76 + _tmp130 * _tmp75;
  const Scalar _tmp132 = _tmp97 * (-_tmp129 * _tmp60 - _tmp131 * _tmp95);
  const Scalar _tmp133 = _tmp131 + _tmp132;
  const Scalar _tmp134 = _tmp102 * _tmp132 - _tmp104 * _tmp133 - _tmp130;
  const Scalar _tmp135 = _tmp116 * fh1;
  const Scalar _tmp136 = _tmp87 * _tmp93;
  const Scalar _tmp137 = -_tmp133 * _tmp136 + Scalar(1.0);
  const Scalar _tmp138 = _tmp58 * _tmp62;
  const Scalar _tmp139 = _tmp86 * _tmp93;
  const Scalar _tmp140 = -_tmp103 * _tmp136 - _tmp61;
  const Scalar _tmp141 = _tmp123 * _tmp93;
  const Scalar _tmp142 = _tmp123 * _tmp136;
  const Scalar _tmp143 = _tmp129 * _tmp87 * _tmp96;
  const Scalar _tmp144 = -_tmp112 * _tmp49 * (_tmp103 * _tmp139 + _tmp138 * _tmp140 + Scalar(1.0)) -
                         _tmp117 * _tmp49 * (_tmp113 * _tmp86 - _tmp143 * _tmp58) -
                         _tmp121 * _tmp49 * (-_tmp138 * _tmp142 + _tmp141 * _tmp86) -
                         _tmp135 * _tmp49 * (_tmp133 * _tmp139 + _tmp137 * _tmp138);
  const Scalar _tmp145 = Scalar(1.0) / (_tmp144);
  const Scalar _tmp146 = std::asinh(
      _tmp145 * (Scalar(1.0) * _tmp112 * (-_tmp105 * _tmp106 + _tmp107 * _tmp98) +
                 Scalar(1.0) * _tmp117 * (-_tmp106 * _tmp115 + _tmp114) +
                 Scalar(1.0) * _tmp119 * (_tmp107 * _tmp120 - _tmp107) +
                 Scalar(1.0) * _tmp121 * (-_tmp106 * _tmp125 - _tmp107 * _tmp122 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp126 * (-_tmp106 * _tmp127 + _tmp128) +
                 Scalar(1.0) * _tmp135 * (-_tmp106 * _tmp134 + _tmp107 * _tmp132)));
  const Scalar _tmp147 = Scalar(9.6622558468725703) * _tmp144;
  const Scalar _tmp148 = _tmp112 * _tmp140 * _tmp62 - _tmp117 * _tmp143 -
                         _tmp121 * _tmp142 * _tmp62 + _tmp135 * _tmp137 * _tmp62;
  const Scalar _tmp149 = Scalar(1.0) / (_tmp148);
  const Scalar _tmp150 = _tmp107 * _tmp119;
  const Scalar _tmp151 =
      std::asinh(_tmp149 * (_tmp105 * _tmp112 * _tmp73 + _tmp115 * _tmp117 * _tmp73 -
                            _tmp120 * _tmp150 + _tmp121 * _tmp125 * _tmp73 +
                            _tmp126 * _tmp127 * _tmp73 + _tmp134 * _tmp135 * _tmp73));
  const Scalar _tmp152 = Scalar(9.6622558468725703) * _tmp148;
  const Scalar _tmp153 = _tmp103 * _tmp112 * _tmp93 + _tmp113 * _tmp117 + _tmp121 * _tmp141 +
                         _tmp133 * _tmp135 * _tmp93;
  const Scalar _tmp154 = Scalar(1.0) / (_tmp153);
  const Scalar _tmp155 =
      std::asinh(_tmp154 * (-_tmp101 * _tmp112 * _tmp98 - _tmp101 * _tmp132 * _tmp135 -
                            _tmp114 * _tmp117 + _tmp121 * _tmp124 - _tmp126 * _tmp128 + _tmp150));
  ...
  _res(1, 0) =
      -_tmp147 *
          (Scalar(0.87679799772039002) * _tmp145 + std::cosh(Scalar(1.0) * _tmp146) -
           std::cosh(
  ...
  _res(2, 0) =
      -_tmp152 *
          (Scalar(0.86625939559540499) * _tmp149 + std::cosh(Scalar(1.0) * _tmp151) -
           std::cosh(
               ...
               (-_tmp155 * _tmp156 -
                Scalar(8.3888750099999996) *
                    std::sqrt(Scalar(
                        ...
                        std::pow(Scalar(-Scalar(0.11920549523123722) * _tmp82 - 1),
                                 Scalar(2))))))) +
      _tmp89 + p_init2;
