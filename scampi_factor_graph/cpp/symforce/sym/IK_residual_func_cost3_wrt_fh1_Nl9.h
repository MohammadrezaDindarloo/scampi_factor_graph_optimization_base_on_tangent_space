...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl9(
  ...
  const Scalar _tmp35 = _tmp34 + p_init1 + Scalar(-4.7752063900000001);
  const Scalar _tmp36 = _tmp33 * _tmp35;
  const Scalar _tmp37 = Scalar(1.0) / (_tmp28 * _tmp36 - _tmp29);
  const Scalar _tmp38 =
  ...
  const Scalar _tmp42 = _tmp38 - _tmp39;
  const Scalar _tmp43 = _tmp40 + _tmp42;
  const Scalar _tmp44 = _tmp37 * (_tmp28 * _tmp41 - _tmp28 * _tmp43);
  const Scalar _tmp45 = _tmp36 * _tmp41;
  const Scalar _tmp46 = _tmp37 * (-_tmp28 * _tmp45 + _tmp29 * _tmp43);
  const Scalar _tmp47 = Scalar(1.0) * _tmp34;
  const Scalar _tmp48 = Scalar(1.0) * _tmp31;
  const Scalar _tmp49 = (-_tmp25 + _tmp48) / (_tmp16 - _tmp47);
  const Scalar _tmp50 = -Scalar(1.0) * _tmp44 + Scalar(1.0) * _tmp46 * _tmp49;
  ...
  const Scalar _tmp60 = _tmp36 * _tmp59 - _tmp58;
  const Scalar _tmp61 = -_tmp40 + _tmp42;
  const Scalar _tmp62 = _tmp41 * _tmp59 - _tmp44 * _tmp60 -
                        _tmp49 * (-_tmp45 * _tmp59 - _tmp46 * _tmp60 + _tmp58 * _tmp61) -
                        _tmp59 * _tmp61;
  ...
  const Scalar _tmp66 = _tmp33 * _tmp64;
  const Scalar _tmp67 = _tmp66 * (_tmp31 * _tmp35 * _tmp65 - _tmp32 * _tmp34 * _tmp65);
  const Scalar _tmp68 = _tmp37 * (_tmp16 * _tmp28 - _tmp25 * _tmp29 + _tmp28 * _tmp67);
  const Scalar _tmp69 = _tmp52 * _tmp59 - _tmp55 * _tmp58 + _tmp59 * _tmp67 - _tmp60 * _tmp68;
  const Scalar _tmp70 = _tmp63 * _tmp69;
  const Scalar _tmp71 = Scalar(1.0) / (_tmp69);
  const Scalar _tmp72 = _tmp62 * _tmp71;
  const Scalar _tmp73 = _tmp50 + _tmp72 * (-_tmp50 * _tmp70 - Scalar(1.0) * _tmp68);
  const Scalar _tmp74 = _tmp60 * _tmp63;
  const Scalar _tmp75 = _tmp37 * (-_tmp73 * _tmp74 + Scalar(1.0));
  const Scalar _tmp76 = _tmp63 * _tmp73;
  const Scalar _tmp77 = _tmp30 + _tmp54;
  const Scalar _tmp78 = _tmp77 + p_init0 + Scalar(-2.5202214700000001);
  const Scalar _tmp79 = _tmp51 + _tmp6;
  ...
  const Scalar _tmp83 = _tmp66 * _tmp82 * (_tmp28 * _tmp75 + _tmp59 * _tmp76);
  const Scalar _tmp84 = _tmp78 * _tmp81;
  const Scalar _tmp85 = _tmp77 * _tmp82 - _tmp79 * _tmp84;
  const Scalar _tmp86 = Scalar(1.0) * _tmp71;
  const Scalar _tmp87 = _tmp37 * _tmp60;
  const Scalar _tmp88 = _tmp66 * _tmp85 * (-_tmp28 * _tmp86 * _tmp87 + _tmp59 * _tmp86);
  const Scalar _tmp89 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp90 = _tmp47 * _tmp49 + _tmp48;
  const Scalar _tmp91 = 0;
  const Scalar _tmp92 = _tmp37 * _tmp74 * _tmp91;
  const Scalar _tmp93 = _tmp63 * _tmp91;
  const Scalar _tmp94 = _tmp36 * _tmp44 - _tmp41 - _tmp49 * (_tmp36 * _tmp46 + _tmp45);
  const Scalar _tmp95 = _tmp72 * (_tmp36 * _tmp68 - _tmp67 - _tmp70 * _tmp94) + _tmp94;
  const Scalar _tmp96 = _tmp63 * _tmp95;
  const Scalar _tmp97 = _tmp37 * (-_tmp36 - _tmp74 * _tmp95);
  const Scalar _tmp98 = _tmp66 * _tmp84 * (_tmp28 * _tmp97 + _tmp59 * _tmp96 + Scalar(1.0));
  const Scalar _tmp99 = _tmp75 * _tmp82;
  const Scalar _tmp100 = _tmp85 * _tmp86;
  const Scalar _tmp101 = _tmp100 * fh1;
  const Scalar _tmp102 = _tmp84 * _tmp97;
  const Scalar _tmp103 = _tmp76 * _tmp82;
  const Scalar _tmp104 = _tmp84 * _tmp96;

  // Output terms (1)
  Eigen::Matrix<Scalar, 4, 1> _res;

  _res(0, 0) = -std::exp(-fh1);
  _res(1, 0) = -(-_tmp83 - _tmp88 - _tmp98) *
               std::exp(_tmp66 * _tmp89 * (-_tmp28 * _tmp92 + _tmp59 * _tmp93) + _tmp83 * fh1 +
                        _tmp88 * fh1 + _tmp98 * fh1);
  _res(2, 0) = -(-_tmp100 * _tmp87 + _tmp102 + _tmp99) *
               std::exp(_tmp101 * _tmp87 - _tmp102 * fh1 + _tmp89 * _tmp92 - _tmp99 * fh1);
  _res(3, 0) = -(_tmp100 + _tmp103 + _tmp104) *
               std::exp(-_tmp101 - _tmp103 * fh1 - _tmp104 * fh1 - _tmp89 * _tmp93);
