...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl0(
  ...
  const Scalar _tmp32 = _tmp20 - _tmp22;
  ...
  const Scalar _tmp44 = Scalar(0.20999999999999999) * _tmp18 + Scalar(0.20999999999999999) * _tmp19;
  const Scalar _tmp45 = -Scalar(0.010999999999999999) * _tmp11 -
                        Scalar(0.010999999999999999) * _tmp21 + Scalar(-0.010999999999999999);
  const Scalar _tmp46 = Scalar(0.20999999999999999) * _tmp8 - Scalar(0.20999999999999999) * _tmp9;
  const Scalar _tmp47 = _tmp45 + _tmp46;
  const Scalar _tmp48 = -_tmp44 + _tmp47;
  const Scalar _tmp49 = _tmp44 + _tmp47;
  const Scalar _tmp50 = _tmp27 * _tmp48;
  const Scalar _tmp51 = -_tmp35 * _tmp50 + _tmp36 * _tmp49;
  ...
  const Scalar _tmp55 = -_tmp27 * _tmp49 + _tmp50;
  const Scalar _tmp56 = _tmp43 * _tmp55 - _tmp48 - _tmp54 * (_tmp35 * _tmp48 + _tmp43 * _tmp51);
  ...
  const Scalar _tmp66 = _tmp35 * _tmp65 - _tmp64;
  const Scalar _tmp67 = _tmp37 * _tmp66;
  const Scalar _tmp68 = _tmp48 * _tmp65;
  const Scalar _tmp69 = _tmp44 + _tmp45 - _tmp46;
  const Scalar _tmp70 = -_tmp54 * (-_tmp35 * _tmp68 - _tmp51 * _tmp67 + _tmp64 * _tmp69) -
                        _tmp55 * _tmp67 - _tmp65 * _tmp69 + _tmp68;
  const Scalar _tmp71 = Scalar(1.0) / (_tmp70);
  const Scalar _tmp72 = _tmp41 * _tmp65 - _tmp42 * _tmp67 + _tmp58 * _tmp65 - _tmp61 * _tmp64;
  const Scalar _tmp73 = _tmp71 * _tmp72;
  const Scalar _tmp74 = Scalar(1.0) / (_tmp72);
  const Scalar _tmp75 = _tmp70 * _tmp74;
  const Scalar _tmp76 = _tmp56 + _tmp75 * (-_tmp41 + _tmp42 * _tmp43 - _tmp56 * _tmp73);
  const Scalar _tmp77 = _tmp66 * _tmp71;
  const Scalar _tmp78 = _tmp37 * (-_tmp35 - _tmp76 * _tmp77);
  const Scalar _tmp79 = _tmp71 * _tmp76;
  const Scalar _tmp80 = _tmp32 + _tmp57;
  ...
  const Scalar _tmp91 = _tmp37 * _tmp77 * _tmp89;
  const Scalar _tmp92 = Scalar(1.0) * _tmp37;
  const Scalar _tmp93 = _tmp51 * _tmp54 * _tmp92 - _tmp55 * _tmp92;
  const Scalar _tmp94 = _tmp75 * (-_tmp42 * _tmp92 - _tmp73 * _tmp93) + _tmp93;
  const Scalar _tmp95 = _tmp71 * _tmp94;
  const Scalar _tmp96 = _tmp37 * (-_tmp77 * _tmp94 + Scalar(1.0));
  const Scalar _tmp97 = _tmp81 * _tmp84;
  const Scalar _tmp98 = _tmp40 * _tmp97 * (_tmp27 * _tmp96 + _tmp65 * _tmp95);
  const Scalar _tmp99 = -_tmp80 * _tmp85 + _tmp82 * _tmp97;
  const Scalar _tmp100 = Scalar(1.0) * _tmp74;
  const Scalar _tmp101 = _tmp66 * _tmp74 * _tmp92;
  const Scalar _tmp102 = _tmp40 * _tmp99 * (_tmp100 * _tmp65 - _tmp101 * _tmp27);
  ...
  const Scalar _tmp108 = _tmp100 * _tmp99;

  // Output terms (1)
  Eigen::Matrix<Scalar, 4, 1> _res;

  _res(0, 0) = -std::exp(-fh1);
  _res(1, 0) = -(-_tmp102 - _tmp86 - _tmp98) *
               std::exp(_tmp102 * fh1 + _tmp40 * _tmp87 * (-_tmp27 * _tmp91 + _tmp65 * _tmp90) +
                        _tmp86 * fh1 + _tmp98 * fh1);
  _res(2, 0) = -(-_tmp103 + _tmp104 + _tmp105) *
               std::exp(_tmp103 * fh1 - _tmp104 * fh1 - _tmp105 * fh1 + _tmp87 * _tmp91);
  _res(3, 0) = -(_tmp106 + _tmp107 + _tmp108) *
               std::exp(-_tmp106 * fh1 - _tmp107 * fh1 - _tmp108 * fh1 - _tmp87 * _tmp90);
