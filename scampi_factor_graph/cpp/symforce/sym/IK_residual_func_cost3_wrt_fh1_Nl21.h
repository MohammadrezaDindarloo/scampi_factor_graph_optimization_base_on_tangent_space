...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl21(
  ...
  const Scalar _tmp19 = _tmp2 * _tmp7;
  ...
  const Scalar _tmp40 = _tmp35 + _tmp4;
  const Scalar _tmp41 = _tmp40 + p_init0 + Scalar(-2.5202214700000001);
  const Scalar _tmp42 = _tmp17 + _tmp32;
  ...
  const Scalar _tmp48 = _tmp47 * (_tmp40 * _tmp43 * _tmp45 - _tmp41 * _tmp42 * _tmp45);
  ...
  const Scalar _tmp62 = _tmp33 * _tmp39 - _tmp36 * _tmp57 + _tmp39 * _tmp48 - _tmp56 * _tmp61;
  const Scalar _tmp63 = Scalar(1.0) / (_tmp62);
  const Scalar _tmp64 = Scalar(1.0) * _tmp63;
  const Scalar _tmp65 = _tmp54 * _tmp61;
  const Scalar _tmp66 = _tmp31 * _tmp47 * (_tmp39 * _tmp64 - _tmp64 * _tmp65);
  ...
  const Scalar _tmp75 = -_tmp54 * _tmp73 + _tmp55 * _tmp74;
  ...
  const Scalar _tmp80 = _tmp54 * _tmp72 - _tmp54 * _tmp74;
  const Scalar _tmp81 = -_tmp72 + _tmp76 * _tmp80 - _tmp79 * (_tmp73 + _tmp75 * _tmp76);
  const Scalar _tmp82 = _tmp68 + _tmp69 - _tmp70;
  const Scalar _tmp83 = _tmp39 * _tmp72 - _tmp39 * _tmp82 - _tmp61 * _tmp80 -
                        _tmp79 * (-_tmp39 * _tmp73 + _tmp57 * _tmp82 - _tmp61 * _tmp75);
  const Scalar _tmp84 = Scalar(1.0) / (_tmp83);
  const Scalar _tmp85 = _tmp62 * _tmp84;
  const Scalar _tmp86 = _tmp63 * _tmp83;
  const Scalar _tmp87 = _tmp81 + _tmp86 * (-_tmp48 + _tmp56 * _tmp76 - _tmp81 * _tmp85);
  const Scalar _tmp88 = _tmp59 * _tmp84;
  const Scalar _tmp89 = -_tmp58 - _tmp87 * _tmp88;
  const Scalar _tmp90 = _tmp54 * _tmp60;
  const Scalar _tmp91 = _tmp84 * _tmp87;
  const Scalar _tmp92 = _tmp30 * _tmp47 * (_tmp39 * _tmp91 + _tmp89 * _tmp90 + Scalar(1.0));
  const Scalar _tmp93 = Scalar(1.0) * _tmp60;
  const Scalar _tmp94 = _tmp75 * _tmp79 * _tmp93 - _tmp80 * _tmp93;
  const Scalar _tmp95 = _tmp86 * (-_tmp56 * _tmp93 - _tmp85 * _tmp94) + _tmp94;
  const Scalar _tmp96 = _tmp84 * _tmp95;
  const Scalar _tmp97 = -_tmp88 * _tmp95 + Scalar(1.0);
  const Scalar _tmp98 = _tmp29 * _tmp47 * (_tmp39 * _tmp96 + _tmp90 * _tmp97);
  const Scalar _tmp99 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp100 = _tmp77 * _tmp79 + _tmp78;
  const Scalar _tmp101 = 0;
  const Scalar _tmp102 = _tmp29 * _tmp60 * _tmp97;
  const Scalar _tmp103 = _tmp31 * _tmp64;
  const Scalar _tmp104 = _tmp103 * fh1;
  const Scalar _tmp105 = _tmp101 * _tmp99;
  const Scalar _tmp106 = _tmp30 * _tmp60 * _tmp89;
  const Scalar _tmp107 = _tmp30 * _tmp91;
  const Scalar _tmp108 = _tmp29 * _tmp96;

  // Output terms (1)
  Eigen::Matrix<Scalar, 4, 1> _res;

  _res(0, 0) = -std::exp(-fh1);
  _res(1, 0) = -(-_tmp66 - _tmp92 - _tmp98) *
               std::exp(_tmp47 * _tmp99 * (_tmp101 * _tmp39 - _tmp101 * _tmp65) + _tmp66 * fh1 +
                        _tmp92 * fh1 + _tmp98 * fh1);
  _res(2, 0) = -(_tmp102 - _tmp103 * _tmp61 + _tmp106) *
               std::exp(-_tmp102 * fh1 + _tmp104 * _tmp61 + _tmp105 * _tmp61 - _tmp106 * fh1);
  _res(3, 0) =
