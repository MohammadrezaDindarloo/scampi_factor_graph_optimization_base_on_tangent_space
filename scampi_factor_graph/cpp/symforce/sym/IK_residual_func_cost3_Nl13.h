...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl13(
  ...
  const Scalar _tmp17 = Scalar(0.20999999999999999) * _tmp1 + Scalar(0.20999999999999999) * _tmp16 +
  ...
  const Scalar _tmp25 = Scalar(0.20999999999999999) * _tmp16 + Scalar(0.20999999999999999) * _tmp3;
  ...
  const Scalar _tmp42 = -_tmp14 + _tmp4;
  const Scalar _tmp43 = _tmp11 + _tmp42;
  const Scalar _tmp44 = _tmp31 * _tmp32;
  const Scalar _tmp45 = _tmp43 * _tmp44;
  const Scalar _tmp46 = _tmp15 * _tmp33 - _tmp41 * _tmp45;
  const Scalar _tmp47 = Scalar(1.0) / (-_tmp33 + _tmp41 * _tmp44);
  const Scalar _tmp48 = Scalar(1.0) * _tmp47;
  const Scalar _tmp49 = Scalar(1.0) * _tmp35;
  const Scalar _tmp50 = Scalar(1.0) * _tmp38;
  const Scalar _tmp51 = (-_tmp30 + _tmp50) / (_tmp23 - _tmp49);
  const Scalar _tmp52 = -_tmp15 * _tmp44 + _tmp45;
  const Scalar _tmp53 = _tmp46 * _tmp48 * _tmp51 - _tmp48 * _tmp52;
  const Scalar _tmp54 = _tmp25 + _tmp37;
  const Scalar _tmp55 = _tmp54 + p_init0 + Scalar(-2.5202214700000001);
  const Scalar _tmp56 = _tmp20 + _tmp21;
  ...
  const Scalar _tmp64 = _tmp10 + _tmp42;
  const Scalar _tmp65 = _tmp43 * _tmp61;
  const Scalar _tmp66 = -_tmp51 * (-_tmp41 * _tmp65 - _tmp46 * _tmp63 + _tmp60 * _tmp64) -
  ...
  const Scalar _tmp71 = _tmp70 * (-_tmp35 * _tmp39 * _tmp69 + _tmp36 * _tmp38 * _tmp69);
  const Scalar _tmp72 = _tmp23 * _tmp44 - _tmp30 * _tmp33 + _tmp44 * _tmp71;
  const Scalar _tmp73 = -_tmp54 * _tmp60 + _tmp57 * _tmp61 + _tmp61 * _tmp71 - _tmp63 * _tmp72;
  ...
  const Scalar _tmp80 = _tmp44 * _tmp47;
  const Scalar _tmp81 = _tmp61 * _tmp67;
  const Scalar _tmp82 = _tmp17 + _tmp56;
  ...
  const Scalar _tmp89 = _tmp41 * _tmp47;
  const Scalar _tmp90 = -_tmp43 - _tmp51 * (_tmp41 * _tmp43 + _tmp46 * _tmp89) + _tmp52 * _tmp89;
  const Scalar _tmp91 = _tmp76 * (-_tmp71 + _tmp72 * _tmp89 - _tmp74 * _tmp90) + _tmp90;
  const Scalar _tmp92 = -_tmp41 - _tmp78 * _tmp91;
  const Scalar _tmp93 = _tmp85 * _tmp86;
  const Scalar _tmp94 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp95 = _tmp49 * _tmp51 + _tmp50;
  const Scalar _tmp96 = 0;
  const Scalar _tmp97 = _tmp44 * _tmp63;
  const Scalar _tmp98 = Scalar(1.0) * _tmp75;
  const Scalar _tmp99 = fh1 * (-_tmp82 * _tmp93 + _tmp84 * _tmp87);
  ...
  _res(1, 0) = std::exp(_tmp70 * _tmp94 * (_tmp61 * _tmp96 - _tmp96 * _tmp97) +
                        _tmp70 * _tmp99 * (_tmp61 * _tmp98 - _tmp97 * _tmp98) +
                        _tmp87 * _tmp88 * (_tmp77 * _tmp81 + _tmp79 * _tmp80) +
                        _tmp88 * _tmp93 * (_tmp80 * _tmp92 + _tmp81 * _tmp91 + Scalar(1.0)));
  _res(2, 0) = std::exp(_tmp100 * _tmp63 - _tmp101 * _tmp79 * _tmp87 - _tmp101 * _tmp92 * _tmp93 +
                        _tmp102 * _tmp63);
