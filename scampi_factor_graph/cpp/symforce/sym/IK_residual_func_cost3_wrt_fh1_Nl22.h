...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl22(
  ...
  const Scalar _tmp29 = -Scalar(0.010999999999999999) * _tmp22 -
                        Scalar(0.010999999999999999) * _tmp8 + Scalar(-0.010999999999999999);
  const Scalar _tmp30 = Scalar(0.20999999999999999) * _tmp12 - Scalar(0.20999999999999999) * _tmp13;
  const Scalar _tmp31 = Scalar(0.20999999999999999) * _tmp19 + Scalar(0.20999999999999999) * _tmp20;
  const Scalar _tmp32 = -_tmp31;
  const Scalar _tmp33 = _tmp29 - _tmp30 + _tmp32;
  const Scalar _tmp34 = -_tmp18;
  const Scalar _tmp35 = _tmp24 + _tmp34;
  const Scalar _tmp36 = _tmp35 + p_init1 + Scalar(8.3196563700000006);
  const Scalar _tmp37 = -_tmp10 + _tmp14;
  const Scalar _tmp38 = _tmp37 + _tmp7;
  const Scalar _tmp39 = _tmp38 + p_init0 + Scalar(1.9874742000000001);
  ...
  const Scalar _tmp44 = -_tmp33 * _tmp41 + _tmp41 * _tmp43;
  const Scalar _tmp45 = _tmp26 * _tmp27;
  const Scalar _tmp46 = _tmp15 + _tmp6;
  const Scalar _tmp47 = _tmp46 + p_init0 + Scalar(-2.71799795);
  ...
  const Scalar _tmp57 = _tmp32 + _tmp42;
  const Scalar _tmp58 = _tmp43 * _tmp52;
  const Scalar _tmp59 = _tmp33 * _tmp54 - _tmp41 * _tmp58;
  const Scalar _tmp60 = Scalar(1.0) * _tmp50;
  const Scalar _tmp61 = Scalar(1.0) * _tmp46;
  const Scalar _tmp62 = (-_tmp38 + _tmp61) / (_tmp35 - _tmp60);
  const Scalar _tmp63 = _tmp28 * _tmp43 - _tmp28 * _tmp57 - _tmp44 * _tmp56 -
                        _tmp62 * (-_tmp28 * _tmp58 + _tmp45 * _tmp57 - _tmp56 * _tmp59);
  ...
  const Scalar _tmp67 = _tmp48 * _tmp65;
  const Scalar _tmp68 = _tmp67 * (_tmp46 * _tmp51 * _tmp66 - _tmp47 * _tmp50 * _tmp66);
  const Scalar _tmp69 = _tmp35 * _tmp41 - _tmp38 * _tmp54 + _tmp41 * _tmp68;
  const Scalar _tmp70 = Scalar(1.0) * _tmp55;
  const Scalar _tmp71 = -_tmp44 * _tmp70 + _tmp59 * _tmp62 * _tmp70;
  const Scalar _tmp72 = -_tmp16 * _tmp45 + _tmp25 * _tmp28 + _tmp28 * _tmp68 - _tmp56 * _tmp69;
  ...
  const Scalar _tmp80 = _tmp34 + _tmp49;
  const Scalar _tmp81 = _tmp80 + p_init1 + Scalar(-4.8333311099999996);
  const Scalar _tmp82 = _tmp37 + _tmp6;
  ...
  const Scalar _tmp88 = -_tmp43 + _tmp44 * _tmp87 - _tmp62 * (_tmp58 + _tmp59 * _tmp87);
  ...
  _res(2, 0) = -(-_tmp101 * _tmp56 + _tmp103 + _tmp105) *
               std::exp(_tmp102 * _tmp56 - _tmp103 * fh1 + _tmp104 * _tmp56 - _tmp105 * fh1);
  _res(3, 0) =
