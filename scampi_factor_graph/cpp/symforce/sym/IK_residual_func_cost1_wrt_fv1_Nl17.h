...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1WrtFv1Nl17(
  ...
  const Scalar _tmp59 = _tmp47 * _tmp57 - _tmp49 * _tmp58 + _tmp53 * _tmp57;
  const Scalar _tmp60 = Scalar(1.0) / (_tmp43 * _tmp57 - _tmp58);
  ...
  const Scalar _tmp70 = _tmp57 * _tmp66 - _tmp57 * _tmp69;
  const Scalar _tmp71 = _tmp43 * _tmp66;
  const Scalar _tmp72 = -_tmp57 * _tmp71 + _tmp58 * _tmp69;
  ...
  const Scalar _tmp79 = _tmp61 * _tmp70 - _tmp66 - _tmp73 * _tmp78;
  const Scalar _tmp80 = _tmp34 + _tmp52;
  ...
  const Scalar _tmp92 = -_tmp71 * _tmp88 - _tmp72 * _tmp90 + _tmp87 * _tmp91;
  const Scalar _tmp93 = _tmp66 * _tmp88 - _tmp70 * _tmp90 - _tmp78 * _tmp92 - _tmp88 * _tmp91;
  const Scalar _tmp94 = Scalar(1.0) / (_tmp93);
  const Scalar _tmp95 = _tmp47 * _tmp88 - _tmp59 * _tmp90 + _tmp80 * _tmp88 - _tmp83 * _tmp87;
  const Scalar _tmp96 = _tmp94 * _tmp95;
  const Scalar _tmp97 = Scalar(1.0) / (_tmp95);
  const Scalar _tmp98 = _tmp93 * _tmp97;
  const Scalar _tmp99 = _tmp98 * (-_tmp47 + _tmp59 * _tmp61 - _tmp79 * _tmp96);
  const Scalar _tmp100 = _tmp79 + _tmp99;
  const Scalar _tmp101 = _tmp89 * _tmp94;
  const Scalar _tmp102 = -_tmp100 * _tmp101 - _tmp43;
  const Scalar _tmp103 = _tmp57 * _tmp60;
  const Scalar _tmp104 = _tmp88 * _tmp94;
  const Scalar _tmp105 = _tmp20 + Scalar(-2.71799795);
  const Scalar _tmp106 = _tmp31 + Scalar(-4.7752063900000001);
  ...
  const Scalar _tmp115 = -_tmp113 * _tmp70 + _tmp114 * _tmp78;
  const Scalar _tmp116 = _tmp98 * (-_tmp113 * _tmp59 - _tmp115 * _tmp96);
  ...
  const Scalar _tmp121 = _tmp74 * _tmp78 + _tmp77;
  const Scalar _tmp122 = 0;
  const Scalar _tmp123 = _tmp122 * _tmp90;
  const Scalar _tmp124 = _tmp46 * (_tmp122 * _tmp88 - _tmp123 * _tmp57);
  const Scalar _tmp125 = -_tmp109 * _tmp46 * (_tmp100 * _tmp104 + _tmp102 * _tmp103 + Scalar(1.0)) -
                         _tmp112 * _tmp46 * (-_tmp110 * _tmp57 * _tmp90 + _tmp110 * _tmp88) -
                         _tmp119 * _tmp46 * (_tmp103 * _tmp118 + _tmp104 * _tmp117) -
                         _tmp120 * _tmp124;
  const Scalar _tmp126 = std::pow(_tmp125, Scalar(-2));
  const Scalar _tmp127 = _tmp124 * _tmp126;
  const Scalar _tmp128 = Scalar(1.0) / (_tmp125);
  const Scalar _tmp129 = fh1 * (_tmp62 + _tmp68);
  const Scalar _tmp130 = -_tmp111 * _tmp129 - Scalar(3.29616) * _tmp25 - _tmp30 * fv1;
  const Scalar _tmp131 = _tmp75 + _tmp80;
  const Scalar _tmp132 = _tmp131 * _tmp78;
  const Scalar _tmp133 = Scalar(1.0) / (-_tmp132 + _tmp77 - _tmp83);
  const Scalar _tmp134 = Scalar(1.0) * _tmp133;
  const Scalar _tmp135 = _tmp76 * (_tmp132 * _tmp134 + Scalar(1.0));
  ...
  const Scalar _tmp140 = -_tmp114 + _tmp116 * _tmp139 - _tmp117 * _tmp138;
  const Scalar _tmp141 = Scalar(1.0) * _tmp76;
  const Scalar _tmp142 = _tmp121 * _tmp133;
  const Scalar _tmp143 = _tmp76 * (-_tmp122 * _tmp92 - _tmp131 * _tmp142 + _tmp75);
  const Scalar _tmp144 = -Scalar(1.0) * _tmp142 - Scalar(1.0) * _tmp143 + Scalar(1.0);
  const Scalar _tmp145 = _tmp134 * _tmp98;
  const Scalar _tmp146 = -_tmp110 * _tmp92 + _tmp131 * _tmp145;
  const Scalar _tmp147 = -_tmp100 * _tmp138 + _tmp139 * _tmp99 + _tmp73;
  const Scalar _tmp148 = _tmp108 * _tmp129 + Scalar(3.29616) * _tmp12 + _tmp19 * fv1;
  const Scalar _tmp149 = _tmp131 * _tmp76;
  const Scalar _tmp150 = Scalar(1.0) * _tmp134 * _tmp149 - Scalar(1.0) * _tmp134;
  const Scalar _tmp151 = Scalar(1.0) * _tmp109 * (_tmp134 * _tmp99 - _tmp141 * _tmp147) +
                         Scalar(1.0) * _tmp112 * (-_tmp141 * _tmp146 + _tmp145) +
                         Scalar(1.0) * _tmp119 * (_tmp116 * _tmp134 - _tmp140 * _tmp141) +
                         _tmp120 * _tmp144 + _tmp130 * _tmp137 + _tmp148 * _tmp150;
  const Scalar _tmp152 = std::asinh(_tmp128 * _tmp151);
  const Scalar _tmp153 = Scalar(1.0) * _tmp152;
  const Scalar _tmp154 = _tmp26 + _tmp33 + _tmp52;
  const Scalar _tmp155 =
      (-_tmp127 * _tmp151 + _tmp128 * (_tmp137 * _tmp154 - _tmp144 + _tmp150 * _tmp19)) /
  ...
  const Scalar _tmp161 = _tmp76 * fh1;
  const Scalar _tmp162 = _tmp134 * _tmp148;
  const Scalar _tmp163 = _tmp108 * _tmp147 * _tmp161 + _tmp111 * _tmp140 * _tmp161 +
                         _tmp112 * _tmp146 * _tmp76 + _tmp120 * _tmp143 + _tmp130 * _tmp135 -
                         _tmp149 * _tmp162;
  const Scalar _tmp164 = _tmp110 * _tmp112;
  const Scalar _tmp165 = _tmp120 * _tmp122;
  const Scalar _tmp166 =
      _tmp102 * _tmp109 * _tmp60 + _tmp118 * _tmp119 * _tmp60 - _tmp164 * _tmp90 - _tmp165 * _tmp90;
  ...
  const Scalar _tmp174 = Scalar(9.6622558468725703) * _tmp122;
  const Scalar _tmp175 = _tmp174 * _tmp90;
  const Scalar _tmp176 = std::pow(_tmp166, Scalar(-2));
  const Scalar _tmp177 = _tmp123 * _tmp176;
  const Scalar _tmp178 = _tmp134 * _tmp19;
  const Scalar _tmp179 =
      (-_tmp163 * _tmp177 + _tmp167 * (_tmp135 * _tmp154 - _tmp143 - _tmp149 * _tmp178)) /
      std::sqrt(Scalar(std::pow(_tmp163, Scalar(2)) * _tmp176 + 1));
  const Scalar _tmp180 =
      _tmp100 * _tmp109 * _tmp94 + _tmp117 * _tmp119 * _tmp94 + _tmp164 + _tmp165;
  const Scalar _tmp181 = Scalar(1.0) / (_tmp180);
  const Scalar _tmp182 = -_tmp109 * _tmp133 * _tmp99 - _tmp112 * _tmp145 -
                         _tmp116 * _tmp119 * _tmp133 + _tmp120 * _tmp142 - _tmp130 * _tmp136 +
                         _tmp162;
  ...
  const Scalar _tmp191 = (_tmp181 * (-_tmp136 * _tmp154 - _tmp142 + _tmp178) + _tmp182 * _tmp190) /
  ...
  _res(1, 0) =
      -_tmp156 *
          (-Scalar(0.86625939559540499) * _tmp127 + Scalar(1.0) * _tmp155 * std::sinh(_tmp153) -
           (-Scalar(0.1034955) * _tmp127 * _tmp159 +
            _tmp158 * (-_tmp152 * _tmp157 - _tmp155 * _tmp156)) *
               std::sinh(_tmp160)) -
      _tmp157 * (Scalar(0.86625939559540499) * _tmp128 + std::cosh(_tmp153) - std::cosh(_tmp160));
  _res(2, 0) =
      -_tmp170 *
          (-Scalar(0.87653584775870996) * _tmp177 + Scalar(1.0) * _tmp179 * std::sinh(_tmp169) -
           (-Scalar(0.1034955) * _tmp171 * _tmp177 +
            _tmp172 * (-_tmp168 * _tmp175 - _tmp170 * _tmp179)) *
               std::sinh(_tmp173)) -
      _tmp175 * (Scalar(0.87653584775870996) * _tmp167 + std::cosh(_tmp169) - std::cosh(_tmp173));
  _res(3, 0) =
      _tmp174 * (Scalar(0.87679799772039002) * _tmp181 + std::cosh(_tmp184) - std::cosh(_tmp188)) -
      _tmp185 *
          (Scalar(0.87679799772039002) * _tmp190 + Scalar(1.0) * _tmp191 * std::sinh(_tmp184) -
