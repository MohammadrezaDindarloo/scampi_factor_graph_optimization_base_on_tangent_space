...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl5(const Scalar fh1, const Scalar fv1,
  ...
  const Scalar _tmp29 = -_tmp20 + _tmp23;
  const Scalar _tmp30 = _tmp18 + _tmp29;
  const Scalar _tmp31 = _tmp30 + p_init1 + Scalar(-4.8333311099999996);
  const Scalar _tmp32 = -_tmp4;
  const Scalar _tmp33 = _tmp13 + _tmp9;
  const Scalar _tmp34 = _tmp32 + _tmp33;
  const Scalar _tmp35 = _tmp34 + p_init0 + Scalar(1.79662371);
  const Scalar _tmp36 =
      std::sqrt(Scalar(std::pow(_tmp31, Scalar(2)) + std::pow(_tmp35, Scalar(2))));
  const Scalar _tmp37 = Scalar(1.0) / (_tmp36);
  const Scalar _tmp38 = Scalar(1.0) / (_tmp35);
  const Scalar _tmp39 = _tmp36 * _tmp38;
  const Scalar _tmp40 = _tmp39 * (-_tmp30 * _tmp35 * _tmp37 + _tmp31 * _tmp34 * _tmp37);
  const Scalar _tmp41 = _tmp33 + _tmp4;
  const Scalar _tmp42 = _tmp41 + p_init0 + Scalar(-2.71799795);
  const Scalar _tmp43 = _tmp18 + _tmp24;
  ...
  const Scalar _tmp48 = _tmp40 * _tmp46 - _tmp41 * _tmp47 + _tmp43 * _tmp46;
  const Scalar _tmp49 = _tmp26 * _tmp27;
  const Scalar _tmp50 = _tmp31 * _tmp38;
  const Scalar _tmp51 = _tmp28 * _tmp50 - _tmp49;
  const Scalar _tmp52 = Scalar(1.0) / (_tmp46 * _tmp50 - _tmp47);
  const Scalar _tmp53 = _tmp51 * _tmp52;
  const Scalar _tmp54 = -_tmp15 * _tmp49 + _tmp25 * _tmp28 + _tmp28 * _tmp40 - _tmp48 * _tmp53;
  const Scalar _tmp55 = Scalar(1.0) / (_tmp54);
  const Scalar _tmp56 = Scalar(1.0) * _tmp55;
  const Scalar _tmp57 = _tmp46 * _tmp53;
  const Scalar _tmp58 = _tmp14 + _tmp32;
  const Scalar _tmp59 = _tmp19 + _tmp29;
  const Scalar _tmp60 = _tmp59 + p_init1 + Scalar(8.3196563700000006);
  const Scalar _tmp61 = _tmp58 + p_init0 + Scalar(1.9874742000000001);
  ...
  const Scalar _tmp66 = Scalar(0.20999999999999999) * _tmp6 - Scalar(0.20999999999999999) * _tmp8;
  const Scalar _tmp67 =
  ...
  const Scalar _tmp72 = -_tmp46 * _tmp70 + _tmp46 * _tmp71;
  const Scalar _tmp73 = _tmp50 * _tmp52;
  const Scalar _tmp74 = _tmp50 * _tmp71;
  const Scalar _tmp75 = -_tmp46 * _tmp74 + _tmp47 * _tmp70;
  const Scalar _tmp76 = Scalar(1.0) * _tmp30;
  const Scalar _tmp77 = Scalar(1.0) * _tmp34;
  const Scalar _tmp78 = (-_tmp41 + _tmp77) / (_tmp43 - _tmp76);
  const Scalar _tmp79 = -_tmp71 + _tmp72 * _tmp73 - _tmp78 * (_tmp73 * _tmp75 + _tmp74);
  const Scalar _tmp80 = _tmp66 + _tmp67 - _tmp68;
  const Scalar _tmp81 = _tmp28 * _tmp71 - _tmp28 * _tmp80 - _tmp53 * _tmp72 -
                        _tmp78 * (-_tmp28 * _tmp74 + _tmp49 * _tmp80 - _tmp53 * _tmp75);
  const Scalar _tmp82 = Scalar(1.0) / (_tmp81);
  const Scalar _tmp83 = _tmp54 * _tmp82;
  const Scalar _tmp84 = _tmp55 * _tmp81;
  const Scalar _tmp85 = _tmp79 + _tmp84 * (-_tmp40 + _tmp48 * _tmp73 - _tmp79 * _tmp83);
  const Scalar _tmp86 = _tmp28 * _tmp82;
  const Scalar _tmp87 = _tmp51 * _tmp82;
  const Scalar _tmp88 = -_tmp50 - _tmp85 * _tmp87;
  const Scalar _tmp89 = _tmp46 * _tmp52;
  const Scalar _tmp90 = _tmp64 * fh1;
  const Scalar _tmp91 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp92 = _tmp76 * _tmp78 + _tmp77;
  const Scalar _tmp93 = 0;
  const Scalar _tmp94 = Scalar(1.0) * _tmp52;
  const Scalar _tmp95 = -_tmp72 * _tmp94 + _tmp75 * _tmp78 * _tmp94;
  const Scalar _tmp96 = _tmp84 * (-_tmp48 * _tmp94 - _tmp83 * _tmp95) + _tmp95;
  const Scalar _tmp97 = -_tmp87 * _tmp96 + Scalar(1.0);
  const Scalar _tmp98 = _tmp63 * fh1;
  const Scalar _tmp99 = _tmp91 * _tmp93;
  const Scalar _tmp100 = _tmp56 * _tmp65;

  // Output terms (1)
  Eigen::Matrix<Scalar, 4, 1> _res;

  _res(0, 0) = std::exp(-fh1);
  _res(1, 0) = std::exp(_tmp39 * _tmp65 * (_tmp28 * _tmp56 - _tmp56 * _tmp57) +
                        _tmp39 * _tmp90 * (_tmp85 * _tmp86 + _tmp88 * _tmp89 + Scalar(1.0)) +
                        _tmp39 * _tmp91 * (_tmp28 * _tmp93 - _tmp57 * _tmp93) +
                        _tmp39 * _tmp98 * (_tmp86 * _tmp96 + _tmp89 * _tmp97));
  _res(2, 0) = std::exp(_tmp100 * _tmp53 - _tmp52 * _tmp88 * _tmp90 - _tmp52 * _tmp97 * _tmp98 +
                        _tmp53 * _tmp99);
  _res(3, 0) = std::exp(-_tmp100 - _tmp82 * _tmp85 * _tmp90 - _tmp82 * _tmp96 * _tmp98 - _tmp99);
