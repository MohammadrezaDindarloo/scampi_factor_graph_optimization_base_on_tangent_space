...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl10(
  ...
  const Scalar _tmp37 = -_tmp34 * _tmp36 + _tmp35;
  ...
  const Scalar _tmp49 = -_tmp35 * _tmp46 + _tmp36 * _tmp38;
  ...
  const Scalar _tmp53 = -_tmp15 + _tmp37 * _tmp48 - _tmp52 * (_tmp15 * _tmp46 + _tmp48 * _tmp49);
  const Scalar _tmp54 = _tmp10 + _tmp13 + _tmp7;
  const Scalar _tmp55 = _tmp26 + _tmp42;
  ...
  const Scalar _tmp65 = -_tmp37 * _tmp64 -
                        _tmp52 * (-_tmp46 * _tmp61 - _tmp49 * _tmp64 + _tmp54 * _tmp62) -
                        _tmp54 * _tmp60 + _tmp61;
  const Scalar _tmp66 = Scalar(1.0) / (_tmp65);
  const Scalar _tmp67 =
      std::sqrt(Scalar(std::pow(_tmp41, Scalar(2)) + std::pow(_tmp44, Scalar(2))));
  const Scalar _tmp68 = Scalar(1.0) / (_tmp67);
  const Scalar _tmp69 = _tmp45 * _tmp67;
  const Scalar _tmp70 = _tmp69 * (-_tmp40 * _tmp44 * _tmp68 + _tmp41 * _tmp43 * _tmp68);
  const Scalar _tmp71 = _tmp24 * _tmp34 - _tmp31 * _tmp38 + _tmp34 * _tmp70;
  ...
  const Scalar _tmp76 = _tmp53 + _tmp75 * (_tmp48 * _tmp71 - _tmp53 * _tmp73 - _tmp70);
  ...
  const Scalar _tmp81 = _tmp26 + _tmp30;
  const Scalar _tmp82 = _tmp81 + p_init0 + Scalar(-2.5202214700000001);
  const Scalar _tmp83 = _tmp18 + _tmp23;
  const Scalar _tmp84 = _tmp83 + p_init1 + Scalar(8.3888750099999996);
  ...
  const Scalar _tmp89 = _tmp63 * _tmp74 * _tmp88;
  ...
  const Scalar _tmp93 = -_tmp37 * _tmp88 + _tmp49 * _tmp52 * _tmp88;
  const Scalar _tmp94 = _tmp75 * (-_tmp71 * _tmp88 - _tmp73 * _tmp93) + _tmp93;
  const Scalar _tmp95 = -_tmp78 * _tmp94 + Scalar(1.0);
  ...
  const Scalar _tmp100 = _tmp69 * (-_tmp34 * _tmp99 + _tmp60 * _tmp98);
  ...
  _res(0, 0) = 0;
  _res(1, 0) = -_tmp100 *
               std::exp(_tmp100 * _tmp96 + _tmp69 * _tmp92 * (-_tmp34 * _tmp89 + _tmp60 * _tmp90) +
                        _tmp86 * _tmp87 * (_tmp76 * _tmp77 + _tmp79 * _tmp80 + Scalar(1.0)) +
                        _tmp87 * _tmp91 * (_tmp77 * _tmp94 + _tmp80 * _tmp95));
  _res(2, 0) = -_tmp99 * std::exp(_tmp101 * _tmp64 - _tmp102 * _tmp79 * _tmp86 -
                                  _tmp102 * _tmp91 * _tmp95 + _tmp89 * _tmp92);
  _res(3, 0) = _tmp98 * std::exp(-_tmp101 - _tmp103 * _tmp76 * _tmp86 - _tmp103 * _tmp91 * _tmp94 -
                                 _tmp90 * _tmp92);
