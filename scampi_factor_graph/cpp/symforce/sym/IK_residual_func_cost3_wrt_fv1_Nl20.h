...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl20(
  ...
  const Scalar _tmp87 = _tmp37 * (_tmp27 * _tmp85 - _tmp47 * _tmp86);
  const Scalar _tmp88 = _tmp50 * _tmp51;
  const Scalar _tmp89 = -_tmp74 - _tmp80 * (_tmp75 + _tmp76 * _tmp88) + _tmp81 * _tmp88;
  const Scalar _tmp90 = _tmp54 * _tmp83;
  const Scalar _tmp91 = _tmp55 * _tmp82;
  const Scalar _tmp92 = _tmp89 + _tmp91 * (-_tmp38 + _tmp49 * _tmp88 - _tmp89 * _tmp90);
  const Scalar _tmp93 = _tmp27 * _tmp83;
  const Scalar _tmp94 = _tmp52 * _tmp83;
  const Scalar _tmp95 = -_tmp50 - _tmp92 * _tmp94;
  const Scalar _tmp96 = _tmp47 * _tmp51;
  const Scalar _tmp97 = _tmp37 * fh1;
  const Scalar _tmp98 = _tmp57 * _tmp76 * _tmp80 - _tmp57 * _tmp81;
  const Scalar _tmp99 = _tmp91 * (-_tmp49 * _tmp57 - _tmp90 * _tmp98) + _tmp98;
  const Scalar _tmp100 = -_tmp94 * _tmp99 + Scalar(1.0);
  const Scalar _tmp101 = _tmp51 * fh1;
  const Scalar _tmp102 = _tmp67 * _tmp85;
  const Scalar _tmp103 = _tmp83 * fh1;
  ...
  _res(0, 0) = 0;
  _res(1, 0) =
      -_tmp87 * std::exp(_tmp37 * _tmp66 * (_tmp27 * _tmp56 - _tmp47 * _tmp58) +
                         _tmp64 * _tmp97 * (_tmp100 * _tmp96 + _tmp93 * _tmp99) +
                         _tmp65 * _tmp97 * (_tmp92 * _tmp93 + _tmp95 * _tmp96 + Scalar(1.0)) +
                         _tmp67 * _tmp87);
  _res(2, 0) = -_tmp86 * std::exp(-_tmp100 * _tmp101 * _tmp64 - _tmp101 * _tmp65 * _tmp95 +
                                  _tmp102 * _tmp53 + _tmp58 * _tmp66);
  _res(3, 0) = _tmp85 * std::exp(-_tmp102 - _tmp103 * _tmp64 * _tmp99 - _tmp103 * _tmp65 * _tmp92 -
                                 _tmp56 * _tmp66);
