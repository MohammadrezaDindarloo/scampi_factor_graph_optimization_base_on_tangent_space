...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl11(
  ...
  const Scalar _tmp28 = _tmp18 + _tmp25;
  const Scalar _tmp29 = _tmp11 + _tmp14;
  const Scalar _tmp30 = _tmp29 + _tmp8;
  const Scalar _tmp31 = (_tmp17 - _tmp30) / (-_tmp27 + _tmp28);
  const Scalar _tmp32 = _tmp17 + _tmp27 * _tmp31;
  ...
  const Scalar _tmp47 = _tmp34 + _tmp35 - _tmp36;
  const Scalar _tmp48 = _tmp33 + _tmp37;
  const Scalar _tmp49 = _tmp30 + p_init0 + Scalar(-2.71799795);
  const Scalar _tmp50 = _tmp28 + p_init1 + Scalar(-4.7752063900000001);
  const Scalar _tmp51 = std::pow(Scalar(std::pow(_tmp49, Scalar(2)) + std::pow(_tmp50, Scalar(2))),
                                 Scalar(Scalar(-1) / Scalar(2)));
  const Scalar _tmp52 = _tmp49 * _tmp51;
  const Scalar _tmp53 = _tmp38 * _tmp52 - _tmp48 * _tmp52;
  const Scalar _tmp54 = _tmp41 * _tmp45;
  const Scalar _tmp55 = _tmp26 + p_init1 + Scalar(-4.8333311099999996);
  const Scalar _tmp56 = _tmp16 + p_init0 + Scalar(1.79662371);
  const Scalar _tmp57 = Scalar(1.0) / (_tmp56);
  const Scalar _tmp58 = _tmp55 * _tmp57;
  const Scalar _tmp59 = _tmp46 * _tmp58 - _tmp54;
  const Scalar _tmp60 = _tmp50 * _tmp51;
  const Scalar _tmp61 = Scalar(1.0) / (_tmp52 * _tmp58 - _tmp60);
  const Scalar _tmp62 = _tmp59 * _tmp61;
  const Scalar _tmp63 = _tmp38 * _tmp58;
  const Scalar _tmp64 = _tmp48 * _tmp60 - _tmp52 * _tmp63;
  const Scalar _tmp65 = -_tmp31 * (-_tmp46 * _tmp63 + _tmp47 * _tmp54 - _tmp62 * _tmp64) +
                        _tmp38 * _tmp46 - _tmp46 * _tmp47 - _tmp53 * _tmp62;
  const Scalar _tmp66 = Scalar(1.0) / (_tmp65);
  const Scalar _tmp67 = 0;
  const Scalar _tmp68 = _tmp52 * _tmp62;
  const Scalar _tmp69 =
      std::sqrt(Scalar(std::pow(_tmp55, Scalar(2)) + std::pow(_tmp56, Scalar(2))));
  const Scalar _tmp70 = _tmp57 * _tmp69;
  const Scalar _tmp71 = _tmp58 * _tmp61;
  const Scalar _tmp72 = -_tmp31 * (_tmp63 + _tmp64 * _tmp71) - _tmp38 + _tmp53 * _tmp71;
  const Scalar _tmp73 = Scalar(1.0) / (_tmp69);
  const Scalar _tmp74 = _tmp70 * (_tmp16 * _tmp55 * _tmp73 - _tmp26 * _tmp56 * _tmp73);
  const Scalar _tmp75 = _tmp28 * _tmp52 - _tmp30 * _tmp60 + _tmp52 * _tmp74;
  const Scalar _tmp76 = _tmp40 * _tmp46 - _tmp43 * _tmp54 + _tmp46 * _tmp74 - _tmp62 * _tmp75;
  const Scalar _tmp77 = _tmp66 * _tmp76;
  const Scalar _tmp78 = Scalar(1.0) / (_tmp76);
  const Scalar _tmp79 = _tmp65 * _tmp78;
  const Scalar _tmp80 = _tmp72 + _tmp79 * (_tmp71 * _tmp75 - _tmp72 * _tmp77 - _tmp74);
  const Scalar _tmp81 = _tmp46 * _tmp66;
  const Scalar _tmp82 = _tmp59 * _tmp66;
  const Scalar _tmp83 = _tmp61 * (-_tmp58 - _tmp80 * _tmp82);
  const Scalar _tmp84 = _tmp29 + _tmp42;
  const Scalar _tmp85 = _tmp84 + p_init0 + Scalar(-2.5202214700000001);
  const Scalar _tmp86 = _tmp18 + _tmp39;
  const Scalar _tmp87 = _tmp86 + p_init1 + Scalar(8.3888750099999996);
  const Scalar _tmp88 = std::pow(Scalar(std::pow(_tmp85, Scalar(2)) + std::pow(_tmp87, Scalar(2))),
                                 Scalar(Scalar(-1) / Scalar(2)));
  const Scalar _tmp89 = _tmp85 * _tmp88;
  const Scalar _tmp90 = _tmp70 * _tmp89 * (_tmp52 * _tmp83 + _tmp80 * _tmp81 + Scalar(1.0));
  const Scalar _tmp91 = Scalar(1.0) * _tmp61;
  const Scalar _tmp92 = _tmp31 * _tmp64 * _tmp91 - _tmp53 * _tmp91;
  const Scalar _tmp93 = _tmp79 * (-_tmp75 * _tmp91 - _tmp77 * _tmp92) + _tmp92;
  const Scalar _tmp94 = _tmp61 * (-_tmp82 * _tmp93 + Scalar(1.0));
  const Scalar _tmp95 = _tmp87 * _tmp88;
  const Scalar _tmp96 = _tmp70 * _tmp95 * (_tmp52 * _tmp94 + _tmp81 * _tmp93);
  const Scalar _tmp97 = _tmp84 * _tmp95 - _tmp86 * _tmp89;
  const Scalar _tmp98 = Scalar(1.0) * _tmp78;
  const Scalar _tmp99 = _tmp70 * _tmp97 * (_tmp46 * _tmp98 - _tmp68 * _tmp98);
  const Scalar _tmp100 = _tmp94 * _tmp95;
  const Scalar _tmp101 = _tmp97 * _tmp98;
  const Scalar _tmp102 = _tmp101 * fh1;
  const Scalar _tmp103 = _tmp83 * _tmp89;
  const Scalar _tmp104 = _tmp0 * _tmp67;
  const Scalar _tmp105 = _tmp66 * _tmp80 * _tmp89;
  const Scalar _tmp106 = _tmp66 * _tmp93 * _tmp95;
  ...
  _res(1, 0) =
      -(-_tmp90 - _tmp96 - _tmp99) * std::exp(_tmp0 * _tmp70 * (_tmp46 * _tmp67 - _tmp67 * _tmp68) +
                                              _tmp90 * fh1 + _tmp96 * fh1 + _tmp99 * fh1);
  _res(2, 0) = -(_tmp100 - _tmp101 * _tmp62 + _tmp103) *
               std::exp(-_tmp100 * fh1 + _tmp102 * _tmp62 - _tmp103 * fh1 + _tmp104 * _tmp62);
  _res(3, 0) =
      -(_tmp101 + _tmp105 + _tmp106) * std::exp(-_tmp102 - _tmp104 - _tmp105 * fh1 - _tmp106 * fh1);
