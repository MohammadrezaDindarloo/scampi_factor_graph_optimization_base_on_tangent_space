...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl23(
  ...
  const Scalar _tmp89 = _tmp66 * _tmp73 * _tmp88;
  const Scalar _tmp90 = _tmp81 * _tmp84;
  const Scalar _tmp91 = fh1 * (-_tmp80 * _tmp85 + _tmp82 * _tmp90);
  const Scalar _tmp92 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp93 = _tmp53 * _tmp55 + _tmp54;
  const Scalar _tmp94 = 0;
  const Scalar _tmp95 = _tmp70 * _tmp94;
  const Scalar _tmp96 = _tmp76 * _tmp94;
  const Scalar _tmp97 = -_tmp50 * _tmp88 + _tmp52 * _tmp55 * _tmp88;
  const Scalar _tmp98 = _tmp74 * (-_tmp41 * _tmp88 - _tmp72 * _tmp97) + _tmp97;
  const Scalar _tmp99 = -_tmp76 * _tmp98 + Scalar(1.0);
  const Scalar _tmp100 = _tmp90 * fh1;

  // Output terms (1)
  Eigen::Matrix<Scalar, 4, 1> _res;

  _res(0, 0) = std::exp(-fh1);
  _res(1, 0) = std::exp(_tmp100 * _tmp30 * (_tmp78 * _tmp99 + _tmp79 * _tmp98) +
                        _tmp30 * _tmp86 * (_tmp75 * _tmp79 + _tmp77 * _tmp78 + Scalar(1.0)) +
                        _tmp30 * _tmp91 * (-_tmp39 * _tmp89 + _tmp65 * _tmp87) +
                        _tmp30 * _tmp92 * (_tmp65 * _tmp95 - _tmp78 * _tmp96));
  _res(2, 0) = std::exp(-_tmp100 * _tmp42 * _tmp99 - _tmp42 * _tmp77 * _tmp86 +
                        _tmp42 * _tmp92 * _tmp96 + _tmp89 * _tmp91);
  _res(3, 0) = std::exp(-_tmp100 * _tmp70 * _tmp98 - _tmp70 * _tmp75 * _tmp86 - _tmp87 * _tmp91 -
                        _tmp92 * _tmp95);
