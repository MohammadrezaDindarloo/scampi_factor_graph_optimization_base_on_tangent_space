...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2WrtFh1Nl7(
  ...
  const Scalar _tmp58 = Scalar(1.0) / (_tmp46 - _tmp47 - _tmp57);
  const Scalar _tmp59 = Scalar(1.0) * _tmp58;
  const Scalar _tmp60 = _tmp52 + p_init1;
  ...
  const Scalar _tmp66 = _tmp45 + Scalar(8.3196563700000006);
  const Scalar _tmp67 = _tmp42 + Scalar(1.9874742000000001);
  const Scalar _tmp68 =
  ...
  const Scalar _tmp72 = _tmp71 * (_tmp41 * _tmp66 * _tmp69 - _tmp44 * _tmp67 * _tmp69);
  const Scalar _tmp73 = _tmp61 * _tmp64;
  const Scalar _tmp74 = _tmp52 * _tmp65 - _tmp54 * _tmp73 + _tmp65 * _tmp72;
  ...
  const Scalar _tmp80 = -Scalar(0.20999999999999999) * _tmp10 + Scalar(0.20999999999999999) * _tmp9;
  ...
  const Scalar _tmp86 = -_tmp65 * _tmp85 + _tmp73 * _tmp82;
  const Scalar _tmp87 = Scalar(1.0) * _tmp53;
  const Scalar _tmp88 = -_tmp65 * _tmp82 + _tmp65 * _tmp84;
  const Scalar _tmp89 = _tmp55 * _tmp76 * _tmp86 * _tmp87 - _tmp77 * _tmp88;
  const Scalar _tmp90 = _tmp47 + p_init0;
  const Scalar _tmp91 = _tmp90 + Scalar(-2.71799795);
  const Scalar _tmp92 = _tmp50 + p_init1;
  ...
  const Scalar _tmp97 = _tmp75 * _tmp95 - _tmp96;
  const Scalar _tmp98 = _tmp76 * _tmp97;
  const Scalar _tmp99 = _tmp79 + _tmp80;
  const Scalar _tmp100 = _tmp78 + _tmp99;
  const Scalar _tmp101 = _tmp100 * _tmp96 - _tmp85 * _tmp95 - _tmp86 * _tmp98;
  const Scalar _tmp102 = -_tmp100 * _tmp95 - _tmp101 * _tmp56 + _tmp84 * _tmp95 - _tmp88 * _tmp98;
  const Scalar _tmp103 = Scalar(1.0) / (_tmp102);
  const Scalar _tmp104 = -_tmp47 * _tmp96 + _tmp50 * _tmp95 + _tmp72 * _tmp95 - _tmp74 * _tmp98;
  const Scalar _tmp105 = _tmp103 * _tmp104;
  const Scalar _tmp106 = Scalar(1.0) / (_tmp104);
  const Scalar _tmp107 = _tmp102 * _tmp106;
  const Scalar _tmp108 = _tmp107 * (-_tmp105 * _tmp89 - _tmp74 * _tmp77);
  const Scalar _tmp109 = _tmp103 * (_tmp108 + _tmp89);
  const Scalar _tmp110 = _tmp51 * _tmp58;
  const Scalar _tmp111 = -_tmp101 * _tmp109 + _tmp108 * _tmp110 - _tmp77 * _tmp86;
  const Scalar _tmp112 = _tmp18 + Scalar(-2.5202214700000001);
  const Scalar _tmp113 = _tmp29 + Scalar(8.3888750099999996);
  const Scalar _tmp114 =
      std::pow(Scalar(std::pow(_tmp112, Scalar(2)) + std::pow(_tmp113, Scalar(2))),
               Scalar(Scalar(-1) / Scalar(2)));
  const Scalar _tmp115 = _tmp113 * _tmp114;
  const Scalar _tmp116 = Scalar(1.0) * _tmp115 * (_tmp108 * _tmp59 - _tmp111 * _tmp87);
  const Scalar _tmp117 = _tmp83 + _tmp99;
  const Scalar _tmp118 = _tmp117 * fh1;
  const Scalar _tmp119 = -_tmp115 * _tmp118 - Scalar(3.29616) * _tmp25 - _tmp28 * fv1;
  const Scalar _tmp120 = _tmp57 * _tmp59 + Scalar(1.0);
  const Scalar _tmp121 = _tmp56 * _tmp59;
  const Scalar _tmp122 = -Scalar(1.0) * _tmp120 * _tmp87 + Scalar(1.0) * _tmp121;
  const Scalar _tmp123 = _tmp112 * _tmp114;
  const Scalar _tmp124 = Scalar(3.29616) * _tmp11 + _tmp118 * _tmp123 + _tmp17 * fv1;
  const Scalar _tmp125 = _tmp51 * _tmp53;
  const Scalar _tmp126 = _tmp125 * _tmp59;
  const Scalar _tmp127 = Scalar(1.0) * _tmp126 - Scalar(1.0) * _tmp59;
  const Scalar _tmp128 = _tmp75 * _tmp76;
  const Scalar _tmp129 = _tmp128 * _tmp86 + _tmp85;
  const Scalar _tmp130 = _tmp128 * _tmp88 - _tmp129 * _tmp56 - _tmp84;
  const Scalar _tmp131 = _tmp107 * (-_tmp105 * _tmp130 + _tmp128 * _tmp74 - _tmp72);
  const Scalar _tmp132 = _tmp103 * (_tmp130 + _tmp131);
  const Scalar _tmp133 = -_tmp101 * _tmp132 + _tmp110 * _tmp131 + _tmp129;
  const Scalar _tmp134 = Scalar(1.0) * _tmp123 * (_tmp131 * _tmp59 - _tmp133 * _tmp87);
  const Scalar _tmp135 = _tmp46 + _tmp48 * _tmp56;
  const Scalar _tmp136 = 0;
  const Scalar _tmp137 = _tmp135 * _tmp58;
  const Scalar _tmp138 = -_tmp101 * _tmp136 - _tmp137 * _tmp51 + _tmp49;
  const Scalar _tmp139 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp140 = _tmp107 * _tmp59;
  const Scalar _tmp141 = Scalar(1.0) * _tmp106;
  const Scalar _tmp142 = -_tmp101 * _tmp141 + _tmp140 * _tmp51;
  const Scalar _tmp143 = _tmp115 * _tmp17 - _tmp123 * _tmp28;
  const Scalar _tmp144 = Scalar(1.0) * _tmp143 * (_tmp140 - _tmp142 * _tmp87);
  const Scalar _tmp145 =
      _tmp116 * fh1 + _tmp119 * _tmp122 + _tmp124 * _tmp127 + _tmp134 * fh1 +
      Scalar(1.0) * _tmp139 * (-_tmp135 * _tmp59 - _tmp138 * _tmp87 + Scalar(1.0)) + _tmp144 * fh1;
  const Scalar _tmp146 = _tmp106 * _tmp77 * _tmp97;
  const Scalar _tmp147 = _tmp143 * _tmp71 * (_tmp141 * _tmp95 - _tmp146 * _tmp65);
  const Scalar _tmp148 = _tmp76 * (-_tmp109 * _tmp97 + Scalar(1.0));
  const Scalar _tmp149 = _tmp115 * _tmp71 * (_tmp109 * _tmp95 + _tmp148 * _tmp65);
  const Scalar _tmp150 = _tmp76 * (-_tmp132 * _tmp97 - _tmp75);
  const Scalar _tmp151 = _tmp123 * _tmp71 * (_tmp132 * _tmp95 + _tmp150 * _tmp65 + Scalar(1.0));
  const Scalar _tmp152 = -_tmp139 * _tmp71 * (-_tmp136 * _tmp65 * _tmp98 + _tmp136 * _tmp95) -
  ...
  const Scalar _tmp158 = -_tmp147 - _tmp149 - _tmp151;
  const Scalar _tmp159 = _tmp157 * _tmp158;
  const Scalar _tmp160 = _tmp117 * _tmp123;
  const Scalar _tmp161 = _tmp115 * _tmp117;
  const Scalar _tmp162 = (-_tmp145 * _tmp159 + _tmp153 * (_tmp116 - _tmp122 * _tmp161 +
                                                          _tmp127 * _tmp160 + _tmp134 + _tmp144)) /
  ...
  const Scalar _tmp167 = _tmp120 * _tmp53;
  const Scalar _tmp168 = _tmp142 * _tmp143 * _tmp53;
  const Scalar _tmp169 = _tmp111 * _tmp115 * _tmp53;
  const Scalar _tmp170 = _tmp123 * _tmp133 * _tmp53;
  const Scalar _tmp171 = _tmp124 * _tmp59;
  const Scalar _tmp172 = _tmp119 * _tmp167 - _tmp125 * _tmp171 + _tmp138 * _tmp139 * _tmp53 +
                         _tmp168 * fh1 + _tmp169 * fh1 + _tmp170 * fh1;
  const Scalar _tmp173 = _tmp143 * _tmp146;
  const Scalar _tmp174 = _tmp115 * _tmp148;
  const Scalar _tmp175 = _tmp123 * _tmp150;
  const Scalar _tmp176 = _tmp136 * _tmp139;
  const Scalar _tmp177 = -_tmp173 * fh1 + _tmp174 * fh1 + _tmp175 * fh1 - _tmp176 * _tmp98;
  ...
  const Scalar _tmp182 = -_tmp173 + _tmp174 + _tmp175;
  const Scalar _tmp183 = _tmp181 * _tmp182;
  const Scalar _tmp184 = (-_tmp172 * _tmp183 + _tmp178 * (-_tmp126 * _tmp160 - _tmp161 * _tmp167 +
  ...
  const Scalar _tmp190 = _tmp123 * _tmp131 * _tmp58;
  const Scalar _tmp191 = _tmp108 * _tmp115 * _tmp58;
  const Scalar _tmp192 = _tmp140 * _tmp143;
  const Scalar _tmp193 = -_tmp119 * _tmp121 + _tmp137 * _tmp139 + _tmp171 - _tmp190 * fh1 -
                         _tmp191 * fh1 - _tmp192 * fh1;
  const Scalar _tmp194 = _tmp109 * _tmp115;
  const Scalar _tmp195 = _tmp141 * _tmp143;
  const Scalar _tmp196 = _tmp123 * _tmp132;
  const Scalar _tmp197 = _tmp176 + _tmp194 * fh1 + _tmp195 * fh1 + _tmp196 * fh1;
  ...
  const Scalar _tmp204 = (-_tmp193 * _tmp203 + _tmp198 * (_tmp121 * _tmp161 + _tmp160 * _tmp59 -
  ...
  _res(1, 0) = _tmp155 * (-Scalar(1.0) * _tmp162 * std::cosh(_tmp166) -
