...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1WrtFv1Nl1(
  ...
  const Scalar _tmp39 = _tmp24 + _tmp29 + _tmp30;
  const Scalar _tmp40 = Scalar(1.0) * _tmp39;
  const Scalar _tmp41 = -_tmp40;
  const Scalar _tmp42 = _tmp23 + _tmp30;
  ...
  const Scalar _tmp47 = _tmp37 + _tmp8;
  ...
  const Scalar _tmp52 = _tmp45 + p_init1;
  const Scalar _tmp53 = _tmp52 + Scalar(-4.8333311099999996);
  const Scalar _tmp54 = _tmp47 + p_init0;
  ...
  const Scalar _tmp59 = _tmp35 + p_init0;
  ...
  const Scalar _tmp67 = _tmp66 * (_tmp35 * _tmp62 * _tmp64 - _tmp39 * _tmp60 * _tmp64);
  const Scalar _tmp68 = _tmp45 * _tmp58 - _tmp47 * _tmp57 + _tmp58 * _tmp67;
  const Scalar _tmp69 = _tmp62 * _tmp65;
  const Scalar _tmp70 = Scalar(1.0) / (-_tmp57 + _tmp58 * _tmp69);
  const Scalar _tmp71 = _tmp69 * _tmp70;
  const Scalar _tmp72 = Scalar(0.20999999999999999) * _tmp10 - Scalar(0.20999999999999999) * _tmp12;
  const Scalar _tmp73 =
  ...
  const Scalar _tmp79 = _tmp73 + _tmp74;
  const Scalar _tmp80 = _tmp78 + _tmp79;
  const Scalar _tmp81 = _tmp57 * _tmp80 - _tmp58 * _tmp77;
  const Scalar _tmp82 = _tmp71 * _tmp81 + _tmp77;
  const Scalar _tmp83 = _tmp58 * _tmp76 - _tmp58 * _tmp80;
  const Scalar _tmp84 = -_tmp48 * _tmp82 + _tmp71 * _tmp83 - _tmp76;
  const Scalar _tmp85 = _tmp72 + _tmp79;
  const Scalar _tmp86 = _tmp43 + p_init1;
  const Scalar _tmp87 = _tmp86 + Scalar(-4.7752063900000001);
  const Scalar _tmp88 = _tmp38 + p_init0;
  ...
  const Scalar _tmp93 = _tmp69 * _tmp92 - _tmp91;
  const Scalar _tmp94 = _tmp70 * _tmp93;
  const Scalar _tmp95 = -_tmp77 * _tmp92 - _tmp81 * _tmp94 + _tmp85 * _tmp91;
  const Scalar _tmp96 = -_tmp48 * _tmp95 + _tmp76 * _tmp92 - _tmp83 * _tmp94 - _tmp85 * _tmp92;
  const Scalar _tmp97 = Scalar(1.0) / (_tmp96);
  const Scalar _tmp98 = -_tmp38 * _tmp91 + _tmp43 * _tmp92 + _tmp67 * _tmp92 - _tmp68 * _tmp94;
  ...
  const Scalar _tmp103 = _tmp97 * (_tmp102 + _tmp84);
  const Scalar _tmp104 = _tmp44 * _tmp50;
  const Scalar _tmp105 = _tmp102 * _tmp104 - _tmp103 * _tmp95 + _tmp82;
  const Scalar _tmp106 = Scalar(1.0) * _tmp46;
  ...
  const Scalar _tmp112 = fh1 * (_tmp75 + _tmp78);
  const Scalar _tmp113 = _tmp110 * _tmp112 + Scalar(3.29616) * _tmp13 + _tmp20 * fv1;
  const Scalar _tmp114 = _tmp44 * _tmp46;
  const Scalar _tmp115 = Scalar(1.0) * _tmp114 * _tmp51 - Scalar(1.0) * _tmp51;
  const Scalar _tmp116 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp117 = _tmp36 + _tmp40 * _tmp48;
  const Scalar _tmp118 = _tmp117 * _tmp50;
  const Scalar _tmp119 = 0;
  const Scalar _tmp120 = _tmp46 * (-_tmp118 * _tmp44 - _tmp119 * _tmp95 + _tmp41);
  const Scalar _tmp121 = -Scalar(1.0) * _tmp118 - Scalar(1.0) * _tmp120 + Scalar(1.0);
  const Scalar _tmp122 = _tmp107 * _tmp109;
  const Scalar _tmp123 = -_tmp112 * _tmp122 - Scalar(3.29616) * _tmp27 - _tmp32 * fv1;
  const Scalar _tmp124 = _tmp46 * (_tmp49 * _tmp51 + Scalar(1.0));
  const Scalar _tmp125 = _tmp48 * _tmp51;
  ...
  const Scalar _tmp129 = -_tmp127 * _tmp83 + _tmp128 * _tmp48;
  const Scalar _tmp130 = _tmp101 * (-_tmp127 * _tmp68 - _tmp129 * _tmp99);
  const Scalar _tmp131 = _tmp97 * (_tmp129 + _tmp130);
  const Scalar _tmp132 = _tmp104 * _tmp130 - _tmp128 - _tmp131 * _tmp95;
  const Scalar _tmp133 = _tmp122 * fh1;
  const Scalar _tmp134 = _tmp101 * _tmp51;
  const Scalar _tmp135 = Scalar(1.0) * _tmp100;
  const Scalar _tmp136 = _tmp134 * _tmp44 - _tmp135 * _tmp95;
  ...
  const Scalar _tmp138 = Scalar(1.0) * _tmp111 * (_tmp102 * _tmp51 - _tmp105 * _tmp106) +
                         ...
                         Scalar(1.0) * _tmp133 * (-_tmp106 * _tmp132 + _tmp130 * _tmp51) +
                         Scalar(1.0) * _tmp137 * (-_tmp106 * _tmp136 + _tmp134);
  const Scalar _tmp139 = -_tmp131 * _tmp93 + Scalar(1.0);
  const Scalar _tmp140 = _tmp58 * _tmp70;
  const Scalar _tmp141 = _tmp119 * _tmp94;
  const Scalar _tmp142 = _tmp66 * (_tmp119 * _tmp92 - _tmp141 * _tmp58);
  const Scalar _tmp143 = -_tmp103 * _tmp93 - _tmp69;
  const Scalar _tmp144 = -_tmp111 * _tmp66 * (_tmp103 * _tmp92 + _tmp140 * _tmp143 + Scalar(1.0)) -
                         _tmp116 * _tmp142 -
                         _tmp133 * _tmp66 * (_tmp131 * _tmp92 + _tmp139 * _tmp140) -
                         _tmp137 * _tmp66 * (-_tmp135 * _tmp58 * _tmp94 + _tmp135 * _tmp92);
  ...
  const Scalar _tmp155 = _tmp28 + _tmp42;
  const Scalar _tmp156 =
      (-_tmp138 * _tmp154 + _tmp145 * (_tmp115 * _tmp20 - _tmp121 + _tmp126 * _tmp155)) /
  ...
  const Scalar _tmp159 =
      _tmp111 * _tmp143 * _tmp70 + _tmp133 * _tmp139 * _tmp70 - _tmp157 * _tmp94 - _tmp158 * _tmp94;
  const Scalar _tmp160 = std::pow(_tmp159, Scalar(-2));
  const Scalar _tmp161 = _tmp141 * _tmp160;
  const Scalar _tmp162 = Scalar(1.0) / (_tmp159);
  const Scalar _tmp163 = _tmp113 * _tmp51;
  const Scalar _tmp164 = _tmp105 * _tmp111 * _tmp46 - _tmp114 * _tmp163 + _tmp116 * _tmp120 +
                         _tmp123 * _tmp124 + _tmp132 * _tmp133 * _tmp46 +
                         _tmp136 * _tmp137 * _tmp46;
  ...
  const Scalar _tmp168 = Scalar(9.6622558468725703) * _tmp119;
  const Scalar _tmp169 = _tmp168 * _tmp94;
  const Scalar _tmp170 = _tmp20 * _tmp51;
  const Scalar _tmp171 =
      (-_tmp161 * _tmp164 + _tmp162 * (-_tmp114 * _tmp170 - _tmp120 + _tmp124 * _tmp155)) /
  ...
  const Scalar _tmp175 = _tmp103 * _tmp111 + _tmp131 * _tmp133 + _tmp157 + _tmp158;
  const Scalar _tmp176 = Scalar(1.0) / (_tmp175);
  const Scalar _tmp177 = -_tmp102 * _tmp111 * _tmp50 + _tmp116 * _tmp118 - _tmp123 * _tmp125 -
  ...
  const Scalar _tmp181 = _tmp119 * _tmp180;
  const Scalar _tmp182 = (_tmp176 * (-_tmp118 - _tmp125 * _tmp155 + _tmp170) + _tmp177 * _tmp181) /
  ...
  _res(1, 0) =
      -_tmp148 *
          (-Scalar(0.87653584775870996) * _tmp154 + Scalar(1.0) * _tmp156 * std::sinh(_tmp147) -
           (-Scalar(0.1034955) * _tmp149 * _tmp154 +
            _tmp150 * (-_tmp146 * _tmp152 - _tmp148 * _tmp156)) *
               std::sinh(_tmp151)) -
      _tmp152 * (Scalar(0.87653584775870996) * _tmp145 + std::cosh(_tmp147) - std::cosh(_tmp151));
  _res(2, 0) =
      -_tmp166 *
          (-Scalar(0.86625939559540499) * _tmp161 + Scalar(1.0) * _tmp171 * std::sinh(_tmp174) -
           (-Scalar(0.1034955) * _tmp161 * _tmp167 +
            _tmp172 * (-_tmp165 * _tmp169 - _tmp166 * _tmp171)) *
               std::sinh(_tmp173)) -
      _tmp169 * (Scalar(0.86625939559540499) * _tmp162 - std::cosh(_tmp173) + std::cosh(_tmp174));
  _res(3, 0) =
      _tmp168 * (Scalar(0.86565325453551001) * _tmp176 + std::cosh(_tmp179) - std::cosh(_tmp186)) -
      _tmp183 *
          (Scalar(0.86565325453551001) * _tmp181 + Scalar(1.0) * _tmp182 * std::sinh(_tmp179) -
           (Scalar(0.1034955) * _tmp181 * _tmp185 +
            _tmp184 * (_tmp168 * _tmp178 - _tmp182 * _tmp183)) *
               std::sinh(_tmp186));
