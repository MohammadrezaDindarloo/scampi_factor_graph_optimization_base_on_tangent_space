...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl1(const Scalar fh1, const Scalar fv1,
  ...
  const Scalar _tmp91 = _tmp34 * _tmp67;
  const Scalar _tmp92 = _tmp46 * _tmp47;
  const Scalar _tmp93 = -_tmp35 + _tmp37 * _tmp92 - _tmp52 * (_tmp49 * _tmp92 + _tmp70);
  const Scalar _tmp94 = _tmp75 * (-_tmp57 + _tmp65 * _tmp92 - _tmp73 * _tmp93) + _tmp93;
  const Scalar _tmp95 = -_tmp46 - _tmp78 * _tmp94;
  const Scalar _tmp96 = _tmp84 * _tmp85;
  const Scalar _tmp97 = _tmp96 * fh1;
  const Scalar _tmp98 = Scalar(1.0) * _tmp74;
  const Scalar _tmp99 = fh1 * (-_tmp81 * _tmp96 + _tmp83 * _tmp86);
  ...
  _res(1, 0) = std::exp(_tmp56 * _tmp87 * (_tmp76 * _tmp77 + _tmp79 * _tmp80) +
                        _tmp56 * _tmp88 * (_tmp63 * _tmp90 - _tmp90 * _tmp91) +
                        _tmp56 * _tmp97 * (_tmp77 * _tmp94 + _tmp80 * _tmp95 + Scalar(1.0)) +
                        _tmp56 * _tmp99 * (_tmp63 * _tmp98 - _tmp91 * _tmp98));
  _res(2, 0) = std::exp(_tmp100 * _tmp67 + _tmp101 * _tmp67 - _tmp47 * _tmp79 * _tmp87 -
                        _tmp47 * _tmp95 * _tmp97);
  _res(3, 0) = std::exp(-_tmp100 - _tmp101 - _tmp72 * _tmp76 * _tmp87 - _tmp72 * _tmp94 * _tmp97);
