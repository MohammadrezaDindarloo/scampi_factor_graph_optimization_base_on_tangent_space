...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl1(
  ...
  const Scalar _tmp26 = Scalar(0.20999999999999999) * _tmp21 + Scalar(0.20999999999999999) * _tmp7;
  ...
  const Scalar _tmp35 = -_tmp13 + _tmp6 + _tmp9;
  ...
  const Scalar _tmp49 = _tmp15 * _tmp38 - _tmp36 * _tmp46;
  ...
  const Scalar _tmp53 = -_tmp37 * _tmp48 + _tmp48 * _tmp49 * _tmp52;
  const Scalar _tmp54 =
      std::sqrt(Scalar(std::pow(_tmp41, Scalar(2)) + std::pow(_tmp45, Scalar(2))));
  const Scalar _tmp55 = Scalar(1.0) / (_tmp54);
  const Scalar _tmp56 = _tmp42 * _tmp54;
  const Scalar _tmp57 = _tmp56 * (_tmp40 * _tmp45 * _tmp55 - _tmp41 * _tmp44 * _tmp55);
  const Scalar _tmp58 = _tmp26 + _tmp30;
  const Scalar _tmp59 = _tmp58 + p_init0 + Scalar(-2.71799795);
  const Scalar _tmp60 = _tmp18 + _tmp23;
  ...
  const Scalar _tmp65 = _tmp24 * _tmp34 - _tmp31 * _tmp38 + _tmp34 * _tmp57;
  const Scalar _tmp66 = _tmp46 * _tmp63 - _tmp64;
  const Scalar _tmp67 = _tmp47 * _tmp66;
  const Scalar _tmp68 = _tmp57 * _tmp63 - _tmp58 * _tmp64 + _tmp60 * _tmp63 - _tmp65 * _tmp67;
  const Scalar _tmp69 = _tmp14 + _tmp6;
  const Scalar _tmp70 = _tmp35 * _tmp46;
  const Scalar _tmp71 = _tmp35 * _tmp63 - _tmp37 * _tmp67 -
                        _tmp52 * (-_tmp49 * _tmp67 - _tmp63 * _tmp70 + _tmp64 * _tmp69) -
                        _tmp63 * _tmp69;
  ...
  const Scalar _tmp76 = _tmp53 + _tmp75 * (-_tmp48 * _tmp65 - _tmp53 * _tmp73);
  const Scalar _tmp77 = _tmp63 * _tmp72;
  const Scalar _tmp78 = _tmp66 * _tmp72;
  const Scalar _tmp79 = -_tmp76 * _tmp78 + Scalar(1.0);
  const Scalar _tmp80 = _tmp34 * _tmp47;
  const Scalar _tmp81 = _tmp19 + _tmp43;
  const Scalar _tmp82 = _tmp81 + p_init1 + Scalar(8.3196563700000006);
  const Scalar _tmp83 = _tmp27 + _tmp39;
  ...
  const Scalar _tmp87 = _tmp56 * fh1;
  ...
  const Scalar _tmp92 = _tmp56 * (-_tmp34 * _tmp91 + _tmp63 * _tmp90);
  const Scalar _tmp93 = _tmp46 * _tmp47;
  const Scalar _tmp94 = -_tmp35 + _tmp37 * _tmp93 - _tmp52 * (_tmp49 * _tmp93 + _tmp70);
  const Scalar _tmp95 = _tmp75 * (-_tmp57 + _tmp65 * _tmp93 - _tmp73 * _tmp94) + _tmp94;
  const Scalar _tmp96 = -_tmp46 - _tmp78 * _tmp95;
  ...
  const Scalar _tmp101 = _tmp47 * fh1;
  ...
  _res(0, 0) = 0;
  _res(1, 0) =
      -_tmp92 * std::exp(_tmp56 * _tmp99 * (-_tmp34 * _tmp67 * _tmp98 + _tmp63 * _tmp98) +
                         _tmp86 * _tmp87 * (_tmp76 * _tmp77 + _tmp79 * _tmp80) +
                         _tmp87 * _tmp97 * (_tmp77 * _tmp95 + _tmp80 * _tmp96 + Scalar(1.0)) +
                         _tmp88 * _tmp92);
  _res(2, 0) = -_tmp91 * std::exp(_tmp100 * _tmp67 - _tmp101 * _tmp79 * _tmp86 -
                                  _tmp101 * _tmp96 * _tmp97 + _tmp102 * _tmp67);
  _res(3, 0) =
      _tmp90 * std::exp(-_tmp100 - _tmp102 - _tmp103 * _tmp76 * _tmp86 - _tmp103 * _tmp95 * _tmp97);
