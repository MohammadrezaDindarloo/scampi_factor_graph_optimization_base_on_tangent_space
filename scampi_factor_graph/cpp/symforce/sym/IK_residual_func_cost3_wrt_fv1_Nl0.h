...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl0(
  ...
  const Scalar _tmp33 = _tmp15 + _tmp7;
  ...
  const Scalar _tmp42 = _tmp41 * (_tmp31 * _tmp39 - _tmp33 * _tmp40 + _tmp36 * _tmp39);
  const Scalar _tmp43 = Scalar(0.20999999999999999) * _tmp19 + Scalar(0.20999999999999999) * _tmp20;
  const Scalar _tmp44 = -Scalar(0.010999999999999999) * _tmp22 -
  ...
  const Scalar _tmp50 = -_tmp39 * _tmp48 + _tmp40 * _tmp49;
  const Scalar _tmp51 = _tmp41 * _tmp50;
  const Scalar _tmp52 = Scalar(1.0) * _tmp25;
  const Scalar _tmp53 = Scalar(1.0) * _tmp16;
  const Scalar _tmp54 = (-_tmp33 + _tmp53) / (_tmp36 - _tmp52);
  const Scalar _tmp55 = _tmp39 * _tmp47 - _tmp39 * _tmp49;
  const Scalar _tmp56 = _tmp41 * _tmp55;
  const Scalar _tmp57 = _tmp32 * _tmp56 - _tmp47 - _tmp54 * (_tmp32 * _tmp51 + _tmp48);
  ...
  const Scalar _tmp67 = _tmp32 * _tmp66 - _tmp65;
  const Scalar _tmp68 = _tmp41 * _tmp67;
  const Scalar _tmp69 = _tmp47 * _tmp66;
  const Scalar _tmp70 = _tmp43 + _tmp44 - _tmp45;
  const Scalar _tmp71 = -_tmp54 * (-_tmp32 * _tmp69 - _tmp50 * _tmp68 + _tmp65 * _tmp70) -
                        _tmp55 * _tmp68 - _tmp66 * _tmp70 + _tmp69;
  const Scalar _tmp72 = Scalar(1.0) / (_tmp71);
  const Scalar _tmp73 = _tmp31 * _tmp66 - _tmp42 * _tmp67 + _tmp59 * _tmp66 - _tmp62 * _tmp65;
  const Scalar _tmp74 = _tmp72 * _tmp73;
  const Scalar _tmp75 = Scalar(1.0) / (_tmp73);
  const Scalar _tmp76 = _tmp71 * _tmp75;
  const Scalar _tmp77 = _tmp57 + _tmp76 * (-_tmp31 + _tmp32 * _tmp42 - _tmp57 * _tmp74);
  const Scalar _tmp78 = _tmp67 * _tmp72;
  const Scalar _tmp79 = -_tmp32 - _tmp77 * _tmp78;
  const Scalar _tmp80 = _tmp39 * _tmp41;
  const Scalar _tmp81 = _tmp66 * _tmp72;
  const Scalar _tmp82 = _tmp24 + _tmp58;
  const Scalar _tmp83 = _tmp82 + p_init1 + Scalar(8.3196563700000006);
  const Scalar _tmp84 = _tmp61 + _tmp8;
  const Scalar _tmp85 = _tmp84 + p_init0 + Scalar(1.9874742000000001);
  ...
  const Scalar _tmp94 = _tmp30 * (_tmp66 * _tmp92 - _tmp80 * _tmp93);
  const Scalar _tmp95 = Scalar(1.0) * _tmp51 * _tmp54 - Scalar(1.0) * _tmp56;
  const Scalar _tmp96 = _tmp76 * (-Scalar(1.0) * _tmp42 - _tmp74 * _tmp95) + _tmp95;
  const Scalar _tmp97 = -_tmp78 * _tmp96 + Scalar(1.0);
  const Scalar _tmp98 = _tmp83 * _tmp86;
  const Scalar _tmp99 = Scalar(1.0) * _tmp75;
  const Scalar _tmp100 = fh1 * (-_tmp82 * _tmp87 + _tmp84 * _tmp98);
  ...
  _res(0, 0) = 0;
  _res(1, 0) =
      -_tmp94 * std::exp(_tmp100 * _tmp30 * (-_tmp39 * _tmp68 * _tmp99 + _tmp66 * _tmp99) +
                         _tmp87 * _tmp88 * (_tmp77 * _tmp81 + _tmp79 * _tmp80 + Scalar(1.0)) +
                         _tmp88 * _tmp98 * (_tmp80 * _tmp97 + _tmp81 * _tmp96) + _tmp89 * _tmp94);
  _res(2, 0) = -_tmp103 * std::exp(_tmp101 * _tmp68 - _tmp102 * _tmp79 * _tmp87 -
                                   _tmp102 * _tmp97 * _tmp98 + _tmp103 * _tmp89);
  _res(3, 0) = _tmp92 * std::exp(-_tmp101 - _tmp104 * _tmp77 * _tmp87 - _tmp104 * _tmp96 * _tmp98 -
                                 _tmp89 * _tmp92);
