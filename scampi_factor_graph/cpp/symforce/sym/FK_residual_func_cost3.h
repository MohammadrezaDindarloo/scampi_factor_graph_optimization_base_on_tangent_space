...
Eigen::Matrix<Scalar, 4, 1> FkResidualFuncCost3(
  ...
  const Scalar _tmp62 = _tmp58 + position_vector(0, 0) + Scalar(1.79662371);
  ...
  const Scalar _tmp68 = _tmp38 * _tmp65 - _tmp40 * _tmp67 - _tmp58 * _tmp64 + _tmp60 * _tmp65;
  const Scalar _tmp69 = -_tmp45 + _tmp49;
  const Scalar _tmp70 = _tmp47 * _tmp65 -
                        _tmp54 * (-_tmp48 * _tmp65 - _tmp51 * _tmp67 + _tmp64 * _tmp69) -
                        _tmp55 * _tmp67 - _tmp65 * _tmp69;
  ...
  const Scalar _tmp95 = _tmp27 * _tmp67;
  const Scalar _tmp96 = Scalar(1.0) * _tmp73;
  const Scalar _tmp97 = fh1 * (-_tmp80 * _tmp91 + _tmp82 * _tmp85);
  const Scalar _tmp98 = _tmp42 * fh1;
  ...
  _res(1, 0) = std::exp(_tmp37 * _tmp92 * (_tmp65 * _tmp94 - _tmp94 * _tmp95) +
                        _tmp37 * _tmp97 * (_tmp65 * _tmp96 - _tmp95 * _tmp96) +
                        _tmp85 * _tmp86 * (_tmp75 * _tmp76 + _tmp78 * _tmp79) +
                        _tmp86 * _tmp91 * (_tmp76 * _tmp89 + _tmp79 * _tmp90 + Scalar(1.0)));
  _res(2, 0) = std::exp(_tmp100 * _tmp67 + _tmp67 * _tmp99 - _tmp78 * _tmp85 * _tmp98 -
                        _tmp90 * _tmp91 * _tmp98);
  _res(3, 0) = std::exp(-_tmp100 - _tmp101 * _tmp75 * _tmp85 - _tmp101 * _tmp89 * _tmp91 - _tmp99);
