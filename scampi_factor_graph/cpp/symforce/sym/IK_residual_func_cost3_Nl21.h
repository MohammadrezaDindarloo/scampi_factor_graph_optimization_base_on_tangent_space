...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl21(
  ...
  const Scalar _tmp58 = _tmp20 + _tmp40;
  const Scalar _tmp59 = _tmp15 + _tmp4;
  const Scalar _tmp60 = _tmp59 + p_init1 + Scalar(-4.8333311099999996);
  const Scalar _tmp61 = _tmp58 + p_init0 + Scalar(1.79662371);
  ...
  const Scalar _tmp73 = -_tmp46 * _tmp71 + _tmp47 * _tmp72;
  const Scalar _tmp74 = _tmp50 * _tmp52;
  ...
  const Scalar _tmp78 = _tmp46 * _tmp70 - _tmp46 * _tmp72;
  const Scalar _tmp79 = -_tmp70 + _tmp74 * _tmp78 - _tmp77 * (_tmp71 + _tmp73 * _tmp74);
  const Scalar _tmp80 = -_tmp66 + _tmp69;
  const Scalar _tmp81 = _tmp29 * _tmp70 - _tmp29 * _tmp80 - _tmp53 * _tmp78 -
                        _tmp77 * (-_tmp29 * _tmp71 + _tmp49 * _tmp80 - _tmp53 * _tmp73);
  const Scalar _tmp82 = Scalar(1.0) / (_tmp81);
  const Scalar _tmp83 = _tmp54 * _tmp82;
  const Scalar _tmp84 = _tmp55 * _tmp81;
  const Scalar _tmp85 = _tmp79 + _tmp84 * (-_tmp39 + _tmp48 * _tmp74 - _tmp79 * _tmp83);
  const Scalar _tmp86 = _tmp51 * _tmp82;
  const Scalar _tmp87 = -_tmp50 - _tmp85 * _tmp86;
  const Scalar _tmp88 = _tmp46 * _tmp52;
  const Scalar _tmp89 = _tmp29 * _tmp82;
  const Scalar _tmp90 = _tmp64 * fh1;
  const Scalar _tmp91 = Scalar(1.0) * _tmp52;
  const Scalar _tmp92 = _tmp73 * _tmp77 * _tmp91 - _tmp78 * _tmp91;
  ...
  const Scalar _tmp99 = _tmp56 * _tmp65;
  ...
  _res(1, 0) = std::exp(_tmp38 * _tmp65 * (_tmp29 * _tmp56 - _tmp56 * _tmp57) +
                        _tmp38 * _tmp90 * (_tmp85 * _tmp89 + _tmp87 * _tmp88 + Scalar(1.0)) +
                        _tmp38 * _tmp95 * (_tmp88 * _tmp94 + _tmp89 * _tmp93) +
                        _tmp38 * _tmp96 * (_tmp29 * _tmp98 - _tmp57 * _tmp98));
  _res(2, 0) = std::exp(_tmp100 * _tmp53 - _tmp52 * _tmp87 * _tmp90 - _tmp52 * _tmp94 * _tmp95 +
                        _tmp53 * _tmp99);
  _res(3, 0) = std::exp(-_tmp100 - _tmp82 * _tmp85 * _tmp90 - _tmp82 * _tmp93 * _tmp95 - _tmp99);
