...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl21(
  ...
  const Scalar _tmp31 = _tmp30 + p_init0 + Scalar(-2.5202214700000001);
  ...
  const Scalar _tmp43 = _tmp32 + _tmp4;
  ...
  const Scalar _tmp48 = _tmp39 * _tmp46 - _tmp41 * _tmp47 + _tmp43 * _tmp46;
  const Scalar _tmp49 = _tmp17 * _tmp28;
  const Scalar _tmp50 = _tmp34 * _tmp37;
  const Scalar _tmp51 = _tmp29 * _tmp50 - _tmp49;
  const Scalar _tmp52 = Scalar(1.0) / (_tmp46 * _tmp50 - _tmp47);
  const Scalar _tmp53 = _tmp51 * _tmp52;
  const Scalar _tmp54 = _tmp16 * _tmp29 - _tmp26 * _tmp49 + _tmp29 * _tmp39 - _tmp48 * _tmp53;
  const Scalar _tmp55 = Scalar(1.0) / (_tmp54);
  const Scalar _tmp56 = Scalar(1.0) * _tmp55;
  const Scalar _tmp57 = _tmp20 + _tmp40;
  const Scalar _tmp58 = _tmp15 + _tmp4;
  ...
  const Scalar _tmp72 = -_tmp46 * _tmp70 + _tmp47 * _tmp71;
  const Scalar _tmp73 = _tmp50 * _tmp52;
  const Scalar _tmp74 = Scalar(1.0) * _tmp33;
  const Scalar _tmp75 = Scalar(1.0) * _tmp30;
  const Scalar _tmp76 = (-_tmp41 + _tmp75) / (_tmp43 - _tmp74);
  const Scalar _tmp77 = _tmp46 * _tmp69 - _tmp46 * _tmp71;
  const Scalar _tmp78 = -_tmp69 + _tmp73 * _tmp77 - _tmp76 * (_tmp70 + _tmp72 * _tmp73);
  const Scalar _tmp79 = -_tmp65 + _tmp68;
  const Scalar _tmp80 = _tmp29 * _tmp69 - _tmp29 * _tmp79 - _tmp53 * _tmp77 -
                        _tmp76 * (-_tmp29 * _tmp70 + _tmp49 * _tmp79 - _tmp53 * _tmp72);
  const Scalar _tmp81 = Scalar(1.0) / (_tmp80);
  const Scalar _tmp82 = _tmp54 * _tmp81;
  const Scalar _tmp83 = _tmp55 * _tmp80;
  const Scalar _tmp84 = _tmp78 + _tmp83 * (-_tmp39 + _tmp48 * _tmp73 - _tmp78 * _tmp82);
  const Scalar _tmp85 = _tmp51 * _tmp81;
  const Scalar _tmp86 = -_tmp50 - _tmp84 * _tmp85;
  const Scalar _tmp87 = _tmp46 * _tmp52;
  const Scalar _tmp88 = _tmp29 * _tmp81;
  const Scalar _tmp89 = _tmp38 * fh1;
  const Scalar _tmp90 = Scalar(1.0) * _tmp52;
  const Scalar _tmp91 = _tmp72 * _tmp76 * _tmp90 - _tmp77 * _tmp90;
  const Scalar _tmp92 = _tmp83 * (-_tmp48 * _tmp90 - _tmp82 * _tmp91) + _tmp91;
  const Scalar _tmp93 = -_tmp85 * _tmp92 + Scalar(1.0);
  const Scalar _tmp94 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp95 = _tmp74 * _tmp76 + _tmp75;
  const Scalar _tmp96 = 0;
  const Scalar _tmp97 = _tmp53 * _tmp96;
  const Scalar _tmp98 = _tmp38 * (_tmp29 * _tmp96 - _tmp46 * _tmp97);
  ...
  _res(0, 0) = 0;
  _res(1, 0) =
      -_tmp98 * std::exp(_tmp38 * _tmp64 * (_tmp29 * _tmp56 - _tmp46 * _tmp53 * _tmp56) +
                         _tmp62 * _tmp89 * (_tmp87 * _tmp93 + _tmp88 * _tmp92) +
                         _tmp63 * _tmp89 * (_tmp84 * _tmp88 + _tmp86 * _tmp87 + Scalar(1.0)) +
                         _tmp94 * _tmp98);
  _res(2, 0) = -_tmp97 * std::exp(_tmp100 * _tmp53 + _tmp101 * _tmp53 - _tmp62 * _tmp93 * _tmp99 -
                                  _tmp63 * _tmp86 * _tmp99);
  _res(3, 0) =
      _tmp96 * std::exp(-_tmp100 - _tmp101 - _tmp102 * _tmp62 * _tmp92 - _tmp102 * _tmp63 * _tmp84);
