...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl12(
  ...
  const Scalar _tmp17 = _tmp13 + _tmp16 + _tmp5;
  ...
  const Scalar _tmp28 = Scalar(0.20999999999999999) * _tmp2 + Scalar(0.20999999999999999) * _tmp22 +
  ...
  const Scalar _tmp46 = -_tmp16 + _tmp5;
  ...
  const Scalar _tmp54 = _tmp21 + _tmp23;
  ...
  const Scalar _tmp62 = -_tmp45 * _tmp61 + _tmp50 * _tmp59;
  const Scalar _tmp63 = _tmp36 * _tmp45 - _tmp49;
  const Scalar _tmp64 = Scalar(1.0) / (_tmp45 * _tmp60 - _tmp59);
  ...
  const Scalar _tmp69 = -_tmp50 * _tmp60 + _tmp61;
  const Scalar _tmp70 = -_tmp17 * _tmp36 + _tmp48 - _tmp65 * _tmp69 -
                        _tmp68 * (_tmp17 * _tmp49 - _tmp45 * _tmp48 - _tmp62 * _tmp65);
  ...
  const Scalar _tmp77 = _tmp76 * (_tmp36 * _tmp73 - _tmp60 * _tmp74);
  const Scalar _tmp78 = Scalar(1.0) / (_tmp75);
  const Scalar _tmp79 = _tmp76 * (-_tmp38 * _tmp43 * _tmp78 + _tmp40 * _tmp42 * _tmp78);
  const Scalar _tmp80 = _tmp52 * _tmp60 - _tmp55 * _tmp59 + _tmp60 * _tmp79;
  const Scalar _tmp81 = -_tmp25 * _tmp49 + _tmp32 * _tmp36 + _tmp36 * _tmp79 - _tmp65 * _tmp80;
  const Scalar _tmp82 = Scalar(1.0) / (_tmp81);
  const Scalar _tmp83 = Scalar(1.0) * _tmp82;
  const Scalar _tmp84 = _tmp28 + _tmp51;
  ...
  const Scalar _tmp92 = Scalar(1.0) * _tmp64;
  const Scalar _tmp93 = _tmp62 * _tmp68 * _tmp92 - _tmp69 * _tmp92;
  const Scalar _tmp94 = _tmp71 * _tmp81;
  const Scalar _tmp95 = _tmp70 * _tmp82;
  const Scalar _tmp96 = _tmp93 + _tmp95 * (-_tmp80 * _tmp92 - _tmp93 * _tmp94);
  const Scalar _tmp97 = _tmp63 * _tmp71;
  const Scalar _tmp98 = -_tmp96 * _tmp97 + Scalar(1.0);
  const Scalar _tmp99 = _tmp60 * _tmp64;
  const Scalar _tmp100 = _tmp36 * _tmp71;
  const Scalar _tmp101 = _tmp76 * fh1;
  const Scalar _tmp102 = _tmp45 * _tmp64;
  const Scalar _tmp103 = _tmp102 * _tmp69 - _tmp47 - _tmp68 * (_tmp102 * _tmp62 + _tmp45 * _tmp47);
  const Scalar _tmp104 = _tmp103 + _tmp95 * (_tmp102 * _tmp80 - _tmp103 * _tmp94 - _tmp79);
  const Scalar _tmp105 = -_tmp104 * _tmp97 - _tmp45;
  const Scalar _tmp106 = _tmp64 * fh1;
  const Scalar _tmp107 = _tmp83 * _tmp91;
  const Scalar _tmp108 = _tmp0 * _tmp73;
  const Scalar _tmp109 = _tmp71 * fh1;
  ...
  _res(0, 0) = 0;
  _res(1, 0) =
      -_tmp77 * std::exp(_tmp0 * _tmp77 +
                         _tmp101 * _tmp89 * (_tmp100 * _tmp104 + _tmp105 * _tmp99 + Scalar(1.0)) +
                         _tmp101 * _tmp90 * (_tmp100 * _tmp96 + _tmp98 * _tmp99) +
                         _tmp76 * _tmp91 * (_tmp36 * _tmp83 - _tmp60 * _tmp65 * _tmp83));
  _res(2, 0) = -_tmp74 * std::exp(-_tmp105 * _tmp106 * _tmp89 - _tmp106 * _tmp90 * _tmp98 +
                                  _tmp107 * _tmp65 + _tmp108 * _tmp65);
  _res(3, 0) = _tmp73 * std::exp(-_tmp104 * _tmp109 * _tmp89 - _tmp107 - _tmp108 -
                                 _tmp109 * _tmp90 * _tmp96);
