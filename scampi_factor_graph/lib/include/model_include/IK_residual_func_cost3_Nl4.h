...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl4(const Scalar fh1, const Scalar fv1,
  ...
  const Scalar _tmp31 = _tmp27 * _tmp29;
  const Scalar _tmp32 = _tmp31 * (-_tmp16 * _tmp26 * _tmp30 + _tmp17 * _tmp25 * _tmp30);
  ...
  const Scalar _tmp43 = _tmp32 * _tmp41 - _tmp35 * _tmp42 + _tmp38 * _tmp41;
  const Scalar _tmp44 = Scalar(1.0) / (_tmp28 * _tmp41 - _tmp42);
  ...
  const Scalar _tmp50 = _tmp46 + _tmp47;
  const Scalar _tmp51 = -_tmp48 + _tmp50;
  const Scalar _tmp52 = _tmp41 * _tmp49 - _tmp41 * _tmp51;
  const Scalar _tmp53 = _tmp28 * _tmp49;
  const Scalar _tmp54 = -_tmp41 * _tmp53 + _tmp42 * _tmp51;
  const Scalar _tmp55 = Scalar(1.0) * _tmp16;
  const Scalar _tmp56 = Scalar(1.0) * _tmp25;
  const Scalar _tmp57 = (-_tmp35 + _tmp56) / (_tmp38 - _tmp55);
  const Scalar _tmp58 = _tmp45 * _tmp52 - _tmp49 - _tmp57 * (_tmp45 * _tmp54 + _tmp53);
  const Scalar _tmp59 = _tmp48 + _tmp50;
  const Scalar _tmp60 = _tmp18 + _tmp34;
  const Scalar _tmp61 = _tmp60 + p_init0 + Scalar(-2.71799795);
  const Scalar _tmp62 = _tmp15 + _tmp6;
  ...
  const Scalar _tmp67 = _tmp28 * _tmp65 - _tmp66;
  const Scalar _tmp68 = _tmp44 * _tmp67;
  const Scalar _tmp69 = _tmp49 * _tmp65 - _tmp52 * _tmp68 -
                        _tmp57 * (-_tmp53 * _tmp65 - _tmp54 * _tmp68 + _tmp59 * _tmp66) -
                        _tmp59 * _tmp65;
  const Scalar _tmp70 = Scalar(1.0) / (_tmp69);
  const Scalar _tmp71 = _tmp32 * _tmp65 - _tmp43 * _tmp68 - _tmp60 * _tmp66 + _tmp62 * _tmp65;
  const Scalar _tmp72 = _tmp70 * _tmp71;
  const Scalar _tmp73 = Scalar(1.0) / (_tmp71);
  const Scalar _tmp74 = _tmp69 * _tmp73;
  const Scalar _tmp75 = _tmp58 + _tmp74 * (-_tmp32 + _tmp43 * _tmp45 - _tmp58 * _tmp72);
  const Scalar _tmp76 = _tmp67 * _tmp70;
  const Scalar _tmp77 = -_tmp28 - _tmp75 * _tmp76;
  const Scalar _tmp78 = _tmp41 * _tmp44;
  const Scalar _tmp79 = _tmp65 * _tmp70;
  const Scalar _tmp80 = _tmp37 + _tmp7;
  ...
  const Scalar _tmp93 = _tmp67 * _tmp73 * _tmp92;
  const Scalar _tmp94 = Scalar(1.0) * _tmp73;
  const Scalar _tmp95 = _tmp81 * _tmp84;
  const Scalar _tmp96 = fh1 * (-_tmp80 * _tmp85 + _tmp82 * _tmp95);
  const Scalar _tmp97 = -_tmp52 * _tmp92 + _tmp54 * _tmp57 * _tmp92;
  const Scalar _tmp98 = _tmp74 * (-_tmp43 * _tmp92 - _tmp72 * _tmp97) + _tmp97;
  const Scalar _tmp99 = -_tmp76 * _tmp98 + Scalar(1.0);
  ...
  _res(1, 0) = std::exp(_tmp100 * _tmp31 * (_tmp78 * _tmp99 + _tmp79 * _tmp98) +
                        _tmp31 * _tmp86 * (_tmp75 * _tmp79 + _tmp77 * _tmp78 + Scalar(1.0)) +
                        _tmp31 * _tmp87 * (_tmp65 * _tmp90 - _tmp78 * _tmp91) +
                        _tmp31 * _tmp96 * (-_tmp41 * _tmp93 + _tmp65 * _tmp94));
  _res(2, 0) = std::exp(-_tmp100 * _tmp44 * _tmp99 - _tmp44 * _tmp77 * _tmp86 +
                        _tmp44 * _tmp87 * _tmp91 + _tmp93 * _tmp96);
  _res(3, 0) = std::exp(-_tmp100 * _tmp70 * _tmp98 - _tmp70 * _tmp75 * _tmp86 - _tmp87 * _tmp90 -
                        _tmp94 * _tmp96);
