...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl14(
  ...
  const Scalar _tmp40 = _tmp18 * _tmp30;
  ...
  const Scalar _tmp44 = _tmp35 * _tmp42;
  const Scalar _tmp45 = _tmp44 * (_tmp32 * _tmp38 * _tmp43 - _tmp34 * _tmp37 * _tmp43);
  const Scalar _tmp46 = _tmp16 * _tmp31 - _tmp27 * _tmp40 + _tmp31 * _tmp45;
  ...
  const Scalar _tmp56 = -_tmp39 * _tmp55 + _tmp40 * _tmp53;
  const Scalar _tmp57 = Scalar(1.0) * _tmp37;
  const Scalar _tmp58 = Scalar(1.0) * _tmp32;
  const Scalar _tmp59 = (-_tmp27 + _tmp58) / (_tmp16 - _tmp57);
  const Scalar _tmp60 = -_tmp31 * _tmp53 + _tmp55;
  const Scalar _tmp61 = _tmp47 * _tmp56 * _tmp59 - _tmp47 * _tmp60;
  const Scalar _tmp62 = _tmp48 + _tmp52;
  const Scalar _tmp63 = _tmp24 + _tmp25;
  ...
  const Scalar _tmp73 = _tmp39 * _tmp70 - _tmp72;
  const Scalar _tmp74 = _tmp41 * _tmp73;
  const Scalar _tmp75 = -_tmp59 * (-_tmp39 * _tmp71 - _tmp56 * _tmp74 + _tmp62 * _tmp72) -
                        _tmp60 * _tmp74 - _tmp62 * _tmp70 + _tmp71;
  const Scalar _tmp76 = Scalar(1.0) / (_tmp75);
  const Scalar _tmp77 = _tmp45 * _tmp70 - _tmp46 * _tmp74 - _tmp64 * _tmp72 + _tmp66 * _tmp70;
  const Scalar _tmp78 = _tmp76 * _tmp77;
  const Scalar _tmp79 = Scalar(1.0) / (_tmp77);
  const Scalar _tmp80 = _tmp75 * _tmp79;
  const Scalar _tmp81 = _tmp61 + _tmp80 * (-_tmp46 * _tmp47 - _tmp61 * _tmp78);
  const Scalar _tmp82 = _tmp73 * _tmp76;
  const Scalar _tmp83 = _tmp41 * (-_tmp81 * _tmp82 + Scalar(1.0));
  const Scalar _tmp84 = _tmp76 * _tmp81;
  const Scalar _tmp85 = _tmp36 + _tmp4;
  const Scalar _tmp86 = _tmp67 + _tmp85;
  const Scalar _tmp87 = _tmp20 + _tmp63;
  ...
  const Scalar _tmp91 = _tmp44 * _tmp90 * (_tmp31 * _tmp83 + _tmp70 * _tmp84);
  const Scalar _tmp92 = _tmp88 * _tmp89;
  const Scalar _tmp93 = -_tmp85 * _tmp92 + _tmp87 * _tmp90;
  const Scalar _tmp94 = Scalar(1.0) * _tmp79;
  const Scalar _tmp95 = _tmp47 * _tmp73 * _tmp79;
  const Scalar _tmp96 = _tmp44 * _tmp93 * (-_tmp31 * _tmp95 + _tmp70 * _tmp94);
  const Scalar _tmp97 = _tmp39 * _tmp41;
  const Scalar _tmp98 = -_tmp54 - _tmp59 * (_tmp39 * _tmp54 + _tmp56 * _tmp97) + _tmp60 * _tmp97;
  const Scalar _tmp99 = _tmp80 * (-_tmp45 + _tmp46 * _tmp97 - _tmp78 * _tmp98) + _tmp98;
  const Scalar _tmp100 = _tmp41 * (-_tmp39 - _tmp82 * _tmp99);
  const Scalar _tmp101 = _tmp76 * _tmp99;
  const Scalar _tmp102 = _tmp44 * _tmp92 * (_tmp100 * _tmp31 + _tmp101 * _tmp70 + Scalar(1.0));
  const Scalar _tmp103 = Scalar(333.54000000000002) - fv1;
  const Scalar _tmp104 = _tmp57 * _tmp59 + _tmp58;
  ...
  const Scalar _tmp109 = _tmp83 * _tmp90;
  const Scalar _tmp110 = _tmp84 * _tmp90;
  const Scalar _tmp111 = _tmp101 * _tmp92;
  const Scalar _tmp112 = _tmp93 * _tmp94;
  ...
  _res(1, 0) =
      -(-_tmp102 - _tmp91 - _tmp96) *
      std::exp(_tmp102 * fh1 + _tmp103 * _tmp44 * (-_tmp105 * _tmp31 * _tmp74 + _tmp105 * _tmp70) +
               _tmp91 * fh1 + _tmp96 * fh1);
  _res(2, 0) = -(-_tmp106 + _tmp107 + _tmp109) *
               std::exp(_tmp106 * fh1 - _tmp107 * fh1 + _tmp108 * _tmp74 - _tmp109 * fh1);
  _res(3, 0) = -(_tmp110 + _tmp111 + _tmp112) *
               std::exp(-_tmp108 - _tmp110 * fh1 - _tmp111 * fh1 - _tmp112 * fh1);
