...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl18(
  ...
  const Scalar _tmp87 = _tmp40 * (_tmp27 * _tmp86 - _tmp56 * _tmp85);
  const Scalar _tmp88 = _tmp42 * _tmp78 - _tmp68 * (_tmp42 * _tmp76 + _tmp42 * _tmp81) - _tmp76;
  const Scalar _tmp89 = _tmp53 * _tmp83;
  const Scalar _tmp90 = _tmp54 * _tmp82;
  const Scalar _tmp91 = _tmp88 + _tmp90 * (-_tmp41 + _tmp42 * _tmp52 - _tmp88 * _tmp89);
  const Scalar _tmp92 = -_tmp42 - _tmp84 * _tmp91;
  const Scalar _tmp93 = _tmp27 * _tmp83;
  const Scalar _tmp94 = _tmp63 * fh1;
  const Scalar _tmp95 = Scalar(1.0) * _tmp68 * _tmp81 - Scalar(1.0) * _tmp78;
  const Scalar _tmp96 = _tmp90 * (-Scalar(1.0) * _tmp52 - _tmp89 * _tmp95) + _tmp95;
  const Scalar _tmp97 = -_tmp84 * _tmp96 + Scalar(1.0);
  const Scalar _tmp98 = _tmp62 * fh1;
  const Scalar _tmp99 = _tmp55 * _tmp64;
  const Scalar _tmp100 = _tmp51 * _tmp85;
  ...
  _res(0, 0) = 0;
  _res(1, 0) =
      -_tmp87 * std::exp(_tmp40 * _tmp64 * (_tmp27 * _tmp55 - _tmp43 * _tmp55 * _tmp56) +
                         _tmp40 * _tmp94 * (_tmp56 * _tmp92 + _tmp91 * _tmp93 + Scalar(1.0)) +
                         _tmp40 * _tmp98 * (_tmp56 * _tmp97 + _tmp93 * _tmp96) + _tmp65 * _tmp87);
  _res(2, 0) = -_tmp100 * std::exp(_tmp100 * _tmp65 + _tmp43 * _tmp51 * _tmp99 -
                                   _tmp51 * _tmp92 * _tmp94 - _tmp51 * _tmp97 * _tmp98);
  _res(3, 0) = _tmp86 * std::exp(-_tmp65 * _tmp86 - _tmp83 * _tmp91 * _tmp94 -
                                 _tmp83 * _tmp96 * _tmp98 - _tmp99);
