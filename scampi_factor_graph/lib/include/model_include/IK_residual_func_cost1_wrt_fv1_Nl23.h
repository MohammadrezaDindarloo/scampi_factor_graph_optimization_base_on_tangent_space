...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1WrtFv1Nl23(
  ...
  const Scalar _tmp56 = _tmp38 * _tmp43;
  const Scalar _tmp57 = _tmp36 * _tmp44 - _tmp40 * _tmp56 + _tmp44 * _tmp55;
  const Scalar _tmp58 = _tmp47 * _tmp53;
  const Scalar _tmp59 = _tmp30 + _tmp34;
  const Scalar _tmp60 = _tmp59 + position_vector(1, 0);
  const Scalar _tmp61 = _tmp60 + Scalar(110.0);
  const Scalar _tmp62 = _tmp39 + _tmp8;
  ...
  const Scalar _tmp69 = Scalar(1.0) / (_tmp44 * _tmp58 - _tmp56);
  const Scalar _tmp70 = _tmp68 * _tmp69;
  const Scalar _tmp71 = _tmp55 * _tmp66 - _tmp57 * _tmp70 + _tmp59 * _tmp66 - _tmp62 * _tmp67;
  const Scalar _tmp72 = Scalar(1.0) / (_tmp71);
  const Scalar _tmp73 = Scalar(1.0) * _tmp72;
  const Scalar _tmp74 = _tmp21 + Scalar(125.0);
  const Scalar _tmp75 = _tmp32 + Scalar(-110.0);
  ...
  const Scalar _tmp79 = fh1 * (_tmp20 * _tmp77 - _tmp31 * _tmp78);
  ...
  const Scalar _tmp83 = -Scalar(0.010999999999999999) * _tmp22 -
  ...
  const Scalar _tmp89 = -_tmp44 * _tmp86 + _tmp88;
  const Scalar _tmp90 = _tmp83 - _tmp84;
  const Scalar _tmp91 = _tmp82 + _tmp90;
  const Scalar _tmp92 = _tmp56 * _tmp86 - _tmp58 * _tmp88;
  const Scalar _tmp93 = _tmp66 * _tmp87;
  const Scalar _tmp94 = -_tmp58 * _tmp93 + _tmp67 * _tmp91 - _tmp70 * _tmp92;
  const Scalar _tmp95 = Scalar(1.0) * _tmp45;
  const Scalar _tmp96 = -_tmp95;
  const Scalar _tmp97 = Scalar(1.0) / (_tmp36 + _tmp96);
  const Scalar _tmp98 = Scalar(1.0) * _tmp48;
  const Scalar _tmp99 = _tmp97 * (-_tmp40 + _tmp98);
  const Scalar _tmp100 = -_tmp66 * _tmp91 - _tmp70 * _tmp89 + _tmp93 - _tmp94 * _tmp99;
  const Scalar _tmp101 = Scalar(1.0) / (_tmp100);
  const Scalar _tmp102 = _tmp95 * _tmp99 + _tmp98;
  const Scalar _tmp103 = 0;
  const Scalar _tmp104 = _tmp103 * _tmp70;
  const Scalar _tmp105 = _tmp54 * (_tmp103 * _tmp66 - _tmp104 * _tmp44);
  const Scalar _tmp106 = Scalar(1.0) * _tmp69;
  const Scalar _tmp107 = _tmp106 * _tmp92;
  const Scalar _tmp108 = -_tmp106 * _tmp89 + _tmp107 * _tmp99;
  const Scalar _tmp109 = _tmp101 * _tmp71;
  const Scalar _tmp110 = _tmp100 * _tmp72;
  const Scalar _tmp111 = _tmp110 * (-_tmp106 * _tmp57 - _tmp108 * _tmp109);
  const Scalar _tmp112 = _tmp108 + _tmp111;
  const Scalar _tmp113 = _tmp101 * _tmp66;
  const Scalar _tmp114 = _tmp101 * _tmp68;
  const Scalar _tmp115 = -_tmp112 * _tmp114 + Scalar(1.0);
  const Scalar _tmp116 = _tmp44 * _tmp69;
  const Scalar _tmp117 = _tmp77 * fh1;
  const Scalar _tmp118 = _tmp58 * _tmp69;
  const Scalar _tmp119 = _tmp118 * _tmp92 + _tmp58 * _tmp87;
  const Scalar _tmp120 = _tmp118 * _tmp89 - _tmp119 * _tmp99 - _tmp87;
  const Scalar _tmp121 = _tmp110 * (-_tmp109 * _tmp120 + _tmp118 * _tmp57 - _tmp55);
  const Scalar _tmp122 = _tmp120 + _tmp121;
  const Scalar _tmp123 = -_tmp114 * _tmp122 - _tmp58;
  const Scalar _tmp124 = _tmp78 * fh1;
  const Scalar _tmp125 = -_tmp105 * _tmp80 -
                         _tmp117 * _tmp54 * (_tmp112 * _tmp113 + _tmp115 * _tmp116) -
                         _tmp124 * _tmp54 * (_tmp113 * _tmp122 + _tmp116 * _tmp123 + Scalar(1.0)) -
                         _tmp54 * _tmp79 * (-_tmp44 * _tmp70 * _tmp73 + _tmp66 * _tmp73);
  const Scalar _tmp126 = std::pow(_tmp125, Scalar(-2));
  const Scalar _tmp127 = _tmp105 * _tmp126;
  const Scalar _tmp128 = fh1 * (_tmp81 + _tmp90);
  const Scalar _tmp129 = -_tmp128 * _tmp77 - Scalar(40.024799999999999) * _tmp27 - _tmp31 * fv1;
  const Scalar _tmp130 = _tmp59 + _tmp96;
  const Scalar _tmp131 = _tmp130 * _tmp99;
  const Scalar _tmp132 = Scalar(1.0) / (-_tmp131 - _tmp62 + _tmp98);
  const Scalar _tmp133 = Scalar(1.0) * _tmp132;
  const Scalar _tmp134 = _tmp97 * (_tmp131 * _tmp133 + Scalar(1.0));
  const Scalar _tmp135 = _tmp133 * _tmp99;
  const Scalar _tmp136 = -Scalar(1.0) * _tmp134 + Scalar(1.0) * _tmp135;
  const Scalar _tmp137 = _tmp101 * _tmp94;
  const Scalar _tmp138 = _tmp130 * _tmp132;
  const Scalar _tmp139 = -_tmp107 + _tmp111 * _tmp138 - _tmp112 * _tmp137;
  const Scalar _tmp140 = Scalar(1.0) * _tmp97;
  const Scalar _tmp141 = _tmp128 * _tmp78 + Scalar(40.024799999999999) * _tmp14 + _tmp20 * fv1;
  const Scalar _tmp142 = _tmp130 * _tmp133;
  const Scalar _tmp143 = -Scalar(1.0) * _tmp133 + Scalar(1.0) * _tmp142 * _tmp97;
  const Scalar _tmp144 = _tmp119 + _tmp121 * _tmp138 - _tmp122 * _tmp137;
  const Scalar _tmp145 = _tmp102 * _tmp132;
  const Scalar _tmp146 = _tmp97 * (-_tmp103 * _tmp94 - _tmp130 * _tmp145 + _tmp96);
  const Scalar _tmp147 = -Scalar(1.0) * _tmp145 - Scalar(1.0) * _tmp146 + Scalar(1.0);
  const Scalar _tmp148 = _tmp110 * _tmp142 - _tmp73 * _tmp94;
  const Scalar _tmp149 = _tmp110 * _tmp133;
  const Scalar _tmp150 = Scalar(1.0) * _tmp117 * (_tmp111 * _tmp133 - _tmp139 * _tmp140) +
                         Scalar(1.0) * _tmp124 * (_tmp121 * _tmp133 - _tmp140 * _tmp144) +
                         _tmp129 * _tmp136 + _tmp141 * _tmp143 + _tmp147 * _tmp80 +
                         Scalar(1.0) * _tmp79 * (-_tmp140 * _tmp148 + _tmp149);
  const Scalar _tmp151 = Scalar(1.0) / (_tmp125);
  const Scalar _tmp152 = std::asinh(_tmp150 * _tmp151);
  const Scalar _tmp153 = Scalar(1.0) * _tmp152;
  const Scalar _tmp154 = _tmp28 + _tmp35;
  const Scalar _tmp155 =
      (-_tmp127 * _tmp150 + _tmp151 * (_tmp136 * _tmp154 + _tmp143 * _tmp20 - _tmp147)) /
  ...
  const Scalar _tmp160 = Scalar(1.4083112389913199) * _tmp105;
  const Scalar _tmp161 = _tmp133 * _tmp141;
  const Scalar _tmp162 = _tmp130 * _tmp97;
  const Scalar _tmp163 = _tmp117 * _tmp139 * _tmp97 + _tmp124 * _tmp144 * _tmp97 +
                         _tmp129 * _tmp134 + _tmp146 * _tmp80 + _tmp148 * _tmp79 * _tmp97 -
                         _tmp161 * _tmp162;
  const Scalar _tmp164 = _tmp103 * _tmp80;
  const Scalar _tmp165 = _tmp73 * _tmp79;
  const Scalar _tmp166 =
      _tmp115 * _tmp117 * _tmp69 + _tmp123 * _tmp124 * _tmp69 - _tmp164 * _tmp70 - _tmp165 * _tmp70;
  ...
  const Scalar _tmp174 = Scalar(1.4083112389913199) * _tmp103;
  ...
  const Scalar _tmp179 =
      (-_tmp163 * _tmp177 + _tmp167 * (_tmp134 * _tmp154 - _tmp146 - _tmp162 * _tmp178)) /
      std::sqrt(Scalar(std::pow(_tmp163, Scalar(2)) * _tmp176 + 1));
  const Scalar _tmp180 = -_tmp111 * _tmp117 * _tmp132 - _tmp121 * _tmp124 * _tmp132 -
                         _tmp129 * _tmp135 + _tmp145 * _tmp80 - _tmp149 * _tmp79 + _tmp161;
  const Scalar _tmp181 =
      _tmp101 * _tmp112 * _tmp117 + _tmp101 * _tmp122 * _tmp124 + _tmp164 + _tmp165;
  ...
  const Scalar _tmp187 = (_tmp180 * _tmp186 + _tmp182 * (-_tmp135 * _tmp154 - _tmp145 + _tmp178)) /
                         std::sqrt(Scalar(std::pow(_tmp180, Scalar(2)) * _tmp185 + 1));
  const Scalar _tmp188 = Scalar(1.4083112389913199) * _tmp181;
  ...
  _res(1, 0) =
      -_tmp156 *
          (-Scalar(34.083374946563197) * _tmp127 + Scalar(1.0) * _tmp155 * std::sinh(_tmp153) -
           (-Scalar(0.71007031138673404) * _tmp127 * _tmp157 +
            _tmp158 * (-_tmp152 * _tmp160 - _tmp155 * _tmp156)) *
               std::sinh(_tmp159)) -
      _tmp160 * (Scalar(34.083374946563197) * _tmp151 + std::cosh(_tmp153) - std::cosh(_tmp159));
  _res(2, 0) =
      -_tmp170 *
          (-Scalar(34.083374946563197) * _tmp177 + Scalar(1.0) * _tmp179 * std::sinh(_tmp169) -
           (-Scalar(0.71007031138673404) * _tmp171 * _tmp177 +
            _tmp172 * (-_tmp168 * _tmp175 - _tmp170 * _tmp179)) *
               std::sinh(_tmp173)) -
      _tmp175 * (Scalar(34.083374946563197) * _tmp167 + std::cosh(_tmp169) - std::cosh(_tmp173));
  _res(3, 0) =
      _tmp174 * (Scalar(34.083374946563197) * _tmp182 + std::cosh(_tmp184) - std::cosh(_tmp191)) -
