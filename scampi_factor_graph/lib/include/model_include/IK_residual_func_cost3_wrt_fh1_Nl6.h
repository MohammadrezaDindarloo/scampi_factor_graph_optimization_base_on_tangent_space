...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl6(
  ...
  const Scalar _tmp32 = _tmp20 + _tmp23;
  ...
  const Scalar _tmp49 = _tmp35 + _tmp8;
  ...
  const Scalar _tmp56 = -_tmp40 * _tmp45 + _tmp41 * _tmp46 + _tmp46 * _tmp55;
  const Scalar _tmp57 = _tmp48 * _tmp53;
  const Scalar _tmp58 = _tmp34 * _tmp38;
  const Scalar _tmp59 = _tmp39 * _tmp57 - _tmp58;
  const Scalar _tmp60 = Scalar(1.0) / (-_tmp45 + _tmp46 * _tmp57);
  const Scalar _tmp61 = _tmp59 * _tmp60;
  const Scalar _tmp62 = _tmp33 * _tmp39 - _tmp36 * _tmp58 + _tmp39 * _tmp55 - _tmp56 * _tmp61;
  const Scalar _tmp63 = Scalar(1.0) / (_tmp62);
  const Scalar _tmp64 = Scalar(1.0) * _tmp63;
  const Scalar _tmp65 = _tmp46 * _tmp61;
  const Scalar _tmp66 = _tmp30 * _tmp54 * (_tmp39 * _tmp64 - _tmp64 * _tmp65);
  ...
  const Scalar _tmp75 = _tmp67 + _tmp68 + _tmp69;
  const Scalar _tmp76 = _tmp45 * _tmp75 - _tmp46 * _tmp74;
  const Scalar _tmp77 = Scalar(1.0) * _tmp47;
  const Scalar _tmp78 = Scalar(1.0) * _tmp49;
  const Scalar _tmp79 = (-_tmp40 + _tmp78) / (_tmp41 - _tmp77);
  const Scalar _tmp80 = _tmp46 * _tmp71 - _tmp46 * _tmp75;
  const Scalar _tmp81 = -_tmp39 * _tmp73 - _tmp61 * _tmp80 + _tmp72 -
                        _tmp79 * (-_tmp57 * _tmp72 + _tmp58 * _tmp73 - _tmp61 * _tmp76);
  const Scalar _tmp82 = Scalar(1.0) / (_tmp81);
  const Scalar _tmp83 = Scalar(1.0) * _tmp60;
  const Scalar _tmp84 = _tmp76 * _tmp79 * _tmp83 - _tmp80 * _tmp83;
  const Scalar _tmp85 = _tmp62 * _tmp82;
  const Scalar _tmp86 = _tmp63 * _tmp81;
  const Scalar _tmp87 = _tmp84 + _tmp86 * (-_tmp56 * _tmp83 - _tmp84 * _tmp85);
  const Scalar _tmp88 = _tmp82 * _tmp87;
  const Scalar _tmp89 = _tmp59 * _tmp82;
  const Scalar _tmp90 = _tmp60 * (-_tmp87 * _tmp89 + Scalar(1.0));
  const Scalar _tmp91 = _tmp28 * _tmp54 * (_tmp39 * _tmp88 + _tmp46 * _tmp90);
  const Scalar _tmp92 = _tmp57 * _tmp60;
  const Scalar _tmp93 = -_tmp71 - _tmp79 * (_tmp74 + _tmp76 * _tmp92) + _tmp80 * _tmp92;
  const Scalar _tmp94 = _tmp86 * (-_tmp55 + _tmp56 * _tmp92 - _tmp85 * _tmp93) + _tmp93;
  const Scalar _tmp95 = _tmp82 * _tmp94;
  const Scalar _tmp96 = _tmp60 * (-_tmp57 - _tmp89 * _tmp94);
  const Scalar _tmp97 = _tmp29 * _tmp54 * (_tmp39 * _tmp95 + _tmp46 * _tmp96 + Scalar(1.0));
  const Scalar _tmp98 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp99 = _tmp77 * _tmp79 + _tmp78;
  const Scalar _tmp100 = 0;
  const Scalar _tmp101 = _tmp100 * _tmp98;
  const Scalar _tmp102 = _tmp28 * _tmp90;
  const Scalar _tmp103 = _tmp29 * _tmp96;
  const Scalar _tmp104 = _tmp30 * _tmp64;
  const Scalar _tmp105 = _tmp104 * fh1;
  const Scalar _tmp106 = _tmp29 * _tmp95;
  const Scalar _tmp107 = _tmp28 * _tmp88;
  ...
  _res(1, 0) = -(-_tmp66 - _tmp91 - _tmp97) *
               std::exp(_tmp54 * _tmp98 * (_tmp100 * _tmp39 - _tmp100 * _tmp65) + _tmp66 * fh1 +
                        _tmp91 * fh1 + _tmp97 * fh1);
  _res(2, 0) = -(_tmp102 + _tmp103 - _tmp104 * _tmp61) *
               std::exp(_tmp101 * _tmp61 - _tmp102 * fh1 - _tmp103 * fh1 + _tmp105 * _tmp61);
  _res(3, 0) =
      -(_tmp104 + _tmp106 + _tmp107) * std::exp(-_tmp101 - _tmp105 - _tmp106 * fh1 - _tmp107 * fh1);
