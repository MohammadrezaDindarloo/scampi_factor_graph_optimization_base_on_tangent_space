...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl6(
  ...
  const Scalar _tmp68 = _tmp46 * _tmp65 - _tmp67;
  const Scalar _tmp69 = _tmp55 * _tmp68;
  const Scalar _tmp70 = -_tmp54 * (-_tmp46 * _tmp66 - _tmp51 * _tmp69 + _tmp59 * _tmp67) -
                        _tmp57 * _tmp69 - _tmp59 * _tmp65 + _tmp66;
  const Scalar _tmp71 = Scalar(1.0) / (_tmp70);
  const Scalar _tmp72 =
      std::sqrt(Scalar(std::pow(_tmp39, Scalar(2)) + std::pow(_tmp44, Scalar(2))));
  const Scalar _tmp73 = Scalar(1.0) / (_tmp72);
  const Scalar _tmp74 = _tmp45 * _tmp72;
  const Scalar _tmp75 = _tmp74 * (-_tmp37 * _tmp44 * _tmp73 + _tmp39 * _tmp42 * _tmp73);
  const Scalar _tmp76 = _tmp23 * _tmp49 - _tmp30 * _tmp34 + _tmp49 * _tmp75;
  const Scalar _tmp77 = -_tmp60 * _tmp67 + _tmp62 * _tmp65 + _tmp65 * _tmp75 - _tmp69 * _tmp76;
  const Scalar _tmp78 = _tmp71 * _tmp77;
  const Scalar _tmp79 = Scalar(1.0) / (_tmp77);
  const Scalar _tmp80 = _tmp70 * _tmp79;
  const Scalar _tmp81 = _tmp58 + _tmp80 * (-_tmp56 * _tmp76 - _tmp58 * _tmp78);
  const Scalar _tmp82 = _tmp65 * _tmp71;
  const Scalar _tmp83 = _tmp68 * _tmp71;
  const Scalar _tmp84 = -_tmp81 * _tmp83 + Scalar(1.0);
  const Scalar _tmp85 = _tmp49 * _tmp55;
  const Scalar _tmp86 = _tmp22 + _tmp35;
  ...
  const Scalar _tmp96 = _tmp49 * _tmp69;
  ...
  const Scalar _tmp100 = _tmp46 * _tmp55;
  const Scalar _tmp101 = _tmp100 * _tmp57 - _tmp48 - _tmp54 * (_tmp100 * _tmp51 + _tmp46 * _tmp48);
  const Scalar _tmp102 = _tmp101 + _tmp80 * (_tmp100 * _tmp76 - _tmp101 * _tmp78 - _tmp75);
  const Scalar _tmp103 = -_tmp102 * _tmp83 - _tmp46;
  const Scalar _tmp104 = _tmp55 * fh1;
  ...
  _res(1, 0) = std::exp(_tmp74 * _tmp93 * (_tmp65 * _tmp95 - _tmp95 * _tmp96) +
                        _tmp74 * _tmp99 * (_tmp65 * _tmp97 - _tmp96 * _tmp97) +
                        _tmp91 * _tmp92 * (_tmp81 * _tmp82 + _tmp84 * _tmp85) +
                        _tmp92 * _tmp98 * (_tmp102 * _tmp82 + _tmp103 * _tmp85 + Scalar(1.0)));
  _res(2, 0) = std::exp(-_tmp103 * _tmp104 * _tmp98 - _tmp104 * _tmp84 * _tmp91 + _tmp105 * _tmp69 +
                        _tmp106 * _tmp69);
  _res(3, 0) =
      std::exp(-_tmp102 * _tmp107 * _tmp98 - _tmp105 - _tmp106 - _tmp107 * _tmp81 * _tmp91);
