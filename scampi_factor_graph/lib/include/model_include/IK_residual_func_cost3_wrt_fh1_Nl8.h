...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl8(
  ...
  const Scalar _tmp40 = _tmp15 + _tmp4;
  ...
  const Scalar _tmp45 = _tmp32 + _tmp36;
  const Scalar _tmp46 = _tmp31 * _tmp45;
  const Scalar _tmp47 = _tmp29 * _tmp30;
  const Scalar _tmp48 = _tmp31 * _tmp44 - _tmp47;
  ...
  const Scalar _tmp59 = Scalar(1.0) / (_tmp44 * _tmp57 - _tmp58);
  const Scalar _tmp60 = _tmp33 + _tmp34 - _tmp35;
  const Scalar _tmp61 = _tmp45 * _tmp57;
  const Scalar _tmp62 = _tmp59 * (-_tmp44 * _tmp61 + _tmp58 * _tmp60);
  const Scalar _tmp63 = Scalar(1.0) * _tmp40;
  const Scalar _tmp64 = Scalar(1.0) * _tmp38;
  const Scalar _tmp65 = (-_tmp54 + _tmp63) / (_tmp50 - _tmp64);
  const Scalar _tmp66 = _tmp59 * (-_tmp57 * _tmp60 + _tmp61);
  const Scalar _tmp67 = -_tmp31 * _tmp37 + _tmp46 - _tmp48 * _tmp66 -
                        _tmp65 * (_tmp37 * _tmp47 - _tmp44 * _tmp46 - _tmp48 * _tmp62);
  const Scalar _tmp68 = Scalar(1.0) / (_tmp67);
  const Scalar _tmp69 =
      std::sqrt(Scalar(std::pow(_tmp39, Scalar(2)) + std::pow(_tmp42, Scalar(2))));
  const Scalar _tmp70 = Scalar(1.0) / (_tmp69);
  const Scalar _tmp71 = _tmp43 * _tmp69;
  const Scalar _tmp72 = _tmp71 * (-_tmp38 * _tmp42 * _tmp70 + _tmp39 * _tmp40 * _tmp70);
  const Scalar _tmp73 = _tmp59 * (_tmp50 * _tmp57 - _tmp54 * _tmp58 + _tmp57 * _tmp72);
  const Scalar _tmp74 = Scalar(1.0) * _tmp62 * _tmp65 - Scalar(1.0) * _tmp66;
  const Scalar _tmp75 = -_tmp16 * _tmp47 + _tmp27 * _tmp31 + _tmp31 * _tmp72 - _tmp48 * _tmp73;
  ...
  const Scalar _tmp81 = _tmp48 * _tmp68;
  const Scalar _tmp82 = _tmp59 * (-_tmp79 * _tmp81 + Scalar(1.0));
  const Scalar _tmp83 = _tmp19 + _tmp49;
  ...
  const Scalar _tmp89 = _tmp71 * _tmp88 * (_tmp31 * _tmp80 + _tmp57 * _tmp82);
  const Scalar _tmp90 = Scalar(333.54000000000002) - fv1;
  const Scalar _tmp91 = _tmp63 + _tmp64 * _tmp65;
  const Scalar _tmp92 = 0;
  const Scalar _tmp93 = _tmp68 * _tmp92;
  const Scalar _tmp94 = _tmp59 * _tmp81 * _tmp92;
  const Scalar _tmp95 = _tmp86 * _tmp87;
  const Scalar _tmp96 = -_tmp83 * _tmp95 + _tmp85 * _tmp88;
  const Scalar _tmp97 = Scalar(1.0) * _tmp77;
  const Scalar _tmp98 = _tmp48 * _tmp59;
  const Scalar _tmp99 = _tmp71 * _tmp96 * (_tmp31 * _tmp97 - _tmp57 * _tmp97 * _tmp98);
  const Scalar _tmp100 = _tmp44 * _tmp66 - _tmp45 - _tmp65 * (_tmp44 * _tmp45 + _tmp44 * _tmp62);
  const Scalar _tmp101 = _tmp100 + _tmp78 * (-_tmp100 * _tmp76 + _tmp44 * _tmp73 - _tmp72);
  const Scalar _tmp102 = _tmp101 * _tmp68;
  const Scalar _tmp103 = _tmp59 * (-_tmp101 * _tmp81 - _tmp44);
  const Scalar _tmp104 = _tmp71 * _tmp95 * (_tmp102 * _tmp31 + _tmp103 * _tmp57 + Scalar(1.0));
  const Scalar _tmp105 = _tmp96 * _tmp97;
  const Scalar _tmp106 = _tmp105 * fh1;
  const Scalar _tmp107 = _tmp82 * _tmp88;
  const Scalar _tmp108 = _tmp103 * _tmp95;
  const Scalar _tmp109 = _tmp102 * _tmp95;
  const Scalar _tmp110 = _tmp80 * _tmp88;

  // Output terms (1)
  Eigen::Matrix<Scalar, 4, 1> _res;

  _res(0, 0) = -std::exp(-fh1);
  _res(1, 0) = -(-_tmp104 - _tmp89 - _tmp99) *
               std::exp(_tmp104 * fh1 + _tmp71 * _tmp90 * (_tmp31 * _tmp93 - _tmp57 * _tmp94) +
                        _tmp89 * fh1 + _tmp99 * fh1);
  _res(2, 0) = -(-_tmp105 * _tmp98 + _tmp107 + _tmp108) *
               std::exp(_tmp106 * _tmp98 - _tmp107 * fh1 - _tmp108 * fh1 + _tmp90 * _tmp94);
  _res(3, 0) = -(_tmp105 + _tmp109 + _tmp110) *
               std::exp(-_tmp106 - _tmp109 * fh1 - _tmp110 * fh1 - _tmp90 * _tmp93);
