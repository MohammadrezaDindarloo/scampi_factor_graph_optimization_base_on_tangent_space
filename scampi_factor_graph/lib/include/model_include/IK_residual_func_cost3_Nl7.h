...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl7(const Scalar fh1, const Scalar fv1,
  ...
  const Scalar _tmp90 = _tmp63 * fh1;
  const Scalar _tmp91 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp92 = _tmp66 * _tmp68 + _tmp67;
  const Scalar _tmp93 = 0;
  const Scalar _tmp94 = _tmp42 * _tmp78 - _tmp68 * (_tmp42 * _tmp77 + _tmp81) - _tmp75;
  const Scalar _tmp95 = _tmp85 * (-_tmp41 + _tmp42 * _tmp52 - _tmp84 * _tmp94) + _tmp94;
  const Scalar _tmp96 = -_tmp42 - _tmp87 * _tmp95;
  const Scalar _tmp97 = _tmp64 * fh1;
  ...
  _res(1, 0) = std::exp(_tmp40 * _tmp65 * (_tmp28 * _tmp55 - _tmp55 * _tmp57) +
                        _tmp40 * _tmp90 * (_tmp56 * _tmp88 + _tmp86 * _tmp89) +
                        _tmp40 * _tmp91 * (_tmp28 * _tmp93 - _tmp57 * _tmp93) +
                        _tmp40 * _tmp97 * (_tmp56 * _tmp96 + _tmp89 * _tmp95 + Scalar(1.0)));
  _res(2, 0) = std::exp(_tmp100 * _tmp99 - _tmp51 * _tmp88 * _tmp90 - _tmp51 * _tmp96 * _tmp97 +
                        _tmp98 * _tmp99);
  _res(3, 0) = std::exp(-_tmp100 - _tmp83 * _tmp86 * _tmp90 - _tmp83 * _tmp95 * _tmp97 - _tmp98);
