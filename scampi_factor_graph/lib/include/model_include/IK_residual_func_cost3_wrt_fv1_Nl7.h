...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl7(
  ...
  const Scalar _tmp30 = -_tmp18 + _tmp21;
  ...
  const Scalar _tmp43 = -_tmp27 + _tmp28 * _tmp42;
  ...
  const Scalar _tmp52 = _tmp51 * (_tmp41 * _tmp49 + _tmp44 * _tmp49 - _tmp46 * _tmp50);
  const Scalar _tmp53 = -_tmp15 * _tmp27 + _tmp23 * _tmp28 + _tmp28 * _tmp41 - _tmp43 * _tmp52;
  ...
  const Scalar _tmp58 = _tmp14 + _tmp33;
  const Scalar _tmp59 = _tmp58 + p_init0 + Scalar(-2.5202214700000001);
  const Scalar _tmp60 = _tmp16 + _tmp30;
  const Scalar _tmp61 = _tmp60 + p_init1 + Scalar(8.3888750099999996);
  ...
  const Scalar _tmp66 = Scalar(1.0) * _tmp31;
  const Scalar _tmp67 = Scalar(1.0) * _tmp35;
  const Scalar _tmp68 = (-_tmp46 + _tmp67) / (_tmp44 - _tmp66);
  ...
  const Scalar _tmp77 = _tmp51 * (-_tmp42 * _tmp76 + _tmp50 * _tmp74);
  const Scalar _tmp78 = _tmp51 * (-_tmp49 * _tmp74 + _tmp76);
  const Scalar _tmp79 = Scalar(1.0) * _tmp68 * _tmp77 - Scalar(1.0) * _tmp78;
  const Scalar _tmp80 = _tmp69 + _tmp73;
  const Scalar _tmp81 = _tmp42 * _tmp75;
  const Scalar _tmp82 = _tmp28 * _tmp75 - _tmp28 * _tmp80 - _tmp43 * _tmp78 -
                        _tmp68 * (_tmp27 * _tmp80 - _tmp28 * _tmp81 - _tmp43 * _tmp77);
  const Scalar _tmp83 = Scalar(1.0) / (_tmp82);
  const Scalar _tmp84 = _tmp53 * _tmp83;
  const Scalar _tmp85 = _tmp54 * _tmp82;
  const Scalar _tmp86 = _tmp79 + _tmp85 * (-Scalar(1.0) * _tmp52 - _tmp79 * _tmp84);
  const Scalar _tmp87 = _tmp43 * _tmp83;
  const Scalar _tmp88 = -_tmp86 * _tmp87 + Scalar(1.0);
  const Scalar _tmp89 = _tmp28 * _tmp83;
  const Scalar _tmp90 = _tmp40 * fh1;
  const Scalar _tmp91 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp92 = _tmp66 * _tmp68 + _tmp67;
  const Scalar _tmp93 = 0;
  const Scalar _tmp94 = _tmp40 * (_tmp28 * _tmp93 - _tmp57 * _tmp93);
  const Scalar _tmp95 = _tmp42 * _tmp78 - _tmp68 * (_tmp42 * _tmp77 + _tmp81) - _tmp75;
  const Scalar _tmp96 = _tmp85 * (-_tmp41 + _tmp42 * _tmp52 - _tmp84 * _tmp95) + _tmp95;
  const Scalar _tmp97 = -_tmp42 - _tmp87 * _tmp96;
  const Scalar _tmp98 = _tmp55 * _tmp65;
  const Scalar _tmp99 = _tmp43 * _tmp51;
  const Scalar _tmp100 = _tmp51 * fh1;
  ...
  _res(0, 0) = 0;
  _res(1, 0) =
      -_tmp94 * std::exp(_tmp40 * _tmp65 * (_tmp28 * _tmp55 - _tmp55 * _tmp57) +
                         _tmp63 * _tmp90 * (_tmp56 * _tmp88 + _tmp86 * _tmp89) +
                         _tmp64 * _tmp90 * (_tmp56 * _tmp97 + _tmp89 * _tmp96 + Scalar(1.0)) +
                         _tmp91 * _tmp94);
  _res(2, 0) = -_tmp93 * _tmp99 *
               std::exp(-_tmp100 * _tmp63 * _tmp88 - _tmp100 * _tmp64 * _tmp97 + _tmp101 * _tmp99 +
                        _tmp98 * _tmp99);
  _res(3, 0) =
      _tmp93 * std::exp(-_tmp101 - _tmp102 * _tmp63 * _tmp86 - _tmp102 * _tmp64 * _tmp96 - _tmp98);
