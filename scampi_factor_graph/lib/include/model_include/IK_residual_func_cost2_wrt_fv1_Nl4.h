...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2WrtFv1Nl4(
  ...
  const Scalar _tmp38 = _tmp35 + _tmp7;
  const Scalar _tmp39 = _tmp25 + _tmp30;
  const Scalar _tmp40 = _tmp23 + _tmp39;
  const Scalar _tmp41 = Scalar(1.0) * _tmp40;
  const Scalar _tmp42 = -_tmp41;
  const Scalar _tmp43 = _tmp22 + _tmp39;
  const Scalar _tmp44 = _tmp42 + _tmp43;
  const Scalar _tmp45 = _tmp22 + _tmp31;
  ...
  const Scalar _tmp52 = _tmp40 + p_init1;
  const Scalar _tmp53 = _tmp52 + Scalar(-4.8333311099999996);
  const Scalar _tmp54 = _tmp36 + p_init0;
  ...
  const Scalar _tmp60 = _tmp59 * (_tmp36 * _tmp53 * _tmp57 - _tmp40 * _tmp55 * _tmp57);
  ...
  const Scalar _tmp82 = Scalar(0.20999999999999999) * _tmp11 - Scalar(0.20999999999999999) * _tmp13;
  const Scalar _tmp83 =
  ...
  const Scalar _tmp125 = fh1 * (_tmp87 + _tmp89);
  const Scalar _tmp126 = _tmp105 * _tmp125 + Scalar(3.29616) * _tmp14 + _tmp20 * fv1;
  const Scalar _tmp127 = _tmp44 * _tmp46;
  const Scalar _tmp128 = Scalar(1.0) * _tmp127 * _tmp51 - Scalar(1.0) * _tmp51;
  const Scalar _tmp129 = -_tmp104 * _tmp125 - Scalar(3.29616) * _tmp28 - _tmp32 * fv1;
  const Scalar _tmp130 = _tmp46 * (_tmp49 * _tmp51 + Scalar(1.0));
  const Scalar _tmp131 = _tmp48 * _tmp51;
  const Scalar _tmp132 = -Scalar(1.0) * _tmp130 + Scalar(1.0) * _tmp131;
  const Scalar _tmp133 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp134 = _tmp37 + _tmp41 * _tmp48;
  const Scalar _tmp135 = _tmp134 * _tmp50;
  const Scalar _tmp136 = 0;
  const Scalar _tmp137 = _tmp46 * (-_tmp115 * _tmp136 - _tmp135 * _tmp44 + _tmp42);
  const Scalar _tmp138 = -Scalar(1.0) * _tmp135 - Scalar(1.0) * _tmp137 + Scalar(1.0);
  const Scalar _tmp139 = Scalar(1.0) * _tmp106 * (-_tmp100 * _tmp99 + _tmp97) +
                         Scalar(1.0) * _tmp117 * (-_tmp100 * _tmp116 + _tmp112 * _tmp51) +
                         Scalar(1.0) * _tmp124 * (-_tmp100 * _tmp123 + _tmp121 * _tmp51) +
                         _tmp126 * _tmp128 + _tmp129 * _tmp132 + _tmp133 * _tmp138;
  const Scalar _tmp140 = _tmp110 * _tmp78;
  const Scalar _tmp141 = -_tmp114 * _tmp140 - _tmp76;
  const Scalar _tmp142 = _tmp73 * _tmp77;
  const Scalar _tmp143 = _tmp110 * _tmp66;
  const Scalar _tmp144 = _tmp110 * _tmp136;
  const Scalar _tmp145 = _tmp136 * _tmp140;
  const Scalar _tmp146 = _tmp59 * (-_tmp142 * _tmp145 + _tmp144 * _tmp66);
  const Scalar _tmp147 = _tmp118 * _tmp78 * _tmp81;
  const Scalar _tmp148 = -_tmp122 * _tmp140 + Scalar(1.0);
  const Scalar _tmp149 = -_tmp106 * _tmp59 * (-_tmp147 * _tmp73 + _tmp66 * _tmp98) -
                         _tmp117 * _tmp59 * (_tmp114 * _tmp143 + _tmp141 * _tmp142 + Scalar(1.0)) -
                         _tmp124 * _tmp59 * (_tmp122 * _tmp143 + _tmp142 * _tmp148) -
                         _tmp133 * _tmp146;
  ...
  const Scalar _tmp157 = Scalar(9.6622558468725703) * _tmp146;
  const Scalar _tmp158 = std::pow(_tmp149, Scalar(-2));
  const Scalar _tmp159 = _tmp146 * _tmp158;
  const Scalar _tmp160 = _tmp22 + _tmp25 + _tmp29;
  const Scalar _tmp161 =
      (-_tmp139 * _tmp159 + _tmp150 * (_tmp128 * _tmp20 + _tmp132 * _tmp160 - _tmp138)) /
      std::sqrt(Scalar(std::pow(_tmp139, Scalar(2)) * _tmp158 + 1));
  const Scalar _tmp162 = _tmp145 * _tmp77;
  const Scalar _tmp163 = -_tmp106 * _tmp147 + _tmp117 * _tmp141 * _tmp77 +
                         _tmp124 * _tmp148 * _tmp77 - _tmp133 * _tmp162;
  const Scalar _tmp164 = Scalar(1.0) / (_tmp163);
  const Scalar _tmp165 = _tmp126 * _tmp51;
  const Scalar _tmp166 = _tmp106 * _tmp46 * _tmp99 + _tmp116 * _tmp117 * _tmp46 +
                         _tmp123 * _tmp124 * _tmp46 - _tmp127 * _tmp165 + _tmp129 * _tmp130 +
                         _tmp133 * _tmp137;
  ...
  const Scalar _tmp174 = _tmp20 * _tmp51;
  const Scalar _tmp175 = _tmp162 * _tmp173;
  const Scalar _tmp176 =
      (_tmp164 * (-_tmp127 * _tmp174 + _tmp130 * _tmp160 - _tmp137) - _tmp166 * _tmp175) /
      std::sqrt(Scalar(std::pow(_tmp166, Scalar(2)) * _tmp173 + 1));
  const Scalar _tmp177 = Scalar(1.0) * _tmp167;
  const Scalar _tmp178 = _tmp106 * _tmp98 + _tmp110 * _tmp114 * _tmp117 +
                         _tmp110 * _tmp122 * _tmp124 + _tmp133 * _tmp144;
  const Scalar _tmp179 = Scalar(1.0) / (_tmp178);
  const Scalar _tmp180 = -_tmp106 * _tmp97 - _tmp112 * _tmp117 * _tmp50 -
                         _tmp121 * _tmp124 * _tmp50 - _tmp129 * _tmp131 + _tmp133 * _tmp135 +
                         _tmp165;
  ...
  const Scalar _tmp187 = Scalar(9.6622558468725703) * _tmp144;
  const Scalar _tmp188 = std::pow(_tmp178, Scalar(-2));
  const Scalar _tmp189 = _tmp144 * _tmp188;
  const Scalar _tmp190 = (_tmp179 * (-_tmp131 * _tmp160 - _tmp135 + _tmp174) + _tmp180 * _tmp189) /
  ...
  _res(2, 0) = _tmp168 * (-Scalar(1.0) * _tmp176 * std::cosh(_tmp177) -
                          (-Scalar(0.1034955) * _tmp169 * _tmp175 +
                           _tmp170 * (-_tmp167 * _tmp172 - _tmp168 * _tmp176)) *
                              std::cosh(_tmp171)) +
               _tmp172 * (-std::sinh(_tmp171) - std::sinh(_tmp177));
  _res(3, 0) = _tmp182 * (-Scalar(1.0) * _tmp190 * std::cosh(_tmp186) -
                          (Scalar(0.1034955) * _tmp183 * _tmp189 +
                           _tmp184 * (_tmp181 * _tmp187 - _tmp182 * _tmp190)) *
                              std::cosh(_tmp185)) -
               _tmp187 * (-std::sinh(_tmp185) - std::sinh(_tmp186));
