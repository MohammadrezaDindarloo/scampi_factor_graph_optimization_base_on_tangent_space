...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl19(
  ...
  const Scalar _tmp26 = 2 * _tmp6 * _tmp9;
  const Scalar _tmp27 =
  ...
  const Scalar _tmp31 = _tmp24 + _tmp27;
  const Scalar _tmp32 = _tmp22 + _tmp31;
  const Scalar _tmp33 = (_tmp18 - _tmp20) / (-_tmp30 + _tmp32);
  ...
  const Scalar _tmp47 = Scalar(1.0) / (_tmp39 * _tmp45 - _tmp46);
  const Scalar _tmp48 =
      -Scalar(0.010999999999999999) * _tmp21 - Scalar(0.010999999999999999) * _tmp3;
  const Scalar _tmp49 = -Scalar(0.20999999999999999) * _tmp11 + Scalar(0.20999999999999999) * _tmp8;
  ...
  const Scalar _tmp55 = -_tmp39 * _tmp54 + _tmp46 * _tmp51;
  const Scalar _tmp56 = _tmp47 * _tmp55;
  const Scalar _tmp57 = -_tmp45 * _tmp51 + _tmp54;
  const Scalar _tmp58 = _tmp47 * _tmp57;
  const Scalar _tmp59 = Scalar(1.0) * _tmp33 * _tmp56 - Scalar(1.0) * _tmp58;
  const Scalar _tmp60 = _tmp23 + _tmp31;
  ...
  const Scalar _tmp70 = _tmp53 * _tmp66;
  const Scalar _tmp71 = -_tmp33 * (-_tmp39 * _tmp70 - _tmp55 * _tmp68 + _tmp65 * _tmp69) -
                        _tmp57 * _tmp68 - _tmp66 * _tmp69 + _tmp70;
  ...
  const Scalar _tmp76 = _tmp75 * (_tmp17 * _tmp35 * _tmp74 - _tmp29 * _tmp37 * _tmp74);
  const Scalar _tmp77 = _tmp47 * (-_tmp20 * _tmp46 + _tmp32 * _tmp45 + _tmp45 * _tmp76);
  const Scalar _tmp78 = _tmp60 * _tmp66 - _tmp62 * _tmp65 + _tmp66 * _tmp76 - _tmp67 * _tmp77;
  const Scalar _tmp79 = _tmp72 * _tmp78;
  const Scalar _tmp80 = Scalar(1.0) / (_tmp78);
  const Scalar _tmp81 = _tmp71 * _tmp80;
  const Scalar _tmp82 = _tmp59 + _tmp81 * (-_tmp59 * _tmp79 - Scalar(1.0) * _tmp77);
  const Scalar _tmp83 = _tmp66 * _tmp72;
  const Scalar _tmp84 = _tmp67 * _tmp72;
  const Scalar _tmp85 = -_tmp82 * _tmp84 + Scalar(1.0);
  const Scalar _tmp86 = _tmp45 * _tmp47;
  const Scalar _tmp87 = _tmp22 + _tmp28;
  const Scalar _tmp88 = _tmp40 + _tmp87;
  const Scalar _tmp89 = _tmp19 + _tmp5;
  ...
  const Scalar _tmp98 = _tmp18 + _tmp30 * _tmp33;
  const Scalar _tmp99 = 0;
  const Scalar _tmp100 = _tmp72 * _tmp99;
  const Scalar _tmp101 = _tmp84 * _tmp99;
  const Scalar _tmp102 = -_tmp33 * (_tmp39 * _tmp53 + _tmp39 * _tmp56) + _tmp39 * _tmp58 - _tmp53;
  const Scalar _tmp103 = _tmp102 + _tmp81 * (-_tmp102 * _tmp79 + _tmp39 * _tmp77 - _tmp76);
  const Scalar _tmp104 = -_tmp103 * _tmp84 - _tmp39;
  const Scalar _tmp105 = _tmp95 * fh1;
  ...
  _res(1, 0) = std::exp(_tmp105 * _tmp75 * (_tmp103 * _tmp83 + _tmp104 * _tmp86 + Scalar(1.0)) +
                        _tmp75 * _tmp93 * (_tmp82 * _tmp83 + _tmp85 * _tmp86) +
                        _tmp75 * _tmp96 * (-_tmp45 * _tmp68 * _tmp94 + _tmp66 * _tmp94) +
                        _tmp75 * _tmp97 * (_tmp100 * _tmp66 - _tmp101 * _tmp86));
  _res(2, 0) = std::exp(_tmp101 * _tmp47 * _tmp97 - _tmp104 * _tmp105 * _tmp47 + _tmp106 * _tmp68 -
                        _tmp47 * _tmp85 * _tmp93);
  _res(3, 0) =
      std::exp(-_tmp100 * _tmp97 - _tmp103 * _tmp105 * _tmp72 - _tmp106 - _tmp72 * _tmp82 * _tmp93);
