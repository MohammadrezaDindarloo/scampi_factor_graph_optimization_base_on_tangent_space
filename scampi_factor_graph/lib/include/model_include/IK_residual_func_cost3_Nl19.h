...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl19(
  ...
  const Scalar _tmp76 = _tmp44 * _tmp66 * _tmp75 - _tmp62 * _tmp75;
  const Scalar _tmp77 = Scalar(1.0) / (_tmp73);
  const Scalar _tmp78 = _tmp74 * (-_tmp17 * _tmp28 * _tmp77 + _tmp18 * _tmp27 * _tmp77);
  const Scalar _tmp79 = -_tmp32 * _tmp39 + _tmp35 * _tmp38 + _tmp38 * _tmp78;
  const Scalar _tmp80 = -_tmp53 * _tmp63 + _tmp55 * _tmp58 + _tmp58 * _tmp78 - _tmp65 * _tmp79;
  ...
  const Scalar _tmp85 = _tmp58 * _tmp69;
  const Scalar _tmp86 = -_tmp70 * _tmp84 + Scalar(1.0);
  const Scalar _tmp87 = _tmp16 + _tmp5;
  const Scalar _tmp88 = _tmp87 + p_init1 + Scalar(-4.8333311099999996);
  const Scalar _tmp89 = _tmp21 + _tmp31;
  ...
  const Scalar _tmp94 = _tmp30 * _tmp40;
  const Scalar _tmp95 = -_tmp44 * (_tmp30 * _tmp59 + _tmp66 * _tmp94) - _tmp59 + _tmp62 * _tmp94;
  const Scalar _tmp96 = _tmp83 * (-_tmp78 + _tmp79 * _tmp94 - _tmp81 * _tmp95) + _tmp95;
  const Scalar _tmp97 = -_tmp30 - _tmp70 * _tmp96;
  const Scalar _tmp98 = _tmp90 * _tmp91;
  const Scalar _tmp99 = _tmp64 * _tmp75 * _tmp82;
  ...
  const Scalar _tmp103 = _tmp69 * fh1;

  // Output terms (1)
  Eigen::Matrix<Scalar, 4, 1> _res;

  _res(0, 0) = std::exp(-fh1);
  _res(1, 0) = std::exp(_tmp0 * _tmp74 * (-_tmp41 * _tmp71 + _tmp58 * _tmp72) +
                        _tmp101 * _tmp74 * (_tmp100 * _tmp58 - _tmp38 * _tmp99) +
                        _tmp92 * _tmp93 * (_tmp41 * _tmp86 + _tmp84 * _tmp85) +
                        _tmp93 * _tmp98 * (_tmp41 * _tmp97 + _tmp85 * _tmp96 + Scalar(1.0)));
  _res(2, 0) = std::exp(_tmp0 * _tmp40 * _tmp71 + _tmp101 * _tmp99 - _tmp102 * _tmp86 * _tmp92 -
                        _tmp102 * _tmp97 * _tmp98);
  _res(3, 0) = std::exp(-_tmp0 * _tmp72 - _tmp100 * _tmp101 - _tmp103 * _tmp84 * _tmp92 -
