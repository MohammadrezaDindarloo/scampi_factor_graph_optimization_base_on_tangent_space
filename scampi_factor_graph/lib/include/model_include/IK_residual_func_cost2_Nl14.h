...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2Nl14(
  ...
  const Scalar _tmp50 = _tmp20 - _tmp22;
  ...
  const Scalar _tmp75 = _tmp38 * _tmp59;
  const Scalar _tmp76 = _tmp65 * _tmp73 - _tmp74 * _tmp75;
  const Scalar _tmp77 = Scalar(1.0) / (_tmp59 * _tmp74 - _tmp73);
  const Scalar _tmp78 = _tmp61 * _tmp77;
  const Scalar _tmp79 = _tmp55 * _tmp64 - _tmp59 * _tmp62 - _tmp76 * _tmp78;
  ...
  const Scalar _tmp85 = _tmp38 * _tmp74 - _tmp65 * _tmp74;
  const Scalar _tmp86 = -_tmp60 * _tmp64 + _tmp62 - _tmp78 * _tmp85 - _tmp79 * _tmp84;
  const Scalar _tmp87 = Scalar(1.0) / (_tmp86);
  const Scalar _tmp88 = _tmp59 * _tmp77;
  const Scalar _tmp89 = _tmp75 + _tmp76 * _tmp88;
  const Scalar _tmp90 = -_tmp38 - _tmp84 * _tmp89 + _tmp85 * _tmp88;
  const Scalar _tmp91 =
      std::sqrt(Scalar(std::pow(_tmp56, Scalar(2)) + std::pow(_tmp58, Scalar(2))));
  const Scalar _tmp92 = Scalar(1.0) / (_tmp91);
  const Scalar _tmp93 = _tmp57 * _tmp91;
  const Scalar _tmp94 = _tmp93 * (_tmp40 * _tmp58 * _tmp92 - _tmp43 * _tmp56 * _tmp92);
  const Scalar _tmp95 = _tmp66 * _tmp74 - _tmp69 * _tmp73 + _tmp74 * _tmp94;
  const Scalar _tmp96 = _tmp47 * _tmp60 - _tmp51 * _tmp55 + _tmp60 * _tmp94 - _tmp78 * _tmp95;
  ...
  const Scalar _tmp102 = -_tmp101 * _tmp61 - _tmp59;
  const Scalar _tmp103 = _tmp74 * _tmp77;
  const Scalar _tmp104 = _tmp25 + Scalar(-2.71799795);
  const Scalar _tmp105 = _tmp32 + Scalar(-4.7752063900000001);
  ...
  const Scalar _tmp111 = -_tmp109 * _tmp85 + _tmp110 * _tmp84;
  const Scalar _tmp112 = _tmp99 * (-_tmp109 * _tmp95 - _tmp111 * _tmp97);
  const Scalar _tmp113 = _tmp87 * (_tmp111 + _tmp112);
  const Scalar _tmp114 = -_tmp113 * _tmp61 + Scalar(1.0);
  const Scalar _tmp115 = _tmp105 * _tmp106;
  const Scalar _tmp116 = _tmp115 * fh1;
  const Scalar _tmp117 = Scalar(1.0) * _tmp98;
  const Scalar _tmp118 = _tmp109 * _tmp61 * _tmp98;
  const Scalar _tmp119 = fh1 * (-_tmp107 * _tmp31 + _tmp115 * _tmp24);
  const Scalar _tmp120 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp121 = _tmp80 * _tmp84 + _tmp83;
  const Scalar _tmp122 = 0;
  const Scalar _tmp123 = -_tmp108 * _tmp93 * (_tmp101 * _tmp60 + _tmp102 * _tmp103 + Scalar(1.0)) -
                         _tmp116 * _tmp93 * (_tmp103 * _tmp114 + _tmp113 * _tmp60) -
                         _tmp119 * _tmp93 * (_tmp117 * _tmp60 - _tmp118 * _tmp74) -
                         _tmp120 * _tmp93 * (_tmp122 * _tmp60 - _tmp122 * _tmp74 * _tmp78);
  const Scalar _tmp124 = Scalar(1.0) / (_tmp123);
  const Scalar _tmp125 = _tmp47 + _tmp81;
  const Scalar _tmp126 = _tmp125 * _tmp84;
  const Scalar _tmp127 = Scalar(1.0) / (-_tmp126 - _tmp51 + _tmp83);
  const Scalar _tmp128 = Scalar(1.0) * _tmp127;
  const Scalar _tmp129 = _tmp121 * _tmp127;
  const Scalar _tmp130 = _tmp82 * (-_tmp122 * _tmp79 - _tmp125 * _tmp129 + _tmp81);
  ...
  const Scalar _tmp134 = _tmp82 * (_tmp126 * _tmp128 + Scalar(1.0));
  const Scalar _tmp135 = _tmp128 * _tmp84;
  const Scalar _tmp136 = _tmp15 * fh1;
  const Scalar _tmp137 = -_tmp115 * _tmp136 - Scalar(3.29616) * _tmp27 - _tmp31 * fv1;
  const Scalar _tmp138 = _tmp128 * _tmp99;
  const Scalar _tmp139 = _tmp125 * _tmp128;
  const Scalar _tmp140 = -_tmp117 * _tmp79 + _tmp139 * _tmp99;
  const Scalar _tmp141 = _tmp107 * _tmp136 + Scalar(3.29616) * _tmp19 + _tmp24 * fv1;
  const Scalar _tmp142 = _tmp100 * _tmp131 - _tmp101 * _tmp79 + _tmp89;
  const Scalar _tmp143 =
      std::asinh(_tmp124 * (Scalar(1.0) * _tmp108 * (_tmp100 * _tmp128 - _tmp133 * _tmp142) +
                            Scalar(1.0) * _tmp116 * (_tmp112 * _tmp128 - _tmp132 * _tmp133) +
                            Scalar(1.0) * _tmp119 * (-_tmp133 * _tmp140 + _tmp138) +
                            Scalar(1.0) * _tmp120 *
                                (-_tmp121 * _tmp128 - Scalar(1.0) * _tmp130 + Scalar(1.0)) +
                            Scalar(1.0) * _tmp137 * (-Scalar(1.0) * _tmp134 + _tmp135) +
                            Scalar(1.0) * _tmp141 * (-_tmp128 + _tmp139 * _tmp82)));
  ...
  const Scalar _tmp147 = _tmp102 * _tmp108 * _tmp77 + _tmp114 * _tmp116 * _tmp77 -
                         _tmp118 * _tmp119 - _tmp146 * _tmp78;
  const Scalar _tmp148 = Scalar(1.0) / (_tmp147);
  const Scalar _tmp149 = _tmp82 * fh1;
  const Scalar _tmp150 = _tmp128 * _tmp141;
  const Scalar _tmp151 =
      std::asinh(_tmp148 * (_tmp107 * _tmp142 * _tmp149 + _tmp115 * _tmp132 * _tmp149 +
                            _tmp119 * _tmp140 * _tmp82 + _tmp120 * _tmp130 -
                            _tmp125 * _tmp150 * _tmp82 + _tmp134 * _tmp137));
  ...
  const Scalar _tmp154 = _tmp101 * _tmp108 + _tmp113 * _tmp116 + _tmp117 * _tmp119 + _tmp146;
  const Scalar _tmp155 = Scalar(1.0) / (_tmp154);
  const Scalar _tmp156 =
      std::asinh(_tmp155 * (-_tmp100 * _tmp108 * _tmp127 - _tmp112 * _tmp116 * _tmp127 -
                            _tmp119 * _tmp138 + _tmp120 * _tmp129 - _tmp135 * _tmp137 + _tmp150));
  ...
  _res(1, 0) =
      _tmp144 *
          (-std::sinh(Scalar(1.0) * _tmp143) -
           std::sinh(Scalar(0.1034955) * _tmp124 * (-_tmp143 * _tmp144 - std::sqrt(_tmp45)))) -
  ...
  _res(2, 0) =
      _tmp152 *
          (-std::sinh(Scalar(1.0) * _tmp151) -
           std::sinh(Scalar(0.1034955) * _tmp148 * (-std::sqrt(_tmp145) - _tmp151 * _tmp152))) -
  ...
  _res(3, 0) =
      ...
      Scalar(8.3700199099999999) *
          std::sqrt(Scalar(Scalar(0.01427404356387209) * _tmp153 +
                           std::pow(Scalar(-Scalar(0.11947402882581673) * _tmp64 -
