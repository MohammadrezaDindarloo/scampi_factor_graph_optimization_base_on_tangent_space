...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl9(
  ...
  const Scalar _tmp99 = _tmp73 * (_tmp66 * _tmp98 - _tmp93 * _tmp98);
  const Scalar _tmp100 = _tmp39 * _tmp50 - _tmp48 - _tmp53 * (_tmp39 * _tmp48 + _tmp39 * _tmp54);
  const Scalar _tmp101 = _tmp100 + _tmp79 * (-_tmp100 * _tmp77 + _tmp39 * _tmp75 - _tmp74);
  const Scalar _tmp102 = -_tmp101 * _tmp82 - _tmp39;
  const Scalar _tmp103 = _tmp92 * _tmp95;
  const Scalar _tmp104 = _tmp41 * _tmp67;
  const Scalar _tmp105 = _tmp41 * fh1;
  const Scalar _tmp106 = _tmp96 * _tmp98;
  ...
  _res(0, 0) = 0;
  _res(1, 0) =
      -_tmp99 * std::exp(_tmp73 * _tmp95 * (_tmp66 * _tmp92 - _tmp92 * _tmp93) +
                         _tmp90 * _tmp91 * (_tmp80 * _tmp81 + _tmp83 * _tmp84) +
                         _tmp91 * _tmp94 * (_tmp101 * _tmp81 + _tmp102 * _tmp84 + Scalar(1.0)) +
                         _tmp96 * _tmp99);
  _res(2, 0) = -_tmp104 * _tmp98 *
               std::exp(-_tmp102 * _tmp105 * _tmp94 + _tmp103 * _tmp104 + _tmp104 * _tmp106 -
                        _tmp105 * _tmp83 * _tmp90);
  _res(3, 0) = _tmp98 * std::exp(-_tmp101 * _tmp107 * _tmp94 - _tmp103 - _tmp106 -
                                 _tmp107 * _tmp80 * _tmp90);
