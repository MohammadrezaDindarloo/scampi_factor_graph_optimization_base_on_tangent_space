...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1WrtFh1Nl23(
  ...
  const Scalar _tmp46 = _tmp45 + Scalar(8.3888750099999996);
  ...
  const Scalar _tmp62 = _tmp61 * (_tmp50 * _tmp56 * _tmp60 - _tmp52 * _tmp54 * _tmp60);
  const Scalar _tmp63 = -_tmp40 * _tmp49 + _tmp44 * _tmp48 + _tmp48 * _tmp62;
  const Scalar _tmp64 = _tmp57 * _tmp58;
  const Scalar _tmp65 = -Scalar(0.20999999999999999) * _tmp10 + Scalar(0.20999999999999999) * _tmp8;
  const Scalar _tmp66 = -Scalar(0.010999999999999999) * _tmp2 -
  ...
  const Scalar _tmp72 = -_tmp48 * _tmp69 + _tmp48 * _tmp71;
  const Scalar _tmp73 = _tmp57 * _tmp71;
  const Scalar _tmp74 = -_tmp48 * _tmp73 + _tmp49 * _tmp69;
  const Scalar _tmp75 = _tmp64 * _tmp74 + _tmp73;
  const Scalar _tmp76 = Scalar(1.0) * _tmp54;
  const Scalar _tmp77 = -_tmp76;
  const Scalar _tmp78 = Scalar(1.0) / (_tmp44 + _tmp77);
  const Scalar _tmp79 = Scalar(1.0) * _tmp50;
  const Scalar _tmp80 = _tmp78 * (-_tmp40 + _tmp79);
  const Scalar _tmp81 = _tmp64 * _tmp72 - _tmp71 - _tmp75 * _tmp80;
  const Scalar _tmp82 = _tmp21 + _tmp43;
  const Scalar _tmp83 = _tmp82 + p_init1;
  const Scalar _tmp84 = _tmp83 + Scalar(8.3196563700000006);
  const Scalar _tmp85 = _tmp39 + _tmp6;
  ...
  const Scalar _tmp91 = _tmp57 * _tmp90 - _tmp89;
  const Scalar _tmp92 = _tmp58 * _tmp91;
  const Scalar _tmp93 = -_tmp65;
  const Scalar _tmp94 = _tmp68 + _tmp93;
  const Scalar _tmp95 = _tmp71 * _tmp90;
  const Scalar _tmp96 = -_tmp57 * _tmp95 - _tmp74 * _tmp92 + _tmp89 * _tmp94;
  const Scalar _tmp97 = -_tmp72 * _tmp92 - _tmp80 * _tmp96 - _tmp90 * _tmp94 + _tmp95;
  const Scalar _tmp98 = Scalar(1.0) / (_tmp97);
  const Scalar _tmp99 = _tmp62 * _tmp90 - _tmp63 * _tmp92 + _tmp82 * _tmp90 - _tmp85 * _tmp89;
  const Scalar _tmp100 = _tmp98 * _tmp99;
  const Scalar _tmp101 = Scalar(1.0) / (_tmp99);
  const Scalar _tmp102 = _tmp101 * _tmp97;
  const Scalar _tmp103 = _tmp102 * (-_tmp100 * _tmp81 - _tmp62 + _tmp63 * _tmp64);
  const Scalar _tmp104 = _tmp103 + _tmp81;
  const Scalar _tmp105 = _tmp91 * _tmp98;
  const Scalar _tmp106 = _tmp58 * (-_tmp104 * _tmp105 - _tmp57);
  const Scalar _tmp107 = _tmp90 * _tmp98;
  ...
  const Scalar _tmp112 = _tmp111 * _tmp61 * (_tmp104 * _tmp107 + _tmp106 * _tmp48 + Scalar(1.0));
  const Scalar _tmp113 = _tmp108 * _tmp110;
  const Scalar _tmp114 = -_tmp111 * _tmp29 + _tmp113 * _tmp18;
  const Scalar _tmp115 = Scalar(1.0) * _tmp101;
  const Scalar _tmp116 = Scalar(1.0) * _tmp58;
  const Scalar _tmp117 =
      _tmp114 * _tmp61 * (-_tmp101 * _tmp116 * _tmp48 * _tmp91 + _tmp115 * _tmp90);
  const Scalar _tmp118 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp119 = _tmp76 * _tmp80 + _tmp79;
  const Scalar _tmp120 = 0;
  const Scalar _tmp121 = _tmp120 * _tmp98;
  const Scalar _tmp122 = _tmp105 * _tmp120 * _tmp58;
  const Scalar _tmp123 = _tmp116 * _tmp74;
  const Scalar _tmp124 = -_tmp116 * _tmp72 + _tmp123 * _tmp80;
  const Scalar _tmp125 = _tmp102 * (-_tmp100 * _tmp124 - _tmp116 * _tmp63);
  const Scalar _tmp126 = _tmp124 + _tmp125;
  const Scalar _tmp127 = _tmp58 * (-_tmp105 * _tmp126 + Scalar(1.0));
  const Scalar _tmp128 = _tmp113 * _tmp61 * (_tmp107 * _tmp126 + _tmp127 * _tmp48);
  const Scalar _tmp129 = -_tmp112 * fh1 - _tmp117 * fh1 -
                         _tmp118 * _tmp61 * (_tmp121 * _tmp90 - _tmp122 * _tmp48) - _tmp128 * fh1;
  const Scalar _tmp130 = Scalar(1.0) / (_tmp129);
  const Scalar _tmp131 = _tmp96 * _tmp98;
  const Scalar _tmp132 = _tmp77 + _tmp82;
  const Scalar _tmp133 = _tmp132 * _tmp80;
  const Scalar _tmp134 = Scalar(1.0) / (-_tmp133 + _tmp79 - _tmp85);
  const Scalar _tmp135 = _tmp132 * _tmp134;
  const Scalar _tmp136 = -_tmp123 + _tmp125 * _tmp135 - _tmp126 * _tmp131;
  const Scalar _tmp137 = Scalar(1.0) * _tmp78;
  const Scalar _tmp138 = Scalar(1.0) * _tmp134;
  const Scalar _tmp139 = Scalar(1.0) * _tmp113 * (_tmp125 * _tmp138 - _tmp136 * _tmp137);
  const Scalar _tmp140 = _tmp103 * _tmp135 - _tmp104 * _tmp131 + _tmp75;
  const Scalar _tmp141 = Scalar(1.0) * _tmp111 * (_tmp103 * _tmp138 - _tmp137 * _tmp140);
  const Scalar _tmp142 = _tmp102 * _tmp138;
  const Scalar _tmp143 = _tmp78 * (-_tmp115 * _tmp96 + _tmp132 * _tmp142);
  const Scalar _tmp144 = Scalar(1.0) * _tmp114;
  const Scalar _tmp145 = _tmp144 * (_tmp142 - Scalar(1.0) * _tmp143);
  const Scalar _tmp146 = _tmp70 + _tmp93;
  const Scalar _tmp147 = _tmp146 * fh1;
  const Scalar _tmp148 = -_tmp113 * _tmp147 - Scalar(3.29616) * _tmp26 - _tmp29 * fv1;
  const Scalar _tmp149 = _tmp133 * _tmp138 + Scalar(1.0);
  const Scalar _tmp150 = _tmp138 * _tmp80;
  const Scalar _tmp151 = -Scalar(1.0) * _tmp137 * _tmp149 + Scalar(1.0) * _tmp150;
  const Scalar _tmp152 = Scalar(3.29616) * _tmp11 + _tmp111 * _tmp147 + _tmp18 * fv1;
  const Scalar _tmp153 = _tmp132 * _tmp78;
  const Scalar _tmp154 = Scalar(1.0) * _tmp138 * _tmp153 - Scalar(1.0) * _tmp138;
  const Scalar _tmp155 = _tmp119 * _tmp134;
  const Scalar _tmp156 = -_tmp121 * _tmp96 - _tmp132 * _tmp155 + _tmp77;
  const Scalar _tmp157 =
      Scalar(1.0) * _tmp118 * (-_tmp119 * _tmp138 - _tmp137 * _tmp156 + Scalar(1.0)) +
      _tmp139 * fh1 + _tmp141 * fh1 + _tmp145 * fh1 + _tmp148 * _tmp151 + _tmp152 * _tmp154;
  ...
  const Scalar _tmp164 = -_tmp112 - _tmp117 - _tmp128;
  ...
  const Scalar _tmp168 = _tmp111 * _tmp146;
  const Scalar _tmp169 = _tmp113 * _tmp146;
  const Scalar _tmp170 =
      (_tmp130 * (_tmp139 + _tmp141 + _tmp145 - _tmp151 * _tmp169 + _tmp154 * _tmp168) -
       _tmp157 * _tmp167) /
      std::sqrt(Scalar(std::pow(_tmp157, Scalar(2)) * _tmp166 + 1));
  const Scalar _tmp171 = _tmp113 * _tmp127;
  const Scalar _tmp172 = _tmp101 * _tmp144;
  const Scalar _tmp173 = _tmp172 * fh1;
  const Scalar _tmp174 = _tmp106 * _tmp111;
  const Scalar _tmp175 = -_tmp118 * _tmp122 + _tmp171 * fh1 - _tmp173 * _tmp92 + _tmp174 * fh1;
  const Scalar _tmp176 = Scalar(1.0) / (_tmp175);
  const Scalar _tmp177 = _tmp114 * _tmp143;
  const Scalar _tmp178 = _tmp149 * _tmp78;
  const Scalar _tmp179 = _tmp138 * _tmp152;
  const Scalar _tmp180 = _tmp111 * _tmp78;
  const Scalar _tmp181 = _tmp140 * _tmp180;
  const Scalar _tmp182 = _tmp113 * _tmp136 * _tmp78;
  const Scalar _tmp183 = _tmp118 * _tmp156 * _tmp78 + _tmp148 * _tmp178 - _tmp153 * _tmp179 +
  ...
  const Scalar _tmp190 = _tmp171 - _tmp172 * _tmp92 + _tmp174;
  const Scalar _tmp191 = _tmp189 * _tmp190;
  const Scalar _tmp192 = Scalar(9.6622558468725703) * _tmp190;
  const Scalar _tmp193 = (_tmp176 * (-_tmp132 * _tmp138 * _tmp146 * _tmp180 - _tmp169 * _tmp178 +
                                     _tmp177 + _tmp181 + _tmp182) -
                          _tmp183 * _tmp191) /
                         std::sqrt(Scalar(std::pow(_tmp183, Scalar(2)) * _tmp189 + 1));
  const Scalar _tmp194 = Scalar(1.0) * _tmp184;
  const Scalar _tmp195 = _tmp113 * _tmp126 * _tmp98;
  const Scalar _tmp196 = _tmp104 * _tmp111 * _tmp98;
  const Scalar _tmp197 = _tmp118 * _tmp121 + _tmp173 + _tmp195 * fh1 + _tmp196 * fh1;
  const Scalar _tmp198 = Scalar(1.0) / (_tmp197);
  const Scalar _tmp199 = _tmp103 * _tmp111 * _tmp134;
  const Scalar _tmp200 = _tmp113 * _tmp125 * _tmp134;
  const Scalar _tmp201 = _tmp114 * _tmp142;
  const Scalar _tmp202 = _tmp118 * _tmp155 - _tmp148 * _tmp150 + _tmp179 - _tmp199 * fh1 -
                         _tmp200 * fh1 - _tmp201 * fh1;
  const Scalar _tmp203 = std::asinh(_tmp198 * _tmp202);
  const Scalar _tmp204 = Scalar(1.0) * _tmp203;
  const Scalar _tmp205 = Scalar(9.6622558468725703) * _tmp203;
  ...
  const Scalar _tmp213 =
      (_tmp198 * (_tmp138 * _tmp168 + _tmp150 * _tmp169 - _tmp199 - _tmp200 - _tmp201) -
       _tmp202 * _tmp212) /
  ...
  _res(1, 0) =
      -_tmp159 *
          (-Scalar(0.86565325453551001) * _tmp167 + Scalar(1.0) * _tmp170 * std::sinh(_tmp163) -
           (-Scalar(0.1034955) * _tmp160 * _tmp167 +
            _tmp161 * (-_tmp158 * _tmp165 - _tmp159 * _tmp170)) *
               std::sinh(_tmp162)) -
      _tmp165 * (Scalar(0.86565325453551001) * _tmp130 - std::cosh(_tmp162) + std::cosh(_tmp163));
  _res(2, 0) =
      -_tmp185 *
          (-Scalar(0.87653584775870996) * _tmp191 + Scalar(1.0) * _tmp193 * std::sinh(_tmp194) -
           (-Scalar(0.1034955) * _tmp186 * _tmp191 +
            _tmp187 * (-_tmp184 * _tmp192 - _tmp185 * _tmp193)) *
               std::sinh(_tmp188)) -
      _tmp192 * (Scalar(0.87653584775870996) * _tmp176 - std::cosh(_tmp188) + std::cosh(_tmp194));
  _res(3, 0) =
      -Scalar(9.6622558468725703) * _tmp209 *
          (Scalar(0.87679799772039002) * _tmp198 + std::cosh(_tmp204) - std::cosh(_tmp208)) -
      _tmp210 *
          (-Scalar(0.87679799772039002) * _tmp212 + Scalar(1.0) * _tmp213 * std::sinh(_tmp204) -
