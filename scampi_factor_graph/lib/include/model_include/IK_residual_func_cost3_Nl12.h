...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl12(
  ...
  const Scalar _tmp59 = _tmp39 + _tmp4;
  const Scalar _tmp60 = _tmp17 + _tmp36;
  const Scalar _tmp61 = _tmp60 + p_init1 + Scalar(-4.7752063900000001);
  const Scalar _tmp62 = _tmp59 + p_init0 + Scalar(-2.71799795);
  ...
  const Scalar _tmp75 = -_tmp35 * _tmp74 + _tmp50 * _tmp71;
  const Scalar _tmp76 = Scalar(1.0) * _tmp29;
  const Scalar _tmp77 = Scalar(1.0) * _tmp32;
  const Scalar _tmp78 = (-_tmp15 + _tmp77) / (_tmp24 - _tmp76);
  const Scalar _tmp79 = -_tmp27 * _tmp71 + _tmp74;
  const Scalar _tmp80 = _tmp56 * _tmp75 * _tmp78 - _tmp56 * _tmp79;
  const Scalar _tmp81 = _tmp68 + _tmp69 + _tmp72;
  const Scalar _tmp82 = _tmp35 * _tmp73;
  const Scalar _tmp83 = _tmp43 * _tmp73 - _tmp43 * _tmp81 - _tmp53 * _tmp79 -
                        _tmp78 * (-_tmp43 * _tmp82 + _tmp44 * _tmp81 - _tmp53 * _tmp75);
  const Scalar _tmp84 = Scalar(1.0) / (_tmp83);
  const Scalar _tmp85 = _tmp54 * _tmp84;
  const Scalar _tmp86 = _tmp55 * _tmp83;
  const Scalar _tmp87 = _tmp80 + _tmp86 * (-_tmp51 * _tmp56 - _tmp80 * _tmp85);
  const Scalar _tmp88 = _tmp43 * _tmp84;
  const Scalar _tmp89 = _tmp45 * _tmp84;
  const Scalar _tmp90 = -_tmp87 * _tmp89 + Scalar(1.0);
  const Scalar _tmp91 = _tmp27 * _tmp52;
  const Scalar _tmp92 = _tmp64 * fh1;
  const Scalar _tmp93 = _tmp35 * _tmp52;
  const Scalar _tmp94 = -_tmp73 - _tmp78 * (_tmp75 * _tmp93 + _tmp82) + _tmp79 * _tmp93;
  const Scalar _tmp95 = _tmp86 * (-_tmp49 + _tmp51 * _tmp93 - _tmp85 * _tmp94) + _tmp94;
  const Scalar _tmp96 = -_tmp35 - _tmp89 * _tmp95;
  const Scalar _tmp97 = _tmp65 * fh1;
  ...
  _res(1, 0) = std::exp(_tmp48 * _tmp66 * (-_tmp27 * _tmp57 + _tmp43 * _tmp58) +
                        _tmp48 * _tmp92 * (_tmp87 * _tmp88 + _tmp90 * _tmp91) +
                        _tmp48 * _tmp97 * (_tmp88 * _tmp95 + _tmp91 * _tmp96 + Scalar(1.0)) +
                        _tmp48 * _tmp98 * (-_tmp100 * _tmp27 * _tmp53 + _tmp100 * _tmp43));
  _res(2, 0) = std::exp(_tmp101 * _tmp53 - _tmp52 * _tmp90 * _tmp92 - _tmp52 * _tmp96 * _tmp97 +
                        _tmp57 * _tmp66);
  _res(3, 0) =
      std::exp(-_tmp101 - _tmp58 * _tmp66 - _tmp84 * _tmp87 * _tmp92 - _tmp84 * _tmp95 * _tmp97);
