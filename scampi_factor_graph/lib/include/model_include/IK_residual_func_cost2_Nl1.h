...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2Nl1(const Scalar fh1, const Scalar fv1,
  ...
  const Scalar _tmp41 = _tmp21 + _tmp28;
  ...
  const Scalar _tmp53 = -_tmp40 * _tmp49 + _tmp52;
  const Scalar _tmp54 = _tmp43 * _tmp48;
  ...
  const Scalar _tmp64 = Scalar(1.0) / (_tmp49 * _tmp63 - _tmp54);
  const Scalar _tmp65 = Scalar(1.0) * _tmp64;
  const Scalar _tmp66 = Scalar(1.0) * _tmp60;
  const Scalar _tmp67 = -_tmp66;
  const Scalar _tmp68 = Scalar(1.0) / (_tmp41 + _tmp67);
  const Scalar _tmp69 = Scalar(1.0) * _tmp55;
  const Scalar _tmp70 = _tmp68 * (-_tmp45 + _tmp69);
  const Scalar _tmp71 = _tmp40 * _tmp54 - _tmp52 * _tmp63;
  const Scalar _tmp72 = _tmp65 * _tmp71;
  const Scalar _tmp73 = -_tmp53 * _tmp65 + _tmp70 * _tmp72;
  const Scalar _tmp74 =
  ...
  const Scalar _tmp87 = _tmp41 * _tmp49 - _tmp45 * _tmp54 + _tmp49 * _tmp77;
  const Scalar _tmp88 = _tmp63 * _tmp85 - _tmp86;
  const Scalar _tmp89 = _tmp64 * _tmp88;
  const Scalar _tmp90 = _tmp77 * _tmp85 - _tmp78 * _tmp86 + _tmp81 * _tmp85 - _tmp87 * _tmp89;
  const Scalar _tmp91 = _tmp34 + _tmp50;
  const Scalar _tmp92 = _tmp51 * _tmp63;
  const Scalar _tmp93 = -_tmp71 * _tmp89 - _tmp85 * _tmp92 + _tmp86 * _tmp91;
  const Scalar _tmp94 = _tmp51 * _tmp85 - _tmp53 * _tmp89 - _tmp70 * _tmp93 - _tmp85 * _tmp91;
  ...
  const Scalar _tmp99 = _tmp98 * (-_tmp65 * _tmp87 - _tmp73 * _tmp96);
  const Scalar _tmp100 = _tmp73 + _tmp99;
  const Scalar _tmp101 = _tmp85 * _tmp95;
  const Scalar _tmp102 = _tmp88 * _tmp95;
  const Scalar _tmp103 = -_tmp100 * _tmp102 + Scalar(1.0);
  const Scalar _tmp104 = _tmp49 * _tmp64;
  const Scalar _tmp105 = _tmp30 + Scalar(8.3196563700000006);
  const Scalar _tmp106 = _tmp19 + Scalar(1.9874742000000001);
  ...
  const Scalar _tmp111 = _tmp66 * _tmp70 + _tmp69;
  ...
  const Scalar _tmp116 = _tmp115 * _tmp71 + _tmp92;
  const Scalar _tmp117 = _tmp115 * _tmp53 - _tmp116 * _tmp70 - _tmp51;
  const Scalar _tmp118 = _tmp98 * (_tmp115 * _tmp87 - _tmp117 * _tmp96 - _tmp77);
  ...
  const Scalar _tmp124 = fh1 * (_tmp108 * _tmp18 - _tmp121 * _tmp29);
  const Scalar _tmp125 = -_tmp109 * _tmp76 * (_tmp100 * _tmp101 + _tmp103 * _tmp104) -
                         _tmp110 * _tmp76 * (-_tmp113 * _tmp114 + _tmp113 * _tmp85) -
                         _tmp122 * _tmp76 * (_tmp101 * _tmp119 + _tmp104 * _tmp120 + Scalar(1.0)) -
                         _tmp124 * _tmp76 * (-_tmp114 * _tmp123 + _tmp123 * _tmp85);
  const Scalar _tmp126 = Scalar(1.0) / (_tmp125);
  const Scalar _tmp127 = Scalar(6.351516257848961) *
  ...
  const Scalar _tmp128 = _tmp67 + _tmp81;
  const Scalar _tmp129 = _tmp128 * _tmp70;
  const Scalar _tmp130 = Scalar(1.0) / (-_tmp129 + _tmp69 - _tmp78);
  const Scalar _tmp131 = Scalar(1.0) * _tmp130;
  const Scalar _tmp132 = _tmp93 * _tmp95;
  const Scalar _tmp133 = _tmp128 * _tmp130;
  const Scalar _tmp134 = _tmp116 + _tmp118 * _tmp133 - _tmp119 * _tmp132;
  const Scalar _tmp135 = Scalar(1.0) * _tmp68;
  const Scalar _tmp136 = Scalar(1.0) * fh1;
  const Scalar _tmp137 = _tmp39 * fh1;
  const Scalar _tmp138 = Scalar(3.29616) * _tmp12 + _tmp121 * _tmp137 + _tmp18 * fv1;
  const Scalar _tmp139 = _tmp128 * _tmp131;
  const Scalar _tmp140 = _tmp111 * _tmp130;
  const Scalar _tmp141 = _tmp68 * (-_tmp112 * _tmp132 - _tmp128 * _tmp140 + _tmp67);
  const Scalar _tmp142 = -_tmp108 * _tmp137 - Scalar(3.29616) * _tmp26 - _tmp29 * fv1;
  const Scalar _tmp143 = _tmp129 * _tmp131 + Scalar(1.0);
  const Scalar _tmp144 = _tmp131 * _tmp70;
  const Scalar _tmp145 = -_tmp100 * _tmp132 + _tmp133 * _tmp99 - _tmp72;
  const Scalar _tmp146 = _tmp131 * _tmp98;
  const Scalar _tmp147 = -_tmp123 * _tmp93 + _tmp139 * _tmp98;
  const Scalar _tmp148 =
      std::asinh(_tmp126 * (_tmp108 * _tmp136 * (_tmp131 * _tmp99 - _tmp135 * _tmp145) +
                            Scalar(1.0) * _tmp110 *
                                (-_tmp111 * _tmp131 - Scalar(1.0) * _tmp141 + Scalar(1.0)) +
                            _tmp121 * _tmp136 * (_tmp118 * _tmp131 - _tmp134 * _tmp135) +
                            Scalar(1.0) * _tmp124 * (-_tmp135 * _tmp147 + _tmp146) +
                            Scalar(1.0) * _tmp138 * (-_tmp131 + _tmp139 * _tmp68) +
                            Scalar(1.0) * _tmp142 * (-_tmp135 * _tmp143 + _tmp144)));
  const Scalar _tmp149 = Scalar(9.6622558468725703) * _tmp125;
  const Scalar _tmp150 = Scalar(23.361089618893828) *
  ...
  const Scalar _tmp152 = _tmp110 * _tmp113;
  const Scalar _tmp153 =
      _tmp103 * _tmp109 * _tmp64 + _tmp120 * _tmp122 * _tmp64 - _tmp151 * _tmp89 - _tmp152 * _tmp89;
  const Scalar _tmp154 = Scalar(1.0) / (_tmp153);
  const Scalar _tmp155 = _tmp131 * _tmp138;
  const Scalar _tmp156 =
      std::asinh(_tmp154 * (_tmp109 * _tmp145 * _tmp68 + _tmp110 * _tmp141 +
                            _tmp122 * _tmp134 * _tmp68 + _tmp124 * _tmp147 * _tmp68 -
                            _tmp128 * _tmp155 * _tmp68 + _tmp142 * _tmp143 * _tmp68));
  const Scalar _tmp157 = Scalar(9.6622558468725703) * _tmp153;
  const Scalar _tmp158 = Scalar(7.3875128562042027) *
  ...
  const Scalar _tmp159 =
      _tmp100 * _tmp109 * _tmp95 + _tmp119 * _tmp122 * _tmp95 + _tmp151 + _tmp152;
  const Scalar _tmp160 = Scalar(1.0) / (_tmp159);
  const Scalar _tmp161 = std::asinh(_tmp160 * (-_tmp109 * _tmp130 * _tmp99 + _tmp110 * _tmp140 -
                                               _tmp118 * _tmp122 * _tmp130 - _tmp124 * _tmp146 -
                                               _tmp142 * _tmp144 + _tmp155));
  ...
  _res(1, 0) =
      _tmp149 *
          (-std::sinh(Scalar(1.0) * _tmp148) -
           std::sinh(Scalar(0.1034955) * _tmp126 * (-std::sqrt(_tmp127) - _tmp148 * _tmp149))) -
      Scalar(8.4693136199999994) *
          std::sqrt(Scalar(Scalar(0.013941309530580858) * _tmp127 +
                           std::pow(Scalar(-Scalar(0.11807332268798426) * _tmp51 -
                                           Scalar(0.11807332268798426) * p_init2 + 1),
                                    Scalar(2))));
  _res(2, 0) =
      _tmp157 *
          (-std::sinh(Scalar(1.0) * _tmp156) -
           std::sinh(Scalar(0.1034955) * _tmp154 * (-std::sqrt(_tmp150) - _tmp156 * _tmp157))) -
      Scalar(8.3700199099999999) *
          std::sqrt(Scalar(Scalar(0.01427404356387209) * _tmp150 +
                           std::pow(Scalar(-Scalar(0.11947402882581673) * _tmp40 -
                                           Scalar(0.11947402882581673) * p_init2 + 1),
                                    Scalar(2))));
  _res(3, 0) =
      _tmp162 *
          (-std::sinh(Scalar(1.0) * _tmp161) -
           std::sinh(Scalar(0.1034955) * _tmp160 * (-std::sqrt(_tmp158) - _tmp161 * _tmp162))) -
      Scalar(8.36416322) *
          std::sqrt(Scalar(Scalar(0.014294040284261563) * _tmp158 +
                           std::pow(Scalar(-Scalar(0.1195576860108189) * _tmp91 -
