...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl2(const Scalar fh1, const Scalar fv1,
  ...
  const Scalar _tmp96 = _tmp37 * _tmp56 - _tmp54 - _tmp63 * (_tmp37 * _tmp54 + _tmp37 * _tmp71);
  const Scalar _tmp97 = _tmp80 * (_tmp37 * _tmp78 - _tmp74 - _tmp77 * _tmp96) + _tmp96;
  const Scalar _tmp98 = -_tmp37 - _tmp83 * _tmp97;
  const Scalar _tmp99 = _tmp93 * _tmp95;
  const Scalar _tmp100 = _tmp0 * _tmp67;
  const Scalar _tmp101 = _tmp48 * fh1;
  ...
  _res(1, 0) = std::exp(_tmp0 * _tmp70 * (_tmp29 * _tmp67 - _tmp67 * _tmp68) +
                        _tmp70 * _tmp95 * (_tmp29 * _tmp93 - _tmp68 * _tmp93) +
                        _tmp91 * _tmp92 * (_tmp81 * _tmp82 + _tmp84 * _tmp85) +
                        _tmp92 * _tmp94 * (_tmp82 * _tmp97 + _tmp85 * _tmp98 + Scalar(1.0)));
  _res(2, 0) = std::exp(_tmp100 * _tmp60 - _tmp101 * _tmp84 * _tmp91 - _tmp101 * _tmp94 * _tmp98 +
                        _tmp60 * _tmp99);
  _res(3, 0) = std::exp(-_tmp100 - _tmp102 * _tmp81 * _tmp91 - _tmp102 * _tmp94 * _tmp97 - _tmp99);
