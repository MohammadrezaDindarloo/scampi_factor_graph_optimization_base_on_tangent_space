...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl5(
  ...
  const Scalar _tmp53 = _tmp52 * (-_tmp44 * _tmp48 * _tmp50 + _tmp46 * _tmp47 * _tmp50);
  const Scalar _tmp54 = _tmp36 * _tmp41;
  const Scalar _tmp55 = _tmp18 + _tmp43;
  const Scalar _tmp56 = _tmp45 + _tmp55;
  const Scalar _tmp57 = _tmp37 + _tmp7;
  ...
  const Scalar _tmp62 = _tmp53 * _tmp60 + _tmp55 * _tmp60 - _tmp57 * _tmp61;
  const Scalar _tmp63 = _tmp46 * _tmp51;
  const Scalar _tmp64 = _tmp42 * _tmp63 - _tmp54;
  const Scalar _tmp65 = Scalar(1.0) / (_tmp60 * _tmp63 - _tmp61);
  const Scalar _tmp66 = _tmp64 * _tmp65;
  const Scalar _tmp67 = _tmp35 * _tmp42 - _tmp38 * _tmp54 + _tmp42 * _tmp53 - _tmp62 * _tmp66;
  const Scalar _tmp68 = Scalar(1.0) / (_tmp67);
  const Scalar _tmp69 = Scalar(1.0) * _tmp68;
  const Scalar _tmp70 = _tmp60 * _tmp66;
  const Scalar _tmp71 = _tmp34 * _tmp52 * (_tmp42 * _tmp69 - _tmp69 * _tmp70);
  const Scalar _tmp72 = _tmp63 * _tmp65;
  ...
  const Scalar _tmp80 = _tmp61 * _tmp79 - _tmp63 * _tmp78;
  const Scalar _tmp81 = Scalar(1.0) * _tmp44;
  const Scalar _tmp82 = Scalar(1.0) * _tmp47;
  const Scalar _tmp83 = (-_tmp57 + _tmp82) / (_tmp55 - _tmp81);
  const Scalar _tmp84 = -_tmp60 * _tmp79 + _tmp78;
  const Scalar _tmp85 = _tmp72 * _tmp84 - _tmp77 - _tmp83 * (_tmp63 * _tmp77 + _tmp72 * _tmp80);
  const Scalar _tmp86 = _tmp73 + _tmp74 - _tmp75;
  const Scalar _tmp87 = _tmp42 * _tmp77;
  const Scalar _tmp88 = -_tmp42 * _tmp86 - _tmp66 * _tmp84 -
                        _tmp83 * (_tmp54 * _tmp86 - _tmp63 * _tmp87 - _tmp66 * _tmp80) + _tmp87;
  const Scalar _tmp89 = Scalar(1.0) / (_tmp88);
  const Scalar _tmp90 = _tmp67 * _tmp89;
  const Scalar _tmp91 = _tmp68 * _tmp88;
  const Scalar _tmp92 = _tmp85 + _tmp91 * (-_tmp53 + _tmp62 * _tmp72 - _tmp85 * _tmp90);
  const Scalar _tmp93 = _tmp42 * _tmp89;
  const Scalar _tmp94 = _tmp64 * _tmp89;
  const Scalar _tmp95 = _tmp65 * (-_tmp63 - _tmp92 * _tmp94);
  const Scalar _tmp96 = _tmp33 * _tmp52 * (_tmp60 * _tmp95 + _tmp92 * _tmp93 + Scalar(1.0));
  const Scalar _tmp97 = Scalar(333.54000000000002) - fv1;
  const Scalar _tmp98 = _tmp81 * _tmp83 + _tmp82;
  const Scalar _tmp99 = 0;
  const Scalar _tmp100 = Scalar(1.0) * _tmp65;
  const Scalar _tmp101 = _tmp100 * _tmp80 * _tmp83 - _tmp100 * _tmp84;
  const Scalar _tmp102 = _tmp101 + _tmp91 * (-_tmp100 * _tmp62 - _tmp101 * _tmp90);
  const Scalar _tmp103 = _tmp65 * (-_tmp102 * _tmp94 + Scalar(1.0));
  const Scalar _tmp104 = _tmp32 * _tmp52 * (_tmp102 * _tmp93 + _tmp103 * _tmp60);
  const Scalar _tmp105 = _tmp34 * _tmp69;
  const Scalar _tmp106 = _tmp105 * fh1;
  const Scalar _tmp107 = _tmp33 * _tmp95;
  const Scalar _tmp108 = _tmp97 * _tmp99;
  const Scalar _tmp109 = _tmp103 * _tmp32;
  const Scalar _tmp110 = _tmp33 * _tmp89 * _tmp92;
  const Scalar _tmp111 = _tmp102 * _tmp32 * _tmp89;

  // Output terms (1)
  Eigen::Matrix<Scalar, 4, 1> _res;

  _res(0, 0) = -std::exp(-fh1);
  _res(1, 0) = -(-_tmp104 - _tmp71 - _tmp96) *
               std::exp(_tmp104 * fh1 + _tmp52 * _tmp97 * (_tmp42 * _tmp99 - _tmp70 * _tmp99) +
                        _tmp71 * fh1 + _tmp96 * fh1);
  _res(2, 0) = -(-_tmp105 * _tmp66 + _tmp107 + _tmp109) *
               std::exp(_tmp106 * _tmp66 - _tmp107 * fh1 + _tmp108 * _tmp66 - _tmp109 * fh1);
  _res(3, 0) =
      -(_tmp105 + _tmp110 + _tmp111) * std::exp(-_tmp106 - _tmp108 - _tmp110 * fh1 - _tmp111 * fh1);
