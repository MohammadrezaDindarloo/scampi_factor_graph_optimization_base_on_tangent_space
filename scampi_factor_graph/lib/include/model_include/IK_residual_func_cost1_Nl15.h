...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl15(
  ...
  const Scalar _tmp32 = -Scalar(0.010999999999999999) * _tmp10 -
  ...
  const Scalar _tmp51 = -_tmp37 * _tmp47 + _tmp50;
  ...
  const Scalar _tmp67 = _tmp37 * _tmp52 - _tmp50 * _tmp62;
  const Scalar _tmp68 = Scalar(1.0) * _tmp59;
  const Scalar _tmp69 = -_tmp68;
  const Scalar _tmp70 = Scalar(1.0) / (_tmp39 + _tmp69);
  const Scalar _tmp71 = Scalar(1.0) * _tmp70;
  const Scalar _tmp72 = -_tmp51 * _tmp64 + _tmp63 * _tmp66 * _tmp67 * _tmp71;
  const Scalar _tmp73 = _tmp36 + _tmp48;
  const Scalar _tmp74 = _tmp38 + _tmp58;
  const Scalar _tmp75 = _tmp74 + p_init1;
  const Scalar _tmp76 = _tmp75 + Scalar(8.3196563700000006);
  const Scalar _tmp77 = _tmp42 + _tmp53;
  ...
  const Scalar _tmp84 = _tmp62 * _tmp82 - _tmp81;
  const Scalar _tmp85 = _tmp63 * _tmp84;
  const Scalar _tmp86 = -_tmp62 * _tmp83 - _tmp67 * _tmp85 + _tmp73 * _tmp81;
  const Scalar _tmp87 = _tmp66 * _tmp70;
  const Scalar _tmp88 = -_tmp51 * _tmp85 - _tmp73 * _tmp82 + _tmp83 - _tmp86 * _tmp87;
  ...
  const Scalar _tmp94 = _tmp39 * _tmp47 - _tmp43 * _tmp52 + _tmp47 * _tmp93;
  const Scalar _tmp95 = _tmp74 * _tmp82 - _tmp77 * _tmp81 + _tmp82 * _tmp93 - _tmp85 * _tmp94;
  const Scalar _tmp96 = _tmp89 * _tmp95;
  const Scalar _tmp97 = Scalar(1.0) / (_tmp95);
  const Scalar _tmp98 = _tmp88 * _tmp97;
  const Scalar _tmp99 = _tmp98 * (-_tmp64 * _tmp94 - _tmp72 * _tmp96);
  ...
  const Scalar _tmp105 = _tmp19 + Scalar(-2.71799795);
  const Scalar _tmp106 = _tmp29 + Scalar(-4.7752063900000001);
  ...
  const Scalar _tmp112 = fh1 * (_tmp108 * _tmp18 - _tmp111 * _tmp28);
  const Scalar _tmp113 = _tmp62 * _tmp63;
  const Scalar _tmp114 = _tmp113 * _tmp67 + _tmp49 * _tmp62;
  const Scalar _tmp115 = _tmp113 * _tmp51 - _tmp114 * _tmp87 - _tmp49;
  const Scalar _tmp116 = _tmp98 * (_tmp113 * _tmp94 - _tmp115 * _tmp96 - _tmp93);
  const Scalar _tmp117 = _tmp115 + _tmp116;
  const Scalar _tmp118 = -_tmp102 * _tmp117 - _tmp62;
  const Scalar _tmp119 = _tmp111 * fh1;
  const Scalar _tmp120 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp121 = _tmp65 + _tmp68 * _tmp87;
  const Scalar _tmp122 = 0;
  const Scalar _tmp123 = _tmp122 * _tmp89;
  const Scalar _tmp124 = _tmp102 * _tmp122;
  const Scalar _tmp125 = -_tmp109 * _tmp92 * (_tmp100 * _tmp101 + _tmp103 * _tmp104) -
                         _tmp112 * _tmp92 * (-_tmp110 * _tmp47 * _tmp85 + _tmp110 * _tmp82) -
                         _tmp119 * _tmp92 * (_tmp101 * _tmp117 + _tmp104 * _tmp118 + Scalar(1.0)) -
                         _tmp120 * _tmp92 * (-_tmp104 * _tmp124 + _tmp123 * _tmp82);
  const Scalar _tmp126 = Scalar(1.0) / (_tmp125);
  const Scalar _tmp127 = _tmp69 + _tmp74;
  const Scalar _tmp128 = _tmp127 * _tmp87;
  const Scalar _tmp129 = Scalar(1.0) / (-_tmp128 + _tmp65 - _tmp77);
  const Scalar _tmp130 = Scalar(1.0) * _tmp129;
  const Scalar _tmp131 = _tmp121 * _tmp129;
  const Scalar _tmp132 = _tmp86 * _tmp89;
  const Scalar _tmp133 = -_tmp122 * _tmp132 - _tmp127 * _tmp131 + _tmp69;
  const Scalar _tmp134 = _tmp35 * fh1;
  const Scalar _tmp135 = -_tmp108 * _tmp134 - Scalar(3.29616) * _tmp25 - _tmp28 * fv1;
  const Scalar _tmp136 = _tmp128 * _tmp130 + Scalar(1.0);
  const Scalar _tmp137 = _tmp130 * _tmp87;
  const Scalar _tmp138 = _tmp127 * _tmp129;
  const Scalar _tmp139 = -_tmp100 * _tmp132 + _tmp138 * _tmp99 - _tmp64 * _tmp67;
  const Scalar _tmp140 = _tmp130 * _tmp98;
  const Scalar _tmp141 = -_tmp110 * _tmp86 + _tmp127 * _tmp140;
  const Scalar _tmp142 = _tmp114 + _tmp116 * _tmp138 - _tmp117 * _tmp132;
  const Scalar _tmp143 = _tmp127 * _tmp70;
  const Scalar _tmp144 = _tmp111 * _tmp134 + Scalar(3.29616) * _tmp15 + _tmp18 * fv1;
  const Scalar _tmp145 = std::asinh(
      _tmp126 * (Scalar(1.0) * _tmp109 * (_tmp130 * _tmp99 - _tmp139 * _tmp71) +
                 Scalar(1.0) * _tmp112 * (_tmp140 - _tmp141 * _tmp71) +
                 Scalar(1.0) * _tmp119 * (_tmp116 * _tmp130 - _tmp142 * _tmp71) +
                 Scalar(1.0) * _tmp120 * (-_tmp121 * _tmp130 - _tmp133 * _tmp71 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp135 * (-_tmp136 * _tmp71 + _tmp137) +
                 Scalar(1.0) * _tmp144 * (_tmp130 * _tmp143 - _tmp130)));
  const Scalar _tmp146 = Scalar(9.6622558468725703) * _tmp125;
  const Scalar _tmp147 = _tmp130 * _tmp144;
  const Scalar _tmp148 = _tmp110 * _tmp112;
  const Scalar _tmp149 = _tmp103 * _tmp109 * _tmp63 + _tmp118 * _tmp119 * _tmp63 -
                         _tmp120 * _tmp124 * _tmp63 - _tmp148 * _tmp85;
  const Scalar _tmp150 = Scalar(1.0) / (_tmp149);
  const Scalar _tmp151 =
      std::asinh(_tmp150 * (_tmp109 * _tmp139 * _tmp70 + _tmp112 * _tmp141 * _tmp70 +
                            _tmp119 * _tmp142 * _tmp70 + _tmp120 * _tmp133 * _tmp70 +
                            _tmp135 * _tmp136 * _tmp70 - _tmp143 * _tmp147));
  const Scalar _tmp152 = Scalar(9.6622558468725703) * _tmp149;
  const Scalar _tmp153 =
      _tmp100 * _tmp109 * _tmp89 + _tmp117 * _tmp119 * _tmp89 + _tmp120 * _tmp123 + _tmp148;
  const Scalar _tmp154 = Scalar(1.0) / (_tmp153);
  const Scalar _tmp155 = std::asinh(_tmp154 * (-_tmp109 * _tmp129 * _tmp99 - _tmp112 * _tmp140 -
                                               _tmp116 * _tmp119 * _tmp129 + _tmp120 * _tmp131 -
                                               _tmp135 * _tmp137 + _tmp147));
               ...
               (-_tmp145 * _tmp146 -
                Scalar(8.3888750099999996) *
                    std::sqrt(Scalar(
                        ...
                        std::pow(Scalar(-Scalar(0.11920549523123722) * _tmp60 - 1),
                                 Scalar(2))))))) +
      _tmp49 + p_init2;
  _res(2, 0) =
      -_tmp152 *
