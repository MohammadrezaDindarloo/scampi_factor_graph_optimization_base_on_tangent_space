...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl23(
  ...
  const Scalar _tmp53 = _tmp38 * _tmp51;
  const Scalar _tmp54 = _tmp53 * (-_tmp33 * _tmp37 * _tmp52 + _tmp35 * _tmp36 * _tmp52);
  const Scalar _tmp55 = _tmp18 * _tmp30;
  const Scalar _tmp56 = _tmp16 * _tmp31 - _tmp27 * _tmp55 + _tmp31 * _tmp54;
  const Scalar _tmp57 = Scalar(1.0) / (_tmp31 * _tmp39 - _tmp55);
  const Scalar _tmp58 = _tmp50 * _tmp57;
  const Scalar _tmp59 = _tmp41 * _tmp48 - _tmp44 * _tmp49 + _tmp48 * _tmp54 - _tmp56 * _tmp58;
  const Scalar _tmp60 = Scalar(1.0) / (_tmp59);
  const Scalar _tmp61 = Scalar(1.0) * _tmp57;
  const Scalar _tmp62 = _tmp50 * _tmp60 * _tmp61;
  const Scalar _tmp63 = Scalar(1.0) * _tmp60;
  const Scalar _tmp64 = _tmp19 + _tmp43;
  ...
  const Scalar _tmp73 = _tmp31 * _tmp57;
  const Scalar _tmp74 = Scalar(1.0) * _tmp33;
  const Scalar _tmp75 = Scalar(1.0) * _tmp36;
  const Scalar _tmp76 = (-_tmp27 + _tmp75) / (_tmp16 - _tmp74);
  ...
  const Scalar _tmp86 = _tmp31 * _tmp85;
  const Scalar _tmp87 = -_tmp31 * _tmp84 + _tmp86;
  const Scalar _tmp88 = _tmp80 + _tmp81 - _tmp82;
  const Scalar _tmp89 = -_tmp39 * _tmp86 + _tmp55 * _tmp84;
  const Scalar _tmp90 = _tmp48 * _tmp85;
  const Scalar _tmp91 = -_tmp48 * _tmp88 - _tmp58 * _tmp87 -
                        _tmp76 * (-_tmp39 * _tmp90 + _tmp49 * _tmp88 - _tmp58 * _tmp89) + _tmp90;
  const Scalar _tmp92 = Scalar(1.0) / (_tmp91);
  const Scalar _tmp93 = _tmp50 * _tmp92;
  const Scalar _tmp94 = _tmp78 * _tmp93;
  const Scalar _tmp95 = _tmp78 * _tmp92;
  const Scalar _tmp96 = _tmp61 * _tmp76 * _tmp89 - _tmp61 * _tmp87;
  const Scalar _tmp97 = _tmp59 * _tmp92;
  const Scalar _tmp98 = _tmp60 * _tmp91;
  const Scalar _tmp99 = _tmp96 + _tmp98 * (-_tmp56 * _tmp61 - _tmp96 * _tmp97);
  const Scalar _tmp100 = _tmp48 * _tmp92;
  const Scalar _tmp101 = -_tmp93 * _tmp99 + Scalar(1.0);
  const Scalar _tmp102 = _tmp69 * fh1;
  const Scalar _tmp103 = _tmp39 * _tmp57;
  const Scalar _tmp104 = _tmp103 * _tmp87 - _tmp76 * (_tmp103 * _tmp89 + _tmp39 * _tmp85) - _tmp85;
  const Scalar _tmp105 = _tmp104 + _tmp98 * (_tmp103 * _tmp56 - _tmp104 * _tmp97 - _tmp54);
  const Scalar _tmp106 = -_tmp105 * _tmp93 - _tmp39;
  ...
  _res(1, 0) = std::exp(_tmp102 * _tmp53 * (_tmp100 * _tmp99 + _tmp101 * _tmp73) +
                        _tmp107 * _tmp53 * (_tmp100 * _tmp105 + _tmp106 * _tmp73 + Scalar(1.0)) +
                        _tmp53 * _tmp71 * (-_tmp31 * _tmp62 + _tmp48 * _tmp63) +
                        _tmp53 * _tmp72 * (_tmp48 * _tmp95 - _tmp73 * _tmp94));
  _res(2, 0) = std::exp(-_tmp101 * _tmp102 * _tmp57 - _tmp106 * _tmp107 * _tmp57 +
                        _tmp57 * _tmp72 * _tmp94 + _tmp62 * _tmp71);
  _res(3, 0) = std::exp(-_tmp102 * _tmp92 * _tmp99 - _tmp105 * _tmp107 * _tmp92 - _tmp63 * _tmp71 -
                        _tmp72 * _tmp95);
