...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl4(
  ...
  const Scalar _tmp44 = _tmp39 * (-_tmp16 * _tmp30 + _tmp26 * _tmp29 + _tmp29 * _tmp43);
  ...
  const Scalar _tmp51 = _tmp39 * (_tmp29 * _tmp48 - _tmp29 * _tmp50);
  const Scalar _tmp52 = _tmp38 * _tmp48;
  const Scalar _tmp53 = _tmp39 * (-_tmp29 * _tmp52 + _tmp30 * _tmp50);
  const Scalar _tmp54 = Scalar(1.0) * _tmp32;
  const Scalar _tmp55 = Scalar(1.0) * _tmp35;
  const Scalar _tmp56 = (-_tmp16 + _tmp55) / (_tmp26 - _tmp54);
  const Scalar _tmp57 = _tmp38 * _tmp51 - _tmp48 - _tmp56 * (_tmp38 * _tmp53 + _tmp52);
  const Scalar _tmp58 = _tmp15 + _tmp7;
  const Scalar _tmp59 = _tmp58 + p_init0 + Scalar(-2.71799795);
  const Scalar _tmp60 = _tmp19 + _tmp25;
  ...
  const Scalar _tmp65 = _tmp38 * _tmp63 - _tmp64;
  const Scalar _tmp66 = _tmp43 * _tmp63 - _tmp44 * _tmp65 - _tmp58 * _tmp64 + _tmp60 * _tmp63;
  const Scalar _tmp67 = _tmp47 + _tmp49;
  const Scalar _tmp68 = _tmp48 * _tmp63 - _tmp51 * _tmp65 -
                        _tmp56 * (-_tmp52 * _tmp63 - _tmp53 * _tmp65 + _tmp64 * _tmp67) -
                        _tmp63 * _tmp67;
  const Scalar _tmp69 = Scalar(1.0) / (_tmp68);
  const Scalar _tmp70 = _tmp66 * _tmp69;
  const Scalar _tmp71 = Scalar(1.0) / (_tmp66);
  const Scalar _tmp72 = _tmp68 * _tmp71;
  const Scalar _tmp73 = _tmp57 + _tmp72 * (_tmp38 * _tmp44 - _tmp43 - _tmp57 * _tmp70);
  const Scalar _tmp74 = _tmp65 * _tmp69;
  const Scalar _tmp75 = _tmp39 * (-_tmp38 - _tmp73 * _tmp74);
  const Scalar _tmp76 = _tmp63 * _tmp69;
  const Scalar _tmp77 = _tmp20 + _tmp31;
  ...
  const Scalar _tmp83 = _tmp42 * _tmp82 * (_tmp29 * _tmp75 + _tmp73 * _tmp76 + Scalar(1.0));
  const Scalar _tmp84 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp85 = _tmp54 * _tmp56 + _tmp55;
  const Scalar _tmp86 = 0;
  const Scalar _tmp87 = _tmp69 * _tmp86;
  const Scalar _tmp88 = _tmp39 * _tmp74 * _tmp86;
  const Scalar _tmp89 = _tmp78 * _tmp81;
  const Scalar _tmp90 = -_tmp77 * _tmp82 + _tmp79 * _tmp89;
  const Scalar _tmp91 = Scalar(1.0) * _tmp71;
  const Scalar _tmp92 = _tmp39 * _tmp65;
  const Scalar _tmp93 = _tmp42 * _tmp90 * (-_tmp29 * _tmp91 * _tmp92 + _tmp63 * _tmp91);
  const Scalar _tmp94 = -Scalar(1.0) * _tmp51 + Scalar(1.0) * _tmp53 * _tmp56;
  const Scalar _tmp95 = _tmp72 * (-Scalar(1.0) * _tmp44 - _tmp70 * _tmp94) + _tmp94;
  const Scalar _tmp96 = _tmp39 * (-_tmp74 * _tmp95 + Scalar(1.0));
  const Scalar _tmp97 = _tmp42 * _tmp89 * (_tmp29 * _tmp96 + _tmp76 * _tmp95);
  const Scalar _tmp98 = _tmp90 * _tmp91;
  const Scalar _tmp99 = _tmp98 * fh1;
  const Scalar _tmp100 = _tmp89 * _tmp96;
  const Scalar _tmp101 = _tmp75 * _tmp82;
  const Scalar _tmp102 = _tmp69 * _tmp73 * _tmp82;
  const Scalar _tmp103 = _tmp69 * _tmp89 * _tmp95;

  // Output terms (1)
  Eigen::Matrix<Scalar, 4, 1> _res;

  _res(0, 0) = -std::exp(-fh1);
  _res(1, 0) = -(-_tmp83 - _tmp93 - _tmp97) *
               std::exp(_tmp42 * _tmp84 * (-_tmp29 * _tmp88 + _tmp63 * _tmp87) + _tmp83 * fh1 +
                        _tmp93 * fh1 + _tmp97 * fh1);
  _res(2, 0) = -(_tmp100 + _tmp101 - _tmp92 * _tmp98) *
               std::exp(-_tmp100 * fh1 - _tmp101 * fh1 + _tmp84 * _tmp88 + _tmp92 * _tmp99);
  _res(3, 0) = -(_tmp102 + _tmp103 + _tmp98) *
               std::exp(-_tmp102 * fh1 - _tmp103 * fh1 - _tmp84 * _tmp87 - _tmp99);
