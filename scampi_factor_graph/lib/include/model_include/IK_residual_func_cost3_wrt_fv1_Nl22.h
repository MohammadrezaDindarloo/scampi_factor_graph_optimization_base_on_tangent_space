...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl22(
  ...
  const Scalar _tmp93 = _tmp41 * (_tmp32 * _tmp92 - _tmp71 * _tmp91);
  const Scalar _tmp94 = _tmp55 * _tmp57;
  const Scalar _tmp95 = -_tmp74 * (_tmp55 * _tmp83 + _tmp85 * _tmp94) - _tmp83 + _tmp87 * _tmp94;
  const Scalar _tmp96 = _tmp59 * _tmp89;
  const Scalar _tmp97 = _tmp60 * _tmp88;
  const Scalar _tmp98 = _tmp95 + _tmp97 * (-_tmp42 + _tmp53 * _tmp94 - _tmp95 * _tmp96);
  const Scalar _tmp99 = _tmp32 * _tmp89;
  const Scalar _tmp100 = -_tmp55 - _tmp90 * _tmp98;
  const Scalar _tmp101 = _tmp68 * fh1;
  const Scalar _tmp102 = Scalar(1.0) * _tmp57;
  const Scalar _tmp103 = _tmp102 * _tmp74 * _tmp85 - _tmp102 * _tmp87;
  const Scalar _tmp104 = _tmp103 + _tmp97 * (-_tmp102 * _tmp53 - _tmp103 * _tmp96);
  const Scalar _tmp105 = -_tmp104 * _tmp90 + Scalar(1.0);
  const Scalar _tmp106 = _tmp67 * fh1;
  const Scalar _tmp107 = _tmp57 * _tmp91;
  ...
  _res(1, 0) =
      -_tmp93 *
      std::exp(_tmp101 * _tmp41 * (_tmp100 * _tmp71 + _tmp98 * _tmp99 + Scalar(1.0)) +
               _tmp106 * _tmp41 * (_tmp104 * _tmp99 + _tmp105 * _tmp71) +
               _tmp41 * _tmp69 * (_tmp32 * _tmp61 - _tmp51 * _tmp58 * _tmp61) + _tmp70 * _tmp93);
  _res(2, 0) = -_tmp107 * std::exp(-_tmp100 * _tmp101 * _tmp57 - _tmp105 * _tmp106 * _tmp57 +
                                   _tmp107 * _tmp70 + _tmp108 * _tmp58);
  _res(3, 0) = _tmp92 * std::exp(-_tmp101 * _tmp89 * _tmp98 - _tmp104 * _tmp106 * _tmp89 - _tmp108 -
                                 _tmp70 * _tmp92);
