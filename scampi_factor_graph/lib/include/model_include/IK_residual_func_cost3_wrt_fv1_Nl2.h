...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl2(
  ...
  const Scalar _tmp29 = -_tmp8;
  const Scalar _tmp30 = _tmp15 + _tmp29;
  const Scalar _tmp31 = (_tmp17 - _tmp30) / (-_tmp26 + _tmp28);
  const Scalar _tmp32 = _tmp17 + _tmp26 * _tmp31;
  const Scalar _tmp33 =
  ...
  const Scalar _tmp35 = Scalar(0.20999999999999999) * _tmp19 + Scalar(0.20999999999999999) * _tmp20;
  const Scalar _tmp36 = _tmp33 + _tmp34 - _tmp35;
  const Scalar _tmp37 = _tmp30 + p_init0 + Scalar(-2.5202214700000001);
  const Scalar _tmp38 = _tmp28 + p_init1 + Scalar(8.3888750099999996);
  const Scalar _tmp39 = std::pow(Scalar(std::pow(_tmp37, Scalar(2)) + std::pow(_tmp38, Scalar(2))),
                                 Scalar(Scalar(-1) / Scalar(2)));
  const Scalar _tmp40 = _tmp37 * _tmp39;
  const Scalar _tmp41 = _tmp33 + _tmp35;
  const Scalar _tmp42 = _tmp34 + _tmp41;
  const Scalar _tmp43 = _tmp40 * _tmp42;
  const Scalar _tmp44 = -_tmp36 * _tmp40 + _tmp43;
  const Scalar _tmp45 = _tmp38 * _tmp39;
  const Scalar _tmp46 = _tmp16 + p_init0 + Scalar(-2.71799795);
  const Scalar _tmp47 = Scalar(1.0) / (_tmp46);
  const Scalar _tmp48 = _tmp25 + p_init1 + Scalar(-4.7752063900000001);
  const Scalar _tmp49 = _tmp47 * _tmp48;
  const Scalar _tmp50 = Scalar(1.0) / (_tmp40 * _tmp49 - _tmp45);
  ...
  const Scalar _tmp60 = _tmp49 * _tmp59 - _tmp58;
  const Scalar _tmp61 = _tmp50 * _tmp60;
  const Scalar _tmp62 = _tmp42 * _tmp59;
  const Scalar _tmp63 = -_tmp34 + _tmp41;
  const Scalar _tmp64 = _tmp36 * _tmp45 - _tmp43 * _tmp49;
  const Scalar _tmp65 = -_tmp31 * (-_tmp49 * _tmp62 + _tmp58 * _tmp63 - _tmp61 * _tmp64) -
                        _tmp44 * _tmp61 - _tmp59 * _tmp63 + _tmp62;
  ...
  const Scalar _tmp71 = _tmp70 * (-_tmp40 * _tmp68 + _tmp59 * _tmp67);
  const Scalar _tmp72 = Scalar(1.0) * _tmp50;
  const Scalar _tmp73 = _tmp31 * _tmp64 * _tmp72 - _tmp44 * _tmp72;
  const Scalar _tmp74 = Scalar(1.0) / (_tmp69);
  const Scalar _tmp75 = _tmp70 * (_tmp16 * _tmp48 * _tmp74 - _tmp25 * _tmp46 * _tmp74);
  const Scalar _tmp76 = _tmp28 * _tmp40 - _tmp30 * _tmp45 + _tmp40 * _tmp75;
  const Scalar _tmp77 = _tmp52 * _tmp59 - _tmp55 * _tmp58 + _tmp59 * _tmp75 - _tmp61 * _tmp76;
  ...
  const Scalar _tmp83 = _tmp60 * _tmp66;
  const Scalar _tmp84 = -_tmp81 * _tmp83 + Scalar(1.0);
  const Scalar _tmp85 = _tmp40 * _tmp50;
  const Scalar _tmp86 = _tmp27 + _tmp51;
  const Scalar _tmp87 = _tmp86 + p_init1 + Scalar(8.3196563700000006);
  const Scalar _tmp88 = _tmp29 + _tmp54;
  ...
  const Scalar _tmp93 = _tmp60 * _tmp72 * _tmp79;
  ...
  const Scalar _tmp97 = _tmp49 * _tmp50;
  const Scalar _tmp98 = -_tmp31 * (_tmp42 * _tmp49 + _tmp64 * _tmp97) - _tmp42 + _tmp44 * _tmp97;
  const Scalar _tmp99 = _tmp80 * (-_tmp75 + _tmp76 * _tmp97 - _tmp78 * _tmp98) + _tmp98;
  const Scalar _tmp100 = -_tmp49 - _tmp83 * _tmp99;
  const Scalar _tmp101 = _tmp0 * _tmp67;
  const Scalar _tmp102 = _tmp50 * fh1;
  ...
  _res(0, 0) = 0;
  _res(1, 0) =
      -_tmp71 * std::exp(_tmp0 * _tmp71 + _tmp70 * _tmp96 * (-_tmp40 * _tmp93 + _tmp59 * _tmp94) +
                         _tmp91 * _tmp92 * (_tmp81 * _tmp82 + _tmp84 * _tmp85) +
                         _tmp92 * _tmp95 * (_tmp100 * _tmp85 + _tmp82 * _tmp99 + Scalar(1.0)));
  _res(2, 0) = -_tmp68 * std::exp(-_tmp100 * _tmp102 * _tmp95 + _tmp101 * _tmp61 -
                                  _tmp102 * _tmp84 * _tmp91 + _tmp93 * _tmp96);
  _res(3, 0) = _tmp67 * std::exp(-_tmp101 - _tmp103 * _tmp81 * _tmp91 - _tmp103 * _tmp95 * _tmp99 -
                                 _tmp94 * _tmp96);
