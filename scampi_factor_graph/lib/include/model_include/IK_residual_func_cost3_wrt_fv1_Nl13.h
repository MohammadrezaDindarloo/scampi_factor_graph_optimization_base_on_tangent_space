...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl13(
  ...
  const Scalar _tmp86 = _tmp40 + _tmp7;
  ...
  const Scalar _tmp97 = _tmp74 * (-_tmp45 * _tmp96 + _tmp66 * _tmp95);
  const Scalar _tmp98 = _tmp31 * _tmp53;
  const Scalar _tmp99 = -_tmp37 - _tmp52 * (_tmp31 * _tmp37 + _tmp49 * _tmp98) + _tmp55 * _tmp98;
  const Scalar _tmp100 = _tmp80 * (-_tmp75 + _tmp76 * _tmp98 - _tmp78 * _tmp99) + _tmp99;
  const Scalar _tmp101 = -_tmp100 * _tmp83 - _tmp31;
  const Scalar _tmp102 = _tmp89 * _tmp90;
  const Scalar _tmp103 = _tmp102 * fh1;
  const Scalar _tmp104 = Scalar(1.0) * _tmp79;
  const Scalar _tmp105 = fh1 * (-_tmp102 * _tmp86 + _tmp88 * _tmp91);
  ...
  _res(0, 0) = 0;
  _res(1, 0) =
      -_tmp97 * std::exp(_tmp103 * _tmp74 * (_tmp100 * _tmp82 + _tmp101 * _tmp85 + Scalar(1.0)) +
                         _tmp105 * _tmp74 * (-_tmp104 * _tmp45 * _tmp68 + _tmp104 * _tmp66) +
                         _tmp74 * _tmp92 * (_tmp81 * _tmp82 + _tmp84 * _tmp85) + _tmp93 * _tmp97);
  _res(2, 0) = -_tmp96 * std::exp(-_tmp101 * _tmp103 * _tmp53 + _tmp106 * _tmp68 +
                                  _tmp107 * _tmp68 - _tmp53 * _tmp84 * _tmp92);
  _res(3, 0) =
      _tmp95 * std::exp(-_tmp100 * _tmp103 * _tmp71 - _tmp106 - _tmp107 - _tmp71 * _tmp81 * _tmp92);
