...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl23(
  ...
  const Scalar _tmp41 = Scalar(1.0) / (_tmp27 * _tmp40 - _tmp39);
  const Scalar _tmp42 = _tmp31 * _tmp40 - _tmp33 * _tmp39 + _tmp36 * _tmp40;
  ...
  const Scalar _tmp50 = _tmp41 * (-_tmp40 * _tmp48 + _tmp40 * _tmp49);
  const Scalar _tmp51 = _tmp27 * _tmp49;
  const Scalar _tmp52 = _tmp39 * _tmp48 - _tmp40 * _tmp51;
  const Scalar _tmp53 = _tmp41 * _tmp52;
  const Scalar _tmp54 = Scalar(1.0) * _tmp25;
  const Scalar _tmp55 = Scalar(1.0) * _tmp15;
  const Scalar _tmp56 = (-_tmp33 + _tmp55) / (_tmp36 - _tmp54);
  const Scalar _tmp57 = _tmp27 * _tmp50 - _tmp49 - _tmp56 * (_tmp27 * _tmp53 + _tmp51);
  ...
  const Scalar _tmp70 = _tmp49 * _tmp66 - _tmp50 * _tmp67 -
                        _tmp56 * (-_tmp51 * _tmp66 - _tmp52 * _tmp69 + _tmp65 * _tmp68) -
                        _tmp66 * _tmp68;
  const Scalar _tmp71 = Scalar(1.0) / (_tmp70);
  const Scalar _tmp72 = _tmp31 * _tmp66 - _tmp42 * _tmp69 + _tmp59 * _tmp66 - _tmp62 * _tmp65;
  const Scalar _tmp73 = _tmp71 * _tmp72;
  const Scalar _tmp74 = Scalar(1.0) / (_tmp72);
  const Scalar _tmp75 = _tmp70 * _tmp74;
  const Scalar _tmp76 = _tmp57 + _tmp75 * (_tmp27 * _tmp43 - _tmp31 - _tmp57 * _tmp73);
  const Scalar _tmp77 = _tmp67 * _tmp71;
  const Scalar _tmp78 = -_tmp27 - _tmp76 * _tmp77;
  const Scalar _tmp79 = _tmp40 * _tmp41;
  const Scalar _tmp80 = _tmp66 * _tmp71;
  const Scalar _tmp81 = _tmp24 + _tmp58;
  const Scalar _tmp82 = _tmp81 + p_init1 + Scalar(-4.8333311099999996);
  const Scalar _tmp83 = _tmp14 + _tmp61;
  ...
  const Scalar _tmp87 = _tmp30 * fh1;
  const Scalar _tmp88 = Scalar(1.0) * _tmp74;
  const Scalar _tmp89 = _tmp82 * _tmp85;
  const Scalar _tmp90 = fh1 * (-_tmp81 * _tmp86 + _tmp83 * _tmp89);
  const Scalar _tmp91 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp92 = _tmp54 * _tmp56 + _tmp55;
  const Scalar _tmp93 = 0;
  const Scalar _tmp94 = _tmp71 * _tmp93;
  const Scalar _tmp95 = _tmp77 * _tmp93;
  const Scalar _tmp96 = _tmp30 * (_tmp66 * _tmp94 - _tmp79 * _tmp95);
  const Scalar _tmp97 = -Scalar(1.0) * _tmp50 + Scalar(1.0) * _tmp53 * _tmp56;
  const Scalar _tmp98 = _tmp75 * (-Scalar(1.0) * _tmp43 - _tmp73 * _tmp97) + _tmp97;
  const Scalar _tmp99 = -_tmp77 * _tmp98 + Scalar(1.0);
  const Scalar _tmp100 = _tmp41 * fh1;
  const Scalar _tmp101 = _tmp88 * _tmp90;
  const Scalar _tmp102 = _tmp41 * _tmp95;
  ...
  _res(0, 0) = 0;
  _res(1, 0) =
      -_tmp96 * std::exp(_tmp30 * _tmp90 * (-_tmp40 * _tmp69 * _tmp88 + _tmp66 * _tmp88) +
                         _tmp86 * _tmp87 * (_tmp76 * _tmp80 + _tmp78 * _tmp79 + Scalar(1.0)) +
                         _tmp87 * _tmp89 * (_tmp79 * _tmp99 + _tmp80 * _tmp98) + _tmp91 * _tmp96);
  _res(2, 0) = -_tmp102 * std::exp(-_tmp100 * _tmp78 * _tmp86 - _tmp100 * _tmp89 * _tmp99 +
                                   _tmp101 * _tmp69 + _tmp102 * _tmp91);
  _res(3, 0) = _tmp94 * std::exp(-_tmp101 - _tmp103 * _tmp76 * _tmp86 - _tmp103 * _tmp89 * _tmp98 -
                                 _tmp91 * _tmp94);
