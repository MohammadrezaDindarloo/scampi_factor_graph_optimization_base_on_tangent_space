...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2Nl16(
  ...
  const Scalar _tmp62 = _tmp39 + _tmp47;
  ...
  const Scalar _tmp67 = _tmp37 + _tmp57;
  const Scalar _tmp68 = _tmp38 * _tmp66 - _tmp66 * _tmp67;
  const Scalar _tmp69 = _tmp54 * _tmp55;
  const Scalar _tmp70 = _tmp44 + Scalar(-4.8333311099999996);
  const Scalar _tmp71 = _tmp41 + Scalar(1.79662371);
  const Scalar _tmp72 = Scalar(1.0) / (_tmp71);
  const Scalar _tmp73 = _tmp70 * _tmp72;
  const Scalar _tmp74 = _tmp56 * _tmp73 - _tmp69;
  const Scalar _tmp75 = _tmp61 * _tmp65;
  const Scalar _tmp76 = Scalar(1.0) / (_tmp66 * _tmp73 - _tmp75);
  const Scalar _tmp77 = _tmp74 * _tmp76;
  const Scalar _tmp78 = _tmp38 * _tmp73;
  const Scalar _tmp79 = -_tmp66 * _tmp78 + _tmp67 * _tmp75;
  const Scalar _tmp80 = -_tmp56 * _tmp78 + _tmp58 * _tmp69 - _tmp77 * _tmp79;
  ...
  const Scalar _tmp85 = _tmp83 * (-_tmp62 + _tmp84);
  const Scalar _tmp86 = _tmp38 * _tmp56 - _tmp56 * _tmp58 - _tmp68 * _tmp77 - _tmp80 * _tmp85;
  ...
  const Scalar _tmp91 = _tmp66 * _tmp76;
  const Scalar _tmp92 = _tmp74 * _tmp87;
  ...
  const Scalar _tmp97 = _tmp95 * (_tmp40 * _tmp70 * _tmp96 - _tmp43 * _tmp71 * _tmp96);
  const Scalar _tmp98 = _tmp59 * _tmp66 - _tmp62 * _tmp75 + _tmp66 * _tmp97;
  const Scalar _tmp99 = -_tmp48 * _tmp69 + _tmp52 * _tmp56 + _tmp56 * _tmp97 - _tmp77 * _tmp98;
  const Scalar _tmp100 = Scalar(1.0) / (_tmp99);
  const Scalar _tmp101 = Scalar(1.0) * _tmp76;
  const Scalar _tmp102 = _tmp100 * _tmp101 * _tmp74;
  const Scalar _tmp103 = Scalar(1.0) * _tmp100;
  const Scalar _tmp104 = _tmp32 + Scalar(-4.7752063900000001);
  const Scalar _tmp105 = _tmp25 + Scalar(-2.71799795);
  ...
  const Scalar _tmp109 = fh1 * (_tmp107 * _tmp24 - _tmp108 * _tmp31);
  const Scalar _tmp110 = _tmp101 * _tmp79;
  const Scalar _tmp111 = -_tmp101 * _tmp68 + _tmp110 * _tmp85;
  const Scalar _tmp112 = _tmp87 * _tmp99;
  const Scalar _tmp113 = _tmp100 * _tmp86;
  const Scalar _tmp114 = _tmp113 * (-_tmp101 * _tmp98 - _tmp111 * _tmp112);
  const Scalar _tmp115 = _tmp111 + _tmp114;
  const Scalar _tmp116 = _tmp56 * _tmp87;
  const Scalar _tmp117 = -_tmp115 * _tmp92 + Scalar(1.0);
  const Scalar _tmp118 = _tmp107 * fh1;
  const Scalar _tmp119 = _tmp73 * _tmp76;
  const Scalar _tmp120 = _tmp119 * _tmp79 + _tmp78;
  const Scalar _tmp121 = _tmp119 * _tmp68 - _tmp120 * _tmp85 - _tmp38;
  const Scalar _tmp122 = _tmp113 * (-_tmp112 * _tmp121 + _tmp119 * _tmp98 - _tmp97);
  const Scalar _tmp123 = _tmp121 + _tmp122;
  const Scalar _tmp124 = -_tmp123 * _tmp92 - _tmp73;
  const Scalar _tmp125 = _tmp108 * fh1;
  const Scalar _tmp126 = -_tmp109 * _tmp95 * (-_tmp102 * _tmp66 + _tmp103 * _tmp56) -
                         _tmp118 * _tmp95 * (_tmp115 * _tmp116 + _tmp117 * _tmp91) -
                         _tmp125 * _tmp95 * (_tmp116 * _tmp123 + _tmp124 * _tmp91 + Scalar(1.0)) -
                         _tmp46 * _tmp95 * (_tmp56 * _tmp90 - _tmp91 * _tmp93);
  const Scalar _tmp127 = Scalar(1.0) / (_tmp126);
  const Scalar _tmp128 = _tmp80 * _tmp87;
  const Scalar _tmp129 = _tmp52 + _tmp82;
  const Scalar _tmp130 = _tmp129 * _tmp85;
  const Scalar _tmp131 = Scalar(1.0) / (-_tmp130 - _tmp48 + _tmp84);
  ...
  const Scalar _tmp136 = _tmp131 * _tmp88;
  const Scalar _tmp137 = -_tmp129 * _tmp136 - _tmp80 * _tmp90 + _tmp82;
  const Scalar _tmp138 = _tmp113 * _tmp135;
  const Scalar _tmp139 = -_tmp103 * _tmp80 + _tmp129 * _tmp138;
  const Scalar _tmp140 = _tmp83 * (_tmp130 * _tmp135 + Scalar(1.0));
  const Scalar _tmp141 = _tmp135 * _tmp85;
  const Scalar _tmp142 = _tmp15 * fh1;
  const Scalar _tmp143 = -_tmp107 * _tmp142 - Scalar(3.29616) * _tmp28 - _tmp31 * fv1;
  const Scalar _tmp144 = _tmp129 * _tmp83;
  const Scalar _tmp145 = _tmp108 * _tmp142 + Scalar(3.29616) * _tmp18 + _tmp24 * fv1;
  const Scalar _tmp146 = -_tmp110 + _tmp114 * _tmp132 - _tmp115 * _tmp128;
  const Scalar _tmp147 = std::asinh(
      _tmp127 * (Scalar(1.0) * _tmp109 * (-_tmp134 * _tmp139 + _tmp138) +
                 Scalar(1.0) * _tmp118 * (_tmp114 * _tmp135 - _tmp134 * _tmp146) +
                 Scalar(1.0) * _tmp125 * (_tmp122 * _tmp135 - _tmp133 * _tmp134) +
                 Scalar(1.0) * _tmp143 * (-Scalar(1.0) * _tmp140 + _tmp141) +
                 Scalar(1.0) * _tmp145 * (_tmp135 * _tmp144 - _tmp135) +
                 Scalar(1.0) * _tmp46 * (-_tmp134 * _tmp137 - _tmp135 * _tmp88 + Scalar(1.0))));
  const Scalar _tmp148 = Scalar(9.6622558468725703) * _tmp126;
  const Scalar _tmp149 = -_tmp102 * _tmp109 + _tmp117 * _tmp118 * _tmp76 +
                         _tmp124 * _tmp125 * _tmp76 - _tmp46 * _tmp76 * _tmp93;
  const Scalar _tmp150 = Scalar(1.0) / (_tmp149);
  const Scalar _tmp151 = _tmp135 * _tmp145;
  const Scalar _tmp152 =
      std::asinh(_tmp150 * (_tmp109 * _tmp139 * _tmp83 + _tmp118 * _tmp146 * _tmp83 +
                            _tmp125 * _tmp133 * _tmp83 + _tmp137 * _tmp46 * _tmp83 +
                            _tmp140 * _tmp143 - _tmp144 * _tmp151));
  ...
  const Scalar _tmp156 =
      _tmp103 * _tmp109 + _tmp115 * _tmp118 * _tmp87 + _tmp123 * _tmp125 * _tmp87 + _tmp46 * _tmp90;
  const Scalar _tmp157 = Scalar(1.0) / (_tmp156);
  const Scalar _tmp158 = std::asinh(_tmp157 * (-_tmp109 * _tmp138 - _tmp114 * _tmp118 * _tmp131 -
                                               _tmp122 * _tmp125 * _tmp131 + _tmp136 * _tmp46 -
                                               _tmp141 * _tmp143 + _tmp151));
  ...
  _res(1, 0) =
      _tmp148 *
          (-std::sinh(Scalar(1.0) * _tmp147) -
           std::sinh(Scalar(0.1034955) * _tmp127 * (-_tmp147 * _tmp148 - std::sqrt(_tmp45)))) -
