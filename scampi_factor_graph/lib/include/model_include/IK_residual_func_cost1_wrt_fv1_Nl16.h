...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1WrtFv1Nl16(
  ...
  const Scalar _tmp37 = _tmp22 + _tmp28 + _tmp36;
  ...
  const Scalar _tmp51 = Scalar(0.20999999999999999) * _tmp10 - Scalar(0.20999999999999999) * _tmp12;
  ...
  const Scalar _tmp73 = _tmp52 + _tmp65;
  const Scalar _tmp74 = _tmp56 * _tmp72 - _tmp72 * _tmp73;
  ...
  const Scalar _tmp82 = _tmp64 * _tmp79 - _tmp81;
  const Scalar _tmp83 = _tmp80 * _tmp82;
  const Scalar _tmp84 = _tmp56 * _tmp79;
  const Scalar _tmp85 = -_tmp72 * _tmp84 + _tmp73 * _tmp75;
  const Scalar _tmp86 = -_tmp64 * _tmp84 + _tmp66 * _tmp81 - _tmp83 * _tmp85;
  const Scalar _tmp87 = -_tmp49 * _tmp86 + _tmp56 * _tmp64 - _tmp64 * _tmp66 - _tmp74 * _tmp83;
  ...
  const Scalar _tmp93 = _tmp92 * (_tmp64 * _tmp89 - _tmp72 * _tmp90);
  ...
  const Scalar _tmp97 = -_tmp57 * _tmp81 + _tmp60 * _tmp64 + _tmp64 * _tmp95 - _tmp83 * _tmp96;
  ...
  const Scalar _tmp114 = _tmp64 * _tmp88;
  const Scalar _tmp115 = _tmp82 * _tmp88;
  const Scalar _tmp116 = -_tmp113 * _tmp115 + Scalar(1.0);
  const Scalar _tmp117 = _tmp72 * _tmp80;
  const Scalar _tmp118 = _tmp105 * fh1;
  const Scalar _tmp119 = _tmp79 * _tmp80;
  const Scalar _tmp120 = _tmp119 * _tmp85 + _tmp84;
  const Scalar _tmp121 = _tmp119 * _tmp74 - _tmp120 * _tmp49 - _tmp56;
  const Scalar _tmp122 = _tmp111 * (-_tmp110 * _tmp121 + _tmp119 * _tmp96 - _tmp95);
  const Scalar _tmp123 = _tmp121 + _tmp122;
  const Scalar _tmp124 = -_tmp115 * _tmp123 - _tmp79;
  const Scalar _tmp125 = _tmp106 * fh1;
  const Scalar _tmp126 = -_tmp107 * _tmp92 * (-_tmp100 * _tmp72 + _tmp101 * _tmp64) -
                         _tmp118 * _tmp92 * (_tmp113 * _tmp114 + _tmp116 * _tmp117) -
                         _tmp125 * _tmp92 * (_tmp114 * _tmp123 + _tmp117 * _tmp124 + Scalar(1.0)) -
                         _tmp39 * _tmp93;
  const Scalar _tmp127 = Scalar(1.0) / (_tmp126);
  const Scalar _tmp128 = _tmp86 * _tmp88;
  const Scalar _tmp129 = _tmp42 + _tmp60;
  const Scalar _tmp130 = _tmp129 * _tmp49;
  const Scalar _tmp131 = Scalar(1.0) / (-_tmp130 + _tmp40 - _tmp57);
  const Scalar _tmp132 = _tmp129 * _tmp131;
  const Scalar _tmp133 = _tmp120 + _tmp122 * _tmp132 - _tmp123 * _tmp128;
  const Scalar _tmp134 = Scalar(1.0) * _tmp46;
  const Scalar _tmp135 = Scalar(1.0) * _tmp131;
  const Scalar _tmp136 = _tmp131 * _tmp50;
  const Scalar _tmp137 = _tmp46 * (-_tmp129 * _tmp136 + _tmp42 - _tmp86 * _tmp89);
  const Scalar _tmp138 = -Scalar(1.0) * _tmp136 - Scalar(1.0) * _tmp137 + Scalar(1.0);
  const Scalar _tmp139 = _tmp111 * _tmp135;
  const Scalar _tmp140 = -_tmp101 * _tmp86 + _tmp129 * _tmp139;
  const Scalar _tmp141 = fh1 * (_tmp51 + _tmp55);
  const Scalar _tmp142 = -_tmp105 * _tmp141 - Scalar(3.29616) * _tmp26 - _tmp30 * fv1;
  const Scalar _tmp143 = _tmp46 * (_tmp130 * _tmp135 + Scalar(1.0));
  const Scalar _tmp144 = _tmp135 * _tmp49;
  const Scalar _tmp145 = -Scalar(1.0) * _tmp143 + Scalar(1.0) * _tmp144;
  const Scalar _tmp146 = _tmp106 * _tmp141 + Scalar(3.29616) * _tmp13 + _tmp19 * fv1;
  const Scalar _tmp147 = _tmp129 * _tmp46;
  const Scalar _tmp148 = Scalar(1.0) * _tmp135 * _tmp147 - Scalar(1.0) * _tmp135;
  const Scalar _tmp149 = -_tmp108 + _tmp112 * _tmp132 - _tmp113 * _tmp128;
  const Scalar _tmp150 = Scalar(1.0) * _tmp107 * (-_tmp134 * _tmp140 + _tmp139) +
                         Scalar(1.0) * _tmp118 * (_tmp112 * _tmp135 - _tmp134 * _tmp149) +
                         Scalar(1.0) * _tmp125 * (_tmp122 * _tmp135 - _tmp133 * _tmp134) +
                         _tmp138 * _tmp39 + _tmp142 * _tmp145 + _tmp146 * _tmp148;
  ...
  const Scalar _tmp159 = _tmp27 + _tmp44;
  const Scalar _tmp160 = _tmp158 * _tmp93;
  const Scalar _tmp161 =
      (_tmp127 * (-_tmp138 + _tmp145 * _tmp159 + _tmp148 * _tmp19) - _tmp150 * _tmp160) /
      std::sqrt(Scalar(std::pow(_tmp150, Scalar(2)) * _tmp158 + 1));
  const Scalar _tmp162 = _tmp39 * _tmp89;
  const Scalar _tmp163 = -_tmp100 * _tmp107 + _tmp116 * _tmp118 * _tmp80 +
                         _tmp124 * _tmp125 * _tmp80 - _tmp162 * _tmp83;
  const Scalar _tmp164 = Scalar(1.0) / (_tmp163);
  const Scalar _tmp165 = _tmp135 * _tmp146;
  const Scalar _tmp166 = _tmp107 * _tmp140 * _tmp46 + _tmp118 * _tmp149 * _tmp46 +
                         _tmp125 * _tmp133 * _tmp46 + _tmp137 * _tmp39 + _tmp142 * _tmp143 -
                         _tmp147 * _tmp165;
  ...
  const Scalar _tmp171 = _tmp135 * _tmp19;
  const Scalar _tmp172 =
      (_tmp164 * (-_tmp137 + _tmp143 * _tmp159 - _tmp147 * _tmp171) - _tmp166 * _tmp170) /
  ...
  const Scalar _tmp177 = Scalar(9.6622558468725703) * _tmp89;
  const Scalar _tmp178 = _tmp177 * _tmp83;
  const Scalar _tmp179 =
      _tmp101 * _tmp107 + _tmp113 * _tmp118 * _tmp88 + _tmp123 * _tmp125 * _tmp88 + _tmp162;
  const Scalar _tmp180 = Scalar(1.0) / (_tmp179);
  const Scalar _tmp181 = -_tmp107 * _tmp139 - _tmp112 * _tmp118 * _tmp131 -
                         _tmp122 * _tmp125 * _tmp131 + _tmp136 * _tmp39 - _tmp142 * _tmp144 +
                         _tmp165;
  ...
  const Scalar _tmp190 = (_tmp180 * (-_tmp136 - _tmp144 * _tmp159 + _tmp171) + _tmp181 * _tmp189) /
  ...
  _res(1, 0) =
      -_tmp152 *
          (-Scalar(0.86625939559540499) * _tmp160 + Scalar(1.0) * _tmp161 * std::sinh(_tmp156) -
           (-Scalar(0.1034955) * _tmp153 * _tmp160 +
            _tmp154 * (-_tmp151 * _tmp157 - _tmp152 * _tmp161)) *
               std::sinh(_tmp155)) -
      _tmp157 * (Scalar(0.86625939559540499) * _tmp127 - std::cosh(_tmp155) + std::cosh(_tmp156));
  _res(2, 0) =
      -_tmp173 *
          (-Scalar(0.87679799772039002) * _tmp170 + Scalar(1.0) * _tmp172 * std::sinh(_tmp168) -
           (-Scalar(0.1034955) * _tmp170 * _tmp174 +
            _tmp175 * (-_tmp167 * _tmp178 - _tmp172 * _tmp173)) *
               std::sinh(_tmp176)) -
      _tmp178 * (Scalar(0.87679799772039002) * _tmp164 + std::cosh(_tmp168) - std::cosh(_tmp176));
  _res(3, 0) =
      _tmp177 * (Scalar(0.87653584775870996) * _tmp180 + std::cosh(_tmp183) - std::cosh(_tmp187)) -
      _tmp184 *
          (Scalar(0.87653584775870996) * _tmp189 + Scalar(1.0) * _tmp190 * std::sinh(_tmp183) -
