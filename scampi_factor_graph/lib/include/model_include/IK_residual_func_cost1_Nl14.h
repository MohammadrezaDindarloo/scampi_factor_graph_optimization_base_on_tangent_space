...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl14(
  ...
  const Scalar _tmp21 = _tmp4 * _tmp6;
  ...
  const Scalar _tmp31 = Scalar(0.20999999999999999) * _tmp10 - Scalar(0.20999999999999999) * _tmp11;
  const Scalar _tmp32 =
  ...
  const Scalar _tmp77 = _tmp45 * _tmp62 - _tmp55 * _tmp60 - _tmp74 * _tmp76;
  const Scalar _tmp78 = Scalar(1.0) * _tmp52;
  const Scalar _tmp79 = -_tmp78;
  const Scalar _tmp80 = Scalar(1.0) / (_tmp64 + _tmp79);
  const Scalar _tmp81 = Scalar(1.0) * _tmp47;
  const Scalar _tmp82 = _tmp80 * (-_tmp67 + _tmp81);
  const Scalar _tmp83 = _tmp75 * (-_tmp63 * _tmp72 + _tmp73);
  const Scalar _tmp84 = -_tmp56 * _tmp62 - _tmp57 * _tmp83 + _tmp60 - _tmp77 * _tmp82;
  const Scalar _tmp85 = Scalar(1.0) / (_tmp84);
  const Scalar _tmp86 = _tmp55 * _tmp75;
  const Scalar _tmp87 = _tmp55 * _tmp59 + _tmp74 * _tmp86;
  const Scalar _tmp88 = _tmp55 * _tmp83 - _tmp59 - _tmp82 * _tmp87;
  const Scalar _tmp89 =
  ...
  const Scalar _tmp92 = _tmp91 * (_tmp47 * _tmp54 * _tmp90 - _tmp49 * _tmp52 * _tmp90);
  const Scalar _tmp93 = _tmp64 * _tmp72 - _tmp67 * _tmp71 + _tmp72 * _tmp92;
  const Scalar _tmp94 = _tmp37 * _tmp56 - _tmp41 * _tmp45 + _tmp56 * _tmp92 - _tmp76 * _tmp93;
  ...
  const Scalar _tmp100 = -_tmp55 - _tmp57 * _tmp99;
  ...
  const Scalar _tmp107 = Scalar(1.0) * _tmp75;
  const Scalar _tmp108 = _tmp107 * _tmp74;
  const Scalar _tmp109 = _tmp108 * _tmp82 - Scalar(1.0) * _tmp83;
  const Scalar _tmp110 = _tmp97 * (-_tmp107 * _tmp93 - _tmp109 * _tmp95);
  const Scalar _tmp111 = _tmp85 * (_tmp109 + _tmp110);
  const Scalar _tmp112 = -_tmp111 * _tmp57 + Scalar(1.0);
  const Scalar _tmp113 = _tmp103 * _tmp104;
  const Scalar _tmp114 = _tmp113 * fh1;
  const Scalar _tmp115 = Scalar(1.0) * _tmp96;
  const Scalar _tmp116 = _tmp107 * _tmp57 * _tmp96;
  const Scalar _tmp117 = fh1 * (-_tmp105 * _tmp28 + _tmp113 * _tmp18);
  const Scalar _tmp118 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp119 = _tmp78 * _tmp82 + _tmp81;
  const Scalar _tmp120 = 0;
  const Scalar _tmp121 = -_tmp106 * _tmp91 * (_tmp100 * _tmp101 + _tmp56 * _tmp99 + Scalar(1.0)) -
                         _tmp114 * _tmp91 * (_tmp101 * _tmp112 + _tmp111 * _tmp56) -
                         _tmp117 * _tmp91 * (_tmp115 * _tmp56 - _tmp116 * _tmp72) -
                         _tmp118 * _tmp91 * (_tmp120 * _tmp56 - _tmp120 * _tmp72 * _tmp76);
  const Scalar _tmp122 = Scalar(1.0) / (_tmp121);
  const Scalar _tmp123 = _tmp37 + _tmp79;
  const Scalar _tmp124 = _tmp123 * _tmp82;
  const Scalar _tmp125 = Scalar(1.0) / (-_tmp124 - _tmp41 + _tmp81);
  const Scalar _tmp126 = Scalar(1.0) * _tmp125;
  const Scalar _tmp127 = _tmp119 * _tmp125;
  const Scalar _tmp128 = -_tmp120 * _tmp77 - _tmp123 * _tmp127 + _tmp79;
  const Scalar _tmp129 = Scalar(1.0) * _tmp80;
  const Scalar _tmp130 = _tmp123 * _tmp125;
  const Scalar _tmp131 = -_tmp108 + _tmp110 * _tmp130 - _tmp111 * _tmp77;
  const Scalar _tmp132 = _tmp80 * (_tmp124 * _tmp126 + Scalar(1.0));
  const Scalar _tmp133 = _tmp126 * _tmp82;
  const Scalar _tmp134 = _tmp35 * fh1;
  const Scalar _tmp135 = -_tmp113 * _tmp134 - Scalar(3.29616) * _tmp23 - _tmp28 * fv1;
  const Scalar _tmp136 = _tmp126 * _tmp97;
  const Scalar _tmp137 = -_tmp115 * _tmp77 + _tmp123 * _tmp136;
  const Scalar _tmp138 = _tmp123 * _tmp80;
  const Scalar _tmp139 = _tmp105 * _tmp134 + Scalar(3.29616) * _tmp12 + _tmp18 * fv1;
  const Scalar _tmp140 = _tmp130 * _tmp98 - _tmp77 * _tmp99 + _tmp87;
  const Scalar _tmp141 = std::asinh(
      _tmp122 * (Scalar(1.0) * _tmp106 * (_tmp126 * _tmp98 - _tmp129 * _tmp140) +
                 Scalar(1.0) * _tmp114 * (_tmp110 * _tmp126 - _tmp129 * _tmp131) +
                 Scalar(1.0) * _tmp117 * (-_tmp129 * _tmp137 + _tmp136) +
                 Scalar(1.0) * _tmp118 * (-_tmp119 * _tmp126 - _tmp128 * _tmp129 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp135 * (-Scalar(1.0) * _tmp132 + _tmp133) +
                 Scalar(1.0) * _tmp139 * (_tmp126 * _tmp138 - _tmp126)));
  const Scalar _tmp142 = Scalar(9.6622558468725703) * _tmp121;
  const Scalar _tmp143 = _tmp118 * _tmp120;
  const Scalar _tmp144 = _tmp100 * _tmp106 * _tmp75 + _tmp112 * _tmp114 * _tmp75 -
                         _tmp116 * _tmp117 - _tmp143 * _tmp76;
  const Scalar _tmp145 = Scalar(1.0) / (_tmp144);
  const Scalar _tmp146 = _tmp126 * _tmp139;
  const Scalar _tmp147 =
      std::asinh(_tmp145 * (_tmp106 * _tmp140 * _tmp80 + _tmp114 * _tmp131 * _tmp80 +
                            _tmp117 * _tmp137 * _tmp80 + _tmp118 * _tmp128 * _tmp80 +
                            _tmp132 * _tmp135 - _tmp138 * _tmp146));
  const Scalar _tmp148 = Scalar(9.6622558468725703) * _tmp144;
  const Scalar _tmp149 = _tmp106 * _tmp99 + _tmp111 * _tmp114 + _tmp115 * _tmp117 + _tmp143;
  const Scalar _tmp150 = Scalar(1.0) / (_tmp149);
  const Scalar _tmp151 =
      std::asinh(_tmp150 * (-_tmp106 * _tmp125 * _tmp98 - _tmp110 * _tmp114 * _tmp125 -
                            _tmp117 * _tmp136 + _tmp118 * _tmp127 - _tmp133 * _tmp135 + _tmp146));
  ...
  _res(1, 0) =
      -_tmp142 *
          (Scalar(0.87653584775870996) * _tmp122 + std::cosh(Scalar(1.0) * _tmp141) -
           std::cosh(
