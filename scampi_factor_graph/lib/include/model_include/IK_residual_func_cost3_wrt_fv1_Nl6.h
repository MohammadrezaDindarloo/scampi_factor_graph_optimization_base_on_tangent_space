...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl6(
  ...
  const Scalar _tmp97 = _tmp74 * (-_tmp49 * _tmp96 + _tmp65 * _tmp95);
  const Scalar _tmp98 = Scalar(1.0) * _tmp79;
  const Scalar _tmp99 = _tmp89 * _tmp90;
  const Scalar _tmp100 = fh1 * (-_tmp86 * _tmp99 + _tmp88 * _tmp91);
  const Scalar _tmp101 = _tmp46 * _tmp55;
  const Scalar _tmp102 = _tmp101 * _tmp57 - _tmp48 - _tmp54 * (_tmp101 * _tmp51 + _tmp46 * _tmp48);
  const Scalar _tmp103 = _tmp102 + _tmp80 * (_tmp101 * _tmp76 - _tmp102 * _tmp78 - _tmp75);
  const Scalar _tmp104 = -_tmp103 * _tmp83 - _tmp46;
  const Scalar _tmp105 = _tmp99 * fh1;
  const Scalar _tmp106 = _tmp100 * _tmp98;
  ...
  _res(0, 0) = 0;
  _res(1, 0) =
      -_tmp97 * std::exp(_tmp100 * _tmp74 * (-_tmp49 * _tmp69 * _tmp98 + _tmp65 * _tmp98) +
                         _tmp105 * _tmp74 * (_tmp103 * _tmp82 + _tmp104 * _tmp85 + Scalar(1.0)) +
                         _tmp74 * _tmp92 * (_tmp81 * _tmp82 + _tmp84 * _tmp85) + _tmp93 * _tmp97);
  _res(2, 0) = -_tmp96 * std::exp(-_tmp104 * _tmp105 * _tmp55 + _tmp106 * _tmp69 +
                                  _tmp107 * _tmp69 - _tmp55 * _tmp84 * _tmp92);
  _res(3, 0) =
      _tmp95 * std::exp(-_tmp103 * _tmp105 * _tmp71 - _tmp106 - _tmp107 - _tmp71 * _tmp81 * _tmp92);
