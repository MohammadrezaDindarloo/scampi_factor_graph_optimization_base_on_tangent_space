...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2Nl2(
  ...
  const Scalar _tmp50 = _tmp45 + _tmp7;
  ...
  const Scalar _tmp59 = _tmp47 + Scalar(-110.0);
  const Scalar _tmp60 = _tmp44 + Scalar(-125.0);
  const Scalar _tmp61 = Scalar(1.0) / (_tmp60);
  const Scalar _tmp62 = _tmp59 * _tmp61;
  const Scalar _tmp63 = Scalar(1.0) / (_tmp57 * _tmp62 - _tmp58);
  const Scalar _tmp64 = _tmp18 + _tmp6;
  const Scalar _tmp65 = _tmp64 + position_vector(1, 0);
  const Scalar _tmp66 = _tmp65 + Scalar(-110.0);
  const Scalar _tmp67 = _tmp21 + _tmp29;
  ...
  const Scalar _tmp77 = _tmp41 * _tmp62;
  const Scalar _tmp78 = -_tmp57 * _tmp77 + _tmp58 * _tmp76;
  const Scalar _tmp79 = _tmp71 * _tmp75 - _tmp72 * _tmp77 - _tmp74 * _tmp78;
  ...
  const Scalar _tmp86 = _tmp41 * _tmp57 - _tmp57 * _tmp76;
  const Scalar _tmp87 = _tmp41 * _tmp72 - _tmp72 * _tmp75 - _tmp74 * _tmp86 - _tmp79 * _tmp85;
  ...
  const Scalar _tmp95 = _tmp93 * (_tmp43 * _tmp59 * _tmp94 - _tmp46 * _tmp60 * _tmp94);
  const Scalar _tmp96 = _tmp50 * _tmp57 - _tmp53 * _tmp58 + _tmp57 * _tmp95;
  const Scalar _tmp97 = _tmp64 * _tmp72 - _tmp67 * _tmp71 + _tmp72 * _tmp95 - _tmp74 * _tmp96;
  const Scalar _tmp98 = Scalar(1.0) / (_tmp97);
  const Scalar _tmp99 = Scalar(1.0) * _tmp98;
  const Scalar _tmp100 = Scalar(1.0) * _tmp63;
  const Scalar _tmp101 = _tmp100 * _tmp73 * _tmp98;
  const Scalar _tmp102 = _tmp20 + Scalar(110.0);
  const Scalar _tmp103 = _tmp31 + Scalar(125.0);
  ...
  const Scalar _tmp109 = _tmp108 * _tmp78 + _tmp77;
  const Scalar _tmp110 = _tmp108 * _tmp86 - _tmp109 * _tmp85 - _tmp41;
  const Scalar _tmp111 = _tmp88 * _tmp97;
  const Scalar _tmp112 = _tmp87 * _tmp98;
  const Scalar _tmp113 = _tmp112 * (_tmp108 * _tmp96 - _tmp110 * _tmp111 - _tmp95);
  const Scalar _tmp114 = _tmp110 + _tmp113;
  const Scalar _tmp115 = _tmp73 * _tmp88;
  const Scalar _tmp116 = -_tmp114 * _tmp115 - _tmp62;
  const Scalar _tmp117 = _tmp57 * _tmp63;
  const Scalar _tmp118 = _tmp72 * _tmp88;
  const Scalar _tmp119 = _tmp106 * fh1;
  const Scalar _tmp120 = Scalar(1.0) * _tmp82;
  const Scalar _tmp121 = -_tmp100 * _tmp86 + _tmp120 * _tmp63 * _tmp78 * _tmp84;
  ...
  const Scalar _tmp126 = -_tmp107 * _tmp93 * (-_tmp101 * _tmp57 + _tmp72 * _tmp99) -
                         _tmp119 * _tmp93 * (_tmp114 * _tmp118 + _tmp116 * _tmp117 + Scalar(1.0)) -
                         _tmp125 * _tmp93 * (_tmp117 * _tmp124 + _tmp118 * _tmp123) -
                         _tmp49 * _tmp93 * (-_tmp57 * _tmp74 * _tmp91 + _tmp72 * _tmp91);
  const Scalar _tmp127 = Scalar(1.0) / (_tmp126);
  const Scalar _tmp128 = _tmp79 * _tmp88;
  const Scalar _tmp129 = _tmp64 + _tmp81;
  const Scalar _tmp130 = _tmp129 * _tmp85;
  const Scalar _tmp131 = Scalar(1.0) / (-_tmp130 - _tmp67 + _tmp83);
  const Scalar _tmp132 = _tmp131 * _tmp89;
  const Scalar _tmp133 = -_tmp128 * _tmp90 - _tmp129 * _tmp132 + _tmp81;
  const Scalar _tmp134 = Scalar(1.0) * _tmp131;
  const Scalar _tmp135 = _tmp129 * _tmp131;
  const Scalar _tmp136 = _tmp109 + _tmp113 * _tmp135 - _tmp114 * _tmp128;
  ...
  const Scalar _tmp141 = -_tmp105 * _tmp140 - Scalar(40.024799999999999) * _tmp16 - _tmp19 * fv1;
  const Scalar _tmp142 = _tmp112 * _tmp134;
  const Scalar _tmp143 = _tmp129 * _tmp142 - _tmp79 * _tmp99;
  const Scalar _tmp144 = _tmp106 * _tmp140 + Scalar(40.024799999999999) * _tmp27 + _tmp30 * fv1;
  const Scalar _tmp145 = _tmp129 * _tmp82;
  const Scalar _tmp146 = -_tmp100 * _tmp78 + _tmp122 * _tmp135 - _tmp123 * _tmp128;
  const Scalar _tmp147 = std::asinh(
      _tmp127 * (_tmp105 * _tmp137 * (-_tmp120 * _tmp146 + _tmp122 * _tmp134) +
                 _tmp106 * _tmp137 * (_tmp113 * _tmp134 - _tmp120 * _tmp136) +
                 Scalar(1.0) * _tmp107 * (-_tmp120 * _tmp143 + _tmp142) +
                 Scalar(1.0) * _tmp141 * (-_tmp120 * _tmp139 + _tmp138) +
                 Scalar(1.0) * _tmp144 * (_tmp134 * _tmp145 - _tmp134) +
                 Scalar(1.0) * _tmp49 * (-_tmp120 * _tmp133 - _tmp134 * _tmp89 + Scalar(1.0))));
  const Scalar _tmp148 = Scalar(1.4083112389913199) * _tmp126;
  const Scalar _tmp149 = _tmp49 * _tmp91;
  const Scalar _tmp150 = -_tmp101 * _tmp107 + _tmp116 * _tmp119 * _tmp63 +
                         _tmp124 * _tmp125 * _tmp63 - _tmp149 * _tmp74;
  const Scalar _tmp151 = Scalar(1.0) / (_tmp150);
  const Scalar _tmp152 = _tmp134 * _tmp144;
  const Scalar _tmp153 =
      std::asinh(_tmp151 * (_tmp107 * _tmp143 * _tmp82 + _tmp119 * _tmp136 * _tmp82 +
                            _tmp125 * _tmp146 * _tmp82 + _tmp133 * _tmp49 * _tmp82 +
                            _tmp139 * _tmp141 * _tmp82 - _tmp145 * _tmp152));
  ...
  const Scalar _tmp157 =
      _tmp107 * _tmp99 + _tmp114 * _tmp119 * _tmp88 + _tmp123 * _tmp125 * _tmp88 + _tmp149;
  const Scalar _tmp158 = Scalar(1.0) / (_tmp157);
  const Scalar _tmp159 = std::asinh(_tmp158 * (-_tmp107 * _tmp142 - _tmp113 * _tmp119 * _tmp131 -
                                               _tmp122 * _tmp125 * _tmp131 + _tmp132 * _tmp49 -
                                               _tmp138 * _tmp141 + _tmp152));
  ...
  _res(2, 0) =
      ...
      Scalar(48.0) * std::sqrt(Scalar(
                         ...
                         std::pow(Scalar(-Scalar(0.020833333333333332) * _tmp76 -
                                         Scalar(0.020833333333333332) * position_vector(2, 0) + 1),
                                  Scalar(2))));
  _res(3, 0) =
