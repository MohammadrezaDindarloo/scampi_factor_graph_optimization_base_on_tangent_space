...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl14(
  ...
  const Scalar _tmp30 = -Scalar(0.20999999999999999) * _tmp10 + Scalar(0.20999999999999999) * _tmp9;
  ...
  const Scalar _tmp45 = Scalar(1.0) / (_tmp28 * _tmp41 - _tmp44);
  const Scalar _tmp46 = _tmp45 * (_tmp33 * _tmp41 - _tmp41 * _tmp43);
  const Scalar _tmp47 = _tmp28 * _tmp33;
  const Scalar _tmp48 = _tmp45 * (-_tmp41 * _tmp47 + _tmp43 * _tmp44);
  const Scalar _tmp49 = Scalar(1.0) * _tmp26;
  const Scalar _tmp50 = Scalar(1.0) * _tmp16;
  const Scalar _tmp51 = (-_tmp38 + _tmp50) / (_tmp35 - _tmp49);
  const Scalar _tmp52 = _tmp28 * _tmp46 - _tmp33 - _tmp51 * (_tmp28 * _tmp48 + _tmp47);
  ...
  const Scalar _tmp56 = _tmp37 + _tmp7;
  ...
  const Scalar _tmp61 = _tmp31 + _tmp42;
  const Scalar _tmp62 = _tmp55 * _tmp58;
  const Scalar _tmp63 = _tmp28 * _tmp59 - _tmp62;
  const Scalar _tmp64 = -_tmp46 * _tmp63 -
                        _tmp51 * (-_tmp28 * _tmp60 - _tmp48 * _tmp63 + _tmp61 * _tmp62) -
  ...
  const Scalar _tmp68 = _tmp18 * _tmp66;
  const Scalar _tmp69 = _tmp68 * (_tmp16 * _tmp27 * _tmp67 - _tmp17 * _tmp26 * _tmp67);
  const Scalar _tmp70 = _tmp45 * (_tmp35 * _tmp41 - _tmp38 * _tmp44 + _tmp41 * _tmp69);
  const Scalar _tmp71 = _tmp54 * _tmp59 - _tmp56 * _tmp62 + _tmp59 * _tmp69 - _tmp63 * _tmp70;
  const Scalar _tmp72 = _tmp65 * _tmp71;
  const Scalar _tmp73 = Scalar(1.0) / (_tmp71);
  const Scalar _tmp74 = _tmp64 * _tmp73;
  const Scalar _tmp75 = _tmp52 + _tmp74 * (_tmp28 * _tmp70 - _tmp52 * _tmp72 - _tmp69);
  ...
  const Scalar _tmp82 = _tmp19 + _tmp53;
  ...
  const Scalar _tmp87 = -Scalar(1.0) * _tmp46 + Scalar(1.0) * _tmp48 * _tmp51;
  ...
  const Scalar _tmp91 = Scalar(1.0) * _tmp73;
  const Scalar _tmp92 = fh1 * (_tmp80 * _tmp90 - _tmp82 * _tmp85);
  const Scalar _tmp93 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp94 = _tmp49 * _tmp51 + _tmp50;
  const Scalar _tmp95 = 0;
  const Scalar _tmp96 = _tmp76 * _tmp95;
  const Scalar _tmp97 = _tmp65 * _tmp95;
  const Scalar _tmp98 = _tmp45 * fh1;
  const Scalar _tmp99 = _tmp91 * _tmp92;
  const Scalar _tmp100 = _tmp65 * fh1;

  // Output terms (1)
  Eigen::Matrix<Scalar, 4, 1> _res;

  _res(0, 0) = std::exp(-fh1);
  _res(1, 0) = std::exp(_tmp68 * _tmp92 * (_tmp59 * _tmp91 - _tmp63 * _tmp78 * _tmp91) +
                        _tmp68 * _tmp93 * (_tmp59 * _tmp97 - _tmp78 * _tmp96) +
                        _tmp85 * _tmp86 * (_tmp75 * _tmp79 + _tmp77 * _tmp78 + Scalar(1.0)) +
                        _tmp86 * _tmp90 * (_tmp78 * _tmp89 + _tmp79 * _tmp88));
  _res(2, 0) = std::exp(_tmp45 * _tmp63 * _tmp99 + _tmp45 * _tmp93 * _tmp96 -
                        _tmp77 * _tmp85 * _tmp98 - _tmp89 * _tmp90 * _tmp98);
  _res(3, 0) =
      std::exp(-_tmp100 * _tmp75 * _tmp85 - _tmp100 * _tmp88 * _tmp90 - _tmp93 * _tmp97 - _tmp99);
