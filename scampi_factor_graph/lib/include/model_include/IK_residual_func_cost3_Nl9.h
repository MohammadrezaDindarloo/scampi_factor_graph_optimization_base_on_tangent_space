...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl9(const Scalar fh1, const Scalar fv1,
  ...
  const Scalar _tmp30 = _tmp21 + _tmp24;
  ...
  const Scalar _tmp34 = _tmp16 + _tmp8;
  ...
  const Scalar _tmp41 = Scalar(0.20999999999999999) * _tmp10 + Scalar(0.20999999999999999) * _tmp11;
  ...
  const Scalar _tmp46 = _tmp38 * (-_tmp37 * _tmp45 + _tmp43);
  const Scalar _tmp47 = Scalar(1.0) * _tmp34;
  const Scalar _tmp48 = Scalar(1.0) * _tmp31;
  const Scalar _tmp49 = (-_tmp26 + _tmp48) / (_tmp17 - _tmp47);
  const Scalar _tmp50 = _tmp29 * _tmp45 - _tmp36 * _tmp43;
  const Scalar _tmp51 = _tmp38 * _tmp50;
  const Scalar _tmp52 = -Scalar(1.0) * _tmp46 + Scalar(1.0) * _tmp49 * _tmp51;
  ...
  const Scalar _tmp63 = _tmp42 * _tmp61;
  const Scalar _tmp64 = -_tmp41 + _tmp44;
  const Scalar _tmp65 = _tmp38 * _tmp62;
  const Scalar _tmp66 = -_tmp46 * _tmp62 -
                        _tmp49 * (-_tmp36 * _tmp63 - _tmp50 * _tmp65 + _tmp60 * _tmp64) -
                        _tmp61 * _tmp64 + _tmp63;
  ...
  const Scalar _tmp72 = _tmp17 * _tmp37 - _tmp26 * _tmp29 + _tmp37 * _tmp71;
  const Scalar _tmp73 = _tmp54 * _tmp61 - _tmp57 * _tmp60 + _tmp61 * _tmp71 - _tmp65 * _tmp72;
  const Scalar _tmp74 = _tmp67 * _tmp73;
  const Scalar _tmp75 = _tmp38 * _tmp72;
  const Scalar _tmp76 = Scalar(1.0) / (_tmp73);
  const Scalar _tmp77 = _tmp66 * _tmp76;
  const Scalar _tmp78 = _tmp52 + _tmp77 * (-_tmp52 * _tmp74 - Scalar(1.0) * _tmp75);
  const Scalar _tmp79 = _tmp62 * _tmp67;
  const Scalar _tmp80 = -_tmp78 * _tmp79 + Scalar(1.0);
  const Scalar _tmp81 = _tmp37 * _tmp38;
  const Scalar _tmp82 = _tmp61 * _tmp67;
  const Scalar _tmp83 = _tmp30 + _tmp56;
  const Scalar _tmp84 = _tmp83 + p_init0 + Scalar(-2.5202214700000001);
  const Scalar _tmp85 = _tmp53 + _tmp8;
  const Scalar _tmp86 = _tmp85 + p_init1 + Scalar(8.3888750099999996);
  ...
  const Scalar _tmp94 = _tmp47 * _tmp49 + _tmp48;
  const Scalar _tmp95 = 0;
  const Scalar _tmp96 = _tmp79 * _tmp95;
  const Scalar _tmp97 = _tmp67 * _tmp95;
  const Scalar _tmp98 = _tmp36 * _tmp46 - _tmp42 - _tmp49 * (_tmp36 * _tmp42 + _tmp36 * _tmp51);
  const Scalar _tmp99 = _tmp77 * (_tmp36 * _tmp75 - _tmp71 - _tmp74 * _tmp98) + _tmp98;
  const Scalar _tmp100 = -_tmp36 - _tmp79 * _tmp99;
  const Scalar _tmp101 = _tmp91 * fh1;
  ...
  _res(1, 0) = std::exp(_tmp101 * _tmp70 * (_tmp100 * _tmp81 + _tmp82 * _tmp99 + Scalar(1.0)) +
                        _tmp70 * _tmp89 * (_tmp78 * _tmp82 + _tmp80 * _tmp81) +
                        _tmp70 * _tmp92 * (-_tmp37 * _tmp65 * _tmp90 + _tmp61 * _tmp90) +
                        _tmp70 * _tmp93 * (_tmp61 * _tmp97 - _tmp81 * _tmp96));
  _res(2, 0) = std::exp(-_tmp100 * _tmp101 * _tmp38 + _tmp102 * _tmp65 - _tmp38 * _tmp80 * _tmp89 +
                        _tmp38 * _tmp93 * _tmp96);
  _res(3, 0) =
      std::exp(-_tmp101 * _tmp67 * _tmp99 - _tmp102 - _tmp67 * _tmp78 * _tmp89 - _tmp93 * _tmp97);
