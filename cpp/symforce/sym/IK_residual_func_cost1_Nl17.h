...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl17(
  ...
  const Scalar _tmp63 = -_tmp47 * _tmp59 + _tmp61 * _tmp62;
  const Scalar _tmp64 = Scalar(1.0) / (_tmp47 * _tmp58 - _tmp62);
  ...
  const Scalar _tmp69 = Scalar(1.0) / (_tmp50 + _tmp68);
  const Scalar _tmp70 = Scalar(1.0) * _tmp43;
  const Scalar _tmp71 = -_tmp54 + _tmp70;
  const Scalar _tmp72 = _tmp69 * _tmp71;
  const Scalar _tmp73 = -_tmp58 * _tmp61 + _tmp59;
  const Scalar _tmp74 = -_tmp37 + _tmp65 * _tmp73 - _tmp66 * _tmp72;
  const Scalar _tmp75 = _tmp36 + _tmp60;
  const Scalar _tmp76 = _tmp38 + _tmp49;
  const Scalar _tmp77 = _tmp76 + position_vector(1, 0);
  const Scalar _tmp78 = _tmp77 + Scalar(8.3196563700000006);
  const Scalar _tmp79 = _tmp42 + _tmp53;
  ...
  const Scalar _tmp85 = _tmp47 * _tmp84 - _tmp83;
  const Scalar _tmp86 = _tmp64 * _tmp85;
  const Scalar _tmp87 = -_tmp48 * _tmp84 - _tmp63 * _tmp86 + _tmp75 * _tmp83;
  const Scalar _tmp88 = _tmp37 * _tmp84 - _tmp72 * _tmp87 - _tmp73 * _tmp86 - _tmp75 * _tmp84;
  ...
  const Scalar _tmp92 = _tmp46 * _tmp90;
  const Scalar _tmp93 = _tmp92 * (-_tmp39 * _tmp45 * _tmp91 + _tmp41 * _tmp43 * _tmp91);
  const Scalar _tmp94 = _tmp50 * _tmp58 - _tmp54 * _tmp62 + _tmp58 * _tmp93;
  ...
  const Scalar _tmp102 = -_tmp100 * _tmp101 - _tmp47;
  const Scalar _tmp103 = _tmp58 * _tmp64;
  ...
  const Scalar _tmp114 = _tmp58 * _tmp86;
  const Scalar _tmp115 = Scalar(1.0) * _tmp69;
  const Scalar _tmp116 = Scalar(1.0) * _tmp64;
  const Scalar _tmp117 = _tmp115 * _tmp63 * _tmp64 * _tmp71 - _tmp116 * _tmp73;
  const Scalar _tmp118 = _tmp98 * (-_tmp116 * _tmp94 - _tmp117 * _tmp96);
  ...
  const Scalar _tmp124 = fh1 * (-_tmp108 * _tmp29 + _tmp121 * _tmp19);
  const Scalar _tmp125 = -_tmp109 * _tmp92 * (_tmp100 * _tmp104 + _tmp102 * _tmp103 + Scalar(1.0)) -
                         _tmp110 * _tmp92 * (-_tmp113 * _tmp114 + _tmp113 * _tmp84) -
                         _tmp122 * _tmp92 * (_tmp103 * _tmp120 + _tmp104 * _tmp119) -
                         _tmp124 * _tmp92 * (-_tmp114 * _tmp123 + _tmp123 * _tmp84);
  const Scalar _tmp126 = Scalar(1.0) / (_tmp125);
  const Scalar _tmp127 = _tmp87 * _tmp89;
  const Scalar _tmp128 = _tmp68 + _tmp76;
  const Scalar _tmp129 = _tmp128 * _tmp72;
  const Scalar _tmp130 = Scalar(1.0) / (-_tmp129 + _tmp70 - _tmp79);
  const Scalar _tmp131 = _tmp128 * _tmp130;
  const Scalar _tmp132 = -_tmp116 * _tmp63 + _tmp118 * _tmp131 - _tmp119 * _tmp127;
  const Scalar _tmp133 = Scalar(1.0) * _tmp130;
  const Scalar _tmp134 = _tmp35 * fh1;
  const Scalar _tmp135 = -_tmp121 * _tmp134 - Scalar(5.1796800000000003) * _tmp26 - _tmp29 * fv1;
  const Scalar _tmp136 = _tmp129 * _tmp133 + Scalar(1.0);
  const Scalar _tmp137 = _tmp111 * _tmp130;
  const Scalar _tmp138 = -_tmp112 * _tmp127 - _tmp128 * _tmp137 + _tmp68;
  const Scalar _tmp139 = -_tmp100 * _tmp127 + _tmp131 * _tmp99 + _tmp66;
  const Scalar _tmp140 = _tmp133 * _tmp98;
  const Scalar _tmp141 = -_tmp123 * _tmp87 + _tmp128 * _tmp140;
  const Scalar _tmp142 = _tmp108 * _tmp134 + Scalar(5.1796800000000003) * _tmp12 + _tmp19 * fv1;
  const Scalar _tmp143 = _tmp128 * _tmp69;
  const Scalar _tmp144 = std::asinh(
      _tmp126 * (Scalar(1.0) * _tmp109 * (-_tmp115 * _tmp139 + _tmp133 * _tmp99) +
                 Scalar(1.0) * _tmp110 * (-_tmp111 * _tmp133 - _tmp115 * _tmp138 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp122 * (-_tmp115 * _tmp132 + _tmp118 * _tmp133) +
                 Scalar(1.0) * _tmp124 * (-_tmp115 * _tmp141 + _tmp140) +
                 Scalar(1.0) * _tmp135 * (-_tmp115 * _tmp136 + _tmp133 * _tmp72) +
                 Scalar(1.0) * _tmp142 * (_tmp133 * _tmp143 - _tmp133)));
  const Scalar _tmp145 = Scalar(9.6622558468725703) * _tmp125;
  const Scalar _tmp146 = _tmp135 * _tmp69;
  const Scalar _tmp147 = _tmp133 * _tmp142;
  const Scalar _tmp148 = _tmp110 * _tmp113;
  const Scalar _tmp149 = _tmp123 * _tmp124;
  const Scalar _tmp150 =
      _tmp102 * _tmp109 * _tmp64 + _tmp120 * _tmp122 * _tmp64 - _tmp148 * _tmp86 - _tmp149 * _tmp86;
  const Scalar _tmp151 = Scalar(1.0) / (_tmp150);
  const Scalar _tmp152 =
      std::asinh(_tmp151 * (_tmp109 * _tmp139 * _tmp69 + _tmp110 * _tmp138 * _tmp69 +
                            _tmp122 * _tmp132 * _tmp69 + _tmp124 * _tmp141 * _tmp69 +
                            _tmp136 * _tmp146 - _tmp143 * _tmp147));
  const Scalar _tmp153 = Scalar(9.6622558468725703) * _tmp150;
  const Scalar _tmp154 =
      _tmp100 * _tmp109 * _tmp89 + _tmp119 * _tmp122 * _tmp89 + _tmp148 + _tmp149;
  const Scalar _tmp155 = Scalar(1.0) / (_tmp154);
  const Scalar _tmp156 = std::asinh(_tmp155 * (-_tmp109 * _tmp130 * _tmp99 + _tmp110 * _tmp137 -
                                               _tmp118 * _tmp122 * _tmp130 - _tmp124 * _tmp140 -
                                               _tmp133 * _tmp146 * _tmp71 + _tmp147));
  ...
  _res(1, 0) =
      -_tmp145 *
          (Scalar(0.86625939559540499) * _tmp126 + std::cosh(Scalar(1.0) * _tmp144) -
           std::cosh(
  ...
  _res(2, 0) =
      -_tmp153 *
          (Scalar(0.87653584775870996) * _tmp151 + std::cosh(Scalar(1.0) * _tmp152) -
           std::cosh(
                ...
                Scalar(8.3196563700000006) *
                    std::sqrt(Scalar(
                        ...
                        Scalar(0.057067943376852184) *
                            std::pow(Scalar(-Scalar(0.50315118556004401) * _tmp80 - 1),
                                     Scalar(2))))))) +
