...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl10(
  ...
  const Scalar _tmp19 = Scalar(0.20999999999999999) * _tmp11 - Scalar(0.20999999999999999) * _tmp13;
  ...
  const Scalar _tmp52 = Scalar(1.0) / (_tmp40 * _tmp50 - _tmp51);
  const Scalar _tmp53 =
  ...
  const Scalar _tmp57 = _tmp52 * (_tmp43 * _tmp50 - _tmp47 * _tmp51 + _tmp50 * _tmp56);
  ...
  const Scalar _tmp64 = _tmp15 + _tmp42;
  const Scalar _tmp65 = _tmp44 + _tmp64;
  const Scalar _tmp66 = _tmp27 + _tmp63;
  ...
  const Scalar _tmp78 = _tmp52 * (-_tmp50 * _tmp77 + _tmp51 * _tmp75);
  const Scalar _tmp79 = Scalar(1.0) * _tmp33;
  const Scalar _tmp80 = Scalar(1.0) * _tmp36;
  const Scalar _tmp81 = (-_tmp47 + _tmp80) / (_tmp43 - _tmp79);
  const Scalar _tmp82 = _tmp52 * (-_tmp50 * _tmp75 + _tmp50 * _tmp76);
  const Scalar _tmp83 = Scalar(1.0) * _tmp78 * _tmp81 - Scalar(1.0) * _tmp82;
  const Scalar _tmp84 = _tmp71 + _tmp72 + _tmp73;
  const Scalar _tmp85 = _tmp30 * _tmp76;
  const Scalar _tmp86 = -_tmp30 * _tmp84 - _tmp41 * _tmp82 -
                        _tmp81 * (_tmp31 * _tmp84 - _tmp40 * _tmp85 - _tmp41 * _tmp78) + _tmp85;
  const Scalar _tmp87 = Scalar(1.0) / (_tmp86);
  const Scalar _tmp88 = _tmp58 * _tmp87;
  const Scalar _tmp89 = _tmp59 * _tmp86;
  const Scalar _tmp90 = _tmp83 + _tmp89 * (-Scalar(1.0) * _tmp57 - _tmp83 * _tmp88);
  const Scalar _tmp91 = _tmp41 * _tmp87;
  const Scalar _tmp92 = -_tmp90 * _tmp91 + Scalar(1.0);
  const Scalar _tmp93 = _tmp30 * _tmp87;
  const Scalar _tmp94 = _tmp68 * fh1;
  const Scalar _tmp95 = _tmp40 * _tmp82 - _tmp76 - _tmp81 * (_tmp40 * _tmp78 + _tmp77);
  const Scalar _tmp96 = _tmp89 * (_tmp40 * _tmp57 - _tmp56 - _tmp88 * _tmp95) + _tmp95;
  const Scalar _tmp97 = -_tmp40 - _tmp91 * _tmp96;
  const Scalar _tmp98 = _tmp69 * fh1;
  const Scalar _tmp99 = Scalar(333.54000000000002) - fv1;
  const Scalar _tmp100 = _tmp79 * _tmp81 + _tmp80;
  const Scalar _tmp101 = 0;
  const Scalar _tmp102 = _tmp55 * (_tmp101 * _tmp30 - _tmp101 * _tmp62);
  const Scalar _tmp103 = _tmp60 * _tmp70;
  const Scalar _tmp104 = _tmp41 * _tmp52;
  ...
  _res(0, 0) = 0;
  _res(1, 0) =
      -_tmp102 * std::exp(_tmp102 * _tmp99 + _tmp55 * _tmp70 * (_tmp30 * _tmp60 - _tmp60 * _tmp62) +
                          _tmp55 * _tmp94 * (_tmp61 * _tmp92 + _tmp90 * _tmp93) +
                          _tmp55 * _tmp98 * (_tmp61 * _tmp97 + _tmp93 * _tmp96 + Scalar(1.0)));
  _res(2, 0) = -_tmp101 * _tmp104 *
               std::exp(_tmp103 * _tmp104 + _tmp104 * _tmp105 - _tmp52 * _tmp92 * _tmp94 -
                        _tmp52 * _tmp97 * _tmp98);
  _res(3, 0) =
      _tmp101 * std::exp(-_tmp103 - _tmp105 - _tmp87 * _tmp90 * _tmp94 - _tmp87 * _tmp96 * _tmp98);
