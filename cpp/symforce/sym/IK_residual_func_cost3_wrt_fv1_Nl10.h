...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl10(
  ...
  const Scalar _tmp68 = _tmp42 * _tmp65 - _tmp67;
  const Scalar _tmp69 = _tmp43 * _tmp68;
  const Scalar _tmp70 = _tmp46 + _tmp50;
  const Scalar _tmp71 = -_tmp56 * (-_tmp42 * _tmp66 - _tmp53 * _tmp69 + _tmp67 * _tmp70) -
                        _tmp57 * _tmp69 - _tmp65 * _tmp70 + _tmp66;
  const Scalar _tmp72 = Scalar(1.0) / (_tmp71);
  const Scalar _tmp73 = _tmp40 * _tmp65 - _tmp41 * _tmp69 + _tmp59 * _tmp65 - _tmp62 * _tmp67;
  const Scalar _tmp74 = _tmp72 * _tmp73;
  const Scalar _tmp75 = Scalar(1.0) / (_tmp73);
  const Scalar _tmp76 = _tmp71 * _tmp75;
  const Scalar _tmp77 = _tmp58 + _tmp76 * (-_tmp41 * _tmp44 - _tmp58 * _tmp74);
  const Scalar _tmp78 = _tmp68 * _tmp72;
  const Scalar _tmp79 = -_tmp77 * _tmp78 + Scalar(1.0);
  const Scalar _tmp80 = _tmp30 * _tmp43;
  const Scalar _tmp81 = _tmp65 * _tmp72;
  const Scalar _tmp82 = _tmp17 + _tmp24;
  const Scalar _tmp83 = _tmp82 + position_vector(1, 0) + Scalar(8.3888750099999996);
  const Scalar _tmp84 = _tmp61 + _tmp7;
  const Scalar _tmp85 = _tmp84 + position_vector(0, 0) + Scalar(-2.5202214700000001);
  const Scalar _tmp86 = std::pow(Scalar(std::pow(_tmp83, Scalar(2)) + std::pow(_tmp85, Scalar(2))),
                                 Scalar(Scalar(-1) / Scalar(2)));
  const Scalar _tmp87 = _tmp83 * _tmp86;
  const Scalar _tmp88 = _tmp39 * fh1;
  const Scalar _tmp89 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp90 = _tmp54 * _tmp56 + _tmp55;
  const Scalar _tmp91 = 0;
  const Scalar _tmp92 = _tmp69 * _tmp91;
  const Scalar _tmp93 = _tmp39 * (-_tmp30 * _tmp92 + _tmp65 * _tmp91);
  const Scalar _tmp94 = _tmp44 * _tmp68 * _tmp75;
  const Scalar _tmp95 = Scalar(1.0) * _tmp75;
  const Scalar _tmp96 = _tmp85 * _tmp86;
  const Scalar _tmp97 = fh1 * (-_tmp82 * _tmp96 + _tmp84 * _tmp87);
  const Scalar _tmp98 = _tmp42 * _tmp43;
  const Scalar _tmp99 = -_tmp51 - _tmp56 * (_tmp52 + _tmp53 * _tmp98) + _tmp57 * _tmp98;
  const Scalar _tmp100 = _tmp76 * (-_tmp40 + _tmp41 * _tmp98 - _tmp74 * _tmp99) + _tmp99;
  const Scalar _tmp101 = -_tmp100 * _tmp78 - _tmp42;
  const Scalar _tmp102 = _tmp89 * _tmp91;
  const Scalar _tmp103 = _tmp43 * fh1;
  const Scalar _tmp104 = _tmp72 * fh1;
  ...
  _res(0, 0) = 0;
  _res(1, 0) =
      -_tmp93 * std::exp(_tmp39 * _tmp97 * (-_tmp30 * _tmp94 + _tmp65 * _tmp95) +
                         _tmp87 * _tmp88 * (_tmp77 * _tmp81 + _tmp79 * _tmp80) +
                         _tmp88 * _tmp96 * (_tmp100 * _tmp81 + _tmp101 * _tmp80 + Scalar(1.0)) +
                         _tmp89 * _tmp93);
  _res(2, 0) = -_tmp92 * std::exp(-_tmp101 * _tmp103 * _tmp96 + _tmp102 * _tmp69 -
                                  _tmp103 * _tmp79 * _tmp87 + _tmp94 * _tmp97);
  _res(3, 0) = _tmp91 * std::exp(-_tmp100 * _tmp104 * _tmp96 - _tmp102 - _tmp104 * _tmp77 * _tmp87 -
                                 _tmp95 * _tmp97);
