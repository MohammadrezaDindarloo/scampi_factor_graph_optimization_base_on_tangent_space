...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2Nl2(
  ...
  const Scalar _tmp62 = _tmp52 * _tmp58;
  const Scalar _tmp63 = _tmp48 * _tmp62 - _tmp61;
  const Scalar _tmp64 = _tmp49 + _tmp6;
  const Scalar _tmp65 = _tmp64 + position_vector(1, 0);
  const Scalar _tmp66 = _tmp65 + Scalar(8.3888750099999996);
  const Scalar _tmp67 = _tmp21 + _tmp28;
  ...
  const Scalar _tmp74 = _tmp73 * (_tmp60 * _tmp72 + _tmp64 * _tmp72 - _tmp67 * _tmp71);
  const Scalar _tmp75 = -_tmp41 * _tmp61 + _tmp44 * _tmp48 + _tmp48 * _tmp60 - _tmp63 * _tmp74;
  const Scalar _tmp76 = Scalar(1.0) / (_tmp75);
  const Scalar _tmp77 = Scalar(1.0) * _tmp76;
  const Scalar _tmp78 = _tmp72 * _tmp73;
  const Scalar _tmp79 = _tmp30 + Scalar(1.9874742000000001);
  const Scalar _tmp80 = _tmp19 + Scalar(8.3196563700000006);
  ...
  const Scalar _tmp85 = _tmp36 + _tmp37;
  const Scalar _tmp86 = _tmp34 + _tmp85;
  const Scalar _tmp87 = _tmp62 * _tmp86;
  const Scalar _tmp88 = _tmp35 + _tmp85;
  const Scalar _tmp89 = _tmp73 * (_tmp71 * _tmp88 - _tmp72 * _tmp87);
  const Scalar _tmp90 = _tmp62 * _tmp89 + _tmp87;
  const Scalar _tmp91 = Scalar(1.0) * _tmp50;
  const Scalar _tmp92 = -_tmp91;
  const Scalar _tmp93 = Scalar(1.0) / (_tmp64 + _tmp92);
  const Scalar _tmp94 = Scalar(1.0) * _tmp53;
  const Scalar _tmp95 = _tmp93 * (-_tmp67 + _tmp94);
  const Scalar _tmp96 = _tmp73 * (_tmp72 * _tmp86 - _tmp72 * _tmp88);
  const Scalar _tmp97 = _tmp62 * _tmp96 - _tmp86 - _tmp90 * _tmp95;
  const Scalar _tmp98 = _tmp34 + _tmp38;
  const Scalar _tmp99 = _tmp48 * _tmp86;
  const Scalar _tmp100 = _tmp61 * _tmp98 - _tmp62 * _tmp99 - _tmp63 * _tmp89;
  const Scalar _tmp101 = -_tmp100 * _tmp95 - _tmp48 * _tmp98 - _tmp63 * _tmp96 + _tmp99;
  const Scalar _tmp102 = Scalar(1.0) / (_tmp101);
  const Scalar _tmp103 = _tmp102 * _tmp75;
  const Scalar _tmp104 = _tmp101 * _tmp76;
  const Scalar _tmp105 = _tmp104 * (-_tmp103 * _tmp97 - _tmp60 + _tmp62 * _tmp74);
  const Scalar _tmp106 = _tmp105 + _tmp97;
  const Scalar _tmp107 = _tmp102 * _tmp63;
  ...
  const Scalar _tmp112 = _tmp111 * _tmp95 - Scalar(1.0) * _tmp96;
  const Scalar _tmp113 = _tmp104 * (-_tmp103 * _tmp112 - Scalar(1.0) * _tmp74);
  const Scalar _tmp114 = _tmp112 + _tmp113;
  const Scalar _tmp115 = -_tmp107 * _tmp114 + Scalar(1.0);
  const Scalar _tmp116 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp117 = _tmp91 * _tmp95 + _tmp94;
  const Scalar _tmp118 = 0;
  const Scalar _tmp119 = _tmp102 * _tmp118;
  const Scalar _tmp120 = _tmp107 * _tmp118;
  const Scalar _tmp121 = -_tmp110 * _tmp82 * (_tmp109 * _tmp114 + _tmp115 * _tmp78) -
                         _tmp110 * _tmp83 * (_tmp106 * _tmp109 + _tmp108 * _tmp78 + Scalar(1.0)) -
                         _tmp116 * _tmp59 * (_tmp119 * _tmp48 - _tmp120 * _tmp78) -
                         _tmp59 * _tmp84 * (_tmp48 * _tmp77 - _tmp63 * _tmp77 * _tmp78);
  const Scalar _tmp122 = Scalar(1.0) / (_tmp121);
  const Scalar _tmp123 = _tmp44 + _tmp92;
  const Scalar _tmp124 = _tmp123 * _tmp95;
  const Scalar _tmp125 = Scalar(1.0) / (-_tmp124 - _tmp41 + _tmp94);
  const Scalar _tmp126 = Scalar(1.0) * _tmp125;
  const Scalar _tmp127 = _tmp104 * _tmp126;
  const Scalar _tmp128 = -_tmp100 * _tmp77 + _tmp123 * _tmp127;
  const Scalar _tmp129 = Scalar(1.0) * _tmp93;
  const Scalar _tmp130 = _tmp100 * _tmp102;
  const Scalar _tmp131 = _tmp117 * _tmp125;
  const Scalar _tmp132 = _tmp93 * (-_tmp118 * _tmp130 - _tmp123 * _tmp131 + _tmp92);
  const Scalar _tmp133 = _tmp126 * _tmp95;
  const Scalar _tmp134 = _tmp93 * (_tmp124 * _tmp126 + Scalar(1.0));
  const Scalar _tmp135 = _tmp39 * fh1;
  const Scalar _tmp136 = -_tmp135 * _tmp82 - Scalar(5.1796800000000003) * _tmp15 - _tmp18 * fv1;
  const Scalar _tmp137 = _tmp135 * _tmp83 + Scalar(5.1796800000000003) * _tmp25 + _tmp29 * fv1;
  const Scalar _tmp138 = _tmp123 * _tmp93;
  const Scalar _tmp139 = _tmp123 * _tmp125;
  const Scalar _tmp140 = _tmp105 * _tmp139 - _tmp106 * _tmp130 + _tmp90;
  const Scalar _tmp141 = Scalar(1.0) * fh1;
  const Scalar _tmp142 = -_tmp111 + _tmp113 * _tmp139 - _tmp114 * _tmp130;
  const Scalar _tmp143 =
      std::asinh(_tmp122 * (Scalar(1.0) * _tmp116 *
                                (-_tmp117 * _tmp126 - Scalar(1.0) * _tmp132 + Scalar(1.0)) +
                            Scalar(1.0) * _tmp136 * (_tmp133 - Scalar(1.0) * _tmp134) +
                            Scalar(1.0) * _tmp137 * (_tmp126 * _tmp138 - _tmp126) +
                            _tmp141 * _tmp82 * (_tmp113 * _tmp126 - _tmp129 * _tmp142) +
                            _tmp141 * _tmp83 * (_tmp105 * _tmp126 - _tmp129 * _tmp140) +
                            Scalar(1.0) * _tmp84 * (_tmp127 - _tmp128 * _tmp129)));
  const Scalar _tmp144 = Scalar(9.6622558468725703) * _tmp121;
  const Scalar _tmp145 = Scalar(22.802596067096832) *
  ...
  const Scalar _tmp146 = Scalar(6.351516257848961) *
  ...
  const Scalar _tmp147 = _tmp126 * _tmp137;
  const Scalar _tmp148 = _tmp93 * fh1;
  const Scalar _tmp149 = _tmp73 * fh1;
  const Scalar _tmp150 = _tmp77 * _tmp84;
  const Scalar _tmp151 = _tmp108 * _tmp149 * _tmp83 + _tmp115 * _tmp149 * _tmp82 -
                         _tmp116 * _tmp120 * _tmp73 - _tmp150 * _tmp63 * _tmp73;
  const Scalar _tmp152 = Scalar(1.0) / (_tmp151);
  const Scalar _tmp153 = std::asinh(
      _tmp152 * (_tmp116 * _tmp132 + _tmp128 * _tmp84 * _tmp93 + _tmp134 * _tmp136 -
                 _tmp138 * _tmp147 + _tmp140 * _tmp148 * _tmp83 + _tmp142 * _tmp148 * _tmp82));
  ...
  const Scalar _tmp156 = _tmp102 * fh1;
  const Scalar _tmp157 =
      _tmp106 * _tmp156 * _tmp83 + _tmp114 * _tmp156 * _tmp82 + _tmp116 * _tmp119 + _tmp150;
  const Scalar _tmp158 = Scalar(1.0) / (_tmp157);
  const Scalar _tmp159 = _tmp125 * fh1;
  const Scalar _tmp160 =
      std::asinh(_tmp158 * (-_tmp105 * _tmp159 * _tmp83 - _tmp113 * _tmp159 * _tmp82 +
                            _tmp116 * _tmp131 - _tmp127 * _tmp84 - _tmp133 * _tmp136 + _tmp147));
  ...
  _res(1, 0) =
      _tmp144 *
          (-std::sinh(Scalar(1.0) * _tmp143) -
           std::sinh(Scalar(0.1034955) * _tmp122 * (-_tmp143 * _tmp144 - std::sqrt(_tmp145)))) -
      Scalar(8.36416322) *
          std::sqrt(Scalar(Scalar(0.014294040284261563) * _tmp145 +
                           std::pow(Scalar(-Scalar(0.1195576860108189) * _tmp86 -
  ...
  _res(2, 0) =
      ...
      Scalar(8.4693136199999994) *
          std::sqrt(Scalar(Scalar(0.013941309530580858) * _tmp146 +
                           std::pow(Scalar(-Scalar(0.11807332268798426) * _tmp88 -
                                           Scalar(0.11807332268798426) * position_vector(2, 0) + 1),
                                    Scalar(2))));
  _res(3, 0) =
      _tmp161 *
          (-std::sinh(Scalar(1.0) * _tmp160) -
           std::sinh(Scalar(0.1034955) * _tmp158 * (-std::sqrt(_tmp155) - _tmp160 * _tmp161))) -
      Scalar(8.3700199099999999) *
          std::sqrt(Scalar(Scalar(0.01427404356387209) * _tmp155 +
                           std::pow(Scalar(-Scalar(0.11947402882581673) * _tmp98 -
