...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2Nl12(
  ...
  const Scalar _tmp48 = _tmp19 + _tmp43;
  ...
  const Scalar _tmp66 = _tmp62 + _tmp8;
  const Scalar _tmp67 = _tmp31 + _tmp38;
  const Scalar _tmp68 = _tmp67 + position_vector(1, 0);
  const Scalar _tmp69 = _tmp68 + Scalar(110.0);
  const Scalar _tmp70 = _tmp24 + _tmp42;
  ...
  const Scalar _tmp77 = -_tmp61 * _tmp76 + _tmp66 * _tmp74;
  const Scalar _tmp78 = Scalar(1.0) / (_tmp61 * _tmp75 - _tmp74);
  const Scalar _tmp79 = _tmp55 * _tmp61 - _tmp65;
  const Scalar _tmp80 = _tmp78 * _tmp79;
  const Scalar _tmp81 = _tmp57 * _tmp65 - _tmp61 * _tmp64 - _tmp77 * _tmp80;
  const Scalar _tmp82 = Scalar(1.0) * _tmp40;
  const Scalar _tmp83 = -_tmp82;
  const Scalar _tmp84 = Scalar(1.0) / (_tmp67 + _tmp83);
  const Scalar _tmp85 = Scalar(1.0) * _tmp44;
  const Scalar _tmp86 = _tmp84 * (-_tmp70 + _tmp85);
  const Scalar _tmp87 = -_tmp66 * _tmp75 + _tmp76;
  const Scalar _tmp88 = -_tmp55 * _tmp57 + _tmp64 - _tmp80 * _tmp87 - _tmp81 * _tmp86;
  ...
  const Scalar _tmp97 = _tmp95 * (-_tmp40 * _tmp59 * _tmp96 + _tmp44 * _tmp58 * _tmp96);
  const Scalar _tmp98 = _tmp67 * _tmp75 - _tmp70 * _tmp74 + _tmp75 * _tmp97;
  const Scalar _tmp99 = -_tmp48 * _tmp65 + _tmp51 * _tmp55 + _tmp55 * _tmp97 - _tmp80 * _tmp98;
  const Scalar _tmp100 = Scalar(1.0) / (_tmp99);
  const Scalar _tmp101 = Scalar(1.0) * _tmp100;
  const Scalar _tmp102 = _tmp33 + Scalar(-110.0);
  const Scalar _tmp103 = _tmp26 + Scalar(-125.0);
  ...
  const Scalar _tmp107 = fh1 * (-_tmp105 * _tmp32 + _tmp106 * _tmp25);
  ...
  const Scalar _tmp115 = _tmp79 * _tmp89;
  const Scalar _tmp116 = -_tmp114 * _tmp115 + Scalar(1.0);
  const Scalar _tmp117 = _tmp75 * _tmp78;
  const Scalar _tmp118 = _tmp55 * _tmp89;
  const Scalar _tmp119 = _tmp106 * fh1;
  const Scalar _tmp120 = _tmp61 * _tmp78;
  const Scalar _tmp121 = _tmp120 * _tmp77 + _tmp61 * _tmp63;
  const Scalar _tmp122 = _tmp120 * _tmp87 - _tmp121 * _tmp86 - _tmp63;
  const Scalar _tmp123 = _tmp112 * (-_tmp111 * _tmp122 + _tmp120 * _tmp98 - _tmp97);
  const Scalar _tmp124 = _tmp122 + _tmp123;
  const Scalar _tmp125 = -_tmp115 * _tmp124 - _tmp61;
  const Scalar _tmp126 = _tmp105 * fh1;
  const Scalar _tmp127 = -_tmp107 * _tmp95 * (_tmp101 * _tmp55 - _tmp101 * _tmp93) -
                         _tmp119 * _tmp95 * (_tmp114 * _tmp118 + _tmp116 * _tmp117) -
                         _tmp126 * _tmp95 * (_tmp117 * _tmp125 + _tmp118 * _tmp124 + Scalar(1.0)) -
                         _tmp47 * _tmp95 * (_tmp55 * _tmp92 - _tmp92 * _tmp93);
  const Scalar _tmp128 = Scalar(1.0) / (_tmp127);
  const Scalar _tmp129 = _tmp51 + _tmp83;
  const Scalar _tmp130 = _tmp129 * _tmp86;
  const Scalar _tmp131 = Scalar(1.0) / (-_tmp130 - _tmp48 + _tmp85);
  const Scalar _tmp132 = _tmp129 * _tmp131;
  const Scalar _tmp133 = _tmp81 * _tmp89;
  const Scalar _tmp134 = -_tmp109 + _tmp113 * _tmp132 - _tmp114 * _tmp133;
  const Scalar _tmp135 = Scalar(1.0) * _tmp84;
  const Scalar _tmp136 = Scalar(1.0) * _tmp131;
  const Scalar _tmp137 = _tmp112 * _tmp136;
  const Scalar _tmp138 = -_tmp101 * _tmp81 + _tmp129 * _tmp137;
  const Scalar _tmp139 = _tmp131 * _tmp90;
  const Scalar _tmp140 = -_tmp129 * _tmp139 - _tmp133 * _tmp91 + _tmp83;
  const Scalar _tmp141 = _tmp136 * _tmp86;
  const Scalar _tmp142 = _tmp130 * _tmp136 + Scalar(1.0);
  const Scalar _tmp143 = _tmp16 * fh1;
  const Scalar _tmp144 = -_tmp106 * _tmp143 - Scalar(40.024799999999999) * _tmp28 - _tmp32 * fv1;
  const Scalar _tmp145 = _tmp121 + _tmp123 * _tmp132 - _tmp124 * _tmp133;
  const Scalar _tmp146 = _tmp105 * _tmp143 + Scalar(40.024799999999999) * _tmp20 + _tmp25 * fv1;
  const Scalar _tmp147 = _tmp129 * _tmp84;
  const Scalar _tmp148 = std::asinh(
      _tmp128 * (Scalar(1.0) * _tmp107 * (-_tmp135 * _tmp138 + _tmp137) +
                 Scalar(1.0) * _tmp119 * (_tmp113 * _tmp136 - _tmp134 * _tmp135) +
                 Scalar(1.0) * _tmp126 * (_tmp123 * _tmp136 - _tmp135 * _tmp145) +
                 Scalar(1.0) * _tmp144 * (-_tmp135 * _tmp142 + _tmp141) +
                 Scalar(1.0) * _tmp146 * (_tmp136 * _tmp147 - _tmp136) +
                 Scalar(1.0) * _tmp47 * (-_tmp135 * _tmp140 - _tmp136 * _tmp90 + Scalar(1.0))));
  const Scalar _tmp149 = Scalar(1.4083112389913199) * _tmp127;
  const Scalar _tmp150 = _tmp101 * _tmp107;
  const Scalar _tmp151 = _tmp47 * _tmp92;
  const Scalar _tmp152 =
      _tmp116 * _tmp119 * _tmp78 + _tmp125 * _tmp126 * _tmp78 - _tmp150 * _tmp80 - _tmp151 * _tmp80;
  const Scalar _tmp153 = Scalar(1.0) / (_tmp152);
  const Scalar _tmp154 = _tmp136 * _tmp146;
  const Scalar _tmp155 =
      std::asinh(_tmp153 * (_tmp107 * _tmp138 * _tmp84 + _tmp119 * _tmp134 * _tmp84 +
                            _tmp126 * _tmp145 * _tmp84 + _tmp140 * _tmp47 * _tmp84 +
                            _tmp142 * _tmp144 * _tmp84 - _tmp147 * _tmp154));
  ...
  const Scalar _tmp157 =
      ...
      Scalar(12100.0) * std::pow(Scalar(-Scalar(0.0090909090909090905) * _tmp68 - 1), Scalar(2));
  const Scalar _tmp158 =
      Scalar(12100.0) * std::pow(Scalar(1 - Scalar(0.0090909090909090905) * _tmp52), Scalar(2)) +
      Scalar(15625.0) * std::pow(Scalar(-Scalar(0.0080000000000000002) * _tmp49 - 1), Scalar(2));
  const Scalar _tmp159 =
      _tmp114 * _tmp119 * _tmp89 + _tmp124 * _tmp126 * _tmp89 + _tmp150 + _tmp151;
  const Scalar _tmp160 = Scalar(1.0) / (_tmp159);
  const Scalar _tmp161 = std::asinh(_tmp160 * (-_tmp107 * _tmp137 - _tmp113 * _tmp119 * _tmp131 -
                                               _tmp123 * _tmp126 * _tmp131 + _tmp139 * _tmp47 -
                                               _tmp141 * _tmp144 + _tmp154));
  ...
  _res(3, 0) =
      _tmp162 * (-std::sinh(Scalar(1.0) * _tmp161) -
                 std::sinh(Scalar(0.71007031138673404) * _tmp160 *
                           (-std::sqrt(_tmp158) - _tmp161 * _tmp162))) -
      Scalar(48.0) * std::sqrt(Scalar(
