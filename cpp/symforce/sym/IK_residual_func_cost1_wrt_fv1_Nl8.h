...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1WrtFv1Nl8(
  ...
  const Scalar _tmp33 = _tmp12 + _tmp18 + _tmp9;
  ...
  const Scalar _tmp40 = _tmp19 + _tmp36;
  const Scalar _tmp41 = Scalar(1.0) / (_tmp35 + _tmp40);
  ...
  const Scalar _tmp47 = _tmp41 * (-_tmp43 + _tmp46);
  ...
  const Scalar _tmp54 = _tmp38 + position_vector(1, 0);
  ...
  const Scalar _tmp66 = _tmp65 * (-_tmp33 * _tmp61 * _tmp63 + _tmp45 * _tmp59 * _tmp63);
  const Scalar _tmp67 = _tmp40 + position_vector(1, 0);
  const Scalar _tmp68 = _tmp67 + Scalar(8.3196563700000006);
  const Scalar _tmp69 = _tmp43 + position_vector(0, 0);
  ...
  const Scalar _tmp74 = _tmp40 * _tmp73 - _tmp43 * _tmp72 + _tmp66 * _tmp73;
  const Scalar _tmp75 = _tmp55 * _tmp56;
  const Scalar _tmp76 = _tmp59 * _tmp64;
  const Scalar _tmp77 = _tmp57 * _tmp76 - _tmp75;
  const Scalar _tmp78 = Scalar(1.0) / (-_tmp72 + _tmp73 * _tmp76);
  const Scalar _tmp79 = _tmp77 * _tmp78;
  const Scalar _tmp80 = _tmp38 * _tmp57 - _tmp49 * _tmp75 + _tmp57 * _tmp66 - _tmp74 * _tmp79;
  ...
  const Scalar _tmp91 = -_tmp73 * _tmp87 + _tmp90;
  const Scalar _tmp92 = _tmp83 + _tmp88;
  const Scalar _tmp93 = _tmp72 * _tmp87 - _tmp76 * _tmp90;
  const Scalar _tmp94 = _tmp76 * _tmp89;
  const Scalar _tmp95 = -_tmp57 * _tmp94 + _tmp75 * _tmp92 - _tmp79 * _tmp93;
  const Scalar _tmp96 = -_tmp47 * _tmp95 + _tmp57 * _tmp89 - _tmp57 * _tmp92 - _tmp79 * _tmp91;
  const Scalar _tmp97 = _tmp81 * _tmp96;
  const Scalar _tmp98 = _tmp51 * _tmp97;
  const Scalar _tmp99 = Scalar(1.0) * _tmp81;
  const Scalar _tmp100 = _tmp39 * _tmp98 - _tmp95 * _tmp99;
  const Scalar _tmp101 = Scalar(1.0) * _tmp41;
  const Scalar _tmp102 = _tmp21 + Scalar(8.3888750099999996);
  const Scalar _tmp103 = _tmp31 + Scalar(-2.5202214700000001);
  ...
  const Scalar _tmp107 = fh1 * (_tmp105 * _tmp30 - _tmp106 * _tmp20);
  const Scalar _tmp108 = _tmp76 * _tmp78;
  const Scalar _tmp109 = _tmp108 * _tmp93 + _tmp94;
  const Scalar _tmp110 = _tmp108 * _tmp91 - _tmp109 * _tmp47 - _tmp89;
  const Scalar _tmp111 = Scalar(1.0) / (_tmp96);
  const Scalar _tmp112 = _tmp111 * _tmp80;
  const Scalar _tmp113 = _tmp97 * (_tmp108 * _tmp74 - _tmp110 * _tmp112 - _tmp66);
  const Scalar _tmp114 = _tmp39 * _tmp50;
  ...
  const Scalar _tmp120 = _tmp106 * _tmp119 + Scalar(5.1796800000000003) * _tmp26 + _tmp30 * fv1;
  const Scalar _tmp121 = _tmp39 * _tmp41;
  ...
  const Scalar _tmp129 = -_tmp127 * _tmp91 + _tmp128 * _tmp47;
  const Scalar _tmp130 = _tmp97 * (-_tmp112 * _tmp129 - _tmp127 * _tmp74);
  ...
  const Scalar _tmp135 = _tmp34 * _tmp47 + _tmp46;
  const Scalar _tmp136 = 0;
  const Scalar _tmp137 = _tmp135 * _tmp50;
  const Scalar _tmp138 = _tmp41 * (-_tmp116 * _tmp136 - _tmp137 * _tmp39 + _tmp35);
  ...
  const Scalar _tmp142 = _tmp111 * _tmp77;
  const Scalar _tmp143 = -_tmp131 * _tmp142 + Scalar(1.0);
  const Scalar _tmp144 = _tmp73 * _tmp78;
  const Scalar _tmp145 = -_tmp115 * _tmp142 - _tmp76;
  ...
  const Scalar _tmp149 = -_tmp107 * _tmp65 * (_tmp57 * _tmp99 - _tmp73 * _tmp79 * _tmp99) -
  ...
  const Scalar _tmp159 = _tmp17 + _tmp37;
  const Scalar _tmp160 = _tmp148 * _tmp158;
  const Scalar _tmp161 =
      (-_tmp140 * _tmp160 + _tmp150 * (_tmp122 * _tmp30 + _tmp126 * _tmp159 - _tmp139)) /
      std::sqrt(Scalar(std::pow(_tmp140, Scalar(2)) * _tmp158 + 1));
  const Scalar _tmp162 = _tmp107 * _tmp99;
  const Scalar _tmp163 = _tmp146 * _tmp78;
  const Scalar _tmp164 = _tmp118 * _tmp145 * _tmp78 + _tmp133 * _tmp143 * _tmp78 -
                         _tmp134 * _tmp163 - _tmp162 * _tmp79;
  const Scalar _tmp165 = std::pow(_tmp164, Scalar(-2));
  const Scalar _tmp166 = _tmp163 * _tmp165;
  const Scalar _tmp167 = _tmp124 * _tmp41;
  const Scalar _tmp168 = _tmp120 * _tmp51;
  const Scalar _tmp169 = _tmp100 * _tmp107 * _tmp41 + _tmp117 * _tmp118 * _tmp41 -
                         _tmp121 * _tmp168 + _tmp123 * _tmp167 + _tmp132 * _tmp133 * _tmp41 +
                         _tmp134 * _tmp138;
  ...
  const Scalar _tmp173 = _tmp30 * _tmp51;
  const Scalar _tmp174 =
      (-_tmp166 * _tmp169 + _tmp170 * (-_tmp121 * _tmp173 - _tmp138 + _tmp159 * _tmp167)) /
  ...
  const Scalar _tmp180 =
      _tmp111 * _tmp115 * _tmp118 + _tmp111 * _tmp131 * _tmp133 + _tmp134 * _tmp147 + _tmp162;
  const Scalar _tmp181 = Scalar(1.0) / (_tmp180);
  const Scalar _tmp182 = -_tmp107 * _tmp98 - _tmp113 * _tmp118 * _tmp50 - _tmp123 * _tmp125 -
                         _tmp130 * _tmp133 * _tmp50 + _tmp134 * _tmp137 + _tmp168;
  ...
  const Scalar _tmp192 = (_tmp181 * (-_tmp125 * _tmp159 - _tmp137 + _tmp173) + _tmp182 * _tmp191) /
          ...
          (-Scalar(0.86565325453551001) * _tmp160 + Scalar(1.0) * _tmp161 * std::sinh(_tmp152) -
           (-Scalar(0.1034955) * _tmp154 * _tmp160 +
            _tmp155 * (-_tmp151 * _tmp157 - _tmp153 * _tmp161)) *
               std::sinh(_tmp156)) -
      _tmp157 * (Scalar(0.86565325453551001) * _tmp150 + std::cosh(_tmp152) - std::cosh(_tmp156));
  _res(2, 0) =
      -_tmp175 *
          (-Scalar(0.87679799772039002) * _tmp166 + Scalar(1.0) * _tmp174 * std::sinh(_tmp172) -
           (-Scalar(0.1034955) * _tmp166 * _tmp178 +
            _tmp177 * (-_tmp171 * _tmp176 - _tmp174 * _tmp175)) *
               std::sinh(_tmp179)) -
      _tmp176 * (Scalar(0.87679799772039002) * _tmp170 + std::cosh(_tmp172) - std::cosh(_tmp179));
  _res(3, 0) =
      -_tmp184 *
          (Scalar(0.86625939559540499) * _tmp191 + Scalar(1.0) * _tmp192 * std::sinh(_tmp188) -
           (Scalar(0.1034955) * _tmp185 * _tmp191 +
            _tmp186 * (_tmp183 * _tmp189 - _tmp184 * _tmp192)) *
               std::sinh(_tmp187)) +
      _tmp189 * (Scalar(0.86625939559540499) * _tmp181 - std::cosh(_tmp187) + std::cosh(_tmp188));
