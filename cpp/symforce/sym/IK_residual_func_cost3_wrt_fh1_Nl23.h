...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl23(
  ...
  const Scalar _tmp33 = _tmp16 * _tmp31 - _tmp27 * _tmp32;
  ...
  const Scalar _tmp45 = _tmp19 + _tmp26;
  ...
  const Scalar _tmp57 = _tmp20 + _tmp34;
  const Scalar _tmp58 = _tmp36 + _tmp57;
  const Scalar _tmp59 = _tmp15 + _tmp38;
  ...
  const Scalar _tmp64 = _tmp56 * _tmp62 - _tmp63;
  const Scalar _tmp65 = Scalar(1.0) / (_tmp44 * _tmp56 - _tmp54);
  const Scalar _tmp66 = _tmp64 * _tmp65;
  const Scalar _tmp67 = _tmp53 * _tmp62 - _tmp55 * _tmp66 + _tmp57 * _tmp62 - _tmp59 * _tmp63;
  const Scalar _tmp68 = Scalar(1.0) / (_tmp67);
  const Scalar _tmp69 = Scalar(1.0) * _tmp68;
  const Scalar _tmp70 = _tmp33 * _tmp52 * (-_tmp44 * _tmp66 * _tmp69 + _tmp62 * _tmp69);
  ...
  const Scalar _tmp74 = (-_tmp40 + _tmp73) / (_tmp35 - _tmp72);
  const Scalar _tmp75 = _tmp72 * _tmp74 + _tmp73;
  const Scalar _tmp76 = 0;
  const Scalar _tmp77 = Scalar(0.20999999999999999) * _tmp21 + Scalar(0.20999999999999999) * _tmp22;
  ...
  const Scalar _tmp85 = -_tmp44 * _tmp82 + _tmp84;
  const Scalar _tmp86 = _tmp78 + _tmp79 - _tmp80;
  const Scalar _tmp87 = _tmp54 * _tmp82 - _tmp56 * _tmp84;
  const Scalar _tmp88 = _tmp62 * _tmp83;
  const Scalar _tmp89 = -_tmp62 * _tmp86 - _tmp66 * _tmp85 -
                        _tmp74 * (-_tmp56 * _tmp88 + _tmp63 * _tmp86 - _tmp66 * _tmp87) + _tmp88;
  const Scalar _tmp90 = Scalar(1.0) / (_tmp89);
  const Scalar _tmp91 = _tmp64 * _tmp90;
  const Scalar _tmp92 = _tmp65 * _tmp76 * _tmp91;
  const Scalar _tmp93 = _tmp76 * _tmp90;
  const Scalar _tmp94 = Scalar(1.0) * _tmp65;
  const Scalar _tmp95 = _tmp74 * _tmp87 * _tmp94 - _tmp85 * _tmp94;
  const Scalar _tmp96 = _tmp67 * _tmp90;
  const Scalar _tmp97 = _tmp68 * _tmp89;
  const Scalar _tmp98 = _tmp95 + _tmp97 * (-_tmp55 * _tmp94 - _tmp95 * _tmp96);
  const Scalar _tmp99 = _tmp90 * _tmp98;
  const Scalar _tmp100 = _tmp65 * (-_tmp91 * _tmp98 + Scalar(1.0));
  const Scalar _tmp101 = _tmp31 * _tmp52 * (_tmp100 * _tmp44 + _tmp62 * _tmp99);
  const Scalar _tmp102 = _tmp56 * _tmp65;
  const Scalar _tmp103 = _tmp102 * _tmp85 - _tmp74 * (_tmp102 * _tmp87 + _tmp56 * _tmp83) - _tmp83;
  const Scalar _tmp104 = _tmp103 + _tmp97 * (_tmp102 * _tmp55 - _tmp103 * _tmp96 - _tmp53);
  const Scalar _tmp105 = _tmp104 * _tmp90;
  const Scalar _tmp106 = _tmp65 * (-_tmp104 * _tmp91 - _tmp56);
  const Scalar _tmp107 = _tmp32 * _tmp52 * (_tmp105 * _tmp62 + _tmp106 * _tmp44 + Scalar(1.0));
  const Scalar _tmp108 = _tmp106 * _tmp32;
  const Scalar _tmp109 = _tmp100 * _tmp31;
  const Scalar _tmp110 = _tmp33 * _tmp69;
  const Scalar _tmp111 = _tmp110 * fh1;
  const Scalar _tmp112 = _tmp105 * _tmp32;
  ...
  _res(1, 0) = -(-_tmp101 - _tmp107 - _tmp70) *
               std::exp(_tmp101 * fh1 + _tmp107 * fh1 +
                        _tmp52 * _tmp71 * (-_tmp44 * _tmp92 + _tmp62 * _tmp93) + _tmp70 * fh1);
  _res(2, 0) = -(_tmp108 + _tmp109 - _tmp110 * _tmp66) *
               std::exp(-_tmp108 * fh1 - _tmp109 * fh1 + _tmp111 * _tmp66 + _tmp71 * _tmp92);
  _res(3, 0) = -(_tmp110 + _tmp112 + _tmp113) *
               std::exp(-_tmp111 - _tmp112 * fh1 - _tmp113 * fh1 - _tmp71 * _tmp93);
