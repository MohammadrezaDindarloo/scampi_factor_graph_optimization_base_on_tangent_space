...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2Nl10(
  ...
  const Scalar _tmp27 = Scalar(0.20999999999999999) * _tmp10 + Scalar(0.20999999999999999) * _tmp22;
  ...
  const Scalar _tmp45 = _tmp21 + _tmp23;
  const Scalar _tmp46 = _tmp44 + _tmp45;
  const Scalar _tmp47 = _tmp46 + position_vector(1, 0);
  const Scalar _tmp48 = Scalar(23.361089618893828) *
                            std::pow(Scalar(1 - Scalar(0.20689664689659551) * _tmp47), Scalar(2)) +
  ...
  const Scalar _tmp52 = _tmp27 + _tmp41;
  ...
  const Scalar _tmp57 = _tmp47 + Scalar(-4.8333311099999996);
  const Scalar _tmp58 = _tmp43 + Scalar(1.79662371);
  const Scalar _tmp59 = Scalar(1.0) / (_tmp58);
  const Scalar _tmp60 = _tmp57 * _tmp59;
  const Scalar _tmp61 = _tmp54 * _tmp55;
  const Scalar _tmp62 = -_tmp56 + _tmp60 * _tmp61;
  const Scalar _tmp63 = _tmp38 + _tmp8;
  const Scalar _tmp64 = _tmp24 + _tmp44;
  const Scalar _tmp65 = _tmp64 + position_vector(1, 0);
  const Scalar _tmp66 = _tmp65 + Scalar(8.3196563700000006);
  const Scalar _tmp67 = _tmp31 + _tmp40;
  ...
  const Scalar _tmp73 = _tmp39 * _tmp60;
  const Scalar _tmp74 = _tmp63 * _tmp71 - _tmp72 * _tmp73;
  const Scalar _tmp75 = Scalar(1.0) / (_tmp60 * _tmp72 - _tmp71);
  const Scalar _tmp76 = _tmp62 * _tmp75;
  const Scalar _tmp77 = _tmp15 + _tmp7;
  const Scalar _tmp78 = _tmp56 * _tmp77 - _tmp61 * _tmp73 - _tmp74 * _tmp76;
  ...
  const Scalar _tmp84 = _tmp39 * _tmp72 - _tmp63 * _tmp72;
  const Scalar _tmp85 = _tmp39 * _tmp61 - _tmp61 * _tmp77 - _tmp76 * _tmp84 - _tmp78 * _tmp83;
  const Scalar _tmp86 = Scalar(1.0) / (_tmp85);
  const Scalar _tmp87 =
      std::sqrt(Scalar(std::pow(_tmp57, Scalar(2)) + std::pow(_tmp58, Scalar(2))));
  const Scalar _tmp88 = Scalar(1.0) / (_tmp87);
  const Scalar _tmp89 = _tmp59 * _tmp87;
  const Scalar _tmp90 = _tmp89 * (_tmp42 * _tmp57 * _tmp88 - _tmp46 * _tmp58 * _tmp88);
  ...
  const Scalar _tmp95 = _tmp49 * _tmp61 - _tmp52 * _tmp56 + _tmp61 * _tmp90 - _tmp76 * _tmp91;
  ...
  const Scalar _tmp101 = -_tmp100 * _tmp62 + Scalar(1.0);
  const Scalar _tmp102 = _tmp72 * _tmp75;
  const Scalar _tmp103 = _tmp26 + Scalar(8.3888750099999996);
  const Scalar _tmp104 = _tmp33 + Scalar(-2.5202214700000001);
  ...
  const Scalar _tmp111 = _tmp62 * _tmp92 * _tmp97;
  const Scalar _tmp112 = Scalar(1.0) * _tmp97;
  const Scalar _tmp113 = _tmp104 * _tmp105;
  const Scalar _tmp114 = fh1 * (_tmp106 * _tmp32 - _tmp113 * _tmp25);
  const Scalar _tmp115 = _tmp60 * _tmp75;
  const Scalar _tmp116 = _tmp115 * _tmp74 + _tmp73;
  const Scalar _tmp117 = _tmp115 * _tmp84 - _tmp116 * _tmp83 - _tmp39;
  const Scalar _tmp118 = _tmp98 * (_tmp115 * _tmp91 - _tmp117 * _tmp96 - _tmp90);
  const Scalar _tmp119 = _tmp86 * (_tmp117 + _tmp118);
  const Scalar _tmp120 = -_tmp119 * _tmp62 - _tmp60;
  const Scalar _tmp121 = _tmp113 * fh1;
  const Scalar _tmp122 = -_tmp107 * _tmp89 * (_tmp100 * _tmp61 + _tmp101 * _tmp102) -
                         _tmp108 * _tmp89 * (_tmp110 * _tmp61 - _tmp110 * _tmp72 * _tmp76) -
                         _tmp114 * _tmp89 * (-_tmp111 * _tmp72 + _tmp112 * _tmp61) -
                         _tmp121 * _tmp89 * (_tmp102 * _tmp120 + _tmp119 * _tmp61 + Scalar(1.0));
  const Scalar _tmp123 = Scalar(1.0) / (_tmp122);
  const Scalar _tmp124 = _tmp49 + _tmp80;
  const Scalar _tmp125 = _tmp124 * _tmp83;
  const Scalar _tmp126 = Scalar(1.0) / (-_tmp125 - _tmp52 + _tmp82);
  const Scalar _tmp127 = Scalar(1.0) * _tmp126;
  const Scalar _tmp128 = _tmp124 * _tmp81;
  const Scalar _tmp129 = _tmp16 * fh1;
  const Scalar _tmp130 = _tmp113 * _tmp129 + Scalar(5.1796800000000003) * _tmp28 + _tmp32 * fv1;
  const Scalar _tmp131 = _tmp124 * _tmp126;
  const Scalar _tmp132 = -_tmp100 * _tmp78 + _tmp131 * _tmp99 - _tmp93;
  const Scalar _tmp133 = Scalar(1.0) * _tmp81;
  const Scalar _tmp134 = _tmp109 * _tmp126;
  const Scalar _tmp135 = -_tmp110 * _tmp78 - _tmp124 * _tmp134 + _tmp80;
  const Scalar _tmp136 = _tmp127 * _tmp98;
  const Scalar _tmp137 = -_tmp112 * _tmp78 + _tmp124 * _tmp136;
  const Scalar _tmp138 = _tmp116 + _tmp118 * _tmp131 - _tmp119 * _tmp78;
  const Scalar _tmp139 = _tmp127 * _tmp83;
  const Scalar _tmp140 = _tmp81 * (_tmp125 * _tmp127 + Scalar(1.0));
  const Scalar _tmp141 = -_tmp106 * _tmp129 - Scalar(5.1796800000000003) * _tmp20 - _tmp25 * fv1;
  const Scalar _tmp142 = std::asinh(
      _tmp123 * (Scalar(1.0) * _tmp107 * (_tmp127 * _tmp99 - _tmp132 * _tmp133) +
                 Scalar(1.0) * _tmp108 * (-_tmp109 * _tmp127 - _tmp133 * _tmp135 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp114 * (-_tmp133 * _tmp137 + _tmp136) +
                 Scalar(1.0) * _tmp121 * (_tmp118 * _tmp127 - _tmp133 * _tmp138) +
                 Scalar(1.0) * _tmp130 * (_tmp127 * _tmp128 - _tmp127) +
                 Scalar(1.0) * _tmp141 * (_tmp139 - Scalar(1.0) * _tmp140)));
  ...
  const Scalar _tmp146 = _tmp101 * _tmp107 * _tmp75 - _tmp111 * _tmp114 +
                         _tmp120 * _tmp121 * _tmp75 - _tmp145 * _tmp76;
  const Scalar _tmp147 = Scalar(1.0) / (_tmp146);
  const Scalar _tmp148 =
      std::asinh(_tmp147 * (_tmp107 * _tmp132 * _tmp81 + _tmp108 * _tmp135 * _tmp81 +
                            _tmp114 * _tmp137 * _tmp81 + _tmp121 * _tmp138 * _tmp81 -
                            _tmp128 * _tmp144 + _tmp140 * _tmp141));
  ...
  const Scalar _tmp151 = _tmp100 * _tmp107 + _tmp112 * _tmp114 + _tmp119 * _tmp121 + _tmp145;
  const Scalar _tmp152 = Scalar(1.0) / (_tmp151);
  const Scalar _tmp153 =
      std::asinh(_tmp152 * (-_tmp107 * _tmp126 * _tmp99 + _tmp108 * _tmp134 - _tmp114 * _tmp136 -
                            _tmp118 * _tmp121 * _tmp126 - _tmp139 * _tmp141 + _tmp144));
  ...
  _res(1, 0) =
      ...
      Scalar(8.3700199099999999) *
          std::sqrt(Scalar(Scalar(0.01427404356387209) * _tmp48 +
  ...
  _res(2, 0) =
      _tmp149 *
          (-std::sinh(Scalar(1.0) * _tmp148) -
           std::sinh(Scalar(0.1034955) * _tmp147 * (-_tmp148 * _tmp149 - std::sqrt(_tmp150)))) -
