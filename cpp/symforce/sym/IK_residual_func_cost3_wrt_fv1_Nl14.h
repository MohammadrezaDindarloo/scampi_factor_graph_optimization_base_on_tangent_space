...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl14(
  ...
  const Scalar _tmp92 = _tmp39 * (-_tmp30 * _tmp91 + _tmp66 * _tmp90);
  ...
  _res(0, 0) = 0;
  _res(1, 0) =
      -_tmp92 * std::exp(_tmp101 * _tmp39 * (_tmp100 * _tmp66 - _tmp30 * _tmp99) +
                         _tmp39 * _tmp87 * (_tmp76 * _tmp77 + _tmp79 * _tmp80 + Scalar(1.0)) +
                         _tmp39 * _tmp98 * (_tmp77 * _tmp95 + _tmp80 * _tmp96) + _tmp88 * _tmp92);
  _res(2, 0) = -_tmp91 * std::exp(_tmp101 * _tmp99 + _tmp102 * _tmp69 - _tmp43 * _tmp79 * _tmp87 -
                                  _tmp43 * _tmp96 * _tmp98);
  _res(3, 0) = _tmp90 * std::exp(-_tmp100 * _tmp101 - _tmp102 - _tmp71 * _tmp76 * _tmp87 -
