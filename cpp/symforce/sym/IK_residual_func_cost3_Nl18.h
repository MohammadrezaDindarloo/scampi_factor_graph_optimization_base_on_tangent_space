...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl18(
  ...
  const Scalar _tmp91 = _tmp41 * fh1;
  const Scalar _tmp92 = Scalar(333.54000000000002) - fv1;
  const Scalar _tmp93 = _tmp56 * _tmp58 + _tmp57;
  const Scalar _tmp94 = 0;
  const Scalar _tmp95 = _tmp38 * _tmp71;
  const Scalar _tmp96 = Scalar(1.0) * _tmp78;
  const Scalar _tmp97 = _tmp88 * _tmp89;
  const Scalar _tmp98 = fh1 * (_tmp85 * _tmp97 - _tmp87 * _tmp90);
  const Scalar _tmp99 = Scalar(1.0) * _tmp45;
  const Scalar _tmp100 = -_tmp54 * _tmp99 + _tmp55 * _tmp58 * _tmp99;
  const Scalar _tmp101 = _tmp100 + _tmp79 * (-_tmp100 * _tmp77 - _tmp44 * _tmp99);
  const Scalar _tmp102 = -_tmp101 * _tmp81 + Scalar(1.0);
  const Scalar _tmp103 = _tmp96 * _tmp98;
  const Scalar _tmp104 = _tmp92 * _tmp94;
  const Scalar _tmp105 = _tmp45 * fh1;
  const Scalar _tmp106 = _tmp76 * fh1;

  // Output terms (1)
  Eigen::Matrix<Scalar, 4, 1> _res;

  _res(0, 0) = std::exp(-fh1);
  _res(1, 0) = std::exp(_tmp41 * _tmp92 * (_tmp68 * _tmp94 - _tmp94 * _tmp95) +
                        _tmp41 * _tmp98 * (_tmp68 * _tmp96 - _tmp95 * _tmp96) +
                        _tmp90 * _tmp91 * (_tmp80 * _tmp84 + _tmp82 * _tmp83 + Scalar(1.0)) +
                        _tmp91 * _tmp97 * (_tmp101 * _tmp84 + _tmp102 * _tmp83));
  _res(2, 0) = std::exp(-_tmp102 * _tmp105 * _tmp97 + _tmp103 * _tmp71 + _tmp104 * _tmp71 -
                        _tmp105 * _tmp82 * _tmp90);
  _res(3, 0) =
      std::exp(-_tmp101 * _tmp106 * _tmp97 - _tmp103 - _tmp104 - _tmp106 * _tmp80 * _tmp90);
