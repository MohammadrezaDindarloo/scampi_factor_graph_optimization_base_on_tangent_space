...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl21(
  ...
  const Scalar _tmp50 = _tmp20 + _tmp41;
  ...
  const Scalar _tmp70 = _tmp52 * _tmp57;
  const Scalar _tmp71 = _tmp46 * _tmp70 - _tmp47;
  const Scalar _tmp72 = Scalar(1.0) / (_tmp67 * _tmp70 - _tmp68);
  const Scalar _tmp73 = _tmp71 * _tmp72;
  const Scalar _tmp74 = -_tmp38 * _tmp47 + _tmp42 * _tmp46 + _tmp46 * _tmp59 - _tmp69 * _tmp73;
  ...
  const Scalar _tmp79 = _tmp30 + Scalar(-4.8333311099999996);
  ...
  const Scalar _tmp89 = _tmp85 + _tmp87;
  const Scalar _tmp90 = _tmp70 * _tmp89;
  const Scalar _tmp91 = -_tmp67 * _tmp90 + _tmp68 * _tmp88;
  const Scalar _tmp92 = -_tmp46 * _tmp90 + _tmp47 * _tmp86 - _tmp73 * _tmp91;
  ...
  const Scalar _tmp97 = _tmp95 * (-_tmp63 + _tmp96);
  const Scalar _tmp98 = -_tmp67 * _tmp88 + _tmp67 * _tmp89;
  const Scalar _tmp99 = -_tmp46 * _tmp86 + _tmp46 * _tmp89 - _tmp73 * _tmp98 - _tmp92 * _tmp97;
  const Scalar _tmp100 = Scalar(1.0) / (_tmp99);
  const Scalar _tmp101 = _tmp93 * _tmp97 + _tmp96;
  const Scalar _tmp102 = 0;
  const Scalar _tmp103 = Scalar(1.0) * _tmp72;
  const Scalar _tmp104 = _tmp103 * _tmp91;
  const Scalar _tmp105 = -_tmp103 * _tmp98 + _tmp104 * _tmp97;
  const Scalar _tmp106 = _tmp100 * _tmp74;
  const Scalar _tmp107 = _tmp75 * _tmp99;
  const Scalar _tmp108 = _tmp107 * (-_tmp103 * _tmp69 - _tmp105 * _tmp106);
  const Scalar _tmp109 = _tmp100 * (_tmp105 + _tmp108);
  const Scalar _tmp110 = -_tmp109 * _tmp71 + Scalar(1.0);
  const Scalar _tmp111 = _tmp67 * _tmp72;
  const Scalar _tmp112 = _tmp81 * fh1;
  const Scalar _tmp113 = _tmp70 * _tmp72;
  const Scalar _tmp114 = _tmp113 * _tmp91 + _tmp90;
  const Scalar _tmp115 = _tmp113 * _tmp98 - _tmp114 * _tmp97 - _tmp89;
  const Scalar _tmp116 = _tmp107 * (-_tmp106 * _tmp115 + _tmp113 * _tmp69 - _tmp59);
  const Scalar _tmp117 = _tmp100 * (_tmp115 + _tmp116);
  const Scalar _tmp118 = -_tmp117 * _tmp71 - _tmp70;
  const Scalar _tmp119 = _tmp82 * fh1;
  const Scalar _tmp120 = -_tmp112 * _tmp58 * (_tmp109 * _tmp46 + _tmp110 * _tmp111) -
                         _tmp119 * _tmp58 * (_tmp111 * _tmp118 + _tmp117 * _tmp46 + Scalar(1.0)) -
                         _tmp58 * _tmp83 * (_tmp46 * _tmp76 - _tmp76 * _tmp77) -
                         _tmp58 * _tmp84 * (_tmp102 * _tmp46 - _tmp102 * _tmp77);
  const Scalar _tmp121 = Scalar(1.0) / (_tmp120);
  const Scalar _tmp122 = _tmp42 + _tmp94;
  const Scalar _tmp123 = _tmp122 * _tmp97;
  const Scalar _tmp124 = Scalar(1.0) / (-_tmp123 - _tmp38 + _tmp96);
  const Scalar _tmp125 = Scalar(1.0) * _tmp124;
  const Scalar _tmp126 = _tmp122 * _tmp124;
  const Scalar _tmp127 = _tmp114 + _tmp116 * _tmp126 - _tmp117 * _tmp92;
  const Scalar _tmp128 = Scalar(1.0) * _tmp95;
  const Scalar _tmp129 = -_tmp104 + _tmp108 * _tmp126 - _tmp109 * _tmp92;
  const Scalar _tmp130 = _tmp107 * _tmp125;
  const Scalar _tmp131 = _tmp122 * _tmp125;
  const Scalar _tmp132 = _tmp107 * _tmp131 - _tmp76 * _tmp92;
  const Scalar _tmp133 = _tmp36 * fh1;
  const Scalar _tmp134 = Scalar(5.1796800000000003) * _tmp12 + _tmp133 * _tmp82 + _tmp18 * fv1;
  const Scalar _tmp135 = _tmp125 * _tmp97;
  const Scalar _tmp136 = _tmp123 * _tmp125 + Scalar(1.0);
  const Scalar _tmp137 = -_tmp133 * _tmp81 - Scalar(5.1796800000000003) * _tmp26 - _tmp29 * fv1;
  const Scalar _tmp138 = _tmp101 * _tmp124;
  const Scalar _tmp139 = -_tmp102 * _tmp92 - _tmp122 * _tmp138 + _tmp94;
  const Scalar _tmp140 = std::asinh(
      _tmp121 * (Scalar(1.0) * _tmp112 * (_tmp108 * _tmp125 - _tmp128 * _tmp129) +
                 Scalar(1.0) * _tmp119 * (_tmp116 * _tmp125 - _tmp127 * _tmp128) +
                 Scalar(1.0) * _tmp134 * (-_tmp125 + _tmp131 * _tmp95) +
                 Scalar(1.0) * _tmp137 * (-_tmp128 * _tmp136 + _tmp135) +
                 Scalar(1.0) * _tmp83 * (-_tmp128 * _tmp132 + _tmp130) +
                 Scalar(1.0) * _tmp84 * (-_tmp101 * _tmp125 - _tmp128 * _tmp139 + Scalar(1.0))));
  const Scalar _tmp141 = Scalar(9.6622558468725703) * _tmp120;
  const Scalar _tmp142 = _tmp125 * _tmp134;
  const Scalar _tmp143 = _tmp102 * _tmp84;
  const Scalar _tmp144 = _tmp76 * _tmp83;
  const Scalar _tmp145 =
      _tmp110 * _tmp112 * _tmp72 + _tmp118 * _tmp119 * _tmp72 - _tmp143 * _tmp73 - _tmp144 * _tmp73;
  const Scalar _tmp146 = Scalar(1.0) / (_tmp145);
  const Scalar _tmp147 =
      std::asinh(_tmp146 * (_tmp112 * _tmp129 * _tmp95 + _tmp119 * _tmp127 * _tmp95 -
                            _tmp122 * _tmp142 * _tmp95 + _tmp132 * _tmp83 * _tmp95 +
                            _tmp136 * _tmp137 * _tmp95 + _tmp139 * _tmp84 * _tmp95));
  const Scalar _tmp148 = Scalar(9.6622558468725703) * _tmp145;
  const Scalar _tmp149 = _tmp109 * _tmp112 + _tmp117 * _tmp119 + _tmp143 + _tmp144;
  const Scalar _tmp150 = Scalar(1.0) / (_tmp149);
  const Scalar _tmp151 =
      std::asinh(_tmp150 * (-_tmp108 * _tmp112 * _tmp124 - _tmp116 * _tmp119 * _tmp124 -
                            _tmp130 * _tmp83 - _tmp135 * _tmp137 + _tmp138 * _tmp84 + _tmp142));
  ...
  _res(2, 0) =
      -_tmp148 *
          (Scalar(0.86565325453551001) * _tmp146 + std::cosh(Scalar(1.0) * _tmp147) -
           std::cosh(
               ...
               (-_tmp151 * _tmp152 -
                Scalar(8.3196563700000006) *
                    std::sqrt(Scalar(
                        ...
                        std::pow(Scalar(-Scalar(0.12019727204189803) * _tmp43 - 1),
                                 Scalar(2))))))) +
