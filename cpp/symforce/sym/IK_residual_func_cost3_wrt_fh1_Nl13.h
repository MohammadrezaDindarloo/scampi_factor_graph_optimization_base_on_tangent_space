...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl13(
  ...
  const Scalar _tmp48 = _tmp32 + _tmp36;
  const Scalar _tmp49 = _tmp44 * _tmp45;
  const Scalar _tmp50 = -_tmp31 * _tmp47 + _tmp48 * _tmp49;
  const Scalar _tmp51 = Scalar(1.0) * _tmp16;
  const Scalar _tmp52 = Scalar(1.0) * _tmp27;
  const Scalar _tmp53 = (-_tmp39 + _tmp52) / (_tmp42 - _tmp51);
  const Scalar _tmp54 = Scalar(1.0) / (_tmp31 * _tmp46 - _tmp49);
  ...
  const Scalar _tmp58 = _tmp33 + _tmp34 + _tmp35;
  const Scalar _tmp59 = _tmp15 + _tmp6;
  ...
  const Scalar _tmp70 = -_tmp53 * (-_tmp31 * _tmp69 - _tmp50 * _tmp68 + _tmp58 * _tmp65) -
                        _tmp56 * _tmp68 - _tmp58 * _tmp66 + _tmp69;
  ...
  const Scalar _tmp76 = -_tmp39 * _tmp49 + _tmp42 * _tmp46 + _tmp46 * _tmp75;
  const Scalar _tmp77 = _tmp59 * _tmp66 - _tmp61 * _tmp65 + _tmp66 * _tmp75 - _tmp68 * _tmp76;
  const Scalar _tmp78 = _tmp71 * _tmp77;
  const Scalar _tmp79 = Scalar(1.0) / (_tmp77);
  const Scalar _tmp80 = _tmp70 * _tmp79;
  const Scalar _tmp81 = _tmp57 + _tmp80 * (-_tmp55 * _tmp76 - _tmp57 * _tmp78);
  ...
  const Scalar _tmp88 = _tmp20 + _tmp38;
  ...
  const Scalar _tmp92 = _tmp74 * _tmp91 * (_tmp81 * _tmp82 + _tmp84 * _tmp85);
  const Scalar _tmp93 = Scalar(333.54000000000002) - fv1;
  const Scalar _tmp94 = _tmp51 * _tmp53 + _tmp52;
  const Scalar _tmp95 = 0;
  const Scalar _tmp96 = _tmp46 * _tmp68;
  const Scalar _tmp97 = _tmp31 * _tmp54;
  const Scalar _tmp98 = -_tmp37 - _tmp53 * (_tmp31 * _tmp37 + _tmp50 * _tmp97) + _tmp56 * _tmp97;
  ...
  const Scalar _tmp102 = _tmp101 * _tmp74 * (_tmp100 * _tmp85 + _tmp82 * _tmp99 + Scalar(1.0));
  const Scalar _tmp103 = -_tmp101 * _tmp86 + _tmp88 * _tmp91;
  const Scalar _tmp104 = Scalar(1.0) * _tmp79;
  const Scalar _tmp105 = _tmp103 * _tmp74 * (_tmp104 * _tmp66 - _tmp104 * _tmp96);
  const Scalar _tmp106 = _tmp93 * _tmp95;
  const Scalar _tmp107 = _tmp100 * _tmp101 * _tmp54;
  const Scalar _tmp108 = _tmp103 * _tmp104;
  const Scalar _tmp109 = _tmp108 * fh1;
  const Scalar _tmp110 = _tmp54 * _tmp84 * _tmp91;
  const Scalar _tmp111 = _tmp101 * _tmp71 * _tmp99;
  const Scalar _tmp112 = _tmp71 * _tmp81 * _tmp91;

  // Output terms (1)
  Eigen::Matrix<Scalar, 4, 1> _res;

  _res(0, 0) = -std::exp(-fh1);
  _res(1, 0) = -(-_tmp102 - _tmp105 - _tmp92) *
               std::exp(_tmp102 * fh1 + _tmp105 * fh1 +
                        _tmp74 * _tmp93 * (_tmp66 * _tmp95 - _tmp95 * _tmp96) + _tmp92 * fh1);
  _res(2, 0) = -(_tmp107 - _tmp108 * _tmp68 + _tmp110) *
               std::exp(_tmp106 * _tmp68 - _tmp107 * fh1 + _tmp109 * _tmp68 - _tmp110 * fh1);
  _res(3, 0) =
      -(_tmp108 + _tmp111 + _tmp112) * std::exp(-_tmp106 - _tmp109 - _tmp111 * fh1 - _tmp112 * fh1);
