...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl16(
  ...
  const Scalar _tmp36 = _tmp30 + Scalar(-4.7752063900000001);
  const Scalar _tmp37 = _tmp20 + Scalar(-2.71799795);
  ...
  const Scalar _tmp41 = -Scalar(5.1796800000000003) * _tmp25 - _tmp29 * fv1 - _tmp39 * _tmp40;
  ...
  const Scalar _tmp56 = _tmp42 + _tmp45;
  const Scalar _tmp57 = _tmp55 * (_tmp44 - _tmp56);
  const Scalar _tmp58 = _tmp53 * _tmp57;
  const Scalar _tmp59 = Scalar(1.0) / (_tmp44 - _tmp46 - _tmp58);
  const Scalar _tmp60 = Scalar(1.0) * _tmp59;
  const Scalar _tmp61 = _tmp58 * _tmp60 + Scalar(1.0);
  const Scalar _tmp62 = Scalar(1.0) * _tmp55;
  ...
  const Scalar _tmp73 = _tmp43 + position_vector(0, 0);
  ...
  const Scalar _tmp79 = _tmp78 * (_tmp43 * _tmp72 * _tmp76 - _tmp48 * _tmp74 * _tmp76);
  const Scalar _tmp80 = _tmp54 * _tmp70 - _tmp56 * _tmp69 + _tmp70 * _tmp79;
  const Scalar _tmp81 = _tmp72 * _tmp77;
  const Scalar _tmp82 = Scalar(1.0) / (-_tmp69 + _tmp70 * _tmp81);
  const Scalar _tmp83 = Scalar(1.0) * _tmp82;
  const Scalar _tmp84 = -_tmp31;
  const Scalar _tmp85 = _tmp32 - _tmp33;
  const Scalar _tmp86 = _tmp84 + _tmp85;
  const Scalar _tmp87 = _tmp31 + _tmp85;
  const Scalar _tmp88 = _tmp81 * _tmp87;
  const Scalar _tmp89 = _tmp69 * _tmp86 - _tmp70 * _tmp88;
  const Scalar _tmp90 = _tmp83 * _tmp89;
  const Scalar _tmp91 = -_tmp70 * _tmp86 + _tmp70 * _tmp87;
  const Scalar _tmp92 = _tmp57 * _tmp90 - _tmp83 * _tmp91;
  const Scalar _tmp93 = _tmp52 + position_vector(1, 0);
  const Scalar _tmp94 = _tmp93 + Scalar(8.3888750099999996);
  const Scalar _tmp95 = _tmp46 + position_vector(0, 0);
  ...
  const Scalar _tmp100 = _tmp81 * _tmp99 - _tmp98;
  const Scalar _tmp101 = _tmp100 * _tmp82;
  const Scalar _tmp102 = _tmp87 * _tmp99;
  const Scalar _tmp103 = _tmp34 + _tmp84;
  const Scalar _tmp104 = -_tmp101 * _tmp89 - _tmp102 * _tmp81 + _tmp103 * _tmp98;
  const Scalar _tmp105 = -_tmp101 * _tmp91 + _tmp102 - _tmp103 * _tmp99 - _tmp104 * _tmp57;
  const Scalar _tmp106 = Scalar(1.0) / (_tmp105);
  const Scalar _tmp107 = -_tmp101 * _tmp80 - _tmp46 * _tmp98 + _tmp52 * _tmp99 + _tmp79 * _tmp99;
  const Scalar _tmp108 = _tmp106 * _tmp107;
  const Scalar _tmp109 = Scalar(1.0) / (_tmp107);
  const Scalar _tmp110 = _tmp105 * _tmp109;
  const Scalar _tmp111 = _tmp110 * (-_tmp108 * _tmp92 - _tmp80 * _tmp83);
  const Scalar _tmp112 = _tmp53 * _tmp59;
  ...
  const Scalar _tmp116 = _tmp39 * fh1;
  const Scalar _tmp117 = _tmp81 * _tmp82;
  const Scalar _tmp118 = _tmp117 * _tmp89 + _tmp88;
  const Scalar _tmp119 = _tmp117 * _tmp91 - _tmp118 * _tmp57 - _tmp87;
  const Scalar _tmp120 = _tmp110 * (-_tmp108 * _tmp119 + _tmp117 * _tmp80 - _tmp79);
  const Scalar _tmp121 = _tmp119 + _tmp120;
  const Scalar _tmp122 = _tmp112 * _tmp120 - _tmp114 * _tmp121 + _tmp118;
  const Scalar _tmp123 = _tmp37 * _tmp38;
  const Scalar _tmp124 = _tmp123 * fh1;
  const Scalar _tmp125 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp126 = _tmp44 + _tmp49 * _tmp57;
  const Scalar _tmp127 = 0;
  const Scalar _tmp128 = _tmp126 * _tmp59;
  const Scalar _tmp129 = -_tmp114 * _tmp127 - _tmp128 * _tmp53 + _tmp50;
  const Scalar _tmp130 = _tmp110 * _tmp60;
  const Scalar _tmp131 = Scalar(1.0) * _tmp109;
  const Scalar _tmp132 = -_tmp104 * _tmp131 + _tmp130 * _tmp53;
  const Scalar _tmp133 = fh1 * (-_tmp123 * _tmp29 + _tmp19 * _tmp39);
  const Scalar _tmp134 = Scalar(5.1796800000000003) * _tmp12 + _tmp123 * _tmp40 + _tmp19 * fv1;
  const Scalar _tmp135 = _tmp53 * _tmp55;
  const Scalar _tmp136 = _tmp106 * _tmp99;
  const Scalar _tmp137 = _tmp100 * _tmp106;
  const Scalar _tmp138 = -_tmp113 * _tmp137 + Scalar(1.0);
  const Scalar _tmp139 = _tmp70 * _tmp82;
  const Scalar _tmp140 = _tmp100 * _tmp109 * _tmp83;
  const Scalar _tmp141 = -_tmp121 * _tmp137 - _tmp81;
  const Scalar _tmp142 = _tmp106 * _tmp127;
  const Scalar _tmp143 = -_tmp116 * _tmp78 * (_tmp113 * _tmp136 + _tmp138 * _tmp139) -
                         _tmp124 * _tmp78 * (_tmp121 * _tmp136 + _tmp139 * _tmp141 + Scalar(1.0)) -
                         _tmp125 * _tmp78 * (-_tmp101 * _tmp142 * _tmp70 + _tmp142 * _tmp99) -
                         _tmp133 * _tmp78 * (_tmp131 * _tmp99 - _tmp140 * _tmp70);
  const Scalar _tmp144 = Scalar(1.0) / (_tmp143);
  const Scalar _tmp145 = std::asinh(
      _tmp144 * (Scalar(1.0) * _tmp116 * (_tmp111 * _tmp60 - _tmp115 * _tmp62) +
                 Scalar(1.0) * _tmp124 * (_tmp120 * _tmp60 - _tmp122 * _tmp62) +
                 Scalar(1.0) * _tmp125 * (-_tmp126 * _tmp60 - _tmp129 * _tmp62 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp133 * (_tmp130 - _tmp132 * _tmp62) +
                 Scalar(1.0) * _tmp134 * (_tmp135 * _tmp60 - _tmp60) +
                 Scalar(1.0) * _tmp41 * (-_tmp61 * _tmp62 + _tmp63)));
  const Scalar _tmp146 = Scalar(9.6622558468725703) * _tmp143;
  const Scalar _tmp147 = _tmp125 * _tmp142;
  const Scalar _tmp148 = -_tmp101 * _tmp147 + _tmp116 * _tmp138 * _tmp82 +
                         _tmp124 * _tmp141 * _tmp82 - _tmp133 * _tmp140;
  const Scalar _tmp149 = Scalar(1.0) / (_tmp148);
  const Scalar _tmp150 = _tmp134 * _tmp60;
  const Scalar _tmp151 =
      std::asinh(_tmp149 * (_tmp115 * _tmp116 * _tmp55 + _tmp122 * _tmp124 * _tmp55 +
                            _tmp125 * _tmp129 * _tmp55 + _tmp132 * _tmp133 * _tmp55 -
                            _tmp135 * _tmp150 + _tmp41 * _tmp55 * _tmp61));
  const Scalar _tmp152 = Scalar(9.6622558468725703) * _tmp148;
  const Scalar _tmp153 =
      _tmp106 * _tmp113 * _tmp116 + _tmp106 * _tmp121 * _tmp124 + _tmp131 * _tmp133 + _tmp147;
  const Scalar _tmp154 = Scalar(1.0) / (_tmp153);
  const Scalar _tmp155 =
      std::asinh(_tmp154 * (-_tmp111 * _tmp116 * _tmp59 - _tmp120 * _tmp124 * _tmp59 +
                            _tmp125 * _tmp128 - _tmp130 * _tmp133 + _tmp150 - _tmp41 * _tmp63));
  ...
  _res(1, 0) =
      -_tmp146 *
          (Scalar(0.86625939559540499) * _tmp144 + std::cosh(Scalar(1.0) * _tmp145) -
           std::cosh(
                ...
                Scalar(4.8333311099999996) *
                    std::sqrt(Scalar(
                        ...
                        Scalar(0.13817235445745474) *
                            std::pow(Scalar(-Scalar(0.55659957866191134) * _tmp73 - 1),
                                     Scalar(2))))))) +
      _tmp87 + position_vector(2, 0);
  _res(2, 0) =
      -_tmp152 *
          (Scalar(0.87679799772039002) * _tmp149 + std::cosh(Scalar(1.0) * _tmp151) -
           std::cosh(
               Scalar(0.1034955) * _tmp149 *
               (-_tmp151 * _tmp152 -
                Scalar(8.3196563700000006) *
                    std::sqrt(Scalar(
                        std::pow(Scalar(-Scalar(0.12019727204189803) * _tmp64 - 1), Scalar(2)) +
                        Scalar(0.057067943376852184) *
                            std::pow(Scalar(-Scalar(0.50315118556004401) * _tmp66 - 1),
                                     Scalar(2))))))) +
