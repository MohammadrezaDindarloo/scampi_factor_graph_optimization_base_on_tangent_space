...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl9(
  ...
  const Scalar _tmp55 = _tmp31 * _tmp54 - _tmp46;
  const Scalar _tmp56 = _tmp40 * _tmp41;
  const Scalar _tmp57 = Scalar(1.0) / (_tmp42 * _tmp54 - _tmp56);
  const Scalar _tmp58 = _tmp55 * _tmp57;
  const Scalar _tmp59 = -_tmp32 + _tmp35;
  const Scalar _tmp60 = _tmp31 * _tmp43;
  const Scalar _tmp61 = _tmp36 * _tmp56 - _tmp44 * _tmp54;
  ...
  const Scalar _tmp65 = -_tmp31 * _tmp59 - _tmp45 * _tmp58 + _tmp60 -
                        _tmp64 * (_tmp46 * _tmp59 - _tmp54 * _tmp60 - _tmp58 * _tmp61);
  ...
  const Scalar _tmp74 = -_tmp37 * _tmp56 + _tmp39 * _tmp42 + _tmp42 * _tmp73;
  const Scalar _tmp75 = -_tmp18 * _tmp46 + _tmp28 * _tmp31 + _tmp31 * _tmp73 - _tmp58 * _tmp74;
  const Scalar _tmp76 = Scalar(1.0) / (_tmp75);
  const Scalar _tmp77 = Scalar(1.0) * _tmp76;
  const Scalar _tmp78 = _tmp10 + _tmp50;
  const Scalar _tmp79 = _tmp22 + _tmp47;
  ...
  const Scalar _tmp87 = -_tmp45 * _tmp86 + _tmp61 * _tmp64 * _tmp86;
  ...
  const Scalar _tmp91 = _tmp31 * _tmp66;
  const Scalar _tmp92 = _tmp55 * _tmp66;
  const Scalar _tmp93 = -_tmp90 * _tmp92 + Scalar(1.0);
  const Scalar _tmp94 = _tmp42 * _tmp57;
  const Scalar _tmp95 = _tmp71 * fh1;
  const Scalar _tmp96 = _tmp54 * _tmp57;
  const Scalar _tmp97 = -_tmp43 + _tmp45 * _tmp96 - _tmp64 * (_tmp43 * _tmp54 + _tmp61 * _tmp96);
  const Scalar _tmp98 = _tmp89 * (-_tmp73 + _tmp74 * _tmp96 - _tmp88 * _tmp97) + _tmp97;
  const Scalar _tmp99 = -_tmp54 - _tmp92 * _tmp98;
  const Scalar _tmp100 = _tmp0 * _tmp68;
  const Scalar _tmp101 = _tmp57 * fh1;
  ...
  _res(1, 0) = std::exp(_tmp0 * _tmp71 * (_tmp31 * _tmp68 - _tmp68 * _tmp69) +
                        _tmp71 * _tmp85 * (_tmp31 * _tmp77 - _tmp69 * _tmp77) +
                        _tmp83 * _tmp95 * (_tmp90 * _tmp91 + _tmp93 * _tmp94) +
                        _tmp84 * _tmp95 * (_tmp91 * _tmp98 + _tmp94 * _tmp99 + Scalar(1.0)));
  _res(2, 0) = std::exp(_tmp100 * _tmp58 - _tmp101 * _tmp83 * _tmp93 - _tmp101 * _tmp84 * _tmp99 +
                        _tmp102 * _tmp58);
  _res(3, 0) = std::exp(-_tmp100 - _tmp102 - _tmp103 * _tmp83 * _tmp90 - _tmp103 * _tmp84 * _tmp98);
