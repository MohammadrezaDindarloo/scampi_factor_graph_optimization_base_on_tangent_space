...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl23(
  ...
  const Scalar _tmp34 =
      -Scalar(0.010999999999999999) * _tmp27 - Scalar(0.010999999999999999) * _tmp5;
  ...
  const Scalar _tmp69 = -_tmp49 * _tmp56 + _tmp50 * _tmp57 + _tmp57 * _tmp68;
  const Scalar _tmp70 = _tmp60 * _tmp66;
  const Scalar _tmp71 = -_tmp47 + _tmp48 * _tmp70;
  const Scalar _tmp72 = Scalar(1.0) / (-_tmp56 + _tmp57 * _tmp70);
  const Scalar _tmp73 = _tmp71 * _tmp72;
  const Scalar _tmp74 = -_tmp39 * _tmp47 + _tmp41 * _tmp48 + _tmp48 * _tmp68 - _tmp69 * _tmp73;
  const Scalar _tmp75 = Scalar(1.0) / (_tmp74);
  const Scalar _tmp76 = Scalar(1.0) * _tmp75;
  const Scalar _tmp77 = _tmp57 * _tmp73;
  const Scalar _tmp78 = _tmp20 + Scalar(1.79662371);
  const Scalar _tmp79 = _tmp31 + Scalar(-4.8333311099999996);
  ...
  const Scalar _tmp83 = fh1 * (_tmp19 * _tmp81 - _tmp30 * _tmp82);
  const Scalar _tmp84 = Scalar(43.164000000000001) - fv1;
  ...
  const Scalar _tmp91 = _tmp56 * _tmp90 - _tmp70 * _tmp89;
  const Scalar _tmp92 = _tmp48 * _tmp88;
  const Scalar _tmp93 = _tmp47 * _tmp86 - _tmp70 * _tmp92 - _tmp73 * _tmp91;
  const Scalar _tmp94 = Scalar(1.0) * _tmp58;
  const Scalar _tmp95 = -_tmp94;
  const Scalar _tmp96 = Scalar(1.0) / (_tmp50 + _tmp95);
  const Scalar _tmp97 = Scalar(1.0) * _tmp61;
  const Scalar _tmp98 = _tmp96 * (-_tmp49 + _tmp97);
  const Scalar _tmp99 = -_tmp57 * _tmp90 + _tmp89;
  const Scalar _tmp100 = -_tmp48 * _tmp86 - _tmp73 * _tmp99 + _tmp92 - _tmp93 * _tmp98;
  const Scalar _tmp101 = Scalar(1.0) / (_tmp100);
  const Scalar _tmp102 = _tmp94 * _tmp98 + _tmp97;
  const Scalar _tmp103 = 0;
  const Scalar _tmp104 = Scalar(1.0) * _tmp72;
  const Scalar _tmp105 = _tmp104 * _tmp91;
  const Scalar _tmp106 = -_tmp104 * _tmp99 + _tmp105 * _tmp98;
  const Scalar _tmp107 = _tmp101 * _tmp74;
  const Scalar _tmp108 = _tmp100 * _tmp75;
  const Scalar _tmp109 = _tmp108 * (-_tmp104 * _tmp69 - _tmp106 * _tmp107);
  const Scalar _tmp110 = _tmp101 * (_tmp106 + _tmp109);
  const Scalar _tmp111 = -_tmp110 * _tmp71 + Scalar(1.0);
  const Scalar _tmp112 = _tmp57 * _tmp72;
  const Scalar _tmp113 = _tmp81 * fh1;
  const Scalar _tmp114 = _tmp70 * _tmp72;
  const Scalar _tmp115 = _tmp114 * _tmp91 + _tmp70 * _tmp88;
  const Scalar _tmp116 = _tmp114 * _tmp99 - _tmp115 * _tmp98 - _tmp88;
  const Scalar _tmp117 = _tmp108 * (-_tmp107 * _tmp116 + _tmp114 * _tmp69 - _tmp68);
  const Scalar _tmp118 = _tmp101 * (_tmp116 + _tmp117);
  const Scalar _tmp119 = -_tmp118 * _tmp71 - _tmp70;
  const Scalar _tmp120 = _tmp82 * fh1;
  const Scalar _tmp121 = -_tmp113 * _tmp67 * (_tmp110 * _tmp48 + _tmp111 * _tmp112) -
                         _tmp120 * _tmp67 * (_tmp112 * _tmp119 + _tmp118 * _tmp48 + Scalar(1.0)) -
                         _tmp67 * _tmp83 * (_tmp48 * _tmp76 - _tmp76 * _tmp77) -
                         _tmp67 * _tmp84 * (_tmp103 * _tmp48 - _tmp103 * _tmp77);
  const Scalar _tmp122 = Scalar(1.0) / (_tmp121);
  const Scalar _tmp123 = _tmp41 + _tmp95;
  const Scalar _tmp124 = _tmp123 * _tmp98;
  const Scalar _tmp125 = Scalar(1.0) / (-_tmp124 - _tmp39 + _tmp97);
  const Scalar _tmp126 = _tmp123 * _tmp125;
  const Scalar _tmp127 = -_tmp105 + _tmp109 * _tmp126 - _tmp110 * _tmp93;
  const Scalar _tmp128 = Scalar(1.0) * _tmp96;
  const Scalar _tmp129 = Scalar(1.0) * _tmp125;
  const Scalar _tmp130 = _tmp123 * _tmp129;
  const Scalar _tmp131 = _tmp108 * _tmp130 - _tmp76 * _tmp93;
  const Scalar _tmp132 = _tmp108 * _tmp129;
  const Scalar _tmp133 = _tmp124 * _tmp129 + Scalar(1.0);
  const Scalar _tmp134 = _tmp129 * _tmp98;
  const Scalar _tmp135 = _tmp37 * fh1;
  const Scalar _tmp136 = -_tmp135 * _tmp81 - Scalar(5.1796800000000003) * _tmp25 - _tmp30 * fv1;
  const Scalar _tmp137 = _tmp115 + _tmp117 * _tmp126 - _tmp118 * _tmp93;
  const Scalar _tmp138 = Scalar(5.1796800000000003) * _tmp13 + _tmp135 * _tmp82 + _tmp19 * fv1;
  const Scalar _tmp139 = _tmp102 * _tmp125;
  const Scalar _tmp140 = -_tmp103 * _tmp93 - _tmp123 * _tmp139 + _tmp95;
  const Scalar _tmp141 = std::asinh(
      _tmp122 * (Scalar(1.0) * _tmp113 * (_tmp109 * _tmp129 - _tmp127 * _tmp128) +
                 Scalar(1.0) * _tmp120 * (_tmp117 * _tmp129 - _tmp128 * _tmp137) +
                 Scalar(1.0) * _tmp136 * (-_tmp128 * _tmp133 + _tmp134) +
                 Scalar(1.0) * _tmp138 * (-_tmp129 + _tmp130 * _tmp96) +
                 Scalar(1.0) * _tmp83 * (-_tmp128 * _tmp131 + _tmp132) +
                 Scalar(1.0) * _tmp84 * (-_tmp102 * _tmp129 - _tmp128 * _tmp140 + Scalar(1.0))));
  const Scalar _tmp142 = Scalar(9.6622558468725703) * _tmp121;
  const Scalar _tmp143 = _tmp76 * _tmp83;
  const Scalar _tmp144 = _tmp103 * _tmp84;
  const Scalar _tmp145 =
      _tmp111 * _tmp113 * _tmp72 + _tmp119 * _tmp120 * _tmp72 - _tmp143 * _tmp73 - _tmp144 * _tmp73;
  const Scalar _tmp146 = Scalar(1.0) / (_tmp145);
  const Scalar _tmp147 = _tmp129 * _tmp138;
  const Scalar _tmp148 =
      std::asinh(_tmp146 * (_tmp113 * _tmp127 * _tmp96 + _tmp120 * _tmp137 * _tmp96 -
                            _tmp123 * _tmp147 * _tmp96 + _tmp131 * _tmp83 * _tmp96 +
                            _tmp133 * _tmp136 * _tmp96 + _tmp140 * _tmp84 * _tmp96));
  const Scalar _tmp149 = Scalar(9.6622558468725703) * _tmp145;
  const Scalar _tmp150 = _tmp110 * _tmp113 + _tmp118 * _tmp120 + _tmp143 + _tmp144;
  const Scalar _tmp151 = Scalar(1.0) / (_tmp150);
  const Scalar _tmp152 =
      std::asinh(_tmp151 * (-_tmp109 * _tmp113 * _tmp125 - _tmp117 * _tmp120 * _tmp125 -
                            _tmp132 * _tmp83 - _tmp134 * _tmp136 + _tmp139 * _tmp84 + _tmp147));
                ...
                Scalar(4.7752063900000001) *
                    std::sqrt(Scalar(
                        ...
                        Scalar(0.32397683292140877) *
                            std::pow(Scalar(1 - Scalar(0.36791786395571047) * _tmp62),
                                     Scalar(2))))))) +
      _tmp88 + position_vector(2, 0);
  _res(2, 0) =
      -_tmp149 *
          (Scalar(0.87653584775870996) * _tmp146 + std::cosh(Scalar(1.0) * _tmp148) -
           std::cosh(
  ...
  _res(3, 0) =
      -_tmp153 *
          (Scalar(0.87679799772039002) * _tmp151 + std::cosh(Scalar(1.0) * _tmp152) -
           std::cosh(
