...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl14(
  ...
  const Scalar _tmp35 = _tmp32 + position_vector(0, 0) + Scalar(-2.5202214700000001);
  const Scalar _tmp36 =
  ...
  const Scalar _tmp40 = _tmp39 * (_tmp32 * _tmp34 * _tmp37 - _tmp33 * _tmp35 * _tmp37);
  const Scalar _tmp41 = -_tmp16 * _tmp29 + _tmp25 * _tmp30 + _tmp30 * _tmp40;
  const Scalar _tmp42 = _tmp34 * _tmp38;
  ...
  const Scalar _tmp47 = -Scalar(0.010999999999999999) * _tmp19 -
  ...
  const Scalar _tmp53 = _tmp29 * _tmp50 - _tmp30 * _tmp52;
  ...
  const Scalar _tmp57 = -_tmp30 * _tmp50 + _tmp30 * _tmp51;
  const Scalar _tmp58 = _tmp44 * _tmp57 - _tmp51 - _tmp56 * (_tmp44 * _tmp53 + _tmp52);
  ...
  const Scalar _tmp62 = _tmp20 + _tmp23;
  const Scalar _tmp63 = _tmp18 + _tmp62;
  const Scalar _tmp64 = _tmp63 + position_vector(1, 0) + Scalar(-4.8333311099999996);
  ...
  const Scalar _tmp70 = _tmp51 * _tmp66 -
                        _tmp56 * (-_tmp52 * _tmp66 - _tmp53 * _tmp69 + _tmp59 * _tmp67) -
                        _tmp57 * _tmp69 - _tmp59 * _tmp66;
  const Scalar _tmp71 = Scalar(1.0) / (_tmp70);
  const Scalar _tmp72 = _tmp40 * _tmp66 - _tmp41 * _tmp69 - _tmp60 * _tmp67 + _tmp63 * _tmp66;
  const Scalar _tmp73 = _tmp71 * _tmp72;
  const Scalar _tmp74 = Scalar(1.0) / (_tmp72);
  const Scalar _tmp75 = _tmp70 * _tmp74;
  const Scalar _tmp76 = _tmp58 + _tmp75 * (-_tmp40 + _tmp41 * _tmp44 - _tmp58 * _tmp73);
  const Scalar _tmp77 = _tmp66 * _tmp71;
  const Scalar _tmp78 = _tmp68 * _tmp71;
  const Scalar _tmp79 = -_tmp42 - _tmp76 * _tmp78;
  const Scalar _tmp80 = _tmp30 * _tmp43;
  const Scalar _tmp81 = _tmp31 + _tmp6;
  const Scalar _tmp82 = _tmp81 + position_vector(0, 0) + Scalar(-2.71799795);
  const Scalar _tmp83 = _tmp17 + _tmp62;
  ...
  const Scalar _tmp94 = _tmp53 * _tmp56 * _tmp93 - _tmp57 * _tmp93;
  ...
  const Scalar _tmp99 = _tmp68 * _tmp74 * _tmp93;
  const Scalar _tmp100 = Scalar(1.0) * _tmp74;
  const Scalar _tmp101 = fh1 * (_tmp81 * _tmp97 - _tmp83 * _tmp86);

  // Output terms (1)
  Eigen::Matrix<Scalar, 4, 1> _res;

  _res(0, 0) = std::exp(-fh1);
  _res(1, 0) = std::exp(_tmp101 * _tmp39 * (_tmp100 * _tmp66 - _tmp30 * _tmp99) +
                        _tmp39 * _tmp87 * (_tmp76 * _tmp77 + _tmp79 * _tmp80 + Scalar(1.0)) +
                        _tmp39 * _tmp88 * (_tmp66 * _tmp91 - _tmp80 * _tmp92) +
                        _tmp39 * _tmp98 * (_tmp77 * _tmp95 + _tmp80 * _tmp96));
  _res(2, 0) = std::exp(_tmp101 * _tmp99 - _tmp43 * _tmp79 * _tmp87 + _tmp43 * _tmp88 * _tmp92 -
                        _tmp43 * _tmp96 * _tmp98);
  _res(3, 0) = std::exp(-_tmp100 * _tmp101 - _tmp71 * _tmp76 * _tmp87 - _tmp71 * _tmp95 * _tmp98 -
                        _tmp88 * _tmp91);
