...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl6(
  ...
  const Scalar _tmp93 = -_tmp36 * _tmp92 + _tmp51 * _tmp54 * _tmp92;
  const Scalar _tmp94 = _tmp76 * (-_tmp72 * _tmp92 - _tmp74 * _tmp93) + _tmp93;
  const Scalar _tmp95 = -_tmp79 * _tmp94 + Scalar(1.0);
  const Scalar _tmp96 = _tmp90 * fh1;
  ...
  const Scalar _tmp101 = _tmp70 * (-_tmp100 * _tmp33 + _tmp63 * _tmp99);
  ...
  _res(1, 0) =
      -_tmp101 * std::exp(_tmp101 * _tmp97 +
                          ...
                          _tmp70 * _tmp91 * (-_tmp33 * _tmp65 * _tmp89 + _tmp63 * _tmp89) +
                          _tmp70 * _tmp96 * (_tmp78 * _tmp94 + _tmp81 * _tmp95));
  _res(2, 0) = -_tmp100 * std::exp(_tmp102 * _tmp65 + _tmp103 * _tmp65 - _tmp48 * _tmp80 * _tmp88 -
                                   _tmp48 * _tmp95 * _tmp96);
  _res(3, 0) =
      _tmp99 * std::exp(-_tmp102 - _tmp103 - _tmp67 * _tmp77 * _tmp88 - _tmp67 * _tmp94 * _tmp96);
