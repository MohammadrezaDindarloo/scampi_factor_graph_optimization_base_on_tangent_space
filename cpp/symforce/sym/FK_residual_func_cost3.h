...
Eigen::Matrix<Scalar, 4, 1> FkResidualFuncCost3(const Scalar fh1, const Scalar fv1,
  ...
  const Scalar _tmp93 = Scalar(1.0) * _tmp45;
  const Scalar _tmp94 = -_tmp35 * _tmp93 + _tmp48 * _tmp51 * _tmp93;
  const Scalar _tmp95 = _tmp75 * (-_tmp71 * _tmp93 - _tmp73 * _tmp94) + _tmp94;
  const Scalar _tmp96 = -_tmp78 * _tmp95 + Scalar(1.0);
  const Scalar _tmp97 = _tmp84 * _tmp85;
  const Scalar _tmp98 = Scalar(1.0) * _tmp74;
  const Scalar _tmp99 = fh1 * (_tmp81 * _tmp97 - _tmp83 * _tmp86);
  const Scalar _tmp100 = _tmp98 * _tmp99;
  const Scalar _tmp101 = _tmp45 * fh1;
  ...
  _res(1, 0) = std::exp(_tmp69 * _tmp88 * (_tmp61 * _tmp92 - _tmp80 * _tmp91) +
                        _tmp69 * _tmp99 * (-_tmp33 * _tmp64 * _tmp98 + _tmp61 * _tmp98) +
                        _tmp86 * _tmp87 * (_tmp76 * _tmp77 + _tmp79 * _tmp80 + Scalar(1.0)) +
                        _tmp87 * _tmp97 * (_tmp77 * _tmp95 + _tmp80 * _tmp96));
  _res(2, 0) = std::exp(_tmp100 * _tmp64 - _tmp101 * _tmp79 * _tmp86 - _tmp101 * _tmp96 * _tmp97 +
                        _tmp45 * _tmp88 * _tmp91);
  _res(3, 0) =
      std::exp(-_tmp100 - _tmp102 * _tmp76 * _tmp86 - _tmp102 * _tmp95 * _tmp97 - _tmp88 * _tmp92);
