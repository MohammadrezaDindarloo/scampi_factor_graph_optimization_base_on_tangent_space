...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl2(
  ...
  const Scalar _tmp32 = _tmp15 + _tmp6;
  const Scalar _tmp33 = _tmp32 + position_vector(0, 0) + Scalar(1.79662371);
  const Scalar _tmp34 = _tmp19 + _tmp25;
  const Scalar _tmp35 = _tmp34 + position_vector(1, 0) + Scalar(-4.8333311099999996);
  const Scalar _tmp36 = std::pow(Scalar(std::pow(_tmp33, Scalar(2)) + std::pow(_tmp35, Scalar(2))),
                                 Scalar(Scalar(-1) / Scalar(2)));
  const Scalar _tmp37 = _tmp33 * _tmp36;
  const Scalar _tmp38 = _tmp23 + _tmp24;
  const Scalar _tmp39 = _tmp19 + _tmp38;
  const Scalar _tmp40 = _tmp39 + position_vector(1, 0) + Scalar(-4.7752063900000001);
  ...
  const Scalar _tmp49 = _tmp41 + _tmp7;
  const Scalar _tmp50 = _tmp20 + _tmp38;
  const Scalar _tmp51 = _tmp50 + position_vector(1, 0) + Scalar(8.3888750099999996);
  const Scalar _tmp52 = _tmp49 + position_vector(0, 0) + Scalar(-2.5202214700000001);
  ...
  const Scalar _tmp56 = _tmp48 * _tmp55 - _tmp49 * _tmp54 + _tmp50 * _tmp55;
  const Scalar _tmp57 = _tmp40 * _tmp46;
  const Scalar _tmp58 = Scalar(1.0) / (-_tmp54 + _tmp55 * _tmp57);
  const Scalar _tmp59 = _tmp35 * _tmp36;
  const Scalar _tmp60 = _tmp37 * _tmp57 - _tmp59;
  const Scalar _tmp61 = _tmp58 * _tmp60;
  const Scalar _tmp62 = -_tmp32 * _tmp59 + _tmp34 * _tmp37 + _tmp37 * _tmp48 - _tmp56 * _tmp61;
  ...
  const Scalar _tmp74 = _tmp54 * _tmp73 - _tmp57 * _tmp72;
  const Scalar _tmp75 = _tmp57 * _tmp58;
  const Scalar _tmp76 = Scalar(1.0) * _tmp39;
  const Scalar _tmp77 = Scalar(1.0) * _tmp42;
  const Scalar _tmp78 = (-_tmp49 + _tmp77) / (_tmp50 - _tmp76);
  const Scalar _tmp79 = -_tmp55 * _tmp73 + _tmp72;
  const Scalar _tmp80 = -_tmp71 + _tmp75 * _tmp79 - _tmp78 * (_tmp57 * _tmp71 + _tmp74 * _tmp75);
  const Scalar _tmp81 = _tmp67 + _tmp68 - _tmp69;
  const Scalar _tmp82 = _tmp37 * _tmp71;
  const Scalar _tmp83 = -_tmp37 * _tmp81 - _tmp61 * _tmp79 -
                        _tmp78 * (-_tmp57 * _tmp82 + _tmp59 * _tmp81 - _tmp61 * _tmp74) + _tmp82;
  const Scalar _tmp84 = Scalar(1.0) / (_tmp83);
  const Scalar _tmp85 = _tmp62 * _tmp84;
  const Scalar _tmp86 = _tmp63 * _tmp83;
  const Scalar _tmp87 = _tmp80 + _tmp86 * (-_tmp48 + _tmp56 * _tmp75 - _tmp80 * _tmp85);
  const Scalar _tmp88 = _tmp60 * _tmp84;
  const Scalar _tmp89 = _tmp58 * (-_tmp57 - _tmp87 * _tmp88);
  const Scalar _tmp90 = _tmp84 * _tmp87;
  const Scalar _tmp91 = _tmp30 * _tmp47 * (_tmp37 * _tmp90 + _tmp55 * _tmp89 + Scalar(1.0));
  const Scalar _tmp92 = Scalar(1.0) * _tmp58;
  const Scalar _tmp93 = _tmp74 * _tmp78 * _tmp92 - _tmp79 * _tmp92;
  const Scalar _tmp94 = _tmp86 * (-_tmp56 * _tmp92 - _tmp85 * _tmp93) + _tmp93;
  const Scalar _tmp95 = _tmp58 * (-_tmp88 * _tmp94 + Scalar(1.0));
  const Scalar _tmp96 = _tmp84 * _tmp94;
  const Scalar _tmp97 = _tmp29 * _tmp47 * (_tmp37 * _tmp96 + _tmp55 * _tmp95);
  const Scalar _tmp98 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp99 = _tmp76 * _tmp78 + _tmp77;
  ...
  const Scalar _tmp105 = _tmp29 * _tmp95;
  const Scalar _tmp106 = _tmp30 * _tmp90;
  ...
  _res(1, 0) = -(-_tmp66 - _tmp91 - _tmp97) *
               std::exp(_tmp47 * _tmp98 * (_tmp100 * _tmp37 - _tmp100 * _tmp65) + _tmp66 * fh1 +
                        _tmp91 * fh1 + _tmp97 * fh1);
  _res(2, 0) = -(_tmp101 - _tmp103 * _tmp61 + _tmp105) *
               std::exp(-_tmp101 * fh1 + _tmp102 * _tmp61 + _tmp104 * _tmp61 - _tmp105 * fh1);
  _res(3, 0) =
      -(_tmp103 + _tmp106 + _tmp107) * std::exp(-_tmp102 - _tmp104 - _tmp106 * fh1 - _tmp107 * fh1);
