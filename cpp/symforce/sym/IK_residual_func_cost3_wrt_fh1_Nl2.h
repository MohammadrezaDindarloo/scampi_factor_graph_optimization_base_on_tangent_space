...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl2(
  ...
  const Scalar _tmp32 = _tmp19 * _tmp30;
  ...
  const Scalar _tmp62 = _tmp32 * _tmp59 - _tmp40 * _tmp61;
  const Scalar _tmp63 = _tmp51 * _tmp60;
  const Scalar _tmp64 = Scalar(1.0) * _tmp33;
  const Scalar _tmp65 = Scalar(1.0) * _tmp37;
  const Scalar _tmp66 = (-_tmp27 + _tmp65) / (_tmp17 - _tmp64);
  const Scalar _tmp67 = -_tmp31 * _tmp59 + _tmp61;
  const Scalar _tmp68 = -_tmp51 * _tmp58 - _tmp53 * _tmp67 + _tmp63 -
                        _tmp66 * (-_tmp40 * _tmp63 + _tmp50 * _tmp58 - _tmp53 * _tmp62);
  ...
  const Scalar _tmp75 = _tmp42 + _tmp6;
  ...
  const Scalar _tmp83 = _tmp73 * (-_tmp33 * _tmp38 * _tmp82 + _tmp35 * _tmp37 * _tmp82);
  const Scalar _tmp84 = _tmp17 * _tmp31 - _tmp27 * _tmp32 + _tmp31 * _tmp83;
  const Scalar _tmp85 = _tmp43 * _tmp51 - _tmp46 * _tmp50 + _tmp51 * _tmp83 - _tmp53 * _tmp84;
  const Scalar _tmp86 = Scalar(1.0) / (_tmp85);
  const Scalar _tmp87 = Scalar(1.0) * _tmp86;
  const Scalar _tmp88 = Scalar(1.0) * _tmp41;
  const Scalar _tmp89 = _tmp52 * _tmp86 * _tmp88;
  const Scalar _tmp90 = _tmp73 * _tmp81 * (-_tmp31 * _tmp89 + _tmp51 * _tmp87);
  const Scalar _tmp91 = _tmp40 * _tmp41;
  const Scalar _tmp92 = -_tmp60 - _tmp66 * (_tmp40 * _tmp60 + _tmp62 * _tmp91) + _tmp67 * _tmp91;
  const Scalar _tmp93 = _tmp69 * _tmp85;
  const Scalar _tmp94 = _tmp68 * _tmp86;
  const Scalar _tmp95 = _tmp92 + _tmp94 * (-_tmp83 + _tmp84 * _tmp91 - _tmp92 * _tmp93);
  const Scalar _tmp96 = _tmp52 * _tmp69;
  const Scalar _tmp97 = _tmp41 * (-_tmp40 - _tmp95 * _tmp96);
  const Scalar _tmp98 = _tmp69 * _tmp95;
  const Scalar _tmp99 = _tmp73 * _tmp80 * (_tmp31 * _tmp97 + _tmp51 * _tmp98 + Scalar(1.0));
  const Scalar _tmp100 = _tmp62 * _tmp66 * _tmp88 - _tmp67 * _tmp88;
  const Scalar _tmp101 = _tmp100 + _tmp94 * (-_tmp100 * _tmp93 - _tmp84 * _tmp88);
  const Scalar _tmp102 = _tmp101 * _tmp69;
  const Scalar _tmp103 = _tmp41 * (-_tmp101 * _tmp96 + Scalar(1.0));
  const Scalar _tmp104 = _tmp73 * _tmp79 * (_tmp102 * _tmp51 + _tmp103 * _tmp31);
  const Scalar _tmp105 = _tmp80 * _tmp97;
  const Scalar _tmp106 = _tmp103 * _tmp79;
  const Scalar _tmp107 = _tmp81 * _tmp89;
  const Scalar _tmp108 = _tmp0 * _tmp71;
  const Scalar _tmp109 = _tmp80 * _tmp98;
  const Scalar _tmp110 = _tmp81 * _tmp87;
  const Scalar _tmp111 = _tmp102 * _tmp79;

  // Output terms (1)
  Eigen::Matrix<Scalar, 4, 1> _res;

  _res(0, 0) = -std::exp(-fh1);
  _res(1, 0) = -(-_tmp104 - _tmp90 - _tmp99) *
               std::exp(_tmp0 * _tmp73 * (-_tmp31 * _tmp53 * _tmp71 + _tmp51 * _tmp71) +
                        _tmp104 * fh1 + _tmp90 * fh1 + _tmp99 * fh1);
  _res(2, 0) = -(_tmp105 + _tmp106 - _tmp107) *
               std::exp(-_tmp105 * fh1 - _tmp106 * fh1 + _tmp107 * fh1 + _tmp108 * _tmp53);
  _res(3, 0) = -(_tmp109 + _tmp110 + _tmp111) *
               std::exp(-_tmp108 - _tmp109 * fh1 - _tmp110 * fh1 - _tmp111 * fh1);
