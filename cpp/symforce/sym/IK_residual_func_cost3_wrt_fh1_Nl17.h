...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl17(
  ...
  const Scalar _tmp14 = _tmp0 * _tmp10;
  const Scalar _tmp15 =
  ...
  const Scalar _tmp44 = Scalar(1.0) / (-_tmp31 + _tmp42 * _tmp43);
  ...
  const Scalar _tmp52 = _tmp46 + _tmp47 + _tmp51;
  const Scalar _tmp53 = -_tmp43 * _tmp52 + _tmp50;
  const Scalar _tmp54 = _tmp44 * _tmp53;
  const Scalar _tmp55 = Scalar(1.0) * _tmp38;
  const Scalar _tmp56 = Scalar(1.0) * _tmp33;
  const Scalar _tmp57 = (-_tmp27 + _tmp55) / (_tmp17 - _tmp56);
  const Scalar _tmp58 = _tmp31 * _tmp52 - _tmp42 * _tmp50;
  const Scalar _tmp59 = _tmp44 * _tmp58;
  const Scalar _tmp60 = -Scalar(1.0) * _tmp54 + Scalar(1.0) * _tmp57 * _tmp59;
  const Scalar _tmp61 = _tmp32 + _tmp5;
  const Scalar _tmp62 = _tmp18 + _tmp61;
  const Scalar _tmp63 = _tmp26 + _tmp36;
  ...
  const Scalar _tmp68 = _tmp62 * _tmp65;
  const Scalar _tmp69 = _tmp42 * _tmp66 - _tmp68;
  const Scalar _tmp70 = _tmp44 * _tmp69;
  const Scalar _tmp71 = _tmp48 + _tmp51;
  const Scalar _tmp72 = -_tmp53 * _tmp70 -
                        _tmp57 * (-_tmp42 * _tmp67 - _tmp58 * _tmp70 + _tmp68 * _tmp71) -
                        _tmp66 * _tmp71 + _tmp67;
  ...
  const Scalar _tmp77 = _tmp76 * (-_tmp33 * _tmp40 * _tmp75 + _tmp35 * _tmp38 * _tmp75);
  const Scalar _tmp78 = _tmp44 * (_tmp17 * _tmp43 - _tmp27 * _tmp31 + _tmp43 * _tmp77);
  const Scalar _tmp79 = _tmp61 * _tmp66 - _tmp63 * _tmp68 + _tmp66 * _tmp77 - _tmp69 * _tmp78;
  const Scalar _tmp80 = _tmp73 * _tmp79;
  const Scalar _tmp81 = Scalar(1.0) / (_tmp79);
  const Scalar _tmp82 = _tmp72 * _tmp81;
  const Scalar _tmp83 = _tmp60 + _tmp82 * (-_tmp60 * _tmp80 - Scalar(1.0) * _tmp78);
  const Scalar _tmp84 = _tmp69 * _tmp73;
  const Scalar _tmp85 = -_tmp83 * _tmp84 + Scalar(1.0);
  const Scalar _tmp86 = _tmp43 * _tmp44;
  const Scalar _tmp87 = _tmp73 * _tmp83;
  const Scalar _tmp88 = _tmp16 + _tmp4;
  const Scalar _tmp89 = _tmp34 + _tmp88;
  const Scalar _tmp90 = _tmp21 + _tmp37;
  ...
  const Scalar _tmp94 = _tmp76 * _tmp93 * (_tmp66 * _tmp87 + _tmp85 * _tmp86);
  const Scalar _tmp95 = _tmp42 * _tmp54 - _tmp49 - _tmp57 * (_tmp42 * _tmp49 + _tmp42 * _tmp59);
  const Scalar _tmp96 = _tmp82 * (_tmp42 * _tmp78 - _tmp77 - _tmp80 * _tmp95) + _tmp95;
  const Scalar _tmp97 = _tmp73 * _tmp96;
  const Scalar _tmp98 = -_tmp42 - _tmp84 * _tmp96;
  const Scalar _tmp99 = _tmp91 * _tmp92;
  const Scalar _tmp100 = _tmp76 * _tmp99 * (_tmp66 * _tmp97 + _tmp86 * _tmp98 + Scalar(1.0));
  const Scalar _tmp101 = -_tmp88 * _tmp99 + _tmp90 * _tmp93;
  const Scalar _tmp102 = Scalar(1.0) * _tmp81;
  const Scalar _tmp103 = _tmp101 * _tmp76 * (-_tmp102 * _tmp43 * _tmp70 + _tmp102 * _tmp66);
  const Scalar _tmp104 = Scalar(333.54000000000002) - fv1;
  const Scalar _tmp105 = _tmp55 + _tmp56 * _tmp57;
  const Scalar _tmp106 = 0;
  const Scalar _tmp107 = _tmp106 * _tmp73;
  const Scalar _tmp108 = _tmp106 * _tmp84;
  const Scalar _tmp109 = _tmp44 * _tmp85 * _tmp93;
  const Scalar _tmp110 = _tmp44 * _tmp98 * _tmp99;
  const Scalar _tmp111 = _tmp101 * _tmp102;
  const Scalar _tmp112 = _tmp111 * fh1;
  const Scalar _tmp113 = _tmp87 * _tmp93;
  const Scalar _tmp114 = _tmp97 * _tmp99;

  // Output terms (1)
  Eigen::Matrix<Scalar, 4, 1> _res;

  _res(0, 0) = -std::exp(-fh1);
  _res(1, 0) = -(-_tmp100 - _tmp103 - _tmp94) *
               std::exp(_tmp100 * fh1 + _tmp103 * fh1 +
                        _tmp104 * _tmp76 * (_tmp107 * _tmp66 - _tmp108 * _tmp86) + _tmp94 * fh1);
  _res(2, 0) =
      -(_tmp109 + _tmp110 - _tmp111 * _tmp70) *
      std::exp(_tmp104 * _tmp108 * _tmp44 - _tmp109 * fh1 - _tmp110 * fh1 + _tmp112 * _tmp70);
  _res(3, 0) = -(_tmp111 + _tmp113 + _tmp114) *
               std::exp(-_tmp104 * _tmp107 - _tmp112 - _tmp113 * fh1 - _tmp114 * fh1);
