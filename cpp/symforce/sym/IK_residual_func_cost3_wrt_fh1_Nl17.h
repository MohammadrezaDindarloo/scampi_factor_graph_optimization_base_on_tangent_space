...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl17(
  ...
  const Scalar _tmp27 = Scalar(0.20999999999999999) * _tmp21 + Scalar(0.20999999999999999) * _tmp9;
  const Scalar _tmp28 =
      -Scalar(0.010999999999999999) * _tmp11 - Scalar(0.010999999999999999) * _tmp12;
  const Scalar _tmp29 = -_tmp27 + _tmp28;
  const Scalar _tmp30 = _tmp26 + _tmp29;
  const Scalar _tmp31 = _tmp30 + position_vector(0, 0) + Scalar(1.79662371);
  ...
  const Scalar _tmp37 = _tmp36 + position_vector(1, 0) + Scalar(8.3888750099999996);
  ...
  const Scalar _tmp48 = -_tmp33 * _tmp44 + _tmp46 * _tmp47;
  const Scalar _tmp49 = Scalar(1.0) / (_tmp33 * _tmp43 - _tmp47);
  const Scalar _tmp50 = _tmp33 * _tmp49;
  const Scalar _tmp51 = Scalar(1.0) * _tmp30;
  const Scalar _tmp52 = Scalar(1.0) * _tmp24;
  const Scalar _tmp53 = (-_tmp40 + _tmp51) / (_tmp36 - _tmp52);
  const Scalar _tmp54 = -_tmp43 * _tmp46 + _tmp44;
  const Scalar _tmp55 = -_tmp15 + _tmp50 * _tmp54 - _tmp53 * (_tmp34 + _tmp48 * _tmp50);
  const Scalar _tmp56 = _tmp14 + _tmp45;
  const Scalar _tmp57 = _tmp19 + _tmp35;
  const Scalar _tmp58 = _tmp57 + position_vector(1, 0) + Scalar(8.3196563700000006);
  const Scalar _tmp59 = _tmp29 + _tmp38;
  const Scalar _tmp60 = _tmp59 + position_vector(0, 0) + Scalar(1.9874742000000001);
  ...
  const Scalar _tmp64 = _tmp33 * _tmp63 - _tmp62;
  const Scalar _tmp65 = _tmp49 * _tmp64;
  const Scalar _tmp66 = _tmp15 * _tmp63 -
                        _tmp53 * (-_tmp34 * _tmp63 - _tmp48 * _tmp65 + _tmp56 * _tmp62) -
                        _tmp54 * _tmp65 - _tmp56 * _tmp63;
  const Scalar _tmp67 = Scalar(1.0) / (_tmp66);
  const Scalar _tmp68 =
      std::sqrt(Scalar(std::pow(_tmp25, Scalar(2)) + std::pow(_tmp31, Scalar(2))));
  const Scalar _tmp69 = Scalar(1.0) / (_tmp68);
  const Scalar _tmp70 = _tmp32 * _tmp68;
  const Scalar _tmp71 = _tmp70 * (-_tmp24 * _tmp31 * _tmp69 + _tmp25 * _tmp30 * _tmp69);
  const Scalar _tmp72 = _tmp36 * _tmp43 - _tmp40 * _tmp47 + _tmp43 * _tmp71;
  const Scalar _tmp73 = _tmp57 * _tmp63 - _tmp59 * _tmp62 + _tmp63 * _tmp71 - _tmp65 * _tmp72;
  const Scalar _tmp74 = _tmp67 * _tmp73;
  const Scalar _tmp75 = Scalar(1.0) / (_tmp73);
  const Scalar _tmp76 = _tmp66 * _tmp75;
  const Scalar _tmp77 = _tmp55 + _tmp76 * (_tmp50 * _tmp72 - _tmp55 * _tmp74 - _tmp71);
  const Scalar _tmp78 = _tmp64 * _tmp67;
  const Scalar _tmp79 = -_tmp33 - _tmp77 * _tmp78;
  const Scalar _tmp80 = _tmp43 * _tmp49;
  const Scalar _tmp81 = _tmp63 * _tmp67;
  const Scalar _tmp82 = _tmp26 + _tmp39;
  const Scalar _tmp83 = _tmp82 + position_vector(0, 0) + Scalar(-2.71799795);
  const Scalar _tmp84 = _tmp18 + _tmp23;
  ...
  const Scalar _tmp88 = _tmp70 * _tmp87 * (_tmp77 * _tmp81 + _tmp79 * _tmp80 + Scalar(1.0));
  const Scalar _tmp89 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp90 = _tmp51 + _tmp52 * _tmp53;
  ...
  const Scalar _tmp95 = _tmp48 * _tmp53 * _tmp94 - _tmp54 * _tmp94;
  ...
  const Scalar _tmp99 = _tmp70 * _tmp98 * (_tmp80 * _tmp97 + _tmp81 * _tmp96);
  const Scalar _tmp100 = _tmp82 * _tmp98 - _tmp84 * _tmp87;
  const Scalar _tmp101 = Scalar(1.0) * _tmp75;
  const Scalar _tmp102 = _tmp100 * _tmp70 * (-_tmp101 * _tmp43 * _tmp65 + _tmp101 * _tmp63);
  const Scalar _tmp103 = _tmp49 * _tmp97 * _tmp98;
  const Scalar _tmp104 = _tmp100 * _tmp101;
  const Scalar _tmp105 = _tmp104 * fh1;
  const Scalar _tmp106 = _tmp49 * _tmp79 * _tmp87;
  const Scalar _tmp107 = _tmp67 * _tmp77 * _tmp87;
  const Scalar _tmp108 = _tmp67 * _tmp96 * _tmp98;
  ...
  _res(1, 0) = -(-_tmp102 - _tmp88 - _tmp99) *
               std::exp(_tmp102 * fh1 + _tmp70 * _tmp89 * (_tmp63 * _tmp92 - _tmp80 * _tmp93) +
                        _tmp88 * fh1 + _tmp99 * fh1);
  _res(2, 0) =
      -(_tmp103 - _tmp104 * _tmp65 + _tmp106) *
      std::exp(-_tmp103 * fh1 + _tmp105 * _tmp65 - _tmp106 * fh1 + _tmp49 * _tmp89 * _tmp93);
  _res(3, 0) = -(_tmp104 + _tmp107 + _tmp108) *
               std::exp(-_tmp105 - _tmp107 * fh1 - _tmp108 * fh1 - _tmp89 * _tmp92);
