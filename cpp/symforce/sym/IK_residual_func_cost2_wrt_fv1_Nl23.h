...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2WrtFv1Nl23(
  ...
  const Scalar _tmp50 = _tmp23 + _tmp24 + _tmp29;
  ...
  const Scalar _tmp61 = _tmp38 * _tmp43;
  const Scalar _tmp62 = -_tmp44 * _tmp58 + _tmp60 * _tmp61;
  const Scalar _tmp63 = Scalar(1.0) / (_tmp44 * _tmp57 - _tmp61);
  ...
  const Scalar _tmp84 = _tmp57 * _tmp83 - _tmp82;
  const Scalar _tmp85 = _tmp63 * _tmp84;
  const Scalar _tmp86 = _tmp49 * _tmp83;
  const Scalar _tmp87 = -_tmp57 * _tmp86 - _tmp62 * _tmp85 + _tmp74 * _tmp82;
  const Scalar _tmp88 = -_tmp70 * _tmp87 - _tmp71 * _tmp85 - _tmp74 * _tmp83 + _tmp86;
  ...
  const Scalar _tmp93 = _tmp92 * (-_tmp50 * _tmp55 * _tmp91 + _tmp52 * _tmp53 * _tmp91);
  const Scalar _tmp94 = _tmp36 * _tmp44 - _tmp40 * _tmp61 + _tmp44 * _tmp93;
  ...
  const Scalar _tmp102 = _tmp67 + _tmp75;
  const Scalar _tmp103 = _tmp102 * _tmp70;
  const Scalar _tmp104 = Scalar(1.0) / (-_tmp103 + _tmp69 - _tmp78);
  ...
  const Scalar _tmp110 = _tmp21 + Scalar(1.79662371);
  ...
  const Scalar _tmp115 = _tmp108 * _tmp98;
  const Scalar _tmp116 = _tmp102 * _tmp115 - _tmp114 * _tmp87;
  const Scalar _tmp117 = _tmp110 * _tmp111;
  const Scalar _tmp118 = fh1 * (_tmp112 * _tmp20 - _tmp117 * _tmp31);
  const Scalar _tmp119 = fh1 * (_tmp45 + _tmp73);
  const Scalar _tmp120 = -_tmp112 * _tmp119 - Scalar(5.1796800000000003) * _tmp27 - _tmp31 * fv1;
  const Scalar _tmp121 = _tmp68 * (_tmp103 * _tmp108 + Scalar(1.0));
  const Scalar _tmp122 = _tmp108 * _tmp70;
  const Scalar _tmp123 = -Scalar(1.0) * _tmp121 + Scalar(1.0) * _tmp122;
  const Scalar _tmp124 = _tmp57 * _tmp63;
  const Scalar _tmp125 = _tmp124 * _tmp62 + _tmp58;
  const Scalar _tmp126 = _tmp124 * _tmp71 - _tmp125 * _tmp70 - _tmp49;
  const Scalar _tmp127 = _tmp98 * (_tmp124 * _tmp94 - _tmp126 * _tmp96 - _tmp93);
  const Scalar _tmp128 = _tmp126 + _tmp127;
  const Scalar _tmp129 = -_tmp101 * _tmp128 + _tmp105 * _tmp127 + _tmp125;
  const Scalar _tmp130 = _tmp117 * fh1;
  const Scalar _tmp131 = _tmp117 * _tmp119 + Scalar(5.1796800000000003) * _tmp14 + _tmp20 * fv1;
  const Scalar _tmp132 = _tmp102 * _tmp68;
  const Scalar _tmp133 = Scalar(1.0) * _tmp108 * _tmp132 - Scalar(1.0) * _tmp108;
  const Scalar _tmp134 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp135 = _tmp66 * _tmp70 + _tmp69;
  const Scalar _tmp136 = _tmp104 * _tmp135;
  const Scalar _tmp137 = 0;
  const Scalar _tmp138 = _tmp68 * (-_tmp102 * _tmp136 - _tmp137 * _tmp87 + _tmp67);
  ...
  const Scalar _tmp141 = _tmp64 * _tmp84 * _tmp97;
  const Scalar _tmp142 = _tmp137 * _tmp85;
  const Scalar _tmp143 = _tmp92 * (_tmp137 * _tmp83 - _tmp142 * _tmp44);
  const Scalar _tmp144 = _tmp84 * _tmp89;
  const Scalar _tmp145 = -_tmp100 * _tmp144 + Scalar(1.0);
  const Scalar _tmp146 = _tmp44 * _tmp63;
  const Scalar _tmp147 = _tmp83 * _tmp89;
  const Scalar _tmp148 = -_tmp128 * _tmp144 - _tmp57;
  const Scalar _tmp149 = -_tmp113 * _tmp92 * (_tmp100 * _tmp147 + _tmp145 * _tmp146) -
                         _tmp118 * _tmp92 * (_tmp114 * _tmp83 - _tmp141 * _tmp44) -
                         _tmp130 * _tmp92 * (_tmp128 * _tmp147 + _tmp146 * _tmp148 + Scalar(1.0)) -
                         _tmp134 * _tmp143;
  ...
  const Scalar _tmp158 = _tmp28 + _tmp35;
  const Scalar _tmp159 =
      (-_tmp140 * _tmp157 + _tmp150 * (_tmp123 * _tmp158 + _tmp133 * _tmp20 - _tmp139)) /
  ...
  const Scalar _tmp162 = _tmp108 * _tmp131;
  const Scalar _tmp163 = _tmp106 * _tmp113 * _tmp68 + _tmp116 * _tmp118 * _tmp68 +
                         _tmp120 * _tmp121 + _tmp129 * _tmp130 * _tmp68 - _tmp132 * _tmp162 +
                         _tmp134 * _tmp138;
  const Scalar _tmp164 = _tmp134 * _tmp137;
  const Scalar _tmp165 = _tmp113 * _tmp145 * _tmp63 - _tmp118 * _tmp141 +
                         _tmp130 * _tmp148 * _tmp63 - _tmp164 * _tmp85;
  ...
  const Scalar _tmp177 = _tmp108 * _tmp20;
  const Scalar _tmp178 =
      (-_tmp163 * _tmp176 + _tmp166 * (_tmp121 * _tmp158 - _tmp132 * _tmp177 - _tmp138)) /
      std::sqrt(Scalar(std::pow(_tmp163, Scalar(2)) * _tmp175 + 1));
  const Scalar _tmp179 =
      _tmp100 * _tmp113 * _tmp89 + _tmp114 * _tmp118 + _tmp128 * _tmp130 * _tmp89 + _tmp164;
  const Scalar _tmp180 = Scalar(1.0) / (_tmp179);
  const Scalar _tmp181 = -_tmp104 * _tmp113 * _tmp99 - _tmp104 * _tmp127 * _tmp130 -
                         _tmp115 * _tmp118 - _tmp120 * _tmp122 + _tmp134 * _tmp136 + _tmp162;
  ...
  const Scalar _tmp189 = _tmp137 * _tmp188;
  const Scalar _tmp190 = (_tmp180 * (-_tmp122 * _tmp158 - _tmp136 + _tmp177) + _tmp181 * _tmp189) /
