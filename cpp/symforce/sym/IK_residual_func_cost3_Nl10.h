...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl10(
  ...
  const Scalar _tmp62 = _tmp25 + _tmp46;
  const Scalar _tmp63 = _tmp15 + _tmp42;
  const Scalar _tmp64 = _tmp44 + _tmp63;
  const Scalar _tmp65 = _tmp27 + _tmp62;
  ...
  const Scalar _tmp77 = _tmp52 * (-_tmp40 * _tmp76 + _tmp51 * _tmp74);
  const Scalar _tmp78 = Scalar(1.0) * _tmp33;
  const Scalar _tmp79 = Scalar(1.0) * _tmp36;
  const Scalar _tmp80 = (-_tmp47 + _tmp79) / (_tmp43 - _tmp78);
  const Scalar _tmp81 = _tmp52 * (-_tmp50 * _tmp74 + _tmp76);
  const Scalar _tmp82 = Scalar(1.0) * _tmp77 * _tmp80 - Scalar(1.0) * _tmp81;
  const Scalar _tmp83 = _tmp70 + _tmp71 + _tmp72;
  const Scalar _tmp84 = _tmp30 * _tmp75;
  const Scalar _tmp85 = -_tmp30 * _tmp83 - _tmp41 * _tmp81 -
                        _tmp80 * (_tmp31 * _tmp83 - _tmp40 * _tmp84 - _tmp41 * _tmp77) + _tmp84;
  const Scalar _tmp86 = Scalar(1.0) / (_tmp85);
  const Scalar _tmp87 = _tmp58 * _tmp86;
  const Scalar _tmp88 = _tmp59 * _tmp85;
  const Scalar _tmp89 = _tmp82 + _tmp88 * (-Scalar(1.0) * _tmp57 - _tmp82 * _tmp87);
  const Scalar _tmp90 = _tmp41 * _tmp86;
  const Scalar _tmp91 = -_tmp89 * _tmp90 + Scalar(1.0);
  const Scalar _tmp92 = _tmp30 * _tmp86;
  const Scalar _tmp93 = _tmp55 * fh1;
  const Scalar _tmp94 = _tmp40 * _tmp81 - _tmp75 - _tmp80 * (_tmp40 * _tmp75 + _tmp40 * _tmp77);
  const Scalar _tmp95 = _tmp88 * (_tmp40 * _tmp57 - _tmp56 - _tmp87 * _tmp94) + _tmp94;
  const Scalar _tmp96 = -_tmp40 - _tmp90 * _tmp95;
  const Scalar _tmp97 = Scalar(333.54000000000002) - fv1;
  const Scalar _tmp98 = _tmp78 * _tmp80 + _tmp79;
  const Scalar _tmp99 = 0;
  const Scalar _tmp100 = _tmp86 * _tmp99;
  const Scalar _tmp101 = _tmp90 * _tmp99;
  const Scalar _tmp102 = _tmp52 * fh1;
  const Scalar _tmp103 = _tmp60 * _tmp69;
  const Scalar _tmp104 = _tmp86 * fh1;

  // Output terms (1)
  Eigen::Matrix<Scalar, 4, 1> _res;

  _res(0, 0) = std::exp(-fh1);
  _res(1, 0) = std::exp(_tmp55 * _tmp69 * (_tmp30 * _tmp60 - _tmp41 * _tmp60 * _tmp61) +
                        _tmp55 * _tmp97 * (_tmp100 * _tmp30 - _tmp101 * _tmp61) +
                        _tmp67 * _tmp93 * (_tmp61 * _tmp91 + _tmp89 * _tmp92) +
                        _tmp68 * _tmp93 * (_tmp61 * _tmp96 + _tmp92 * _tmp95 + Scalar(1.0)));
  _res(2, 0) = std::exp(_tmp101 * _tmp52 * _tmp97 - _tmp102 * _tmp67 * _tmp91 -
                        _tmp102 * _tmp68 * _tmp96 + _tmp103 * _tmp41 * _tmp52);
  _res(3, 0) =
      std::exp(-_tmp100 * _tmp97 - _tmp103 - _tmp104 * _tmp67 * _tmp89 - _tmp104 * _tmp68 * _tmp95);
