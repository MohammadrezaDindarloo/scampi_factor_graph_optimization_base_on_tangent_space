...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl23(
  ...
  const Scalar _tmp48 = Scalar(1.0) / (_tmp39 * _tmp47 - _tmp46);
  const Scalar _tmp49 =
      std::sqrt(Scalar(std::pow(_tmp34, Scalar(2)) + std::pow(_tmp37, Scalar(2))));
  const Scalar _tmp50 = Scalar(1.0) / (_tmp49);
  const Scalar _tmp51 = _tmp38 * _tmp49;
  const Scalar _tmp52 = _tmp51 * (-_tmp33 * _tmp37 * _tmp50 + _tmp34 * _tmp36 * _tmp50);
  const Scalar _tmp53 = _tmp48 * (_tmp41 * _tmp47 - _tmp43 * _tmp46 + _tmp47 * _tmp52);
  const Scalar _tmp54 = -_tmp17 * _tmp30 + _tmp26 * _tmp31 + _tmp31 * _tmp52 - _tmp40 * _tmp53;
  const Scalar _tmp55 = Scalar(1.0) / (_tmp54);
  const Scalar _tmp56 = Scalar(1.0) * _tmp55;
  const Scalar _tmp57 = _tmp47 * _tmp48;
  const Scalar _tmp58 = _tmp40 * _tmp57;
  const Scalar _tmp59 = _tmp16 + _tmp8;
  const Scalar _tmp60 = _tmp19 + _tmp32;
  const Scalar _tmp61 = _tmp60 + position_vector(1, 0) + Scalar(-4.8333311099999996);
  const Scalar _tmp62 = _tmp59 + position_vector(0, 0) + Scalar(1.79662371);
  ...
  const Scalar _tmp76 = _tmp48 * (-_tmp39 * _tmp74 + _tmp46 * _tmp75);
  const Scalar _tmp77 = _tmp31 * _tmp73;
  const Scalar _tmp78 = Scalar(1.0) * _tmp33;
  const Scalar _tmp79 = Scalar(1.0) * _tmp36;
  const Scalar _tmp80 = (-_tmp43 + _tmp79) / (_tmp41 - _tmp78);
  const Scalar _tmp81 = _tmp48 * (-_tmp47 * _tmp75 + _tmp74);
  const Scalar _tmp82 = -_tmp31 * _tmp72 - _tmp40 * _tmp81 + _tmp77 -
                        _tmp80 * (_tmp30 * _tmp72 - _tmp39 * _tmp77 - _tmp40 * _tmp76);
  const Scalar _tmp83 = Scalar(1.0) / (_tmp82);
  const Scalar _tmp84 = _tmp78 * _tmp80 + _tmp79;
  const Scalar _tmp85 = 0;
  const Scalar _tmp86 = _tmp51 * (_tmp31 * _tmp85 - _tmp58 * _tmp85);
  const Scalar _tmp87 = Scalar(1.0) * _tmp76 * _tmp80 - Scalar(1.0) * _tmp81;
  const Scalar _tmp88 = _tmp54 * _tmp83;
  const Scalar _tmp89 = _tmp55 * _tmp82;
  const Scalar _tmp90 = _tmp87 + _tmp89 * (-Scalar(1.0) * _tmp53 - _tmp87 * _tmp88);
  const Scalar _tmp91 = _tmp40 * _tmp83;
  const Scalar _tmp92 = -_tmp90 * _tmp91 + Scalar(1.0);
  const Scalar _tmp93 = _tmp31 * _tmp83;
  const Scalar _tmp94 = _tmp51 * fh1;
  const Scalar _tmp95 = _tmp39 * _tmp81 - _tmp73 - _tmp80 * (_tmp39 * _tmp73 + _tmp39 * _tmp76);
  const Scalar _tmp96 = _tmp89 * (_tmp39 * _tmp53 - _tmp52 - _tmp88 * _tmp95) + _tmp95;
  const Scalar _tmp97 = -_tmp39 - _tmp91 * _tmp96;
  const Scalar _tmp98 = _tmp48 * fh1;
  const Scalar _tmp99 = _tmp56 * _tmp66;
  const Scalar _tmp100 = _tmp40 * _tmp48;
  ...
  _res(0, 0) = 0;
  _res(1, 0) =
      -_tmp86 * std::exp(_tmp51 * _tmp66 * (_tmp31 * _tmp56 - _tmp56 * _tmp58) +
                         _tmp64 * _tmp94 * (_tmp57 * _tmp92 + _tmp90 * _tmp93) +
                         _tmp65 * _tmp94 * (_tmp57 * _tmp97 + _tmp93 * _tmp96 + Scalar(1.0)) +
                         _tmp67 * _tmp86);
  _res(2, 0) = -_tmp100 * _tmp85 *
               std::exp(_tmp100 * _tmp101 + _tmp100 * _tmp99 - _tmp64 * _tmp92 * _tmp98 -
                        _tmp65 * _tmp97 * _tmp98);
  _res(3, 0) =
      _tmp85 * std::exp(-_tmp101 - _tmp102 * _tmp64 * _tmp90 - _tmp102 * _tmp65 * _tmp96 - _tmp99);
