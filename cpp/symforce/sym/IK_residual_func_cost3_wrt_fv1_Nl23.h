...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl23(
  ...
  const Scalar _tmp36 = _tmp19 + _tmp26;
  ...
  const Scalar _tmp50 = _tmp39 * _tmp48 - _tmp49;
  const Scalar _tmp51 = _tmp18 * _tmp30;
  const Scalar _tmp52 = Scalar(1.0) / (_tmp31 * _tmp39 - _tmp51);
  ...
  const Scalar _tmp56 = _tmp38 * _tmp54;
  const Scalar _tmp57 = _tmp56 * (-_tmp33 * _tmp37 * _tmp55 + _tmp35 * _tmp36 * _tmp55);
  const Scalar _tmp58 = _tmp52 * (_tmp16 * _tmp31 - _tmp27 * _tmp51 + _tmp31 * _tmp57);
  const Scalar _tmp59 = _tmp41 * _tmp48 - _tmp44 * _tmp49 + _tmp48 * _tmp57 - _tmp50 * _tmp58;
  const Scalar _tmp60 = Scalar(1.0) / (_tmp59);
  const Scalar _tmp61 = Scalar(1.0) * _tmp60;
  const Scalar _tmp62 = _tmp19 + _tmp43;
  const Scalar _tmp63 = _tmp32 + _tmp40;
  const Scalar _tmp64 = _tmp34 + _tmp63;
  const Scalar _tmp65 = _tmp45 + _tmp62;
  ...
  const Scalar _tmp71 = _tmp31 * _tmp52;
  const Scalar _tmp72 = Scalar(1.0) * _tmp33;
  const Scalar _tmp73 = Scalar(1.0) * _tmp36;
  const Scalar _tmp74 = (-_tmp27 + _tmp73) / (_tmp16 - _tmp72);
  const Scalar _tmp75 = _tmp72 * _tmp74 + _tmp73;
  const Scalar _tmp76 = 0;
  const Scalar _tmp77 = Scalar(0.20999999999999999) * _tmp10 + Scalar(0.20999999999999999) * _tmp9;
  const Scalar _tmp78 = -_tmp77;
  const Scalar _tmp79 =
      -Scalar(0.010999999999999999) * _tmp12 - Scalar(0.010999999999999999) * _tmp21;
  const Scalar _tmp80 = Scalar(0.20999999999999999) * _tmp23 - Scalar(0.20999999999999999) * _tmp24;
  const Scalar _tmp81 = _tmp79 + _tmp80;
  const Scalar _tmp82 = _tmp78 + _tmp81;
  const Scalar _tmp83 = _tmp77 + _tmp81;
  const Scalar _tmp84 = _tmp31 * _tmp83;
  const Scalar _tmp85 = -_tmp31 * _tmp82 + _tmp84;
  const Scalar _tmp86 = _tmp78 + _tmp79 - _tmp80;
  const Scalar _tmp87 = -_tmp39 * _tmp84 + _tmp51 * _tmp82;
  const Scalar _tmp88 = _tmp48 * _tmp83;
  const Scalar _tmp89 = -_tmp48 * _tmp86 - _tmp53 * _tmp85 -
                        _tmp74 * (-_tmp39 * _tmp88 + _tmp49 * _tmp86 - _tmp53 * _tmp87) + _tmp88;
  const Scalar _tmp90 = Scalar(1.0) / (_tmp89);
  const Scalar _tmp91 = _tmp50 * _tmp90;
  const Scalar _tmp92 = _tmp76 * _tmp91;
  const Scalar _tmp93 = _tmp76 * _tmp90;
  const Scalar _tmp94 = _tmp56 * (_tmp48 * _tmp93 - _tmp71 * _tmp92);
  const Scalar _tmp95 = _tmp52 * _tmp87;
  const Scalar _tmp96 = _tmp52 * _tmp85;
  const Scalar _tmp97 = Scalar(1.0) * _tmp74 * _tmp95 - Scalar(1.0) * _tmp96;
  const Scalar _tmp98 = _tmp59 * _tmp90;
  const Scalar _tmp99 = _tmp60 * _tmp89;
  const Scalar _tmp100 = _tmp97 + _tmp99 * (-Scalar(1.0) * _tmp58 - _tmp97 * _tmp98);
  const Scalar _tmp101 = _tmp48 * _tmp90;
  const Scalar _tmp102 = -_tmp100 * _tmp91 + Scalar(1.0);
  const Scalar _tmp103 = _tmp56 * fh1;
  const Scalar _tmp104 = _tmp39 * _tmp96 - _tmp74 * (_tmp39 * _tmp83 + _tmp39 * _tmp95) - _tmp83;
  const Scalar _tmp105 = _tmp104 + _tmp99 * (-_tmp104 * _tmp98 + _tmp39 * _tmp58 - _tmp57);
  const Scalar _tmp106 = -_tmp105 * _tmp91 - _tmp39;
  const Scalar _tmp107 = _tmp52 * fh1;
  const Scalar _tmp108 = _tmp52 * _tmp92;
  const Scalar _tmp109 = _tmp61 * _tmp69;
  const Scalar _tmp110 = _tmp90 * fh1;
  ...
  _res(1, 0) =
      -_tmp94 *
      std::exp(_tmp103 * _tmp67 * (_tmp100 * _tmp101 + _tmp102 * _tmp71) +
               _tmp103 * _tmp68 * (_tmp101 * _tmp105 + _tmp106 * _tmp71 + Scalar(1.0)) +
               _tmp56 * _tmp69 * (-_tmp31 * _tmp53 * _tmp61 + _tmp48 * _tmp61) + _tmp70 * _tmp94);
  _res(2, 0) = -_tmp108 * std::exp(-_tmp102 * _tmp107 * _tmp67 - _tmp106 * _tmp107 * _tmp68 +
                                   _tmp108 * _tmp70 + _tmp109 * _tmp53);
  _res(3, 0) = _tmp93 * std::exp(-_tmp100 * _tmp110 * _tmp67 - _tmp105 * _tmp110 * _tmp68 -
                                 _tmp109 - _tmp70 * _tmp93);
