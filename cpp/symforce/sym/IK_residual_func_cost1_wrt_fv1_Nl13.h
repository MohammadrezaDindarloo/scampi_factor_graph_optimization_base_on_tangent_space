...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1WrtFv1Nl13(
  ...
  const Scalar _tmp41 = _tmp24 + _tmp37;
  ...
  const Scalar _tmp52 = -Scalar(0.010999999999999999) * _tmp23 -
                        Scalar(0.010999999999999999) * _tmp5 + Scalar(-0.010999999999999999);
  const Scalar _tmp53 = Scalar(0.20999999999999999) * _tmp11 - Scalar(0.20999999999999999) * _tmp14;
  const Scalar _tmp54 = _tmp52 - _tmp53;
  const Scalar _tmp55 = _tmp51 + _tmp54;
  const Scalar _tmp56 = _tmp38 + position_vector(1, 0);
  const Scalar _tmp57 = _tmp56 + Scalar(8.3196563700000006);
  const Scalar _tmp58 = _tmp46 + position_vector(0, 0);
  ...
  const Scalar _tmp71 = _tmp52 + _tmp53;
  const Scalar _tmp72 = _tmp51 + _tmp71;
  const Scalar _tmp73 = _tmp65 * _tmp69;
  const Scalar _tmp74 = _tmp61 * _tmp70 - _tmp73;
  const Scalar _tmp75 = _tmp41 + position_vector(1, 0);
  ...
  const Scalar _tmp82 = Scalar(1.0) / (_tmp61 * _tmp81 - _tmp80);
  const Scalar _tmp83 = _tmp50 + _tmp54;
  const Scalar _tmp84 = _tmp82 * (-_tmp62 * _tmp81 + _tmp80 * _tmp83);
  const Scalar _tmp85 = -_tmp62 * _tmp70 + _tmp72 * _tmp73 - _tmp74 * _tmp84;
  const Scalar _tmp86 = _tmp82 * (_tmp55 * _tmp81 - _tmp81 * _tmp83);
  const Scalar _tmp87 = -_tmp48 * _tmp85 + _tmp55 * _tmp70 - _tmp70 * _tmp72 - _tmp74 * _tmp86;
  ...
  const Scalar _tmp94 = _tmp93 * (_tmp70 * _tmp89 - _tmp89 * _tmp91);
  const Scalar _tmp95 = Scalar(1.0) * _tmp84;
  const Scalar _tmp96 = _tmp48 * _tmp95 - Scalar(1.0) * _tmp86;
  const Scalar _tmp97 = Scalar(1.0) / (_tmp92);
  const Scalar _tmp98 = _tmp93 * (-_tmp38 * _tmp59 * _tmp97 + _tmp46 * _tmp57 * _tmp97);
  const Scalar _tmp99 = _tmp82 * (_tmp41 * _tmp81 - _tmp44 * _tmp80 + _tmp81 * _tmp98);
  const Scalar _tmp100 = _tmp63 * _tmp70 - _tmp66 * _tmp73 + _tmp70 * _tmp98 - _tmp74 * _tmp99;
  const Scalar _tmp101 = _tmp100 * _tmp88;
  const Scalar _tmp102 = Scalar(1.0) / (_tmp100);
  const Scalar _tmp103 = _tmp102 * _tmp87;
  const Scalar _tmp104 = _tmp103 * (-_tmp101 * _tmp96 - Scalar(1.0) * _tmp99);
  const Scalar _tmp105 = _tmp104 + _tmp96;
  const Scalar _tmp106 = _tmp70 * _tmp88;
  const Scalar _tmp107 = _tmp74 * _tmp88;
  const Scalar _tmp108 = -_tmp105 * _tmp107 + Scalar(1.0);
  const Scalar _tmp109 = _tmp33 + Scalar(-4.7752063900000001);
  ...
  const Scalar _tmp114 = _tmp61 * _tmp84 + _tmp62;
  const Scalar _tmp115 = -_tmp114 * _tmp48 - _tmp55 + _tmp61 * _tmp86;
  const Scalar _tmp116 = _tmp103 * (-_tmp101 * _tmp115 + _tmp61 * _tmp99 - _tmp98);
  const Scalar _tmp117 = _tmp115 + _tmp116;
  const Scalar _tmp118 = -_tmp107 * _tmp117 - _tmp61;
  const Scalar _tmp119 = _tmp110 * _tmp111;
  const Scalar _tmp120 = _tmp119 * fh1;
  const Scalar _tmp121 = Scalar(1.0) * _tmp102;
  const Scalar _tmp122 = fh1 * (_tmp112 * _tmp21 - _tmp119 * _tmp32);
  const Scalar _tmp123 = -_tmp113 * _tmp93 * (_tmp105 * _tmp106 + _tmp108 * _tmp90) -
                         _tmp120 * _tmp93 * (_tmp106 * _tmp117 + _tmp118 * _tmp90 + Scalar(1.0)) -
                         _tmp122 * _tmp93 * (_tmp121 * _tmp70 - _tmp121 * _tmp91) - _tmp34 * _tmp94;
  const Scalar _tmp124 = Scalar(1.0) / (_tmp123);
  const Scalar _tmp125 = fh1 * (_tmp50 + _tmp71);
  const Scalar _tmp126 = _tmp119 * _tmp125 + Scalar(5.1796800000000003) * _tmp15 + _tmp21 * fv1;
  const Scalar _tmp127 = _tmp40 + _tmp63;
  const Scalar _tmp128 = _tmp127 * _tmp48;
  const Scalar _tmp129 = Scalar(1.0) / (-_tmp128 + _tmp47 - _tmp66);
  const Scalar _tmp130 = Scalar(1.0) * _tmp129;
  const Scalar _tmp131 = _tmp127 * _tmp130;
  const Scalar _tmp132 = -Scalar(1.0) * _tmp130 + Scalar(1.0) * _tmp131 * _tmp42;
  const Scalar _tmp133 = -_tmp112 * _tmp125 - Scalar(5.1796800000000003) * _tmp27 - _tmp32 * fv1;
  const Scalar _tmp134 = _tmp130 * _tmp48;
  const Scalar _tmp135 = _tmp42 * (_tmp128 * _tmp130 + Scalar(1.0));
  ...
  const Scalar _tmp141 = _tmp103 * _tmp130;
  const Scalar _tmp142 = _tmp103 * _tmp131 - _tmp121 * _tmp85;
  const Scalar _tmp143 = _tmp104 * _tmp138 - _tmp105 * _tmp137 - _tmp95;
  const Scalar _tmp144 = _tmp129 * _tmp49;
  const Scalar _tmp145 = _tmp42 * (-_tmp127 * _tmp144 + _tmp40 - _tmp85 * _tmp89);
  const Scalar _tmp146 = -Scalar(1.0) * _tmp130 * _tmp49 - Scalar(1.0) * _tmp145 + Scalar(1.0);
  const Scalar _tmp147 = Scalar(1.0) * _tmp113 * (_tmp104 * _tmp130 - _tmp140 * _tmp143) +
                         Scalar(1.0) * _tmp120 * (_tmp116 * _tmp130 - _tmp139 * _tmp140) +
                         Scalar(1.0) * _tmp122 * (-_tmp140 * _tmp142 + _tmp141) +
                         _tmp126 * _tmp132 + _tmp133 * _tmp136 + _tmp146 * _tmp34;
  ...
  const Scalar _tmp157 = _tmp28 + _tmp35 + _tmp36;
  const Scalar _tmp158 =
      (_tmp124 * (_tmp132 * _tmp21 + _tmp136 * _tmp157 - _tmp146) - _tmp147 * _tmp156) /
      std::sqrt(Scalar(std::pow(_tmp147, Scalar(2)) * _tmp155 + 1));
  const Scalar _tmp159 = _tmp126 * _tmp130;
  const Scalar _tmp160 = _tmp127 * _tmp42;
  const Scalar _tmp161 = _tmp113 * _tmp143 * _tmp42 + _tmp120 * _tmp139 * _tmp42 +
                         _tmp122 * _tmp142 * _tmp42 + _tmp133 * _tmp135 + _tmp145 * _tmp34 -
                         _tmp159 * _tmp160;
  const Scalar _tmp162 = _tmp121 * _tmp122;
  const Scalar _tmp163 = _tmp74 * _tmp82;
  const Scalar _tmp164 = _tmp34 * _tmp89;
  const Scalar _tmp165 = _tmp108 * _tmp113 * _tmp82 + _tmp118 * _tmp120 * _tmp82 -
  ...
  const Scalar _tmp176 = _tmp130 * _tmp21;
  const Scalar _tmp177 = _tmp163 * _tmp175 * _tmp89;
  const Scalar _tmp178 =
      (-_tmp161 * _tmp177 + _tmp166 * (_tmp135 * _tmp157 - _tmp145 - _tmp160 * _tmp176)) /
      std::sqrt(Scalar(std::pow(_tmp161, Scalar(2)) * _tmp175 + 1));
  const Scalar _tmp179 =
      _tmp105 * _tmp113 * _tmp88 + _tmp117 * _tmp120 * _tmp88 + _tmp162 + _tmp164;
  const Scalar _tmp180 = std::pow(_tmp179, Scalar(-2));
  const Scalar _tmp181 = _tmp180 * _tmp89;
  const Scalar _tmp182 = Scalar(1.0) / (_tmp179);
  const Scalar _tmp183 = -_tmp104 * _tmp113 * _tmp129 - _tmp116 * _tmp120 * _tmp129 -
                         _tmp122 * _tmp141 - _tmp133 * _tmp134 + _tmp144 * _tmp34 + _tmp159;
  const Scalar _tmp184 = std::asinh(_tmp182 * _tmp183);
  const Scalar _tmp185 = Scalar(1.0) * _tmp184;
  const Scalar _tmp186 = (_tmp181 * _tmp183 + _tmp182 * (-_tmp134 * _tmp157 - _tmp144 + _tmp176)) /
                         std::sqrt(Scalar(_tmp180 * std::pow(_tmp183, Scalar(2)) + 1));
               ...
               (-_tmp1 * _tmp3 -
                Scalar(4.7752063900000001) *
                    std::sqrt(Scalar(
                        ...
                        std::pow(Scalar(1 - Scalar(0.20941503221602112) * _tmp33), Scalar(2)))))));
  _res(1, 0) =
      -_tmp149 *
          (-Scalar(0.87679799772039002) * _tmp156 + Scalar(1.0) * _tmp158 * std::sinh(_tmp153) -
           (-Scalar(0.1034955) * _tmp150 * _tmp156 +
            _tmp151 * (-_tmp148 * _tmp154 - _tmp149 * _tmp158)) *
               std::sinh(_tmp152)) -
      _tmp154 * (Scalar(0.87679799772039002) * _tmp124 - std::cosh(_tmp152) + std::cosh(_tmp153));
  _res(2, 0) =
      -_tmp169 *
          (-Scalar(0.86625939559540499) * _tmp177 + Scalar(1.0) * _tmp178 * std::sinh(_tmp168) -
           (-Scalar(0.1034955) * _tmp170 * _tmp177 +
            _tmp171 * (-_tmp167 * _tmp174 - _tmp169 * _tmp178)) *
               std::sinh(_tmp172)) -
      _tmp174 * (Scalar(0.86625939559540499) * _tmp166 + std::cosh(_tmp168) - std::cosh(_tmp172));
  _res(3, 0) =
      _tmp173 * (Scalar(0.87653584775870996) * _tmp182 + std::cosh(_tmp185) - std::cosh(_tmp190)) -
      _tmp187 *
          (Scalar(0.87653584775870996) * _tmp181 + Scalar(1.0) * _tmp186 * std::sinh(_tmp185) -
           (Scalar(0.1034955) * _tmp181 * _tmp188 +
            _tmp189 * (_tmp173 * _tmp184 - _tmp186 * _tmp187)) *
               std::sinh(_tmp190));
