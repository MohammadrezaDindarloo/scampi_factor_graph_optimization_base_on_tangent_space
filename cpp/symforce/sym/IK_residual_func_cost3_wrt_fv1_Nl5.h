...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl5(
  ...
  const Scalar _tmp101 = _tmp44 * (-_tmp100 * _tmp94 + _tmp31 * _tmp99);
  const Scalar _tmp102 = Scalar(1.0) * _tmp57;
  const Scalar _tmp103 = _tmp102 * _tmp78 * _tmp81 - _tmp102 * _tmp82;
  const Scalar _tmp104 = _tmp103 + _tmp89 * (-_tmp102 * _tmp54 - _tmp103 * _tmp88);
  const Scalar _tmp105 = -_tmp104 * _tmp92 + Scalar(1.0);
  const Scalar _tmp106 = _tmp61 * _tmp69;
  const Scalar _tmp107 = _tmp57 * fh1;
  const Scalar _tmp108 = _tmp100 * _tmp57;
  ...
  _res(1, 0) =
      -_tmp101 *
      std::exp(_tmp101 * _tmp96 + _tmp44 * _tmp69 * (_tmp31 * _tmp61 - _tmp52 * _tmp58 * _tmp61) +
               _tmp67 * _tmp95 * (_tmp104 * _tmp91 + _tmp105 * _tmp94) +
               _tmp68 * _tmp95 * (_tmp90 * _tmp91 + _tmp93 * _tmp94 + Scalar(1.0)));
  _res(2, 0) = -_tmp108 * std::exp(-_tmp105 * _tmp107 * _tmp67 + _tmp106 * _tmp58 -
                                   _tmp107 * _tmp68 * _tmp93 + _tmp108 * _tmp96);
  _res(3, 0) = _tmp99 * std::exp(-_tmp104 * _tmp109 * _tmp67 - _tmp106 - _tmp109 * _tmp68 * _tmp90 -
                                 _tmp96 * _tmp99);
