...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl12(
  ...
  const Scalar _tmp40 = _tmp39 + position_vector(1, 0) + Scalar(8.3196563700000006);
  const Scalar _tmp41 = _tmp20 - _tmp23;
  const Scalar _tmp42 = _tmp19 + _tmp41;
  const Scalar _tmp43 = _tmp42 + position_vector(0, 0) + Scalar(1.9874742000000001);
  const Scalar _tmp44 = Scalar(1.0) / (_tmp43);
  const Scalar _tmp45 = _tmp40 * _tmp44;
  const Scalar _tmp46 = _tmp34 * _tmp45 - _tmp37;
  const Scalar _tmp47 = _tmp28 + _tmp29;
  const Scalar _tmp48 = _tmp38 + _tmp47;
  const Scalar _tmp49 = _tmp48 + position_vector(1, 0) + Scalar(8.3888750099999996);
  const Scalar _tmp50 = _tmp18 + _tmp41;
  ...
  const Scalar _tmp56 = _tmp36 * _tmp45;
  const Scalar _tmp57 = _tmp11 + _tmp14 + _tmp35;
  const Scalar _tmp58 = _tmp55 * (-_tmp53 * _tmp56 + _tmp54 * _tmp57);
  const Scalar _tmp59 = Scalar(1.0) * _tmp39;
  const Scalar _tmp60 = Scalar(1.0) * _tmp42;
  const Scalar _tmp61 = (-_tmp50 + _tmp60) / (_tmp48 - _tmp59);
  const Scalar _tmp62 = _tmp55 * (_tmp36 * _tmp53 - _tmp53 * _tmp57);
  const Scalar _tmp63 = -_tmp16 * _tmp34 + _tmp34 * _tmp36 - _tmp46 * _tmp62 -
                        _tmp61 * (_tmp16 * _tmp37 - _tmp34 * _tmp56 - _tmp46 * _tmp58);
  const Scalar _tmp64 = Scalar(1.0) / (_tmp63);
  const Scalar _tmp65 = _tmp59 * _tmp61 + _tmp60;
  const Scalar _tmp66 = 0;
  const Scalar _tmp67 = _tmp53 * _tmp55;
  ...
  const Scalar _tmp72 = _tmp70 * (-_tmp39 * _tmp43 * _tmp71 + _tmp40 * _tmp42 * _tmp71);
  const Scalar _tmp73 = _tmp55 * (_tmp48 * _tmp53 - _tmp50 * _tmp54 + _tmp53 * _tmp72);
  const Scalar _tmp74 = Scalar(1.0) * _tmp58 * _tmp61 - Scalar(1.0) * _tmp62;
  const Scalar _tmp75 = -_tmp25 * _tmp37 + _tmp31 * _tmp34 + _tmp34 * _tmp72 - _tmp46 * _tmp73;
  const Scalar _tmp76 = _tmp64 * _tmp75;
  const Scalar _tmp77 = Scalar(1.0) / (_tmp75);
  const Scalar _tmp78 = _tmp63 * _tmp77;
  const Scalar _tmp79 = _tmp74 + _tmp78 * (-Scalar(1.0) * _tmp73 - _tmp74 * _tmp76);
  const Scalar _tmp80 = _tmp46 * _tmp64;
  const Scalar _tmp81 = -_tmp79 * _tmp80 + Scalar(1.0);
  const Scalar _tmp82 = _tmp64 * _tmp79;
  const Scalar _tmp83 = _tmp27 + _tmp47;
  const Scalar _tmp84 = _tmp83 + position_vector(1, 0) + Scalar(-4.7752063900000001);
  const Scalar _tmp85 = _tmp18 + _tmp24;
  const Scalar _tmp86 = _tmp85 + position_vector(0, 0) + Scalar(-2.71799795);
  const Scalar _tmp87 = std::pow(Scalar(std::pow(_tmp84, Scalar(2)) + std::pow(_tmp86, Scalar(2))),
                                 Scalar(Scalar(-1) / Scalar(2)));
  const Scalar _tmp88 = _tmp84 * _tmp87;
  const Scalar _tmp89 = _tmp70 * _tmp88 * (_tmp34 * _tmp82 + _tmp67 * _tmp81);
  const Scalar _tmp90 = _tmp86 * _tmp87;
  const Scalar _tmp91 = -_tmp83 * _tmp90 + _tmp85 * _tmp88;
  const Scalar _tmp92 = Scalar(1.0) * _tmp77;
  const Scalar _tmp93 = _tmp70 * _tmp91 * (_tmp34 * _tmp92 - _tmp68 * _tmp92);
  const Scalar _tmp94 = -_tmp36 + _tmp45 * _tmp62 - _tmp61 * (_tmp45 * _tmp58 + _tmp56);
  const Scalar _tmp95 = _tmp78 * (_tmp45 * _tmp73 - _tmp72 - _tmp76 * _tmp94) + _tmp94;
  const Scalar _tmp96 = _tmp64 * _tmp95;
  const Scalar _tmp97 = -_tmp45 - _tmp80 * _tmp95;
  const Scalar _tmp98 = _tmp70 * _tmp90 * (_tmp34 * _tmp96 + _tmp67 * _tmp97 + Scalar(1.0));
  const Scalar _tmp99 = _tmp55 * _tmp81 * _tmp88;
  const Scalar _tmp100 = _tmp0 * _tmp66;
  const Scalar _tmp101 = _tmp46 * _tmp55;
  const Scalar _tmp102 = _tmp91 * _tmp92;
  const Scalar _tmp103 = _tmp102 * fh1;
  const Scalar _tmp104 = _tmp55 * _tmp90 * _tmp97;
  const Scalar _tmp105 = _tmp90 * _tmp96;
  const Scalar _tmp106 = _tmp82 * _tmp88;
  ...
  _res(1, 0) =
      -(-_tmp89 - _tmp93 - _tmp98) * std::exp(_tmp0 * _tmp70 * (_tmp34 * _tmp66 - _tmp66 * _tmp68) +
                                              _tmp89 * fh1 + _tmp93 * fh1 + _tmp98 * fh1);
  _res(2, 0) = -(-_tmp101 * _tmp102 + _tmp104 + _tmp99) *
               std::exp(_tmp100 * _tmp101 + _tmp101 * _tmp103 - _tmp104 * fh1 - _tmp99 * fh1);
  _res(3, 0) =
