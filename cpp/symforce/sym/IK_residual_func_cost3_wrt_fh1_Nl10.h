...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl10(
  ...
  const Scalar _tmp44 = -_tmp16 * _tmp38 + _tmp26 * _tmp29 + _tmp29 * _tmp43;
  ...
  const Scalar _tmp53 = -_tmp29 * _tmp52 + _tmp38 * _tmp50;
  ...
  const Scalar _tmp67 = _tmp37 * _tmp64 - _tmp66;
  const Scalar _tmp68 = _tmp39 * _tmp67;
  const Scalar _tmp69 = _tmp46 + _tmp47 + _tmp48;
  const Scalar _tmp70 = -_tmp56 * (-_tmp37 * _tmp65 - _tmp53 * _tmp68 + _tmp66 * _tmp69) -
                        _tmp57 * _tmp68 - _tmp64 * _tmp69 + _tmp65;
  const Scalar _tmp71 = Scalar(1.0) / (_tmp70);
  const Scalar _tmp72 = _tmp43 * _tmp64 - _tmp44 * _tmp68 + _tmp59 * _tmp64 - _tmp61 * _tmp66;
  const Scalar _tmp73 = _tmp71 * _tmp72;
  const Scalar _tmp74 = Scalar(1.0) / (_tmp72);
  const Scalar _tmp75 = _tmp70 * _tmp74;
  const Scalar _tmp76 = _tmp58 + _tmp75 * (-_tmp44 * _tmp45 - _tmp58 * _tmp73);
  const Scalar _tmp77 = _tmp67 * _tmp71;
  const Scalar _tmp78 = _tmp39 * (-_tmp76 * _tmp77 + Scalar(1.0));
  ...
  const Scalar _tmp82 = _tmp15 + _tmp4;
  ...
  const Scalar _tmp86 = _tmp42 * _tmp85 * (_tmp29 * _tmp78 + _tmp64 * _tmp79);
  const Scalar _tmp87 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp88 = _tmp54 * _tmp56 + _tmp55;
  const Scalar _tmp89 = 0;
  const Scalar _tmp90 = _tmp83 * _tmp84;
  const Scalar _tmp91 = -_tmp80 * _tmp90 + _tmp82 * _tmp85;
  const Scalar _tmp92 = _tmp45 * _tmp67 * _tmp74;
  const Scalar _tmp93 = Scalar(1.0) * _tmp74;
  const Scalar _tmp94 = _tmp42 * _tmp91 * (-_tmp29 * _tmp92 + _tmp64 * _tmp93);
  const Scalar _tmp95 = _tmp37 * _tmp39;
  const Scalar _tmp96 = -_tmp51 - _tmp56 * (_tmp52 + _tmp53 * _tmp95) + _tmp57 * _tmp95;
  const Scalar _tmp97 = _tmp75 * (-_tmp43 + _tmp44 * _tmp95 - _tmp73 * _tmp96) + _tmp96;
  const Scalar _tmp98 = _tmp39 * (-_tmp37 - _tmp77 * _tmp97);
  const Scalar _tmp99 = _tmp71 * _tmp97;
  const Scalar _tmp100 = _tmp42 * _tmp90 * (_tmp29 * _tmp98 + _tmp64 * _tmp99 + Scalar(1.0));
  const Scalar _tmp101 = _tmp87 * _tmp89;
  const Scalar _tmp102 = _tmp90 * _tmp98;
  ...
  const Scalar _tmp107 = _tmp90 * _tmp99;
  ...
  _res(1, 0) =
      -(-_tmp100 - _tmp86 - _tmp94) *
      std::exp(_tmp100 * fh1 + _tmp42 * _tmp87 * (-_tmp29 * _tmp68 * _tmp89 + _tmp64 * _tmp89) +
               _tmp86 * fh1 + _tmp94 * fh1);
  _res(2, 0) = -(_tmp102 - _tmp103 + _tmp104) *
               std::exp(_tmp101 * _tmp68 - _tmp102 * fh1 + _tmp103 * fh1 - _tmp104 * fh1);
