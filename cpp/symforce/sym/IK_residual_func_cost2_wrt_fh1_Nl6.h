...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2WrtFh1Nl6(
  ...
  const Scalar _tmp61 = _tmp26 + _tmp39;
  ...
  const Scalar _tmp71 = _tmp20 + _tmp40;
  ...
  const Scalar _tmp79 = _tmp49 * _tmp65 - _tmp78;
  const Scalar _tmp80 = Scalar(1.0) / (_tmp65 * _tmp76 - _tmp75);
  const Scalar _tmp81 = _tmp79 * _tmp80;
  const Scalar _tmp82 = -_tmp49 * _tmp66 + _tmp55 * _tmp78 - _tmp77 * _tmp81;
  ...
  const Scalar _tmp87 = _tmp86 * (-_tmp71 + _tmp83);
  const Scalar _tmp88 = _tmp57 * _tmp76 - _tmp67 * _tmp76;
  const Scalar _tmp89 = -_tmp49 * _tmp55 + _tmp49 * _tmp57 - _tmp81 * _tmp88 - _tmp82 * _tmp87;
  const Scalar _tmp90 = Scalar(1.0) / (_tmp89);
  const Scalar _tmp91 = Scalar(1.0) * _tmp80;
  ...
  const Scalar _tmp98 = _tmp68 * _tmp76 - _tmp71 * _tmp75 + _tmp76 * _tmp97;
  const Scalar _tmp99 = -_tmp41 * _tmp78 + _tmp45 * _tmp49 + _tmp49 * _tmp97 - _tmp81 * _tmp98;
  const Scalar _tmp100 = _tmp90 * _tmp99;
  const Scalar _tmp101 = Scalar(1.0) / (_tmp99);
  const Scalar _tmp102 = _tmp101 * _tmp89;
  const Scalar _tmp103 = _tmp102 * (-_tmp100 * _tmp93 - _tmp91 * _tmp98);
  ...
  const Scalar _tmp108 = _tmp76 * _tmp80;
  ...
  const Scalar _tmp113 = _tmp112 * _tmp96 * (_tmp105 * _tmp49 + _tmp107 * _tmp108);
  const Scalar _tmp114 = Scalar(333.54000000000002) - fv1;
  const Scalar _tmp115 = _tmp83 + _tmp84 * _tmp87;
  ...
  const Scalar _tmp120 = _tmp112 * _tmp27 - _tmp119 * _tmp17;
  const Scalar _tmp121 = Scalar(1.0) * _tmp101;
  const Scalar _tmp122 = _tmp120 * _tmp96 * (-_tmp118 * _tmp121 + _tmp121 * _tmp49);
  const Scalar _tmp123 = _tmp65 * _tmp80;
  const Scalar _tmp124 = _tmp123 * _tmp77 + _tmp66;
  const Scalar _tmp125 = _tmp123 * _tmp88 - _tmp124 * _tmp87 - _tmp57;
  const Scalar _tmp126 = _tmp102 * (-_tmp100 * _tmp125 + _tmp123 * _tmp98 - _tmp97);
  const Scalar _tmp127 = _tmp125 + _tmp126;
  const Scalar _tmp128 = _tmp127 * _tmp90;
  const Scalar _tmp129 = -_tmp106 * _tmp127 - _tmp65;
  const Scalar _tmp130 = _tmp119 * _tmp96 * (_tmp108 * _tmp129 + _tmp128 * _tmp49 + Scalar(1.0));
  const Scalar _tmp131 = -_tmp113 * fh1 -
                         _tmp114 * _tmp96 * (-_tmp117 * _tmp118 + _tmp117 * _tmp49) -
                         _tmp122 * fh1 - _tmp130 * fh1;
  const Scalar _tmp132 = Scalar(1.0) / (_tmp131);
  const Scalar _tmp133 = _tmp50 + _tmp56;
  const Scalar _tmp134 = _tmp133 * fh1;
  const Scalar _tmp135 = -Scalar(40.024799999999999) * _tmp11 - _tmp112 * _tmp134 - _tmp17 * fv1;
  const Scalar _tmp136 = _tmp45 + _tmp85;
  ...
  const Scalar _tmp142 = _tmp139 * _tmp87;
  const Scalar _tmp143 = -Scalar(1.0) * _tmp140 * _tmp141 + Scalar(1.0) * _tmp142;
  const Scalar _tmp144 = _tmp136 * _tmp138;
  const Scalar _tmp145 = _tmp82 * _tmp90;
  const Scalar _tmp146 = _tmp124 + _tmp126 * _tmp144 - _tmp127 * _tmp145;
  const Scalar _tmp147 = Scalar(1.0) * _tmp119 * (_tmp126 * _tmp139 - _tmp141 * _tmp146);
  const Scalar _tmp148 = _tmp119 * _tmp134 + Scalar(40.024799999999999) * _tmp23 + _tmp27 * fv1;
  const Scalar _tmp149 = _tmp136 * _tmp86;
  const Scalar _tmp150 = Scalar(1.0) * _tmp139 * _tmp149 - Scalar(1.0) * _tmp139;
  const Scalar _tmp151 = _tmp115 * _tmp138;
  const Scalar _tmp152 = -_tmp116 * _tmp145 - _tmp136 * _tmp151 + _tmp85;
  const Scalar _tmp153 = _tmp102 * _tmp139;
  const Scalar _tmp154 = -_tmp121 * _tmp82 + _tmp136 * _tmp153;
  const Scalar _tmp155 = Scalar(1.0) * _tmp120;
  const Scalar _tmp156 = _tmp155 * (-_tmp141 * _tmp154 + _tmp153);
  const Scalar _tmp157 = _tmp103 * _tmp144 - _tmp104 * _tmp145 - _tmp92;
  const Scalar _tmp158 = Scalar(1.0) * _tmp112 * (_tmp103 * _tmp139 - _tmp141 * _tmp157);
  const Scalar _tmp159 =
      Scalar(1.0) * _tmp114 * (-_tmp115 * _tmp139 - _tmp141 * _tmp152 + Scalar(1.0)) +
      _tmp135 * _tmp143 + _tmp147 * fh1 + _tmp148 * _tmp150 + _tmp156 * fh1 + _tmp158 * fh1;
  ...
  const Scalar _tmp163 = _tmp112 * _tmp133;
  const Scalar _tmp164 = _tmp119 * _tmp133;
  const Scalar _tmp165 = -_tmp113 - _tmp122 - _tmp130;
  const Scalar _tmp166 = _tmp162 * _tmp165;
  const Scalar _tmp167 =
      (_tmp132 * (-_tmp143 * _tmp163 + _tmp147 + _tmp150 * _tmp164 + _tmp156 + _tmp158) -
       _tmp159 * _tmp166) /
      std::sqrt(Scalar(std::pow(_tmp159, Scalar(2)) * _tmp162 + 1));
  const Scalar _tmp168 = Scalar(1.4083112389913199) * _tmp131;
  ...
  const Scalar _tmp170 = Scalar(0.71007031138673404) * _tmp132;
  const Scalar _tmp171 = _tmp169 * _tmp170;
  const Scalar _tmp172 = Scalar(1.4083112389913199) * _tmp165;
  const Scalar _tmp173 = _tmp112 * _tmp157 * _tmp86;
  const Scalar _tmp174 = _tmp140 * _tmp86;
  const Scalar _tmp175 = _tmp139 * _tmp148;
  const Scalar _tmp176 = _tmp119 * _tmp86;
  const Scalar _tmp177 = _tmp146 * _tmp176;
  const Scalar _tmp178 = _tmp120 * _tmp154 * _tmp86;
  const Scalar _tmp179 = _tmp114 * _tmp152 * _tmp86 + _tmp135 * _tmp174 - _tmp149 * _tmp175 +
                         _tmp173 * fh1 + _tmp177 * fh1 + _tmp178 * fh1;
  const Scalar _tmp180 = _tmp119 * _tmp129 * _tmp80;
  const Scalar _tmp181 = _tmp101 * _tmp155;
  const Scalar _tmp182 = _tmp181 * fh1;
  const Scalar _tmp183 = _tmp107 * _tmp112 * _tmp80;
  const Scalar _tmp184 = _tmp114 * _tmp117;
  const Scalar _tmp185 = _tmp180 * fh1 - _tmp182 * _tmp81 + _tmp183 * fh1 - _tmp184 * _tmp81;
  const Scalar _tmp186 = Scalar(1.0) / (_tmp185);
  const Scalar _tmp187 = std::asinh(_tmp179 * _tmp186);
  const Scalar _tmp188 = Scalar(1.4083112389913199) * _tmp185;
  ...
  const Scalar _tmp193 = _tmp180 - _tmp181 * _tmp81 + _tmp183;
  const Scalar _tmp194 = _tmp192 * _tmp193;
  const Scalar _tmp195 =
      (-_tmp179 * _tmp194 + _tmp186 * (-_tmp133 * _tmp136 * _tmp139 * _tmp176 - _tmp163 * _tmp174 +
                                       _tmp173 + _tmp177 + _tmp178)) /
      std::sqrt(Scalar(std::pow(_tmp179, Scalar(2)) * _tmp192 + 1));
  const Scalar _tmp196 = Scalar(1.4083112389913199) * _tmp193;
  const Scalar _tmp197 = Scalar(1.0) * _tmp187;
  const Scalar _tmp198 = _tmp105 * _tmp112;
  const Scalar _tmp199 = _tmp119 * _tmp128;
  const Scalar _tmp200 = _tmp182 + _tmp184 + _tmp198 * fh1 + _tmp199 * fh1;
  const Scalar _tmp201 = Scalar(1.0) / (_tmp200);
  const Scalar _tmp202 = _tmp103 * _tmp112 * _tmp138;
  const Scalar _tmp203 = _tmp119 * _tmp126 * _tmp138;
  const Scalar _tmp204 = _tmp120 * _tmp153;
  const Scalar _tmp205 = _tmp114 * _tmp151 - _tmp135 * _tmp142 + _tmp175 - _tmp202 * fh1 -
  ...
  const Scalar _tmp211 =
      (_tmp201 * (_tmp139 * _tmp164 + _tmp142 * _tmp163 - _tmp202 - _tmp203 - _tmp204) -
       _tmp205 * _tmp210) /
      std::sqrt(Scalar(std::pow(_tmp205, Scalar(2)) * _tmp208 + 1));
  const Scalar _tmp212 = Scalar(1.4083112389913199) * _tmp200;
  ...
  const Scalar _tmp214 = Scalar(1.4083112389913199) * _tmp209;
  ...
  _res(1, 0) = _tmp168 * (-Scalar(1.0) * _tmp167 * std::cosh(_tmp161) -
                          (-Scalar(0.71007031138673404) * _tmp166 * _tmp169 +
                           _tmp170 * (-_tmp160 * _tmp172 - _tmp167 * _tmp168)) *
                              std::cosh(_tmp171)) +
               _tmp172 * (-std::sinh(_tmp161) - std::sinh(_tmp171));
  _res(2, 0) = _tmp188 * (-Scalar(1.0) * _tmp195 * std::cosh(_tmp197) -
                          (-Scalar(0.71007031138673404) * _tmp189 * _tmp194 +
                           _tmp190 * (-_tmp187 * _tmp196 - _tmp188 * _tmp195)) *
                              std::cosh(_tmp191)) +
               _tmp196 * (-std::sinh(_tmp191) - std::sinh(_tmp197));
  _res(3, 0) = _tmp212 * (-Scalar(1.0) * _tmp211 * std::cosh(_tmp207) -
                          (-Scalar(0.71007031138673404) * _tmp210 * _tmp213 +
                           _tmp215 * (-_tmp206 * _tmp214 - _tmp211 * _tmp212)) *
                              std::cosh(_tmp216)) +
               _tmp214 * (-std::sinh(_tmp207) - std::sinh(_tmp216));
