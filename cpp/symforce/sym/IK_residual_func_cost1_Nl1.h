...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl1(
  ...
  const Scalar _tmp55 = _tmp40 + _tmp6;
  ...
  const Scalar _tmp60 = _tmp18 + _tmp5;
  ...
  const Scalar _tmp90 = _tmp35 + _tmp87;
  const Scalar _tmp91 = _tmp68 * _tmp90;
  const Scalar _tmp92 = _tmp69 * (-_tmp68 * _tmp89 + _tmp91);
  const Scalar _tmp93 = _tmp69 * (-_tmp58 * _tmp91 + _tmp67 * _tmp89);
  const Scalar _tmp94 = _tmp49 * _tmp90;
  const Scalar _tmp95 = _tmp50 * _tmp88 - _tmp58 * _tmp94 - _tmp59 * _tmp93;
  ...
  const Scalar _tmp100 = _tmp98 * (-_tmp63 + _tmp99);
  const Scalar _tmp101 = -_tmp100 * _tmp95 - _tmp49 * _tmp88 - _tmp59 * _tmp92 + _tmp94;
  const Scalar _tmp102 = Scalar(1.0) / (_tmp101);
  const Scalar _tmp103 = _tmp100 * _tmp96 + _tmp99;
  const Scalar _tmp104 = 0;
  const Scalar _tmp105 = _tmp102 * _tmp104;
  const Scalar _tmp106 = Scalar(1.0) * _tmp93;
  const Scalar _tmp107 = _tmp100 * _tmp106 - Scalar(1.0) * _tmp92;
  const Scalar _tmp108 = _tmp102 * _tmp75;
  const Scalar _tmp109 = _tmp101 * _tmp76;
  const Scalar _tmp110 = _tmp109 * (-_tmp107 * _tmp108 - Scalar(1.0) * _tmp74);
  const Scalar _tmp111 = _tmp107 + _tmp110;
  const Scalar _tmp112 = _tmp102 * _tmp59;
  const Scalar _tmp113 = -_tmp111 * _tmp112 + Scalar(1.0);
  const Scalar _tmp114 = _tmp102 * _tmp49;
  const Scalar _tmp115 = _tmp83 * fh1;
  const Scalar _tmp116 = _tmp58 * _tmp90 + _tmp58 * _tmp93;
  const Scalar _tmp117 = -_tmp100 * _tmp116 + _tmp58 * _tmp92 - _tmp90;
  const Scalar _tmp118 = _tmp109 * (-_tmp108 * _tmp117 + _tmp58 * _tmp74 - _tmp73);
  const Scalar _tmp119 = _tmp117 + _tmp118;
  const Scalar _tmp120 = -_tmp112 * _tmp119 - _tmp58;
  const Scalar _tmp121 = _tmp84 * fh1;
  const Scalar _tmp122 = -_tmp115 * _tmp72 * (_tmp111 * _tmp114 + _tmp113 * _tmp78) -
                         _tmp121 * _tmp72 * (_tmp114 * _tmp119 + _tmp120 * _tmp78 + Scalar(1.0)) -
                         _tmp72 * _tmp85 * (_tmp49 * _tmp77 - _tmp77 * _tmp79) -
                         _tmp72 * _tmp86 * (_tmp105 * _tmp49 - _tmp105 * _tmp79);
  const Scalar _tmp123 = Scalar(1.0) / (_tmp122);
  const Scalar _tmp124 = _tmp102 * _tmp95;
  const Scalar _tmp125 = _tmp41 + _tmp97;
  ...
  const Scalar _tmp129 = _tmp116 + _tmp118 * _tmp128 - _tmp119 * _tmp124;
  const Scalar _tmp130 = Scalar(1.0) * _tmp98;
  const Scalar _tmp131 = Scalar(1.0) * _tmp127;
  const Scalar _tmp132 = _tmp39 * fh1;
  const Scalar _tmp133 = -_tmp132 * _tmp83 - Scalar(40.024799999999999) * _tmp16 - _tmp19 * fv1;
  const Scalar _tmp134 = _tmp98 * (_tmp126 * _tmp131 + Scalar(1.0));
  const Scalar _tmp135 = _tmp100 * _tmp131;
  const Scalar _tmp136 = _tmp109 * _tmp131;
  const Scalar _tmp137 = _tmp125 * _tmp136 - _tmp77 * _tmp95;
  const Scalar _tmp138 = _tmp132 * _tmp84 + Scalar(40.024799999999999) * _tmp26 + _tmp30 * fv1;
  const Scalar _tmp139 = _tmp125 * _tmp98;
  const Scalar _tmp140 = _tmp103 * _tmp127;
  const Scalar _tmp141 = -_tmp104 * _tmp124 - _tmp125 * _tmp140 + _tmp97;
  const Scalar _tmp142 = -_tmp106 + _tmp110 * _tmp128 - _tmp111 * _tmp124;
  const Scalar _tmp143 = std::asinh(
      _tmp123 * (Scalar(1.0) * _tmp115 * (_tmp110 * _tmp131 - _tmp130 * _tmp142) +
                 Scalar(1.0) * _tmp121 * (_tmp118 * _tmp131 - _tmp129 * _tmp130) +
                 Scalar(1.0) * _tmp133 * (-Scalar(1.0) * _tmp134 + _tmp135) +
                 Scalar(1.0) * _tmp138 * (_tmp131 * _tmp139 - _tmp131) +
                 Scalar(1.0) * _tmp85 * (-_tmp130 * _tmp137 + _tmp136) +
                 Scalar(1.0) * _tmp86 * (-_tmp103 * _tmp131 - _tmp130 * _tmp141 + Scalar(1.0))));
  const Scalar _tmp144 = Scalar(1.4083112389913199) * _tmp122;
  const Scalar _tmp145 = _tmp98 * fh1;
  const Scalar _tmp146 = _tmp131 * _tmp138;
  const Scalar _tmp147 = _tmp77 * _tmp85;
  const Scalar _tmp148 = _tmp59 * _tmp69;
  const Scalar _tmp149 = _tmp105 * _tmp86;
  const Scalar _tmp150 = _tmp113 * _tmp115 * _tmp69 + _tmp120 * _tmp121 * _tmp69 -
                         _tmp147 * _tmp148 - _tmp148 * _tmp149;
  const Scalar _tmp151 = Scalar(1.0) / (_tmp150);
  const Scalar _tmp152 = std::asinh(
      _tmp151 * (_tmp129 * _tmp145 * _tmp84 + _tmp133 * _tmp134 + _tmp137 * _tmp85 * _tmp98 -
                 _tmp139 * _tmp146 + _tmp141 * _tmp86 * _tmp98 + _tmp142 * _tmp145 * _tmp83));
  const Scalar _tmp153 = Scalar(1.4083112389913199) * _tmp150;
  const Scalar _tmp154 =
      _tmp102 * _tmp111 * _tmp115 + _tmp102 * _tmp119 * _tmp121 + _tmp147 + _tmp149;
  const Scalar _tmp155 = Scalar(1.0) / (_tmp154);
  const Scalar _tmp156 =
      std::asinh(_tmp155 * (-_tmp110 * _tmp115 * _tmp127 - _tmp118 * _tmp121 * _tmp127 -
                            _tmp133 * _tmp135 - _tmp136 * _tmp85 + _tmp140 * _tmp86 + _tmp146));
               ...
               (-_tmp143 * _tmp144 -
                Scalar(125.0) *
                    std::sqrt(Scalar(
                        ...
                        Scalar(0.77439999999999998) *
                            std::pow(Scalar(-Scalar(0.0090909090909090905) * _tmp56 - 1),
                                     Scalar(2))))))) +
                ...
                Scalar(125.0) * std::sqrt(Scalar(
                                    Scalar(0.77439999999999998) *
                                        std::pow(Scalar(1 - Scalar(0.0090909090909090905) * _tmp61),
                                                 Scalar(2)) +
                                    std::pow(Scalar(-Scalar(0.0080000000000000002) * _tmp64 - 1),
                                             Scalar(2))))))) +
