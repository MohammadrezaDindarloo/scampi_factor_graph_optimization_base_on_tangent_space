...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl12(
  ...
  const Scalar _tmp54 = _tmp32 + _tmp44;
  const Scalar _tmp55 = _tmp18 * _tmp29;
  const Scalar _tmp56 = -_tmp30 * _tmp53 + _tmp54 * _tmp55;
  const Scalar _tmp57 = _tmp43 * _tmp52 - _tmp46;
  const Scalar _tmp58 = Scalar(1.0) / (_tmp30 * _tmp52 - _tmp55);
  const Scalar _tmp59 = _tmp57 * _tmp58;
  const Scalar _tmp60 = Scalar(1.0) * _tmp47;
  const Scalar _tmp61 = Scalar(1.0) * _tmp49;
  const Scalar _tmp62 = (-_tmp27 + _tmp61) / (_tmp17 - _tmp60);
  const Scalar _tmp63 = _tmp30 * _tmp45 - _tmp30 * _tmp54;
  const Scalar _tmp64 = -_tmp35 * _tmp43 + _tmp43 * _tmp45 - _tmp59 * _tmp63 -
                        _tmp62 * (_tmp35 * _tmp46 - _tmp43 * _tmp53 - _tmp56 * _tmp59);
  ...
  const Scalar _tmp71 = _tmp70 * (-_tmp30 * _tmp68 + _tmp43 * _tmp67);
  const Scalar _tmp72 = Scalar(1.0) / (_tmp69);
  const Scalar _tmp73 = _tmp70 * (-_tmp47 * _tmp50 * _tmp72 + _tmp48 * _tmp49 * _tmp72);
  const Scalar _tmp74 = _tmp17 * _tmp30 - _tmp27 * _tmp55 + _tmp30 * _tmp73;
  const Scalar _tmp75 = Scalar(1.0) * _tmp58;
  const Scalar _tmp76 = _tmp56 * _tmp62 * _tmp75 - _tmp63 * _tmp75;
  const Scalar _tmp77 = -_tmp37 * _tmp46 + _tmp40 * _tmp43 + _tmp43 * _tmp73 - _tmp59 * _tmp74;
  ...
  const Scalar _tmp84 = _tmp30 * _tmp58;
  const Scalar _tmp85 = _tmp43 * _tmp65;
  ...
  const Scalar _tmp96 = _tmp52 * _tmp58;
  const Scalar _tmp97 = -_tmp45 - _tmp62 * (_tmp53 + _tmp56 * _tmp96) + _tmp63 * _tmp96;
  const Scalar _tmp98 = _tmp80 * (-_tmp73 + _tmp74 * _tmp96 - _tmp78 * _tmp97) + _tmp97;
  const Scalar _tmp99 = -_tmp52 - _tmp82 * _tmp98;
  const Scalar _tmp100 = _tmp58 * fh1;
  ...
  _res(1, 0) =
      -_tmp71 *
      std::exp(_tmp0 * _tmp71 + _tmp70 * _tmp95 * (-_tmp30 * _tmp59 * _tmp93 + _tmp43 * _tmp93) +
               _tmp91 * _tmp92 * (_tmp81 * _tmp85 + _tmp83 * _tmp84) +
               _tmp92 * _tmp94 * (_tmp84 * _tmp99 + _tmp85 * _tmp98 + Scalar(1.0)));
  _res(2, 0) = -_tmp68 * std::exp(-_tmp100 * _tmp83 * _tmp91 - _tmp100 * _tmp94 * _tmp99 +
                                  _tmp101 * _tmp59 + _tmp102 * _tmp59);
  _res(3, 0) =
      _tmp67 * std::exp(-_tmp101 - _tmp102 - _tmp103 * _tmp81 * _tmp91 - _tmp103 * _tmp94 * _tmp98);
