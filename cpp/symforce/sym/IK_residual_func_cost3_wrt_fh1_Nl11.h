...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl11(
  ...
  const Scalar _tmp38 = _tmp22 + _tmp25;
  ...
  const Scalar _tmp46 = _tmp30 * _tmp44 - _tmp36;
  const Scalar _tmp47 = _tmp19 + _tmp38;
  ...
  const Scalar _tmp55 = Scalar(1.0) / (_tmp44 * _tmp54 - _tmp53);
  const Scalar _tmp56 = _tmp37 * _tmp54;
  const Scalar _tmp57 = _tmp31 + _tmp32 + _tmp33;
  const Scalar _tmp58 = _tmp55 * (-_tmp44 * _tmp56 + _tmp53 * _tmp57);
  const Scalar _tmp59 = Scalar(1.0) * _tmp39;
  const Scalar _tmp60 = Scalar(1.0) * _tmp41;
  const Scalar _tmp61 = (-_tmp50 + _tmp60) / (_tmp47 - _tmp59);
  const Scalar _tmp62 = _tmp55 * (-_tmp54 * _tmp57 + _tmp56);
  const Scalar _tmp63 = -_tmp30 * _tmp35 + _tmp30 * _tmp37 - _tmp46 * _tmp62 -
                        _tmp61 * (-_tmp30 * _tmp45 + _tmp35 * _tmp36 - _tmp46 * _tmp58);
  const Scalar _tmp64 = Scalar(1.0) / (_tmp63);
  const Scalar _tmp65 = _tmp59 * _tmp61 + _tmp60;
  const Scalar _tmp66 = 0;
  const Scalar _tmp67 = _tmp46 * _tmp55;
  ...
  const Scalar _tmp71 = _tmp49 + _tmp9;
  ...
  const Scalar _tmp80 = _tmp70 * (-_tmp39 * _tmp42 * _tmp79 + _tmp40 * _tmp41 * _tmp79);
  const Scalar _tmp81 = _tmp55 * (_tmp47 * _tmp54 - _tmp50 * _tmp53 + _tmp54 * _tmp80);
  const Scalar _tmp82 = -_tmp17 * _tmp36 + _tmp27 * _tmp30 + _tmp30 * _tmp80 - _tmp46 * _tmp81;
  const Scalar _tmp83 = Scalar(1.0) / (_tmp82);
  const Scalar _tmp84 = Scalar(1.0) * _tmp83;
  const Scalar _tmp85 = _tmp70 * _tmp78 * (_tmp30 * _tmp84 - _tmp68 * _tmp84);
  const Scalar _tmp86 = -_tmp37 + _tmp44 * _tmp62 - _tmp61 * (_tmp44 * _tmp58 + _tmp45);
  const Scalar _tmp87 = _tmp64 * _tmp82;
  const Scalar _tmp88 = _tmp63 * _tmp83;
  const Scalar _tmp89 = _tmp86 + _tmp88 * (_tmp44 * _tmp81 - _tmp80 - _tmp86 * _tmp87);
  const Scalar _tmp90 = _tmp30 * _tmp64;
  const Scalar _tmp91 = _tmp46 * _tmp64;
  const Scalar _tmp92 = _tmp55 * (-_tmp44 - _tmp89 * _tmp91);
  const Scalar _tmp93 = _tmp70 * _tmp77 * (_tmp54 * _tmp92 + _tmp89 * _tmp90 + Scalar(1.0));
  const Scalar _tmp94 = Scalar(1.0) * _tmp58 * _tmp61 - Scalar(1.0) * _tmp62;
  const Scalar _tmp95 = _tmp88 * (-Scalar(1.0) * _tmp81 - _tmp87 * _tmp94) + _tmp94;
  const Scalar _tmp96 = _tmp55 * (-_tmp91 * _tmp95 + Scalar(1.0));
  const Scalar _tmp97 = _tmp70 * _tmp76 * (_tmp54 * _tmp96 + _tmp90 * _tmp95);
  ...
  const Scalar _tmp102 = _tmp76 * _tmp96;
  const Scalar _tmp103 = _tmp64 * _tmp77 * _tmp89;
  const Scalar _tmp104 = _tmp64 * _tmp76 * _tmp95;
  ...
  _res(1, 0) =
      -(-_tmp85 - _tmp93 - _tmp97) * std::exp(_tmp0 * _tmp70 * (_tmp30 * _tmp66 - _tmp66 * _tmp68) +
                                              _tmp85 * fh1 + _tmp93 * fh1 + _tmp97 * fh1);
  _res(2, 0) = -(-_tmp100 * _tmp67 + _tmp102 + _tmp98) *
               std::exp(_tmp101 * _tmp67 - _tmp102 * fh1 + _tmp67 * _tmp99 - _tmp98 * fh1);
  _res(3, 0) =
      -(_tmp100 + _tmp103 + _tmp104) * std::exp(-_tmp101 - _tmp103 * fh1 - _tmp104 * fh1 - _tmp99);
