...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2WrtFh1Nl3(
  ...
  const Scalar _tmp55 = Scalar(0.20999999999999999) * _tmp27 - Scalar(0.20999999999999999) * _tmp28;
  ...
  const Scalar _tmp61 = _tmp21 + _tmp9;
  ...
  const Scalar _tmp109 = _tmp34 + Scalar(125.0);
  const Scalar _tmp110 = _tmp23 + Scalar(110.0);
  ...
  const Scalar _tmp115 = -_tmp112 * _tmp22 + _tmp114 * _tmp33;
  ...
  const Scalar _tmp145 = _tmp112 * _tmp144 + Scalar(40.024799999999999) * _tmp29 + _tmp33 * fv1;
  ...
  const Scalar _tmp153 = -_tmp114 * _tmp144 - Scalar(40.024799999999999) * _tmp19 - _tmp22 * fv1;
  ...
  const Scalar _tmp164 = Scalar(1.4083112389913199) * _tmp130;
  ...
  const Scalar _tmp174 = _tmp114 * _tmp124;
  const Scalar _tmp175 = -_tmp171 * _tmp93 + _tmp172 * fh1 - _tmp173 * fh1 + _tmp174 * fh1;
  const Scalar _tmp176 = Scalar(1.0) / (_tmp175);
  const Scalar _tmp177 = _tmp115 * _tmp137 * _tmp78;
  const Scalar _tmp178 = _tmp112 * _tmp141 * _tmp78;
  const Scalar _tmp179 = _tmp135 * _tmp145;
  const Scalar _tmp180 = _tmp155 * _tmp78;
  const Scalar _tmp181 = _tmp114 * _tmp149 * _tmp78;
  const Scalar _tmp182 = _tmp126 * _tmp152 * _tmp78 - _tmp146 * _tmp179 + _tmp153 * _tmp180 +
                         _tmp177 * fh1 + _tmp178 * fh1 + _tmp181 * fh1;
  ...
  const Scalar _tmp186 = _tmp172 - _tmp173 + _tmp174;
  const Scalar _tmp187 = _tmp185 * _tmp186;
  const Scalar _tmp188 =
      (_tmp176 * (-_tmp147 * _tmp166 - _tmp165 * _tmp180 + _tmp177 + _tmp178 + _tmp181) -
       _tmp182 * _tmp187) /
  ...
  const Scalar _tmp191 = Scalar(1.4083112389913199) * _tmp186;
  const Scalar _tmp192 = Scalar(0.71007031138673404) * _tmp176;
  ...
  const Scalar _tmp197 = _tmp171 + _tmp194 * fh1 + _tmp195 * fh1 + _tmp196 * fh1;
  ...
  const Scalar _tmp202 = _tmp126 * _tmp151 - _tmp153 * _tmp154 + _tmp179 - _tmp199 * fh1 -
  ...
  const Scalar _tmp207 = _tmp194 + _tmp195 + _tmp196;
  ...
  const Scalar _tmp210 = Scalar(1.4083112389913199) * _tmp207;
  ...
  _res(1, 0) = Scalar(1.4083112389913199) * _tmp163 * (-std::sinh(_tmp162) - std::sinh(_tmp170)) +
  ...
  _res(3, 0) = _tmp204 * (-Scalar(1.0) * _tmp209 * std::cosh(_tmp213) -
                          (-Scalar(0.71007031138673404) * _tmp205 * _tmp208 +
                           _tmp211 * (-_tmp203 * _tmp210 - _tmp204 * _tmp209)) *
                              std::cosh(_tmp212)) +
               _tmp210 * (-std::sinh(_tmp212) - std::sinh(_tmp213));
