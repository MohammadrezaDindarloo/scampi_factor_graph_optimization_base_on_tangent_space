...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl23(
  ...
  const Scalar _tmp18 = _tmp17 + position_vector(1, 0) + Scalar(8.3196563700000006);
  ...
  const Scalar _tmp28 = _tmp27 + position_vector(0, 0) + Scalar(1.9874742000000001);
  ...
  const Scalar _tmp34 = _tmp22 + _tmp25;
  ...
  const Scalar _tmp48 = Scalar(1.0) / (_tmp38 * _tmp47 - _tmp46);
  ...
  const Scalar _tmp53 = _tmp52 * (-_tmp32 * _tmp36 * _tmp51 + _tmp33 * _tmp35 * _tmp51);
  const Scalar _tmp54 = _tmp48 * (_tmp41 * _tmp47 - _tmp43 * _tmp46 + _tmp47 * _tmp53);
  const Scalar _tmp55 = _tmp17 * _tmp39 - _tmp27 * _tmp30 + _tmp39 * _tmp53 - _tmp40 * _tmp54;
  const Scalar _tmp56 = Scalar(1.0) / (_tmp55);
  const Scalar _tmp57 = Scalar(1.0) * _tmp56;
  const Scalar _tmp58 = _tmp19 + _tmp26;
  const Scalar _tmp59 = _tmp31 + _tmp9;
  ...
  const Scalar _tmp69 = (-_tmp43 + _tmp68) / (_tmp41 - _tmp67);
  ...
  const Scalar _tmp80 = _tmp48 * (-_tmp38 * _tmp78 + _tmp46 * _tmp79);
  const Scalar _tmp81 = _tmp39 * _tmp77;
  const Scalar _tmp82 = _tmp48 * (-_tmp47 * _tmp79 + _tmp78);
  const Scalar _tmp83 = -_tmp39 * _tmp76 - _tmp40 * _tmp82 -
                        _tmp69 * (_tmp30 * _tmp76 - _tmp38 * _tmp81 - _tmp40 * _tmp80) + _tmp81;
  ...
  const Scalar _tmp88 = Scalar(1.0) * _tmp69 * _tmp80 - Scalar(1.0) * _tmp82;
  const Scalar _tmp89 = _tmp55 * _tmp84;
  const Scalar _tmp90 = _tmp56 * _tmp83;
  const Scalar _tmp91 = _tmp88 + _tmp90 * (-Scalar(1.0) * _tmp54 - _tmp88 * _tmp89);
  const Scalar _tmp92 = -_tmp85 * _tmp91 + Scalar(1.0);
  const Scalar _tmp93 = _tmp39 * _tmp84;
  const Scalar _tmp94 = _tmp63 * fh1;
  const Scalar _tmp95 = _tmp38 * _tmp82 - _tmp69 * (_tmp38 * _tmp77 + _tmp38 * _tmp80) - _tmp77;
  const Scalar _tmp96 = _tmp90 * (_tmp38 * _tmp54 - _tmp53 - _tmp89 * _tmp95) + _tmp95;
  const Scalar _tmp97 = -_tmp38 - _tmp85 * _tmp96;
  const Scalar _tmp98 = _tmp64 * fh1;
  const Scalar _tmp99 = _tmp57 * _tmp65;

  // Output terms (1)
  Eigen::Matrix<Scalar, 4, 1> _res;

  _res(0, 0) = std::exp(-fh1);
  _res(1, 0) = std::exp(_tmp52 * _tmp65 * (_tmp39 * _tmp57 - _tmp40 * _tmp49 * _tmp57) +
                        _tmp52 * _tmp66 * (_tmp39 * _tmp87 - _tmp49 * _tmp86) +
                        _tmp52 * _tmp94 * (_tmp49 * _tmp92 + _tmp91 * _tmp93) +
                        _tmp52 * _tmp98 * (_tmp49 * _tmp97 + _tmp93 * _tmp96 + Scalar(1.0)));
  _res(2, 0) = std::exp(_tmp40 * _tmp48 * _tmp99 + _tmp48 * _tmp66 * _tmp86 -
                        _tmp48 * _tmp92 * _tmp94 - _tmp48 * _tmp97 * _tmp98);
  _res(3, 0) =
      std::exp(-_tmp66 * _tmp87 - _tmp84 * _tmp91 * _tmp94 - _tmp84 * _tmp96 * _tmp98 - _tmp99);
