...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2Nl1(
  ...
  const Scalar _tmp58 = _tmp34 + _tmp38;
  ...
  const Scalar _tmp67 = _tmp41 * _tmp66 - _tmp58 * _tmp66;
  const Scalar _tmp68 = _tmp64 * _tmp65;
  const Scalar _tmp69 = _tmp47 + Scalar(-2.5202214700000001);
  const Scalar _tmp70 = Scalar(1.0) / (_tmp69);
  const Scalar _tmp71 = _tmp44 + Scalar(8.3888750099999996);
  const Scalar _tmp72 = _tmp70 * _tmp71;
  const Scalar _tmp73 = Scalar(1.0) / (_tmp66 * _tmp72 - _tmp68);
  const Scalar _tmp74 = _tmp52 * _tmp56;
  const Scalar _tmp75 = _tmp57 * _tmp72 - _tmp74;
  const Scalar _tmp76 = _tmp73 * _tmp75;
  const Scalar _tmp77 = _tmp34 + _tmp40;
  const Scalar _tmp78 = _tmp41 * _tmp72;
  const Scalar _tmp79 = _tmp58 * _tmp68 - _tmp66 * _tmp78;
  const Scalar _tmp80 = -_tmp57 * _tmp78 + _tmp74 * _tmp77 - _tmp76 * _tmp79;
  const Scalar _tmp81 = Scalar(1.0) * _tmp46;
  const Scalar _tmp82 = Scalar(1.0) * _tmp43;
  const Scalar _tmp83 = -_tmp82;
  const Scalar _tmp84 = Scalar(1.0) / (_tmp62 + _tmp83);
  const Scalar _tmp85 = _tmp84 * (-_tmp59 + _tmp81);
  const Scalar _tmp86 = _tmp41 * _tmp57 - _tmp57 * _tmp77 - _tmp67 * _tmp76 - _tmp80 * _tmp85;
  const Scalar _tmp87 = Scalar(1.0) / (_tmp86);
  const Scalar _tmp88 = _tmp81 + _tmp82 * _tmp85;
  ...
  const Scalar _tmp95 = _tmp93 * (-_tmp43 * _tmp69 * _tmp94 + _tmp46 * _tmp71 * _tmp94);
  const Scalar _tmp96 = -_tmp59 * _tmp68 + _tmp62 * _tmp66 + _tmp66 * _tmp95;
  const Scalar _tmp97 = _tmp50 * _tmp57 - _tmp53 * _tmp74 + _tmp57 * _tmp95 - _tmp76 * _tmp96;
  const Scalar _tmp98 = Scalar(1.0) / (_tmp97);
  const Scalar _tmp99 = Scalar(1.0) * _tmp98;
  const Scalar _tmp100 = _tmp30 + Scalar(1.9874742000000001);
  const Scalar _tmp101 = _tmp19 + Scalar(8.3196563700000006);
  ...
  const Scalar _tmp105 = fh1 * (_tmp103 * _tmp29 - _tmp104 * _tmp18);
  const Scalar _tmp106 = Scalar(1.0) * _tmp73;
  const Scalar _tmp107 = _tmp106 * _tmp79;
  const Scalar _tmp108 = -_tmp106 * _tmp67 + _tmp107 * _tmp85;
  ...
  const Scalar _tmp113 = _tmp75 * _tmp87;
  const Scalar _tmp114 = -_tmp112 * _tmp113 + Scalar(1.0);
  const Scalar _tmp115 = _tmp66 * _tmp73;
  const Scalar _tmp116 = _tmp57 * _tmp87;
  const Scalar _tmp117 = _tmp103 * fh1;
  const Scalar _tmp118 = _tmp72 * _tmp73;
  const Scalar _tmp119 = _tmp118 * _tmp79 + _tmp78;
  const Scalar _tmp120 = _tmp118 * _tmp67 - _tmp119 * _tmp85 - _tmp41;
  ...
  const Scalar _tmp125 = -_tmp105 * _tmp93 * (_tmp57 * _tmp99 - _tmp91 * _tmp99) -
                         _tmp117 * _tmp93 * (_tmp112 * _tmp116 + _tmp114 * _tmp115) -
                         _tmp124 * _tmp93 * (_tmp115 * _tmp123 + _tmp116 * _tmp122 + Scalar(1.0)) -
                         _tmp49 * _tmp93 * (_tmp57 * _tmp90 - _tmp90 * _tmp91);
  const Scalar _tmp126 = Scalar(1.0) / (_tmp125);
  const Scalar _tmp127 = _tmp50 + _tmp83;
  const Scalar _tmp128 = _tmp127 * _tmp85;
  const Scalar _tmp129 = Scalar(1.0) / (-_tmp128 - _tmp53 + _tmp81);
  const Scalar _tmp130 = Scalar(1.0) * _tmp129;
  const Scalar _tmp131 = _tmp128 * _tmp130 + Scalar(1.0);
  const Scalar _tmp132 = Scalar(1.0) * _tmp84;
  const Scalar _tmp133 = _tmp130 * _tmp85;
  const Scalar _tmp134 = _tmp39 * fh1;
  const Scalar _tmp135 = -_tmp103 * _tmp134 - Scalar(5.1796800000000003) * _tmp15 - _tmp18 * fv1;
  const Scalar _tmp136 = _tmp104 * _tmp134 + Scalar(5.1796800000000003) * _tmp24 + _tmp29 * fv1;
  const Scalar _tmp137 = _tmp127 * _tmp84;
  const Scalar _tmp138 = _tmp110 * _tmp130;
  const Scalar _tmp139 = _tmp127 * _tmp138 - _tmp80 * _tmp99;
  const Scalar _tmp140 = _tmp127 * _tmp129;
  const Scalar _tmp141 = _tmp80 * _tmp87;
  const Scalar _tmp142 = _tmp119 + _tmp121 * _tmp140 - _tmp122 * _tmp141;
  const Scalar _tmp143 = _tmp129 * _tmp88;
  const Scalar _tmp144 = -_tmp127 * _tmp143 - _tmp141 * _tmp89 + _tmp83;
  const Scalar _tmp145 = -_tmp107 + _tmp111 * _tmp140 - _tmp112 * _tmp141;
  const Scalar _tmp146 = std::asinh(
      _tmp126 * (Scalar(1.0) * _tmp105 * (-_tmp132 * _tmp139 + _tmp138) +
                 Scalar(1.0) * _tmp117 * (_tmp111 * _tmp130 - _tmp132 * _tmp145) +
                 Scalar(1.0) * _tmp124 * (_tmp121 * _tmp130 - _tmp132 * _tmp142) +
                 Scalar(1.0) * _tmp135 * (-_tmp131 * _tmp132 + _tmp133) +
                 Scalar(1.0) * _tmp136 * (_tmp130 * _tmp137 - _tmp130) +
                 Scalar(1.0) * _tmp49 * (-_tmp130 * _tmp88 - _tmp132 * _tmp144 + Scalar(1.0))));
  ...
  const Scalar _tmp151 = _tmp73 * fh1;
  const Scalar _tmp152 = _tmp103 * _tmp114 * _tmp151 + _tmp104 * _tmp123 * _tmp151 -
                         _tmp149 * _tmp76 - _tmp150 * _tmp76;
  const Scalar _tmp153 = Scalar(1.0) / (_tmp152);
  const Scalar _tmp154 =
      std::asinh(_tmp153 * (_tmp105 * _tmp139 * _tmp84 + _tmp117 * _tmp145 * _tmp84 +
                            _tmp124 * _tmp142 * _tmp84 + _tmp131 * _tmp135 * _tmp84 -
                            _tmp137 * _tmp148 + _tmp144 * _tmp49 * _tmp84));
  ...
  const Scalar _tmp159 = std::asinh(_tmp158 * (-_tmp105 * _tmp138 - _tmp111 * _tmp117 * _tmp129 -
                                               _tmp121 * _tmp124 * _tmp129 - _tmp133 * _tmp135 +
                                               _tmp143 * _tmp49 + _tmp148));
  const Scalar _tmp160 = Scalar(9.6622558468725703) * _tmp157;
  const Scalar _tmp161 = Scalar(22.802596067096832) *
  ...
  _res(1, 0) =
      _tmp147 *
          (-std::sinh(Scalar(1.0) * _tmp146) -
           std::sinh(Scalar(0.1034955) * _tmp126 * (-_tmp146 * _tmp147 - std::sqrt(_tmp48)))) -
  ...
  _res(2, 0) =
      ...
      Scalar(8.3700199099999999) *
          std::sqrt(Scalar(Scalar(0.01427404356387209) * _tmp156 +
                           std::pow(Scalar(-Scalar(0.11947402882581673) * _tmp58 -
  ...
  _res(3, 0) =
      ...
      Scalar(8.36416322) *
          std::sqrt(Scalar(Scalar(0.014294040284261563) * _tmp161 +
