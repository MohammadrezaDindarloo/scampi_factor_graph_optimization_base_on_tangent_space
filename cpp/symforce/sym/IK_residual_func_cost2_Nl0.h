...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2Nl0(
  ...
  const Scalar _tmp46 = Scalar(6.351516257848961) *
  ...
  const Scalar _tmp48 = _tmp40 + _tmp5;
  ...
  const Scalar _tmp58 = _tmp47 * _tmp55 - _tmp55 * _tmp57;
  const Scalar _tmp59 = _tmp45 + Scalar(-2.5202214700000001);
  const Scalar _tmp60 = Scalar(1.0) / (_tmp59);
  const Scalar _tmp61 = _tmp42 + Scalar(8.3888750099999996);
  ...
  const Scalar _tmp66 = _tmp47 * _tmp62;
  const Scalar _tmp67 = _tmp64 * (-_tmp55 * _tmp66 + _tmp57 * _tmp63);
  const Scalar _tmp68 = _tmp62 * _tmp67 + _tmp66;
  const Scalar _tmp69 = Scalar(1.0) * _tmp41;
  const Scalar _tmp70 = -_tmp69;
  const Scalar _tmp71 = Scalar(1.0) / (_tmp48 + _tmp70);
  const Scalar _tmp72 = Scalar(1.0) * _tmp44;
  const Scalar _tmp73 = _tmp71 * (-_tmp51 + _tmp72);
  const Scalar _tmp74 = -_tmp47 + _tmp58 * _tmp65 - _tmp68 * _tmp73;
  const Scalar _tmp75 = _tmp35 + _tmp56;
  ...
  const Scalar _tmp79 = _tmp17 + _tmp5;
  ...
  const Scalar _tmp86 = -_tmp66 * _tmp83 - _tmp67 * _tmp85 + _tmp75 * _tmp84;
  const Scalar _tmp87 = _tmp64 * _tmp85;
  const Scalar _tmp88 = _tmp47 * _tmp83 - _tmp58 * _tmp87 - _tmp73 * _tmp86 - _tmp75 * _tmp83;
  ...
  const Scalar _tmp93 = _tmp92 * (-_tmp41 * _tmp59 * _tmp91 + _tmp44 * _tmp61 * _tmp91);
  const Scalar _tmp94 = _tmp48 * _tmp55 - _tmp51 * _tmp63 + _tmp55 * _tmp93;
  const Scalar _tmp95 = -_tmp76 * _tmp84 + _tmp79 * _tmp83 + _tmp83 * _tmp93 - _tmp87 * _tmp94;
  ...
  const Scalar _tmp105 = _tmp30 + Scalar(1.9874742000000001);
  const Scalar _tmp106 = _tmp19 + Scalar(8.3196563700000006);
  ...
  const Scalar _tmp114 = _tmp55 * _tmp87;
  const Scalar _tmp115 = Scalar(1.0) * _tmp64;
  const Scalar _tmp116 = Scalar(1.0) * _tmp67;
  const Scalar _tmp117 = -_tmp115 * _tmp58 + _tmp116 * _tmp73;
  const Scalar _tmp118 = _tmp98 * (-_tmp115 * _tmp94 - _tmp117 * _tmp96);
  ...
  const Scalar _tmp125 = -_tmp109 * _tmp92 * (_tmp100 * _tmp101 + _tmp103 * _tmp104 + Scalar(1.0)) -
                         _tmp110 * _tmp92 * (-_tmp113 * _tmp114 + _tmp113 * _tmp83) -
                         _tmp122 * _tmp92 * (_tmp101 * _tmp119 + _tmp104 * _tmp120) -
                         _tmp124 * _tmp92 * (-_tmp114 * _tmp123 + _tmp123 * _tmp83);
  const Scalar _tmp126 = Scalar(1.0) / (_tmp125);
  const Scalar _tmp127 = _tmp86 * _tmp89;
  const Scalar _tmp128 = _tmp70 + _tmp79;
  const Scalar _tmp129 = _tmp128 * _tmp73;
  const Scalar _tmp130 = Scalar(1.0) / (-_tmp129 + _tmp72 - _tmp76);
  ...
  const Scalar _tmp136 = -_tmp112 * _tmp127 - _tmp128 * _tmp135 + _tmp70;
  const Scalar _tmp137 = -_tmp100 * _tmp127 + _tmp131 * _tmp99 + _tmp68;
  const Scalar _tmp138 = _tmp128 * _tmp134;
  const Scalar _tmp139 = -_tmp123 * _tmp86 + _tmp138 * _tmp98;
  const Scalar _tmp140 = _tmp134 * _tmp98;
  const Scalar _tmp141 = _tmp129 * _tmp134 + Scalar(1.0);
  const Scalar _tmp142 = _tmp134 * _tmp73;
  const Scalar _tmp143 = _tmp39 * fh1;
  const Scalar _tmp144 = -_tmp121 * _tmp143 - Scalar(5.1796800000000003) * _tmp15 - _tmp18 * fv1;
  const Scalar _tmp145 = _tmp108 * _tmp143 + Scalar(5.1796800000000003) * _tmp26 + _tmp29 * fv1;
  const Scalar _tmp146 = std::asinh(
      _tmp126 * (Scalar(1.0) * _tmp109 * (-_tmp133 * _tmp137 + _tmp134 * _tmp99) +
                 Scalar(1.0) * _tmp110 * (-_tmp111 * _tmp134 - _tmp133 * _tmp136 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp122 * (_tmp118 * _tmp134 - _tmp132 * _tmp133) +
                 Scalar(1.0) * _tmp124 * (-_tmp133 * _tmp139 + _tmp140) +
                 Scalar(1.0) * _tmp144 * (-_tmp133 * _tmp141 + _tmp142) +
                 Scalar(1.0) * _tmp145 * (-_tmp134 + _tmp138 * _tmp71)));
  const Scalar _tmp147 = Scalar(9.6622558468725703) * _tmp125;
  const Scalar _tmp148 = _tmp134 * _tmp145;
  const Scalar _tmp149 = _tmp123 * _tmp124;
  const Scalar _tmp150 = _tmp110 * _tmp113;
  const Scalar _tmp151 =
      _tmp103 * _tmp109 * _tmp64 + _tmp120 * _tmp122 * _tmp64 - _tmp149 * _tmp87 - _tmp150 * _tmp87;
  const Scalar _tmp152 = Scalar(1.0) / (_tmp151);
  const Scalar _tmp153 =
      std::asinh(_tmp152 * (_tmp109 * _tmp137 * _tmp71 + _tmp110 * _tmp136 * _tmp71 +
                            _tmp122 * _tmp132 * _tmp71 + _tmp124 * _tmp139 * _tmp71 -
                            _tmp128 * _tmp148 * _tmp71 + _tmp141 * _tmp144 * _tmp71));
  ...
  const Scalar _tmp156 =
      _tmp100 * _tmp109 * _tmp89 + _tmp119 * _tmp122 * _tmp89 + _tmp149 + _tmp150;
  ...
  const Scalar _tmp159 = std::asinh(_tmp157 * (-_tmp109 * _tmp130 * _tmp99 + _tmp110 * _tmp135 -
  ...
  _res(1, 0) =
      _tmp147 *
          (-std::sinh(Scalar(1.0) * _tmp146) -
           std::sinh(Scalar(0.1034955) * _tmp126 * (-_tmp146 * _tmp147 - std::sqrt(_tmp46)))) -
      Scalar(8.4693136199999994) *
          std::sqrt(Scalar(Scalar(0.013941309530580858) * _tmp46 +
  ...
  _res(2, 0) =
      ...
      Scalar(8.36416322) *
          std::sqrt(Scalar(Scalar(0.014294040284261563) * _tmp155 +
                           std::pow(Scalar(-Scalar(0.1195576860108189) * _tmp57 -
  ...
  _res(3, 0) =
      ...
      Scalar(8.3700199099999999) *
          std::sqrt(Scalar(Scalar(0.01427404356387209) * _tmp158 +
                           std::pow(Scalar(-Scalar(0.11947402882581673) * _tmp75 -
