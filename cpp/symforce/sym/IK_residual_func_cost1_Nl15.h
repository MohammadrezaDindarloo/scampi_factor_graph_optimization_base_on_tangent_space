...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl15(
  ...
  const Scalar _tmp33 = -Scalar(0.010999999999999999) * _tmp16 -
  ...
  const Scalar _tmp74 = -_tmp50 + _tmp51 * _tmp64 - _tmp67 * _tmp73;
  ...
  const Scalar _tmp78 = _tmp43 + _tmp58;
  ...
  const Scalar _tmp83 = _tmp37 + _tmp49;
  ...
  const Scalar _tmp88 = _tmp50 * _tmp82 - _tmp51 * _tmp86 - _tmp73 * _tmp87 - _tmp82 * _tmp83;
  ...
  const Scalar _tmp94 = _tmp63 * (-_tmp40 * _tmp52 + _tmp44 * _tmp48 + _tmp48 * _tmp93);
  ...
  const Scalar _tmp99 = _tmp98 * (_tmp62 * _tmp94 - _tmp74 * _tmp96 - _tmp93);
  ...
  const Scalar _tmp112 = _tmp110 * _tmp63 * _tmp66 * _tmp72 - _tmp111 * _tmp51;
  const Scalar _tmp113 = _tmp98 * (-_tmp112 * _tmp96 - Scalar(1.0) * _tmp94);
  ...
  const Scalar _tmp119 = _tmp111 * _tmp85 * _tmp97;
  const Scalar _tmp120 = fh1 * (-_tmp108 * _tmp30 + _tmp116 * _tmp20);
  ...
  const Scalar _tmp125 = -_tmp109 * _tmp92 * (_tmp100 * _tmp101 + _tmp103 * _tmp104 + Scalar(1.0)) -
                         ...
                         _tmp120 * _tmp92 * (_tmp118 * _tmp82 - _tmp119 * _tmp48) -
                         _tmp121 * _tmp92 * (-_tmp124 * _tmp48 * _tmp86 + _tmp124 * _tmp82);
  ...
  const Scalar _tmp133 = -_tmp123 * _tmp131 - _tmp127 * _tmp132 + _tmp69;
  const Scalar _tmp134 = _tmp127 * _tmp130;
  const Scalar _tmp135 = -_tmp118 * _tmp87 + _tmp134 * _tmp98;
  const Scalar _tmp136 = _tmp130 * _tmp98;
  const Scalar _tmp137 = _tmp127 * _tmp129;
  const Scalar _tmp138 = -_tmp100 * _tmp131 + _tmp137 * _tmp99 + _tmp67;
  const Scalar _tmp139 = -_tmp111 * _tmp66 + _tmp113 * _tmp137 - _tmp114 * _tmp131;
  const Scalar _tmp140 = _tmp36 * fh1;
  const Scalar _tmp141 = -_tmp116 * _tmp140 - Scalar(5.1796800000000003) * _tmp26 - _tmp30 * fv1;
  const Scalar _tmp142 = _tmp70 * (_tmp128 * _tmp130 + Scalar(1.0));
  const Scalar _tmp143 = _tmp130 * _tmp73;
  const Scalar _tmp144 = _tmp108 * _tmp140 + Scalar(5.1796800000000003) * _tmp14 + _tmp20 * fv1;
  const Scalar _tmp145 = std::asinh(
      _tmp126 * (Scalar(1.0) * _tmp109 * (-_tmp110 * _tmp138 + _tmp130 * _tmp99) +
                 Scalar(1.0) * _tmp117 * (-_tmp110 * _tmp139 + _tmp113 * _tmp130) +
                 Scalar(1.0) * _tmp120 * (-_tmp110 * _tmp135 + _tmp136) +
                 Scalar(1.0) * _tmp121 * (-_tmp110 * _tmp133 - _tmp122 * _tmp130 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp141 * (-Scalar(1.0) * _tmp142 + _tmp143) +
                 Scalar(1.0) * _tmp144 * (-_tmp130 + _tmp134 * _tmp70)));
  const Scalar _tmp146 = Scalar(9.6622558468725703) * _tmp125;
  const Scalar _tmp147 = _tmp121 * _tmp124;
  const Scalar _tmp148 = _tmp103 * _tmp109 * _tmp63 + _tmp115 * _tmp117 * _tmp63 -
                         _tmp119 * _tmp120 - _tmp147 * _tmp86;
  const Scalar _tmp149 = Scalar(1.0) / (_tmp148);
  const Scalar _tmp150 = _tmp130 * _tmp144;
  const Scalar _tmp151 =
      std::asinh(_tmp149 * (_tmp109 * _tmp138 * _tmp70 + _tmp117 * _tmp139 * _tmp70 +
                            _tmp120 * _tmp135 * _tmp70 + _tmp121 * _tmp133 * _tmp70 -
                            _tmp127 * _tmp150 * _tmp70 + _tmp141 * _tmp142));
  const Scalar _tmp152 = Scalar(9.6622558468725703) * _tmp148;
  const Scalar _tmp153 =
      _tmp100 * _tmp109 * _tmp89 + _tmp114 * _tmp117 * _tmp89 + _tmp118 * _tmp120 + _tmp147;
  const Scalar _tmp154 = Scalar(1.0) / (_tmp153);
  const Scalar _tmp155 =
      std::asinh(_tmp154 * (-_tmp109 * _tmp129 * _tmp99 - _tmp113 * _tmp117 * _tmp129 -
                            _tmp120 * _tmp136 + _tmp121 * _tmp132 - _tmp141 * _tmp143 + _tmp150));
               ...
               (-_tmp155 * _tmp156 -
                Scalar(8.3196563700000006) *
                    std::sqrt(Scalar(
                        ...
                        std::pow(Scalar(-Scalar(0.12019727204189803) * _tmp79 - 1),
                                 Scalar(2))))))) +
