...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl8(
  ...
  const Scalar _tmp30 = -Scalar(0.010999999999999999) * _tmp22 -
  ...
  const Scalar _tmp39 = _tmp38 + position_vector(1, 0) + Scalar(8.3196563700000006);
  const Scalar _tmp40 = std::pow(Scalar(std::pow(_tmp36, Scalar(2)) + std::pow(_tmp39, Scalar(2))),
                                 Scalar(Scalar(-1) / Scalar(2)));
  const Scalar _tmp41 = _tmp36 * _tmp40;
  const Scalar _tmp42 = _tmp29 + _tmp30 + _tmp31;
  const Scalar _tmp43 = _tmp41 * _tmp42;
  const Scalar _tmp44 = -_tmp33 * _tmp41 + _tmp43;
  const Scalar _tmp45 = _tmp26 * _tmp27;
  const Scalar _tmp46 = _tmp17 + _tmp24;
  ...
  const Scalar _tmp53 = _tmp28 * _tmp52 - _tmp45;
  const Scalar _tmp54 = _tmp39 * _tmp40;
  const Scalar _tmp55 = Scalar(1.0) / (_tmp41 * _tmp52 - _tmp54);
  const Scalar _tmp56 = _tmp53 * _tmp55;
  const Scalar _tmp57 = _tmp29 + _tmp32;
  const Scalar _tmp58 = _tmp28 * _tmp42;
  const Scalar _tmp59 = _tmp33 * _tmp54 - _tmp43 * _tmp52;
  const Scalar _tmp60 = Scalar(1.0) * _tmp49;
  const Scalar _tmp61 = Scalar(1.0) * _tmp46;
  const Scalar _tmp62 = (-_tmp35 + _tmp60) / (_tmp38 - _tmp61);
  const Scalar _tmp63 = -_tmp28 * _tmp57 - _tmp44 * _tmp56 + _tmp58 -
                        _tmp62 * (_tmp45 * _tmp57 - _tmp52 * _tmp58 - _tmp56 * _tmp59);
  ...
  const Scalar _tmp67 = _tmp51 * _tmp65;
  const Scalar _tmp68 = _tmp67 * (-_tmp46 * _tmp50 * _tmp66 + _tmp47 * _tmp49 * _tmp66);
  const Scalar _tmp69 = -_tmp35 * _tmp54 + _tmp38 * _tmp41 + _tmp41 * _tmp68;
  const Scalar _tmp70 = Scalar(1.0) * _tmp55;
  const Scalar _tmp71 = -_tmp44 * _tmp70 + _tmp59 * _tmp62 * _tmp70;
  const Scalar _tmp72 = -_tmp15 * _tmp45 + _tmp25 * _tmp28 + _tmp28 * _tmp68 - _tmp56 * _tmp69;
  const Scalar _tmp73 = _tmp64 * _tmp72;
  const Scalar _tmp74 = Scalar(1.0) / (_tmp72);
  const Scalar _tmp75 = _tmp63 * _tmp74;
  const Scalar _tmp76 = _tmp71 + _tmp75 * (-_tmp69 * _tmp70 - _tmp71 * _tmp73);
  const Scalar _tmp77 = _tmp64 * _tmp76;
  const Scalar _tmp78 = _tmp53 * _tmp64;
  const Scalar _tmp79 = _tmp55 * (-_tmp76 * _tmp78 + Scalar(1.0));
  const Scalar _tmp80 = _tmp17 + _tmp37;
  const Scalar _tmp81 = _tmp80 + position_vector(1, 0) + Scalar(8.3888750099999996);
  const Scalar _tmp82 = _tmp34 + _tmp48;
  const Scalar _tmp83 = _tmp82 + position_vector(0, 0) + Scalar(-2.5202214700000001);
  const Scalar _tmp84 = std::pow(Scalar(std::pow(_tmp81, Scalar(2)) + std::pow(_tmp83, Scalar(2))),
                                 Scalar(Scalar(-1) / Scalar(2)));
  const Scalar _tmp85 = _tmp81 * _tmp84;
  const Scalar _tmp86 = _tmp67 * _tmp85 * (_tmp28 * _tmp77 + _tmp41 * _tmp79);
  const Scalar _tmp87 = _tmp52 * _tmp55;
  const Scalar _tmp88 = -_tmp42 + _tmp44 * _tmp87 - _tmp62 * (_tmp42 * _tmp52 + _tmp59 * _tmp87);
  const Scalar _tmp89 = _tmp75 * (-_tmp68 + _tmp69 * _tmp87 - _tmp73 * _tmp88) + _tmp88;
  const Scalar _tmp90 = _tmp55 * (-_tmp52 - _tmp78 * _tmp89);
  const Scalar _tmp91 = _tmp64 * _tmp89;
  const Scalar _tmp92 = _tmp83 * _tmp84;
  const Scalar _tmp93 = _tmp67 * _tmp92 * (_tmp28 * _tmp91 + _tmp41 * _tmp90 + Scalar(1.0));
  const Scalar _tmp94 = -_tmp80 * _tmp92 + _tmp82 * _tmp85;
  const Scalar _tmp95 = Scalar(1.0) * _tmp74;
  const Scalar _tmp96 = _tmp41 * _tmp56;
  const Scalar _tmp97 = _tmp67 * _tmp94 * (_tmp28 * _tmp95 - _tmp95 * _tmp96);
  const Scalar _tmp98 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp99 = _tmp60 + _tmp61 * _tmp62;
  const Scalar _tmp100 = 0;
  const Scalar _tmp101 = _tmp79 * _tmp85;
  ...
  const Scalar _tmp107 = _tmp91 * _tmp92;
  ...
  _res(1, 0) = -(-_tmp86 - _tmp93 - _tmp97) *
               std::exp(_tmp67 * _tmp98 * (_tmp100 * _tmp28 - _tmp100 * _tmp96) + _tmp86 * fh1 +
                        _tmp93 * fh1 + _tmp97 * fh1);
  _res(2, 0) = -(_tmp101 - _tmp102 * _tmp56 + _tmp105) *
               std::exp(-_tmp101 * fh1 + _tmp103 * _tmp56 + _tmp104 * _tmp56 - _tmp105 * fh1);
  _res(3, 0) =
      -(_tmp102 + _tmp106 + _tmp107) * std::exp(-_tmp103 - _tmp104 - _tmp106 * fh1 - _tmp107 * fh1);
