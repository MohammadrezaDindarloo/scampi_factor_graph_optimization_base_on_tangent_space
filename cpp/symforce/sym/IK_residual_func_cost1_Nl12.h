...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl12(
  ...
  const Scalar _tmp27 = Scalar(0.20999999999999999) * _tmp5 + Scalar(0.20999999999999999) * _tmp8;
  ...
  const Scalar _tmp70 = _tmp31 + _tmp59;
  const Scalar _tmp71 = _tmp52 * _tmp57;
  const Scalar _tmp72 = -_tmp58 * _tmp69 + _tmp70 * _tmp71;
  const Scalar _tmp73 = _tmp46 * _tmp47;
  const Scalar _tmp74 = -_tmp48 + _tmp68 * _tmp73;
  const Scalar _tmp75 = Scalar(1.0) / (_tmp58 * _tmp68 - _tmp71);
  const Scalar _tmp76 = _tmp74 * _tmp75;
  const Scalar _tmp77 = _tmp38 * _tmp48 - _tmp69 * _tmp73 - _tmp72 * _tmp76;
  const Scalar _tmp78 = Scalar(1.0) * _tmp61;
  const Scalar _tmp79 = -_tmp78;
  const Scalar _tmp80 = Scalar(1.0) / (_tmp50 + _tmp79);
  const Scalar _tmp81 = Scalar(1.0) * _tmp64;
  const Scalar _tmp82 = -_tmp54 + _tmp81;
  const Scalar _tmp83 = _tmp80 * _tmp82;
  const Scalar _tmp84 = _tmp75 * (_tmp58 * _tmp60 - _tmp58 * _tmp70);
  const Scalar _tmp85 = -_tmp38 * _tmp73 + _tmp60 * _tmp73 - _tmp74 * _tmp84 - _tmp77 * _tmp83;
  const Scalar _tmp86 = Scalar(1.0) / (_tmp85);
  const Scalar _tmp87 = _tmp78 * _tmp83 + _tmp81;
  const Scalar _tmp88 = 0;
  const Scalar _tmp89 = _tmp40 + _tmp79;
  const Scalar _tmp90 = _tmp83 * _tmp89;
  const Scalar _tmp91 = Scalar(1.0) / (-_tmp44 + _tmp81 - _tmp90);
  ...
  const Scalar _tmp98 = _tmp67 * _tmp96;
  const Scalar _tmp99 = _tmp98 * (-_tmp61 * _tmp66 * _tmp97 + _tmp63 * _tmp64 * _tmp97);
  const Scalar _tmp100 = _tmp50 * _tmp58 - _tmp54 * _tmp71 + _tmp58 * _tmp99;
  const Scalar _tmp101 = Scalar(1.0) * _tmp75;
  const Scalar _tmp102 = _tmp72 * _tmp75 * _tmp82 * _tmp94 - Scalar(1.0) * _tmp84;
  const Scalar _tmp103 = -_tmp100 * _tmp76 + _tmp40 * _tmp73 - _tmp44 * _tmp48 + _tmp73 * _tmp99;
  const Scalar _tmp104 = _tmp103 * _tmp86;
  const Scalar _tmp105 = Scalar(1.0) / (_tmp103);
  const Scalar _tmp106 = _tmp105 * _tmp85;
  const Scalar _tmp107 = _tmp106 * (-_tmp100 * _tmp101 - _tmp102 * _tmp104);
  const Scalar _tmp108 = _tmp89 * _tmp91;
  const Scalar _tmp109 = _tmp86 * (_tmp102 + _tmp107);
  const Scalar _tmp110 = -_tmp101 * _tmp72 + _tmp107 * _tmp108 - _tmp109 * _tmp77;
  const Scalar _tmp111 = _tmp30 + Scalar(-4.7752063900000001);
  const Scalar _tmp112 = _tmp20 + Scalar(-2.71799795);
  ...
  const Scalar _tmp116 = _tmp35 * fh1;
  const Scalar _tmp117 = -_tmp114 * _tmp116 - Scalar(5.1796800000000003) * _tmp25 - _tmp29 * fv1;
  const Scalar _tmp118 = _tmp83 * _tmp95;
  const Scalar _tmp119 = _tmp90 * _tmp95 + Scalar(1.0);
  const Scalar _tmp120 = _tmp106 * _tmp95;
  const Scalar _tmp121 = Scalar(1.0) * _tmp105;
  const Scalar _tmp122 = _tmp89 * _tmp95;
  const Scalar _tmp123 = _tmp106 * _tmp122 - _tmp121 * _tmp77;
  const Scalar _tmp124 = _tmp112 * _tmp113;
  const Scalar _tmp125 = fh1 * (_tmp114 * _tmp19 - _tmp124 * _tmp29);
  const Scalar _tmp126 = _tmp68 * _tmp75;
  const Scalar _tmp127 = _tmp126 * _tmp72 + _tmp69;
  const Scalar _tmp128 = -_tmp127 * _tmp83 - _tmp60 + _tmp68 * _tmp84;
  const Scalar _tmp129 = _tmp106 * (_tmp100 * _tmp126 - _tmp104 * _tmp128 - _tmp99);
  const Scalar _tmp130 = _tmp86 * (_tmp128 + _tmp129);
  const Scalar _tmp131 = _tmp108 * _tmp129 + _tmp127 - _tmp130 * _tmp77;
  const Scalar _tmp132 = _tmp124 * fh1;
  const Scalar _tmp133 = _tmp116 * _tmp124 + Scalar(5.1796800000000003) * _tmp13 + _tmp19 * fv1;
  const Scalar _tmp134 = -_tmp109 * _tmp74 + Scalar(1.0);
  const Scalar _tmp135 = _tmp58 * _tmp75;
  const Scalar _tmp136 = _tmp101 * _tmp105 * _tmp74;
  const Scalar _tmp137 = -_tmp130 * _tmp74 - _tmp68;
  const Scalar _tmp138 = -_tmp115 * _tmp98 * (_tmp109 * _tmp73 + _tmp134 * _tmp135) -
                         _tmp125 * _tmp98 * (_tmp121 * _tmp73 - _tmp136 * _tmp58) -
                         _tmp132 * _tmp98 * (_tmp130 * _tmp73 + _tmp135 * _tmp137 + Scalar(1.0)) -
                         _tmp36 * _tmp98 * (-_tmp58 * _tmp76 * _tmp88 + _tmp73 * _tmp88);
  const Scalar _tmp139 = Scalar(1.0) / (_tmp138);
  const Scalar _tmp140 = std::asinh(
      _tmp139 * (Scalar(1.0) * _tmp115 * (_tmp107 * _tmp95 - _tmp110 * _tmp94) +
                 Scalar(1.0) * _tmp117 * (_tmp118 - _tmp119 * _tmp94) +
                 Scalar(1.0) * _tmp125 * (_tmp120 - _tmp123 * _tmp94) +
                 Scalar(1.0) * _tmp132 * (_tmp129 * _tmp95 - _tmp131 * _tmp94) +
                 Scalar(1.0) * _tmp133 * (_tmp122 * _tmp80 - _tmp95) +
                 Scalar(1.0) * _tmp36 * (-_tmp87 * _tmp95 - _tmp93 * _tmp94 + Scalar(1.0))));
  const Scalar _tmp141 = Scalar(9.6622558468725703) * _tmp138;
  const Scalar _tmp142 = _tmp36 * _tmp88;
  const Scalar _tmp143 = _tmp115 * _tmp134 * _tmp75 - _tmp125 * _tmp136 +
                         _tmp132 * _tmp137 * _tmp75 - _tmp142 * _tmp76;
  const Scalar _tmp144 = Scalar(1.0) / (_tmp143);
  const Scalar _tmp145 = _tmp133 * _tmp95;
  const Scalar _tmp146 =
      std::asinh(_tmp144 * (_tmp110 * _tmp115 * _tmp80 + _tmp117 * _tmp119 * _tmp80 +
                            _tmp123 * _tmp125 * _tmp80 + _tmp131 * _tmp132 * _tmp80 -
                            _tmp145 * _tmp80 * _tmp89 + _tmp36 * _tmp80 * _tmp93));
  const Scalar _tmp147 = Scalar(9.6622558468725703) * _tmp143;
  const Scalar _tmp148 = _tmp109 * _tmp115 + _tmp121 * _tmp125 + _tmp130 * _tmp132 + _tmp142;
  const Scalar _tmp149 = Scalar(1.0) / (_tmp148);
  const Scalar _tmp150 =
      std::asinh(_tmp149 * (-_tmp107 * _tmp115 * _tmp91 - _tmp117 * _tmp118 - _tmp120 * _tmp125 -
                            _tmp129 * _tmp132 * _tmp91 + _tmp145 + _tmp36 * _tmp92));
           ...
           std::cosh(
               ...
               (-_tmp140 * _tmp141 -
                Scalar(8.3196563700000006) *
                    std::sqrt(Scalar(
                        std::pow(Scalar(-Scalar(0.12019727204189803) * _tmp62 - 1), Scalar(2)) +
  ...
  _res(2, 0) =
      -_tmp147 *
          (Scalar(0.87653584775870996) * _tmp144 + std::cosh(Scalar(1.0) * _tmp146) -
           std::cosh(
           ...
           std::cosh(
               ...
               (-_tmp150 * _tmp151 -
                Scalar(4.8333311099999996) *
                    std::sqrt(Scalar(
                        std::pow(Scalar(1 - Scalar(0.20689664689659551) * _tmp41), Scalar(2)) +
