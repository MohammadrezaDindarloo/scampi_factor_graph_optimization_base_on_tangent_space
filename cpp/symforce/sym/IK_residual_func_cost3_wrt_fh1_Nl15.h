...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl15(
  ...
  const Scalar _tmp31 = -Scalar(0.010999999999999999) * _tmp10 -
  ...
  const Scalar _tmp47 = _tmp30 * _tmp46 - _tmp38;
  ...
  const Scalar _tmp51 = _tmp50 + position_vector(0, 0) + Scalar(1.79662371);
  ...
  const Scalar _tmp55 = Scalar(1.0) / (_tmp46 * _tmp54 - _tmp53);
  const Scalar _tmp56 = _tmp33 + _tmp36;
  const Scalar _tmp57 = _tmp35 * _tmp46;
  const Scalar _tmp58 = _tmp55 * (_tmp53 * _tmp56 - _tmp54 * _tmp57);
  const Scalar _tmp59 = Scalar(1.0) * _tmp40;
  const Scalar _tmp60 = Scalar(1.0) * _tmp44;
  const Scalar _tmp61 = (-_tmp50 + _tmp59) / (_tmp48 - _tmp60);
  const Scalar _tmp62 = _tmp55 * (_tmp35 * _tmp54 - _tmp54 * _tmp56);
  const Scalar _tmp63 = _tmp30 * _tmp35 - _tmp30 * _tmp37 - _tmp47 * _tmp62 -
                        _tmp61 * (-_tmp30 * _tmp57 + _tmp37 * _tmp38 - _tmp47 * _tmp58);
  const Scalar _tmp64 = Scalar(1.0) / (_tmp63);
  const Scalar _tmp65 = -_tmp35 + _tmp46 * _tmp62 - _tmp61 * (_tmp46 * _tmp58 + _tmp57);
  const Scalar _tmp66 =
      std::sqrt(Scalar(std::pow(_tmp41, Scalar(2)) + std::pow(_tmp45, Scalar(2))));
  const Scalar _tmp67 = Scalar(1.0) / (_tmp66);
  const Scalar _tmp68 = _tmp42 * _tmp66;
  const Scalar _tmp69 = _tmp68 * (_tmp40 * _tmp45 * _tmp67 - _tmp41 * _tmp44 * _tmp67);
  const Scalar _tmp70 = _tmp55 * (_tmp48 * _tmp54 - _tmp50 * _tmp53 + _tmp54 * _tmp69);
  const Scalar _tmp71 = -_tmp17 * _tmp38 + _tmp27 * _tmp30 + _tmp30 * _tmp69 - _tmp47 * _tmp70;
  const Scalar _tmp72 = _tmp64 * _tmp71;
  const Scalar _tmp73 = Scalar(1.0) / (_tmp71);
  const Scalar _tmp74 = _tmp63 * _tmp73;
  const Scalar _tmp75 = _tmp65 + _tmp74 * (_tmp46 * _tmp70 - _tmp65 * _tmp72 - _tmp69);
  const Scalar _tmp76 = _tmp64 * _tmp75;
  const Scalar _tmp77 = _tmp47 * _tmp64;
  const Scalar _tmp78 = _tmp55 * (-_tmp46 - _tmp75 * _tmp77);
  const Scalar _tmp79 = _tmp39 + _tmp8;
  const Scalar _tmp80 = _tmp79 + position_vector(0, 0) + Scalar(-2.71799795);
  const Scalar _tmp81 = _tmp20 + _tmp43;
  const Scalar _tmp82 = _tmp81 + position_vector(1, 0) + Scalar(-4.7752063900000001);
  const Scalar _tmp83 = std::pow(Scalar(std::pow(_tmp80, Scalar(2)) + std::pow(_tmp82, Scalar(2))),
                                 Scalar(Scalar(-1) / Scalar(2)));
  const Scalar _tmp84 = _tmp80 * _tmp83;
  const Scalar _tmp85 = _tmp68 * _tmp84 * (_tmp30 * _tmp76 + _tmp54 * _tmp78 + Scalar(1.0));
  const Scalar _tmp86 = Scalar(1.0) * _tmp58 * _tmp61 - Scalar(1.0) * _tmp62;
  const Scalar _tmp87 = _tmp74 * (-Scalar(1.0) * _tmp70 - _tmp72 * _tmp86) + _tmp86;
  const Scalar _tmp88 = _tmp55 * (-_tmp77 * _tmp87 + Scalar(1.0));
  const Scalar _tmp89 = _tmp64 * _tmp87;
  const Scalar _tmp90 = _tmp82 * _tmp83;
  const Scalar _tmp91 = _tmp68 * _tmp90 * (_tmp30 * _tmp89 + _tmp54 * _tmp88);
  const Scalar _tmp92 = _tmp79 * _tmp90 - _tmp81 * _tmp84;
  const Scalar _tmp93 = Scalar(1.0) * _tmp73;
  const Scalar _tmp94 = _tmp47 * _tmp55;
  const Scalar _tmp95 = _tmp54 * _tmp94;
  const Scalar _tmp96 = _tmp68 * _tmp92 * (_tmp30 * _tmp93 - _tmp93 * _tmp95);
  const Scalar _tmp97 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp98 = _tmp59 + _tmp60 * _tmp61;
  ...
  const Scalar _tmp103 = _tmp78 * _tmp84;
  const Scalar _tmp104 = _tmp88 * _tmp90;
  const Scalar _tmp105 = _tmp89 * _tmp90;
  const Scalar _tmp106 = _tmp76 * _tmp84;

  // Output terms (1)
  Eigen::Matrix<Scalar, 4, 1> _res;

  _res(0, 0) = -std::exp(-fh1);
  _res(1, 0) = -(-_tmp85 - _tmp91 - _tmp96) *
               std::exp(_tmp68 * _tmp97 * (_tmp30 * _tmp99 - _tmp95 * _tmp99) + _tmp85 * fh1 +
                        _tmp91 * fh1 + _tmp96 * fh1);
  _res(2, 0) = -(-_tmp101 * _tmp94 + _tmp103 + _tmp104) *
               std::exp(_tmp100 * _tmp94 + _tmp102 * _tmp94 - _tmp103 * fh1 - _tmp104 * fh1);
  _res(3, 0) =
