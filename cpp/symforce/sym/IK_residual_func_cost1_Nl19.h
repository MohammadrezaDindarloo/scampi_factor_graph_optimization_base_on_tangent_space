...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl19(
  ...
  const Scalar _tmp23 = Scalar(0.20999999999999999) * _tmp5 + Scalar(0.20999999999999999) * _tmp9;
  ...
  const Scalar _tmp62 = _tmp32 + _tmp36;
  const Scalar _tmp63 = _tmp22 + _tmp42;
  const Scalar _tmp64 = _tmp63 + position_vector(1, 0);
  const Scalar _tmp65 = _tmp64 + Scalar(-4.7752063900000001);
  const Scalar _tmp66 = _tmp10 + _tmp47;
  ...
  const Scalar _tmp73 = _tmp45 * _tmp51;
  const Scalar _tmp74 = _tmp52 * _tmp60 - _tmp73;
  const Scalar _tmp75 = Scalar(1.0) / (_tmp60 * _tmp71 - _tmp70);
  const Scalar _tmp76 = _tmp74 * _tmp75;
  const Scalar _tmp77 = _tmp32 + _tmp39;
  const Scalar _tmp78 = -_tmp52 * _tmp61 - _tmp72 * _tmp76 + _tmp73 * _tmp77;
  ...
  const Scalar _tmp84 = _tmp75 * (_tmp40 * _tmp71 - _tmp62 * _tmp71);
  const Scalar _tmp85 = _tmp40 * _tmp52 - _tmp52 * _tmp77 - _tmp74 * _tmp84 - _tmp78 * _tmp83;
  ...
  const Scalar _tmp91 = _tmp74 * _tmp86;
  ...
  const Scalar _tmp98 = _tmp60 * _tmp75;
  const Scalar _tmp99 = _tmp61 + _tmp72 * _tmp98;
  const Scalar _tmp100 = -_tmp40 + _tmp60 * _tmp84 - _tmp83 * _tmp99;
  const Scalar _tmp101 = _tmp43 * _tmp52 - _tmp48 * _tmp73 + _tmp52 * _tmp96 - _tmp76 * _tmp97;
  ...
  const Scalar _tmp107 = _tmp52 * _tmp86;
  const Scalar _tmp108 = -_tmp106 * _tmp91 - _tmp60;
  ...
  const Scalar _tmp116 = _tmp115 * _tmp83 - Scalar(1.0) * _tmp84;
  const Scalar _tmp117 = _tmp104 * (-_tmp102 * _tmp116 - _tmp114 * _tmp97);
  const Scalar _tmp118 = _tmp116 + _tmp117;
  const Scalar _tmp119 = -_tmp118 * _tmp91 + Scalar(1.0);
  const Scalar _tmp120 = _tmp110 * _tmp111;
  const Scalar _tmp121 = _tmp120 * fh1;
  const Scalar _tmp122 = _tmp103 * _tmp114 * _tmp74;
  const Scalar _tmp123 = Scalar(1.0) * _tmp103;
  const Scalar _tmp124 = fh1 * (-_tmp112 * _tmp29 + _tmp120 * _tmp19);
  const Scalar _tmp125 = -_tmp113 * _tmp94 * (_tmp106 * _tmp107 + _tmp108 * _tmp90 + Scalar(1.0)) -
                         _tmp121 * _tmp94 * (_tmp107 * _tmp118 + _tmp119 * _tmp90) -
                         _tmp124 * _tmp94 * (-_tmp122 * _tmp71 + _tmp123 * _tmp52) -
                         _tmp38 * _tmp94 * (_tmp52 * _tmp89 - _tmp90 * _tmp92);
  const Scalar _tmp126 = Scalar(1.0) / (_tmp125);
  const Scalar _tmp127 = _tmp78 * _tmp86;
  const Scalar _tmp128 = _tmp43 + _tmp80;
  const Scalar _tmp129 = _tmp128 * _tmp83;
  const Scalar _tmp130 = Scalar(1.0) / (-_tmp129 - _tmp48 + _tmp82);
  ...
  const Scalar _tmp135 = -_tmp115 + _tmp117 * _tmp131 - _tmp118 * _tmp127;
  const Scalar _tmp136 = _tmp128 * _tmp134;
  const Scalar _tmp137 = _tmp37 * fh1;
  const Scalar _tmp138 = _tmp112 * _tmp137 + Scalar(5.1796800000000003) * _tmp16 + _tmp19 * fv1;
  const Scalar _tmp139 = _tmp130 * _tmp87;
  const Scalar _tmp140 = _tmp81 * (-_tmp128 * _tmp139 - _tmp78 * _tmp89 + _tmp80);
  const Scalar _tmp141 = _tmp81 * (_tmp129 * _tmp134 + Scalar(1.0));
  const Scalar _tmp142 = _tmp134 * _tmp83;
  const Scalar _tmp143 = -_tmp120 * _tmp137 - Scalar(5.1796800000000003) * _tmp26 - _tmp29 * fv1;
  const Scalar _tmp144 = _tmp104 * _tmp134;
  const Scalar _tmp145 = _tmp104 * _tmp136 - _tmp123 * _tmp78;
  const Scalar _tmp146 = std::asinh(
      _tmp126 * (Scalar(1.0) * _tmp113 * (_tmp105 * _tmp134 - _tmp132 * _tmp133) +
                 Scalar(1.0) * _tmp121 * (_tmp117 * _tmp134 - _tmp133 * _tmp135) +
                 Scalar(1.0) * _tmp124 * (-_tmp133 * _tmp145 + _tmp144) +
                 Scalar(1.0) * _tmp138 * (-_tmp134 + _tmp136 * _tmp81) +
                 Scalar(1.0) * _tmp143 * (-Scalar(1.0) * _tmp141 + _tmp142) +
                 Scalar(1.0) * _tmp38 * (-_tmp134 * _tmp87 - Scalar(1.0) * _tmp140 + Scalar(1.0))));
  const Scalar _tmp147 = Scalar(9.6622558468725703) * _tmp125;
  const Scalar _tmp148 = _tmp108 * _tmp113 * _tmp75 + _tmp119 * _tmp121 * _tmp75 -
                         _tmp122 * _tmp124 - _tmp38 * _tmp75 * _tmp92;
  const Scalar _tmp149 = Scalar(1.0) / (_tmp148);
  const Scalar _tmp150 = _tmp134 * _tmp138;
  const Scalar _tmp151 =
      std::asinh(_tmp149 * (_tmp113 * _tmp132 * _tmp81 + _tmp121 * _tmp135 * _tmp81 +
                            _tmp124 * _tmp145 * _tmp81 - _tmp128 * _tmp150 * _tmp81 +
                            _tmp140 * _tmp38 + _tmp141 * _tmp143));
  const Scalar _tmp152 = Scalar(9.6622558468725703) * _tmp148;
  const Scalar _tmp153 =
      _tmp106 * _tmp113 * _tmp86 + _tmp118 * _tmp121 * _tmp86 + _tmp123 * _tmp124 + _tmp38 * _tmp89;
  const Scalar _tmp154 = Scalar(1.0) / (_tmp153);
  const Scalar _tmp155 =
      std::asinh(_tmp154 * (-_tmp105 * _tmp113 * _tmp130 - _tmp117 * _tmp121 * _tmp130 -
                            _tmp124 * _tmp144 + _tmp139 * _tmp38 - _tmp142 * _tmp143 + _tmp150));
  ...
  _res(1, 0) =
      -_tmp147 *
          (Scalar(0.87679799772039002) * _tmp126 + std::cosh(Scalar(1.0) * _tmp146) -
           std::cosh(
  ...
  _res(2, 0) =
      -_tmp152 *
          (Scalar(0.86565325453551001) * _tmp149 + std::cosh(Scalar(1.0) * _tmp151) -
           std::cosh(
