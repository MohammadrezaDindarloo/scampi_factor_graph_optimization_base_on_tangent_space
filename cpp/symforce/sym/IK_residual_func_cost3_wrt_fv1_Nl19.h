...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl19(
  ...
  const Scalar _tmp30 = -Scalar(0.010999999999999999) * _tmp10 -
  ...
  const Scalar _tmp34 = _tmp30 - _tmp31 + _tmp33;
  ...
  const Scalar _tmp44 = _tmp18 * _tmp28;
  const Scalar _tmp45 = _tmp29 * _tmp42 - _tmp44;
  ...
  const Scalar _tmp58 = _tmp34 * _tmp54;
  const Scalar _tmp59 = _tmp55 * (-_tmp42 * _tmp58 + _tmp53 * _tmp57);
  const Scalar _tmp60 = _tmp33 + _tmp56;
  const Scalar _tmp61 = Scalar(1.0) * _tmp39;
  const Scalar _tmp62 = Scalar(1.0) * _tmp36;
  const Scalar _tmp63 = (-_tmp50 + _tmp61) / (_tmp47 - _tmp62);
  const Scalar _tmp64 = _tmp55 * (-_tmp54 * _tmp57 + _tmp58);
  const Scalar _tmp65 = _tmp29 * _tmp34 - _tmp29 * _tmp60 - _tmp45 * _tmp64 -
                        _tmp63 * (-_tmp29 * _tmp43 + _tmp44 * _tmp60 - _tmp45 * _tmp59);
  ...
  const Scalar _tmp73 = _tmp72 * (_tmp29 * _tmp68 - _tmp68 * _tmp70);
  const Scalar _tmp74 = Scalar(1.0) / (_tmp71);
  const Scalar _tmp75 = _tmp72 * (-_tmp36 * _tmp40 * _tmp74 + _tmp37 * _tmp39 * _tmp74);
  const Scalar _tmp76 = _tmp55 * (_tmp47 * _tmp54 - _tmp50 * _tmp53 + _tmp54 * _tmp75);
  const Scalar _tmp77 = -_tmp34 + _tmp42 * _tmp64 - _tmp63 * (_tmp42 * _tmp59 + _tmp43);
  const Scalar _tmp78 = _tmp17 * _tmp29 - _tmp26 * _tmp44 + _tmp29 * _tmp75 - _tmp45 * _tmp76;
  const Scalar _tmp79 = _tmp66 * _tmp78;
  const Scalar _tmp80 = Scalar(1.0) / (_tmp78);
  const Scalar _tmp81 = _tmp65 * _tmp80;
  const Scalar _tmp82 = _tmp77 + _tmp81 * (_tmp42 * _tmp76 - _tmp75 - _tmp77 * _tmp79);
  const Scalar _tmp83 = _tmp29 * _tmp66;
  const Scalar _tmp84 = _tmp45 * _tmp66;
  const Scalar _tmp85 = -_tmp42 - _tmp82 * _tmp84;
  const Scalar _tmp86 = _tmp38 + _tmp49;
  const Scalar _tmp87 = _tmp86 + position_vector(0, 0) + Scalar(1.79662371);
  const Scalar _tmp88 = _tmp35 + _tmp46;
  const Scalar _tmp89 = _tmp88 + position_vector(1, 0) + Scalar(-4.8333311099999996);
  ...
  const Scalar _tmp93 = Scalar(1.0) * _tmp59 * _tmp63 - Scalar(1.0) * _tmp64;
  const Scalar _tmp94 = _tmp81 * (-Scalar(1.0) * _tmp76 - _tmp79 * _tmp93) + _tmp93;
  ...
  const Scalar _tmp99 = fh1 * (_tmp86 * _tmp96 - _tmp88 * _tmp91);
  const Scalar _tmp100 = _tmp98 * _tmp99;
  const Scalar _tmp101 = _tmp45 * _tmp55;
  ...
  _res(1, 0) =
      -_tmp73 * std::exp(_tmp0 * _tmp73 +
                         _tmp72 * _tmp92 * (_tmp69 * _tmp85 + _tmp82 * _tmp83 + Scalar(1.0)) +
                         _tmp72 * _tmp97 * (_tmp69 * _tmp95 + _tmp83 * _tmp94) +
                         _tmp72 * _tmp99 * (_tmp29 * _tmp98 - _tmp70 * _tmp98));
  _res(2, 0) = -_tmp101 * _tmp68 *
               std::exp(_tmp100 * _tmp101 + _tmp101 * _tmp102 - _tmp55 * _tmp85 * _tmp92 -
                        _tmp55 * _tmp95 * _tmp97);
  _res(3, 0) =
      _tmp68 * std::exp(-_tmp100 - _tmp102 - _tmp66 * _tmp82 * _tmp92 - _tmp66 * _tmp94 * _tmp97);
