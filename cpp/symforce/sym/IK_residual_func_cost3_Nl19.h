...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl19(
  ...
  const Scalar _tmp27 = _tmp26 + position_vector(0, 0) + Scalar(-2.5202214700000001);
  const Scalar _tmp28 = std::pow(Scalar(std::pow(_tmp18, Scalar(2)) + std::pow(_tmp27, Scalar(2))),
                                 Scalar(Scalar(-1) / Scalar(2)));
  const Scalar _tmp29 = _tmp27 * _tmp28;
  const Scalar _tmp30 = -_tmp9;
  ...
  const Scalar _tmp36 = _tmp23 + _tmp24;
  const Scalar _tmp37 = _tmp20 + _tmp36;
  const Scalar _tmp38 = _tmp12 + _tmp15;
  const Scalar _tmp39 = _tmp38 + _tmp9;
  const Scalar _tmp40 = (_tmp35 - _tmp37) / (-_tmp32 + _tmp39);
  const Scalar _tmp41 = _tmp32 * _tmp40 + _tmp35;
  const Scalar _tmp42 = -Scalar(0.010999999999999999) * _tmp10 -
  ...
  const Scalar _tmp44 = Scalar(0.20999999999999999) * _tmp13 + Scalar(0.20999999999999999) * _tmp14;
  const Scalar _tmp45 = -_tmp44;
  const Scalar _tmp46 = _tmp42 - _tmp43 + _tmp45;
  const Scalar _tmp47 = _tmp31 + position_vector(1, 0) + Scalar(8.3196563700000006);
  const Scalar _tmp48 = _tmp34 + position_vector(0, 0) + Scalar(1.9874742000000001);
  const Scalar _tmp49 = Scalar(1.0) / (_tmp48);
  const Scalar _tmp50 = _tmp47 * _tmp49;
  const Scalar _tmp51 = _tmp46 * _tmp50;
  const Scalar _tmp52 = _tmp18 * _tmp28;
  const Scalar _tmp53 = _tmp29 * _tmp50 - _tmp52;
  const Scalar _tmp54 = _tmp39 + position_vector(1, 0) + Scalar(-4.7752063900000001);
  const Scalar _tmp55 = _tmp37 + position_vector(0, 0) + Scalar(-2.71799795);
  ...
  const Scalar _tmp59 = Scalar(1.0) / (_tmp50 * _tmp58 - _tmp57);
  const Scalar _tmp60 = _tmp42 + _tmp43;
  const Scalar _tmp61 = _tmp44 + _tmp60;
  const Scalar _tmp62 = _tmp59 * (-_tmp51 * _tmp58 + _tmp57 * _tmp61);
  const Scalar _tmp63 = _tmp45 + _tmp60;
  const Scalar _tmp64 = _tmp59 * (_tmp46 * _tmp58 - _tmp58 * _tmp61);
  const Scalar _tmp65 = _tmp29 * _tmp46 - _tmp29 * _tmp63 -
                        _tmp40 * (-_tmp29 * _tmp51 + _tmp52 * _tmp63 - _tmp53 * _tmp62) -
                        _tmp53 * _tmp64;
  ...
  const Scalar _tmp73 = _tmp71 * (-_tmp31 * _tmp48 * _tmp72 + _tmp34 * _tmp47 * _tmp72);
  const Scalar _tmp74 = _tmp59 * (-_tmp37 * _tmp57 + _tmp39 * _tmp58 + _tmp58 * _tmp73);
  const Scalar _tmp75 = -_tmp40 * (_tmp50 * _tmp62 + _tmp51) - _tmp46 + _tmp50 * _tmp64;
  const Scalar _tmp76 = _tmp17 * _tmp29 - _tmp26 * _tmp52 + _tmp29 * _tmp73 - _tmp53 * _tmp74;
  const Scalar _tmp77 = _tmp66 * _tmp76;
  const Scalar _tmp78 = Scalar(1.0) / (_tmp76);
  const Scalar _tmp79 = _tmp65 * _tmp78;
  const Scalar _tmp80 = _tmp75 + _tmp79 * (_tmp50 * _tmp74 - _tmp73 - _tmp75 * _tmp77);
  const Scalar _tmp81 = _tmp29 * _tmp66;
  const Scalar _tmp82 = _tmp53 * _tmp66;
  const Scalar _tmp83 = -_tmp50 - _tmp80 * _tmp82;
  const Scalar _tmp84 = _tmp33 + _tmp36;
  const Scalar _tmp85 = _tmp84 + position_vector(0, 0) + Scalar(1.79662371);
  const Scalar _tmp86 = _tmp30 + _tmp38;
  ...
  const Scalar _tmp90 = _tmp71 * fh1;
  const Scalar _tmp91 = Scalar(1.0) * _tmp40 * _tmp62 - Scalar(1.0) * _tmp64;
  const Scalar _tmp92 = _tmp79 * (-Scalar(1.0) * _tmp74 - _tmp77 * _tmp91) + _tmp91;
  const Scalar _tmp93 = -_tmp82 * _tmp92 + Scalar(1.0);
  const Scalar _tmp94 = _tmp87 * _tmp88;
  const Scalar _tmp95 = Scalar(1.0) * _tmp78;
  const Scalar _tmp96 = fh1 * (_tmp84 * _tmp94 - _tmp86 * _tmp89);
  const Scalar _tmp97 = _tmp59 * fh1;
  const Scalar _tmp98 = _tmp95 * _tmp96;
  const Scalar _tmp99 = _tmp53 * _tmp59;
  const Scalar _tmp100 = _tmp0 * _tmp67;
  const Scalar _tmp101 = _tmp66 * fh1;

  // Output terms (1)
  Eigen::Matrix<Scalar, 4, 1> _res;

  _res(0, 0) = std::exp(-fh1);
  _res(1, 0) = std::exp(_tmp0 * _tmp71 * (_tmp29 * _tmp67 - _tmp67 * _tmp69) +
                        _tmp71 * _tmp96 * (_tmp29 * _tmp95 - _tmp69 * _tmp95) +
                        _tmp89 * _tmp90 * (_tmp68 * _tmp83 + _tmp80 * _tmp81 + Scalar(1.0)) +
                        _tmp90 * _tmp94 * (_tmp68 * _tmp93 + _tmp81 * _tmp92));
  _res(2, 0) = std::exp(_tmp100 * _tmp99 - _tmp83 * _tmp89 * _tmp97 - _tmp93 * _tmp94 * _tmp97 +
                        _tmp98 * _tmp99);
  _res(3, 0) = std::exp(-_tmp100 - _tmp101 * _tmp80 * _tmp89 - _tmp101 * _tmp92 * _tmp94 - _tmp98);
