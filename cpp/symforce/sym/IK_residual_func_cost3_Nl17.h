...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl17(
  ...
  const Scalar _tmp17 = _tmp1 * _tmp4;
  ...
  const Scalar _tmp27 = Scalar(0.20999999999999999) * _tmp21 + Scalar(0.20999999999999999) * _tmp7;
  const Scalar _tmp28 =
  ...
  const Scalar _tmp46 = _tmp13 + _tmp45 + _tmp9;
  ...
  const Scalar _tmp92 = _tmp43 * _tmp65;
  const Scalar _tmp93 = Scalar(1.0) * _tmp49;
  const Scalar _tmp94 = _tmp48 * _tmp53 * _tmp93 - _tmp54 * _tmp93;
  const Scalar _tmp95 = _tmp76 * (-_tmp72 * _tmp93 - _tmp74 * _tmp94) + _tmp94;
  ...
  const Scalar _tmp100 = fh1 * (_tmp82 * _tmp97 - _tmp84 * _tmp87);
  ...
  _res(1, 0) = std::exp(_tmp100 * _tmp70 * (_tmp63 * _tmp99 - _tmp92 * _tmp99) +
                        _tmp70 * _tmp88 * (_tmp77 * _tmp81 + _tmp79 * _tmp80 + Scalar(1.0)) +
                        _tmp70 * _tmp89 * (_tmp63 * _tmp91 - _tmp91 * _tmp92) +
                        _tmp70 * _tmp98 * (_tmp80 * _tmp96 + _tmp81 * _tmp95));
  _res(2, 0) = std::exp(_tmp101 * _tmp65 + _tmp102 * _tmp65 - _tmp49 * _tmp79 * _tmp88 -
                        _tmp49 * _tmp96 * _tmp98);
  _res(3, 0) = std::exp(-_tmp101 - _tmp102 - _tmp67 * _tmp77 * _tmp88 - _tmp67 * _tmp95 * _tmp98);
