...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl17(
  ...
  const Scalar _tmp24 = Scalar(0.20999999999999999) * _tmp2 - Scalar(0.20999999999999999) * _tmp6;
  ...
  const Scalar _tmp53 = _tmp44 * (-_tmp43 * _tmp52 + _tmp50);
  ...
  const Scalar _tmp57 = _tmp44 * (_tmp30 * _tmp52 - _tmp42 * _tmp50);
  const Scalar _tmp58 = -Scalar(1.0) * _tmp53 + Scalar(1.0) * _tmp56 * _tmp57;
  const Scalar _tmp59 = _tmp15 + _tmp31;
  ...
  const Scalar _tmp69 = -_tmp53 * _tmp67 -
                        _tmp56 * (-_tmp42 * _tmp65 - _tmp57 * _tmp67 + _tmp66 * _tmp68) -
                        _tmp64 * _tmp68 + _tmp65;
  ...
  const Scalar _tmp74 = _tmp73 * (-_tmp33 * _tmp40 * _tmp72 + _tmp35 * _tmp38 * _tmp72);
  const Scalar _tmp75 = _tmp44 * (_tmp16 * _tmp43 - _tmp26 * _tmp30 + _tmp43 * _tmp74);
  const Scalar _tmp76 = _tmp59 * _tmp64 - _tmp61 * _tmp66 + _tmp64 * _tmp74 - _tmp67 * _tmp75;
  const Scalar _tmp77 = _tmp70 * _tmp76;
  const Scalar _tmp78 = Scalar(1.0) / (_tmp76);
  const Scalar _tmp79 = _tmp69 * _tmp78;
  const Scalar _tmp80 = _tmp58 + _tmp79 * (-_tmp58 * _tmp77 - Scalar(1.0) * _tmp75);
  const Scalar _tmp81 = _tmp67 * _tmp70;
  const Scalar _tmp82 = -_tmp80 * _tmp81 + Scalar(1.0);
  const Scalar _tmp83 = _tmp43 * _tmp44;
  const Scalar _tmp84 = _tmp64 * _tmp70;
  const Scalar _tmp85 = _tmp32 + _tmp7;
  ...
  const Scalar _tmp92 = _tmp42 * _tmp53 - _tmp49 - _tmp56 * (_tmp42 * _tmp49 + _tmp42 * _tmp57);
  const Scalar _tmp93 = _tmp79 * (_tmp42 * _tmp75 - _tmp74 - _tmp77 * _tmp92) + _tmp92;
  const Scalar _tmp94 = -_tmp42 - _tmp81 * _tmp93;
  ...
  const Scalar _tmp100 = _tmp54 + _tmp55 * _tmp56;
  const Scalar _tmp101 = 0;
  const Scalar _tmp102 = _tmp44 * fh1;
  const Scalar _tmp103 = _tmp101 * _tmp99;
  const Scalar _tmp104 = _tmp44 * _tmp67;
  ...
  _res(1, 0) = std::exp(_tmp73 * _tmp98 * (_tmp64 * _tmp96 - _tmp96 * _tmp97) +
                        _tmp73 * _tmp99 * (_tmp101 * _tmp64 - _tmp101 * _tmp97) +
                        _tmp90 * _tmp91 * (_tmp80 * _tmp84 + _tmp82 * _tmp83) +
                        _tmp91 * _tmp95 * (_tmp83 * _tmp94 + _tmp84 * _tmp93 + Scalar(1.0)));
  _res(2, 0) = std::exp(-_tmp102 * _tmp82 * _tmp90 - _tmp102 * _tmp94 * _tmp95 + _tmp103 * _tmp104 +
                        _tmp104 * _tmp105);
  _res(3, 0) = std::exp(-_tmp103 - _tmp105 - _tmp106 * _tmp80 * _tmp90 - _tmp106 * _tmp93 * _tmp95);
