...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2Nl18(
  ...
  const Scalar _tmp60 = _tmp41 + position_vector(1, 0);
  const Scalar _tmp61 = _tmp60 + Scalar(8.3196563700000006);
  const Scalar _tmp62 = _tmp48 + position_vector(0, 0);
  ...
  const Scalar _tmp66 = _tmp57 * _tmp58;
  ...
  const Scalar _tmp70 = _tmp47 + position_vector(0, 0);
  ...
  const Scalar _tmp75 = Scalar(1.0) / (_tmp65 * _tmp73 - _tmp74);
  const Scalar _tmp76 = -_tmp34;
  const Scalar _tmp77 = _tmp37 + _tmp76;
  const Scalar _tmp78 = _tmp35 + _tmp36;
  const Scalar _tmp79 = _tmp76 + _tmp78;
  const Scalar _tmp80 = _tmp75 * (_tmp73 * _tmp77 - _tmp73 * _tmp79);
  const Scalar _tmp81 = _tmp34 + _tmp78;
  const Scalar _tmp82 = _tmp65 * _tmp77;
  const Scalar _tmp83 = _tmp75 * (-_tmp73 * _tmp82 + _tmp74 * _tmp79);
  const Scalar _tmp84 = _tmp66 * _tmp77;
  const Scalar _tmp85 = _tmp59 * _tmp81 - _tmp65 * _tmp84 - _tmp67 * _tmp83;
  const Scalar _tmp86 = -_tmp50 * _tmp85 - _tmp66 * _tmp81 - _tmp67 * _tmp80 + _tmp84;
  const Scalar _tmp87 = Scalar(1.0) / (_tmp86);
  const Scalar _tmp88 = 0;
  const Scalar _tmp89 = _tmp73 * _tmp75;
  ...
  const Scalar _tmp94 = _tmp92 * (-_tmp41 * _tmp63 * _tmp93 + _tmp48 * _tmp61 * _tmp93);
  const Scalar _tmp95 = _tmp75 * (_tmp44 * _tmp73 - _tmp47 * _tmp74 + _tmp73 * _tmp94);
  const Scalar _tmp96 = Scalar(1.0) * _tmp83;
  const Scalar _tmp97 = _tmp50 * _tmp96 - Scalar(1.0) * _tmp80;
  const Scalar _tmp98 = _tmp52 * _tmp66 - _tmp55 * _tmp59 + _tmp66 * _tmp94 - _tmp67 * _tmp95;
  const Scalar _tmp99 = _tmp87 * _tmp98;
  const Scalar _tmp100 = Scalar(1.0) / (_tmp98);
  const Scalar _tmp101 = _tmp100 * _tmp86;
  const Scalar _tmp102 = _tmp101 * (-Scalar(1.0) * _tmp95 - _tmp97 * _tmp99);
  const Scalar _tmp103 = _tmp87 * (_tmp102 + _tmp97);
  const Scalar _tmp104 = -_tmp103 * _tmp67 + Scalar(1.0);
  const Scalar _tmp105 = _tmp30 + Scalar(-4.8333311099999996);
  ...
  const Scalar _tmp110 = _tmp65 * _tmp83 + _tmp82;
  const Scalar _tmp111 = -_tmp110 * _tmp50 + _tmp65 * _tmp80 - _tmp77;
  const Scalar _tmp112 = _tmp101 * (-_tmp111 * _tmp99 + _tmp65 * _tmp95 - _tmp94);
  const Scalar _tmp113 = _tmp87 * (_tmp111 + _tmp112);
  const Scalar _tmp114 = -_tmp113 * _tmp67 - _tmp65;
  const Scalar _tmp115 = _tmp106 * _tmp107;
  const Scalar _tmp116 = _tmp115 * fh1;
  const Scalar _tmp117 = Scalar(1.0) * _tmp100;
  const Scalar _tmp118 = fh1 * (_tmp108 * _tmp18 - _tmp115 * _tmp29);
  const Scalar _tmp119 = -_tmp109 * _tmp92 * (_tmp103 * _tmp66 + _tmp104 * _tmp89) -
                         _tmp116 * _tmp92 * (_tmp113 * _tmp66 + _tmp114 * _tmp89 + Scalar(1.0)) -
                         _tmp118 * _tmp92 * (_tmp117 * _tmp66 - _tmp117 * _tmp90) -
                         _tmp39 * _tmp92 * (_tmp66 * _tmp88 - _tmp88 * _tmp90);
  const Scalar _tmp120 = Scalar(1.0) / (_tmp119);
  const Scalar _tmp121 =
      Scalar(69.216682114881593) *
          std::pow(Scalar(-Scalar(0.12019727204189803) * _tmp60 - 1), Scalar(2)) +
      Scalar(3.9500536956656402) *
          std::pow(Scalar(-Scalar(0.50315118556004401) * _tmp62 - 1), Scalar(2));
  const Scalar _tmp122 = _tmp43 + _tmp52;
  const Scalar _tmp123 = _tmp122 * _tmp50;
  const Scalar _tmp124 = Scalar(1.0) / (-_tmp123 + _tmp49 - _tmp55);
  const Scalar _tmp125 = Scalar(1.0) * _tmp124;
  const Scalar _tmp126 = _tmp101 * _tmp125;
  const Scalar _tmp127 = -_tmp117 * _tmp85 + _tmp122 * _tmp126;
  const Scalar _tmp128 = Scalar(1.0) * _tmp45;
  const Scalar _tmp129 = _tmp122 * _tmp124;
  const Scalar _tmp130 = _tmp110 + _tmp112 * _tmp129 - _tmp113 * _tmp85;
  const Scalar _tmp131 = _tmp124 * _tmp51;
  const Scalar _tmp132 = -_tmp122 * _tmp131 + _tmp43 - _tmp85 * _tmp88;
  const Scalar _tmp133 = _tmp102 * _tmp129 - _tmp103 * _tmp85 - _tmp96;
  const Scalar _tmp134 = _tmp123 * _tmp125 + Scalar(1.0);
  const Scalar _tmp135 = _tmp125 * _tmp50;
  const Scalar _tmp136 = _tmp38 * fh1;
  const Scalar _tmp137 = -_tmp108 * _tmp136 - Scalar(5.1796800000000003) * _tmp26 - _tmp29 * fv1;
  const Scalar _tmp138 = _tmp122 * _tmp45;
  const Scalar _tmp139 = _tmp115 * _tmp136 + Scalar(5.1796800000000003) * _tmp12 + _tmp18 * fv1;
  const Scalar _tmp140 = std::asinh(
      _tmp120 * (Scalar(1.0) * _tmp109 * (_tmp102 * _tmp125 - _tmp128 * _tmp133) +
                 Scalar(1.0) * _tmp116 * (_tmp112 * _tmp125 - _tmp128 * _tmp130) +
                 Scalar(1.0) * _tmp118 * (_tmp126 - _tmp127 * _tmp128) +
                 Scalar(1.0) * _tmp137 * (-_tmp128 * _tmp134 + _tmp135) +
                 Scalar(1.0) * _tmp139 * (_tmp125 * _tmp138 - _tmp125) +
                 Scalar(1.0) * _tmp39 * (-_tmp125 * _tmp51 - _tmp128 * _tmp132 + Scalar(1.0))));
  const Scalar _tmp141 = Scalar(9.6622558468725703) * _tmp119;
  const Scalar _tmp142 = Scalar(6.351516257848961) *
  ...
  const Scalar _tmp143 = _tmp125 * _tmp139;
  const Scalar _tmp144 = _tmp39 * _tmp88;
  const Scalar _tmp145 = _tmp67 * _tmp75;
  const Scalar _tmp146 = _tmp117 * _tmp118;
  const Scalar _tmp147 = _tmp104 * _tmp109 * _tmp75 + _tmp114 * _tmp116 * _tmp75 -
                         _tmp144 * _tmp145 - _tmp145 * _tmp146;
  const Scalar _tmp148 = Scalar(1.0) / (_tmp147);
  const Scalar _tmp149 =
      std::asinh(_tmp148 * (_tmp109 * _tmp133 * _tmp45 + _tmp116 * _tmp130 * _tmp45 +
                            _tmp118 * _tmp127 * _tmp45 + _tmp132 * _tmp39 * _tmp45 +
                            _tmp134 * _tmp137 * _tmp45 - _tmp138 * _tmp143));
  const Scalar _tmp150 = Scalar(9.6622558468725703) * _tmp147;
  const Scalar _tmp151 = _tmp103 * _tmp109 + _tmp113 * _tmp116 + _tmp144 + _tmp146;
  const Scalar _tmp152 = Scalar(1.0) / (_tmp151);
  const Scalar _tmp153 =
      std::asinh(_tmp152 * (-_tmp102 * _tmp109 * _tmp124 - _tmp112 * _tmp116 * _tmp124 -
                            _tmp118 * _tmp126 + _tmp131 * _tmp39 - _tmp135 * _tmp137 + _tmp143));
  ...
  _res(1, 0) =
      _tmp141 *
          (-std::sinh(Scalar(1.0) * _tmp140) -
           std::sinh(Scalar(0.1034955) * _tmp120 * (-std::sqrt(_tmp121) - _tmp140 * _tmp141))) -
      Scalar(8.4718465799999993) *
          std::sqrt(Scalar(Scalar(0.013932974275675287) * _tmp121 +
  ...
  _res(2, 0) =
      _tmp150 *
          (-std::sinh(Scalar(1.0) * _tmp149) -
           std::sinh(Scalar(0.1034955) * _tmp148 * (-std::sqrt(_tmp142) - _tmp149 * _tmp150))) -
      Scalar(8.4693136199999994) *
          std::sqrt(Scalar(Scalar(0.013941309530580858) * _tmp142 +
                           std::pow(Scalar(-Scalar(0.11807332268798426) * _tmp79 -
