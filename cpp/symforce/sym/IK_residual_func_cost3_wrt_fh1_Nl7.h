...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl7(
  ...
  const Scalar _tmp30 = Scalar(0.20999999999999999) * _tmp21 + Scalar(0.20999999999999999) * _tmp9 +
  ...
  const Scalar _tmp37 = -_tmp17 * _tmp35 + _tmp35 * _tmp36;
  ...
  const Scalar _tmp47 = Scalar(1.0) / (_tmp35 * _tmp46 - _tmp38);
  ...
  const Scalar _tmp56 = _tmp46 * _tmp55 - _tmp54;
  const Scalar _tmp57 = _tmp47 * _tmp56;
  const Scalar _tmp58 = _tmp11 + _tmp15 + _tmp8;
  const Scalar _tmp59 = _tmp36 * _tmp46;
  const Scalar _tmp60 = _tmp17 * _tmp38 - _tmp35 * _tmp59;
  const Scalar _tmp61 = Scalar(1.0) * _tmp40;
  const Scalar _tmp62 = Scalar(1.0) * _tmp43;
  const Scalar _tmp63 = (-_tmp25 + _tmp62) / (_tmp32 - _tmp61);
  const Scalar _tmp64 = _tmp36 * _tmp55 - _tmp37 * _tmp57 - _tmp55 * _tmp58 -
                        _tmp63 * (_tmp54 * _tmp58 - _tmp55 * _tmp59 - _tmp57 * _tmp60);
  const Scalar _tmp65 = Scalar(1.0) / (_tmp64);
  const Scalar _tmp66 = _tmp61 * _tmp63 + _tmp62;
  const Scalar _tmp67 = 0;
  const Scalar _tmp68 = _tmp35 * _tmp57;
  const Scalar _tmp69 =
      std::sqrt(Scalar(std::pow(_tmp41, Scalar(2)) + std::pow(_tmp44, Scalar(2))));
  const Scalar _tmp70 = _tmp45 * _tmp69;
  const Scalar _tmp71 = _tmp42 + _tmp50;
  const Scalar _tmp72 = _tmp27 + _tmp39;
  const Scalar _tmp73 = _tmp72 + position_vector(1, 0) + Scalar(8.3888750099999996);
  const Scalar _tmp74 = _tmp71 + position_vector(0, 0) + Scalar(-2.5202214700000001);
  ...
  const Scalar _tmp80 = _tmp70 * (-_tmp40 * _tmp44 * _tmp79 + _tmp41 * _tmp43 * _tmp79);
  const Scalar _tmp81 = -_tmp25 * _tmp38 + _tmp32 * _tmp35 + _tmp35 * _tmp80;
  const Scalar _tmp82 = _tmp48 * _tmp55 - _tmp51 * _tmp54 + _tmp55 * _tmp80 - _tmp57 * _tmp81;
  const Scalar _tmp83 = Scalar(1.0) / (_tmp82);
  const Scalar _tmp84 = Scalar(1.0) * _tmp83;
  const Scalar _tmp85 = _tmp70 * _tmp78 * (_tmp55 * _tmp84 - _tmp68 * _tmp84);
  const Scalar _tmp86 = _tmp46 * _tmp47;
  const Scalar _tmp87 = -_tmp36 + _tmp37 * _tmp86 - _tmp63 * (_tmp59 + _tmp60 * _tmp86);
  const Scalar _tmp88 = _tmp65 * _tmp82;
  const Scalar _tmp89 = _tmp64 * _tmp83;
  const Scalar _tmp90 = _tmp87 + _tmp89 * (-_tmp80 + _tmp81 * _tmp86 - _tmp87 * _tmp88);
  const Scalar _tmp91 = _tmp65 * _tmp90;
  const Scalar _tmp92 = _tmp56 * _tmp65;
  const Scalar _tmp93 = _tmp47 * (-_tmp46 - _tmp90 * _tmp92);
  const Scalar _tmp94 = _tmp70 * _tmp77 * (_tmp35 * _tmp93 + _tmp55 * _tmp91 + Scalar(1.0));
  const Scalar _tmp95 = Scalar(1.0) * _tmp47;
  const Scalar _tmp96 = -_tmp37 * _tmp95 + _tmp60 * _tmp63 * _tmp95;
  const Scalar _tmp97 = _tmp89 * (-_tmp81 * _tmp95 - _tmp88 * _tmp96) + _tmp96;
  const Scalar _tmp98 = _tmp65 * _tmp97;
  const Scalar _tmp99 = _tmp47 * (-_tmp92 * _tmp97 + Scalar(1.0));
  const Scalar _tmp100 = _tmp70 * _tmp76 * (_tmp35 * _tmp99 + _tmp55 * _tmp98);
  const Scalar _tmp101 = _tmp76 * _tmp99;
  const Scalar _tmp102 = _tmp78 * _tmp84;
  const Scalar _tmp103 = _tmp102 * fh1;
  const Scalar _tmp104 = _tmp77 * _tmp93;
  ...
  _res(1, 0) = -(-_tmp100 - _tmp85 - _tmp94) *
               std::exp(_tmp0 * _tmp70 * (_tmp55 * _tmp67 - _tmp67 * _tmp68) + _tmp100 * fh1 +
                        _tmp85 * fh1 + _tmp94 * fh1);
  _res(2, 0) = -(_tmp101 - _tmp102 * _tmp57 + _tmp104) *
               std::exp(-_tmp101 * fh1 + _tmp103 * _tmp57 - _tmp104 * fh1 + _tmp105 * _tmp57);
  _res(3, 0) =
      -(_tmp102 + _tmp106 + _tmp107) * std::exp(-_tmp103 - _tmp105 - _tmp106 * fh1 - _tmp107 * fh1);
