...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2WrtFv1Nl4(
  ...
  const Scalar _tmp42 = _tmp38 + _tmp9;
  const Scalar _tmp43 = _tmp41 + _tmp42;
  const Scalar _tmp44 = _tmp20 + _tmp9;
  ...
  const Scalar _tmp50 = _tmp24 + _tmp35;
  ...
  const Scalar _tmp76 = _tmp58 * _tmp75 - _tmp64 * _tmp73;
  const Scalar _tmp77 = Scalar(1.0) * _tmp45;
  const Scalar _tmp78 = -_tmp65 * _tmp75 + _tmp73;
  const Scalar _tmp79 = Scalar(1.0) * _tmp66;
  const Scalar _tmp80 = _tmp47 * _tmp66 * _tmp76 * _tmp77 - _tmp78 * _tmp79;
  const Scalar _tmp81 = _tmp42 + position_vector(1, 0);
  ...
  const Scalar _tmp88 = _tmp64 * _tmp86 - _tmp87;
  const Scalar _tmp89 = _tmp66 * _tmp88;
  const Scalar _tmp90 = _tmp64 * _tmp72;
  const Scalar _tmp91 = _tmp67 + _tmp71;
  const Scalar _tmp92 = -_tmp76 * _tmp89 - _tmp86 * _tmp90 + _tmp87 * _tmp91;
  const Scalar _tmp93 = -_tmp48 * _tmp92 + _tmp72 * _tmp86 - _tmp78 * _tmp89 - _tmp86 * _tmp91;
  ...
  const Scalar _tmp98 = _tmp97 * (_tmp36 * _tmp60 * _tmp96 - _tmp39 * _tmp62 * _tmp96);
  const Scalar _tmp99 = _tmp44 * _tmp65 - _tmp46 * _tmp58 + _tmp65 * _tmp98;
  const Scalar _tmp100 = _tmp42 * _tmp86 - _tmp50 * _tmp87 + _tmp86 * _tmp98 - _tmp89 * _tmp99;
  const Scalar _tmp101 = _tmp100 * _tmp94;
  const Scalar _tmp102 = Scalar(1.0) / (_tmp100);
  const Scalar _tmp103 = _tmp102 * _tmp93;
  const Scalar _tmp104 = _tmp103 * (-_tmp101 * _tmp80 - _tmp79 * _tmp99);
  const Scalar _tmp105 = _tmp43 * _tmp51;
  const Scalar _tmp106 = _tmp104 + _tmp80;
  const Scalar _tmp107 = _tmp92 * _tmp94;
  const Scalar _tmp108 = _tmp104 * _tmp105 - _tmp106 * _tmp107 - _tmp76 * _tmp79;
  ...
  const Scalar _tmp114 = fh1 * (_tmp68 + _tmp74);
  const Scalar _tmp115 = -_tmp112 * _tmp114 - Scalar(5.1796800000000003) * _tmp14 - _tmp21 * fv1;
  const Scalar _tmp116 = _tmp49 * _tmp52 + Scalar(1.0);
  const Scalar _tmp117 = _tmp48 * _tmp52;
  const Scalar _tmp118 = -Scalar(1.0) * _tmp116 * _tmp77 + Scalar(1.0) * _tmp117;
  ...
  const Scalar _tmp122 = Scalar(1.0) * _tmp121 * _tmp45 - Scalar(1.0) * _tmp52;
  const Scalar _tmp123 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp124 = _tmp37 + _tmp40 * _tmp48;
  const Scalar _tmp125 = 0;
  const Scalar _tmp126 = _tmp124 * _tmp51;
  const Scalar _tmp127 = _tmp45 * (-_tmp125 * _tmp92 - _tmp126 * _tmp43 + _tmp41);
  const Scalar _tmp128 = -Scalar(1.0) * _tmp124 * _tmp52 - Scalar(1.0) * _tmp127 + Scalar(1.0);
  const Scalar _tmp129 = _tmp64 * _tmp66;
  const Scalar _tmp130 = _tmp129 * _tmp76 + _tmp90;
  const Scalar _tmp131 = _tmp129 * _tmp78 - _tmp130 * _tmp48 - _tmp72;
  const Scalar _tmp132 = _tmp103 * (-_tmp101 * _tmp131 + _tmp129 * _tmp99 - _tmp98);
  const Scalar _tmp133 = _tmp131 + _tmp132;
  const Scalar _tmp134 = _tmp105 * _tmp132 - _tmp107 * _tmp133 + _tmp130;
  const Scalar _tmp135 = _tmp119 * fh1;
  const Scalar _tmp136 = Scalar(1.0) * _tmp102;
  const Scalar _tmp137 = _tmp103 * _tmp121 - _tmp136 * _tmp92;
  const Scalar _tmp138 = _tmp103 * _tmp52;
  const Scalar _tmp139 = fh1 * (_tmp112 * _tmp32 - _tmp119 * _tmp21);
  const Scalar _tmp140 = Scalar(1.0) * _tmp113 * (_tmp104 * _tmp52 - _tmp108 * _tmp77) +
                         _tmp115 * _tmp118 + _tmp120 * _tmp122 + _tmp123 * _tmp128 +
                         Scalar(1.0) * _tmp135 * (_tmp132 * _tmp52 - _tmp134 * _tmp77) +
                         Scalar(1.0) * _tmp139 * (-_tmp137 * _tmp77 + _tmp138);
  const Scalar _tmp141 = _tmp65 * _tmp89;
  const Scalar _tmp142 = _tmp97 * (-_tmp125 * _tmp141 + _tmp125 * _tmp86);
  const Scalar _tmp143 = _tmp88 * _tmp94;
  const Scalar _tmp144 = -_tmp106 * _tmp143 + Scalar(1.0);
  const Scalar _tmp145 = _tmp65 * _tmp66;
  const Scalar _tmp146 = _tmp86 * _tmp94;
  const Scalar _tmp147 = -_tmp133 * _tmp143 - _tmp64;
  const Scalar _tmp148 = -_tmp113 * _tmp97 * (_tmp106 * _tmp146 + _tmp144 * _tmp145) -
                         _tmp123 * _tmp142 -
                         _tmp135 * _tmp97 * (_tmp133 * _tmp146 + _tmp145 * _tmp147 + Scalar(1.0)) -
                         _tmp139 * _tmp97 * (-_tmp136 * _tmp141 + _tmp136 * _tmp86);
  ...
  const Scalar _tmp159 = _tmp15 + _tmp19 + _tmp9;
  const Scalar _tmp160 =
      (-_tmp140 * _tmp158 + _tmp149 * (_tmp118 * _tmp159 + _tmp122 * _tmp32 - _tmp128)) /
      std::sqrt(Scalar(std::pow(_tmp140, Scalar(2)) * _tmp157 + 1));
  const Scalar _tmp161 = _tmp120 * _tmp52;
  const Scalar _tmp162 = _tmp43 * _tmp45;
  const Scalar _tmp163 = _tmp116 * _tmp45;
  const Scalar _tmp164 = _tmp108 * _tmp113 * _tmp45 + _tmp115 * _tmp163 + _tmp123 * _tmp127 +
                         _tmp134 * _tmp135 * _tmp45 + _tmp137 * _tmp139 * _tmp45 -
                         _tmp161 * _tmp162;
  const Scalar _tmp165 = _tmp136 * _tmp139;
  const Scalar _tmp166 = _tmp123 * _tmp125;
  const Scalar _tmp167 =
      _tmp113 * _tmp144 * _tmp66 + _tmp135 * _tmp147 * _tmp66 - _tmp165 * _tmp89 - _tmp166 * _tmp89;
  ...
  const Scalar _tmp175 = _tmp125 * _tmp174 * _tmp89;
  const Scalar _tmp176 = Scalar(9.6622558468725703) * _tmp125;
  const Scalar _tmp177 = _tmp176 * _tmp89;
  const Scalar _tmp178 = _tmp32 * _tmp52;
  const Scalar _tmp179 =
      (-_tmp164 * _tmp175 + _tmp168 * (-_tmp127 + _tmp159 * _tmp163 - _tmp162 * _tmp178)) /
      std::sqrt(Scalar(std::pow(_tmp164, Scalar(2)) * _tmp174 + 1));
  const Scalar _tmp180 = Scalar(1.0) * _tmp169;
  const Scalar _tmp181 =
      _tmp106 * _tmp113 * _tmp94 + _tmp133 * _tmp135 * _tmp94 + _tmp165 + _tmp166;
  const Scalar _tmp182 = Scalar(1.0) / (_tmp181);
  const Scalar _tmp183 = -_tmp104 * _tmp113 * _tmp51 - _tmp115 * _tmp117 + _tmp123 * _tmp126 -
                         _tmp132 * _tmp135 * _tmp51 - _tmp138 * _tmp139 + _tmp161;
  ...
  const Scalar _tmp192 = (_tmp182 * (-_tmp117 * _tmp159 - _tmp126 + _tmp178) + _tmp183 * _tmp191) /
  ...
  _res(2, 0) = _tmp170 * (-Scalar(1.0) * _tmp179 * std::cosh(_tmp180) -
                          (-Scalar(0.1034955) * _tmp171 * _tmp175 +
                           _tmp172 * (-_tmp169 * _tmp177 - _tmp170 * _tmp179)) *
                              std::cosh(_tmp173)) +
               _tmp177 * (-std::sinh(_tmp173) - std::sinh(_tmp180));
  _res(3, 0) = -_tmp176 * (-std::sinh(_tmp185) - std::sinh(_tmp189)) +
               _tmp186 * (-Scalar(1.0) * _tmp192 * std::cosh(_tmp185) -
                          (Scalar(0.1034955) * _tmp187 * _tmp191 +
                           _tmp188 * (_tmp176 * _tmp184 - _tmp186 * _tmp192)) *
                              std::cosh(_tmp189));
