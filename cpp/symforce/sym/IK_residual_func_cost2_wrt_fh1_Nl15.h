...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2WrtFh1Nl15(
  ...
  const Scalar _tmp49 = Scalar(0.20999999999999999) * _tmp25 + Scalar(0.20999999999999999) * _tmp26;
  const Scalar _tmp50 = -_tmp49;
  const Scalar _tmp51 =
      -Scalar(0.010999999999999999) * _tmp13 - Scalar(0.010999999999999999) * _tmp23;
  const Scalar _tmp52 = Scalar(0.20999999999999999) * _tmp15 - Scalar(0.20999999999999999) * _tmp16;
  ...
  const Scalar _tmp58 = _tmp49 + _tmp55;
  const Scalar _tmp59 = _tmp29 + _tmp42;
  const Scalar _tmp60 = _tmp59 + position_vector(1, 0);
  const Scalar _tmp61 = _tmp60 + Scalar(-4.8333311099999996);
  const Scalar _tmp62 = _tmp11 + _tmp38;
  ...
  const Scalar _tmp77 = _tmp58 * _tmp66 - _tmp75 * _tmp76;
  const Scalar _tmp78 = Scalar(1.0) / (-_tmp66 + _tmp74 * _tmp76);
  const Scalar _tmp79 = _tmp48 * _tmp74 - _tmp57;
  const Scalar _tmp80 = _tmp78 * _tmp79;
  const Scalar _tmp81 = -_tmp48 * _tmp75 + _tmp56 * _tmp57 - _tmp77 * _tmp80;
  const Scalar _tmp82 = Scalar(1.0) * _tmp71;
  const Scalar _tmp83 = -_tmp82;
  const Scalar _tmp84 = Scalar(1.0) / (_tmp59 + _tmp83);
  const Scalar _tmp85 = Scalar(1.0) * _tmp67;
  const Scalar _tmp86 = _tmp84 * (-_tmp62 + _tmp85);
  const Scalar _tmp87 = _tmp78 * (_tmp54 * _tmp76 - _tmp58 * _tmp76);
  const Scalar _tmp88 = _tmp48 * _tmp54 - _tmp48 * _tmp56 - _tmp79 * _tmp87 - _tmp81 * _tmp86;
  const Scalar _tmp89 = Scalar(1.0) / (_tmp88);
  const Scalar _tmp90 = _tmp74 * _tmp78;
  const Scalar _tmp91 = _tmp75 + _tmp77 * _tmp90;
  const Scalar _tmp92 = -_tmp54 + _tmp74 * _tmp87 - _tmp86 * _tmp91;
  const Scalar _tmp93 =
  ...
  const Scalar _tmp96 = _tmp95 * (_tmp67 * _tmp73 * _tmp94 - _tmp69 * _tmp71 * _tmp94);
  const Scalar _tmp97 = _tmp59 * _tmp76 - _tmp62 * _tmp66 + _tmp76 * _tmp96;
  const Scalar _tmp98 = -_tmp39 * _tmp57 + _tmp44 * _tmp48 + _tmp48 * _tmp96 - _tmp80 * _tmp97;
  ...
  const Scalar _tmp106 = _tmp78 * (-_tmp103 * _tmp105 - _tmp74);
  ...
  const Scalar _tmp111 = _tmp110 * _tmp95 * (_tmp104 * _tmp48 + _tmp106 * _tmp76 + Scalar(1.0));
  const Scalar _tmp112 = Scalar(1.0) * _tmp78;
  const Scalar _tmp113 = _tmp112 * _tmp77;
  const Scalar _tmp114 = _tmp113 * _tmp86 - Scalar(1.0) * _tmp87;
  const Scalar _tmp115 = _tmp101 * (-_tmp112 * _tmp97 - _tmp114 * _tmp99);
  const Scalar _tmp116 = _tmp114 + _tmp115;
  const Scalar _tmp117 = _tmp78 * (-_tmp105 * _tmp116 + Scalar(1.0));
  const Scalar _tmp118 = _tmp116 * _tmp89;
  const Scalar _tmp119 = _tmp108 * _tmp109;
  const Scalar _tmp120 = _tmp119 * _tmp95 * (_tmp117 * _tmp76 + _tmp118 * _tmp48);
  const Scalar _tmp121 = -_tmp110 * _tmp30 + _tmp119 * _tmp20;
  const Scalar _tmp122 = Scalar(1.0) * _tmp100;
  const Scalar _tmp123 = _tmp76 * _tmp80;
  const Scalar _tmp124 = _tmp121 * _tmp95 * (-_tmp122 * _tmp123 + _tmp122 * _tmp48);
  const Scalar _tmp125 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp126 = _tmp82 * _tmp86 + _tmp85;
  const Scalar _tmp127 = 0;
  const Scalar _tmp128 = -_tmp111 * fh1 - _tmp120 * fh1 - _tmp124 * fh1 -
                         _tmp125 * _tmp95 * (-_tmp123 * _tmp127 + _tmp127 * _tmp48);
  const Scalar _tmp129 = Scalar(1.0) / (_tmp128);
  const Scalar _tmp130 = _tmp44 + _tmp83;
  const Scalar _tmp131 = _tmp130 * _tmp86;
  const Scalar _tmp132 = Scalar(1.0) / (-_tmp131 - _tmp39 + _tmp85);
  const Scalar _tmp133 = Scalar(1.0) * _tmp132;
  const Scalar _tmp134 = _tmp126 * _tmp132;
  const Scalar _tmp135 = -_tmp127 * _tmp81 - _tmp130 * _tmp134 + _tmp83;
  const Scalar _tmp136 = Scalar(1.0) * _tmp84;
  const Scalar _tmp137 = _tmp130 * _tmp133;
  const Scalar _tmp138 = _tmp84 * (_tmp101 * _tmp137 - _tmp122 * _tmp81);
  const Scalar _tmp139 = _tmp101 * _tmp133;
  const Scalar _tmp140 = Scalar(1.0) * _tmp121 * (-Scalar(1.0) * _tmp138 + _tmp139);
  const Scalar _tmp141 = _tmp81 * _tmp89;
  const Scalar _tmp142 = _tmp130 * _tmp132;
  const Scalar _tmp143 = _tmp102 * _tmp142 - _tmp103 * _tmp141 + _tmp91;
  const Scalar _tmp144 = Scalar(1.0) * _tmp110 * (_tmp102 * _tmp133 - _tmp136 * _tmp143);
  const Scalar _tmp145 = -_tmp113 + _tmp115 * _tmp142 - _tmp116 * _tmp141;
  const Scalar _tmp146 = Scalar(1.0) * _tmp119 * (_tmp115 * _tmp133 - _tmp136 * _tmp145);
  const Scalar _tmp147 = _tmp49 + _tmp53;
  const Scalar _tmp148 = _tmp147 * fh1;
  const Scalar _tmp149 = -_tmp119 * _tmp148 - Scalar(5.1796800000000003) * _tmp27 - _tmp30 * fv1;
  const Scalar _tmp150 = _tmp84 * (_tmp131 * _tmp133 + Scalar(1.0));
  const Scalar _tmp151 = _tmp133 * _tmp86;
  const Scalar _tmp152 = -Scalar(1.0) * _tmp150 + Scalar(1.0) * _tmp151;
  const Scalar _tmp153 = _tmp110 * _tmp148 + Scalar(5.1796800000000003) * _tmp17 + _tmp20 * fv1;
  const Scalar _tmp154 = -Scalar(1.0) * _tmp133 + Scalar(1.0) * _tmp137 * _tmp84;
  const Scalar _tmp155 =
      Scalar(1.0) * _tmp125 * (-_tmp126 * _tmp133 - _tmp135 * _tmp136 + Scalar(1.0)) +
      _tmp140 * fh1 + _tmp144 * fh1 + _tmp146 * fh1 + _tmp149 * _tmp152 + _tmp153 * _tmp154;
  ...
  const Scalar _tmp159 = -_tmp111 - _tmp120 - _tmp124;
  const Scalar _tmp160 = _tmp158 * _tmp159;
  const Scalar _tmp161 = _tmp110 * _tmp147;
  const Scalar _tmp162 = _tmp119 * _tmp147;
  const Scalar _tmp163 =
      (_tmp129 * (_tmp140 + _tmp144 + _tmp146 - _tmp152 * _tmp162 + _tmp154 * _tmp161) -
       _tmp155 * _tmp160) /
  ...
  const Scalar _tmp169 = _tmp121 * _tmp138;
  const Scalar _tmp170 = _tmp110 * _tmp84;
  const Scalar _tmp171 = _tmp143 * _tmp170;
  const Scalar _tmp172 = _tmp119 * _tmp145 * _tmp84;
  const Scalar _tmp173 = _tmp133 * _tmp153;
  const Scalar _tmp174 = _tmp125 * _tmp135 * _tmp84 - _tmp130 * _tmp173 * _tmp84 +
                         _tmp149 * _tmp150 + _tmp169 * fh1 + _tmp171 * fh1 + _tmp172 * fh1;
  const Scalar _tmp175 = _tmp125 * _tmp127;
  const Scalar _tmp176 = _tmp121 * _tmp122;
  const Scalar _tmp177 = _tmp176 * fh1;
  const Scalar _tmp178 = _tmp106 * _tmp110;
  const Scalar _tmp179 = _tmp117 * _tmp119;
  const Scalar _tmp180 = -_tmp175 * _tmp80 - _tmp177 * _tmp80 + _tmp178 * fh1 + _tmp179 * fh1;
  ...
  const Scalar _tmp188 = -_tmp176 * _tmp80 + _tmp178 + _tmp179;
  ...
  const Scalar _tmp192 =
      (-_tmp174 * _tmp191 +
       _tmp181 * (-_tmp137 * _tmp147 * _tmp170 - _tmp150 * _tmp162 + _tmp169 + _tmp171 + _tmp172)) /
      std::sqrt(Scalar(std::pow(_tmp174, Scalar(2)) * _tmp190 + 1));
  const Scalar _tmp193 = _tmp121 * _tmp139;
  const Scalar _tmp194 = _tmp102 * _tmp110 * _tmp132;
  const Scalar _tmp195 = _tmp115 * _tmp119 * _tmp132;
  const Scalar _tmp196 = _tmp125 * _tmp134 - _tmp149 * _tmp151 + _tmp173 - _tmp193 * fh1 -
                         _tmp194 * fh1 - _tmp195 * fh1;
  const Scalar _tmp197 = _tmp118 * _tmp119;
  const Scalar _tmp198 = _tmp104 * _tmp110;
  ...
  const Scalar _tmp210 = (-_tmp196 * _tmp208 + _tmp200 * (_tmp133 * _tmp161 + _tmp151 * _tmp162 -
  ...
  _res(1, 0) = _tmp164 * (-Scalar(1.0) * _tmp163 * std::cosh(_tmp157) -
                          (-Scalar(0.1034955) * _tmp160 * _tmp165 +
                           _tmp167 * (-_tmp156 * _tmp166 - _tmp163 * _tmp164)) *
                              std::cosh(_tmp168)) +
               _tmp166 * (-std::sinh(_tmp157) - std::sinh(_tmp168));
  _res(2, 0) = Scalar(9.6622558468725703) * _tmp188 * (-std::sinh(_tmp183) - std::sinh(_tmp187)) +
               _tmp189 * (-Scalar(1.0) * _tmp192 * std::cosh(_tmp183) -
