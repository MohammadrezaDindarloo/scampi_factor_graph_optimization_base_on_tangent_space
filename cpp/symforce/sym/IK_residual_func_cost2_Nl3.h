...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2Nl3(
  ...
  const Scalar _tmp64 = _tmp36 + _tmp37;
  const Scalar _tmp65 = _tmp34 + _tmp64;
  const Scalar _tmp66 = _tmp43 + position_vector(1, 0);
  const Scalar _tmp67 = _tmp66 + Scalar(-4.7752063900000001);
  const Scalar _tmp68 = _tmp51 + position_vector(0, 0);
  ...
  const Scalar _tmp74 = _tmp57 * _tmp63 - _tmp72 * _tmp73;
  const Scalar _tmp75 = Scalar(1.0) / (-_tmp63 + _tmp71 * _tmp73);
  const Scalar _tmp76 = Scalar(1.0) * _tmp75;
  const Scalar _tmp77 = _tmp74 * _tmp76;
  const Scalar _tmp78 = -_tmp57 * _tmp73 + _tmp65 * _tmp73;
  const Scalar _tmp79 = _tmp53 * _tmp77 - _tmp76 * _tmp78;
  const Scalar _tmp80 = _tmp46 + position_vector(1, 0);
  const Scalar _tmp81 = _tmp80 + Scalar(8.3888750099999996);
  const Scalar _tmp82 = _tmp41 + position_vector(0, 0);
  ...
  const Scalar _tmp86 = _tmp35 + _tmp64;
  const Scalar _tmp87 = _tmp81 * _tmp84;
  const Scalar _tmp88 = _tmp71 * _tmp85 - _tmp87;
  const Scalar _tmp89 = _tmp75 * _tmp88;
  const Scalar _tmp90 = -_tmp72 * _tmp85 - _tmp74 * _tmp89 + _tmp86 * _tmp87;
  const Scalar _tmp91 = -_tmp53 * _tmp90 + _tmp65 * _tmp85 - _tmp78 * _tmp89 - _tmp85 * _tmp86;
  ...
  const Scalar _tmp96 = _tmp95 * (-_tmp43 * _tmp69 * _tmp94 + _tmp51 * _tmp67 * _tmp94);
  const Scalar _tmp97 = _tmp48 * _tmp73 - _tmp50 * _tmp63 + _tmp73 * _tmp96;
  const Scalar _tmp98 = -_tmp41 * _tmp87 + _tmp46 * _tmp85 + _tmp85 * _tmp96 - _tmp89 * _tmp97;
  ...
  const Scalar _tmp105 = _tmp47 * _tmp55;
  const Scalar _tmp106 = _tmp102 * _tmp105 - _tmp103 * _tmp104 - _tmp77;
  const Scalar _tmp107 = Scalar(1.0) * _tmp49;
  const Scalar _tmp108 = _tmp30 + Scalar(1.9874742000000001);
  const Scalar _tmp109 = _tmp19 + Scalar(8.3196563700000006);
  ...
  const Scalar _tmp113 = _tmp71 * _tmp75;
  const Scalar _tmp114 = _tmp113 * _tmp74 + _tmp72;
  const Scalar _tmp115 = _tmp113 * _tmp78 - _tmp114 * _tmp53 - _tmp65;
  const Scalar _tmp116 = _tmp101 * (_tmp113 * _tmp97 - _tmp115 * _tmp99 - _tmp96);
  const Scalar _tmp117 = _tmp115 + _tmp116;
  const Scalar _tmp118 = -_tmp104 * _tmp117 + _tmp105 * _tmp116 + _tmp114;
  const Scalar _tmp119 = _tmp108 * _tmp110;
  const Scalar _tmp120 = _tmp119 * fh1;
  const Scalar _tmp121 = _tmp53 * _tmp56;
  const Scalar _tmp122 = _tmp49 * (_tmp54 * _tmp56 + Scalar(1.0));
  const Scalar _tmp123 = _tmp39 * fh1;
  const Scalar _tmp124 = -_tmp111 * _tmp123 - Scalar(5.1796800000000003) * _tmp15 - _tmp18 * fv1;
  const Scalar _tmp125 = _tmp101 * _tmp56;
  const Scalar _tmp126 = Scalar(1.0) * _tmp100;
  const Scalar _tmp127 = _tmp125 * _tmp47 - _tmp126 * _tmp90;
  const Scalar _tmp128 = fh1 * (_tmp111 * _tmp29 - _tmp119 * _tmp18);
  const Scalar _tmp129 = _tmp47 * _tmp49;
  const Scalar _tmp130 = _tmp119 * _tmp123 + Scalar(5.1796800000000003) * _tmp26 + _tmp29 * fv1;
  const Scalar _tmp131 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp132 = _tmp44 * _tmp53 + _tmp52;
  const Scalar _tmp133 = 0;
  const Scalar _tmp134 = _tmp132 * _tmp55;
  const Scalar _tmp135 = _tmp49 * (-_tmp104 * _tmp133 - _tmp134 * _tmp47 + _tmp45);
  const Scalar _tmp136 = _tmp88 * _tmp92;
  const Scalar _tmp137 = -_tmp103 * _tmp136 + Scalar(1.0);
  const Scalar _tmp138 = _tmp73 * _tmp75;
  const Scalar _tmp139 = _tmp85 * _tmp92;
  const Scalar _tmp140 = _tmp133 * _tmp92;
  const Scalar _tmp141 = -_tmp117 * _tmp136 - _tmp71;
  const Scalar _tmp142 = _tmp100 * _tmp76 * _tmp88;
  const Scalar _tmp143 = -_tmp112 * _tmp95 * (_tmp103 * _tmp139 + _tmp137 * _tmp138) -
                         _tmp120 * _tmp95 * (_tmp117 * _tmp139 + _tmp138 * _tmp141 + Scalar(1.0)) -
                         _tmp128 * _tmp95 * (_tmp126 * _tmp85 - _tmp142 * _tmp73) -
                         _tmp131 * _tmp95 * (-_tmp140 * _tmp73 * _tmp89 + _tmp140 * _tmp85);
  const Scalar _tmp144 = Scalar(1.0) / (_tmp143);
  const Scalar _tmp145 =
      std::asinh(_tmp144 * (Scalar(1.0) * _tmp112 * (_tmp102 * _tmp56 - _tmp106 * _tmp107) +
                            Scalar(1.0) * _tmp120 * (-_tmp107 * _tmp118 + _tmp116 * _tmp56) +
                            Scalar(1.0) * _tmp124 * (_tmp121 - Scalar(1.0) * _tmp122) +
                            Scalar(1.0) * _tmp128 * (-_tmp107 * _tmp127 + _tmp125) +
                            Scalar(1.0) * _tmp130 * (_tmp129 * _tmp56 - _tmp56) +
                            Scalar(1.0) * _tmp131 *
                                (-_tmp132 * _tmp56 - Scalar(1.0) * _tmp135 + Scalar(1.0))));
  const Scalar _tmp146 = Scalar(9.6622558468725703) * _tmp143;
  const Scalar _tmp147 = Scalar(22.802596067096832) *
  ...
  const Scalar _tmp148 = _tmp131 * _tmp140;
  const Scalar _tmp149 = _tmp112 * _tmp137 * _tmp75 + _tmp120 * _tmp141 * _tmp75 -
                         _tmp128 * _tmp142 - _tmp148 * _tmp89;
  const Scalar _tmp150 = Scalar(1.0) / (_tmp149);
  const Scalar _tmp151 = _tmp130 * _tmp56;
  const Scalar _tmp152 = std::asinh(
      _tmp150 * (_tmp106 * _tmp112 * _tmp49 + _tmp118 * _tmp120 * _tmp49 + _tmp122 * _tmp124 +
                 _tmp127 * _tmp128 * _tmp49 - _tmp129 * _tmp151 + _tmp131 * _tmp135));
  ...
  const Scalar _tmp156 =
      _tmp103 * _tmp112 * _tmp92 + _tmp117 * _tmp120 * _tmp92 + _tmp126 * _tmp128 + _tmp148;
  const Scalar _tmp157 = Scalar(1.0) / (_tmp156);
  const Scalar _tmp158 =
      std::asinh(_tmp157 * (-_tmp102 * _tmp112 * _tmp55 - _tmp116 * _tmp120 * _tmp55 -
                            _tmp121 * _tmp124 - _tmp125 * _tmp128 + _tmp131 * _tmp134 + _tmp151));
  ...
  _res(1, 0) =
      ...
      Scalar(8.36416322) *
          std::sqrt(Scalar(Scalar(0.014294040284261563) * _tmp147 +
                           std::pow(Scalar(-Scalar(0.1195576860108189) * _tmp65 -
  ...
  _res(2, 0) =
      ...
      Scalar(8.3700199099999999) *
          std::sqrt(Scalar(Scalar(0.01427404356387209) * _tmp154 +
                           std::pow(Scalar(-Scalar(0.11947402882581673) * _tmp57 -
  ...
  _res(3, 0) =
      ...
      Scalar(8.4693136199999994) *
          std::sqrt(Scalar(Scalar(0.013941309530580858) * _tmp155 +
                           std::pow(Scalar(-Scalar(0.11807332268798426) * _tmp86 -
