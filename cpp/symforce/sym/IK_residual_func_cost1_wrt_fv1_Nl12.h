...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1WrtFv1Nl12(
  ...
  const Scalar _tmp76 = -_tmp48 + _tmp69 * _tmp75;
  const Scalar _tmp77 = Scalar(1.0) / (_tmp59 * _tmp69 - _tmp73);
  const Scalar _tmp78 = _tmp76 * _tmp77;
  const Scalar _tmp79 = _tmp38 * _tmp48 - _tmp70 * _tmp75 - _tmp74 * _tmp78;
  ...
  const Scalar _tmp85 = _tmp77 * (_tmp59 * _tmp61 - _tmp59 * _tmp72);
  const Scalar _tmp86 = -_tmp38 * _tmp75 + _tmp61 * _tmp75 - _tmp76 * _tmp85 - _tmp79 * _tmp84;
  const Scalar _tmp87 = Scalar(1.0) / (_tmp86);
  const Scalar _tmp88 = _tmp80 * _tmp84 + _tmp83;
  const Scalar _tmp89 = 0;
  const Scalar _tmp90 = _tmp40 + _tmp81;
  const Scalar _tmp91 = _tmp84 * _tmp90;
  const Scalar _tmp92 = Scalar(1.0) / (-_tmp44 + _tmp83 - _tmp91);
  ...
  const Scalar _tmp96 = -Scalar(1.0) * _tmp88 * _tmp95 - Scalar(1.0) * _tmp94 + Scalar(1.0);
  const Scalar _tmp97 =
  ...
  const Scalar _tmp101 = _tmp100 * _tmp59 + _tmp51 * _tmp59 - _tmp55 * _tmp73;
  const Scalar _tmp102 = Scalar(1.0) * _tmp77;
  const Scalar _tmp103 = _tmp102 * _tmp74;
  const Scalar _tmp104 = _tmp103 * _tmp84 - Scalar(1.0) * _tmp85;
  const Scalar _tmp105 = _tmp100 * _tmp75 - _tmp101 * _tmp78 + _tmp40 * _tmp75 - _tmp44 * _tmp48;
  ...
  const Scalar _tmp111 = _tmp87 * (_tmp104 + _tmp109);
  const Scalar _tmp112 = -_tmp103 + _tmp109 * _tmp110 - _tmp111 * _tmp79;
  const Scalar _tmp113 = Scalar(1.0) * _tmp82;
  const Scalar _tmp114 = _tmp32 + Scalar(-4.7752063900000001);
  const Scalar _tmp115 = _tmp21 + Scalar(-2.71799795);
  ...
  const Scalar _tmp119 = fh1 * (_tmp34 + _tmp71);
  const Scalar _tmp120 = -_tmp117 * _tmp119 - Scalar(5.1796800000000003) * _tmp27 - _tmp31 * fv1;
  const Scalar _tmp121 = _tmp84 * _tmp95;
  const Scalar _tmp122 = _tmp91 * _tmp95 + Scalar(1.0);
  const Scalar _tmp123 = -Scalar(1.0) * _tmp113 * _tmp122 + Scalar(1.0) * _tmp121;
  const Scalar _tmp124 = _tmp108 * _tmp95;
  const Scalar _tmp125 = Scalar(1.0) * _tmp107;
  const Scalar _tmp126 = _tmp124 * _tmp90 - _tmp125 * _tmp79;
  const Scalar _tmp127 = _tmp115 * _tmp116;
  const Scalar _tmp128 = fh1 * (_tmp117 * _tmp20 - _tmp127 * _tmp31);
  const Scalar _tmp129 = _tmp69 * _tmp77;
  const Scalar _tmp130 = _tmp129 * _tmp74 + _tmp70;
  const Scalar _tmp131 = -_tmp130 * _tmp84 - _tmp61 + _tmp69 * _tmp85;
  const Scalar _tmp132 = _tmp108 * (-_tmp100 + _tmp101 * _tmp129 - _tmp106 * _tmp131);
  const Scalar _tmp133 = _tmp87 * (_tmp131 + _tmp132);
  const Scalar _tmp134 = _tmp110 * _tmp132 + _tmp130 - _tmp133 * _tmp79;
  const Scalar _tmp135 = _tmp127 * fh1;
  const Scalar _tmp136 = _tmp119 * _tmp127 + Scalar(5.1796800000000003) * _tmp17 + _tmp20 * fv1;
  const Scalar _tmp137 = _tmp82 * _tmp90;
  const Scalar _tmp138 = Scalar(1.0) * _tmp137 * _tmp95 - Scalar(1.0) * _tmp95;
  const Scalar _tmp139 = Scalar(1.0) * _tmp118 * (_tmp109 * _tmp95 - _tmp112 * _tmp113) +
                         _tmp120 * _tmp123 +
                         Scalar(1.0) * _tmp128 * (-_tmp113 * _tmp126 + _tmp124) +
                         Scalar(1.0) * _tmp135 * (-_tmp113 * _tmp134 + _tmp132 * _tmp95) +
                         _tmp136 * _tmp138 + _tmp33 * _tmp96;
  const Scalar _tmp140 = _tmp78 * _tmp89;
  const Scalar _tmp141 = _tmp99 * (-_tmp140 * _tmp59 + _tmp75 * _tmp89);
  const Scalar _tmp142 = -_tmp111 * _tmp76 + Scalar(1.0);
  const Scalar _tmp143 = _tmp59 * _tmp77;
  const Scalar _tmp144 = _tmp102 * _tmp107 * _tmp76;
  const Scalar _tmp145 = -_tmp133 * _tmp76 - _tmp69;
  const Scalar _tmp146 = -_tmp118 * _tmp99 * (_tmp111 * _tmp75 + _tmp142 * _tmp143) -
                         _tmp128 * _tmp99 * (_tmp125 * _tmp75 - _tmp144 * _tmp59) -
                         _tmp135 * _tmp99 * (_tmp133 * _tmp75 + _tmp143 * _tmp145 + Scalar(1.0)) -
                         _tmp141 * _tmp33;
  ...
  const Scalar _tmp151 = _tmp28 + _tmp39 + _tmp49;
  const Scalar _tmp152 = _tmp141 * _tmp150;
  const Scalar _tmp153 =
      (-_tmp139 * _tmp152 + _tmp147 * (_tmp123 * _tmp151 + _tmp138 * _tmp20 - _tmp96)) /
      std::sqrt(Scalar(std::pow(_tmp139, Scalar(2)) * _tmp150 + 1));
  const Scalar _tmp154 = Scalar(9.6622558468725703) * _tmp141;
  const Scalar _tmp155 = Scalar(9.6622558468725703) * _tmp146;
  const Scalar _tmp156 = Scalar(0.1034955) * _tmp147;
  ...
  const Scalar _tmp159 = _tmp33 * _tmp89;
  const Scalar _tmp160 = _tmp118 * _tmp142 * _tmp77 - _tmp128 * _tmp144 +
                         _tmp135 * _tmp145 * _tmp77 - _tmp159 * _tmp78;
  const Scalar _tmp161 = Scalar(1.0) / (_tmp160);
  const Scalar _tmp162 = _tmp122 * _tmp82;
  const Scalar _tmp163 = _tmp136 * _tmp95;
  const Scalar _tmp164 = _tmp112 * _tmp118 * _tmp82 + _tmp120 * _tmp162 +
                         _tmp126 * _tmp128 * _tmp82 + _tmp134 * _tmp135 * _tmp82 -
                         _tmp137 * _tmp163 + _tmp33 * _tmp94;
  ...
  const Scalar _tmp169 = _tmp20 * _tmp95;
  const Scalar _tmp170 =
      (_tmp161 * (-_tmp137 * _tmp169 + _tmp151 * _tmp162 - _tmp94) - _tmp164 * _tmp168) /
      std::sqrt(Scalar(std::pow(_tmp164, Scalar(2)) * _tmp167 + 1));
  const Scalar _tmp171 = Scalar(9.6622558468725703) * _tmp160;
  const Scalar _tmp172 = Scalar(9.6622558468725703) * _tmp89;
  ...
  const Scalar _tmp177 = _tmp111 * _tmp118 + _tmp125 * _tmp128 + _tmp133 * _tmp135 + _tmp159;
  const Scalar _tmp178 = Scalar(1.0) / (_tmp177);
  const Scalar _tmp179 = -_tmp109 * _tmp118 * _tmp92 - _tmp120 * _tmp121 - _tmp124 * _tmp128 -
                         _tmp132 * _tmp135 * _tmp92 + _tmp163 + _tmp33 * _tmp93;
  ...
  const Scalar _tmp184 = (_tmp178 * (-_tmp121 * _tmp151 + _tmp169 - _tmp93) + _tmp179 * _tmp183) /
  ...
  _res(1, 0) =
      -_tmp154 * (Scalar(0.87679799772039002) * _tmp147 + std::cosh(_tmp149) - std::cosh(_tmp158)) -
      _tmp155 *
          (-Scalar(0.87679799772039002) * _tmp152 + Scalar(1.0) * _tmp153 * std::sinh(_tmp149) -
          ...
          (-Scalar(0.87653584775870996) * _tmp168 + Scalar(1.0) * _tmp170 * std::sinh(_tmp166) -
           (-Scalar(0.1034955) * _tmp168 * _tmp175 +
            _tmp174 * (-_tmp165 * _tmp173 - _tmp170 * _tmp171)) *
               std::sinh(_tmp176)) -
      _tmp173 * (Scalar(0.87653584775870996) * _tmp161 + std::cosh(_tmp166) - std::cosh(_tmp176));
  _res(3, 0) =
      _tmp172 * (Scalar(0.86625939559540499) * _tmp178 + std::cosh(_tmp181) - std::cosh(_tmp188)) -
      _tmp185 *
          (Scalar(0.86625939559540499) * _tmp183 + Scalar(1.0) * _tmp184 * std::sinh(_tmp181) -
           (Scalar(0.1034955) * _tmp183 * _tmp186 +
            _tmp187 * (_tmp172 * _tmp180 - _tmp184 * _tmp185)) *
               std::sinh(_tmp188));
