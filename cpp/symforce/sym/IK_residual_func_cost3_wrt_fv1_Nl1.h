...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl1(
  ...
  const Scalar _tmp19 = _tmp12 * _tmp6;
  ...
  const Scalar _tmp35 = _tmp11 - _tmp15 + _tmp8;
  ...
  const Scalar _tmp44 = _tmp17 * _tmp43 - _tmp35 * _tmp43;
  ...
  const Scalar _tmp50 = -_tmp22 + _tmp23;
  ...
  const Scalar _tmp56 = _tmp34 * _tmp53 - _tmp55;
  const Scalar _tmp57 = _tmp54 * _tmp56;
  const Scalar _tmp58 = _tmp16 + _tmp8;
  const Scalar _tmp59 = _tmp17 * _tmp53;
  ...
  const Scalar _tmp64 = _tmp17 * _tmp34 - _tmp34 * _tmp58 - _tmp44 * _tmp57 -
                        _tmp63 * (-_tmp34 * _tmp59 + _tmp55 * _tmp58 - _tmp57 * _tmp60);
  ...
  const Scalar _tmp71 = _tmp70 * (_tmp34 * _tmp67 - _tmp43 * _tmp68);
  const Scalar _tmp72 = Scalar(1.0) / (_tmp69);
  const Scalar _tmp73 = _tmp70 * (_tmp47 * _tmp52 * _tmp72 - _tmp48 * _tmp51 * _tmp72);
  const Scalar _tmp74 = -_tmp37 * _tmp45 + _tmp40 * _tmp43 + _tmp43 * _tmp73;
  const Scalar _tmp75 = _tmp25 * _tmp34 - _tmp31 * _tmp55 + _tmp34 * _tmp73 - _tmp57 * _tmp74;
  const Scalar _tmp76 = Scalar(1.0) / (_tmp75);
  const Scalar _tmp77 = Scalar(1.0) * _tmp54;
  const Scalar _tmp78 = _tmp56 * _tmp76 * _tmp77;
  const Scalar _tmp79 = Scalar(1.0) * _tmp76;
  const Scalar _tmp80 = _tmp36 + _tmp46;
  const Scalar _tmp81 = _tmp39 + _tmp50;
  const Scalar _tmp82 = _tmp81 + position_vector(1, 0) + Scalar(8.3196563700000006);
  const Scalar _tmp83 = _tmp80 + position_vector(0, 0) + Scalar(1.9874742000000001);
  ...
  const Scalar _tmp87 = fh1 * (_tmp80 * _tmp85 - _tmp81 * _tmp86);
  const Scalar _tmp88 = -_tmp44 * _tmp77 + _tmp60 * _tmp63 * _tmp77;
  const Scalar _tmp89 = _tmp65 * _tmp75;
  const Scalar _tmp90 = _tmp64 * _tmp76;
  const Scalar _tmp91 = _tmp88 + _tmp90 * (-_tmp74 * _tmp77 - _tmp88 * _tmp89);
  const Scalar _tmp92 = _tmp56 * _tmp65;
  const Scalar _tmp93 = -_tmp91 * _tmp92 + Scalar(1.0);
  const Scalar _tmp94 = _tmp43 * _tmp54;
  const Scalar _tmp95 = _tmp34 * _tmp65;
  const Scalar _tmp96 = _tmp70 * fh1;
  const Scalar _tmp97 = _tmp53 * _tmp54;
  const Scalar _tmp98 = -_tmp17 + _tmp44 * _tmp97 - _tmp63 * (_tmp59 + _tmp60 * _tmp97);
  const Scalar _tmp99 = _tmp90 * (-_tmp73 + _tmp74 * _tmp97 - _tmp89 * _tmp98) + _tmp98;
  const Scalar _tmp100 = -_tmp53 - _tmp92 * _tmp99;
  const Scalar _tmp101 = _tmp0 * _tmp67;
  const Scalar _tmp102 = _tmp54 * fh1;
  ...
  _res(0, 0) = 0;
  _res(1, 0) =
      -_tmp71 * std::exp(_tmp0 * _tmp71 + _tmp70 * _tmp87 * (_tmp34 * _tmp79 - _tmp43 * _tmp78) +
                         _tmp85 * _tmp96 * (_tmp91 * _tmp95 + _tmp93 * _tmp94) +
                         _tmp86 * _tmp96 * (_tmp100 * _tmp94 + _tmp95 * _tmp99 + Scalar(1.0)));
  _res(2, 0) = -_tmp68 * std::exp(-_tmp100 * _tmp102 * _tmp86 + _tmp101 * _tmp57 -
                                  _tmp102 * _tmp85 * _tmp93 + _tmp78 * _tmp87);
  _res(3, 0) = _tmp67 * std::exp(-_tmp101 - _tmp103 * _tmp85 * _tmp91 - _tmp103 * _tmp86 * _tmp99 -
                                 _tmp79 * _tmp87);
