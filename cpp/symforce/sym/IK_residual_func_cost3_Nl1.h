...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl1(
  ...
  const Scalar _tmp61 = _tmp40 * _tmp57;
  const Scalar _tmp62 = _tmp31 + _tmp41;
  const Scalar _tmp63 = _tmp33 + _tmp43;
  const Scalar _tmp64 = _tmp45 + _tmp63;
  const Scalar _tmp65 = _tmp36 + _tmp62;
  ...
  const Scalar _tmp78 = -_tmp40 * _tmp76 + _tmp40 * _tmp77;
  const Scalar _tmp79 = _tmp54 * _tmp77;
  const Scalar _tmp80 = _tmp39 * _tmp76 - _tmp40 * _tmp79;
  const Scalar _tmp81 = Scalar(1.0) * _tmp42;
  const Scalar _tmp82 = Scalar(1.0) * _tmp44;
  const Scalar _tmp83 = (-_tmp32 + _tmp81) / (_tmp34 - _tmp82);
  const Scalar _tmp84 = -_tmp29 * _tmp75 + _tmp29 * _tmp77 - _tmp57 * _tmp78 -
                        _tmp83 * (-_tmp29 * _tmp79 + _tmp30 * _tmp75 - _tmp57 * _tmp80);
  const Scalar _tmp85 = Scalar(1.0) / (_tmp84);
  const Scalar _tmp86 = _tmp81 + _tmp82 * _tmp83;
  const Scalar _tmp87 = 0;
  const Scalar _tmp88 = Scalar(1.0) * _tmp55;
  const Scalar _tmp89 = -_tmp78 * _tmp88 + _tmp80 * _tmp83 * _tmp88;
  const Scalar _tmp90 = _tmp58 * _tmp85;
  const Scalar _tmp91 = _tmp59 * _tmp84;
  const Scalar _tmp92 = _tmp89 + _tmp91 * (-_tmp53 * _tmp88 - _tmp89 * _tmp90);
  const Scalar _tmp93 = _tmp56 * _tmp85;
  const Scalar _tmp94 = -_tmp92 * _tmp93 + Scalar(1.0);
  const Scalar _tmp95 = _tmp40 * _tmp55;
  const Scalar _tmp96 = _tmp29 * _tmp85;
  const Scalar _tmp97 = _tmp67 * fh1;
  const Scalar _tmp98 = _tmp54 * _tmp55;
  const Scalar _tmp99 = -_tmp77 + _tmp78 * _tmp98 - _tmp83 * (_tmp79 + _tmp80 * _tmp98);
  const Scalar _tmp100 = _tmp91 * (-_tmp52 + _tmp53 * _tmp98 - _tmp90 * _tmp99) + _tmp99;
  const Scalar _tmp101 = -_tmp100 * _tmp93 - _tmp54;
  const Scalar _tmp102 = _tmp68 * fh1;
  const Scalar _tmp103 = _tmp60 * _tmp69;
  const Scalar _tmp104 = _tmp70 * _tmp87;

  // Output terms (1)
  Eigen::Matrix<Scalar, 4, 1> _res;

  _res(0, 0) = std::exp(-fh1);
  _res(1, 0) = std::exp(_tmp102 * _tmp51 * (_tmp100 * _tmp96 + _tmp101 * _tmp95 + Scalar(1.0)) +
                        _tmp51 * _tmp69 * (_tmp29 * _tmp60 - _tmp60 * _tmp61) +
                        _tmp51 * _tmp70 * (_tmp29 * _tmp87 - _tmp61 * _tmp87) +
                        _tmp51 * _tmp97 * (_tmp92 * _tmp96 + _tmp94 * _tmp95));
  _res(2, 0) = std::exp(-_tmp101 * _tmp102 * _tmp55 + _tmp103 * _tmp57 + _tmp104 * _tmp57 -
                        _tmp55 * _tmp94 * _tmp97);
  _res(3, 0) = std::exp(-_tmp100 * _tmp102 * _tmp85 - _tmp103 - _tmp104 - _tmp85 * _tmp92 * _tmp97);
