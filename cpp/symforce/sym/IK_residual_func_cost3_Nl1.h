...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl1(
  ...
  const Scalar _tmp31 = -Scalar(0.010999999999999999) * _tmp20 -
  ...
  const Scalar _tmp44 = _tmp34 * _tmp43 - _tmp35 * _tmp43;
  ...
  const Scalar _tmp64 = _tmp29 * _tmp34 - _tmp29 * _tmp58 - _tmp44 * _tmp57 -
  ...
  const Scalar _tmp71 = _tmp69 * (_tmp47 * _tmp52 * _tmp70 - _tmp48 * _tmp51 * _tmp70);
  const Scalar _tmp72 = -_tmp37 * _tmp45 + _tmp40 * _tmp43 + _tmp43 * _tmp71;
  const Scalar _tmp73 = _tmp17 * _tmp29 - _tmp26 * _tmp55 + _tmp29 * _tmp71 - _tmp57 * _tmp72;
  ...
  const Scalar _tmp78 = _tmp36 + _tmp46;
  const Scalar _tmp79 = _tmp39 + _tmp50;
  const Scalar _tmp80 = _tmp79 + position_vector(1, 0) + Scalar(8.3196563700000006);
  const Scalar _tmp81 = _tmp78 + position_vector(0, 0) + Scalar(1.9874742000000001);
  ...
  const Scalar _tmp86 = -_tmp44 * _tmp75 + _tmp60 * _tmp63 * _tmp75;
  const Scalar _tmp87 = _tmp65 * _tmp73;
  const Scalar _tmp88 = _tmp64 * _tmp74;
  const Scalar _tmp89 = _tmp86 + _tmp88 * (-_tmp72 * _tmp75 - _tmp86 * _tmp87);
  const Scalar _tmp90 = _tmp56 * _tmp65;
  const Scalar _tmp91 = -_tmp89 * _tmp90 + Scalar(1.0);
  const Scalar _tmp92 = _tmp43 * _tmp54;
  const Scalar _tmp93 = _tmp29 * _tmp65;
  const Scalar _tmp94 = _tmp69 * fh1;
  const Scalar _tmp95 = _tmp53 * _tmp54;
  const Scalar _tmp96 = -_tmp34 + _tmp44 * _tmp95 - _tmp63 * (_tmp59 + _tmp60 * _tmp95);
  const Scalar _tmp97 = _tmp88 * (-_tmp71 + _tmp72 * _tmp95 - _tmp87 * _tmp96) + _tmp96;
  const Scalar _tmp98 = -_tmp53 - _tmp90 * _tmp97;
  const Scalar _tmp99 = _tmp0 * _tmp67;
  const Scalar _tmp100 = _tmp54 * fh1;
  const Scalar _tmp101 = _tmp65 * fh1;

  // Output terms (1)
  Eigen::Matrix<Scalar, 4, 1> _res;

  _res(0, 0) = std::exp(-fh1);
  _res(1, 0) = std::exp(_tmp0 * _tmp69 * (_tmp29 * _tmp67 - _tmp43 * _tmp57 * _tmp67) +
                        _tmp69 * _tmp85 * (_tmp29 * _tmp77 - _tmp43 * _tmp76) +
                        _tmp83 * _tmp94 * (_tmp89 * _tmp93 + _tmp91 * _tmp92) +
                        _tmp84 * _tmp94 * (_tmp92 * _tmp98 + _tmp93 * _tmp97 + Scalar(1.0)));
  _res(2, 0) = std::exp(-_tmp100 * _tmp83 * _tmp91 - _tmp100 * _tmp84 * _tmp98 + _tmp57 * _tmp99 +
                        _tmp76 * _tmp85);
  _res(3, 0) =
      std::exp(-_tmp101 * _tmp83 * _tmp89 - _tmp101 * _tmp84 * _tmp97 - _tmp77 * _tmp85 - _tmp99);
