...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2WrtFv1Nl14(
  ...
  const Scalar _tmp16 = -2 * std::pow(_tmp7, Scalar(2));
  ...
  const Scalar _tmp23 = _tmp11 * _tmp4;
  ...
  const Scalar _tmp42 = -Scalar(5.1796800000000003) * _tmp25 - _tmp31 * fv1 - _tmp36 * _tmp41;
  const Scalar _tmp43 = -_tmp29;
  const Scalar _tmp44 = _tmp22 + _tmp27 + _tmp43;
  ...
  const Scalar _tmp67 = _tmp38 - _tmp39;
  ...
  const Scalar _tmp71 = _tmp52 + position_vector(0, 0);
  ...
  const Scalar _tmp81 = _tmp44 + position_vector(1, 0);
  const Scalar _tmp82 = _tmp81 + Scalar(8.3888750099999996);
  const Scalar _tmp83 = _tmp80 * _tmp82;
  const Scalar _tmp84 = _tmp77 * _tmp83;
  const Scalar _tmp85 = _tmp67 + _tmp76;
  const Scalar _tmp86 = _tmp49 + position_vector(1, 0);
  const Scalar _tmp87 = _tmp86 + Scalar(8.3196563700000006);
  const Scalar _tmp88 = _tmp58 + position_vector(0, 0);
  ...
  const Scalar _tmp93 = -_tmp84 * _tmp92 + _tmp85 * _tmp91;
  const Scalar _tmp94 = -_tmp74 + _tmp75 * _tmp83;
  const Scalar _tmp95 = Scalar(1.0) / (_tmp83 * _tmp92 - _tmp91);
  const Scalar _tmp96 = _tmp94 * _tmp95;
  const Scalar _tmp97 = _tmp68 * _tmp74 - _tmp75 * _tmp84 - _tmp93 * _tmp96;
  const Scalar _tmp98 =
  ...
  const Scalar _tmp101 = _tmp100 * (-_tmp44 * _tmp79 * _tmp99 + _tmp54 * _tmp82 * _tmp99);
  const Scalar _tmp102 = _tmp101 * _tmp92 + _tmp49 * _tmp92 - _tmp58 * _tmp91;
  const Scalar _tmp103 = _tmp101 * _tmp75 - _tmp102 * _tmp96 - _tmp52 * _tmp74 + _tmp56 * _tmp75;
  const Scalar _tmp104 = Scalar(1.0) / (_tmp103);
  const Scalar _tmp105 = Scalar(1.0) * _tmp104;
  const Scalar _tmp106 = _tmp77 * _tmp92 - _tmp85 * _tmp92;
  const Scalar _tmp107 = -_tmp106 * _tmp96 - _tmp60 * _tmp97 - _tmp68 * _tmp75 + _tmp75 * _tmp77;
  const Scalar _tmp108 = _tmp104 * _tmp107;
  const Scalar _tmp109 = _tmp108 * _tmp63;
  const Scalar _tmp110 = -_tmp105 * _tmp97 + _tmp109 * _tmp57;
  const Scalar _tmp111 = Scalar(1.0) * _tmp50;
  const Scalar _tmp112 = _tmp34 * _tmp35;
  const Scalar _tmp113 = fh1 * (-_tmp112 * _tmp31 + _tmp20 * _tmp36);
  const Scalar _tmp114 = Scalar(1.0) * _tmp95;
  const Scalar _tmp115 = -_tmp106 * _tmp114 + _tmp111 * _tmp59 * _tmp93 * _tmp95;
  const Scalar _tmp116 = Scalar(1.0) / (_tmp107);
  const Scalar _tmp117 = _tmp103 * _tmp116;
  const Scalar _tmp118 = _tmp108 * (-_tmp102 * _tmp114 - _tmp115 * _tmp117);
  const Scalar _tmp119 = _tmp115 + _tmp118;
  const Scalar _tmp120 = _tmp116 * _tmp97;
  const Scalar _tmp121 = _tmp57 * _tmp62;
  const Scalar _tmp122 = -_tmp114 * _tmp93 + _tmp118 * _tmp121 - _tmp119 * _tmp120;
  const Scalar _tmp123 = Scalar(1.0) * fh1;
  const Scalar _tmp124 = _tmp83 * _tmp95;
  const Scalar _tmp125 = _tmp124 * _tmp93 + _tmp84;
  const Scalar _tmp126 = _tmp106 * _tmp124 - _tmp125 * _tmp60 - _tmp77;
  const Scalar _tmp127 = _tmp108 * (-_tmp101 + _tmp102 * _tmp124 - _tmp117 * _tmp126);
  const Scalar _tmp128 = _tmp126 + _tmp127;
  const Scalar _tmp129 = -_tmp120 * _tmp128 + _tmp121 * _tmp127 + _tmp125;
  const Scalar _tmp130 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp131 = _tmp45 * _tmp60 + _tmp55;
  const Scalar _tmp132 = _tmp131 * _tmp62;
  const Scalar _tmp133 = 0;
  const Scalar _tmp134 = _tmp50 * (-_tmp120 * _tmp133 - _tmp132 * _tmp57 + _tmp46);
  const Scalar _tmp135 = -Scalar(1.0) * _tmp132 - Scalar(1.0) * _tmp134 + Scalar(1.0);
  const Scalar _tmp136 = _tmp112 * _tmp41 + Scalar(5.1796800000000003) * _tmp14 + _tmp20 * fv1;
  const Scalar _tmp137 = _tmp50 * _tmp57;
  const Scalar _tmp138 = Scalar(1.0) * _tmp137 * _tmp63 - Scalar(1.0) * _tmp63;
  const Scalar _tmp139 = _tmp112 * _tmp123 * (-_tmp111 * _tmp129 + _tmp127 * _tmp63) +
                         Scalar(1.0) * _tmp113 * (_tmp109 - _tmp110 * _tmp111) +
                         _tmp123 * _tmp36 * (-_tmp111 * _tmp122 + _tmp118 * _tmp63) +
                         _tmp130 * _tmp135 + _tmp136 * _tmp138 + _tmp42 * _tmp66;
  const Scalar _tmp140 = _tmp116 * _tmp75;
  const Scalar _tmp141 = _tmp116 * _tmp94;
  const Scalar _tmp142 = -_tmp128 * _tmp141 - _tmp83;
  const Scalar _tmp143 = _tmp92 * _tmp95;
  const Scalar _tmp144 = _tmp112 * fh1;
  const Scalar _tmp145 = _tmp116 * _tmp133;
  const Scalar _tmp146 = _tmp133 * _tmp141;
  const Scalar _tmp147 = _tmp100 * (-_tmp143 * _tmp146 + _tmp145 * _tmp75);
  const Scalar _tmp148 = -_tmp119 * _tmp141 + Scalar(1.0);
  const Scalar _tmp149 = _tmp36 * fh1;
  const Scalar _tmp150 = _tmp104 * _tmp114 * _tmp94;
  const Scalar _tmp151 = -_tmp100 * _tmp113 * (_tmp105 * _tmp75 - _tmp150 * _tmp92) -
                         _tmp100 * _tmp144 * (_tmp128 * _tmp140 + _tmp142 * _tmp143 + Scalar(1.0)) -
                         _tmp100 * _tmp149 * (_tmp119 * _tmp140 + _tmp143 * _tmp148) -
                         _tmp130 * _tmp147;
  const Scalar _tmp152 = Scalar(1.0) / (_tmp151);
  const Scalar _tmp153 = std::asinh(_tmp139 * _tmp152);
  ...
  const Scalar _tmp161 = _tmp26 + _tmp48;
  const Scalar _tmp162 = _tmp147 * _tmp160;
  const Scalar _tmp163 =
      (-_tmp139 * _tmp162 + _tmp152 * (-_tmp135 + _tmp138 * _tmp20 + _tmp161 * _tmp66)) /
      std::sqrt(Scalar(std::pow(_tmp139, Scalar(2)) * _tmp160 + 1));
  const Scalar _tmp164 = _tmp146 * _tmp95;
  const Scalar _tmp165 = -_tmp113 * _tmp150 - _tmp130 * _tmp164 + _tmp142 * _tmp144 * _tmp95 +
                         _tmp148 * _tmp149 * _tmp95;
  const Scalar _tmp166 = Scalar(1.0) / (_tmp165);
  const Scalar _tmp167 = _tmp136 * _tmp63;
  const Scalar _tmp168 = _tmp110 * _tmp113 * _tmp50 + _tmp122 * _tmp149 * _tmp50 +
                         _tmp129 * _tmp144 * _tmp50 + _tmp130 * _tmp134 - _tmp137 * _tmp167 +
                         _tmp42 * _tmp64;
  ...
  const Scalar _tmp178 = _tmp20 * _tmp63;
  const Scalar _tmp179 =
      (_tmp166 * (-_tmp134 - _tmp137 * _tmp178 + _tmp161 * _tmp64) - _tmp168 * _tmp177) /
      std::sqrt(Scalar(std::pow(_tmp168, Scalar(2)) * _tmp176 + 1));
  const Scalar _tmp180 = _tmp105 * _tmp113 + _tmp116 * _tmp119 * _tmp149 +
                         _tmp116 * _tmp128 * _tmp144 + _tmp130 * _tmp145;
  const Scalar _tmp181 = Scalar(1.0) / (_tmp180);
  const Scalar _tmp182 = -_tmp109 * _tmp113 - _tmp118 * _tmp149 * _tmp62 -
                         _tmp127 * _tmp144 * _tmp62 + _tmp130 * _tmp132 + _tmp167 - _tmp42 * _tmp65;
  ...
  const Scalar _tmp187 = (_tmp181 * (-_tmp132 - _tmp161 * _tmp65 + _tmp178) + _tmp182 * _tmp186) /
  ...
  const Scalar _tmp192 = Scalar(9.6622558468725703) * _tmp145;
  ...
  _res(3, 0) = _tmp188 * (-Scalar(1.0) * _tmp187 * std::cosh(_tmp184) -
                          (Scalar(0.1034955) * _tmp186 * _tmp189 +
                           _tmp190 * (_tmp183 * _tmp192 - _tmp187 * _tmp188)) *
                              std::cosh(_tmp191)) -
               _tmp192 * (-std::sinh(_tmp184) - std::sinh(_tmp191));
