...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl18(
  ...
  const Scalar _tmp20 = -Scalar(0.20999999999999999) * _tmp12 + Scalar(0.20999999999999999) * _tmp9;
  const Scalar _tmp21 = -_tmp20;
  const Scalar _tmp22 = _tmp3 * _tmp8;
  const Scalar _tmp23 = 2 * _tmp10 * _tmp7;
  const Scalar _tmp24 =
      -Scalar(0.010999999999999999) * _tmp22 - Scalar(0.010999999999999999) * _tmp23;
  const Scalar _tmp25 = 1 - 2 * std::pow(_tmp7, Scalar(2));
  const Scalar _tmp26 = Scalar(0.20999999999999999) * _tmp25 + Scalar(0.20999999999999999) * _tmp4;
  const Scalar _tmp27 = _tmp24 + _tmp26;
  const Scalar _tmp28 = _tmp21 + _tmp27;
  const Scalar _tmp29 = _tmp28 + position_vector(0, 0) + Scalar(-2.5202214700000001);
  ...
  const Scalar _tmp35 = _tmp24 - _tmp26;
  const Scalar _tmp36 = _tmp21 + _tmp35;
  const Scalar _tmp37 = Scalar(1.0) * _tmp36;
  const Scalar _tmp38 = (-_tmp28 + _tmp37) / (_tmp18 - _tmp34);
  const Scalar _tmp39 = _tmp34 * _tmp38 + _tmp37;
  const Scalar _tmp40 = Scalar(0.20999999999999999) * _tmp22 - Scalar(0.20999999999999999) * _tmp23;
  const Scalar _tmp41 =
      -Scalar(0.010999999999999999) * _tmp2 - Scalar(0.010999999999999999) * _tmp25;
  const Scalar _tmp42 = Scalar(0.20999999999999999) * _tmp14 + Scalar(0.20999999999999999) * _tmp15;
  const Scalar _tmp43 = _tmp41 - _tmp42;
  const Scalar _tmp44 = -_tmp40 + _tmp43;
  const Scalar _tmp45 = _tmp31 * _tmp44;
  const Scalar _tmp46 = _tmp40 + _tmp43;
  const Scalar _tmp47 = -_tmp31 * _tmp46 + _tmp45;
  const Scalar _tmp48 = _tmp33 + position_vector(1, 0) + Scalar(8.3196563700000006);
  const Scalar _tmp49 = _tmp36 + position_vector(0, 0) + Scalar(1.9874742000000001);
  const Scalar _tmp50 = Scalar(1.0) / (_tmp49);
  const Scalar _tmp51 = _tmp48 * _tmp50;
  const Scalar _tmp52 = _tmp19 * _tmp30;
  const Scalar _tmp53 = Scalar(1.0) / (_tmp31 * _tmp51 - _tmp52);
  ...
  const Scalar _tmp57 = _tmp56 + position_vector(0, 0) + Scalar(-2.71799795);
  ...
  const Scalar _tmp61 = _tmp51 * _tmp60 - _tmp59;
  const Scalar _tmp62 = _tmp53 * _tmp61;
  const Scalar _tmp63 = _tmp40 + _tmp41 + _tmp42;
  const Scalar _tmp64 = -_tmp45 * _tmp51 + _tmp46 * _tmp52;
  const Scalar _tmp65 = _tmp44 * _tmp51;
  const Scalar _tmp66 = -_tmp38 * (_tmp59 * _tmp63 - _tmp60 * _tmp65 - _tmp62 * _tmp64) +
                        _tmp44 * _tmp60 - _tmp47 * _tmp62 - _tmp60 * _tmp63;
  ...
  const Scalar _tmp72 = _tmp71 * (-_tmp31 * _tmp69 + _tmp60 * _tmp68);
  const Scalar _tmp73 = Scalar(1.0) / (_tmp70);
  const Scalar _tmp74 = _tmp71 * (-_tmp33 * _tmp49 * _tmp73 + _tmp36 * _tmp48 * _tmp73);
  const Scalar _tmp75 = _tmp18 * _tmp31 - _tmp28 * _tmp52 + _tmp31 * _tmp74;
  const Scalar _tmp76 = Scalar(1.0) * _tmp53;
  const Scalar _tmp77 = _tmp38 * _tmp64 * _tmp76 - _tmp47 * _tmp76;
  const Scalar _tmp78 = _tmp54 * _tmp60 - _tmp56 * _tmp59 + _tmp60 * _tmp74 - _tmp62 * _tmp75;
  ...
  const Scalar _tmp94 = _tmp51 * _tmp53;
  const Scalar _tmp95 = -_tmp38 * (_tmp64 * _tmp94 + _tmp65) - _tmp44 + _tmp47 * _tmp94;
  const Scalar _tmp96 = _tmp81 * (-_tmp74 + _tmp75 * _tmp94 - _tmp79 * _tmp95) + _tmp95;
  const Scalar _tmp97 = -_tmp51 - _tmp83 * _tmp96;
  ...
  _res(1, 0) =
      -_tmp72 *
      std::exp(_tmp0 * _tmp72 + _tmp101 * _tmp71 * (-_tmp100 * _tmp31 * _tmp62 + _tmp100 * _tmp60) +
               _tmp71 * _tmp93 * (_tmp82 * _tmp86 + _tmp84 * _tmp85) +
               _tmp71 * _tmp99 * (_tmp85 * _tmp97 + _tmp86 * _tmp96 + Scalar(1.0)));
  _res(2, 0) = -_tmp69 * std::exp(_tmp102 * _tmp62 + _tmp103 * _tmp62 - _tmp53 * _tmp84 * _tmp93 -
                                  _tmp53 * _tmp97 * _tmp99);
  _res(3, 0) =
      _tmp68 * std::exp(-_tmp102 - _tmp103 - _tmp67 * _tmp82 * _tmp93 - _tmp67 * _tmp96 * _tmp99);
