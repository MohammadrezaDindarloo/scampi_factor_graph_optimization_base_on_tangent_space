...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl6(
  ...
  const Scalar _tmp16 = _tmp12 - _tmp15 + _tmp4;
  const Scalar _tmp17 = _tmp2 * _tmp9;
  ...
  const Scalar _tmp28 = Scalar(0.20999999999999999) * _tmp1 + Scalar(0.20999999999999999) * _tmp21;
  ...
  const Scalar _tmp36 = _tmp16 * _tmp33 - _tmp33 * _tmp35;
  ...
  const Scalar _tmp45 = _tmp44 + position_vector(0, 0) + Scalar(1.9874742000000001);
  const Scalar _tmp46 = Scalar(1.0) / (_tmp45);
  const Scalar _tmp47 = _tmp41 * _tmp46;
  const Scalar _tmp48 = Scalar(1.0) / (_tmp33 * _tmp47 - _tmp37);
  const Scalar _tmp49 = _tmp47 * _tmp48;
  const Scalar _tmp50 = _tmp16 * _tmp47;
  const Scalar _tmp51 = -_tmp33 * _tmp50 + _tmp35 * _tmp37;
  const Scalar _tmp52 = Scalar(1.0) * _tmp44;
  const Scalar _tmp53 = Scalar(1.0) * _tmp40;
  const Scalar _tmp54 = (-_tmp30 + _tmp52) / (_tmp24 - _tmp53);
  const Scalar _tmp55 = -_tmp16 + _tmp36 * _tmp49 - _tmp54 * (_tmp49 * _tmp51 + _tmp50);
  const Scalar _tmp56 = _tmp12 + _tmp34;
  const Scalar _tmp57 = _tmp23 + _tmp38;
  const Scalar _tmp58 = _tmp57 + position_vector(1, 0) + Scalar(-4.8333311099999996);
  const Scalar _tmp59 = _tmp26 + _tmp43;
  ...
  const Scalar _tmp64 = _tmp47 * _tmp63 - _tmp62;
  const Scalar _tmp65 = _tmp48 * _tmp64;
  const Scalar _tmp66 = _tmp16 * _tmp63 - _tmp36 * _tmp65 -
                        _tmp54 * (-_tmp50 * _tmp63 - _tmp51 * _tmp65 + _tmp56 * _tmp62) -
                        _tmp56 * _tmp63;
  ...
  const Scalar _tmp81 = _tmp33 * _tmp48;
  const Scalar _tmp82 = _tmp29 + _tmp42;
  const Scalar _tmp83 = _tmp82 + position_vector(0, 0) + Scalar(-2.5202214700000001);
  const Scalar _tmp84 = _tmp19 + _tmp39;
  const Scalar _tmp85 = _tmp84 + position_vector(1, 0) + Scalar(8.3888750099999996);
  ...
  const Scalar _tmp90 = _tmp33 * _tmp65;
  ...
  const Scalar _tmp94 = -_tmp36 * _tmp93 + _tmp51 * _tmp54 * _tmp93;
  ...
  const Scalar _tmp100 = _tmp48 * fh1;
  ...
  _res(1, 0) = std::exp(_tmp70 * _tmp92 * (_tmp63 * _tmp89 - _tmp89 * _tmp90) +
                        _tmp70 * _tmp97 * (_tmp63 * _tmp99 - _tmp90 * _tmp99) +
                        _tmp87 * _tmp88 * (_tmp77 * _tmp78 + _tmp80 * _tmp81 + Scalar(1.0)) +
                        _tmp88 * _tmp91 * (_tmp78 * _tmp95 + _tmp81 * _tmp96));
  _res(2, 0) = std::exp(-_tmp100 * _tmp80 * _tmp87 - _tmp100 * _tmp91 * _tmp96 + _tmp101 * _tmp65 +
                        _tmp102 * _tmp65);
