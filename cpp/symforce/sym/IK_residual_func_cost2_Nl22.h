...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2Nl22(
  ...
  const Scalar _tmp60 = _tmp16 + _tmp43;
  const Scalar _tmp61 = _tmp20 + _tmp39;
  ...
  const Scalar _tmp71 = _tmp56 * _tmp69;
  const Scalar _tmp72 = _tmp71 * (-_tmp50 * _tmp55 * _tmp70 + _tmp52 * _tmp53 * _tmp70);
  const Scalar _tmp73 = -_tmp60 * _tmp67 + _tmp61 * _tmp68 + _tmp68 * _tmp72;
  const Scalar _tmp74 = Scalar(1.0) / (_tmp57 * _tmp68 - _tmp67);
  ...
  const Scalar _tmp82 = _tmp74 * (-_tmp57 * _tmp81 + _tmp67 * _tmp79);
  const Scalar _tmp83 = Scalar(1.0) * _tmp50;
  const Scalar _tmp84 = -_tmp83;
  const Scalar _tmp85 = Scalar(1.0) / (_tmp61 + _tmp84);
  const Scalar _tmp86 = Scalar(1.0) * _tmp85;
  const Scalar _tmp87 = -_tmp68 * _tmp79 + _tmp81;
  const Scalar _tmp88 = -_tmp75 * _tmp87 + _tmp77 * _tmp82 * _tmp86;
  const Scalar _tmp89 = _tmp58 * _tmp80;
  const Scalar _tmp90 = _tmp33 + _tmp78;
  const Scalar _tmp91 = _tmp49 * _tmp90 - _tmp57 * _tmp89 - _tmp59 * _tmp82;
  const Scalar _tmp92 = _tmp77 * _tmp85;
  const Scalar _tmp93 = _tmp59 * _tmp74;
  const Scalar _tmp94 = -_tmp58 * _tmp90 - _tmp87 * _tmp93 + _tmp89 - _tmp91 * _tmp92;
  const Scalar _tmp95 = Scalar(1.0) / (_tmp94);
  const Scalar _tmp96 = _tmp40 * _tmp58 - _tmp45 * _tmp49 + _tmp58 * _tmp72 - _tmp73 * _tmp93;
  const Scalar _tmp97 = _tmp95 * _tmp96;
  const Scalar _tmp98 = Scalar(1.0) / (_tmp96);
  const Scalar _tmp99 = _tmp94 * _tmp98;
  const Scalar _tmp100 = _tmp99 * (-_tmp73 * _tmp75 - _tmp88 * _tmp97);
  const Scalar _tmp101 = _tmp95 * (_tmp100 + _tmp88);
  const Scalar _tmp102 = -_tmp101 * _tmp59 + Scalar(1.0);
  ...
  const Scalar _tmp109 = _tmp57 * _tmp74;
  const Scalar _tmp110 = _tmp57 * _tmp80 + _tmp57 * _tmp82;
  const Scalar _tmp111 = _tmp109 * _tmp87 - _tmp110 * _tmp92 - _tmp80;
  const Scalar _tmp112 = _tmp99 * (_tmp109 * _tmp73 - _tmp111 * _tmp97 - _tmp72);
  const Scalar _tmp113 = _tmp95 * (_tmp111 + _tmp112);
  const Scalar _tmp114 = -_tmp113 * _tmp59 - _tmp57;
  const Scalar _tmp115 = _tmp104 * _tmp106;
  const Scalar _tmp116 = _tmp115 * fh1;
  const Scalar _tmp117 = Scalar(1.0) * _tmp98;
  const Scalar _tmp118 = _tmp68 * _tmp93;
  const Scalar _tmp119 = fh1 * (_tmp107 * _tmp17 - _tmp115 * _tmp28);
  const Scalar _tmp120 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp121 = _tmp76 + _tmp83 * _tmp92;
  const Scalar _tmp122 = 0;
  const Scalar _tmp123 = -_tmp108 * _tmp71 * (_tmp101 * _tmp58 + _tmp102 * _tmp103) -
                         _tmp116 * _tmp71 * (_tmp103 * _tmp114 + _tmp113 * _tmp58 + Scalar(1.0)) -
                         _tmp119 * _tmp71 * (-_tmp117 * _tmp118 + _tmp117 * _tmp58) -
                         _tmp120 * _tmp71 * (-_tmp118 * _tmp122 + _tmp122 * _tmp58);
  const Scalar _tmp124 = Scalar(1.0) / (_tmp123);
  const Scalar _tmp125 = _tmp40 + _tmp84;
  const Scalar _tmp126 = _tmp125 * _tmp92;
  const Scalar _tmp127 = Scalar(1.0) / (-_tmp126 - _tmp45 + _tmp76);
  const Scalar _tmp128 = Scalar(1.0) * _tmp127;
  const Scalar _tmp129 = _tmp125 * _tmp127;
  const Scalar _tmp130 = _tmp110 + _tmp112 * _tmp129 - _tmp113 * _tmp91;
  const Scalar _tmp131 = _tmp100 * _tmp129 - _tmp101 * _tmp91 - Scalar(1.0) * _tmp82;
  const Scalar _tmp132 = _tmp128 * _tmp99;
  const Scalar _tmp133 = -_tmp117 * _tmp91 + _tmp125 * _tmp132;
  const Scalar _tmp134 = _tmp125 * _tmp85;
  const Scalar _tmp135 = _tmp38 * fh1;
  const Scalar _tmp136 = _tmp115 * _tmp135 + Scalar(5.1796800000000003) * _tmp14 + _tmp17 * fv1;
  const Scalar _tmp137 = _tmp121 * _tmp127;
  const Scalar _tmp138 = -_tmp122 * _tmp91 - _tmp125 * _tmp137 + _tmp84;
  const Scalar _tmp139 = _tmp85 * (_tmp126 * _tmp128 + Scalar(1.0));
  const Scalar _tmp140 = _tmp128 * _tmp92;
  const Scalar _tmp141 = -_tmp107 * _tmp135 - Scalar(5.1796800000000003) * _tmp23 - _tmp28 * fv1;
  const Scalar _tmp142 = std::asinh(
      _tmp124 * (Scalar(1.0) * _tmp108 * (_tmp100 * _tmp128 - _tmp131 * _tmp86) +
                 Scalar(1.0) * _tmp116 * (_tmp112 * _tmp128 - _tmp130 * _tmp86) +
                 Scalar(1.0) * _tmp119 * (_tmp132 - _tmp133 * _tmp86) +
                 Scalar(1.0) * _tmp120 * (-_tmp121 * _tmp128 - _tmp138 * _tmp86 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp136 * (_tmp128 * _tmp134 - _tmp128) +
  ...
  const Scalar _tmp147 = _tmp120 * _tmp122;
  const Scalar _tmp148 = _tmp117 * _tmp119;
  const Scalar _tmp149 =
      _tmp102 * _tmp108 * _tmp74 + _tmp114 * _tmp116 * _tmp74 - _tmp147 * _tmp93 - _tmp148 * _tmp93;
  const Scalar _tmp150 = Scalar(1.0) / (_tmp149);
  const Scalar _tmp151 =
      std::asinh(_tmp150 * (_tmp108 * _tmp131 * _tmp85 + _tmp116 * _tmp130 * _tmp85 +
                            _tmp119 * _tmp133 * _tmp85 + _tmp120 * _tmp138 * _tmp85 -
                            _tmp134 * _tmp146 + _tmp139 * _tmp141));
  ...
  const Scalar _tmp156 =
      std::asinh(_tmp154 * (-_tmp100 * _tmp108 * _tmp127 - _tmp112 * _tmp116 * _tmp127 -
                            _tmp119 * _tmp132 + _tmp120 * _tmp137 - _tmp140 * _tmp141 + _tmp146));
  ...
  _res(1, 0) =
      ...
      Scalar(8.36416322) *
          std::sqrt(Scalar(Scalar(0.014294040284261563) * _tmp144 +
                           std::pow(Scalar(-Scalar(0.1195576860108189) * _tmp80 -
  ...
  _res(2, 0) =
      ...
      Scalar(8.4718465799999993) *
          std::sqrt(Scalar(Scalar(0.013932974275675287) * _tmp145 +
                           std::pow(Scalar(-Scalar(0.11803802046660766) * _tmp79 -
                                           Scalar(0.11803802046660766) * position_vector(2, 0) + 1),
                                    Scalar(2))));
  _res(3, 0) =
      _tmp157 *
          (-std::sinh(Scalar(1.0) * _tmp156) -
           std::sinh(Scalar(0.1034955) * _tmp154 * (-std::sqrt(_tmp155) - _tmp156 * _tmp157))) -
