...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl16(
  ...
  const Scalar _tmp101 = _tmp42 * fh1;
  ...
  _res(1, 0) = std::exp(_tmp38 * _tmp92 * (-_tmp30 * _tmp90 + _tmp66 * _tmp89) +
                        _tmp38 * _tmp97 * (-_tmp30 * _tmp68 * _tmp99 + _tmp66 * _tmp99) +
                        _tmp87 * _tmp88 * (_tmp77 * _tmp78 + _tmp80 * _tmp81) +
                        _tmp88 * _tmp91 * (_tmp78 * _tmp95 + _tmp81 * _tmp96 + Scalar(1.0)));
  _res(2, 0) = std::exp(_tmp100 * _tmp68 - _tmp101 * _tmp80 * _tmp87 - _tmp101 * _tmp91 * _tmp96 +
                        _tmp90 * _tmp92);
  _res(3, 0) =
      std::exp(-_tmp100 - _tmp102 * _tmp77 * _tmp87 - _tmp102 * _tmp91 * _tmp95 - _tmp89 * _tmp92);
