...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl5(
  ...
  const Scalar _tmp54 = _tmp44 + Scalar(-110.0);
  ...
  const Scalar _tmp60 = _tmp59 * (_tmp41 * _tmp54 * _tmp57 - _tmp43 * _tmp55 * _tmp57);
  const Scalar _tmp61 = _tmp48 * _tmp52;
  const Scalar _tmp62 = _tmp45 + _tmp5;
  const Scalar _tmp63 = _tmp62 + position_vector(1, 0);
  const Scalar _tmp64 = _tmp63 + Scalar(-110.0);
  const Scalar _tmp65 = _tmp22 + _tmp40;
  ...
  const Scalar _tmp91 = _tmp34 + _tmp86;
  const Scalar _tmp92 = _tmp70 * _tmp91 - _tmp72 * _tmp90;
  const Scalar _tmp93 = _tmp61 * _tmp87 - _tmp72 * _tmp89 - _tmp75 * _tmp92;
  ...
  const Scalar _tmp101 = -_tmp100 * _tmp75 - _tmp53 * _tmp87 + _tmp89 - _tmp93 * _tmp99;
  const Scalar _tmp102 = Scalar(1.0) / (_tmp101);
  const Scalar _tmp103 = _tmp72 * _tmp74;
  const Scalar _tmp104 = _tmp103 * _tmp92 + _tmp72 * _tmp88;
  ...
  const Scalar _tmp108 = _tmp107 * (_tmp103 * _tmp71 - _tmp105 * _tmp106 - _tmp60);
  const Scalar _tmp109 = _tmp102 * (_tmp105 + _tmp108);
  const Scalar _tmp110 = -_tmp109 * _tmp73 - _tmp72;
  const Scalar _tmp111 = _tmp69 * _tmp74;
  ...
  const Scalar _tmp118 = -_tmp100 * _tmp116 + _tmp117 * _tmp74 * _tmp92 * _tmp98;
  const Scalar _tmp119 = _tmp107 * (-_tmp106 * _tmp118 - _tmp116 * _tmp71);
  const Scalar _tmp120 = _tmp102 * (_tmp118 + _tmp119);
  const Scalar _tmp121 = -_tmp120 * _tmp73 + Scalar(1.0);
  const Scalar _tmp122 = _tmp83 * fh1;
  const Scalar _tmp123 = -_tmp112 * _tmp59 * (_tmp109 * _tmp53 + _tmp110 * _tmp111 + Scalar(1.0)) -
                         _tmp113 * _tmp59 * (_tmp115 * _tmp53 - _tmp115 * _tmp79) -
                         _tmp122 * _tmp59 * (_tmp111 * _tmp121 + _tmp120 * _tmp53) -
                         _tmp59 * _tmp85 * (_tmp53 * _tmp78 - _tmp78 * _tmp79);
  const Scalar _tmp124 = Scalar(1.0) / (_tmp123);
  const Scalar _tmp125 = _tmp46 + _tmp95;
  const Scalar _tmp126 = _tmp125 * _tmp99;
  const Scalar _tmp127 = Scalar(1.0) / (-_tmp126 - _tmp49 + _tmp97);
  const Scalar _tmp128 = _tmp125 * _tmp127;
  const Scalar _tmp129 = -_tmp116 * _tmp92 + _tmp119 * _tmp128 - _tmp120 * _tmp93;
  const Scalar _tmp130 = Scalar(1.0) * _tmp127;
  const Scalar _tmp131 = _tmp107 * _tmp130;
  const Scalar _tmp132 = _tmp125 * _tmp131 - _tmp78 * _tmp93;
  const Scalar _tmp133 = _tmp114 * _tmp127;
  const Scalar _tmp134 = -_tmp115 * _tmp93 - _tmp125 * _tmp133 + _tmp95;
  const Scalar _tmp135 = _tmp104 + _tmp108 * _tmp128 - _tmp109 * _tmp93;
  const Scalar _tmp136 = _tmp126 * _tmp130 + Scalar(1.0);
  const Scalar _tmp137 = _tmp130 * _tmp99;
  const Scalar _tmp138 = _tmp39 * fh1;
  const Scalar _tmp139 = -_tmp138 * _tmp83 - Scalar(40.024799999999999) * _tmp16 - _tmp19 * fv1;
  const Scalar _tmp140 = _tmp138 * _tmp84 + Scalar(40.024799999999999) * _tmp26 + _tmp30 * fv1;
  const Scalar _tmp141 = _tmp125 * _tmp96;
  const Scalar _tmp142 = std::asinh(
      _tmp124 * (Scalar(1.0) * _tmp112 * (_tmp108 * _tmp130 - _tmp117 * _tmp135) +
                 Scalar(1.0) * _tmp113 * (-_tmp114 * _tmp130 - _tmp117 * _tmp134 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp122 * (-_tmp117 * _tmp129 + _tmp119 * _tmp130) +
                 Scalar(1.0) * _tmp139 * (-_tmp117 * _tmp136 + _tmp137) +
                 Scalar(1.0) * _tmp140 * (_tmp130 * _tmp141 - _tmp130) +
                 Scalar(1.0) * _tmp85 * (-_tmp117 * _tmp132 + _tmp131)));
  ...
  const Scalar _tmp146 =
      _tmp110 * _tmp112 * _tmp74 + _tmp121 * _tmp122 * _tmp74 - _tmp144 * _tmp75 - _tmp145 * _tmp75;
  const Scalar _tmp147 = Scalar(1.0) / (_tmp146);
  const Scalar _tmp148 = _tmp130 * _tmp140;
  const Scalar _tmp149 =
      std::asinh(_tmp147 * (_tmp112 * _tmp135 * _tmp96 + _tmp113 * _tmp134 * _tmp96 +
                            _tmp122 * _tmp129 * _tmp96 + _tmp132 * _tmp85 * _tmp96 +
                            _tmp136 * _tmp139 * _tmp96 - _tmp141 * _tmp148));
  const Scalar _tmp150 = Scalar(1.4083112389913199) * _tmp146;
  const Scalar _tmp151 = _tmp109 * _tmp112 + _tmp120 * _tmp122 + _tmp144 + _tmp145;
  const Scalar _tmp152 = Scalar(1.0) / (_tmp151);
  const Scalar _tmp153 = std::asinh(_tmp152 * (-_tmp108 * _tmp112 * _tmp127 + _tmp113 * _tmp133 -
                                               _tmp119 * _tmp122 * _tmp127 - _tmp131 * _tmp85 -
                                               _tmp137 * _tmp139 + _tmp148));
  ...
  _res(2, 0) =
      -_tmp150 *
          (Scalar(34.083374946563197) * _tmp147 + std::cosh(Scalar(1.0) * _tmp149) -
           std::cosh(
               Scalar(0.71007031138673404) * _tmp147 *
               (-_tmp149 * _tmp150 -
                Scalar(125.0) * std::sqrt(Scalar(
                                    Scalar(0.77439999999999998) *
               ...
               (-_tmp153 * _tmp154 -
                Scalar(125.0) *
                    std::sqrt(Scalar(
                        ...
                        Scalar(0.77439999999999998) *
                            std::pow(Scalar(-Scalar(0.0090909090909090905) * _tmp47 - 1),
                                     Scalar(2))))))) +
