...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl5(
  ...
  const Scalar _tmp42 = _tmp21 + _tmp29;
  ...
  const Scalar _tmp70 = _tmp61 * _tmp65;
  const Scalar _tmp71 = -_tmp46 * _tmp67 + _tmp69 * _tmp70;
  const Scalar _tmp72 = _tmp51 * _tmp56;
  const Scalar _tmp73 = _tmp46 * _tmp57 - _tmp72;
  const Scalar _tmp74 = Scalar(1.0) / (_tmp46 * _tmp66 - _tmp70);
  const Scalar _tmp75 = _tmp73 * _tmp74;
  const Scalar _tmp76 = _tmp34 + _tmp68;
  const Scalar _tmp77 = -_tmp46 * _tmp58 - _tmp71 * _tmp75 + _tmp72 * _tmp76;
  const Scalar _tmp78 =
  ...
  const Scalar _tmp81 = _tmp80 * (-_tmp39 * _tmp44 * _tmp79 + _tmp41 * _tmp42 * _tmp79);
  const Scalar _tmp82 = _tmp59 * _tmp66 - _tmp62 * _tmp70 + _tmp66 * _tmp81;
  const Scalar _tmp83 = _tmp49 * _tmp57 - _tmp53 * _tmp72 + _tmp57 * _tmp81 - _tmp75 * _tmp82;
  ...
  const Scalar _tmp89 = Scalar(1.0) * _tmp42;
  const Scalar _tmp90 = Scalar(1.0) / (_tmp59 + _tmp87);
  const Scalar _tmp91 = -_tmp62 + _tmp89;
  const Scalar _tmp92 = _tmp90 * _tmp91;
  const Scalar _tmp93 = _tmp88 * _tmp92;
  const Scalar _tmp94 = Scalar(1.0) / (-_tmp53 + _tmp89 - _tmp93);
  const Scalar _tmp95 = Scalar(1.0) * _tmp94;
  const Scalar _tmp96 = -_tmp66 * _tmp69 + _tmp67;
  const Scalar _tmp97 = -_tmp57 * _tmp76 + _tmp58 - _tmp75 * _tmp96 - _tmp77 * _tmp92;
  ...
  const Scalar _tmp102 = _tmp31 + Scalar(1.9874742000000001);
  ...
  const Scalar _tmp108 = _tmp86 * _tmp92 + _tmp89;
  const Scalar _tmp109 = 0;
  const Scalar _tmp110 = Scalar(1.0) / (_tmp97);
  const Scalar _tmp111 = _tmp110 * _tmp77;
  const Scalar _tmp112 = _tmp108 * _tmp94;
  const Scalar _tmp113 = -_tmp109 * _tmp111 - _tmp112 * _tmp88 + _tmp87;
  const Scalar _tmp114 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp115 = _tmp46 * _tmp74;
  const Scalar _tmp116 = _tmp115 * _tmp71 + _tmp46 * _tmp47;
  const Scalar _tmp117 = _tmp115 * _tmp96 - _tmp116 * _tmp92 - _tmp47;
  const Scalar _tmp118 = _tmp110 * _tmp83;
  const Scalar _tmp119 = _tmp98 * (_tmp115 * _tmp82 - _tmp117 * _tmp118 - _tmp81);
  const Scalar _tmp120 = _tmp88 * _tmp94;
  const Scalar _tmp121 = _tmp117 + _tmp119;
  const Scalar _tmp122 = -_tmp111 * _tmp121 + _tmp116 + _tmp119 * _tmp120;
  const Scalar _tmp123 = _tmp106 * fh1;
  const Scalar _tmp124 = Scalar(1.0) * _tmp74;
  const Scalar _tmp125 = _tmp101 * _tmp71 * _tmp74 * _tmp91 - _tmp124 * _tmp96;
  const Scalar _tmp126 = _tmp98 * (-_tmp118 * _tmp125 - _tmp124 * _tmp82);
  const Scalar _tmp127 = _tmp110 * (_tmp125 + _tmp126);
  const Scalar _tmp128 = _tmp120 * _tmp126 - _tmp124 * _tmp71 - _tmp127 * _tmp77;
  const Scalar _tmp129 = _tmp105 * fh1;
  const Scalar _tmp130 = _tmp93 * _tmp95 + Scalar(1.0);
  const Scalar _tmp131 = _tmp92 * _tmp95;
  const Scalar _tmp132 = _tmp38 * fh1;
  const Scalar _tmp133 = -_tmp105 * _tmp132 - Scalar(5.1796800000000003) * _tmp16 - _tmp19 * fv1;
  const Scalar _tmp134 = _tmp88 * _tmp90;
  const Scalar _tmp135 = _tmp106 * _tmp132 + Scalar(5.1796800000000003) * _tmp25 + _tmp30 * fv1;
  const Scalar _tmp136 = _tmp109 * _tmp110;
  const Scalar _tmp137 = _tmp66 * _tmp75;
  const Scalar _tmp138 = _tmp110 * _tmp121;
  const Scalar _tmp139 = -_tmp138 * _tmp73 - _tmp46;
  const Scalar _tmp140 = _tmp66 * _tmp74;
  const Scalar _tmp141 = -_tmp127 * _tmp73 + Scalar(1.0);
  const Scalar _tmp142 = -_tmp107 * _tmp80 * (-_tmp137 * _tmp85 + _tmp57 * _tmp85) -
                         _tmp114 * _tmp80 * (-_tmp136 * _tmp137 + _tmp136 * _tmp57) -
                         _tmp123 * _tmp80 * (_tmp138 * _tmp57 + _tmp139 * _tmp140 + Scalar(1.0)) -
                         _tmp129 * _tmp80 * (_tmp127 * _tmp57 + _tmp140 * _tmp141);
  const Scalar _tmp143 = Scalar(1.0) / (_tmp142);
  const Scalar _tmp144 = std::asinh(
      _tmp143 * (Scalar(1.0) * _tmp107 * (-_tmp100 * _tmp101 + _tmp99) +
                 Scalar(1.0) * _tmp114 * (-_tmp101 * _tmp113 - _tmp108 * _tmp95 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp123 * (-_tmp101 * _tmp122 + _tmp119 * _tmp95) +
                 Scalar(1.0) * _tmp129 * (-_tmp101 * _tmp128 + _tmp126 * _tmp95) +
                 Scalar(1.0) * _tmp133 * (-_tmp101 * _tmp130 + _tmp131) +
                 Scalar(1.0) * _tmp135 * (_tmp134 * _tmp95 - _tmp95)));
  const Scalar _tmp145 = Scalar(9.6622558468725703) * _tmp142;
  const Scalar _tmp146 = _tmp135 * _tmp95;
  const Scalar _tmp147 = _tmp107 * _tmp85;
  const Scalar _tmp148 = _tmp114 * _tmp136;
  const Scalar _tmp149 =
      _tmp123 * _tmp139 * _tmp74 + _tmp129 * _tmp141 * _tmp74 - _tmp147 * _tmp75 - _tmp148 * _tmp75;
  const Scalar _tmp150 = Scalar(1.0) / (_tmp149);
  const Scalar _tmp151 =
      std::asinh(_tmp150 * (_tmp100 * _tmp107 * _tmp90 + _tmp113 * _tmp114 * _tmp90 +
                            _tmp122 * _tmp123 * _tmp90 + _tmp128 * _tmp129 * _tmp90 +
                            _tmp130 * _tmp133 * _tmp90 - _tmp134 * _tmp146));
  const Scalar _tmp152 = Scalar(9.6622558468725703) * _tmp149;
  const Scalar _tmp153 = _tmp123 * _tmp138 + _tmp127 * _tmp129 + _tmp147 + _tmp148;
  const Scalar _tmp154 = Scalar(1.0) / (_tmp153);
  const Scalar _tmp155 =
      std::asinh(_tmp154 * (-_tmp107 * _tmp99 + _tmp112 * _tmp114 - _tmp119 * _tmp123 * _tmp94 -
                            _tmp126 * _tmp129 * _tmp94 - _tmp131 * _tmp133 + _tmp146));
                ...
                Scalar(4.8333311099999996) *
                    std::sqrt(Scalar(
                        ...
                        Scalar(0.13817235445745474) *
                            std::pow(Scalar(-Scalar(0.55659957866191134) * _tmp43 - 1),
                                     Scalar(2))))))) +
                ...
                Scalar(4.7752063900000001) *
                    std::sqrt(Scalar(
                        ...
                        Scalar(0.32397683292140877) *
                            std::pow(Scalar(1 - Scalar(0.36791786395571047) * _tmp63),
                                     Scalar(2))))))) +
