...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1WrtFh1Nl15(
  ...
  const Scalar _tmp26 = _tmp10 * _tmp5;
  ...
  const Scalar _tmp49 = -Scalar(0.010999999999999999) * _tmp17 -
  ...
  const Scalar _tmp66 = Scalar(1.0) / (_tmp46 * _tmp62 - _tmp65);
  const Scalar _tmp67 = _tmp66 * (-_tmp52 * _tmp62 + _tmp62 * _tmp64);
  const Scalar _tmp68 = _tmp46 * _tmp64;
  const Scalar _tmp69 = _tmp52 * _tmp65 - _tmp62 * _tmp68;
  ...
  const Scalar _tmp77 = _tmp46 * _tmp67 - _tmp64 - _tmp71 * _tmp76;
  const Scalar _tmp78 = _tmp37 + _tmp53;
  ...
  const Scalar _tmp86 = _tmp48 + _tmp63;
  const Scalar _tmp87 = _tmp83 * _tmp84;
  const Scalar _tmp88 = _tmp46 * _tmp85 - _tmp87;
  const Scalar _tmp89 = _tmp66 * _tmp88;
  const Scalar _tmp90 = -_tmp68 * _tmp85 - _tmp69 * _tmp89 + _tmp86 * _tmp87;
  const Scalar _tmp91 = _tmp64 * _tmp85 - _tmp67 * _tmp88 - _tmp76 * _tmp90 - _tmp85 * _tmp86;
  const Scalar _tmp92 = Scalar(1.0) / (_tmp91);
  const Scalar _tmp93 =
      std::sqrt(Scalar(std::pow(_tmp40, Scalar(2)) + std::pow(_tmp45, Scalar(2))));
  const Scalar _tmp94 = Scalar(1.0) / (_tmp93);
  const Scalar _tmp95 = _tmp41 * _tmp93;
  const Scalar _tmp96 = _tmp95 * (_tmp38 * _tmp45 * _tmp94 - _tmp40 * _tmp43 * _tmp94);
  const Scalar _tmp97 = -_tmp54 * _tmp65 + _tmp58 * _tmp62 + _tmp62 * _tmp96;
  const Scalar _tmp98 = -_tmp78 * _tmp87 + _tmp81 * _tmp85 + _tmp85 * _tmp96 - _tmp89 * _tmp97;
  const Scalar _tmp99 = _tmp92 * _tmp98;
  const Scalar _tmp100 = Scalar(1.0) / (_tmp98);
  const Scalar _tmp101 = _tmp100 * _tmp91;
  const Scalar _tmp102 = _tmp101 * (_tmp70 * _tmp97 - _tmp77 * _tmp99 - _tmp96);
  const Scalar _tmp103 = _tmp102 + _tmp77;
  const Scalar _tmp104 = _tmp85 * _tmp92;
  const Scalar _tmp105 = _tmp88 * _tmp92;
  const Scalar _tmp106 = _tmp66 * (-_tmp103 * _tmp105 - _tmp46);
  const Scalar _tmp107 = _tmp22 + Scalar(-2.71799795);
  const Scalar _tmp108 = _tmp32 + Scalar(-4.7752063900000001);
  const Scalar _tmp109 =
      std::pow(Scalar(std::pow(_tmp107, Scalar(2)) + std::pow(_tmp108, Scalar(2))),
               Scalar(Scalar(-1) / Scalar(2)));
  const Scalar _tmp110 = _tmp107 * _tmp109;
  const Scalar _tmp111 = _tmp110 * _tmp95 * (_tmp103 * _tmp104 + _tmp106 * _tmp62 + Scalar(1.0));
  const Scalar _tmp112 = Scalar(1.0) * _tmp66;
  const Scalar _tmp113 = _tmp112 * _tmp69;
  const Scalar _tmp114 = _tmp113 * _tmp76 - Scalar(1.0) * _tmp67;
  ...
  const Scalar _tmp119 = _tmp118 * _tmp95 * (_tmp104 * _tmp116 + _tmp117 * _tmp62);
  const Scalar _tmp120 = -_tmp110 * _tmp31 + _tmp118 * _tmp21;
  const Scalar _tmp121 = Scalar(1.0) * _tmp100;
  const Scalar _tmp122 = _tmp62 * _tmp89;
  const Scalar _tmp123 = _tmp120 * _tmp95 * (-_tmp121 * _tmp122 + _tmp121 * _tmp85);
  ...
  const Scalar _tmp127 = -_tmp111 * fh1 - _tmp119 * fh1 - _tmp123 * fh1 -
                         _tmp124 * _tmp95 * (-_tmp122 * _tmp126 + _tmp126 * _tmp85);
  const Scalar _tmp128 = Scalar(1.0) / (_tmp127);
  const Scalar _tmp129 = _tmp73 + _tmp81;
  const Scalar _tmp130 = _tmp129 * _tmp76;
  const Scalar _tmp131 = Scalar(1.0) / (-_tmp130 + _tmp75 - _tmp78);
  const Scalar _tmp132 = Scalar(1.0) * _tmp131;
  const Scalar _tmp133 = _tmp125 * _tmp131;
  const Scalar _tmp134 = _tmp74 * (-_tmp126 * _tmp90 - _tmp129 * _tmp133 + _tmp73);
  const Scalar _tmp135 = _tmp101 * _tmp132;
  const Scalar _tmp136 = _tmp74 * (-_tmp121 * _tmp90 + _tmp129 * _tmp135);
  const Scalar _tmp137 = Scalar(1.0) * _tmp120 * (_tmp135 - Scalar(1.0) * _tmp136);
  const Scalar _tmp138 = _tmp90 * _tmp92;
  const Scalar _tmp139 = _tmp129 * _tmp131;
  const Scalar _tmp140 = _tmp102 * _tmp139 - _tmp103 * _tmp138 + _tmp71;
  const Scalar _tmp141 = Scalar(1.0) * _tmp74;
  const Scalar _tmp142 = Scalar(1.0) * _tmp110 * (_tmp102 * _tmp132 - _tmp140 * _tmp141);
  const Scalar _tmp143 = -_tmp113 + _tmp115 * _tmp139 - _tmp116 * _tmp138;
  const Scalar _tmp144 = Scalar(1.0) * _tmp118 * (_tmp115 * _tmp132 - _tmp141 * _tmp143);
  const Scalar _tmp145 = _tmp47 + _tmp51;
  const Scalar _tmp146 = _tmp145 * fh1;
  const Scalar _tmp147 = -_tmp118 * _tmp146 - Scalar(5.1796800000000003) * _tmp27 - _tmp31 * fv1;
  ...
  const Scalar _tmp151 = _tmp110 * _tmp146 + Scalar(5.1796800000000003) * _tmp15 + _tmp21 * fv1;
  const Scalar _tmp152 = _tmp129 * _tmp74;
  const Scalar _tmp153 = _tmp132 * _tmp152;
  const Scalar _tmp154 = -Scalar(1.0) * _tmp132 + Scalar(1.0) * _tmp153;
  const Scalar _tmp155 =
      Scalar(1.0) * _tmp124 * (-_tmp125 * _tmp132 - Scalar(1.0) * _tmp134 + Scalar(1.0)) +
      _tmp137 * fh1 + _tmp142 * fh1 + _tmp144 * fh1 + _tmp147 * _tmp150 + _tmp151 * _tmp154;
  ...
  const Scalar _tmp162 = -_tmp111 - _tmp119 - _tmp123;
  ...
  const Scalar _tmp166 = _tmp110 * _tmp145;
  const Scalar _tmp167 = _tmp118 * _tmp145;
  const Scalar _tmp168 =
      (_tmp128 * (_tmp137 + _tmp142 + _tmp144 - _tmp150 * _tmp167 + _tmp154 * _tmp166) -
       _tmp155 * _tmp165) /
      std::sqrt(Scalar(std::pow(_tmp155, Scalar(2)) * _tmp164 + 1));
  const Scalar _tmp169 = _tmp124 * _tmp126;
  const Scalar _tmp170 = _tmp120 * _tmp121;
  const Scalar _tmp171 = _tmp170 * fh1;
  const Scalar _tmp172 = _tmp106 * _tmp110;
  const Scalar _tmp173 = _tmp117 * _tmp118;
  const Scalar _tmp174 = -_tmp169 * _tmp89 - _tmp171 * _tmp89 + _tmp172 * fh1 + _tmp173 * fh1;
  const Scalar _tmp175 = Scalar(1.0) / (_tmp174);
  const Scalar _tmp176 = _tmp120 * _tmp136;
  const Scalar _tmp177 = _tmp110 * _tmp140 * _tmp74;
  const Scalar _tmp178 = _tmp118 * _tmp143 * _tmp74;
  const Scalar _tmp179 = _tmp132 * _tmp151;
  const Scalar _tmp180 = _tmp124 * _tmp134 + _tmp147 * _tmp148 - _tmp152 * _tmp179 + _tmp176 * fh1 +
                         _tmp177 * fh1 + _tmp178 * fh1;
  const Scalar _tmp181 = std::asinh(_tmp175 * _tmp180);
  const Scalar _tmp182 = Scalar(9.6622558468725703) * _tmp174;
  ...
  const Scalar _tmp184 = Scalar(0.1034955) * _tmp175;
  const Scalar _tmp185 = _tmp183 * _tmp184;
  const Scalar _tmp186 = Scalar(1.0) * _tmp181;
  const Scalar _tmp187 = -_tmp170 * _tmp89 + _tmp172 + _tmp173;
  ...
  const Scalar _tmp191 =
      (_tmp175 * (-_tmp148 * _tmp167 - _tmp153 * _tmp166 + _tmp176 + _tmp177 + _tmp178) -
       _tmp180 * _tmp190) /
      std::sqrt(Scalar(std::pow(_tmp180, Scalar(2)) * _tmp189 + 1));
  const Scalar _tmp192 = _tmp116 * _tmp118 * _tmp92;
  ...
  const Scalar _tmp196 = _tmp170 + _tmp192 + _tmp193;
  const Scalar _tmp197 = _tmp195 * _tmp196;
  const Scalar _tmp198 = _tmp120 * _tmp135;
  const Scalar _tmp199 = _tmp102 * _tmp110 * _tmp131;
  const Scalar _tmp200 = _tmp115 * _tmp118 * _tmp131;
  const Scalar _tmp201 = _tmp124 * _tmp133 - _tmp147 * _tmp149 + _tmp179 - _tmp198 * fh1 -
  ...
  const Scalar _tmp209 = (-_tmp197 * _tmp201 + _tmp202 * (_tmp132 * _tmp166 + _tmp149 * _tmp167 -
  ...
  _res(1, 0) =
      -_tmp158 *
          (-Scalar(0.87653584775870996) * _tmp165 + Scalar(1.0) * _tmp168 * std::sinh(_tmp157) -
           (-Scalar(0.1034955) * _tmp159 * _tmp165 +
            _tmp160 * (-_tmp156 * _tmp163 - _tmp158 * _tmp168)) *
               std::sinh(_tmp161)) -
      _tmp163 * (Scalar(0.87653584775870996) * _tmp128 + std::cosh(_tmp157) - std::cosh(_tmp161));
  _res(2, 0) =
      -_tmp182 *
          (-Scalar(0.86625939559540499) * _tmp190 + Scalar(1.0) * _tmp191 * std::sinh(_tmp186) -
           (-Scalar(0.1034955) * _tmp183 * _tmp190 +
            _tmp184 * (-_tmp181 * _tmp188 - _tmp182 * _tmp191)) *
               std::sinh(_tmp185)) -
      _tmp188 * (Scalar(0.86625939559540499) * _tmp175 - std::cosh(_tmp185) + std::cosh(_tmp186));
  _res(3, 0) =
      -_tmp204 *
          (-Scalar(0.87679799772039002) * _tmp197 + Scalar(1.0) * _tmp209 * std::sinh(_tmp210) -
           (-Scalar(0.1034955) * _tmp197 * _tmp205 +
            _tmp206 * (-_tmp203 * _tmp208 - _tmp204 * _tmp209)) *
               std::sinh(_tmp207)) -
      _tmp208 * (Scalar(0.87679799772039002) * _tmp202 - std::cosh(_tmp207) + std::cosh(_tmp210));
