...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl4(
  ...
  const Scalar _tmp29 = Scalar(0.20999999999999999) * _tmp10 + Scalar(0.20999999999999999) * _tmp22;
  ...
  const Scalar _tmp53 = _tmp12 - _tmp15 + _tmp9;
  const Scalar _tmp54 = _tmp46 * _tmp50;
  const Scalar _tmp55 = -_tmp43 * _tmp52 + _tmp53 * _tmp54;
  const Scalar _tmp56 = _tmp26 * _tmp33;
  const Scalar _tmp57 = _tmp34 * _tmp43 - _tmp56;
  const Scalar _tmp58 = Scalar(1.0) / (_tmp43 * _tmp51 - _tmp54);
  const Scalar _tmp59 = _tmp57 * _tmp58;
  const Scalar _tmp60 = _tmp16 + _tmp9;
  ...
  const Scalar _tmp65 = -_tmp34 * _tmp60 + _tmp35 - _tmp59 * _tmp64 -
                        _tmp63 * (-_tmp35 * _tmp43 - _tmp55 * _tmp59 + _tmp56 * _tmp60);
  ...
  const Scalar _tmp72 = _tmp55 * _tmp58;
  ...
  const Scalar _tmp77 = _tmp58 * (_tmp45 * _tmp51 - _tmp48 * _tmp54 + _tmp51 * _tmp76);
  const Scalar _tmp78 = _tmp25 * _tmp34 - _tmp31 * _tmp56 + _tmp34 * _tmp76 - _tmp57 * _tmp77;
  ...
  const Scalar _tmp83 = _tmp57 * _tmp66;
  const Scalar _tmp84 = -_tmp82 * _tmp83 + Scalar(1.0);
  const Scalar _tmp85 = _tmp51 * _tmp58;
  const Scalar _tmp86 = _tmp34 * _tmp66;
  const Scalar _tmp87 = _tmp36 + _tmp44;
  const Scalar _tmp88 = _tmp87 + position_vector(1, 0) + Scalar(8.3196563700000006);
  const Scalar _tmp89 = _tmp39 + _tmp47;
  ...
  const Scalar _tmp99 = -_tmp43 - _tmp83 * _tmp98;
  ...
  _res(1, 0) = std::exp(_tmp0 * _tmp71 * (_tmp34 * _tmp68 - _tmp68 * _tmp69) +
                        _tmp100 * _tmp71 * (_tmp85 * _tmp99 + _tmp86 * _tmp98 + Scalar(1.0)) +
                        _tmp71 * _tmp93 * (_tmp82 * _tmp86 + _tmp84 * _tmp85) +
                        _tmp71 * _tmp96 * (_tmp34 * _tmp94 - _tmp69 * _tmp94));
  _res(2, 0) = std::exp(-_tmp100 * _tmp58 * _tmp99 + _tmp101 * _tmp59 + _tmp102 * _tmp59 -
                        _tmp58 * _tmp84 * _tmp93);
  _res(3, 0) = std::exp(-_tmp100 * _tmp66 * _tmp98 - _tmp101 - _tmp102 - _tmp66 * _tmp82 * _tmp93);
