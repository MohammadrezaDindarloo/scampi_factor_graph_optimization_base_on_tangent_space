...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl4(
  ...
  const Scalar _tmp77 = _tmp52 * (_tmp51 * _tmp74 - _tmp51 * _tmp76);
  const Scalar _tmp78 = Scalar(1.0) * _tmp36;
  const Scalar _tmp79 = Scalar(1.0) * _tmp33;
  const Scalar _tmp80 = (-_tmp47 + _tmp78) / (_tmp43 - _tmp79);
  const Scalar _tmp81 = _tmp40 * _tmp74;
  const Scalar _tmp82 = _tmp52 * (_tmp50 * _tmp76 - _tmp51 * _tmp81);
  const Scalar _tmp83 = -Scalar(1.0) * _tmp77 + Scalar(1.0) * _tmp80 * _tmp82;
  const Scalar _tmp84 = _tmp73 + _tmp75;
  const Scalar _tmp85 = _tmp30 * _tmp74;
  const Scalar _tmp86 = -_tmp30 * _tmp84 - _tmp41 * _tmp77 -
                        _tmp80 * (_tmp31 * _tmp84 - _tmp40 * _tmp85 - _tmp41 * _tmp82) + _tmp85;
  ...
  const Scalar _tmp95 = _tmp40 * _tmp77 - _tmp74 - _tmp80 * (_tmp40 * _tmp82 + _tmp81);
  ...
  const Scalar _tmp100 = _tmp78 + _tmp79 * _tmp80;
  const Scalar _tmp101 = 0;
  const Scalar _tmp102 = _tmp60 * _tmp70;
  const Scalar _tmp103 = _tmp41 * _tmp52;
  const Scalar _tmp104 = _tmp101 * _tmp99;

  // Output terms (1)
  Eigen::Matrix<Scalar, 4, 1> _res;

  _res(0, 0) = std::exp(-fh1);
  _res(1, 0) = std::exp(_tmp55 * _tmp70 * (_tmp30 * _tmp60 - _tmp60 * _tmp62) +
                        _tmp55 * _tmp94 * (_tmp61 * _tmp92 + _tmp90 * _tmp93) +
                        _tmp55 * _tmp98 * (_tmp61 * _tmp97 + _tmp93 * _tmp96 + Scalar(1.0)) +
                        _tmp55 * _tmp99 * (_tmp101 * _tmp30 - _tmp101 * _tmp62));
  _res(2, 0) = std::exp(_tmp102 * _tmp103 + _tmp103 * _tmp104 - _tmp52 * _tmp92 * _tmp94 -
                        _tmp52 * _tmp97 * _tmp98);
  _res(3, 0) = std::exp(-_tmp102 - _tmp104 - _tmp87 * _tmp90 * _tmp94 - _tmp87 * _tmp96 * _tmp98);
