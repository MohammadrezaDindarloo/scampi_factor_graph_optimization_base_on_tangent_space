...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl10(
  ...
  const Scalar _tmp42 = _tmp37 + position_vector(0, 0);
  ...
  const Scalar _tmp60 = -_tmp37 * _tmp45 + _tmp39 * _tmp46 + _tmp46 * _tmp59;
  const Scalar _tmp61 = _tmp50 * _tmp57;
  const Scalar _tmp62 = Scalar(1.0) / (-_tmp45 + _tmp46 * _tmp61);
  const Scalar _tmp63 = Scalar(1.0) * _tmp62;
  const Scalar _tmp64 = -_tmp31;
  const Scalar _tmp65 = _tmp34 + _tmp64;
  const Scalar _tmp66 = _tmp32 + _tmp33;
  const Scalar _tmp67 = _tmp64 + _tmp66;
  const Scalar _tmp68 = _tmp46 * _tmp67;
  const Scalar _tmp69 = _tmp45 * _tmp65 - _tmp61 * _tmp68;
  ...
  const Scalar _tmp74 = Scalar(1.0) * _tmp52;
  const Scalar _tmp75 = _tmp73 * (-_tmp37 + _tmp74);
  const Scalar _tmp76 = -_tmp46 * _tmp65 + _tmp68;
  const Scalar _tmp77 = -_tmp63 * _tmp76 + _tmp70 * _tmp75;
  ...
  const Scalar _tmp81 = _tmp21 + _tmp51;
  ...
  const Scalar _tmp87 = _tmp80 * _tmp84;
  const Scalar _tmp88 = _tmp61 * _tmp85 - _tmp87;
  const Scalar _tmp89 = _tmp62 * _tmp88;
  const Scalar _tmp90 = _tmp31 + _tmp66;
  const Scalar _tmp91 = -_tmp61 * _tmp86 - _tmp69 * _tmp89 + _tmp87 * _tmp90;
  const Scalar _tmp92 = -_tmp75 * _tmp91 - _tmp76 * _tmp89 - _tmp85 * _tmp90 + _tmp86;
  const Scalar _tmp93 = Scalar(1.0) / (_tmp92);
  const Scalar _tmp94 = _tmp59 * _tmp85 - _tmp60 * _tmp89 + _tmp78 * _tmp85 - _tmp81 * _tmp87;
  const Scalar _tmp95 = _tmp93 * _tmp94;
  const Scalar _tmp96 = Scalar(1.0) / (_tmp94);
  const Scalar _tmp97 = _tmp92 * _tmp96;
  const Scalar _tmp98 = _tmp97 * (-_tmp60 * _tmp63 - _tmp77 * _tmp95);
  const Scalar _tmp99 = _tmp77 + _tmp98;
  const Scalar _tmp100 = _tmp88 * _tmp93;
  const Scalar _tmp101 = -_tmp100 * _tmp99 + Scalar(1.0);
  const Scalar _tmp102 = _tmp46 * _tmp62;
  const Scalar _tmp103 = _tmp85 * _tmp93;
  const Scalar _tmp104 = _tmp19 + Scalar(8.3888750099999996);
  const Scalar _tmp105 = _tmp29 + Scalar(-2.5202214700000001);
  ...
  const Scalar _tmp110 = _tmp71 * _tmp75 + _tmp74;
  const Scalar _tmp111 = 0;
  const Scalar _tmp112 = _tmp111 * _tmp93;
  const Scalar _tmp113 = _tmp63 * _tmp88 * _tmp96;
  ...
  const Scalar _tmp117 = _tmp61 * _tmp62;
  const Scalar _tmp118 = _tmp117 * _tmp69 + _tmp61 * _tmp67;
  const Scalar _tmp119 = _tmp117 * _tmp76 - _tmp118 * _tmp75 - _tmp67;
  const Scalar _tmp120 = _tmp97 * (_tmp117 * _tmp60 - _tmp119 * _tmp95 - _tmp59);
  const Scalar _tmp121 = _tmp119 + _tmp120;
  const Scalar _tmp122 = -_tmp100 * _tmp121 - _tmp61;
  const Scalar _tmp123 = _tmp115 * fh1;
  const Scalar _tmp124 = -_tmp108 * _tmp58 * (_tmp101 * _tmp102 + _tmp103 * _tmp99) -
                         _tmp109 * _tmp58 * (-_tmp112 * _tmp46 * _tmp89 + _tmp112 * _tmp85) -
                         _tmp116 * _tmp58 * (-_tmp113 * _tmp46 + _tmp114 * _tmp85) -
                         _tmp123 * _tmp58 * (_tmp102 * _tmp122 + _tmp103 * _tmp121 + Scalar(1.0));
  const Scalar _tmp125 = Scalar(1.0) / (_tmp124);
  const Scalar _tmp126 = _tmp72 + _tmp78;
  const Scalar _tmp127 = _tmp126 * _tmp75;
  const Scalar _tmp128 = Scalar(1.0) / (-_tmp127 + _tmp74 - _tmp81);
  const Scalar _tmp129 = Scalar(1.0) * _tmp128;
  const Scalar _tmp130 = _tmp126 * _tmp129;
  const Scalar _tmp131 = _tmp35 * fh1;
  const Scalar _tmp132 = _tmp115 * _tmp131 + Scalar(5.1796800000000003) * _tmp24 + _tmp28 * fv1;
  const Scalar _tmp133 = _tmp126 * _tmp128;
  const Scalar _tmp134 = _tmp91 * _tmp93;
  const Scalar _tmp135 = _tmp133 * _tmp98 - _tmp134 * _tmp99 - _tmp70;
  const Scalar _tmp136 = Scalar(1.0) * _tmp73;
  const Scalar _tmp137 = Scalar(1.0) * fh1;
  const Scalar _tmp138 = _tmp110 * _tmp128;
  const Scalar _tmp139 = -_tmp111 * _tmp134 - _tmp126 * _tmp138 + _tmp72;
  const Scalar _tmp140 = -_tmp114 * _tmp91 + _tmp130 * _tmp97;
  const Scalar _tmp141 = _tmp129 * _tmp97;
  const Scalar _tmp142 = _tmp118 + _tmp120 * _tmp133 - _tmp121 * _tmp134;
  const Scalar _tmp143 = _tmp129 * _tmp75;
  const Scalar _tmp144 = _tmp127 * _tmp129 + Scalar(1.0);
  const Scalar _tmp145 = -_tmp107 * _tmp131 - Scalar(5.1796800000000003) * _tmp15 - _tmp18 * fv1;
  const Scalar _tmp146 = std::asinh(
      _tmp125 * (_tmp107 * _tmp137 * (_tmp129 * _tmp98 - _tmp135 * _tmp136) +
                 Scalar(1.0) * _tmp109 * (-_tmp110 * _tmp129 - _tmp136 * _tmp139 + Scalar(1.0)) +
                 _tmp115 * _tmp137 * (_tmp120 * _tmp129 - _tmp136 * _tmp142) +
                 Scalar(1.0) * _tmp116 * (-_tmp136 * _tmp140 + _tmp141) +
                 Scalar(1.0) * _tmp132 * (-_tmp129 + _tmp130 * _tmp73) +
                 Scalar(1.0) * _tmp145 * (-_tmp136 * _tmp144 + _tmp143)));
  const Scalar _tmp147 = Scalar(9.6622558468725703) * _tmp124;
  const Scalar _tmp148 = _tmp129 * _tmp132;
  const Scalar _tmp149 = _tmp109 * _tmp112;
  const Scalar _tmp150 = _tmp62 * fh1;
  const Scalar _tmp151 = _tmp101 * _tmp107 * _tmp150 - _tmp113 * _tmp116 +
                         _tmp115 * _tmp122 * _tmp150 - _tmp149 * _tmp89;
  const Scalar _tmp152 = Scalar(1.0) / (_tmp151);
  const Scalar _tmp153 =
      std::asinh(_tmp152 * (_tmp108 * _tmp135 * _tmp73 + _tmp109 * _tmp139 * _tmp73 +
                            _tmp116 * _tmp140 * _tmp73 + _tmp123 * _tmp142 * _tmp73 -
                            _tmp126 * _tmp148 * _tmp73 + _tmp144 * _tmp145 * _tmp73));
  const Scalar _tmp154 = Scalar(9.6622558468725703) * _tmp151;
  const Scalar _tmp155 =
      _tmp108 * _tmp93 * _tmp99 + _tmp114 * _tmp116 + _tmp121 * _tmp123 * _tmp93 + _tmp149;
  const Scalar _tmp156 = Scalar(1.0) / (_tmp155);
  const Scalar _tmp157 =
      std::asinh(_tmp156 * (-_tmp108 * _tmp128 * _tmp98 + _tmp109 * _tmp138 - _tmp116 * _tmp141 -
                            _tmp120 * _tmp123 * _tmp128 - _tmp143 * _tmp145 + _tmp148));
                ...
                Scalar(8.3888750099999996) *
                    std::sqrt(Scalar(
                        Scalar(0.090254729040973036) *
                            std::pow(Scalar(1 - Scalar(0.39679052492160538) * _tmp29), Scalar(2)) +
                        std::pow(Scalar(-Scalar(0.11920549523123722) * _tmp19 - 1),
                                 Scalar(2))))))) +
      _tmp35 + position_vector(2, 0);
  _res(1, 0) =
      -_tmp147 *
          (Scalar(0.86625939559540499) * _tmp125 + std::cosh(Scalar(1.0) * _tmp146) -
           std::cosh(
               Scalar(0.1034955) * _tmp125 *
               (-_tmp146 * _tmp147 -
                Scalar(4.8333311099999996) *
                    std::sqrt(Scalar(
                        std::pow(Scalar(1 - Scalar(0.20689664689659551) * _tmp49), Scalar(2)) +
                        Scalar(0.13817235445745474) *
                            std::pow(Scalar(-Scalar(0.55659957866191134) * _tmp53 - 1),
                                     Scalar(2))))))) +
      _tmp67 + position_vector(2, 0);
  _res(2, 0) =
      -_tmp154 *
          (Scalar(0.87679799772039002) * _tmp152 + std::cosh(Scalar(1.0) * _tmp153) -
           std::cosh(
                ...
                Scalar(4.7752063900000001) *
                    std::sqrt(Scalar(
                        ...
                        Scalar(0.32397683292140877) *
                            std::pow(Scalar(1 - Scalar(0.36791786395571047) * _tmp82),
                                     Scalar(2))))))) +
