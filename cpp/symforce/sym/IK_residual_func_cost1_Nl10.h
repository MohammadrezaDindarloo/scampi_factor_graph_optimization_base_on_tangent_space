...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl10(
  ...
  const Scalar _tmp33 = Scalar(0.20999999999999999) * _tmp14 + Scalar(0.20999999999999999) * _tmp16;
  ...
  const Scalar _tmp39 = _tmp19 + _tmp6;
  ...
  const Scalar _tmp62 = _tmp42 + _tmp53;
  ...
  const Scalar _tmp71 = _tmp50 * _tmp58 - _tmp54 * _tmp70 + _tmp58 * _tmp69;
  const Scalar _tmp72 = _tmp61 * _tmp67;
  const Scalar _tmp73 = Scalar(1.0) / (_tmp58 * _tmp72 - _tmp70);
  const Scalar _tmp74 = _tmp47 * _tmp72 - _tmp48;
  const Scalar _tmp75 = _tmp73 * _tmp74;
  const Scalar _tmp76 = _tmp39 * _tmp47 - _tmp43 * _tmp48 + _tmp47 * _tmp69 - _tmp71 * _tmp75;
  ...
  const Scalar _tmp81 = _tmp31 + Scalar(-125.0);
  ...
  const Scalar _tmp85 = fh1 * (-_tmp20 * _tmp84 + _tmp30 * _tmp83);
  const Scalar _tmp86 = _tmp33 + _tmp37;
  const Scalar _tmp87 = _tmp35 - _tmp36;
  const Scalar _tmp88 = _tmp33 + _tmp87;
  const Scalar _tmp89 = _tmp34 + _tmp87;
  const Scalar _tmp90 = _tmp58 * _tmp88 - _tmp58 * _tmp89;
  const Scalar _tmp91 = _tmp47 * _tmp88;
  const Scalar _tmp92 = _tmp72 * _tmp88;
  const Scalar _tmp93 = -_tmp58 * _tmp92 + _tmp70 * _tmp89;
  const Scalar _tmp94 = _tmp48 * _tmp86 - _tmp72 * _tmp91 - _tmp75 * _tmp93;
  const Scalar _tmp95 = Scalar(1.0) * _tmp59;
  const Scalar _tmp96 = -_tmp95;
  const Scalar _tmp97 = Scalar(1.0) / (_tmp50 + _tmp96);
  const Scalar _tmp98 = Scalar(1.0) * _tmp62;
  const Scalar _tmp99 = -_tmp54 + _tmp98;
  const Scalar _tmp100 = _tmp97 * _tmp99;
  const Scalar _tmp101 = -_tmp100 * _tmp94 - _tmp47 * _tmp86 - _tmp75 * _tmp90 + _tmp91;
  const Scalar _tmp102 = Scalar(1.0) / (_tmp101);
  const Scalar _tmp103 = Scalar(1.0) * _tmp73;
  const Scalar _tmp104 = Scalar(1.0) * _tmp97;
  const Scalar _tmp105 = -_tmp103 * _tmp90 + _tmp104 * _tmp73 * _tmp93 * _tmp99;
  const Scalar _tmp106 = _tmp102 * _tmp76;
  const Scalar _tmp107 = _tmp101 * _tmp77;
  const Scalar _tmp108 = _tmp107 * (-_tmp103 * _tmp71 - _tmp105 * _tmp106);
  const Scalar _tmp109 = _tmp102 * (_tmp105 + _tmp108);
  const Scalar _tmp110 = -_tmp109 * _tmp74 + Scalar(1.0);
  const Scalar _tmp111 = _tmp58 * _tmp73;
  const Scalar _tmp112 = _tmp83 * fh1;
  const Scalar _tmp113 = _tmp72 * _tmp73;
  const Scalar _tmp114 = _tmp113 * _tmp93 + _tmp92;
  const Scalar _tmp115 = -_tmp100 * _tmp114 + _tmp113 * _tmp90 - _tmp88;
  const Scalar _tmp116 = _tmp107 * (-_tmp106 * _tmp115 + _tmp113 * _tmp71 - _tmp69);
  const Scalar _tmp117 = _tmp102 * (_tmp115 + _tmp116);
  const Scalar _tmp118 = -_tmp117 * _tmp74 - _tmp72;
  const Scalar _tmp119 = _tmp84 * fh1;
  const Scalar _tmp120 = Scalar(333.54000000000002) - fv1;
  const Scalar _tmp121 = _tmp100 * _tmp95 + _tmp98;
  const Scalar _tmp122 = 0;
  const Scalar _tmp123 = -_tmp112 * _tmp68 * (_tmp109 * _tmp47 + _tmp110 * _tmp111) -
                         _tmp119 * _tmp68 * (_tmp111 * _tmp118 + _tmp117 * _tmp47 + Scalar(1.0)) -
                         _tmp120 * _tmp68 * (_tmp122 * _tmp47 - _tmp122 * _tmp79) -
                         _tmp68 * _tmp85 * (_tmp47 * _tmp78 - _tmp78 * _tmp79);
  const Scalar _tmp124 = Scalar(1.0) / (_tmp123);
  const Scalar _tmp125 = _tmp39 + _tmp96;
  const Scalar _tmp126 = _tmp100 * _tmp125;
  const Scalar _tmp127 = Scalar(1.0) / (-_tmp126 - _tmp43 + _tmp98);
  const Scalar _tmp128 = Scalar(1.0) * _tmp127;
  const Scalar _tmp129 = _tmp100 * _tmp128;
  const Scalar _tmp130 = _tmp126 * _tmp128 + Scalar(1.0);
  const Scalar _tmp131 = _tmp38 * fh1;
  const Scalar _tmp132 = -_tmp131 * _tmp83 - Scalar(40.024799999999999) * _tmp17 - _tmp20 * fv1;
  const Scalar _tmp133 = _tmp107 * _tmp128;
  const Scalar _tmp134 = _tmp125 * _tmp133 - _tmp78 * _tmp94;
  const Scalar _tmp135 = _tmp125 * _tmp127;
  const Scalar _tmp136 = _tmp114 + _tmp116 * _tmp135 - _tmp117 * _tmp94;
  const Scalar _tmp137 = _tmp125 * _tmp97;
  const Scalar _tmp138 = _tmp131 * _tmp84 + Scalar(40.024799999999999) * _tmp26 + _tmp30 * fv1;
  const Scalar _tmp139 = _tmp121 * _tmp127;
  const Scalar _tmp140 = -_tmp122 * _tmp94 - _tmp125 * _tmp139 + _tmp96;
  const Scalar _tmp141 = -_tmp103 * _tmp93 + _tmp108 * _tmp135 - _tmp109 * _tmp94;
  const Scalar _tmp142 = std::asinh(
      _tmp124 * (Scalar(1.0) * _tmp112 * (-_tmp104 * _tmp141 + _tmp108 * _tmp128) +
                 Scalar(1.0) * _tmp119 * (-_tmp104 * _tmp136 + _tmp116 * _tmp128) +
                 Scalar(1.0) * _tmp120 * (-_tmp104 * _tmp140 - _tmp121 * _tmp128 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp132 * (-_tmp104 * _tmp130 + _tmp129) +
                 Scalar(1.0) * _tmp138 * (_tmp128 * _tmp137 - _tmp128) +
                 Scalar(1.0) * _tmp85 * (-_tmp104 * _tmp134 + _tmp133)));
  const Scalar _tmp143 = Scalar(1.4083112389913199) * _tmp123;
  const Scalar _tmp144 = _tmp78 * _tmp85;
  const Scalar _tmp145 = _tmp120 * _tmp122;
  const Scalar _tmp146 =
      _tmp110 * _tmp112 * _tmp73 + _tmp118 * _tmp119 * _tmp73 - _tmp144 * _tmp75 - _tmp145 * _tmp75;
  const Scalar _tmp147 = Scalar(1.0) / (_tmp146);
  const Scalar _tmp148 = _tmp128 * _tmp138;
  const Scalar _tmp149 =
      std::asinh(_tmp147 * (_tmp112 * _tmp141 * _tmp97 + _tmp119 * _tmp136 * _tmp97 +
                            _tmp120 * _tmp140 * _tmp97 + _tmp130 * _tmp132 * _tmp97 +
                            _tmp134 * _tmp85 * _tmp97 - _tmp137 * _tmp148));
  const Scalar _tmp150 = Scalar(1.4083112389913199) * _tmp146;
  const Scalar _tmp151 = _tmp109 * _tmp112 + _tmp117 * _tmp119 + _tmp144 + _tmp145;
  const Scalar _tmp152 = Scalar(1.0) / (_tmp151);
  const Scalar _tmp153 =
      std::asinh(_tmp152 * (-_tmp108 * _tmp112 * _tmp127 - _tmp116 * _tmp119 * _tmp127 +
                            _tmp120 * _tmp139 - _tmp129 * _tmp132 - _tmp133 * _tmp85 + _tmp148));
  ...
  _res(1, 0) =
      -_tmp143 *
          (Scalar(34.083374946563197) * _tmp124 + std::cosh(Scalar(1.0) * _tmp142) -
           std::cosh(
               Scalar(0.71007031138673404) * _tmp124 *
               (-_tmp142 * _tmp143 -
  ...
  _res(2, 0) =
      -_tmp150 *
          (Scalar(34.083374946563197) * _tmp147 + std::cosh(Scalar(1.0) * _tmp149) -
           std::cosh(Scalar(0.71007031138673404) * _tmp147 *
                     (-_tmp149 * _tmp150 -
                      Scalar(125.0) *
                          std::sqrt(Scalar(
                              Scalar(0.77439999999999998) *
                ...
                Scalar(125.0) * std::sqrt(Scalar(
                                    Scalar(0.77439999999999998) *
                                        std::pow(Scalar(1 - Scalar(0.0090909090909090905) * _tmp40),
                                                 Scalar(2)) +
                                    std::pow(Scalar(1 - Scalar(0.0080000000000000002) * _tmp44),
                                             Scalar(2))))))) +
