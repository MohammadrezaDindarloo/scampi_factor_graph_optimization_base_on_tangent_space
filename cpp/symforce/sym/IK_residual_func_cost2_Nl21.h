...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2Nl21(
  ...
  const Scalar _tmp52 = _tmp20 + _tmp41;
  ...
  const Scalar _tmp58 = _tmp43 + Scalar(8.3888750099999996);
  const Scalar _tmp59 = _tmp47 + Scalar(-2.5202214700000001);
  const Scalar _tmp60 =
  ...
  const Scalar _tmp64 = _tmp63 * (-_tmp42 * _tmp59 * _tmp61 + _tmp46 * _tmp58 * _tmp61);
  const Scalar _tmp65 = _tmp19 + _tmp27;
  const Scalar _tmp66 = _tmp65 + position_vector(1, 0);
  const Scalar _tmp67 = _tmp66 + Scalar(-4.7752063900000001);
  const Scalar _tmp68 = _tmp45 + _tmp8;
  ...
  const Scalar _tmp76 = _tmp56 * _tmp75 - _tmp57;
  const Scalar _tmp77 = Scalar(1.0) / (_tmp72 * _tmp75 - _tmp73);
  const Scalar _tmp78 = _tmp76 * _tmp77;
  const Scalar _tmp79 = -_tmp49 * _tmp57 + _tmp52 * _tmp56 + _tmp56 * _tmp64 - _tmp74 * _tmp78;
  const Scalar _tmp80 = Scalar(1.0) / (_tmp79);
  const Scalar _tmp81 = Scalar(1.0) * _tmp80;
  const Scalar _tmp82 = _tmp18 + Scalar(1.79662371);
  const Scalar _tmp83 = _tmp29 + Scalar(-4.8333311099999996);
  ...
  const Scalar _tmp87 = fh1 * (_tmp17 * _tmp85 - _tmp28 * _tmp86);
  const Scalar _tmp88 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp89 = _tmp72 * _tmp77;
  const Scalar _tmp90 = Scalar(1.0) * _tmp46;
  const Scalar _tmp91 = Scalar(1.0) * _tmp42;
  const Scalar _tmp92 = -_tmp91;
  const Scalar _tmp93 = Scalar(1.0) / (_tmp65 + _tmp92);
  const Scalar _tmp94 = _tmp93 * (-_tmp68 + _tmp90);
  const Scalar _tmp95 = _tmp90 + _tmp91 * _tmp94;
  const Scalar _tmp96 = 0;
  const Scalar _tmp97 = _tmp36 + _tmp38;
  const Scalar _tmp98 = _tmp33 + _tmp39;
  const Scalar _tmp99 = _tmp40 * _tmp75;
  const Scalar _tmp100 = -_tmp72 * _tmp99 + _tmp73 * _tmp98;
  const Scalar _tmp101 = -_tmp100 * _tmp78 - _tmp56 * _tmp99 + _tmp57 * _tmp97;
  const Scalar _tmp102 = _tmp40 * _tmp72 - _tmp72 * _tmp98;
  const Scalar _tmp103 = -_tmp101 * _tmp94 - _tmp102 * _tmp78 + _tmp40 * _tmp56 - _tmp56 * _tmp97;
  const Scalar _tmp104 = Scalar(1.0) / (_tmp103);
  const Scalar _tmp105 = _tmp104 * _tmp76;
  const Scalar _tmp106 = _tmp105 * _tmp96;
  const Scalar _tmp107 = _tmp104 * _tmp96;
  const Scalar _tmp108 = Scalar(1.0) * _tmp77;
  const Scalar _tmp109 = _tmp100 * _tmp108;
  const Scalar _tmp110 = -_tmp102 * _tmp108 + _tmp109 * _tmp94;
  const Scalar _tmp111 = _tmp104 * _tmp79;
  const Scalar _tmp112 = _tmp103 * _tmp80;
  const Scalar _tmp113 = _tmp112 * (-_tmp108 * _tmp74 - _tmp110 * _tmp111);
  const Scalar _tmp114 = _tmp110 + _tmp113;
  const Scalar _tmp115 = -_tmp105 * _tmp114 + Scalar(1.0);
  const Scalar _tmp116 = _tmp104 * _tmp56;
  const Scalar _tmp117 = _tmp85 * fh1;
  const Scalar _tmp118 = _tmp75 * _tmp77;
  const Scalar _tmp119 = _tmp100 * _tmp118 + _tmp99;
  const Scalar _tmp120 = _tmp102 * _tmp118 - _tmp119 * _tmp94 - _tmp40;
  const Scalar _tmp121 = _tmp112 * (-_tmp111 * _tmp120 + _tmp118 * _tmp74 - _tmp64);
  const Scalar _tmp122 = _tmp120 + _tmp121;
  const Scalar _tmp123 = -_tmp105 * _tmp122 - _tmp75;
  const Scalar _tmp124 = _tmp86 * fh1;
  const Scalar _tmp125 = -_tmp117 * _tmp63 * (_tmp114 * _tmp116 + _tmp115 * _tmp89) -
                         _tmp124 * _tmp63 * (_tmp116 * _tmp122 + _tmp123 * _tmp89 + Scalar(1.0)) -
                         _tmp63 * _tmp87 * (_tmp56 * _tmp81 - _tmp72 * _tmp78 * _tmp81) -
                         _tmp63 * _tmp88 * (-_tmp106 * _tmp89 + _tmp107 * _tmp56);
  const Scalar _tmp126 = Scalar(1.0) / (_tmp125);
  const Scalar _tmp127 = _tmp52 + _tmp92;
  const Scalar _tmp128 = _tmp127 * _tmp94;
  const Scalar _tmp129 = Scalar(1.0) / (-_tmp128 - _tmp49 + _tmp90);
  const Scalar _tmp130 = Scalar(1.0) * _tmp129;
  const Scalar _tmp131 = _tmp101 * _tmp104;
  const Scalar _tmp132 = _tmp127 * _tmp129;
  const Scalar _tmp133 = _tmp119 + _tmp121 * _tmp132 - _tmp122 * _tmp131;
  const Scalar _tmp134 = Scalar(1.0) * _tmp93;
  const Scalar _tmp135 = Scalar(1.0) * fh1;
  const Scalar _tmp136 = -_tmp109 + _tmp113 * _tmp132 - _tmp114 * _tmp131;
  const Scalar _tmp137 = _tmp112 * _tmp130;
  const Scalar _tmp138 = -_tmp101 * _tmp81 + _tmp127 * _tmp137;
  const Scalar _tmp139 = _tmp127 * _tmp93;
  const Scalar _tmp140 = _tmp37 * fh1;
  const Scalar _tmp141 = Scalar(5.1796800000000003) * _tmp11 + _tmp140 * _tmp86 + _tmp17 * fv1;
  const Scalar _tmp142 = _tmp130 * _tmp94;
  const Scalar _tmp143 = _tmp93 * (_tmp128 * _tmp130 + Scalar(1.0));
  const Scalar _tmp144 = -_tmp140 * _tmp85 - Scalar(5.1796800000000003) * _tmp25 - _tmp28 * fv1;
  const Scalar _tmp145 = _tmp129 * _tmp95;
  const Scalar _tmp146 = -_tmp127 * _tmp145 - _tmp131 * _tmp96 + _tmp92;
  const Scalar _tmp147 = std::asinh(
      _tmp126 * (_tmp135 * _tmp85 * (_tmp113 * _tmp130 - _tmp134 * _tmp136) +
                 _tmp135 * _tmp86 * (_tmp121 * _tmp130 - _tmp133 * _tmp134) +
                 Scalar(1.0) * _tmp141 * (_tmp130 * _tmp139 - _tmp130) +
                 Scalar(1.0) * _tmp144 * (_tmp142 - Scalar(1.0) * _tmp143) +
                 Scalar(1.0) * _tmp87 * (-_tmp134 * _tmp138 + _tmp137) +
                 Scalar(1.0) * _tmp88 * (-_tmp130 * _tmp95 - _tmp134 * _tmp146 + Scalar(1.0))));
  const Scalar _tmp148 = Scalar(9.6622558468725703) * _tmp125;
  const Scalar _tmp149 = _tmp130 * _tmp141;
  const Scalar _tmp150 = _tmp81 * _tmp87;
  const Scalar _tmp151 = -_tmp106 * _tmp77 * _tmp88 + _tmp115 * _tmp117 * _tmp77 +
                         _tmp123 * _tmp124 * _tmp77 - _tmp150 * _tmp78;
  const Scalar _tmp152 = Scalar(1.0) / (_tmp151);
  const Scalar _tmp153 =
      std::asinh(_tmp152 * (_tmp117 * _tmp136 * _tmp93 + _tmp124 * _tmp133 * _tmp93 +
                            _tmp138 * _tmp87 * _tmp93 - _tmp139 * _tmp149 + _tmp143 * _tmp144 +
                            _tmp146 * _tmp88 * _tmp93));
  const Scalar _tmp154 = Scalar(9.6622558468725703) * _tmp151;
  const Scalar _tmp155 = Scalar(22.802596067096832) *
  ...
  const Scalar _tmp156 =
      _tmp104 * _tmp114 * _tmp117 + _tmp104 * _tmp122 * _tmp124 + _tmp107 * _tmp88 + _tmp150;
  ...
  const Scalar _tmp159 =
      std::asinh(_tmp157 * (-_tmp113 * _tmp117 * _tmp129 - _tmp121 * _tmp124 * _tmp129 -
                            _tmp137 * _tmp87 - _tmp142 * _tmp144 + _tmp145 * _tmp88 + _tmp149));
  ...
  _res(1, 0) =
      _tmp148 *
          (-std::sinh(Scalar(1.0) * _tmp147) -
           std::sinh(Scalar(0.1034955) * _tmp126 * (-_tmp147 * _tmp148 - std::sqrt(_tmp48)))) -
      Scalar(8.4693136199999994) *
          std::sqrt(Scalar(Scalar(0.013941309530580858) * _tmp48 +
                           std::pow(Scalar(-Scalar(0.11807332268798426) * _tmp40 -
  ...
  _res(3, 0) =
      ...
      Scalar(8.4718465799999993) *
          std::sqrt(Scalar(Scalar(0.013932974275675287) * _tmp158 +
                           std::pow(Scalar(-Scalar(0.11803802046660766) * _tmp97 -
