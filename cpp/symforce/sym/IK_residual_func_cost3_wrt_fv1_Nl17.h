...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl17(
  ...
  const Scalar _tmp27 = Scalar(0.20999999999999999) * _tmp21 + Scalar(0.20999999999999999) * _tmp8;
  const Scalar _tmp28 =
  ...
  const Scalar _tmp94 = _tmp70 * (_tmp63 * _tmp92 - _tmp80 * _tmp93);
  const Scalar _tmp95 = Scalar(1.0) * _tmp49;
  const Scalar _tmp96 = _tmp48 * _tmp53 * _tmp95 - _tmp54 * _tmp95;
  const Scalar _tmp97 = _tmp76 * (-_tmp72 * _tmp95 - _tmp74 * _tmp96) + _tmp96;
  const Scalar _tmp98 = -_tmp78 * _tmp97 + Scalar(1.0);
  const Scalar _tmp99 = _tmp85 * _tmp86;
  const Scalar _tmp100 = _tmp99 * fh1;
  const Scalar _tmp101 = Scalar(1.0) * _tmp75;
  const Scalar _tmp102 = fh1 * (_tmp82 * _tmp99 - _tmp84 * _tmp87);
  ...
  _res(0, 0) = 0;
  _res(1, 0) =
      -_tmp94 * std::exp(_tmp100 * _tmp70 * (_tmp80 * _tmp98 + _tmp81 * _tmp97) +
                         _tmp102 * _tmp70 * (-_tmp101 * _tmp43 * _tmp65 + _tmp101 * _tmp63) +
                         _tmp70 * _tmp88 * (_tmp77 * _tmp81 + _tmp79 * _tmp80 + Scalar(1.0)) +
                         _tmp89 * _tmp94);
  _res(2, 0) = -_tmp103 * std::exp(-_tmp100 * _tmp49 * _tmp98 + _tmp103 * _tmp89 +
                                   _tmp104 * _tmp65 - _tmp49 * _tmp79 * _tmp88);
  _res(3, 0) = _tmp92 * std::exp(-_tmp100 * _tmp67 * _tmp97 - _tmp104 - _tmp67 * _tmp77 * _tmp88 -
                                 _tmp89 * _tmp92);
