...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl21(
  ...
  const Scalar _tmp68 = -Scalar(0.20999999999999999) * _tmp11 + Scalar(0.20999999999999999) * _tmp8;
  const Scalar _tmp69 =
  ...
  const Scalar _tmp76 = -_tmp48 * _tmp75 + _tmp49 * _tmp73;
  const Scalar _tmp77 = Scalar(1.0) * _tmp34;
  const Scalar _tmp78 = Scalar(1.0) * _tmp32;
  const Scalar _tmp79 = (-_tmp45 + _tmp78) / (_tmp42 - _tmp77);
  const Scalar _tmp80 = -_tmp48 * _tmp73 + _tmp48 * _tmp74;
  const Scalar _tmp81 = -_tmp30 * _tmp72 + _tmp30 * _tmp74 - _tmp54 * _tmp80 -
                        _tmp79 * (-_tmp30 * _tmp75 + _tmp31 * _tmp72 - _tmp54 * _tmp76);
  ...
  const Scalar _tmp86 = _tmp76 * _tmp79 * _tmp85 - _tmp80 * _tmp85;
  const Scalar _tmp87 = _tmp55 * _tmp82;
  const Scalar _tmp88 = _tmp56 * _tmp81;
  const Scalar _tmp89 = _tmp86 + _tmp88 * (-_tmp50 * _tmp85 - _tmp86 * _tmp87);
  const Scalar _tmp90 = _tmp52 * _tmp82;
  const Scalar _tmp91 = -_tmp89 * _tmp90 + Scalar(1.0);
  const Scalar _tmp92 = _tmp48 * _tmp53;
  const Scalar _tmp93 = _tmp30 * _tmp82;
  const Scalar _tmp94 = _tmp64 * fh1;
  const Scalar _tmp95 = _tmp51 * _tmp53;
  const Scalar _tmp96 = -_tmp74 - _tmp79 * (_tmp75 + _tmp76 * _tmp95) + _tmp80 * _tmp95;
  const Scalar _tmp97 = _tmp88 * (-_tmp41 + _tmp50 * _tmp95 - _tmp87 * _tmp96) + _tmp96;
  const Scalar _tmp98 = -_tmp51 - _tmp90 * _tmp97;
  const Scalar _tmp99 = _tmp65 * fh1;
  const Scalar _tmp100 = _tmp67 * _tmp84;
  const Scalar _tmp101 = _tmp57 * _tmp66;

  // Output terms (1)
  Eigen::Matrix<Scalar, 4, 1> _res;

  _res(0, 0) = std::exp(-fh1);
  _res(1, 0) = std::exp(_tmp40 * _tmp66 * (_tmp30 * _tmp57 - _tmp57 * _tmp58) +
                        _tmp40 * _tmp67 * (_tmp30 * _tmp84 - _tmp58 * _tmp84) +
                        _tmp40 * _tmp94 * (_tmp89 * _tmp93 + _tmp91 * _tmp92) +
                        _tmp40 * _tmp99 * (_tmp92 * _tmp98 + _tmp93 * _tmp97 + Scalar(1.0)));
  _res(2, 0) = std::exp(_tmp100 * _tmp54 + _tmp101 * _tmp54 - _tmp53 * _tmp91 * _tmp94 -
                        _tmp53 * _tmp98 * _tmp99);
  _res(3, 0) = std::exp(-_tmp100 - _tmp101 - _tmp82 * _tmp89 * _tmp94 - _tmp82 * _tmp97 * _tmp99);
