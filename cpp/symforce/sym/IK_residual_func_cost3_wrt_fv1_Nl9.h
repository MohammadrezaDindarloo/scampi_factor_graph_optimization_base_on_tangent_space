...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl9(
  ...
  const Scalar _tmp56 = _tmp32 * _tmp33;
  const Scalar _tmp57 = Scalar(1.0) / (_tmp34 * _tmp53 - _tmp56);
  const Scalar _tmp58 = _tmp55 * _tmp57;
  const Scalar _tmp59 = _tmp16 - _tmp8;
  const Scalar _tmp60 = _tmp35 * _tmp53;
  const Scalar _tmp61 = _tmp17 * _tmp56 - _tmp36 * _tmp53;
  ...
  const Scalar _tmp65 = _tmp35 * _tmp54 - _tmp37 * _tmp58 - _tmp54 * _tmp59 -
                        _tmp64 * (_tmp45 * _tmp59 - _tmp54 * _tmp60 - _tmp58 * _tmp61);
  ...
  const Scalar _tmp72 = _tmp71 * (-_tmp34 * _tmp69 + _tmp54 * _tmp68);
  const Scalar _tmp73 = Scalar(1.0) / (_tmp70);
  const Scalar _tmp74 = _tmp71 * (-_tmp47 * _tmp51 * _tmp73 + _tmp48 * _tmp50 * _tmp73);
  const Scalar _tmp75 = _tmp57 * (-_tmp25 * _tmp56 + _tmp31 * _tmp34 + _tmp34 * _tmp74);
  const Scalar _tmp76 = _tmp39 * _tmp54 - _tmp42 * _tmp45 + _tmp54 * _tmp74 - _tmp55 * _tmp75;
  const Scalar _tmp77 = Scalar(1.0) / (_tmp76);
  const Scalar _tmp78 = Scalar(1.0) * _tmp77;
  const Scalar _tmp79 = _tmp41 + _tmp49;
  const Scalar _tmp80 = _tmp38 + _tmp46;
  const Scalar _tmp81 = _tmp80 + position_vector(1, 0) + Scalar(8.3888750099999996);
  const Scalar _tmp82 = _tmp79 + position_vector(0, 0) + Scalar(-2.5202214700000001);
  ...
  const Scalar _tmp86 = fh1 * (_tmp79 * _tmp84 - _tmp80 * _tmp85);
  const Scalar _tmp87 = _tmp57 * _tmp61;
  const Scalar _tmp88 = _tmp37 * _tmp57;
  const Scalar _tmp89 = Scalar(1.0) * _tmp64 * _tmp87 - Scalar(1.0) * _tmp88;
  const Scalar _tmp90 = _tmp66 * _tmp76;
  const Scalar _tmp91 = _tmp65 * _tmp77;
  const Scalar _tmp92 = _tmp89 + _tmp91 * (-Scalar(1.0) * _tmp75 - _tmp89 * _tmp90);
  const Scalar _tmp93 = _tmp54 * _tmp66;
  const Scalar _tmp94 = _tmp55 * _tmp66;
  const Scalar _tmp95 = -_tmp92 * _tmp94 + Scalar(1.0);
  const Scalar _tmp96 = _tmp34 * _tmp57;
  const Scalar _tmp97 = _tmp71 * fh1;
  const Scalar _tmp98 = -_tmp35 + _tmp53 * _tmp88 - _tmp64 * (_tmp53 * _tmp87 + _tmp60);
  const Scalar _tmp99 = _tmp91 * (_tmp53 * _tmp75 - _tmp74 - _tmp90 * _tmp98) + _tmp98;
  const Scalar _tmp100 = -_tmp53 - _tmp94 * _tmp99;
  const Scalar _tmp101 = _tmp0 * _tmp68;
  const Scalar _tmp102 = _tmp57 * fh1;
  const Scalar _tmp103 = _tmp78 * _tmp86;
  ...
  _res(1, 0) =
      -_tmp72 *
      std::exp(_tmp0 * _tmp72 + _tmp71 * _tmp86 * (-_tmp34 * _tmp58 * _tmp78 + _tmp54 * _tmp78) +
               _tmp84 * _tmp97 * (_tmp92 * _tmp93 + _tmp95 * _tmp96) +
               _tmp85 * _tmp97 * (_tmp100 * _tmp96 + _tmp93 * _tmp99 + Scalar(1.0)));
  _res(2, 0) = -_tmp69 * std::exp(-_tmp100 * _tmp102 * _tmp85 + _tmp101 * _tmp58 -
                                  _tmp102 * _tmp84 * _tmp95 + _tmp103 * _tmp58);
  _res(3, 0) =
      _tmp68 * std::exp(-_tmp101 - _tmp103 - _tmp104 * _tmp84 * _tmp92 - _tmp104 * _tmp85 * _tmp99);
