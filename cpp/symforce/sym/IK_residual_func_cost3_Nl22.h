...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl22(
  ...
  const Scalar _tmp21 = _tmp10 * _tmp2;
  const Scalar _tmp22 = 2 * _tmp6 * _tmp9;
  const Scalar _tmp23 =
  ...
  const Scalar _tmp72 = -_tmp58 * (-_tmp44 * _tmp67 - _tmp55 * _tmp71 + _tmp68 * _tmp69) -
                        _tmp59 * _tmp71 - _tmp66 * _tmp68 + _tmp67;
  ...
  const Scalar _tmp91 = -_tmp53 - _tmp58 * (_tmp44 * _tmp53 + _tmp55 * _tmp90) + _tmp59 * _tmp90;
  ...
  const Scalar _tmp97 = _tmp31 * _tmp71;
  const Scalar _tmp98 = fh1 * (-_tmp83 * _tmp94 + _tmp85 * _tmp88);
  ...
  _res(1, 0) = std::exp(_tmp41 * _tmp89 * (_tmp78 * _tmp82 + _tmp80 * _tmp81) +
                        _tmp41 * _tmp95 * (_tmp81 * _tmp93 + _tmp82 * _tmp92 + Scalar(1.0)) +
                        _tmp41 * _tmp98 * (_tmp66 * _tmp96 - _tmp96 * _tmp97) +
                        _tmp41 * _tmp99 * (_tmp101 * _tmp66 - _tmp101 * _tmp97));
  _res(2, 0) = std::exp(_tmp102 * _tmp71 + _tmp103 * _tmp71 - _tmp45 * _tmp80 * _tmp89 -
                        _tmp45 * _tmp93 * _tmp95);
  _res(3, 0) = std::exp(-_tmp102 - _tmp103 - _tmp73 * _tmp78 * _tmp89 - _tmp73 * _tmp92 * _tmp95);
