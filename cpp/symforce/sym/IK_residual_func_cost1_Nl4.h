...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl4(
  ...
  const Scalar _tmp91 = -_tmp58 * _tmp90 + _tmp88;
  const Scalar _tmp92 = Scalar(1.0) * _tmp62;
  const Scalar _tmp93 = -_tmp54 + _tmp92;
  const Scalar _tmp94 = _tmp70 * _tmp90 - _tmp72 * _tmp88;
  ...
  const Scalar _tmp99 = _tmp73 * _tmp93 * _tmp94 * _tmp98 - _tmp79 * _tmp91;
  const Scalar _tmp100 = _tmp34 + _tmp89;
  const Scalar _tmp101 = _tmp49 * _tmp87;
  const Scalar _tmp102 = _tmp100 * _tmp50 - _tmp101 * _tmp72 - _tmp75 * _tmp94;
  const Scalar _tmp103 = _tmp93 * _tmp97;
  const Scalar _tmp104 = -_tmp100 * _tmp49 + _tmp101 - _tmp102 * _tmp103 - _tmp75 * _tmp91;
  const Scalar _tmp105 = Scalar(1.0) / (_tmp104);
  const Scalar _tmp106 = _tmp105 * _tmp76;
  const Scalar _tmp107 = _tmp104 * _tmp77;
  const Scalar _tmp108 = _tmp107 * (-_tmp106 * _tmp99 - _tmp71 * _tmp79);
  const Scalar _tmp109 = _tmp108 + _tmp99;
  const Scalar _tmp110 = _tmp105 * _tmp74;
  const Scalar _tmp111 = -_tmp109 * _tmp110 + Scalar(1.0);
  const Scalar _tmp112 = _tmp58 * _tmp73;
  const Scalar _tmp113 = _tmp105 * _tmp49;
  const Scalar _tmp114 = _tmp84 * fh1;
  const Scalar _tmp115 = _tmp72 * _tmp73;
  const Scalar _tmp116 = _tmp115 * _tmp94 + _tmp72 * _tmp87;
  const Scalar _tmp117 = -_tmp103 * _tmp116 + _tmp115 * _tmp91 - _tmp87;
  const Scalar _tmp118 = _tmp107 * (-_tmp106 * _tmp117 + _tmp115 * _tmp71 - _tmp69);
  const Scalar _tmp119 = _tmp117 + _tmp118;
  const Scalar _tmp120 = -_tmp110 * _tmp119 - _tmp72;
  const Scalar _tmp121 = _tmp85 * fh1;
  ...
  const Scalar _tmp126 = -_tmp114 * _tmp68 * (_tmp109 * _tmp113 + _tmp111 * _tmp112) -
                         _tmp121 * _tmp68 * (_tmp112 * _tmp120 + _tmp113 * _tmp119 + Scalar(1.0)) -
                         _tmp122 * _tmp68 * (_tmp125 * _tmp49 - _tmp125 * _tmp58 * _tmp75) -
                         _tmp68 * _tmp86 * (_tmp49 * _tmp78 - _tmp58 * _tmp80);
  const Scalar _tmp127 = Scalar(1.0) / (_tmp126);
  const Scalar _tmp128 = _tmp41 + _tmp96;
  const Scalar _tmp129 = _tmp103 * _tmp128;
  const Scalar _tmp130 = Scalar(1.0) / (-_tmp129 - _tmp45 + _tmp92);
  const Scalar _tmp131 = Scalar(1.0) * _tmp130;
  const Scalar _tmp132 = _tmp102 * _tmp105;
  ...
  const Scalar _tmp136 = -_tmp135 * _tmp84 - Scalar(40.024799999999999) * _tmp16 - _tmp19 * fv1;
  const Scalar _tmp137 = _tmp129 * _tmp131 + Scalar(1.0);
  const Scalar _tmp138 = _tmp103 * _tmp131;
  const Scalar _tmp139 = _tmp108 * _tmp133 - _tmp109 * _tmp132 - _tmp79 * _tmp94;
  const Scalar _tmp140 = _tmp135 * _tmp85 + Scalar(40.024799999999999) * _tmp27 + _tmp30 * fv1;
  const Scalar _tmp141 = _tmp128 * _tmp97;
  const Scalar _tmp142 = _tmp123 * _tmp130;
  const Scalar _tmp143 = -_tmp124 * _tmp132 - _tmp128 * _tmp142 + _tmp96;
  const Scalar _tmp144 = _tmp107 * _tmp131;
  const Scalar _tmp145 = -_tmp102 * _tmp78 + _tmp128 * _tmp144;
  const Scalar _tmp146 = std::asinh(
      _tmp127 * (Scalar(1.0) * _tmp114 * (_tmp108 * _tmp131 - _tmp139 * _tmp98) +
                 Scalar(1.0) * _tmp121 * (_tmp118 * _tmp131 - _tmp134 * _tmp98) +
                 Scalar(1.0) * _tmp122 * (-_tmp123 * _tmp131 - _tmp143 * _tmp98 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp136 * (-_tmp137 * _tmp98 + _tmp138) +
                 Scalar(1.0) * _tmp140 * (_tmp131 * _tmp141 - _tmp131) +
                 Scalar(1.0) * _tmp86 * (_tmp144 - _tmp145 * _tmp98)));
  ...
  const Scalar _tmp150 =
      _tmp111 * _tmp114 * _tmp73 + _tmp120 * _tmp121 * _tmp73 - _tmp149 * _tmp75 - _tmp80 * _tmp86;
  const Scalar _tmp151 = Scalar(1.0) / (_tmp150);
  const Scalar _tmp152 =
      std::asinh(_tmp151 * (_tmp114 * _tmp139 * _tmp97 + _tmp121 * _tmp134 * _tmp97 +
                            _tmp122 * _tmp143 * _tmp97 + _tmp136 * _tmp137 * _tmp97 -
                            _tmp141 * _tmp148 + _tmp145 * _tmp86 * _tmp97));
  const Scalar _tmp153 = Scalar(1.4083112389913199) * _tmp150;
  const Scalar _tmp154 =
      _tmp105 * _tmp109 * _tmp114 + _tmp105 * _tmp119 * _tmp121 + _tmp149 + _tmp78 * _tmp86;
  const Scalar _tmp155 = Scalar(1.0) / (_tmp154);
  const Scalar _tmp156 =
      std::asinh(_tmp155 * (-_tmp108 * _tmp114 * _tmp130 - _tmp118 * _tmp121 * _tmp130 +
                            _tmp122 * _tmp142 - _tmp136 * _tmp138 - _tmp144 * _tmp86 + _tmp148));
  ...
  _res(1, 0) =
      -_tmp147 *
          (Scalar(34.083374946563197) * _tmp127 + std::cosh(Scalar(1.0) * _tmp146) -
           std::cosh(
  ...
  _res(3, 0) =
      _tmp100 -
      _tmp157 * (Scalar(34.083374946563197) * _tmp155 + std::cosh(Scalar(1.0) * _tmp156) -
