...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl21(
  ...
  const Scalar _tmp17 = Scalar(0.20999999999999999) * _tmp3 + Scalar(0.20999999999999999) * _tmp7;
  ...
  const Scalar _tmp27 = _tmp16 + position_vector(0, 0) + Scalar(1.79662371);
  ...
  const Scalar _tmp44 = _tmp43 + position_vector(1, 0) + Scalar(8.3888750099999996);
  const Scalar _tmp45 = _tmp42 + position_vector(0, 0) + Scalar(-2.5202214700000001);
  const Scalar _tmp46 =
  ...
  const Scalar _tmp50 = _tmp49 * (_tmp42 * _tmp44 * _tmp47 - _tmp43 * _tmp45 * _tmp47);
  const Scalar _tmp51 = _tmp17 + _tmp24;
  const Scalar _tmp52 = _tmp51 + position_vector(1, 0) + Scalar(-4.7752063900000001);
  ...
  const Scalar _tmp58 = _tmp50 * _tmp56 + _tmp51 * _tmp56 - _tmp53 * _tmp57;
  const Scalar _tmp59 = _tmp44 * _tmp48;
  const Scalar _tmp60 = _tmp39 * _tmp59 - _tmp40;
  const Scalar _tmp61 = Scalar(1.0) / (_tmp56 * _tmp59 - _tmp57);
  const Scalar _tmp62 = _tmp60 * _tmp61;
  const Scalar _tmp63 = -_tmp33 * _tmp40 + _tmp36 * _tmp39 + _tmp39 * _tmp50 - _tmp58 * _tmp62;
  const Scalar _tmp64 = Scalar(1.0) / (_tmp63);
  const Scalar _tmp65 = Scalar(1.0) * _tmp64;
  const Scalar _tmp66 = _tmp56 * _tmp62;
  const Scalar _tmp67 = _tmp31 * _tmp49 * (_tmp39 * _tmp65 - _tmp65 * _tmp66);
  ...
  const Scalar _tmp71 = Scalar(0.20999999999999999) * _tmp19 + Scalar(0.20999999999999999) * _tmp20;
  ...
  const Scalar _tmp78 = -_tmp56 * _tmp77 + _tmp57 * _tmp75;
  const Scalar _tmp79 = Scalar(1.0) * _tmp43;
  const Scalar _tmp80 = Scalar(1.0) * _tmp42;
  const Scalar _tmp81 = (-_tmp53 + _tmp80) / (_tmp51 - _tmp79);
  const Scalar _tmp82 = -_tmp56 * _tmp75 + _tmp56 * _tmp76;
  const Scalar _tmp83 = -_tmp39 * _tmp73 + _tmp39 * _tmp76 - _tmp62 * _tmp82 -
                        _tmp81 * (-_tmp39 * _tmp77 + _tmp40 * _tmp73 - _tmp62 * _tmp78);
  const Scalar _tmp84 = Scalar(1.0) / (_tmp83);
  const Scalar _tmp85 = _tmp79 * _tmp81 + _tmp80;
  const Scalar _tmp86 = 0;
  const Scalar _tmp87 = Scalar(1.0) * _tmp61;
  const Scalar _tmp88 = _tmp78 * _tmp81 * _tmp87 - _tmp82 * _tmp87;
  const Scalar _tmp89 = _tmp63 * _tmp84;
  const Scalar _tmp90 = _tmp64 * _tmp83;
  const Scalar _tmp91 = _tmp88 + _tmp90 * (-_tmp58 * _tmp87 - _tmp88 * _tmp89);
  const Scalar _tmp92 = _tmp60 * _tmp84;
  const Scalar _tmp93 = _tmp61 * (-_tmp91 * _tmp92 + Scalar(1.0));
  const Scalar _tmp94 = _tmp84 * _tmp91;
  const Scalar _tmp95 = _tmp29 * _tmp49 * (_tmp39 * _tmp94 + _tmp56 * _tmp93);
  const Scalar _tmp96 = _tmp59 * _tmp61;
  const Scalar _tmp97 = -_tmp76 - _tmp81 * (_tmp77 + _tmp78 * _tmp96) + _tmp82 * _tmp96;
  const Scalar _tmp98 = _tmp90 * (-_tmp50 + _tmp58 * _tmp96 - _tmp89 * _tmp97) + _tmp97;
  const Scalar _tmp99 = _tmp84 * _tmp98;
  const Scalar _tmp100 = _tmp61 * (-_tmp59 - _tmp92 * _tmp98);
  const Scalar _tmp101 = _tmp30 * _tmp49 * (_tmp100 * _tmp56 + _tmp39 * _tmp99 + Scalar(1.0));
  const Scalar _tmp102 = _tmp29 * _tmp93;
  const Scalar _tmp103 = _tmp68 * _tmp86;
  const Scalar _tmp104 = _tmp31 * _tmp65;
  const Scalar _tmp105 = _tmp104 * fh1;
  const Scalar _tmp106 = _tmp100 * _tmp30;
  const Scalar _tmp107 = _tmp29 * _tmp94;
  const Scalar _tmp108 = _tmp30 * _tmp99;

  // Output terms (1)
  Eigen::Matrix<Scalar, 4, 1> _res;

  _res(0, 0) = -std::exp(-fh1);
  _res(1, 0) = -(-_tmp101 - _tmp67 - _tmp95) *
               std::exp(_tmp101 * fh1 + _tmp49 * _tmp68 * (_tmp39 * _tmp86 - _tmp66 * _tmp86) +
                        _tmp67 * fh1 + _tmp95 * fh1);
  _res(2, 0) = -(_tmp102 - _tmp104 * _tmp62 + _tmp106) *
               std::exp(-_tmp102 * fh1 + _tmp103 * _tmp62 + _tmp105 * _tmp62 - _tmp106 * fh1);
  _res(3, 0) =
      -(_tmp104 + _tmp107 + _tmp108) * std::exp(-_tmp103 - _tmp105 - _tmp107 * fh1 - _tmp108 * fh1);
