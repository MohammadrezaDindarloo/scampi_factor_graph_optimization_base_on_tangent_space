...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2Nl12(
  ...
  const Scalar _tmp42 = _tmp26 + _tmp38;
  const Scalar _tmp43 = _tmp41 + _tmp42;
  const Scalar _tmp44 = -_tmp17;
  const Scalar _tmp45 = _tmp23 + _tmp44;
  const Scalar _tmp46 = _tmp30 + _tmp37;
  const Scalar _tmp47 = Scalar(1.0) / (_tmp41 + _tmp46);
  const Scalar _tmp48 = _tmp19 - _tmp22;
  ...
  const Scalar _tmp54 = Scalar(1.0) / (-_tmp45 + _tmp51 - _tmp53);
  const Scalar _tmp55 = Scalar(1.0) * _tmp54;
  const Scalar _tmp56 = -_tmp7;
  const Scalar _tmp57 = _tmp10 - _tmp13;
  const Scalar _tmp58 = _tmp56 + _tmp57;
  const Scalar _tmp59 = _tmp42 + p_init1;
  const Scalar _tmp60 = _tmp59 + Scalar(-4.8333311099999996);
  const Scalar _tmp61 = _tmp45 + p_init0;
  ...
  const Scalar _tmp66 = _tmp57 + _tmp7;
  const Scalar _tmp67 = _tmp49 + p_init0;
  ...
  const Scalar _tmp73 = _tmp39 + p_init1;
  const Scalar _tmp74 = _tmp73 + Scalar(8.3196563700000006);
  const Scalar _tmp75 = _tmp50 + p_init0;
  ...
  const Scalar _tmp81 = _tmp66 * _tmp72 - _tmp78 * _tmp80;
  const Scalar _tmp82 = Scalar(1.0) / (-_tmp72 + _tmp78 * _tmp79);
  const Scalar _tmp83 = _tmp60 * _tmp63;
  const Scalar _tmp84 = _tmp64 * _tmp78 - _tmp83;
  const Scalar _tmp85 = _tmp82 * _tmp84;
  const Scalar _tmp86 = _tmp14 + _tmp56;
  const Scalar _tmp87 = -_tmp65 * _tmp78 - _tmp81 * _tmp85 + _tmp83 * _tmp86;
  const Scalar _tmp88 = _tmp82 * (-_tmp66 * _tmp79 + _tmp80);
  const Scalar _tmp89 = -_tmp52 * _tmp87 - _tmp64 * _tmp86 + _tmp65 - _tmp84 * _tmp88;
  const Scalar _tmp90 =
      std::sqrt(Scalar(std::pow(_tmp74, Scalar(2)) + std::pow(_tmp76, Scalar(2))));
  const Scalar _tmp91 = Scalar(1.0) / (_tmp90);
  const Scalar _tmp92 = _tmp77 * _tmp90;
  const Scalar _tmp93 = _tmp92 * (-_tmp39 * _tmp76 * _tmp91 + _tmp50 * _tmp74 * _tmp91);
  const Scalar _tmp94 = _tmp46 * _tmp79 - _tmp49 * _tmp72 + _tmp79 * _tmp93;
  const Scalar _tmp95 = _tmp42 * _tmp64 - _tmp45 * _tmp83 + _tmp64 * _tmp93 - _tmp85 * _tmp94;
  ...
  const Scalar _tmp100 = _tmp43 * _tmp98 - _tmp87 * _tmp99;
  const Scalar _tmp101 = Scalar(1.0) * _tmp47;
  const Scalar _tmp102 = _tmp32 + Scalar(-4.7752063900000001);
  ...
  const Scalar _tmp107 = fh1 * (_tmp105 * _tmp24 - _tmp106 * _tmp31);
  const Scalar _tmp108 = _tmp40 * _tmp52 + _tmp51;
  const Scalar _tmp109 = _tmp108 * _tmp54;
  const Scalar _tmp110 = 0;
  const Scalar _tmp111 = Scalar(1.0) / (_tmp89);
  const Scalar _tmp112 = _tmp111 * _tmp87;
  const Scalar _tmp113 = -_tmp109 * _tmp43 - _tmp110 * _tmp112 + _tmp41;
  const Scalar _tmp114 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp115 = _tmp15 * fh1;
  const Scalar _tmp116 = -_tmp105 * _tmp115 - Scalar(3.29616) * _tmp27 - _tmp31 * fv1;
  const Scalar _tmp117 = _tmp53 * _tmp55 + Scalar(1.0);
  const Scalar _tmp118 = _tmp52 * _tmp55;
  const Scalar _tmp119 = _tmp78 * _tmp82;
  const Scalar _tmp120 = _tmp119 * _tmp81 + _tmp58 * _tmp78;
  const Scalar _tmp121 = -_tmp120 * _tmp52 - _tmp58 + _tmp78 * _tmp88;
  const Scalar _tmp122 = _tmp111 * _tmp95;
  const Scalar _tmp123 = _tmp97 * (_tmp119 * _tmp94 - _tmp121 * _tmp122 - _tmp93);
  const Scalar _tmp124 = _tmp121 + _tmp123;
  const Scalar _tmp125 = _tmp43 * _tmp54;
  const Scalar _tmp126 = -_tmp112 * _tmp124 + _tmp120 + _tmp123 * _tmp125;
  const Scalar _tmp127 = _tmp106 * fh1;
  const Scalar _tmp128 = _tmp106 * _tmp115 + Scalar(3.29616) * _tmp18 + _tmp24 * fv1;
  const Scalar _tmp129 = _tmp43 * _tmp47;
  const Scalar _tmp130 = Scalar(1.0) * _tmp82;
  const Scalar _tmp131 = _tmp130 * _tmp81;
  const Scalar _tmp132 = _tmp131 * _tmp52 - Scalar(1.0) * _tmp88;
  const Scalar _tmp133 = _tmp97 * (-_tmp122 * _tmp132 - _tmp130 * _tmp94);
  const Scalar _tmp134 = _tmp132 + _tmp133;
  const Scalar _tmp135 = -_tmp112 * _tmp134 + _tmp125 * _tmp133 - _tmp131;
  const Scalar _tmp136 = _tmp105 * fh1;
  const Scalar _tmp137 = _tmp130 * _tmp84 * _tmp96;
  const Scalar _tmp138 = _tmp111 * _tmp64;
  const Scalar _tmp139 = _tmp111 * _tmp84;
  const Scalar _tmp140 = -_tmp134 * _tmp139 + Scalar(1.0);
  const Scalar _tmp141 = _tmp79 * _tmp82;
  const Scalar _tmp142 = -_tmp124 * _tmp139 - _tmp78;
  const Scalar _tmp143 = _tmp110 * _tmp111;
  const Scalar _tmp144 = -_tmp107 * _tmp92 * (-_tmp137 * _tmp79 + _tmp64 * _tmp99) -
                         _tmp114 * _tmp92 * (_tmp143 * _tmp64 - _tmp143 * _tmp79 * _tmp85) -
                         _tmp127 * _tmp92 * (_tmp124 * _tmp138 + _tmp141 * _tmp142 + Scalar(1.0)) -
                         _tmp136 * _tmp92 * (_tmp134 * _tmp138 + _tmp140 * _tmp141);
  const Scalar _tmp145 = Scalar(1.0) / (_tmp144);
  const Scalar _tmp146 = std::asinh(
      _tmp145 * (Scalar(1.0) * _tmp107 * (-_tmp100 * _tmp101 + _tmp98) +
                 Scalar(1.0) * _tmp114 * (-_tmp101 * _tmp113 - _tmp108 * _tmp55 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp116 * (-_tmp101 * _tmp117 + _tmp118) +
                 Scalar(1.0) * _tmp127 * (-_tmp101 * _tmp126 + _tmp123 * _tmp55) +
                 Scalar(1.0) * _tmp128 * (_tmp129 * _tmp55 - _tmp55) +
                 Scalar(1.0) * _tmp136 * (-_tmp101 * _tmp135 + _tmp133 * _tmp55)));
  ...
  const Scalar _tmp149 = Scalar(6.351516257848961) *
  ...
  const Scalar _tmp150 = _tmp47 * fh1;
  const Scalar _tmp151 = _tmp128 * _tmp55;
  const Scalar _tmp152 = _tmp114 * _tmp143;
  const Scalar _tmp153 = -_tmp107 * _tmp137 + _tmp127 * _tmp142 * _tmp82 +
                         _tmp136 * _tmp140 * _tmp82 - _tmp152 * _tmp85;
  const Scalar _tmp154 = Scalar(1.0) / (_tmp153);
  const Scalar _tmp155 =
      std::asinh(_tmp154 * (_tmp100 * _tmp107 * _tmp47 + _tmp105 * _tmp135 * _tmp150 +
                            _tmp106 * _tmp126 * _tmp150 + _tmp113 * _tmp114 * _tmp47 +
                            _tmp116 * _tmp117 * _tmp47 - _tmp129 * _tmp151));
  ...
  const Scalar _tmp158 =
      _tmp107 * _tmp99 + _tmp111 * _tmp124 * _tmp127 + _tmp111 * _tmp134 * _tmp136 + _tmp152;
  const Scalar _tmp159 = Scalar(1.0) / (_tmp158);
  const Scalar _tmp160 =
      std::asinh(_tmp159 * (-_tmp107 * _tmp98 + _tmp109 * _tmp114 - _tmp116 * _tmp118 -
                            _tmp123 * _tmp127 * _tmp54 - _tmp133 * _tmp136 * _tmp54 + _tmp151));
  ...
  _res(1, 0) =
      ...
      Scalar(8.4718465799999993) *
          std::sqrt(Scalar(Scalar(0.013932974275675287) * _tmp148 +
                           std::pow(Scalar(-Scalar(0.11803802046660766) * _tmp58 -
  ...
  _res(2, 0) =
      ...
      Scalar(8.4693136199999994) *
          std::sqrt(Scalar(Scalar(0.013941309530580858) * _tmp149 +
                           std::pow(Scalar(-Scalar(0.11807332268798426) * _tmp66 -
