...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2Nl13(
  ...
  const Scalar _tmp29 = Scalar(0.20999999999999999) * _tmp16 + Scalar(0.20999999999999999) * _tmp9;
  ...
  const Scalar _tmp53 = _tmp30 + _tmp37;
  ...
  const Scalar _tmp69 = _tmp62 * (-_tmp60 * _tmp68 + _tmp61 * _tmp65);
  const Scalar _tmp70 = _tmp52 * _tmp69 + _tmp68;
  ...
  const Scalar _tmp77 = _tmp62 * (-_tmp60 * _tmp65 + _tmp60 * _tmp67);
  const Scalar _tmp78 = _tmp52 * _tmp77 - _tmp67 - _tmp70 * _tmp76;
  const Scalar _tmp79 = _tmp17 + _tmp43;
  const Scalar _tmp80 = _tmp79 + p_init0;
  const Scalar _tmp81 = _tmp80 + Scalar(-2.5202214700000001);
  const Scalar _tmp82 = _tmp26 + _tmp38;
  ...
  const Scalar _tmp88 = _tmp52 * _tmp87 - _tmp86;
  const Scalar _tmp89 = _tmp66 + _tmp7;
  const Scalar _tmp90 = _tmp67 * _tmp87;
  const Scalar _tmp91 = -_tmp52 * _tmp90 - _tmp69 * _tmp88 + _tmp86 * _tmp89;
  const Scalar _tmp92 = -_tmp76 * _tmp91 - _tmp77 * _tmp88 - _tmp87 * _tmp89 + _tmp90;
  const Scalar _tmp93 = Scalar(1.0) / (_tmp92);
  const Scalar _tmp94 = _tmp51 * _tmp87 - _tmp63 * _tmp88 - _tmp79 * _tmp86 + _tmp82 * _tmp87;
  const Scalar _tmp95 = _tmp93 * _tmp94;
  const Scalar _tmp96 = Scalar(1.0) / (_tmp94);
  const Scalar _tmp97 = _tmp92 * _tmp96;
  const Scalar _tmp98 = _tmp97 * (-_tmp51 + _tmp52 * _tmp63 - _tmp78 * _tmp95);
  const Scalar _tmp99 = _tmp72 + _tmp82;
  const Scalar _tmp100 = _tmp76 * _tmp99;
  const Scalar _tmp101 = Scalar(1.0) / (-_tmp100 + _tmp74 - _tmp79);
  const Scalar _tmp102 = _tmp101 * _tmp99;
  const Scalar _tmp103 = _tmp93 * (_tmp78 + _tmp98);
  const Scalar _tmp104 = _tmp102 * _tmp98 - _tmp103 * _tmp91 + _tmp70;
  const Scalar _tmp105 = Scalar(1.0) * _tmp73;
  const Scalar _tmp106 = Scalar(1.0) * _tmp101;
  const Scalar _tmp107 = _tmp25 + Scalar(-2.71799795);
  ...
  const Scalar _tmp114 = -_tmp112 * _tmp91 + _tmp113 * _tmp99;
  const Scalar _tmp115 = _tmp108 * _tmp109;
  const Scalar _tmp116 = fh1 * (-_tmp110 * _tmp31 + _tmp115 * _tmp24);
  const Scalar _tmp117 = _tmp15 * fh1;
  const Scalar _tmp118 = _tmp110 * _tmp117 + Scalar(3.29616) * _tmp18 + _tmp24 * fv1;
  const Scalar _tmp119 = _tmp73 * _tmp99;
  const Scalar _tmp120 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp121 = _tmp71 * _tmp76 + _tmp74;
  const Scalar _tmp122 = 0;
  const Scalar _tmp123 = _tmp91 * _tmp93;
  const Scalar _tmp124 = _tmp101 * _tmp121;
  const Scalar _tmp125 = -_tmp122 * _tmp123 - _tmp124 * _tmp99 + _tmp72;
  const Scalar _tmp126 = -_tmp115 * _tmp117 - Scalar(3.29616) * _tmp27 - _tmp31 * fv1;
  const Scalar _tmp127 = _tmp100 * _tmp106 + Scalar(1.0);
  const Scalar _tmp128 = _tmp106 * _tmp76;
  const Scalar _tmp129 = _tmp105 * _tmp69 * _tmp75 - Scalar(1.0) * _tmp77;
  const Scalar _tmp130 = _tmp97 * (-_tmp129 * _tmp95 - Scalar(1.0) * _tmp63);
  const Scalar _tmp131 = _tmp129 + _tmp130;
  const Scalar _tmp132 = _tmp102 * _tmp130 - _tmp123 * _tmp131 - Scalar(1.0) * _tmp69;
  const Scalar _tmp133 = _tmp115 * fh1;
  const Scalar _tmp134 = _tmp131 * _tmp93;
  const Scalar _tmp135 = -_tmp134 * _tmp88 + Scalar(1.0);
  const Scalar _tmp136 = _tmp60 * _tmp62;
  const Scalar _tmp137 = -_tmp103 * _tmp88 - _tmp52;
  const Scalar _tmp138 = _tmp122 * _tmp93;
  const Scalar _tmp139 = _tmp136 * _tmp88;
  const Scalar _tmp140 = -_tmp111 * _tmp50 * (_tmp103 * _tmp87 + _tmp136 * _tmp137 + Scalar(1.0)) -
                         _tmp116 * _tmp50 * (-_tmp112 * _tmp139 + _tmp112 * _tmp87) -
                         _tmp120 * _tmp50 * (-_tmp138 * _tmp139 + _tmp138 * _tmp87) -
                         _tmp133 * _tmp50 * (_tmp134 * _tmp87 + _tmp135 * _tmp136);
  const Scalar _tmp141 = Scalar(1.0) / (_tmp140);
  const Scalar _tmp142 = std::asinh(
      _tmp141 * (Scalar(1.0) * _tmp111 * (-_tmp104 * _tmp105 + _tmp106 * _tmp98) +
                 Scalar(1.0) * _tmp116 * (-_tmp105 * _tmp114 + _tmp113) +
                 Scalar(1.0) * _tmp118 * (_tmp106 * _tmp119 - _tmp106) +
                 Scalar(1.0) * _tmp120 * (-_tmp105 * _tmp125 - _tmp106 * _tmp121 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp126 * (-_tmp105 * _tmp127 + _tmp128) +
                 Scalar(1.0) * _tmp133 * (-_tmp105 * _tmp132 + _tmp106 * _tmp130)));
  ...
  const Scalar _tmp145 = _tmp112 * _tmp116;
  const Scalar _tmp146 = _tmp62 * _tmp88;
  const Scalar _tmp147 = _tmp120 * _tmp138;
  const Scalar _tmp148 = _tmp111 * _tmp137 * _tmp62 + _tmp133 * _tmp135 * _tmp62 -
  ...
  const Scalar _tmp151 = _tmp106 * _tmp118;
  const Scalar _tmp152 =
      std::asinh(_tmp149 * (_tmp104 * _tmp111 * _tmp73 + _tmp114 * _tmp116 * _tmp73 -
                            _tmp119 * _tmp151 + _tmp120 * _tmp125 * _tmp73 +
                            _tmp126 * _tmp127 * _tmp73 + _tmp132 * _tmp133 * _tmp73));
  const Scalar _tmp153 = Scalar(9.6622558468725703) * _tmp148;
  const Scalar _tmp154 = _tmp103 * _tmp111 + _tmp133 * _tmp134 + _tmp145 + _tmp147;
  const Scalar _tmp155 = Scalar(1.0) / (_tmp154);
  const Scalar _tmp156 =
      std::asinh(_tmp155 * (-_tmp101 * _tmp111 * _tmp98 - _tmp101 * _tmp130 * _tmp133 -
                            _tmp113 * _tmp116 + _tmp120 * _tmp124 - _tmp126 * _tmp128 + _tmp151));
  ...
  _res(2, 0) =
      ...
      Scalar(8.3700199099999999) *
          std::sqrt(Scalar(Scalar(0.01427404356387209) * _tmp150 +
                           std::pow(Scalar(-Scalar(0.11947402882581673) * _tmp65 -
  ...
  _res(3, 0) =
      ...
      Scalar(8.4693136199999994) *
          std::sqrt(Scalar(Scalar(0.013941309530580858) * _tmp157 +
                           std::pow(Scalar(-Scalar(0.11807332268798426) * _tmp89 -
