...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl8(const Scalar fh1, const Scalar fv1,
  ...
  const Scalar _tmp48 = _tmp19 + _tmp37;
  ...
  const Scalar _tmp72 = _tmp71 * (_tmp58 * _tmp69 + _tmp62 * _tmp69 - _tmp65 * _tmp70);
  const Scalar _tmp73 = _tmp38 * _tmp47 - _tmp43 * _tmp59 + _tmp47 * _tmp58 - _tmp61 * _tmp72;
  const Scalar _tmp74 = Scalar(1.0) / (_tmp73);
  const Scalar _tmp75 = Scalar(1.0) * _tmp74;
  const Scalar _tmp76 = _tmp69 * _tmp71;
  const Scalar _tmp77 = _tmp18 + Scalar(-2.5202214700000001);
  const Scalar _tmp78 = _tmp28 + Scalar(8.3888750099999996);
  ...
  const Scalar _tmp82 = fh1 * (_tmp17 * _tmp80 - _tmp27 * _tmp81);
  ...
  const Scalar _tmp87 = Scalar(1.0) / (_tmp62 + _tmp86);
  ...
  const Scalar _tmp93 = _tmp34 + _tmp92;
  const Scalar _tmp94 = _tmp71 * (-_tmp69 * _tmp91 + _tmp70 * _tmp93);
  const Scalar _tmp95 = _tmp71 * (_tmp69 * _tmp90 - _tmp69 * _tmp93);
  const Scalar _tmp96 = _tmp84 * _tmp88 * _tmp94 - Scalar(1.0) * _tmp95;
  const Scalar _tmp97 = _tmp89 + _tmp92;
  const Scalar _tmp98 = -_tmp47 * _tmp91 + _tmp59 * _tmp97 - _tmp61 * _tmp94;
  const Scalar _tmp99 = _tmp84 * _tmp87;
  const Scalar _tmp100 = _tmp47 * _tmp90 - _tmp47 * _tmp97 - _tmp61 * _tmp95 - _tmp98 * _tmp99;
  ...
  const Scalar _tmp106 = _tmp101 * _tmp47;
  const Scalar _tmp107 = _tmp101 * _tmp61;
  const Scalar _tmp108 = -_tmp105 * _tmp107 + Scalar(1.0);
  const Scalar _tmp109 = _tmp80 * fh1;
  const Scalar _tmp110 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp111 = _tmp83 + _tmp85 * _tmp99;
  const Scalar _tmp112 = 0;
  const Scalar _tmp113 = _tmp107 * _tmp112;
  const Scalar _tmp114 = _tmp101 * _tmp112;
  const Scalar _tmp115 = _tmp60 * _tmp94 + _tmp91;
  const Scalar _tmp116 = -_tmp115 * _tmp99 + _tmp60 * _tmp95 - _tmp90;
  const Scalar _tmp117 = _tmp103 * (-_tmp102 * _tmp116 - _tmp58 + _tmp60 * _tmp72);
  const Scalar _tmp118 = _tmp116 + _tmp117;
  const Scalar _tmp119 = -_tmp107 * _tmp118 - _tmp60;
  const Scalar _tmp120 = _tmp81 * fh1;
  const Scalar _tmp121 = -_tmp109 * _tmp57 * (_tmp105 * _tmp106 + _tmp108 * _tmp76) -
                         _tmp110 * _tmp57 * (-_tmp113 * _tmp76 + _tmp114 * _tmp47) -
                         _tmp120 * _tmp57 * (_tmp106 * _tmp118 + _tmp119 * _tmp76 + Scalar(1.0)) -
                         _tmp57 * _tmp82 * (_tmp47 * _tmp75 - _tmp61 * _tmp75 * _tmp76);
  const Scalar _tmp122 = Scalar(1.0) / (_tmp121);
  const Scalar _tmp123 = _tmp38 + _tmp86;
  const Scalar _tmp124 = _tmp123 * _tmp99;
  const Scalar _tmp125 = Scalar(1.0) / (-_tmp124 - _tmp43 + _tmp83);
  const Scalar _tmp126 = Scalar(1.0) * _tmp125;
  const Scalar _tmp127 = _tmp123 * _tmp125;
  const Scalar _tmp128 = _tmp101 * _tmp98;
  const Scalar _tmp129 = _tmp115 + _tmp117 * _tmp127 - _tmp118 * _tmp128;
  const Scalar _tmp130 = _tmp111 * _tmp125;
  const Scalar _tmp131 = -_tmp112 * _tmp128 - _tmp123 * _tmp130 + _tmp86;
  const Scalar _tmp132 = _tmp126 * _tmp99;
  const Scalar _tmp133 = _tmp124 * _tmp126 + Scalar(1.0);
  const Scalar _tmp134 = _tmp35 * fh1;
  const Scalar _tmp135 = -_tmp134 * _tmp80 - Scalar(3.29616) * _tmp22 - _tmp27 * fv1;
  const Scalar _tmp136 = _tmp123 * _tmp87;
  const Scalar _tmp137 = Scalar(3.29616) * _tmp10 + _tmp134 * _tmp81 + _tmp17 * fv1;
  const Scalar _tmp138 = _tmp103 * _tmp126;
  const Scalar _tmp139 = _tmp123 * _tmp138 - _tmp75 * _tmp98;
  const Scalar _tmp140 = _tmp104 * _tmp127 - _tmp105 * _tmp128 - Scalar(1.0) * _tmp94;
  const Scalar _tmp141 = std::asinh(
      _tmp122 * (Scalar(1.0) * _tmp109 * (_tmp104 * _tmp126 - _tmp140 * _tmp88) +
                 Scalar(1.0) * _tmp110 * (-_tmp111 * _tmp126 - _tmp131 * _tmp88 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp120 * (_tmp117 * _tmp126 - _tmp129 * _tmp88) +
                 Scalar(1.0) * _tmp135 * (_tmp132 - _tmp133 * _tmp88) +
                 Scalar(1.0) * _tmp137 * (_tmp126 * _tmp136 - _tmp126) +
                 Scalar(1.0) * _tmp82 * (_tmp138 - _tmp139 * _tmp88)));
  const Scalar _tmp142 = Scalar(9.6622558468725703) * _tmp121;
  const Scalar _tmp143 = _tmp75 * _tmp82;
  const Scalar _tmp144 = _tmp108 * _tmp109 * _tmp71 - _tmp110 * _tmp113 * _tmp71 +
                         _tmp119 * _tmp120 * _tmp71 - _tmp143 * _tmp61 * _tmp71;
  const Scalar _tmp145 = Scalar(1.0) / (_tmp144);
  const Scalar _tmp146 = _tmp126 * _tmp137;
  const Scalar _tmp147 =
      std::asinh(_tmp145 * (_tmp109 * _tmp140 * _tmp87 + _tmp110 * _tmp131 * _tmp87 +
                            _tmp120 * _tmp129 * _tmp87 + _tmp133 * _tmp135 * _tmp87 -
                            _tmp136 * _tmp146 + _tmp139 * _tmp82 * _tmp87));
  const Scalar _tmp148 = Scalar(9.6622558468725703) * _tmp144;
  const Scalar _tmp149 =
      _tmp101 * _tmp105 * _tmp109 + _tmp101 * _tmp118 * _tmp120 + _tmp110 * _tmp114 + _tmp143;
  const Scalar _tmp150 = Scalar(1.0) / (_tmp149);
  const Scalar _tmp151 = std::asinh(_tmp150 * (-_tmp104 * _tmp109 * _tmp125 + _tmp110 * _tmp130 -
                                               _tmp117 * _tmp120 * _tmp125 - _tmp132 * _tmp135 -
                                               _tmp138 * _tmp82 + _tmp146));
  ...
  _res(1, 0) =
      -_tmp142 *
          (Scalar(0.86565325453551001) * _tmp122 + std::cosh(Scalar(1.0) * _tmp141) -
           std::cosh(
  ...
  _res(2, 0) =
      -_tmp148 *
          (Scalar(0.87679799772039002) * _tmp145 + std::cosh(Scalar(1.0) * _tmp147) -
           std::cosh(
           ...
           std::cosh(
               ...
               (-_tmp151 * _tmp152 -
                Scalar(4.8333311099999996) *
                    std::sqrt(Scalar(
                        std::pow(Scalar(1 - Scalar(0.20689664689659551) * _tmp39), Scalar(2)) +
                        Scalar(0.13817235445745474) *
                            std::pow(Scalar(-Scalar(0.55659957866191134) * _tmp44 - 1),
                                     Scalar(2))))))) +
      _tmp97 + p_init2;
