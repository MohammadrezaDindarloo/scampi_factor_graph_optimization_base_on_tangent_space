...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1WrtFh1Nl8(
  ...
  const Scalar _tmp59 = _tmp5 + _tmp50;
  ...
  const Scalar _tmp96 = _tmp79 * (-_tmp68 * _tmp92 + _tmp78 * _tmp95);
  const Scalar _tmp97 = _tmp68 * _tmp91;
  const Scalar _tmp98 = _tmp90 + _tmp93;
  const Scalar _tmp99 = -_tmp55 * _tmp97 + _tmp67 * _tmp98 - _tmp69 * _tmp96;
  ...
  const Scalar _tmp106 = _tmp79 * (-_tmp77 * _tmp95 + _tmp92);
  const Scalar _tmp107 = -_tmp105 * _tmp99 - _tmp106 * _tmp69 + _tmp55 * _tmp91 - _tmp55 * _tmp98;
  const Scalar _tmp108 = Scalar(1.0) / (_tmp107);
  const Scalar _tmp109 = Scalar(1.0) * _tmp102;
  const Scalar _tmp110 = _tmp104 * _tmp109 * _tmp96 - Scalar(1.0) * _tmp106;
  const Scalar _tmp111 = _tmp108 * _tmp81;
  const Scalar _tmp112 = _tmp107 * _tmp82;
  const Scalar _tmp113 = _tmp112 * (-_tmp110 * _tmp111 - Scalar(1.0) * _tmp80);
  const Scalar _tmp114 = _tmp108 * (_tmp110 + _tmp113);
  const Scalar _tmp115 = _tmp79 * (-_tmp114 * _tmp69 + Scalar(1.0));
  const Scalar _tmp116 = _tmp42 * _tmp65 * (_tmp114 * _tmp55 + _tmp115 * _tmp77);
  const Scalar _tmp117 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp118 = _tmp100 * _tmp105 + _tmp103;
  const Scalar _tmp119 = 0;
  const Scalar _tmp120 = _tmp68 * _tmp96 + _tmp97;
  const Scalar _tmp121 = -_tmp105 * _tmp120 + _tmp106 * _tmp68 - _tmp91;
  const Scalar _tmp122 = _tmp112 * (-_tmp111 * _tmp121 - _tmp66 + _tmp68 * _tmp80);
  const Scalar _tmp123 = _tmp108 * (_tmp121 + _tmp122);
  const Scalar _tmp124 = _tmp79 * (-_tmp123 * _tmp69 - _tmp68);
  const Scalar _tmp125 = _tmp43 * _tmp65 * (_tmp123 * _tmp55 + _tmp124 * _tmp77 + Scalar(1.0));
  const Scalar _tmp126 = -_tmp116 * fh1 - _tmp117 * _tmp65 * (_tmp119 * _tmp55 - _tmp119 * _tmp85) -
                         _tmp125 * fh1 - _tmp86 * fh1;
  const Scalar _tmp127 = Scalar(1.0) / (_tmp126);
  const Scalar _tmp128 = _tmp101 + _tmp46;
  const Scalar _tmp129 = _tmp105 * _tmp128;
  const Scalar _tmp130 = Scalar(1.0) / (_tmp103 - _tmp129 - _tmp51);
  const Scalar _tmp131 = Scalar(1.0) * _tmp130;
  const Scalar _tmp132 = _tmp128 * _tmp130;
  const Scalar _tmp133 = _tmp120 + _tmp122 * _tmp132 - _tmp123 * _tmp99;
  const Scalar _tmp134 = Scalar(1.0) * _tmp43 * (-_tmp109 * _tmp133 + _tmp122 * _tmp131);
  const Scalar _tmp135 = _tmp118 * _tmp130;
  const Scalar _tmp136 = _tmp101 - _tmp119 * _tmp99 - _tmp128 * _tmp135;
  const Scalar _tmp137 = _tmp87 + _tmp94;
  const Scalar _tmp138 = _tmp137 * fh1;
  const Scalar _tmp139 = -_tmp138 * _tmp42 - Scalar(3.29616) * _tmp24 - _tmp28 * fv1;
  const Scalar _tmp140 = _tmp105 * _tmp131;
  const Scalar _tmp141 = _tmp129 * _tmp131 + Scalar(1.0);
  const Scalar _tmp142 = -Scalar(1.0) * _tmp109 * _tmp141 + Scalar(1.0) * _tmp140;
  const Scalar _tmp143 = Scalar(3.29616) * _tmp10 + _tmp138 * _tmp43 + _tmp17 * fv1;
  const Scalar _tmp144 = _tmp102 * _tmp128;
  const Scalar _tmp145 = Scalar(1.0) * _tmp131 * _tmp144 - Scalar(1.0) * _tmp131;
  const Scalar _tmp146 = _tmp112 * _tmp131;
  const Scalar _tmp147 = _tmp102 * (_tmp128 * _tmp146 - _tmp83 * _tmp99);
  const Scalar _tmp148 = Scalar(1.0) * _tmp44;
  const Scalar _tmp149 = _tmp148 * (_tmp146 - Scalar(1.0) * _tmp147);
  const Scalar _tmp150 = _tmp113 * _tmp132 - _tmp114 * _tmp99 - Scalar(1.0) * _tmp96;
  const Scalar _tmp151 = Scalar(1.0) * _tmp42 * (-_tmp109 * _tmp150 + _tmp113 * _tmp131);
  const Scalar _tmp152 =
      Scalar(1.0) * _tmp117 * (-_tmp109 * _tmp136 - _tmp118 * _tmp131 + Scalar(1.0)) +
      _tmp134 * fh1 + _tmp139 * _tmp142 + _tmp143 * _tmp145 + _tmp149 * fh1 + _tmp151 * fh1;
  const Scalar _tmp153 = std::asinh(_tmp127 * _tmp152);
  const Scalar _tmp154 = -_tmp116 - _tmp125 - _tmp86;
  ...
  const Scalar _tmp159 = _tmp137 * _tmp42;
  const Scalar _tmp160 = _tmp137 * _tmp43;
  const Scalar _tmp161 =
      (_tmp127 * (_tmp134 - _tmp142 * _tmp159 + _tmp145 * _tmp160 + _tmp149 + _tmp151) -
       _tmp152 * _tmp158) /
  ...
  const Scalar _tmp165 = Scalar(1.0) * _tmp153;
  const Scalar _tmp166 = _tmp115 * _tmp42;
  const Scalar _tmp167 = _tmp148 * _tmp82;
  const Scalar _tmp168 = _tmp167 * fh1;
  const Scalar _tmp169 = _tmp124 * _tmp43;
  const Scalar _tmp170 = _tmp117 * _tmp119;
  const Scalar _tmp171 = _tmp166 * fh1 - _tmp168 * _tmp84 + _tmp169 * fh1 - _tmp170 * _tmp84;
  const Scalar _tmp172 = Scalar(1.0) / (_tmp171);
  const Scalar _tmp173 = _tmp147 * _tmp44;
  const Scalar _tmp174 = _tmp102 * _tmp43;
  const Scalar _tmp175 = _tmp133 * _tmp174;
  const Scalar _tmp176 = _tmp131 * _tmp143;
  const Scalar _tmp177 = _tmp102 * _tmp139;
  const Scalar _tmp178 = _tmp102 * _tmp42;
  const Scalar _tmp179 = _tmp150 * _tmp178;
  const Scalar _tmp180 = _tmp102 * _tmp117 * _tmp136 + _tmp141 * _tmp177 - _tmp144 * _tmp176 +
                         _tmp173 * fh1 + _tmp175 * fh1 + _tmp179 * fh1;
  const Scalar _tmp181 = std::asinh(_tmp172 * _tmp180);
  ...
  const Scalar _tmp187 = _tmp166 - _tmp167 * _tmp84 + _tmp169;
  const Scalar _tmp188 = Scalar(9.6622558468725703) * _tmp187;
  const Scalar _tmp189 = std::pow(_tmp171, Scalar(-2));
  const Scalar _tmp190 = _tmp187 * _tmp189;
  const Scalar _tmp191 = (_tmp172 * (-_tmp128 * _tmp131 * _tmp137 * _tmp174 -
                                     _tmp137 * _tmp141 * _tmp178 + _tmp173 + _tmp175 + _tmp179) -
                          _tmp180 * _tmp190) /
                         std::sqrt(Scalar(std::pow(_tmp180, Scalar(2)) * _tmp189 + 1));
  const Scalar _tmp192 = _tmp123 * _tmp43;
  const Scalar _tmp193 = _tmp114 * _tmp42;
  const Scalar _tmp194 = _tmp168 + _tmp170 + _tmp192 * fh1 + _tmp193 * fh1;
  const Scalar _tmp195 = Scalar(1.0) / (_tmp194);
  const Scalar _tmp196 = _tmp146 * _tmp44;
  const Scalar _tmp197 = _tmp122 * _tmp130 * _tmp43;
  const Scalar _tmp198 = _tmp113 * _tmp130 * _tmp42;
  const Scalar _tmp199 = -_tmp104 * _tmp131 * _tmp177 + _tmp117 * _tmp135 + _tmp176 -
                         _tmp196 * fh1 - _tmp197 * fh1 - _tmp198 * fh1;
  ...
  const Scalar _tmp206 = _tmp167 + _tmp192 + _tmp193;
  const Scalar _tmp207 = _tmp205 * _tmp206;
  const Scalar _tmp208 =
      (_tmp195 * (_tmp131 * _tmp160 + _tmp140 * _tmp159 - _tmp196 - _tmp197 - _tmp198) -
       _tmp199 * _tmp207) /
  ...
  _res(1, 0) =
      -_tmp155 * (Scalar(0.86565325453551001) * _tmp127 - std::cosh(_tmp164) + std::cosh(_tmp165)) -
      _tmp156 *
          (-Scalar(0.86565325453551001) * _tmp158 + Scalar(1.0) * _tmp161 * std::sinh(_tmp165) -
           (-Scalar(0.1034955) * _tmp158 * _tmp163 +
            _tmp162 * (-_tmp153 * _tmp155 - _tmp156 * _tmp161)) *
               std::sinh(_tmp164));
  _res(2, 0) =
      -_tmp182 *
          (-Scalar(0.87679799772039002) * _tmp190 + Scalar(1.0) * _tmp191 * std::sinh(_tmp186) -
           (-Scalar(0.1034955) * _tmp183 * _tmp190 +
            _tmp184 * (-_tmp181 * _tmp188 - _tmp182 * _tmp191)) *
               std::sinh(_tmp185)) -
      _tmp188 * (Scalar(0.87679799772039002) * _tmp172 - std::cosh(_tmp185) + std::cosh(_tmp186));
  _res(3, 0) =
      -_tmp201 *
          (-Scalar(0.86625939559540499) * _tmp207 + Scalar(1.0) * _tmp208 * std::sinh(_tmp210) -
           (-Scalar(0.1034955) * _tmp202 * _tmp207 +
            _tmp203 * (-_tmp200 * _tmp209 - _tmp201 * _tmp208)) *
               std::sinh(_tmp204)) -
      _tmp209 * (Scalar(0.86625939559540499) * _tmp195 - std::cosh(_tmp204) + std::cosh(_tmp210));
