...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl6(const Scalar fh1, const Scalar fv1,
  ...
  const Scalar _tmp47 = _tmp46 * (-_tmp38 * _tmp42 * _tmp44 + _tmp39 * _tmp41 * _tmp44);
  const Scalar _tmp48 = -_tmp29 * _tmp35 + _tmp31 * _tmp36 + _tmp36 * _tmp47;
  const Scalar _tmp49 = _tmp39 * _tmp45;
  const Scalar _tmp50 = _tmp16 * _tmp27;
  const Scalar _tmp51 = _tmp28 * _tmp49 - _tmp50;
  const Scalar _tmp52 = Scalar(1.0) / (-_tmp35 + _tmp36 * _tmp49);
  const Scalar _tmp53 = _tmp51 * _tmp52;
  const Scalar _tmp54 = _tmp15 * _tmp28 - _tmp25 * _tmp50 + _tmp28 * _tmp47 - _tmp48 * _tmp53;
  const Scalar _tmp55 = Scalar(1.0) / (_tmp54);
  const Scalar _tmp56 = Scalar(1.0) * _tmp55;
  const Scalar _tmp57 = _tmp18 + _tmp40;
  ...
  const Scalar _tmp72 = -_tmp36 * _tmp71 + _tmp70;
  const Scalar _tmp73 = Scalar(1.0) * _tmp52;
  const Scalar _tmp74 = _tmp35 * _tmp71 - _tmp49 * _tmp70;
  const Scalar _tmp75 = Scalar(1.0) * _tmp38;
  const Scalar _tmp76 = Scalar(1.0) * _tmp41;
  const Scalar _tmp77 = (-_tmp29 + _tmp76) / (_tmp31 - _tmp75);
  const Scalar _tmp78 = -_tmp72 * _tmp73 + _tmp73 * _tmp74 * _tmp77;
  const Scalar _tmp79 = _tmp28 * _tmp69;
  const Scalar _tmp80 = _tmp65 + _tmp68;
  const Scalar _tmp81 = -_tmp28 * _tmp80 - _tmp53 * _tmp72 -
                        _tmp77 * (-_tmp49 * _tmp79 + _tmp50 * _tmp80 - _tmp53 * _tmp74) + _tmp79;
  const Scalar _tmp82 = Scalar(1.0) / (_tmp81);
  const Scalar _tmp83 = _tmp54 * _tmp82;
  const Scalar _tmp84 = _tmp55 * _tmp81;
  const Scalar _tmp85 = _tmp78 + _tmp84 * (-_tmp48 * _tmp73 - _tmp78 * _tmp83);
  const Scalar _tmp86 = _tmp28 * _tmp82;
  const Scalar _tmp87 = _tmp51 * _tmp82;
  const Scalar _tmp88 = -_tmp85 * _tmp87 + Scalar(1.0);
  const Scalar _tmp89 = _tmp36 * _tmp52;
  const Scalar _tmp90 = _tmp62 * fh1;
  const Scalar _tmp91 = _tmp49 * _tmp52;
  const Scalar _tmp92 = -_tmp69 + _tmp72 * _tmp91 - _tmp77 * (_tmp49 * _tmp69 + _tmp74 * _tmp91);
  const Scalar _tmp93 = _tmp84 * (-_tmp47 + _tmp48 * _tmp91 - _tmp83 * _tmp92) + _tmp92;
  const Scalar _tmp94 = -_tmp49 - _tmp87 * _tmp93;
  ...
  const Scalar _tmp100 = _tmp87 * _tmp98;
  ...
  _res(1, 0) = std::exp(_tmp46 * _tmp64 * (_tmp28 * _tmp56 - _tmp36 * _tmp53 * _tmp56) +
                        _tmp46 * _tmp90 * (_tmp85 * _tmp86 + _tmp88 * _tmp89) +
                        _tmp46 * _tmp95 * (_tmp86 * _tmp93 + _tmp89 * _tmp94 + Scalar(1.0)) +
                        _tmp46 * _tmp96 * (-_tmp100 * _tmp89 + _tmp28 * _tmp99));
  _res(2, 0) = std::exp(_tmp100 * _tmp52 * _tmp96 + _tmp101 * _tmp53 - _tmp52 * _tmp88 * _tmp90 -
                        _tmp52 * _tmp94 * _tmp95);
  _res(3, 0) =
      std::exp(-_tmp101 - _tmp82 * _tmp85 * _tmp90 - _tmp82 * _tmp93 * _tmp95 - _tmp96 * _tmp99);
