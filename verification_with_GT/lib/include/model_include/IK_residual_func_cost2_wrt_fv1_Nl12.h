...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2WrtFv1Nl12(
  ...
  const Scalar _tmp39 = _tmp29 + _tmp34;
  const Scalar _tmp40 = _tmp38 + _tmp39;
  const Scalar _tmp41 = -_tmp7;
  const Scalar _tmp42 = _tmp18 + _tmp41;
  const Scalar _tmp43 = _tmp21 + _tmp26 + _tmp33;
  ...
  const Scalar _tmp55 = -Scalar(0.010999999999999999) * _tmp27 -
  ...
  const Scalar _tmp68 = _tmp43 + p_init1;
  ...
  const Scalar _tmp72 = _tmp36 + p_init1;
  const Scalar _tmp73 = _tmp72 + Scalar(8.3196563700000006);
  const Scalar _tmp74 = _tmp47 + p_init0;
  ...
  const Scalar _tmp81 = Scalar(1.0) / (-_tmp71 + _tmp77 * _tmp79);
  const Scalar _tmp82 = _tmp60 * _tmp63;
  const Scalar _tmp83 = _tmp64 * _tmp77 - _tmp82;
  const Scalar _tmp84 = _tmp81 * _tmp83;
  const Scalar _tmp85 = _tmp55 + _tmp56;
  const Scalar _tmp86 = _tmp54 + _tmp85;
  const Scalar _tmp87 = -_tmp64 * _tmp78 - _tmp80 * _tmp84 + _tmp82 * _tmp86;
  const Scalar _tmp88 = _tmp81 * (_tmp58 * _tmp79 - _tmp65 * _tmp79);
  const Scalar _tmp89 = -_tmp49 * _tmp87 + _tmp58 * _tmp64 - _tmp64 * _tmp86 - _tmp83 * _tmp88;
  const Scalar _tmp90 =
      std::sqrt(Scalar(std::pow(_tmp73, Scalar(2)) + std::pow(_tmp75, Scalar(2))));
  const Scalar _tmp91 = Scalar(1.0) / (_tmp90);
  const Scalar _tmp92 = _tmp76 * _tmp90;
  const Scalar _tmp93 = _tmp92 * (-_tmp36 * _tmp75 * _tmp91 + _tmp47 * _tmp73 * _tmp91);
  const Scalar _tmp94 = _tmp43 * _tmp79 - _tmp46 * _tmp71 + _tmp79 * _tmp93;
  const Scalar _tmp95 = _tmp39 * _tmp64 - _tmp42 * _tmp82 + _tmp64 * _tmp93 - _tmp84 * _tmp94;
  ...
  const Scalar _tmp100 = _tmp40 * _tmp98 - _tmp87 * _tmp99;
  ...
  const Scalar _tmp109 = _tmp37 * _tmp49 + _tmp48;
  const Scalar _tmp110 = _tmp109 * _tmp51;
  const Scalar _tmp111 = 0;
  const Scalar _tmp112 = Scalar(1.0) / (_tmp89);
  const Scalar _tmp113 = _tmp112 * _tmp87;
  const Scalar _tmp114 = _tmp44 * (-_tmp110 * _tmp40 - _tmp111 * _tmp113 + _tmp38);
  const Scalar _tmp115 = -Scalar(1.0) * _tmp110 - Scalar(1.0) * _tmp114 + Scalar(1.0);
  const Scalar _tmp116 = fh1 * (_tmp53 + _tmp85);
  const Scalar _tmp117 = -_tmp105 * _tmp116 - Scalar(3.29616) * _tmp24 - _tmp30 * fv1;
  const Scalar _tmp118 = _tmp50 * _tmp52 + Scalar(1.0);
  const Scalar _tmp119 = _tmp49 * _tmp52;
  const Scalar _tmp120 = -Scalar(1.0) * _tmp101 * _tmp118 + Scalar(1.0) * _tmp119;
  const Scalar _tmp121 = _tmp77 * _tmp81;
  const Scalar _tmp122 = _tmp121 * _tmp80 + _tmp78;
  const Scalar _tmp123 = -_tmp122 * _tmp49 - _tmp58 + _tmp77 * _tmp88;
  const Scalar _tmp124 = _tmp112 * _tmp95;
  const Scalar _tmp125 = _tmp97 * (_tmp121 * _tmp94 - _tmp123 * _tmp124 - _tmp93);
  const Scalar _tmp126 = _tmp123 + _tmp125;
  const Scalar _tmp127 = _tmp40 * _tmp51;
  const Scalar _tmp128 = -_tmp113 * _tmp126 + _tmp122 + _tmp125 * _tmp127;
  const Scalar _tmp129 = _tmp106 * fh1;
  const Scalar _tmp130 = _tmp106 * _tmp116 + Scalar(3.29616) * _tmp13 + _tmp19 * fv1;
  const Scalar _tmp131 = _tmp40 * _tmp44;
  const Scalar _tmp132 = Scalar(1.0) * _tmp131 * _tmp52 - Scalar(1.0) * _tmp52;
  const Scalar _tmp133 = Scalar(1.0) * _tmp81;
  const Scalar _tmp134 = _tmp133 * _tmp80;
  const Scalar _tmp135 = _tmp134 * _tmp49 - Scalar(1.0) * _tmp88;
  const Scalar _tmp136 = _tmp97 * (-_tmp124 * _tmp135 - _tmp133 * _tmp94);
  const Scalar _tmp137 = _tmp135 + _tmp136;
  const Scalar _tmp138 = -_tmp113 * _tmp137 + _tmp127 * _tmp136 - _tmp134;
  const Scalar _tmp139 = _tmp105 * fh1;
  const Scalar _tmp140 =
      Scalar(1.0) * _tmp107 * (-_tmp100 * _tmp101 + _tmp98) + _tmp108 * _tmp115 +
      _tmp117 * _tmp120 + Scalar(1.0) * _tmp129 * (-_tmp101 * _tmp128 + _tmp125 * _tmp52) +
      _tmp130 * _tmp132 + Scalar(1.0) * _tmp139 * (-_tmp101 * _tmp138 + _tmp136 * _tmp52);
  const Scalar _tmp141 = _tmp133 * _tmp83 * _tmp96;
  const Scalar _tmp142 = _tmp112 * _tmp64;
  const Scalar _tmp143 = _tmp112 * _tmp83;
  const Scalar _tmp144 = -_tmp137 * _tmp143 + Scalar(1.0);
  const Scalar _tmp145 = _tmp79 * _tmp81;
  const Scalar _tmp146 = -_tmp126 * _tmp143 - _tmp77;
  const Scalar _tmp147 = _tmp111 * _tmp112;
  const Scalar _tmp148 = _tmp111 * _tmp143;
  const Scalar _tmp149 = _tmp92 * (-_tmp145 * _tmp148 + _tmp147 * _tmp64);
  const Scalar _tmp150 = -_tmp107 * _tmp92 * (-_tmp141 * _tmp79 + _tmp64 * _tmp99) -
                         _tmp108 * _tmp149 -
                         _tmp129 * _tmp92 * (_tmp126 * _tmp142 + _tmp145 * _tmp146 + Scalar(1.0)) -
                         _tmp139 * _tmp92 * (_tmp137 * _tmp142 + _tmp144 * _tmp145);
  ...
  const Scalar _tmp159 = _tmp25 + _tmp35;
  const Scalar _tmp160 =
      (-_tmp140 * _tmp158 + _tmp151 * (-_tmp115 + _tmp120 * _tmp159 + _tmp132 * _tmp19)) /
  ...
  const Scalar _tmp164 = _tmp118 * _tmp44;
  const Scalar _tmp165 = _tmp100 * _tmp107 * _tmp44 + _tmp108 * _tmp114 + _tmp117 * _tmp164 +
                         _tmp128 * _tmp129 * _tmp44 - _tmp131 * _tmp163 +
                         _tmp138 * _tmp139 * _tmp44;
  const Scalar _tmp166 = _tmp148 * _tmp81;
  const Scalar _tmp167 = -_tmp107 * _tmp141 - _tmp108 * _tmp166 + _tmp129 * _tmp146 * _tmp81 +
                         _tmp139 * _tmp144 * _tmp81;
  ...
  const Scalar _tmp178 = _tmp19 * _tmp52;
  const Scalar _tmp179 =
      (-_tmp165 * _tmp177 + _tmp168 * (-_tmp114 - _tmp131 * _tmp178 + _tmp159 * _tmp164)) /
      std::sqrt(Scalar(std::pow(_tmp165, Scalar(2)) * _tmp176 + 1));
  const Scalar _tmp180 = -_tmp107 * _tmp98 + _tmp108 * _tmp110 - _tmp117 * _tmp119 -
                         _tmp125 * _tmp129 * _tmp51 - _tmp136 * _tmp139 * _tmp51 + _tmp163;
  const Scalar _tmp181 = _tmp107 * _tmp99 + _tmp108 * _tmp147 + _tmp112 * _tmp126 * _tmp129 +
                         _tmp112 * _tmp137 * _tmp139;
  ...
  const Scalar _tmp187 = (_tmp180 * _tmp186 + _tmp182 * (-_tmp110 - _tmp119 * _tmp159 + _tmp178)) /
  ...
  _res(3, 0) = -_tmp188 * (-std::sinh(_tmp184) - std::sinh(_tmp192)) +
               _tmp189 * (-Scalar(1.0) * _tmp187 * std::cosh(_tmp184) -
                          (Scalar(0.1034955) * _tmp186 * _tmp191 +
                           _tmp190 * (_tmp183 * _tmp188 - _tmp187 * _tmp189)) *
                              std::cosh(_tmp192));
