...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2WrtFv1Nl5(
  ...
  const Scalar _tmp43 = Scalar(1.0) * _tmp39;
  ...
  const Scalar _tmp50 = _tmp36 + _tmp7;
  const Scalar _tmp51 = _tmp49 * (_tmp41 - _tmp50);
  const Scalar _tmp52 = _tmp46 * _tmp51;
  const Scalar _tmp53 = Scalar(1.0) / (_tmp41 - _tmp42 - _tmp52);
  const Scalar _tmp54 = Scalar(1.0) * _tmp53;
  const Scalar _tmp55 = Scalar(0.20999999999999999) * _tmp11 - Scalar(0.20999999999999999) * _tmp14;
  const Scalar _tmp56 = -Scalar(0.010999999999999999) * _tmp23 -
  ...
  const Scalar _tmp60 = _tmp50 + p_init0;
  const Scalar _tmp61 = _tmp60 + Scalar(-2.71799795);
  const Scalar _tmp62 = _tmp48 + p_init1;
  ...
  const Scalar _tmp68 = -_tmp59 * _tmp65 + _tmp65 * _tmp67;
  const Scalar _tmp69 = _tmp63 * _tmp64;
  const Scalar _tmp70 = _tmp40 + Scalar(-4.8333311099999996);
  const Scalar _tmp71 = _tmp38 + Scalar(1.79662371);
  const Scalar _tmp72 = Scalar(1.0) / (_tmp71);
  const Scalar _tmp73 = _tmp70 * _tmp72;
  const Scalar _tmp74 = Scalar(1.0) / (_tmp65 * _tmp73 - _tmp69);
  const Scalar _tmp75 = _tmp73 * _tmp74;
  const Scalar _tmp76 = _tmp67 * _tmp73;
  const Scalar _tmp77 = _tmp59 * _tmp69 - _tmp65 * _tmp76;
  const Scalar _tmp78 = _tmp75 * _tmp77 + _tmp76;
  const Scalar _tmp79 = -_tmp51 * _tmp78 - _tmp67 + _tmp68 * _tmp75;
  const Scalar _tmp80 = _tmp42 + p_init0;
  const Scalar _tmp81 = _tmp80 + Scalar(-2.5202214700000001);
  const Scalar _tmp82 = _tmp45 + p_init1;
  ...
  const Scalar _tmp87 = _tmp73 * _tmp86 - _tmp85;
  const Scalar _tmp88 = _tmp74 * _tmp87;
  const Scalar _tmp89 = _tmp67 * _tmp86;
  const Scalar _tmp90 = _tmp56 - _tmp57;
  const Scalar _tmp91 = _tmp55 + _tmp90;
  const Scalar _tmp92 = -_tmp73 * _tmp89 - _tmp77 * _tmp88 + _tmp85 * _tmp91;
  const Scalar _tmp93 = -_tmp51 * _tmp92 - _tmp68 * _tmp88 - _tmp86 * _tmp91 + _tmp89;
  ...
  const Scalar _tmp98 = _tmp97 * (_tmp37 * _tmp70 * _tmp96 - _tmp39 * _tmp71 * _tmp96);
  const Scalar _tmp99 = _tmp48 * _tmp65 - _tmp50 * _tmp69 + _tmp65 * _tmp98;
  const Scalar _tmp100 = -_tmp42 * _tmp85 + _tmp45 * _tmp86 + _tmp86 * _tmp98 - _tmp88 * _tmp99;
  const Scalar _tmp101 = _tmp100 * _tmp94;
  const Scalar _tmp102 = Scalar(1.0) / (_tmp100);
  const Scalar _tmp103 = _tmp102 * _tmp93;
  const Scalar _tmp104 = _tmp103 * (-_tmp101 * _tmp79 + _tmp75 * _tmp99 - _tmp98);
  const Scalar _tmp105 = _tmp46 * _tmp53;
  const Scalar _tmp106 = _tmp104 + _tmp79;
  const Scalar _tmp107 = _tmp92 * _tmp94;
  const Scalar _tmp108 = _tmp104 * _tmp105 - _tmp106 * _tmp107 + _tmp78;
  const Scalar _tmp109 = Scalar(1.0) * _tmp49;
  const Scalar _tmp110 = _tmp34 + Scalar(8.3196563700000006);
  const Scalar _tmp111 = _tmp22 + Scalar(1.9874742000000001);
  ...
  const Scalar _tmp117 = -_tmp115 * _tmp68 + _tmp116 * _tmp51;
  const Scalar _tmp118 = _tmp103 * (-_tmp101 * _tmp117 - _tmp115 * _tmp99);
  const Scalar _tmp119 = _tmp117 + _tmp118;
  const Scalar _tmp120 = _tmp105 * _tmp118 - _tmp107 * _tmp119 - _tmp116;
  const Scalar _tmp121 = _tmp110 * _tmp112;
  const Scalar _tmp122 = _tmp121 * fh1;
  const Scalar _tmp123 = fh1 * (_tmp66 + _tmp90);
  const Scalar _tmp124 = _tmp113 * _tmp123 + Scalar(3.29616) * _tmp15 + _tmp21 * fv1;
  const Scalar _tmp125 = _tmp46 * _tmp49;
  const Scalar _tmp126 = Scalar(1.0) * _tmp125 * _tmp54 - Scalar(1.0) * _tmp54;
  const Scalar _tmp127 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp128 = _tmp41 + _tmp43 * _tmp51;
  const Scalar _tmp129 = _tmp128 * _tmp53;
  const Scalar _tmp130 = 0;
  const Scalar _tmp131 = _tmp49 * (-_tmp107 * _tmp130 - _tmp129 * _tmp46 + _tmp44);
  const Scalar _tmp132 = -Scalar(1.0) * _tmp129 - Scalar(1.0) * _tmp131 + Scalar(1.0);
  const Scalar _tmp133 = _tmp103 * _tmp54;
  const Scalar _tmp134 = Scalar(1.0) * _tmp102;
  const Scalar _tmp135 = _tmp133 * _tmp46 - _tmp134 * _tmp92;
  const Scalar _tmp136 = fh1 * (-_tmp113 * _tmp33 + _tmp121 * _tmp21);
  const Scalar _tmp137 = -_tmp121 * _tmp123 - Scalar(3.29616) * _tmp28 - _tmp33 * fv1;
  const Scalar _tmp138 = _tmp49 * (_tmp52 * _tmp54 + Scalar(1.0));
  const Scalar _tmp139 = _tmp51 * _tmp54;
  const Scalar _tmp140 = -Scalar(1.0) * _tmp138 + Scalar(1.0) * _tmp139;
  const Scalar _tmp141 = Scalar(1.0) * _tmp114 * (_tmp104 * _tmp54 - _tmp108 * _tmp109) +
                         Scalar(1.0) * _tmp122 * (-_tmp109 * _tmp120 + _tmp118 * _tmp54) +
                         _tmp124 * _tmp126 + _tmp127 * _tmp132 +
                         Scalar(1.0) * _tmp136 * (-_tmp109 * _tmp135 + _tmp133) + _tmp137 * _tmp140;
  const Scalar _tmp142 = _tmp65 * _tmp88;
  const Scalar _tmp143 = _tmp86 * _tmp94;
  const Scalar _tmp144 = _tmp87 * _tmp94;
  const Scalar _tmp145 = -_tmp106 * _tmp144 - _tmp73;
  const Scalar _tmp146 = _tmp65 * _tmp74;
  const Scalar _tmp147 = _tmp130 * _tmp94;
  const Scalar _tmp148 = _tmp97 * (-_tmp142 * _tmp147 + _tmp147 * _tmp86);
  const Scalar _tmp149 = -_tmp119 * _tmp144 + Scalar(1.0);
  const Scalar _tmp150 = -_tmp114 * _tmp97 * (_tmp106 * _tmp143 + _tmp145 * _tmp146 + Scalar(1.0)) -
                         _tmp122 * _tmp97 * (_tmp119 * _tmp143 + _tmp146 * _tmp149) -
                         _tmp127 * _tmp148 -
                         _tmp136 * _tmp97 * (-_tmp134 * _tmp142 + _tmp134 * _tmp86);
          ...
          std::sqrt(
              Scalar(std::pow(Scalar(1 - Scalar(0.20689664689659551) * _tmp40), Scalar(2)) +
                     Scalar(0.13817235445745474) *
                         std::pow(Scalar(-Scalar(0.55659957866191134) * _tmp38 - 1), Scalar(2))));
  ...
  const Scalar _tmp159 = _tmp29 + _tmp47;
  const Scalar _tmp160 = std::pow(_tmp150, Scalar(-2));
  const Scalar _tmp161 = _tmp148 * _tmp160;
  const Scalar _tmp162 =
      (-_tmp141 * _tmp161 + _tmp151 * (_tmp126 * _tmp21 - _tmp132 + _tmp140 * _tmp159)) /
      std::sqrt(Scalar(std::pow(_tmp141, Scalar(2)) * _tmp160 + 1));
  const Scalar _tmp163 = _tmp127 * _tmp147;
  const Scalar _tmp164 = _tmp134 * _tmp136;
  const Scalar _tmp165 =
      _tmp114 * _tmp145 * _tmp74 + _tmp122 * _tmp149 * _tmp74 - _tmp163 * _tmp88 - _tmp164 * _tmp88;
  const Scalar _tmp166 = Scalar(1.0) / (_tmp165);
  const Scalar _tmp167 = _tmp124 * _tmp54;
  const Scalar _tmp168 = _tmp108 * _tmp114 * _tmp49 + _tmp120 * _tmp122 * _tmp49 -
                         _tmp125 * _tmp167 + _tmp127 * _tmp131 + _tmp135 * _tmp136 * _tmp49 +
                         _tmp137 * _tmp138;
  ...
  const Scalar _tmp175 = Scalar(9.6622558468725703) * _tmp147;
  const Scalar _tmp176 = _tmp175 * _tmp88;
  const Scalar _tmp177 = std::pow(_tmp165, Scalar(-2));
  const Scalar _tmp178 = _tmp147 * _tmp177 * _tmp88;
  const Scalar _tmp179 = _tmp21 * _tmp54;
  const Scalar _tmp180 =
      (_tmp166 * (-_tmp125 * _tmp179 - _tmp131 + _tmp138 * _tmp159) - _tmp168 * _tmp178) /
      std::sqrt(Scalar(std::pow(_tmp168, Scalar(2)) * _tmp177 + 1));
  const Scalar _tmp181 =
      _tmp106 * _tmp114 * _tmp94 + _tmp119 * _tmp122 * _tmp94 + _tmp163 + _tmp164;
  const Scalar _tmp182 = Scalar(1.0) / (_tmp181);
  const Scalar _tmp183 = -_tmp104 * _tmp114 * _tmp53 - _tmp118 * _tmp122 * _tmp53 +
                         _tmp127 * _tmp129 - _tmp133 * _tmp136 - _tmp137 * _tmp139 + _tmp167;
  ...
  const Scalar _tmp191 = (_tmp182 * (-_tmp129 - _tmp139 * _tmp159 + _tmp179) + _tmp183 * _tmp190) /
  ...
  _res(3, 0) = -_tmp175 * (-std::sinh(_tmp188) - std::sinh(_tmp192)) +
