...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1WrtFv1Nl9(
  ...
  const Scalar _tmp64 = _tmp37 * _tmp61;
  ...
  const Scalar _tmp72 = -_tmp52 * _tmp63 + _tmp62 * _tmp65 * _tmp67 * _tmp71;
  const Scalar _tmp73 = _tmp29 + _tmp38;
  const Scalar _tmp74 = _tmp73 + p_init1;
  const Scalar _tmp75 = _tmp74 + Scalar(8.3196563700000006);
  const Scalar _tmp76 = _tmp18 + _tmp43;
  ...
  const Scalar _tmp86 = -_tmp64 * _tmp81 - _tmp65 * _tmp83 + _tmp80 * _tmp85;
  const Scalar _tmp87 = _tmp67 * _tmp70;
  const Scalar _tmp88 = _tmp37 * _tmp81 - _tmp52 * _tmp83 - _tmp81 * _tmp85 - _tmp86 * _tmp87;
  ...
  const Scalar _tmp94 = _tmp40 * _tmp49 - _tmp45 * _tmp53 + _tmp49 * _tmp93;
  const Scalar _tmp95 = _tmp73 * _tmp81 - _tmp76 * _tmp80 + _tmp81 * _tmp93 - _tmp83 * _tmp94;
  ...
  const Scalar _tmp104 = _tmp81 * _tmp89;
  const Scalar _tmp105 = _tmp20 + Scalar(-2.5202214700000001);
  const Scalar _tmp106 = _tmp31 + Scalar(8.3888750099999996);
  ...
  const Scalar _tmp110 = _tmp63 * _tmp82 * _tmp97;
  ...
  const Scalar _tmp115 = _tmp66 + _tmp68 * _tmp87;
  const Scalar _tmp116 = 0;
  const Scalar _tmp117 = _tmp101 * _tmp116;
  const Scalar _tmp118 = _tmp116 * _tmp89;
  const Scalar _tmp119 = _tmp92 * (-_tmp103 * _tmp117 + _tmp118 * _tmp81);
  const Scalar _tmp120 = _tmp61 * _tmp62;
  const Scalar _tmp121 = _tmp120 * _tmp65 + _tmp64;
  const Scalar _tmp122 = _tmp120 * _tmp52 - _tmp121 * _tmp87 - _tmp37;
  const Scalar _tmp123 = _tmp98 * (_tmp120 * _tmp94 - _tmp122 * _tmp96 - _tmp93);
  const Scalar _tmp124 = _tmp122 + _tmp123;
  const Scalar _tmp125 = -_tmp101 * _tmp124 - _tmp61;
  const Scalar _tmp126 = _tmp112 * fh1;
  const Scalar _tmp127 = -_tmp109 * _tmp92 * (_tmp100 * _tmp104 + _tmp102 * _tmp103) -
                         _tmp113 * _tmp92 * (-_tmp110 * _tmp49 + _tmp111 * _tmp81) -
                         _tmp114 * _tmp119 -
                         _tmp126 * _tmp92 * (_tmp103 * _tmp125 + _tmp104 * _tmp124 + Scalar(1.0));
  const Scalar _tmp128 = std::pow(_tmp127, Scalar(-2));
  const Scalar _tmp129 = _tmp119 * _tmp128;
  const Scalar _tmp130 = fh1 * (_tmp33 + _tmp84);
  const Scalar _tmp131 = -_tmp108 * _tmp130 - Scalar(3.29616) * _tmp26 - _tmp30 * fv1;
  const Scalar _tmp132 = _tmp69 + _tmp73;
  const Scalar _tmp133 = _tmp132 * _tmp87;
  const Scalar _tmp134 = Scalar(1.0) / (-_tmp133 + _tmp66 - _tmp76);
  const Scalar _tmp135 = Scalar(1.0) * _tmp134;
  const Scalar _tmp136 = _tmp133 * _tmp135 + Scalar(1.0);
  const Scalar _tmp137 = _tmp135 * _tmp87;
  const Scalar _tmp138 = -Scalar(1.0) * _tmp136 * _tmp71 + Scalar(1.0) * _tmp137;
  const Scalar _tmp139 = _tmp112 * _tmp130 + Scalar(3.29616) * _tmp12 + _tmp19 * fv1;
  const Scalar _tmp140 = _tmp132 * _tmp70;
  const Scalar _tmp141 = Scalar(1.0) * _tmp135 * _tmp140 - Scalar(1.0) * _tmp135;
  const Scalar _tmp142 = _tmp86 * _tmp89;
  const Scalar _tmp143 = _tmp132 * _tmp134;
  const Scalar _tmp144 = -_tmp100 * _tmp142 + _tmp143 * _tmp99 - _tmp63 * _tmp65;
  const Scalar _tmp145 = _tmp115 * _tmp134;
  const Scalar _tmp146 = _tmp70 * (-_tmp118 * _tmp86 - _tmp132 * _tmp145 + _tmp69);
  const Scalar _tmp147 = -Scalar(1.0) * _tmp115 * _tmp135 - Scalar(1.0) * _tmp146 + Scalar(1.0);
  const Scalar _tmp148 = _tmp121 + _tmp123 * _tmp143 - _tmp124 * _tmp142;
  const Scalar _tmp149 = _tmp135 * _tmp98;
  const Scalar _tmp150 = -_tmp111 * _tmp86 + _tmp132 * _tmp149;
  const Scalar _tmp151 = Scalar(1.0) * _tmp109 * (_tmp135 * _tmp99 - _tmp144 * _tmp71) +
                         Scalar(1.0) * _tmp113 * (_tmp149 - _tmp150 * _tmp71) + _tmp114 * _tmp147 +
                         Scalar(1.0) * _tmp126 * (_tmp123 * _tmp135 - _tmp148 * _tmp71) +
                         _tmp131 * _tmp138 + _tmp139 * _tmp141;
  ...
  const Scalar _tmp155 = _tmp27 + _tmp39;
  const Scalar _tmp156 =
      (-_tmp129 * _tmp151 + _tmp152 * (_tmp138 * _tmp155 + _tmp141 * _tmp19 - _tmp147)) /
      std::sqrt(Scalar(_tmp128 * std::pow(_tmp151, Scalar(2)) + 1));
  const Scalar _tmp157 = Scalar(9.6622558468725703) * _tmp119;
  ...
  const Scalar _tmp162 = _tmp136 * _tmp70;
  const Scalar _tmp163 = _tmp135 * _tmp139;
  const Scalar _tmp164 = _tmp109 * _tmp144 * _tmp70 + _tmp113 * _tmp150 * _tmp70 +
                         _tmp114 * _tmp146 + _tmp126 * _tmp148 * _tmp70 + _tmp131 * _tmp162 -
                         _tmp140 * _tmp163;
  const Scalar _tmp165 = _tmp117 * _tmp62;
  const Scalar _tmp166 = _tmp102 * _tmp109 * _tmp62 - _tmp110 * _tmp113 - _tmp114 * _tmp165 +
                         _tmp125 * _tmp126 * _tmp62;
  ...
  const Scalar _tmp177 = _tmp135 * _tmp19;
  const Scalar _tmp178 =
      (-_tmp164 * _tmp176 + _tmp167 * (-_tmp140 * _tmp177 - _tmp146 + _tmp155 * _tmp162)) /
      std::sqrt(Scalar(std::pow(_tmp164, Scalar(2)) * _tmp175 + 1));
  const Scalar _tmp179 = _tmp89 * fh1;
  const Scalar _tmp180 = _tmp100 * _tmp108 * _tmp179 + _tmp111 * _tmp113 +
                         _tmp112 * _tmp124 * _tmp179 + _tmp114 * _tmp118;
  const Scalar _tmp181 = Scalar(1.0) / (_tmp180);
  const Scalar _tmp182 = -_tmp109 * _tmp134 * _tmp99 - _tmp113 * _tmp149 + _tmp114 * _tmp145 -
                         _tmp123 * _tmp126 * _tmp134 - _tmp131 * _tmp137 + _tmp163;
  ...
  const Scalar _tmp187 = (_tmp181 * (-_tmp137 * _tmp155 - _tmp145 + _tmp177) + _tmp182 * _tmp186) /
  ...
  const Scalar _tmp192 = Scalar(9.6622558468725703) * _tmp118;
  ...
  _res(1, 0) =
      -_tmp157 * (Scalar(0.86565325453551001) * _tmp152 + std::cosh(_tmp154) - std::cosh(_tmp161)) -
      _tmp158 *
  ...
  _res(2, 0) =
      -_tmp170 *
          (-Scalar(0.86625939559540499) * _tmp176 + Scalar(1.0) * _tmp178 * std::sinh(_tmp169) -
           (-Scalar(0.1034955) * _tmp171 * _tmp176 +
            _tmp172 * (-_tmp168 * _tmp174 - _tmp170 * _tmp178)) *
               std::sinh(_tmp173)) -
      _tmp174 * (Scalar(0.86625939559540499) * _tmp167 + std::cosh(_tmp169) - std::cosh(_tmp173));
  _res(3, 0) =
      -_tmp188 *
          (Scalar(0.87679799772039002) * _tmp186 + Scalar(1.0) * _tmp187 * std::sinh(_tmp184) -
           (Scalar(0.1034955) * _tmp186 * _tmp189 +
            _tmp190 * (_tmp183 * _tmp192 - _tmp187 * _tmp188)) *
               std::sinh(_tmp191)) +
      _tmp192 * (Scalar(0.87679799772039002) * _tmp181 + std::cosh(_tmp184) - std::cosh(_tmp191));
