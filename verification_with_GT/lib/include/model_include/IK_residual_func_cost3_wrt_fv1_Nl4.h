...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl4(
  ...
  const Scalar _tmp39 = Scalar(1.0) / (_tmp28 * _tmp38 - _tmp37);
  const Scalar _tmp40 =
      std::sqrt(Scalar(std::pow(_tmp17, Scalar(2)) + std::pow(_tmp26, Scalar(2))));
  const Scalar _tmp41 = Scalar(1.0) / (_tmp40);
  const Scalar _tmp42 = _tmp27 * _tmp40;
  const Scalar _tmp43 = _tmp42 * (-_tmp16 * _tmp26 * _tmp41 + _tmp17 * _tmp25 * _tmp41);
  const Scalar _tmp44 = _tmp39 * (-_tmp31 * _tmp37 + _tmp34 * _tmp38 + _tmp38 * _tmp43);
  ...
  const Scalar _tmp51 = _tmp39 * (_tmp38 * _tmp48 - _tmp38 * _tmp50);
  const Scalar _tmp52 = _tmp28 * _tmp48;
  const Scalar _tmp53 = _tmp39 * (_tmp37 * _tmp50 - _tmp38 * _tmp52);
  const Scalar _tmp54 = Scalar(1.0) * _tmp16;
  const Scalar _tmp55 = Scalar(1.0) * _tmp25;
  const Scalar _tmp56 = (-_tmp31 + _tmp55) / (_tmp34 - _tmp54);
  const Scalar _tmp57 = _tmp28 * _tmp51 - _tmp48 - _tmp56 * (_tmp28 * _tmp53 + _tmp52);
  const Scalar _tmp58 = _tmp47 + _tmp49;
  ...
  const Scalar _tmp66 = _tmp28 * _tmp64 - _tmp65;
  const Scalar _tmp67 = _tmp48 * _tmp64 - _tmp51 * _tmp66 -
                        _tmp56 * (-_tmp52 * _tmp64 - _tmp53 * _tmp66 + _tmp58 * _tmp65) -
                        _tmp58 * _tmp64;
  const Scalar _tmp68 = Scalar(1.0) / (_tmp67);
  const Scalar _tmp69 = _tmp43 * _tmp64 - _tmp44 * _tmp66 - _tmp59 * _tmp65 + _tmp61 * _tmp64;
  const Scalar _tmp70 = _tmp68 * _tmp69;
  const Scalar _tmp71 = Scalar(1.0) / (_tmp69);
  const Scalar _tmp72 = _tmp67 * _tmp71;
  const Scalar _tmp73 = _tmp57 + _tmp72 * (_tmp28 * _tmp44 - _tmp43 - _tmp57 * _tmp70);
  const Scalar _tmp74 = _tmp66 * _tmp68;
  const Scalar _tmp75 = -_tmp28 - _tmp73 * _tmp74;
  const Scalar _tmp76 = _tmp38 * _tmp39;
  const Scalar _tmp77 = _tmp64 * _tmp68;
  const Scalar _tmp78 = _tmp33 + _tmp8;
  const Scalar _tmp79 = _tmp78 + p_init1 + Scalar(8.3196563700000006);
  const Scalar _tmp80 = _tmp24 + _tmp29;
  ...
  const Scalar _tmp84 = _tmp42 * fh1;
  const Scalar _tmp85 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp86 = _tmp54 * _tmp56 + _tmp55;
  const Scalar _tmp87 = 0;
  const Scalar _tmp88 = _tmp66 * _tmp76;
  const Scalar _tmp89 = _tmp42 * (_tmp64 * _tmp87 - _tmp87 * _tmp88);
  const Scalar _tmp90 = Scalar(1.0) * _tmp71;
  const Scalar _tmp91 = _tmp79 * _tmp82;
  const Scalar _tmp92 = fh1 * (-_tmp78 * _tmp83 + _tmp80 * _tmp91);
  const Scalar _tmp93 = -Scalar(1.0) * _tmp51 + Scalar(1.0) * _tmp53 * _tmp56;
  const Scalar _tmp94 = _tmp72 * (-Scalar(1.0) * _tmp44 - _tmp70 * _tmp93) + _tmp93;
  const Scalar _tmp95 = -_tmp74 * _tmp94 + Scalar(1.0);
  const Scalar _tmp96 = _tmp90 * _tmp92;
  const Scalar _tmp97 = _tmp39 * _tmp66;
  const Scalar _tmp98 = _tmp85 * _tmp87;
  const Scalar _tmp99 = _tmp39 * fh1;
  ...
  _res(0, 0) = 0;
  _res(1, 0) =
      -_tmp89 * std::exp(_tmp42 * _tmp92 * (_tmp64 * _tmp90 - _tmp88 * _tmp90) +
                         _tmp83 * _tmp84 * (_tmp73 * _tmp77 + _tmp75 * _tmp76 + Scalar(1.0)) +
                         _tmp84 * _tmp91 * (_tmp76 * _tmp95 + _tmp77 * _tmp94) + _tmp85 * _tmp89);
  _res(2, 0) = -_tmp87 * _tmp97 *
               std::exp(-_tmp75 * _tmp83 * _tmp99 - _tmp91 * _tmp95 * _tmp99 + _tmp96 * _tmp97 +
                        _tmp97 * _tmp98);
  _res(3, 0) =
      _tmp87 * std::exp(-_tmp100 * _tmp73 * _tmp83 - _tmp100 * _tmp91 * _tmp94 - _tmp96 - _tmp98);
