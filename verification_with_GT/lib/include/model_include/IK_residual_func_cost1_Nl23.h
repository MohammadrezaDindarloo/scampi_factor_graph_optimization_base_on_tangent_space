...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl23(
  ...
  const Scalar _tmp58 = _tmp46 * _tmp57 - _tmp56;
  ...
  const Scalar _tmp64 = _tmp42 + _tmp47;
  ...
  const Scalar _tmp69 = _tmp32 + _tmp36;
  const Scalar _tmp70 = -_tmp60 * _tmp68 + _tmp68 * _tmp69;
  const Scalar _tmp71 = _tmp66 * _tmp67;
  const Scalar _tmp72 = Scalar(1.0) / (_tmp46 * _tmp68 - _tmp71);
  const Scalar _tmp73 = _tmp58 * _tmp72;
  const Scalar _tmp74 = _tmp33 + _tmp59;
  const Scalar _tmp75 = _tmp46 * _tmp69;
  const Scalar _tmp76 = _tmp60 * _tmp71 - _tmp68 * _tmp75;
  const Scalar _tmp77 = _tmp56 * _tmp74 - _tmp57 * _tmp75 - _tmp73 * _tmp76;
  ...
  const Scalar _tmp83 = _tmp57 * _tmp69 - _tmp57 * _tmp74 - _tmp70 * _tmp73 - _tmp77 * _tmp82;
  ...
  const Scalar _tmp88 = _tmp87 * (_tmp38 * _tmp45 * _tmp86 - _tmp40 * _tmp43 * _tmp86);
  const Scalar _tmp89 = -_tmp61 * _tmp71 + _tmp64 * _tmp68 + _tmp68 * _tmp88;
  const Scalar _tmp90 = _tmp46 * _tmp72;
  const Scalar _tmp91 = _tmp75 + _tmp76 * _tmp90;
  const Scalar _tmp92 = -_tmp69 + _tmp70 * _tmp90 - _tmp82 * _tmp91;
  const Scalar _tmp93 = _tmp48 * _tmp57 - _tmp52 * _tmp56 + _tmp57 * _tmp88 - _tmp73 * _tmp89;
  ...
  const Scalar _tmp100 = -_tmp46 - _tmp58 * _tmp99;
  const Scalar _tmp101 = _tmp68 * _tmp72;
  ...
  const Scalar _tmp107 = Scalar(1.0) * _tmp95;
  const Scalar _tmp108 = Scalar(1.0) * _tmp72;
  const Scalar _tmp109 = _tmp108 * _tmp58 * _tmp95;
  ...
  const Scalar _tmp113 = _tmp78 * _tmp82 + _tmp81;
  const Scalar _tmp114 = 0;
  const Scalar _tmp115 = _tmp114 * _tmp84;
  const Scalar _tmp116 = _tmp108 * _tmp76;
  const Scalar _tmp117 = -_tmp108 * _tmp70 + _tmp116 * _tmp82;
  const Scalar _tmp118 = _tmp96 * (-_tmp108 * _tmp89 - _tmp117 * _tmp94);
  const Scalar _tmp119 = _tmp84 * (_tmp117 + _tmp118);
  const Scalar _tmp120 = -_tmp119 * _tmp58 + Scalar(1.0);
  const Scalar _tmp121 = _tmp110 * fh1;
  const Scalar _tmp122 = -_tmp106 * _tmp87 * (_tmp100 * _tmp101 + _tmp57 * _tmp99 + Scalar(1.0)) -
                         _tmp111 * _tmp87 * (_tmp107 * _tmp57 - _tmp109 * _tmp68) -
                         _tmp112 * _tmp87 * (_tmp115 * _tmp57 - _tmp115 * _tmp68 * _tmp73) -
                         _tmp121 * _tmp87 * (_tmp101 * _tmp120 + _tmp119 * _tmp57);
  const Scalar _tmp123 = Scalar(1.0) / (_tmp122);
  const Scalar _tmp124 = _tmp48 + _tmp79;
  const Scalar _tmp125 = _tmp124 * _tmp82;
  const Scalar _tmp126 = Scalar(1.0) / (-_tmp125 - _tmp52 + _tmp81);
  const Scalar _tmp127 = _tmp124 * _tmp126;
  const Scalar _tmp128 = -_tmp116 + _tmp118 * _tmp127 - _tmp119 * _tmp77;
  const Scalar _tmp129 = Scalar(1.0) * _tmp80;
  const Scalar _tmp130 = Scalar(1.0) * _tmp126;
  const Scalar _tmp131 = _tmp77 * _tmp84;
  const Scalar _tmp132 = _tmp127 * _tmp97 - _tmp131 * _tmp98 + _tmp91;
  const Scalar _tmp133 = _tmp130 * _tmp96;
  const Scalar _tmp134 = _tmp124 * _tmp130;
  const Scalar _tmp135 = -_tmp107 * _tmp77 + _tmp134 * _tmp96;
  const Scalar _tmp136 = _tmp37 * fh1;
  const Scalar _tmp137 = -_tmp110 * _tmp136 - Scalar(3.29616) * _tmp24 - _tmp28 * fv1;
  const Scalar _tmp138 = _tmp80 * (_tmp125 * _tmp130 + Scalar(1.0));
  const Scalar _tmp139 = _tmp130 * _tmp82;
  const Scalar _tmp140 = _tmp105 * _tmp136 + Scalar(3.29616) * _tmp12 + _tmp18 * fv1;
  const Scalar _tmp141 = _tmp113 * _tmp126;
  const Scalar _tmp142 = _tmp80 * (-_tmp114 * _tmp131 - _tmp124 * _tmp141 + _tmp79);
  const Scalar _tmp143 =
      std::asinh(_tmp123 * (Scalar(1.0) * _tmp106 * (-_tmp129 * _tmp132 + _tmp130 * _tmp97) +
                            Scalar(1.0) * _tmp111 * (-_tmp129 * _tmp135 + _tmp133) +
                            Scalar(1.0) * _tmp112 *
                                (-_tmp113 * _tmp130 - Scalar(1.0) * _tmp142 + Scalar(1.0)) +
                            Scalar(1.0) * _tmp121 * (_tmp118 * _tmp130 - _tmp128 * _tmp129) +
                            Scalar(1.0) * _tmp137 * (-Scalar(1.0) * _tmp138 + _tmp139) +
                            Scalar(1.0) * _tmp140 * (-_tmp130 + _tmp134 * _tmp80)));
  const Scalar _tmp144 = Scalar(9.6622558468725703) * _tmp122;
  const Scalar _tmp145 = _tmp72 * fh1;
  const Scalar _tmp146 = _tmp112 * _tmp115;
  const Scalar _tmp147 = _tmp100 * _tmp105 * _tmp145 - _tmp109 * _tmp111 +
                         _tmp110 * _tmp120 * _tmp145 - _tmp146 * _tmp73;
  const Scalar _tmp148 = Scalar(1.0) / (_tmp147);
  const Scalar _tmp149 = _tmp130 * _tmp140;
  const Scalar _tmp150 = _tmp80 * fh1;
  const Scalar _tmp151 =
      std::asinh(_tmp148 * (_tmp105 * _tmp132 * _tmp150 + _tmp110 * _tmp128 * _tmp150 +
                            _tmp111 * _tmp135 * _tmp80 + _tmp112 * _tmp142 -
                            _tmp124 * _tmp149 * _tmp80 + _tmp137 * _tmp138));
  const Scalar _tmp152 = Scalar(9.6622558468725703) * _tmp147;
  const Scalar _tmp153 = _tmp106 * _tmp99 + _tmp107 * _tmp111 + _tmp119 * _tmp121 + _tmp146;
  const Scalar _tmp154 = Scalar(1.0) / (_tmp153);
  const Scalar _tmp155 =
      std::asinh(_tmp154 * (-_tmp106 * _tmp126 * _tmp97 - _tmp111 * _tmp133 + _tmp112 * _tmp141 -
                            _tmp118 * _tmp121 * _tmp126 - _tmp137 * _tmp139 + _tmp149));
  ...
  _res(1, 0) =
      -_tmp144 *
          (Scalar(0.86565325453551001) * _tmp123 + std::cosh(Scalar(1.0) * _tmp143) -
           std::cosh(
  ...
  _res(2, 0) =
      -_tmp152 *
          (Scalar(0.87653584775870996) * _tmp148 + std::cosh(Scalar(1.0) * _tmp151) -
           std::cosh(
