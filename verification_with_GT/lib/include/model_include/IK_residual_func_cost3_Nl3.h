...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl3(const Scalar fh1, const Scalar fv1,
  ...
  const Scalar _tmp42 = (-_tmp26 + _tmp40) / (_tmp17 - _tmp41);
  ...
  const Scalar _tmp51 = _tmp37 * _tmp49 - _tmp37 * _tmp50;
  ...
  const Scalar _tmp61 = _tmp36 * _tmp60 - _tmp59;
  const Scalar _tmp62 = _tmp38 * _tmp61;
  const Scalar _tmp63 = _tmp45 + _tmp46 - _tmp47;
  const Scalar _tmp64 = _tmp36 * _tmp49;
  const Scalar _tmp65 = _tmp29 * _tmp50 - _tmp37 * _tmp64;
  const Scalar _tmp66 = -_tmp42 * (_tmp59 * _tmp63 - _tmp60 * _tmp64 - _tmp62 * _tmp65) +
                        _tmp49 * _tmp60 - _tmp51 * _tmp62 - _tmp60 * _tmp63;
  ...
  const Scalar _tmp74 = _tmp72 * (_tmp31 * _tmp35 * _tmp73 - _tmp32 * _tmp34 * _tmp73);
  const Scalar _tmp75 = _tmp17 * _tmp37 - _tmp26 * _tmp29 + _tmp37 * _tmp74;
  const Scalar _tmp76 = -_tmp53 * _tmp59 + _tmp56 * _tmp60 + _tmp60 * _tmp74 - _tmp62 * _tmp75;
  const Scalar _tmp77 = Scalar(1.0) / (_tmp76);
  const Scalar _tmp78 = Scalar(1.0) * _tmp38;
  const Scalar _tmp79 = _tmp61 * _tmp77 * _tmp78;
  const Scalar _tmp80 = Scalar(1.0) * _tmp77;
  const Scalar _tmp81 = _tmp25 + _tmp52;
  const Scalar _tmp82 = _tmp55 + _tmp8;
  const Scalar _tmp83 = _tmp82 + p_init1 + Scalar(8.3196563700000006);
  const Scalar _tmp84 = _tmp81 + p_init0 + Scalar(1.9874742000000001);
  ...
  const Scalar _tmp89 = _tmp36 * _tmp38;
  const Scalar _tmp90 = -_tmp42 * (_tmp64 + _tmp65 * _tmp89) - _tmp49 + _tmp51 * _tmp89;
  ...
  const Scalar _tmp95 = -_tmp36 - _tmp68 * _tmp93;
  const Scalar _tmp96 = _tmp72 * fh1;
  const Scalar _tmp97 = _tmp42 * _tmp65 * _tmp78 - _tmp51 * _tmp78;
  const Scalar _tmp98 = _tmp92 * (-_tmp75 * _tmp78 - _tmp91 * _tmp97) + _tmp97;
  const Scalar _tmp99 = -_tmp68 * _tmp98 + Scalar(1.0);
  ...
  _res(1, 0) = std::exp(_tmp0 * _tmp72 * (-_tmp39 * _tmp69 + _tmp60 * _tmp70) +
                        _tmp72 * _tmp88 * (-_tmp37 * _tmp79 + _tmp60 * _tmp80) +
                        _tmp86 * _tmp96 * (_tmp39 * _tmp99 + _tmp94 * _tmp98) +
                        _tmp87 * _tmp96 * (_tmp39 * _tmp95 + _tmp93 * _tmp94 + Scalar(1.0)));
  _res(2, 0) = std::exp(_tmp0 * _tmp38 * _tmp69 - _tmp100 * _tmp86 * _tmp99 -
                        _tmp100 * _tmp87 * _tmp95 + _tmp79 * _tmp88);
  _res(3, 0) = std::exp(-_tmp0 * _tmp70 - _tmp101 * _tmp86 * _tmp98 - _tmp101 * _tmp87 * _tmp93 -
                        _tmp80 * _tmp88);
