...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl20(
  ...
  const Scalar _tmp50 = -_tmp23 + _tmp27;
  ...
  const Scalar _tmp59 = _tmp43 * _tmp44;
  const Scalar _tmp60 = _tmp21 + _tmp50;
  const Scalar _tmp61 = _tmp60 + p_init1;
  const Scalar _tmp62 = _tmp61 + Scalar(8.3196563700000006);
  const Scalar _tmp63 = _tmp46 + _tmp6;
  ...
  const Scalar _tmp84 = fh1 * (_tmp18 * _tmp82 - _tmp29 * _tmp83);
  const Scalar _tmp85 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp86 = -_tmp33;
  const Scalar _tmp87 = _tmp36 + _tmp86;
  const Scalar _tmp88 = _tmp34 + _tmp35;
  const Scalar _tmp89 = _tmp86 + _tmp88;
  const Scalar _tmp90 = _tmp67 * _tmp89;
  const Scalar _tmp91 = _tmp68 * _tmp87 - _tmp70 * _tmp90;
  const Scalar _tmp92 = _tmp33 + _tmp88;
  const Scalar _tmp93 = _tmp45 * _tmp89;
  const Scalar _tmp94 = _tmp59 * _tmp92 - _tmp70 * _tmp93 - _tmp73 * _tmp91;
  const Scalar _tmp95 = Scalar(1.0) * _tmp51;
  ...
  const Scalar _tmp100 = -_tmp67 * _tmp87 + _tmp90;
  const Scalar _tmp101 = -_tmp100 * _tmp73 - _tmp45 * _tmp92 + _tmp93 - _tmp94 * _tmp99;
  ...
  const Scalar _tmp106 = _tmp70 * _tmp72;
  const Scalar _tmp107 = _tmp106 * _tmp91 + _tmp70 * _tmp89;
  ...
  const Scalar _tmp111 = _tmp110 * (_tmp106 * _tmp69 - _tmp108 * _tmp109 - _tmp58);
  const Scalar _tmp112 = _tmp108 + _tmp111;
  const Scalar _tmp113 = _tmp102 * _tmp112;
  const Scalar _tmp114 = -_tmp113 * _tmp71 - _tmp70;
  const Scalar _tmp115 = _tmp67 * _tmp72;
  const Scalar _tmp116 = _tmp83 * fh1;
  const Scalar _tmp117 = _tmp77 * _tmp91;
  const Scalar _tmp118 = -_tmp100 * _tmp77 + _tmp117 * _tmp99;
  const Scalar _tmp119 = _tmp110 * (-_tmp109 * _tmp118 - _tmp69 * _tmp77);
  const Scalar _tmp120 = _tmp102 * (_tmp118 + _tmp119);
  const Scalar _tmp121 = -_tmp120 * _tmp71 + Scalar(1.0);
  const Scalar _tmp122 = _tmp82 * fh1;
  const Scalar _tmp123 = -_tmp116 * _tmp57 * (_tmp113 * _tmp45 + _tmp114 * _tmp115 + Scalar(1.0)) -
                         _tmp122 * _tmp57 * (_tmp115 * _tmp121 + _tmp120 * _tmp45) -
                         _tmp57 * _tmp84 * (_tmp45 * _tmp76 - _tmp67 * _tmp78) -
                         _tmp57 * _tmp85 * (_tmp105 * _tmp45 - _tmp105 * _tmp67 * _tmp73);
  const Scalar _tmp124 = Scalar(1.0) / (_tmp123);
  const Scalar _tmp125 = _tmp102 * _tmp94;
  const Scalar _tmp126 = _tmp41 + _tmp96;
  const Scalar _tmp127 = _tmp126 * _tmp99;
  const Scalar _tmp128 = Scalar(1.0) / (-_tmp127 - _tmp38 + _tmp98);
  const Scalar _tmp129 = _tmp126 * _tmp128;
  const Scalar _tmp130 = _tmp107 + _tmp111 * _tmp129 - _tmp112 * _tmp125;
  const Scalar _tmp131 = Scalar(1.0) * _tmp97;
  const Scalar _tmp132 = Scalar(1.0) * _tmp128;
  const Scalar _tmp133 = _tmp132 * _tmp99;
  const Scalar _tmp134 = _tmp97 * (_tmp127 * _tmp132 + Scalar(1.0));
  const Scalar _tmp135 = _tmp37 * fh1;
  const Scalar _tmp136 = -_tmp135 * _tmp82 - Scalar(3.29616) * _tmp26 - _tmp29 * fv1;
  const Scalar _tmp137 = Scalar(3.29616) * _tmp11 + _tmp135 * _tmp83 + _tmp18 * fv1;
  const Scalar _tmp138 = _tmp126 * _tmp97;
  const Scalar _tmp139 = -_tmp117 + _tmp119 * _tmp129 - _tmp120 * _tmp94;
  const Scalar _tmp140 = _tmp110 * _tmp132;
  const Scalar _tmp141 = _tmp126 * _tmp140 - _tmp76 * _tmp94;
  const Scalar _tmp142 = _tmp103 * _tmp128;
  const Scalar _tmp143 = -_tmp104 * _tmp125 - _tmp126 * _tmp142 + _tmp96;
  const Scalar _tmp144 = std::asinh(
      _tmp124 * (Scalar(1.0) * _tmp116 * (_tmp111 * _tmp132 - _tmp130 * _tmp131) +
                 Scalar(1.0) * _tmp122 * (_tmp119 * _tmp132 - _tmp131 * _tmp139) +
                 Scalar(1.0) * _tmp136 * (_tmp133 - Scalar(1.0) * _tmp134) +
                 Scalar(1.0) * _tmp137 * (_tmp132 * _tmp138 - _tmp132) +
                 Scalar(1.0) * _tmp84 * (-_tmp131 * _tmp141 + _tmp140) +
                 Scalar(1.0) * _tmp85 * (-_tmp103 * _tmp132 - _tmp131 * _tmp143 + Scalar(1.0))));
  const Scalar _tmp145 = Scalar(9.6622558468725703) * _tmp123;
  const Scalar _tmp146 = _tmp105 * _tmp85;
  const Scalar _tmp147 =
      _tmp114 * _tmp116 * _tmp72 + _tmp121 * _tmp122 * _tmp72 - _tmp146 * _tmp73 - _tmp78 * _tmp84;
  const Scalar _tmp148 = Scalar(1.0) / (_tmp147);
  const Scalar _tmp149 = _tmp132 * _tmp137;
  const Scalar _tmp150 = std::asinh(
      _tmp148 * (_tmp116 * _tmp130 * _tmp97 + _tmp122 * _tmp139 * _tmp97 + _tmp134 * _tmp136 -
                 _tmp138 * _tmp149 + _tmp141 * _tmp84 * _tmp97 + _tmp143 * _tmp85 * _tmp97));
  const Scalar _tmp151 = Scalar(9.6622558468725703) * _tmp147;
  const Scalar _tmp152 = _tmp113 * _tmp116 + _tmp120 * _tmp122 + _tmp146 + _tmp76 * _tmp84;
  const Scalar _tmp153 = Scalar(1.0) / (_tmp152);
  const Scalar _tmp154 =
      std::asinh(_tmp153 * (-_tmp111 * _tmp116 * _tmp128 - _tmp119 * _tmp122 * _tmp128 -
                            _tmp133 * _tmp136 - _tmp140 * _tmp84 + _tmp142 * _tmp85 + _tmp149));
                ...
                Scalar(8.3196563700000006) *
                    std::sqrt(Scalar(
                        ...
                        Scalar(0.057067943376852184) *
                            std::pow(Scalar(-Scalar(0.50315118556004401) * _tmp64 - 1),
                                     Scalar(2))))))) +
      _tmp87 + p_init2;
  _res(3, 0) =
      -_tmp155 *
