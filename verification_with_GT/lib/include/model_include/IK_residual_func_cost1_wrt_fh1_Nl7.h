...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1WrtFh1Nl7(
  ...
  const Scalar _tmp38 = _tmp18 + Scalar(-2.5202214700000001);
  const Scalar _tmp39 = _tmp29 + Scalar(8.3888750099999996);
  ...
  const Scalar _tmp75 = _tmp47 * _tmp53;
  const Scalar _tmp76 = _tmp45 * _tmp54 - _tmp50 * _tmp75 + _tmp54 * _tmp74;
  const Scalar _tmp77 = _tmp66 * _tmp72;
  const Scalar _tmp78 = Scalar(1.0) / (_tmp54 * _tmp77 - _tmp75);
  const Scalar _tmp79 = -_tmp62 + _tmp63 * _tmp77;
  const Scalar _tmp80 = _tmp78 * _tmp79;
  const Scalar _tmp81 = -_tmp55 * _tmp62 + _tmp56 * _tmp63 + _tmp63 * _tmp74 - _tmp76 * _tmp80;
  const Scalar _tmp82 = Scalar(1.0) / (_tmp81);
  const Scalar _tmp83 = Scalar(1.0) * _tmp78;
  const Scalar _tmp84 = _tmp79 * _tmp82 * _tmp83;
  const Scalar _tmp85 = Scalar(1.0) * _tmp82;
  const Scalar _tmp86 = _tmp43 * _tmp73 * (-_tmp54 * _tmp84 + _tmp63 * _tmp85);
  ...
  const Scalar _tmp96 = -_tmp54 * _tmp95 + _tmp75 * _tmp92;
  const Scalar _tmp97 = _tmp83 * _tmp96;
  const Scalar _tmp98 = Scalar(1.0) * _tmp64;
  const Scalar _tmp99 = -_tmp98;
  const Scalar _tmp100 = Scalar(1.0) / (_tmp45 + _tmp99);
  const Scalar _tmp101 = Scalar(1.0) * _tmp67;
  const Scalar _tmp102 = _tmp100 * (_tmp101 - _tmp50);
  const Scalar _tmp103 = -_tmp54 * _tmp92 + _tmp54 * _tmp94;
  const Scalar _tmp104 = _tmp102 * _tmp97 - _tmp103 * _tmp83;
  const Scalar _tmp105 = _tmp87 + _tmp91;
  const Scalar _tmp106 = _tmp105 * _tmp62 - _tmp63 * _tmp95 - _tmp80 * _tmp96;
  const Scalar _tmp107 = -_tmp102 * _tmp106 - _tmp103 * _tmp80 - _tmp105 * _tmp63 + _tmp63 * _tmp94;
  const Scalar _tmp108 = Scalar(1.0) / (_tmp107);
  const Scalar _tmp109 = _tmp108 * _tmp81;
  const Scalar _tmp110 = _tmp107 * _tmp82;
  const Scalar _tmp111 = _tmp110 * (-_tmp104 * _tmp109 - _tmp76 * _tmp83);
  const Scalar _tmp112 = _tmp104 + _tmp111;
  const Scalar _tmp113 = _tmp108 * _tmp79;
  const Scalar _tmp114 = _tmp78 * (-_tmp112 * _tmp113 + Scalar(1.0));
  const Scalar _tmp115 = _tmp108 * _tmp112;
  const Scalar _tmp116 = _tmp41 * _tmp73 * (_tmp114 * _tmp54 + _tmp115 * _tmp63);
  const Scalar _tmp117 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp118 = _tmp101 + _tmp102 * _tmp98;
  const Scalar _tmp119 = 0;
  const Scalar _tmp120 = _tmp108 * _tmp119;
  const Scalar _tmp121 = _tmp77 * _tmp78;
  const Scalar _tmp122 = _tmp121 * _tmp96 + _tmp95;
  const Scalar _tmp123 = -_tmp102 * _tmp122 + _tmp103 * _tmp121 - _tmp94;
  const Scalar _tmp124 = _tmp110 * (-_tmp109 * _tmp123 + _tmp121 * _tmp76 - _tmp74);
  const Scalar _tmp125 = _tmp123 + _tmp124;
  const Scalar _tmp126 = _tmp108 * _tmp125;
  const Scalar _tmp127 = _tmp78 * (-_tmp113 * _tmp125 - _tmp77);
  const Scalar _tmp128 = _tmp42 * _tmp73 * (_tmp126 * _tmp63 + _tmp127 * _tmp54 + Scalar(1.0));
  const Scalar _tmp129 = -_tmp116 * fh1 -
                         _tmp117 * _tmp73 * (-_tmp120 * _tmp54 * _tmp80 + _tmp120 * _tmp63) -
                         _tmp128 * fh1 - _tmp86 * fh1;
  const Scalar _tmp130 = std::pow(_tmp129, Scalar(-2));
  const Scalar _tmp131 = -_tmp116 - _tmp128 - _tmp86;
  const Scalar _tmp132 = _tmp130 * _tmp131;
  const Scalar _tmp133 = _tmp56 + _tmp99;
  ...
  const Scalar _tmp137 = _tmp106 * _tmp108;
  const Scalar _tmp138 = _tmp133 * _tmp135;
  const Scalar _tmp139 = _tmp111 * _tmp138 - _tmp112 * _tmp137 - _tmp97;
  const Scalar _tmp140 = Scalar(1.0) * _tmp100;
  const Scalar _tmp141 = Scalar(1.0) * _tmp41 * (_tmp111 * _tmp136 - _tmp139 * _tmp140);
  const Scalar _tmp142 = _tmp87 + _tmp93;
  const Scalar _tmp143 = _tmp142 * fh1;
  const Scalar _tmp144 = -_tmp143 * _tmp41 - Scalar(3.29616) * _tmp24 - _tmp28 * fv1;
  const Scalar _tmp145 = _tmp134 * _tmp136 + Scalar(1.0);
  const Scalar _tmp146 = _tmp102 * _tmp136;
  const Scalar _tmp147 = -Scalar(1.0) * _tmp140 * _tmp145 + Scalar(1.0) * _tmp146;
  const Scalar _tmp148 = Scalar(3.29616) * _tmp11 + _tmp143 * _tmp42 + _tmp17 * fv1;
  const Scalar _tmp149 = _tmp100 * _tmp133;
  const Scalar _tmp150 = _tmp136 * _tmp149;
  const Scalar _tmp151 = -Scalar(1.0) * _tmp136 + Scalar(1.0) * _tmp150;
  const Scalar _tmp152 = _tmp122 + _tmp124 * _tmp138 - _tmp125 * _tmp137;
  const Scalar _tmp153 = Scalar(1.0) * _tmp42 * (_tmp124 * _tmp136 - _tmp140 * _tmp152);
  const Scalar _tmp154 = _tmp118 * _tmp135;
  const Scalar _tmp155 = -_tmp119 * _tmp137 - _tmp133 * _tmp154 + _tmp99;
  const Scalar _tmp156 = _tmp110 * _tmp136;
  const Scalar _tmp157 = -_tmp106 * _tmp85 + _tmp133 * _tmp156;
  const Scalar _tmp158 = Scalar(1.0) * _tmp43;
  const Scalar _tmp159 = _tmp158 * (-_tmp140 * _tmp157 + _tmp156);
  const Scalar _tmp160 =
      Scalar(1.0) * _tmp117 * (-_tmp118 * _tmp136 - _tmp140 * _tmp155 + Scalar(1.0)) +
      _tmp141 * fh1 + _tmp144 * _tmp147 + _tmp148 * _tmp151 + _tmp153 * fh1 + _tmp159 * fh1;
  const Scalar _tmp161 = Scalar(1.0) / (_tmp129);
  ...
  const Scalar _tmp165 = Scalar(9.6622558468725703) * _tmp129;
  const Scalar _tmp166 = _tmp142 * _tmp42;
  const Scalar _tmp167 = _tmp142 * _tmp41;
  const Scalar _tmp168 = (-_tmp132 * _tmp160 + _tmp161 * (_tmp141 - _tmp147 * _tmp167 +
                                                          _tmp151 * _tmp166 + _tmp153 + _tmp159)) /
                         std::sqrt(Scalar(_tmp130 * std::pow(_tmp160, Scalar(2)) + 1));
  ...
  const Scalar _tmp173 = _tmp114 * _tmp41;
  const Scalar _tmp174 = _tmp127 * _tmp42;
  const Scalar _tmp175 = _tmp117 * _tmp120;
  const Scalar _tmp176 = -_tmp172 * fh1 + _tmp173 * fh1 + _tmp174 * fh1 - _tmp175 * _tmp80;
  const Scalar _tmp177 = std::pow(_tmp176, Scalar(-2));
  const Scalar _tmp178 = -_tmp172 + _tmp173 + _tmp174;
  const Scalar _tmp179 = _tmp177 * _tmp178;
  const Scalar _tmp180 = _tmp100 * _tmp145;
  const Scalar _tmp181 = _tmp100 * _tmp157 * _tmp43;
  const Scalar _tmp182 = _tmp100 * _tmp139 * _tmp41;
  const Scalar _tmp183 = _tmp100 * _tmp152 * _tmp42;
  const Scalar _tmp184 = _tmp136 * _tmp148;
  const Scalar _tmp185 = _tmp100 * _tmp117 * _tmp155 + _tmp144 * _tmp180 - _tmp149 * _tmp184 +
  ...
  const Scalar _tmp189 = (-_tmp179 * _tmp185 + _tmp186 * (-_tmp150 * _tmp166 - _tmp167 * _tmp180 +
  ...
  const Scalar _tmp195 = _tmp124 * _tmp135 * _tmp42;
  const Scalar _tmp196 = _tmp111 * _tmp135 * _tmp41;
  const Scalar _tmp197 = _tmp156 * _tmp43;
  const Scalar _tmp198 = _tmp117 * _tmp154 - _tmp144 * _tmp146 + _tmp184 - _tmp195 * fh1 -
                         _tmp196 * fh1 - _tmp197 * fh1;
  const Scalar _tmp199 = _tmp115 * _tmp41;
  const Scalar _tmp200 = _tmp158 * _tmp82;
  const Scalar _tmp201 = _tmp126 * _tmp42;
  const Scalar _tmp202 = _tmp175 + _tmp199 * fh1 + _tmp200 * fh1 + _tmp201 * fh1;
  ...
  const Scalar _tmp214 = (-_tmp198 * _tmp213 + _tmp203 * (_tmp136 * _tmp166 + _tmp146 * _tmp167 -
  ...
  _res(1, 0) =
      -Scalar(9.6622558468725703) * _tmp131 *
          (Scalar(0.87679799772039002) * _tmp161 - std::cosh(_tmp170) + std::cosh(_tmp171)) -
      _tmp165 *
          (-Scalar(0.87679799772039002) * _tmp132 + Scalar(1.0) * _tmp168 * std::sinh(_tmp171) -
           (-Scalar(0.1034955) * _tmp132 * _tmp164 +
            _tmp169 * (-_tmp131 * _tmp163 - _tmp165 * _tmp168)) *
               std::sinh(_tmp170));
  _res(2, 0) =
      -_tmp190 *
          (-Scalar(0.86625939559540499) * _tmp179 + Scalar(1.0) * _tmp189 * std::sinh(_tmp188) -
           (-Scalar(0.1034955) * _tmp179 * _tmp191 +
            _tmp193 * (-_tmp187 * _tmp192 - _tmp189 * _tmp190)) *
               std::sinh(_tmp194)) -
      _tmp192 * (Scalar(0.86625939559540499) * _tmp186 + std::cosh(_tmp188) - std::cosh(_tmp194));
  _res(3, 0) =
      -_tmp205 *
          (-Scalar(0.86565325453551001) * _tmp213 + Scalar(1.0) * _tmp214 * std::sinh(_tmp209) -
           (-Scalar(0.1034955) * _tmp206 * _tmp213 +
            _tmp207 * (-_tmp204 * _tmp211 - _tmp205 * _tmp214)) *
               std::sinh(_tmp208)) -
      _tmp211 * (Scalar(0.86565325453551001) * _tmp203 - std::cosh(_tmp208) + std::cosh(_tmp209));
