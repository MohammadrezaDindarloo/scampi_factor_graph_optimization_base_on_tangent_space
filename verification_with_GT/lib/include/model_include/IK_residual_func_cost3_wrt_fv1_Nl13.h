...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl13(
  ...
  const Scalar _tmp49 = (-_tmp30 + _tmp48) / (_tmp23 - _tmp47);
  const Scalar _tmp50 = Scalar(1.0) / (-_tmp33 + _tmp41 * _tmp44);
  const Scalar _tmp51 = Scalar(1.0) * _tmp50;
  const Scalar _tmp52 = -_tmp15 * _tmp44 + _tmp45;
  const Scalar _tmp53 = _tmp46 * _tmp49 * _tmp51 - _tmp51 * _tmp52;
  ...
  const Scalar _tmp66 = -_tmp49 * (-_tmp41 * _tmp65 - _tmp46 * _tmp63 + _tmp60 * _tmp64) -
  ...
  const Scalar _tmp80 = _tmp44 * _tmp50;
  ...
  const Scalar _tmp89 = _tmp41 * _tmp50;
  const Scalar _tmp90 = -_tmp43 - _tmp49 * (_tmp41 * _tmp43 + _tmp46 * _tmp89) + _tmp52 * _tmp89;
  ...
  const Scalar _tmp95 = _tmp47 * _tmp49 + _tmp48;
  const Scalar _tmp96 = 0;
  const Scalar _tmp97 = _tmp63 * _tmp96;
  const Scalar _tmp98 = _tmp70 * (-_tmp44 * _tmp97 + _tmp61 * _tmp96);
  const Scalar _tmp99 = Scalar(1.0) * _tmp75;
  const Scalar _tmp100 = fh1 * (-_tmp82 * _tmp93 + _tmp84 * _tmp87);
  ...
  _res(0, 0) = 0;
  _res(1, 0) =
      -_tmp98 * std::exp(_tmp100 * _tmp70 * (-_tmp44 * _tmp63 * _tmp99 + _tmp61 * _tmp99) +
                         _tmp87 * _tmp88 * (_tmp77 * _tmp81 + _tmp79 * _tmp80) +
                         _tmp88 * _tmp93 * (_tmp80 * _tmp92 + _tmp81 * _tmp91 + Scalar(1.0)) +
                         _tmp94 * _tmp98);
  _res(2, 0) = -_tmp97 * std::exp(_tmp101 * _tmp63 - _tmp102 * _tmp79 * _tmp87 -
                                  _tmp102 * _tmp92 * _tmp93 + _tmp103 * _tmp63);
  _res(3, 0) =
      _tmp96 * std::exp(-_tmp101 - _tmp103 - _tmp104 * _tmp77 * _tmp87 - _tmp104 * _tmp91 * _tmp93);
