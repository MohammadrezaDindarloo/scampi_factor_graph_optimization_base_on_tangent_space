...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1WrtFh1Nl19(
  ...
  const Scalar _tmp39 = _tmp30 + Scalar(-4.8333311099999996);
  ...
  const Scalar _tmp50 = -Scalar(3.29616) * _tmp26 - _tmp29 * fv1 - _tmp42 * _tmp49;
  const Scalar _tmp51 = _tmp12 - _tmp16;
  const Scalar _tmp52 = _tmp5 + _tmp51;
  const Scalar _tmp53 = _tmp51 + _tmp6;
  ...
  const Scalar _tmp59 = _tmp20 + _tmp55;
  const Scalar _tmp60 = _tmp58 + _tmp59;
  const Scalar _tmp61 = _tmp20 + _tmp28;
  ...
  const Scalar _tmp78 = _tmp59 + p_init1;
  ...
  const Scalar _tmp82 = _tmp63 + p_init0;
  const Scalar _tmp83 = _tmp82 + Scalar(-2.71799795);
  const Scalar _tmp84 = _tmp61 + p_init1;
  ...
  const Scalar _tmp88 = _tmp44 + _tmp74;
  const Scalar _tmp89 = _tmp56 + p_init1;
  const Scalar _tmp90 = _tmp89 + Scalar(8.3196563700000006);
  const Scalar _tmp91 = _tmp53 + p_init0;
  const Scalar _tmp92 = _tmp91 + Scalar(1.9874742000000001);
  ...
  const Scalar _tmp99 = _tmp77 * _tmp80;
  const Scalar _tmp100 = -_tmp81 + _tmp94 * _tmp99;
  const Scalar _tmp101 = Scalar(1.0) / (_tmp87 * _tmp94 - _tmp97);
  const Scalar _tmp102 = _tmp100 * _tmp101;
  const Scalar _tmp103 = _tmp88 * _tmp99;
  const Scalar _tmp104 = -_tmp102 * _tmp98 - _tmp103 * _tmp94 + _tmp75 * _tmp81;
  const Scalar _tmp105 = _tmp87 * _tmp88 - _tmp87 * _tmp96;
  const Scalar _tmp106 = -_tmp102 * _tmp105 + _tmp103 - _tmp104 * _tmp64 - _tmp75 * _tmp99;
  const Scalar _tmp107 = Scalar(1.0) / (_tmp106);
  const Scalar _tmp108 = 0;
  const Scalar _tmp109 = -_tmp104 * _tmp108 + _tmp58 - _tmp60 * _tmp73;
  ...
  const Scalar _tmp113 = -_tmp105 * _tmp111 + _tmp112 * _tmp64;
  ...
  const Scalar _tmp116 = _tmp114 * _tmp93;
  const Scalar _tmp117 = _tmp116 * (_tmp115 * _tmp53 * _tmp90 - _tmp115 * _tmp56 * _tmp92);
  const Scalar _tmp118 = _tmp101 * (_tmp117 * _tmp87 + _tmp61 * _tmp87 - _tmp63 * _tmp97);
  const Scalar _tmp119 = -_tmp100 * _tmp118 + _tmp117 * _tmp99 - _tmp52 * _tmp81 + _tmp59 * _tmp99;
  ...
  const Scalar _tmp125 = _tmp107 * (_tmp113 + _tmp123);
  const Scalar _tmp126 = -_tmp104 * _tmp125 - _tmp112 + _tmp123 * _tmp124;
  const Scalar _tmp127 = Scalar(1.0) * _tmp42 * (_tmp123 * _tmp67 - _tmp126 * _tmp70);
  const Scalar _tmp128 = _tmp101 * _tmp94;
  const Scalar _tmp129 = _tmp128 * _tmp98 + _tmp95;
  const Scalar _tmp130 = _tmp105 * _tmp128 - _tmp129 * _tmp64 - _tmp88;
  const Scalar _tmp131 = _tmp122 * (-_tmp117 + _tmp118 * _tmp94 - _tmp120 * _tmp130);
  const Scalar _tmp132 = _tmp107 * (_tmp130 + _tmp131);
  const Scalar _tmp133 = -_tmp104 * _tmp132 + _tmp124 * _tmp131 + _tmp129;
  const Scalar _tmp134 = _tmp40 * _tmp41;
  const Scalar _tmp135 = Scalar(1.0) * _tmp134 * (_tmp131 * _tmp67 - _tmp133 * _tmp70);
  const Scalar _tmp136 = _tmp122 * _tmp67;
  const Scalar _tmp137 = Scalar(1.0) * _tmp121;
  const Scalar _tmp138 = -_tmp104 * _tmp137 + _tmp136 * _tmp60;
  const Scalar _tmp139 = -_tmp134 * _tmp29 + _tmp18 * _tmp42;
  const Scalar _tmp140 = Scalar(1.0) * _tmp139 * (_tmp136 - _tmp138 * _tmp70);
  const Scalar _tmp141 = Scalar(3.29616) * _tmp11 + _tmp134 * _tmp49 + _tmp18 * fv1;
  ...
  const Scalar _tmp145 =
      Scalar(1.0) * _tmp110 * (-_tmp109 * _tmp70 - _tmp67 * _tmp72 + Scalar(1.0)) + _tmp127 * fh1 +
      _tmp135 * fh1 + _tmp140 * fh1 + _tmp141 * _tmp144 + _tmp50 * _tmp71;
  const Scalar _tmp146 = _tmp101 * (-_tmp100 * _tmp125 + Scalar(1.0));
  const Scalar _tmp147 = _tmp116 * _tmp42 * (_tmp125 * _tmp99 + _tmp146 * _tmp87);
  const Scalar _tmp148 = _tmp101 * (-_tmp100 * _tmp132 - _tmp94);
  const Scalar _tmp149 = _tmp116 * _tmp134 * (_tmp132 * _tmp99 + _tmp148 * _tmp87 + Scalar(1.0));
  const Scalar _tmp150 = _tmp100 * _tmp111 * _tmp121;
  const Scalar _tmp151 = _tmp116 * _tmp139 * (_tmp137 * _tmp99 - _tmp150 * _tmp87);
  const Scalar _tmp152 = -_tmp110 * _tmp116 * (-_tmp102 * _tmp108 * _tmp87 + _tmp108 * _tmp99) -
  ...
  const Scalar _tmp157 =
      ...
      Scalar(8.3196563700000006) *
          std::sqrt(
              Scalar(std::pow(Scalar(-Scalar(0.12019727204189803) * _tmp89 - 1), Scalar(2)) +
                     Scalar(0.057067943376852184) *
                         std::pow(Scalar(-Scalar(0.50315118556004401) * _tmp91 - 1), Scalar(2))));
  ...
  const Scalar _tmp165 = _tmp134 * _tmp48;
  const Scalar _tmp166 = (-_tmp145 * _tmp163 + _tmp153 * (_tmp127 + _tmp135 + _tmp140 +
                                                          _tmp144 * _tmp165 - _tmp164 * _tmp71)) /
                         std::sqrt(Scalar(std::pow(_tmp145, Scalar(2)) * _tmp162 + 1));
  const Scalar _tmp167 = _tmp133 * _tmp134 * _tmp62;
  const Scalar _tmp168 = _tmp126 * _tmp42 * _tmp62;
  const Scalar _tmp169 = _tmp62 * _tmp69;
  const Scalar _tmp170 = _tmp141 * _tmp67;
  const Scalar _tmp171 = _tmp138 * _tmp139 * _tmp62;
  const Scalar _tmp172 = _tmp109 * _tmp110 * _tmp62 - _tmp142 * _tmp170 + _tmp167 * fh1 +
                         _tmp168 * fh1 + _tmp169 * _tmp50 + _tmp171 * fh1;
  const Scalar _tmp173 = _tmp108 * _tmp110;
  const Scalar _tmp174 = _tmp134 * _tmp148;
  const Scalar _tmp175 = _tmp146 * _tmp42;
  const Scalar _tmp176 = _tmp139 * _tmp150;
  const Scalar _tmp177 = -_tmp102 * _tmp173 + _tmp174 * fh1 + _tmp175 * fh1 - _tmp176 * fh1;
  ...
  const Scalar _tmp182 = _tmp174 + _tmp175 - _tmp176;
  const Scalar _tmp183 = _tmp181 * _tmp182;
  const Scalar _tmp184 = (-_tmp172 * _tmp183 + _tmp178 * (-_tmp143 * _tmp165 - _tmp164 * _tmp169 +
                                                          _tmp167 + _tmp168 + _tmp171)) /
  ...
  const Scalar _tmp191 = _tmp123 * _tmp42 * _tmp66;
  const Scalar _tmp192 = _tmp131 * _tmp134 * _tmp66;
  const Scalar _tmp193 =
      _tmp110 * _tmp73 + _tmp170 - _tmp190 * fh1 - _tmp191 * fh1 - _tmp192 * fh1 - _tmp50 * _tmp68;
  const Scalar _tmp194 = _tmp125 * _tmp42;
  ...
  _res(1, 0) =
      -_tmp156 *
          (-Scalar(0.87679799772039002) * _tmp163 + Scalar(1.0) * _tmp166 * std::sinh(_tmp155) -
           (-Scalar(0.1034955) * _tmp157 * _tmp163 +
            _tmp158 * (-_tmp154 * _tmp161 - _tmp156 * _tmp166)) *
               std::sinh(_tmp159)) -
      _tmp161 * (Scalar(0.87679799772039002) * _tmp153 + std::cosh(_tmp155) - std::cosh(_tmp159));
  _res(2, 0) =
      -_tmp185 *
          (-Scalar(0.86565325453551001) * _tmp183 + Scalar(1.0) * _tmp184 * std::sinh(_tmp180) -
           (-Scalar(0.1034955) * _tmp183 * _tmp186 +
            _tmp188 * (-_tmp179 * _tmp187 - _tmp184 * _tmp185)) *
               std::sinh(_tmp189)) -
      _tmp187 * (Scalar(0.86565325453551001) * _tmp178 + std::cosh(_tmp180) - std::cosh(_tmp189));
  _res(3, 0) =
      -_tmp205 *
          (-Scalar(0.87653584775870996) * _tmp203 + Scalar(1.0) * _tmp204 * std::sinh(_tmp200) -
           (-Scalar(0.1034955) * _tmp203 * _tmp206 +
            _tmp207 * (-_tmp199 * _tmp209 - _tmp204 * _tmp205)) *
               std::sinh(_tmp208)) -
      _tmp209 * (Scalar(0.87653584775870996) * _tmp198 + std::cosh(_tmp200) - std::cosh(_tmp208));
