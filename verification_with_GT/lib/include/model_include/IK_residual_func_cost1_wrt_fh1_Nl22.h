...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1WrtFh1Nl22(
  ...
  const Scalar _tmp56 = -Scalar(0.010999999999999999) * _tmp19 -
  ...
  const Scalar _tmp60 = _tmp44 + p_init1;
  const Scalar _tmp61 = _tmp60 + Scalar(8.3196563700000006);
  const Scalar _tmp62 = _tmp47 + p_init0;
  ...
  const Scalar _tmp70 = _tmp46 + _tmp48;
  ...
  const Scalar _tmp78 = _tmp49 + p_init0;
  const Scalar _tmp79 = _tmp78 + Scalar(-2.71799795);
  const Scalar _tmp80 = Scalar(1.0) / (_tmp79);
  const Scalar _tmp81 = _tmp40 + p_init1;
  const Scalar _tmp82 = _tmp81 + Scalar(-4.7752063900000001);
  const Scalar _tmp83 = _tmp80 * _tmp82;
  const Scalar _tmp84 = _tmp72 * _tmp76;
  const Scalar _tmp85 = -_tmp77 + _tmp83 * _tmp84;
  const Scalar _tmp86 = _tmp61 * _tmp64;
  const Scalar _tmp87 = Scalar(1.0) / (_tmp65 * _tmp83 - _tmp86);
  const Scalar _tmp88 = _tmp85 * _tmp87;
  const Scalar _tmp89 = _tmp55 + _tmp66;
  const Scalar _tmp90 = _tmp59 * _tmp86 - _tmp68 * _tmp83;
  const Scalar _tmp91 = _tmp67 * _tmp83;
  const Scalar _tmp92 = _tmp77 * _tmp89 - _tmp84 * _tmp91 - _tmp88 * _tmp90;
  const Scalar _tmp93 = -_tmp51 * _tmp92 + _tmp67 * _tmp84 - _tmp69 * _tmp88 - _tmp84 * _tmp89;
  const Scalar _tmp94 = Scalar(1.0) / (_tmp93);
  const Scalar _tmp95 = _tmp92 * _tmp94;
  const Scalar _tmp96 = _tmp42 + _tmp73;
  const Scalar _tmp97 = _tmp51 * _tmp96;
  const Scalar _tmp98 = Scalar(1.0) / (_tmp50 - _tmp70 - _tmp97);
  const Scalar _tmp99 = _tmp52 * _tmp98;
  const Scalar _tmp100 = _tmp42 - _tmp53 * _tmp95 - _tmp96 * _tmp99;
  const Scalar _tmp101 = Scalar(1.0) * _tmp45;
  const Scalar _tmp102 = Scalar(1.0) * _tmp98;
  const Scalar _tmp103 = _tmp28 + Scalar(-4.8333311099999996);
  const Scalar _tmp104 = _tmp18 + Scalar(1.79662371);
  const Scalar _tmp105 =
      std::pow(Scalar(std::pow(_tmp103, Scalar(2)) + std::pow(_tmp104, Scalar(2))),
               Scalar(Scalar(-1) / Scalar(2)));
  const Scalar _tmp106 = _tmp103 * _tmp105;
  const Scalar _tmp107 = _tmp54 + _tmp58;
  const Scalar _tmp108 = _tmp107 * fh1;
  const Scalar _tmp109 = -_tmp106 * _tmp108 - Scalar(3.29616) * _tmp23 - _tmp27 * fv1;
  const Scalar _tmp110 = _tmp102 * _tmp51;
  const Scalar _tmp111 = _tmp45 * (_tmp102 * _tmp97 + Scalar(1.0));
  const Scalar _tmp112 = Scalar(1.0) * _tmp110 - Scalar(1.0) * _tmp111;
  const Scalar _tmp113 =
      std::sqrt(Scalar(std::pow(_tmp79, Scalar(2)) + std::pow(_tmp82, Scalar(2))));
  const Scalar _tmp114 = Scalar(1.0) / (_tmp113);
  const Scalar _tmp115 = _tmp113 * _tmp80;
  const Scalar _tmp116 = _tmp115 * (-_tmp114 * _tmp40 * _tmp79 + _tmp114 * _tmp49 * _tmp82);
  const Scalar _tmp117 = _tmp83 * _tmp87;
  const Scalar _tmp118 = _tmp117 * _tmp90 + _tmp91;
  const Scalar _tmp119 = _tmp117 * _tmp69 - _tmp118 * _tmp51 - _tmp67;
  const Scalar _tmp120 = _tmp116 * _tmp65 + _tmp44 * _tmp65 - _tmp47 * _tmp86;
  const Scalar _tmp121 = _tmp116 * _tmp84 - _tmp120 * _tmp88 - _tmp70 * _tmp77 + _tmp73 * _tmp84;
  const Scalar _tmp122 = _tmp121 * _tmp94;
  const Scalar _tmp123 = Scalar(1.0) / (_tmp121);
  const Scalar _tmp124 = _tmp123 * _tmp93;
  const Scalar _tmp125 = _tmp124 * (-_tmp116 + _tmp117 * _tmp120 - _tmp119 * _tmp122);
  const Scalar _tmp126 = _tmp119 + _tmp125;
  const Scalar _tmp127 = _tmp96 * _tmp98;
  const Scalar _tmp128 = _tmp118 + _tmp125 * _tmp127 - _tmp126 * _tmp95;
  const Scalar _tmp129 = _tmp104 * _tmp105;
  const Scalar _tmp130 = Scalar(1.0) * _tmp129 * (-_tmp101 * _tmp128 + _tmp102 * _tmp125);
  const Scalar _tmp131 = Scalar(1.0) * _tmp87;
  const Scalar _tmp132 = _tmp131 * _tmp90;
  const Scalar _tmp133 = -_tmp131 * _tmp69 + _tmp132 * _tmp51;
  const Scalar _tmp134 = _tmp124 * (-_tmp120 * _tmp131 - _tmp122 * _tmp133);
  const Scalar _tmp135 = _tmp133 + _tmp134;
  const Scalar _tmp136 = _tmp127 * _tmp134 - _tmp132 - _tmp135 * _tmp95;
  const Scalar _tmp137 = Scalar(1.0) * _tmp106 * (-_tmp101 * _tmp136 + _tmp102 * _tmp134);
  const Scalar _tmp138 = _tmp102 * _tmp124;
  const Scalar _tmp139 = Scalar(1.0) * _tmp123;
  const Scalar _tmp140 = _tmp45 * (_tmp138 * _tmp96 - _tmp139 * _tmp92);
  const Scalar _tmp141 = _tmp106 * _tmp17 - _tmp129 * _tmp27;
  const Scalar _tmp142 = Scalar(1.0) * _tmp141 * (_tmp138 - Scalar(1.0) * _tmp140);
  const Scalar _tmp143 = _tmp108 * _tmp129 + Scalar(3.29616) * _tmp14 + _tmp17 * fv1;
  const Scalar _tmp144 = _tmp45 * _tmp96;
  const Scalar _tmp145 = Scalar(1.0) * _tmp102 * _tmp144 - Scalar(1.0) * _tmp102;
  const Scalar _tmp146 =
      _tmp109 * _tmp112 + _tmp130 * fh1 + _tmp137 * fh1 + _tmp142 * fh1 + _tmp143 * _tmp145 +
      Scalar(1.0) * _tmp38 * (-_tmp100 * _tmp101 - _tmp102 * _tmp52 + Scalar(1.0));
  const Scalar _tmp147 = _tmp135 * _tmp94;
  const Scalar _tmp148 = _tmp85 * _tmp94;
  const Scalar _tmp149 = _tmp87 * (-_tmp135 * _tmp148 + Scalar(1.0));
  const Scalar _tmp150 = _tmp106 * _tmp115 * (_tmp147 * _tmp84 + _tmp149 * _tmp65);
  const Scalar _tmp151 = _tmp87 * (-_tmp126 * _tmp148 - _tmp83);
  const Scalar _tmp152 = _tmp126 * _tmp94;
  const Scalar _tmp153 = _tmp115 * _tmp129 * (_tmp151 * _tmp65 + _tmp152 * _tmp84 + Scalar(1.0));
  const Scalar _tmp154 = _tmp65 * _tmp88;
  const Scalar _tmp155 = _tmp115 * _tmp141 * (-_tmp139 * _tmp154 + _tmp139 * _tmp84);
  const Scalar _tmp156 = _tmp53 * _tmp94;
  const Scalar _tmp157 = -_tmp115 * _tmp38 * (-_tmp154 * _tmp156 + _tmp156 * _tmp84) -
  ...
  const Scalar _tmp165 = -_tmp150 - _tmp153 - _tmp155;
  ...
  const Scalar _tmp170 = _tmp107 * _tmp129;
  const Scalar _tmp171 = (-_tmp146 * _tmp168 + _tmp158 * (-_tmp112 * _tmp169 + _tmp130 + _tmp137 +
                                                          _tmp142 + _tmp145 * _tmp170)) /
                         std::sqrt(Scalar(std::pow(_tmp146, Scalar(2)) * _tmp167 + 1));
  const Scalar _tmp172 = _tmp139 * _tmp141;
  const Scalar _tmp173 = _tmp172 * fh1;
  const Scalar _tmp174 = _tmp129 * _tmp151;
  const Scalar _tmp175 = _tmp156 * _tmp38;
  const Scalar _tmp176 = _tmp106 * _tmp149;
  const Scalar _tmp177 = -_tmp173 * _tmp88 + _tmp174 * fh1 - _tmp175 * _tmp88 + _tmp176 * fh1;
  const Scalar _tmp178 = std::pow(_tmp177, Scalar(-2));
  const Scalar _tmp179 = -_tmp172 * _tmp88 + _tmp174 + _tmp176;
  const Scalar _tmp180 = _tmp178 * _tmp179;
  const Scalar _tmp181 = Scalar(1.0) / (_tmp177);
  const Scalar _tmp182 = _tmp129 * _tmp45;
  const Scalar _tmp183 = _tmp128 * _tmp182;
  const Scalar _tmp184 = _tmp102 * _tmp143;
  const Scalar _tmp185 = _tmp106 * _tmp136 * _tmp45;
  const Scalar _tmp186 = _tmp140 * _tmp141;
  const Scalar _tmp187 = _tmp100 * _tmp38 * _tmp45 + _tmp109 * _tmp111 - _tmp144 * _tmp184 +
  ...
  const Scalar _tmp190 =
      (-_tmp180 * _tmp187 + _tmp181 * (-_tmp102 * _tmp107 * _tmp182 * _tmp96 - _tmp111 * _tmp169 +
  ...
  const Scalar _tmp193 = Scalar(0.1034955) * _tmp181;
  const Scalar _tmp194 = _tmp192 * _tmp193;
  const Scalar _tmp195 = Scalar(9.6622558468725703) * _tmp179;
  const Scalar _tmp196 = _tmp106 * _tmp134 * _tmp98;
  const Scalar _tmp197 = _tmp138 * _tmp141;
  const Scalar _tmp198 = _tmp125 * _tmp129 * _tmp98;
  const Scalar _tmp199 = -_tmp109 * _tmp110 + _tmp184 - _tmp196 * fh1 - _tmp197 * fh1 -
                         _tmp198 * fh1 + _tmp38 * _tmp99;
  const Scalar _tmp200 = _tmp106 * _tmp147;
  const Scalar _tmp201 = _tmp129 * _tmp152;
  ...
  const Scalar _tmp214 = (-_tmp199 * _tmp213 + _tmp203 * (_tmp102 * _tmp170 + _tmp110 * _tmp169 -
  ...
  _res(1, 0) =
      -_tmp161 *
          (-Scalar(0.86565325453551001) * _tmp168 + Scalar(1.0) * _tmp171 * std::sinh(_tmp160) -
           (-Scalar(0.1034955) * _tmp162 * _tmp168 +
            _tmp163 * (-_tmp159 * _tmp166 - _tmp161 * _tmp171)) *
               std::sinh(_tmp164)) -
      _tmp166 * (Scalar(0.86565325453551001) * _tmp158 + std::cosh(_tmp160) - std::cosh(_tmp164));
  _res(2, 0) =
      -_tmp191 *
          (-Scalar(0.87679799772039002) * _tmp180 + Scalar(1.0) * _tmp190 * std::sinh(_tmp189) -
           (-Scalar(0.1034955) * _tmp180 * _tmp192 +
            _tmp193 * (-_tmp188 * _tmp195 - _tmp190 * _tmp191)) *
               std::sinh(_tmp194)) -
      _tmp195 * (Scalar(0.87679799772039002) * _tmp181 + std::cosh(_tmp189) - std::cosh(_tmp194));
  _res(3, 0) =
      -_tmp205 *
          (-Scalar(0.87653584775870996) * _tmp213 + Scalar(1.0) * _tmp214 * std::sinh(_tmp209) -
           (-Scalar(0.1034955) * _tmp206 * _tmp213 +
            _tmp207 * (-_tmp204 * _tmp211 - _tmp205 * _tmp214)) *
               std::sinh(_tmp208)) -
      _tmp211 * (Scalar(0.87653584775870996) * _tmp203 - std::cosh(_tmp208) + std::cosh(_tmp209));
