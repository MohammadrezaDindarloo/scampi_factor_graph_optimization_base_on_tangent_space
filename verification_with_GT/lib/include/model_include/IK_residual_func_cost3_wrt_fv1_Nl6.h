...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl6(
  ...
  const Scalar _tmp70 = _tmp65 + _tmp66 + _tmp67;
  const Scalar _tmp71 = _tmp36 * _tmp69 - _tmp36 * _tmp70;
  const Scalar _tmp72 = Scalar(1.0) * _tmp52;
  const Scalar _tmp73 = _tmp49 * _tmp69;
  const Scalar _tmp74 = _tmp35 * _tmp70 - _tmp36 * _tmp73;
  ...
  const Scalar _tmp78 = -_tmp71 * _tmp72 + _tmp72 * _tmp74 * _tmp77;
  const Scalar _tmp79 = _tmp65 + _tmp68;
  const Scalar _tmp80 = _tmp28 * _tmp69 - _tmp28 * _tmp79 - _tmp53 * _tmp71 -
                        _tmp77 * (-_tmp28 * _tmp73 + _tmp50 * _tmp79 - _tmp53 * _tmp74);
  const Scalar _tmp81 = Scalar(1.0) / (_tmp80);
  const Scalar _tmp82 = _tmp54 * _tmp81;
  const Scalar _tmp83 = _tmp55 * _tmp80;
  const Scalar _tmp84 = _tmp78 + _tmp83 * (-_tmp48 * _tmp72 - _tmp78 * _tmp82);
  const Scalar _tmp85 = _tmp28 * _tmp81;
  const Scalar _tmp86 = _tmp51 * _tmp81;
  const Scalar _tmp87 = -_tmp84 * _tmp86 + Scalar(1.0);
  const Scalar _tmp88 = _tmp36 * _tmp52;
  const Scalar _tmp89 = _tmp62 * fh1;
  const Scalar _tmp90 = _tmp49 * _tmp52;
  const Scalar _tmp91 = -_tmp69 + _tmp71 * _tmp90 - _tmp77 * (_tmp73 + _tmp74 * _tmp90);
  const Scalar _tmp92 = _tmp83 * (-_tmp47 + _tmp48 * _tmp90 - _tmp82 * _tmp91) + _tmp91;
  const Scalar _tmp93 = -_tmp49 - _tmp86 * _tmp92;
  const Scalar _tmp94 = _tmp63 * fh1;
  const Scalar _tmp95 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp96 = _tmp75 * _tmp77 + _tmp76;
  const Scalar _tmp97 = 0;
  const Scalar _tmp98 = _tmp53 * _tmp97;
  const Scalar _tmp99 = _tmp46 * (_tmp28 * _tmp97 - _tmp36 * _tmp98);
  ...
  _res(0, 0) = 0;
  _res(1, 0) =
      -_tmp99 * std::exp(_tmp46 * _tmp64 * (_tmp28 * _tmp56 - _tmp36 * _tmp53 * _tmp56) +
                         _tmp46 * _tmp89 * (_tmp84 * _tmp85 + _tmp87 * _tmp88) +
                         _tmp46 * _tmp94 * (_tmp85 * _tmp92 + _tmp88 * _tmp93 + Scalar(1.0)) +
                         _tmp95 * _tmp99);
  _res(2, 0) = -_tmp98 * std::exp(_tmp100 * _tmp53 + _tmp101 * _tmp53 - _tmp52 * _tmp87 * _tmp89 -
                                  _tmp52 * _tmp93 * _tmp94);
  _res(3, 0) =
      _tmp97 * std::exp(-_tmp100 - _tmp101 - _tmp81 * _tmp84 * _tmp89 - _tmp81 * _tmp92 * _tmp94);
