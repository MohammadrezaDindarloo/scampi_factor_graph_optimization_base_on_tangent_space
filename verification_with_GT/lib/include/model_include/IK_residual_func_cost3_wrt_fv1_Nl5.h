...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl5(
  ...
  const Scalar _tmp58 = _tmp19 + _tmp29;
  const Scalar _tmp59 = _tmp58 + p_init1 + Scalar(8.3196563700000006);
  const Scalar _tmp60 = _tmp57 + p_init0 + Scalar(1.9874742000000001);
  ...
  const Scalar _tmp65 = Scalar(0.20999999999999999) * _tmp6 - Scalar(0.20999999999999999) * _tmp8;
  const Scalar _tmp66 =
  ...
  const Scalar _tmp71 = -_tmp46 * _tmp69 + _tmp46 * _tmp70;
  const Scalar _tmp72 = _tmp50 * _tmp52;
  const Scalar _tmp73 = _tmp50 * _tmp70;
  const Scalar _tmp74 = -_tmp46 * _tmp73 + _tmp47 * _tmp69;
  const Scalar _tmp75 = Scalar(1.0) * _tmp30;
  const Scalar _tmp76 = Scalar(1.0) * _tmp34;
  const Scalar _tmp77 = (-_tmp41 + _tmp76) / (_tmp43 - _tmp75);
  const Scalar _tmp78 = -_tmp70 + _tmp71 * _tmp72 - _tmp77 * (_tmp72 * _tmp74 + _tmp73);
  const Scalar _tmp79 = _tmp65 + _tmp66 - _tmp67;
  const Scalar _tmp80 = _tmp28 * _tmp70 - _tmp28 * _tmp79 - _tmp53 * _tmp71 -
                        _tmp77 * (-_tmp28 * _tmp73 + _tmp49 * _tmp79 - _tmp53 * _tmp74);
  const Scalar _tmp81 = Scalar(1.0) / (_tmp80);
  const Scalar _tmp82 = _tmp54 * _tmp81;
  const Scalar _tmp83 = _tmp55 * _tmp80;
  const Scalar _tmp84 = _tmp78 + _tmp83 * (-_tmp40 + _tmp48 * _tmp72 - _tmp78 * _tmp82);
  const Scalar _tmp85 = _tmp28 * _tmp81;
  const Scalar _tmp86 = _tmp51 * _tmp81;
  const Scalar _tmp87 = -_tmp50 - _tmp84 * _tmp86;
  const Scalar _tmp88 = _tmp46 * _tmp52;
  const Scalar _tmp89 = _tmp63 * fh1;
  const Scalar _tmp90 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp91 = _tmp75 * _tmp77 + _tmp76;
  const Scalar _tmp92 = 0;
  const Scalar _tmp93 = _tmp53 * _tmp92;
  const Scalar _tmp94 = _tmp39 * (_tmp28 * _tmp92 - _tmp46 * _tmp93);
  const Scalar _tmp95 = Scalar(1.0) * _tmp52;
  const Scalar _tmp96 = -_tmp71 * _tmp95 + _tmp74 * _tmp77 * _tmp95;
  const Scalar _tmp97 = _tmp83 * (-_tmp48 * _tmp95 - _tmp82 * _tmp96) + _tmp96;
  const Scalar _tmp98 = -_tmp86 * _tmp97 + Scalar(1.0);
  const Scalar _tmp99 = _tmp62 * fh1;
  ...
  _res(0, 0) = 0;
  _res(1, 0) =
      -_tmp94 * std::exp(_tmp39 * _tmp64 * (_tmp28 * _tmp56 - _tmp46 * _tmp53 * _tmp56) +
                         _tmp39 * _tmp89 * (_tmp84 * _tmp85 + _tmp87 * _tmp88 + Scalar(1.0)) +
                         _tmp39 * _tmp99 * (_tmp85 * _tmp97 + _tmp88 * _tmp98) + _tmp90 * _tmp94);
  _res(2, 0) = -_tmp93 * std::exp(_tmp100 * _tmp53 + _tmp101 * _tmp53 - _tmp52 * _tmp87 * _tmp89 -
                                  _tmp52 * _tmp98 * _tmp99);
  _res(3, 0) =
      _tmp92 * std::exp(-_tmp100 - _tmp101 - _tmp81 * _tmp84 * _tmp89 - _tmp81 * _tmp97 * _tmp99);
