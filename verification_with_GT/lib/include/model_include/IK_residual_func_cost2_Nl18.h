...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2Nl18(
  ...
  const Scalar _tmp47 = Scalar(3.9500536956656402) *
  ...
  const Scalar _tmp48 = _tmp46 + Scalar(8.3196563700000006);
  const Scalar _tmp49 = _tmp43 + Scalar(1.9874742000000001);
  ...
  const Scalar _tmp73 = -_tmp51 * _tmp72 + _tmp62 * _tmp70;
  const Scalar _tmp74 = Scalar(1.0) / (_tmp51 * _tmp71 - _tmp70);
  const Scalar _tmp75 = _tmp58 * _tmp59;
  const Scalar _tmp76 = _tmp51 * _tmp60 - _tmp75;
  const Scalar _tmp77 = _tmp74 * _tmp76;
  const Scalar _tmp78 = _tmp33 + _tmp37;
  const Scalar _tmp79 = -_tmp51 * _tmp61 - _tmp73 * _tmp77 + _tmp75 * _tmp78;
  const Scalar _tmp80 =
      std::sqrt(Scalar(std::pow(_tmp48, Scalar(2)) + std::pow(_tmp49, Scalar(2))));
  const Scalar _tmp81 = Scalar(1.0) / (_tmp80);
  const Scalar _tmp82 = _tmp50 * _tmp80;
  const Scalar _tmp83 = _tmp82 * (_tmp42 * _tmp48 * _tmp81 - _tmp45 * _tmp49 * _tmp81);
  const Scalar _tmp84 = -_tmp63 * _tmp70 + _tmp66 * _tmp71 + _tmp71 * _tmp83;
  const Scalar _tmp85 = -_tmp52 * _tmp75 + _tmp56 * _tmp60 + _tmp60 * _tmp83 - _tmp77 * _tmp84;
  ...
  const Scalar _tmp92 = Scalar(1.0) / (_tmp66 + _tmp89);
  const Scalar _tmp93 = _tmp92 * (-_tmp63 + _tmp91);
  const Scalar _tmp94 = _tmp90 * _tmp93;
  const Scalar _tmp95 = Scalar(1.0) / (-_tmp52 + _tmp91 - _tmp94);
  const Scalar _tmp96 = Scalar(1.0) * _tmp95;
  const Scalar _tmp97 = -_tmp62 * _tmp71 + _tmp72;
  const Scalar _tmp98 = -_tmp60 * _tmp78 + _tmp61 - _tmp77 * _tmp97 - _tmp79 * _tmp93;
  const Scalar _tmp99 = _tmp86 * _tmp98;
  const Scalar _tmp100 = _tmp96 * _tmp99;
  const Scalar _tmp101 = _tmp100 * _tmp90 - _tmp79 * _tmp87;
  const Scalar _tmp102 = Scalar(1.0) * _tmp92;
  const Scalar _tmp103 = _tmp29 + Scalar(-4.8333311099999996);
  const Scalar _tmp104 = _tmp19 + Scalar(1.79662371);
  ...
  const Scalar _tmp109 = _tmp38 * fh1;
  const Scalar _tmp110 = -_tmp106 * _tmp109 - Scalar(3.29616) * _tmp24 - _tmp28 * fv1;
  const Scalar _tmp111 = _tmp94 * _tmp96 + Scalar(1.0);
  const Scalar _tmp112 = _tmp93 * _tmp96;
  const Scalar _tmp113 = _tmp51 * _tmp74;
  const Scalar _tmp114 = _tmp113 * _tmp73 + _tmp40 * _tmp51;
  const Scalar _tmp115 = _tmp113 * _tmp97 - _tmp114 * _tmp93 - _tmp40;
  const Scalar _tmp116 = Scalar(1.0) / (_tmp98);
  const Scalar _tmp117 = _tmp116 * _tmp85;
  const Scalar _tmp118 = _tmp99 * (_tmp113 * _tmp84 - _tmp115 * _tmp117 - _tmp83);
  const Scalar _tmp119 = _tmp116 * (_tmp115 + _tmp118);
  const Scalar _tmp120 = _tmp90 * _tmp95;
  const Scalar _tmp121 = _tmp114 + _tmp118 * _tmp120 - _tmp119 * _tmp79;
  const Scalar _tmp122 = _tmp107 * fh1;
  const Scalar _tmp123 = _tmp90 * _tmp92;
  const Scalar _tmp124 = _tmp107 * _tmp109 + Scalar(3.29616) * _tmp12 + _tmp18 * fv1;
  const Scalar _tmp125 = Scalar(1.0) * _tmp74;
  const Scalar _tmp126 = _tmp125 * _tmp73;
  const Scalar _tmp127 = -_tmp125 * _tmp97 + _tmp126 * _tmp93;
  const Scalar _tmp128 = _tmp99 * (-_tmp117 * _tmp127 - _tmp125 * _tmp84);
  const Scalar _tmp129 = _tmp116 * (_tmp127 + _tmp128);
  const Scalar _tmp130 = _tmp120 * _tmp128 - _tmp126 - _tmp129 * _tmp79;
  const Scalar _tmp131 = _tmp106 * fh1;
  const Scalar _tmp132 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp133 = _tmp88 * _tmp93 + _tmp91;
  const Scalar _tmp134 = 0;
  const Scalar _tmp135 = _tmp133 * _tmp95;
  const Scalar _tmp136 = _tmp92 * (-_tmp134 * _tmp79 - _tmp135 * _tmp90 + _tmp89);
  const Scalar _tmp137 = _tmp71 * _tmp77;
  const Scalar _tmp138 = -_tmp119 * _tmp76 - _tmp51;
  const Scalar _tmp139 = _tmp71 * _tmp74;
  const Scalar _tmp140 = -_tmp129 * _tmp76 + Scalar(1.0);
  const Scalar _tmp141 = -_tmp108 * _tmp82 * (-_tmp137 * _tmp87 + _tmp60 * _tmp87) -
                         _tmp122 * _tmp82 * (_tmp119 * _tmp60 + _tmp138 * _tmp139 + Scalar(1.0)) -
                         _tmp131 * _tmp82 * (_tmp129 * _tmp60 + _tmp139 * _tmp140) -
                         _tmp132 * _tmp82 * (-_tmp134 * _tmp137 + _tmp134 * _tmp60);
  const Scalar _tmp142 = Scalar(1.0) / (_tmp141);
  const Scalar _tmp143 =
      std::asinh(_tmp142 * (Scalar(1.0) * _tmp108 * (_tmp100 - _tmp101 * _tmp102) +
                            Scalar(1.0) * _tmp110 * (-_tmp102 * _tmp111 + _tmp112) +
                            Scalar(1.0) * _tmp122 * (-_tmp102 * _tmp121 + _tmp118 * _tmp96) +
                            Scalar(1.0) * _tmp124 * (_tmp123 * _tmp96 - _tmp96) +
                            Scalar(1.0) * _tmp131 * (-_tmp102 * _tmp130 + _tmp128 * _tmp96) +
                            Scalar(1.0) * _tmp132 *
                                (-_tmp133 * _tmp96 - Scalar(1.0) * _tmp136 + Scalar(1.0))));
  ...
  const Scalar _tmp146 = _tmp108 * _tmp87;
  const Scalar _tmp147 = _tmp132 * _tmp134;
  const Scalar _tmp148 =
      _tmp122 * _tmp138 * _tmp74 + _tmp131 * _tmp140 * _tmp74 - _tmp146 * _tmp77 - _tmp147 * _tmp77;
  const Scalar _tmp149 = Scalar(1.0) / (_tmp148);
  const Scalar _tmp150 = _tmp124 * _tmp96;
  const Scalar _tmp151 =
      std::asinh(_tmp149 * (_tmp101 * _tmp108 * _tmp92 + _tmp110 * _tmp111 * _tmp92 +
                            _tmp121 * _tmp122 * _tmp92 - _tmp123 * _tmp150 +
                            _tmp130 * _tmp131 * _tmp92 + _tmp132 * _tmp136));
  const Scalar _tmp152 = Scalar(9.6622558468725703) * _tmp148;
  const Scalar _tmp153 = _tmp119 * _tmp122 + _tmp129 * _tmp131 + _tmp146 + _tmp147;
  const Scalar _tmp154 = Scalar(1.0) / (_tmp153);
  const Scalar _tmp155 =
      std::asinh(_tmp154 * (-_tmp100 * _tmp108 - _tmp110 * _tmp112 - _tmp118 * _tmp122 * _tmp95 -
                            _tmp128 * _tmp131 * _tmp95 + _tmp132 * _tmp135 + _tmp150));
  ...
  _res(1, 0) =
      _tmp144 *
          (-std::sinh(Scalar(1.0) * _tmp143) -
           std::sinh(Scalar(0.1034955) * _tmp142 * (-_tmp143 * _tmp144 - std::sqrt(_tmp47)))) -
      Scalar(8.4718465799999993) *
          std::sqrt(Scalar(Scalar(0.013932974275675287) * _tmp47 +
  ...
  _res(2, 0) =
      _tmp152 *
          (-std::sinh(Scalar(1.0) * _tmp151) -
           std::sinh(Scalar(0.1034955) * _tmp149 * (-std::sqrt(_tmp145) - _tmp151 * _tmp152))) -
  ...
  _res(3, 0) =
      ...
      Scalar(8.36416322) *
          std::sqrt(Scalar(Scalar(0.014294040284261563) * _tmp156 +
                           std::pow(Scalar(-Scalar(0.1195576860108189) * _tmp78 -
