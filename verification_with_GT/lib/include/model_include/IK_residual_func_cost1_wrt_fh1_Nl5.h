...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1WrtFh1Nl5(
  ...
  const Scalar _tmp19 = _tmp13 * _tmp5;
  ...
  const Scalar _tmp27 = _tmp17 * _tmp5;
  ...
  const Scalar _tmp52 = _tmp40 + _tmp9;
  ...
  const Scalar _tmp57 = Scalar(0.20999999999999999) * _tmp12 - Scalar(0.20999999999999999) * _tmp14;
  const Scalar _tmp58 =
  ...
  const Scalar _tmp68 = -_tmp57;
  const Scalar _tmp69 = _tmp60 + _tmp68;
  const Scalar _tmp70 = -_tmp61 * _tmp67 + _tmp67 * _tmp69;
  const Scalar _tmp71 = _tmp65 * _tmp66;
  const Scalar _tmp72 = _tmp44 + p_init1;
  const Scalar _tmp73 = _tmp72 + Scalar(-4.8333311099999996);
  const Scalar _tmp74 = _tmp41 + p_init0;
  const Scalar _tmp75 = _tmp74 + Scalar(1.79662371);
  const Scalar _tmp76 = Scalar(1.0) / (_tmp75);
  const Scalar _tmp77 = _tmp73 * _tmp76;
  const Scalar _tmp78 = Scalar(1.0) / (_tmp67 * _tmp77 - _tmp71);
  const Scalar _tmp79 = _tmp77 * _tmp78;
  const Scalar _tmp80 = _tmp69 * _tmp77;
  const Scalar _tmp81 = _tmp78 * (_tmp61 * _tmp71 - _tmp67 * _tmp80);
  const Scalar _tmp82 = _tmp77 * _tmp81 + _tmp80;
  const Scalar _tmp83 = -_tmp53 * _tmp82 - _tmp69 + _tmp70 * _tmp79;
  const Scalar _tmp84 = _tmp43 + p_init0;
  ...
  const Scalar _tmp93 = _tmp58 - _tmp59;
  const Scalar _tmp94 = _tmp57 + _tmp93;
  const Scalar _tmp95 = -_tmp80 * _tmp90 - _tmp81 * _tmp91 + _tmp89 * _tmp94;
  const Scalar _tmp96 = -_tmp53 * _tmp95 + _tmp69 * _tmp90 - _tmp70 * _tmp92 - _tmp90 * _tmp94;
  ...
  const Scalar _tmp101 = _tmp100 * (_tmp41 * _tmp73 * _tmp99 - _tmp44 * _tmp75 * _tmp99);
  const Scalar _tmp102 = _tmp101 * _tmp67 + _tmp50 * _tmp67 - _tmp52 * _tmp71;
  const Scalar _tmp103 = _tmp101 * _tmp90 - _tmp102 * _tmp92 - _tmp43 * _tmp89 + _tmp48 * _tmp90;
  ...
  const Scalar _tmp108 = _tmp49 * _tmp55;
  const Scalar _tmp109 = _tmp97 * (_tmp107 + _tmp83);
  const Scalar _tmp110 = _tmp107 * _tmp108 - _tmp109 * _tmp95 + _tmp82;
  const Scalar _tmp111 = Scalar(1.0) * _tmp51;
  const Scalar _tmp112 = _tmp34 + Scalar(8.3196563700000006);
  const Scalar _tmp113 = _tmp23 + Scalar(1.9874742000000001);
  const Scalar _tmp114 =
      std::pow(Scalar(std::pow(_tmp112, Scalar(2)) + std::pow(_tmp113, Scalar(2))),
               Scalar(Scalar(-1) / Scalar(2)));
  const Scalar _tmp115 = _tmp113 * _tmp114;
  const Scalar _tmp116 = Scalar(1.0) * _tmp115 * (_tmp107 * _tmp56 - _tmp110 * _tmp111);
  const Scalar _tmp117 = Scalar(1.0) * _tmp78;
  const Scalar _tmp118 = Scalar(1.0) * _tmp81;
  const Scalar _tmp119 = -_tmp117 * _tmp70 + _tmp118 * _tmp53;
  const Scalar _tmp120 = _tmp106 * (-_tmp102 * _tmp117 - _tmp104 * _tmp119);
  const Scalar _tmp121 = _tmp97 * (_tmp119 + _tmp120);
  const Scalar _tmp122 = _tmp108 * _tmp120 - _tmp118 - _tmp121 * _tmp95;
  const Scalar _tmp123 = _tmp112 * _tmp114;
  const Scalar _tmp124 = Scalar(1.0) * _tmp123 * (-_tmp111 * _tmp122 + _tmp120 * _tmp56);
  const Scalar _tmp125 = _tmp68 + _tmp93;
  const Scalar _tmp126 = _tmp125 * fh1;
  const Scalar _tmp127 = _tmp115 * _tmp126 + Scalar(3.29616) * _tmp15 + _tmp22 * fv1;
  const Scalar _tmp128 = _tmp49 * _tmp51;
  const Scalar _tmp129 = Scalar(1.0) * _tmp128 * _tmp56 - Scalar(1.0) * _tmp56;
  const Scalar _tmp130 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp131 = _tmp42 + _tmp45 * _tmp53;
  const Scalar _tmp132 = _tmp131 * _tmp55;
  const Scalar _tmp133 = 0;
  const Scalar _tmp134 = -_tmp132 * _tmp49 - _tmp133 * _tmp95 + _tmp46;
  const Scalar _tmp135 = -_tmp115 * _tmp33 + _tmp123 * _tmp22;
  const Scalar _tmp136 = _tmp106 * _tmp56;
  const Scalar _tmp137 = Scalar(1.0) * _tmp105;
  const Scalar _tmp138 = _tmp136 * _tmp49 - _tmp137 * _tmp95;
  const Scalar _tmp139 = Scalar(1.0) * _tmp135 * (-_tmp111 * _tmp138 + _tmp136);
  const Scalar _tmp140 = -_tmp123 * _tmp126 - Scalar(3.29616) * _tmp29 - _tmp33 * fv1;
  const Scalar _tmp141 = _tmp54 * _tmp56 + Scalar(1.0);
  const Scalar _tmp142 = _tmp53 * _tmp56;
  const Scalar _tmp143 = -Scalar(1.0) * _tmp111 * _tmp141 + Scalar(1.0) * _tmp142;
  const Scalar _tmp144 =
      _tmp116 * fh1 + _tmp124 * fh1 + _tmp127 * _tmp129 +
      Scalar(1.0) * _tmp130 * (-_tmp111 * _tmp134 - _tmp131 * _tmp56 + Scalar(1.0)) +
      _tmp139 * fh1 + _tmp140 * _tmp143;
  const Scalar _tmp145 = _tmp67 * _tmp92;
  const Scalar _tmp146 = _tmp100 * _tmp135 * (-_tmp137 * _tmp145 + _tmp137 * _tmp90);
  const Scalar _tmp147 = _tmp78 * (-_tmp109 * _tmp91 - _tmp77);
  const Scalar _tmp148 = _tmp100 * _tmp115 * (_tmp109 * _tmp90 + _tmp147 * _tmp67 + Scalar(1.0));
  const Scalar _tmp149 = _tmp78 * (-_tmp121 * _tmp91 + Scalar(1.0));
  const Scalar _tmp150 = _tmp100 * _tmp123 * (_tmp121 * _tmp90 + _tmp149 * _tmp67);
  const Scalar _tmp151 = -_tmp100 * _tmp130 * (-_tmp133 * _tmp145 + _tmp133 * _tmp90) -
                         _tmp146 * fh1 - _tmp148 * fh1 - _tmp150 * fh1;
  ...
  const Scalar _tmp159 = -_tmp146 - _tmp148 - _tmp150;
  ...
  const Scalar _tmp163 = _tmp123 * _tmp125;
  const Scalar _tmp164 = _tmp115 * _tmp125;
  const Scalar _tmp165 = (-_tmp144 * _tmp162 + _tmp152 * (_tmp116 + _tmp124 + _tmp129 * _tmp164 +
                                                          _tmp139 - _tmp143 * _tmp163)) /
                         std::sqrt(Scalar(std::pow(_tmp144, Scalar(2)) * _tmp161 + 1));
  const Scalar _tmp166 = _tmp123 * _tmp149;
  const Scalar _tmp167 = _tmp115 * _tmp147;
  const Scalar _tmp168 = _tmp130 * _tmp133;
  const Scalar _tmp169 = _tmp135 * _tmp137;
  const Scalar _tmp170 = _tmp169 * fh1;
  const Scalar _tmp171 = _tmp166 * fh1 + _tmp167 * fh1 - _tmp168 * _tmp92 - _tmp170 * _tmp92;
  const Scalar _tmp172 = Scalar(1.0) / (_tmp171);
  const Scalar _tmp173 = _tmp115 * _tmp51;
  const Scalar _tmp174 = _tmp110 * _tmp173;
  const Scalar _tmp175 = _tmp141 * _tmp51;
  const Scalar _tmp176 = _tmp135 * _tmp138 * _tmp51;
  const Scalar _tmp177 = _tmp122 * _tmp123 * _tmp51;
  const Scalar _tmp178 = _tmp127 * _tmp56;
  const Scalar _tmp179 = -_tmp128 * _tmp178 + _tmp130 * _tmp134 * _tmp51 + _tmp140 * _tmp175 +
  ...
  const Scalar _tmp184 = _tmp166 + _tmp167 - _tmp169 * _tmp92;
  const Scalar _tmp185 = _tmp183 * _tmp184;
  const Scalar _tmp186 = (_tmp172 * (-_tmp125 * _tmp173 * _tmp49 * _tmp56 - _tmp163 * _tmp175 +
  ...
  const Scalar _tmp188 = Scalar(0.1034955) * _tmp172;
  const Scalar _tmp189 = _tmp182 * _tmp188;
  const Scalar _tmp190 = Scalar(1.0) * _tmp180;
  const Scalar _tmp191 = _tmp121 * _tmp123;
  ...
  const Scalar _tmp195 = _tmp107 * _tmp115 * _tmp55;
  const Scalar _tmp196 = _tmp120 * _tmp123 * _tmp55;
  const Scalar _tmp197 = _tmp135 * _tmp136;
  const Scalar _tmp198 = _tmp130 * _tmp132 - _tmp140 * _tmp142 + _tmp178 - _tmp195 * fh1 -
  ...
  const Scalar _tmp209 =
      (_tmp194 * (_tmp142 * _tmp163 + _tmp164 * _tmp56 - _tmp195 - _tmp196 - _tmp197) -
       _tmp198 * _tmp208) /
  ...
  _res(1, 0) =
      -_tmp155 *
          (-Scalar(0.86625939559540499) * _tmp162 + Scalar(1.0) * _tmp165 * std::sinh(_tmp154) -
           (-Scalar(0.1034955) * _tmp156 * _tmp162 +
            _tmp157 * (-_tmp153 * _tmp160 - _tmp155 * _tmp165)) *
               std::sinh(_tmp158)) -
      _tmp160 * (Scalar(0.86625939559540499) * _tmp152 + std::cosh(_tmp154) - std::cosh(_tmp158));
  _res(2, 0) =
      -_tmp181 *
          (-Scalar(0.86565325453551001) * _tmp185 + Scalar(1.0) * _tmp186 * std::sinh(_tmp190) -
           (-Scalar(0.1034955) * _tmp182 * _tmp185 +
            _tmp188 * (-_tmp180 * _tmp187 - _tmp181 * _tmp186)) *
               std::sinh(_tmp189)) -
      _tmp187 * (Scalar(0.86565325453551001) * _tmp172 - std::cosh(_tmp189) + std::cosh(_tmp190));
  _res(3, 0) =
      -_tmp200 *
          (-Scalar(0.87653584775870996) * _tmp208 + Scalar(1.0) * _tmp209 * std::sinh(_tmp204) -
           (-Scalar(0.1034955) * _tmp201 * _tmp208 +
            _tmp202 * (-_tmp199 * _tmp206 - _tmp200 * _tmp209)) *
               std::sinh(_tmp203)) -
      _tmp206 * (Scalar(0.87653584775870996) * _tmp194 - std::cosh(_tmp203) + std::cosh(_tmp204));
