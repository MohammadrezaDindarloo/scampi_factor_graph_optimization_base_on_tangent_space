...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1WrtFv1Nl10(
  ...
  const Scalar _tmp41 = _tmp23 + _tmp29 + _tmp40;
  ...
  const Scalar _tmp66 = _tmp39 * _tmp63;
  const Scalar _tmp67 = -_tmp49 * _tmp66 + _tmp51 * _tmp53;
  const Scalar _tmp68 = _tmp65 * _tmp67 + _tmp66;
  const Scalar _tmp69 = Scalar(1.0) * _tmp55;
  const Scalar _tmp70 = -_tmp69;
  const Scalar _tmp71 = Scalar(1.0) / (_tmp41 + _tmp70);
  const Scalar _tmp72 = Scalar(1.0) * _tmp59;
  const Scalar _tmp73 = _tmp71 * (-_tmp45 + _tmp72);
  const Scalar _tmp74 = -_tmp39 + _tmp52 * _tmp65 - _tmp68 * _tmp73;
  const Scalar _tmp75 =
  ...
  const Scalar _tmp78 = _tmp77 * (-_tmp55 * _tmp61 * _tmp76 + _tmp57 * _tmp59 * _tmp76);
  const Scalar _tmp79 = _tmp41 * _tmp49 - _tmp45 * _tmp53 + _tmp49 * _tmp78;
  const Scalar _tmp80 = _tmp22 + _tmp30;
  const Scalar _tmp81 = _tmp80 + p_init1;
  const Scalar _tmp82 = _tmp81 + Scalar(-4.7752063900000001);
  const Scalar _tmp83 = _tmp58 + _tmp7;
  ...
  const Scalar _tmp89 = _tmp63 * _tmp88 - _tmp87;
  const Scalar _tmp90 = _tmp64 * _tmp89;
  const Scalar _tmp91 = _tmp78 * _tmp88 - _tmp79 * _tmp90 + _tmp80 * _tmp88 - _tmp83 * _tmp87;
  const Scalar _tmp92 = _tmp34 + _tmp38;
  const Scalar _tmp93 = -_tmp66 * _tmp88 - _tmp67 * _tmp90 + _tmp87 * _tmp92;
  const Scalar _tmp94 = _tmp39 * _tmp88 - _tmp52 * _tmp90 - _tmp73 * _tmp93 - _tmp88 * _tmp92;
  ...
  const Scalar _tmp99 = _tmp98 * (_tmp65 * _tmp79 - _tmp74 * _tmp96 - _tmp78);
  const Scalar _tmp100 = _tmp74 + _tmp99;
  const Scalar _tmp101 = _tmp88 * _tmp95;
  const Scalar _tmp102 = _tmp89 * _tmp95;
  const Scalar _tmp103 = -_tmp100 * _tmp102 - _tmp63;
  const Scalar _tmp104 = _tmp49 * _tmp64;
  const Scalar _tmp105 = _tmp20 + Scalar(-2.5202214700000001);
  const Scalar _tmp106 = _tmp32 + Scalar(8.3888750099999996);
  ...
  const Scalar _tmp112 = fh1 * (-_tmp108 * _tmp31 + _tmp111 * _tmp19);
  const Scalar _tmp113 = Scalar(1.0) * _tmp64;
  const Scalar _tmp114 = _tmp113 * _tmp67;
  const Scalar _tmp115 = -_tmp113 * _tmp52 + _tmp114 * _tmp73;
  const Scalar _tmp116 = _tmp98 * (-_tmp113 * _tmp79 - _tmp115 * _tmp96);
  ...
  const Scalar _tmp121 = _tmp69 * _tmp73 + _tmp72;
  const Scalar _tmp122 = 0;
  const Scalar _tmp123 = _tmp122 * _tmp95;
  const Scalar _tmp124 = _tmp123 * _tmp90;
  const Scalar _tmp125 = _tmp77 * (_tmp123 * _tmp88 - _tmp124 * _tmp49);
  const Scalar _tmp126 = -_tmp109 * _tmp77 * (_tmp100 * _tmp101 + _tmp103 * _tmp104 + Scalar(1.0)) -
                         _tmp112 * _tmp77 * (-_tmp110 * _tmp49 * _tmp90 + _tmp110 * _tmp88) -
                         _tmp119 * _tmp77 * (_tmp101 * _tmp117 + _tmp104 * _tmp118) -
                         _tmp120 * _tmp125;
  const Scalar _tmp127 = std::pow(_tmp126, Scalar(-2));
  const Scalar _tmp128 = _tmp125 * _tmp127;
  const Scalar _tmp129 = Scalar(1.0) / (_tmp126);
  const Scalar _tmp130 = _tmp70 + _tmp80;
  const Scalar _tmp131 = _tmp130 * _tmp73;
  const Scalar _tmp132 = Scalar(1.0) / (-_tmp131 + _tmp72 - _tmp83);
  const Scalar _tmp133 = _tmp130 * _tmp132;
  const Scalar _tmp134 = _tmp93 * _tmp95;
  const Scalar _tmp135 = -_tmp114 + _tmp116 * _tmp133 - _tmp117 * _tmp134;
  const Scalar _tmp136 = Scalar(1.0) * _tmp71;
  const Scalar _tmp137 = Scalar(1.0) * _tmp132;
  const Scalar _tmp138 = _tmp137 * _tmp98;
  const Scalar _tmp139 = -_tmp110 * _tmp93 + _tmp130 * _tmp138;
  const Scalar _tmp140 = -_tmp100 * _tmp134 + _tmp133 * _tmp99 + _tmp68;
  const Scalar _tmp141 = fh1 * (_tmp34 + _tmp50);
  const Scalar _tmp142 = _tmp108 * _tmp141 + Scalar(3.29616) * _tmp12 + _tmp19 * fv1;
  const Scalar _tmp143 = _tmp130 * _tmp71;
  const Scalar _tmp144 = Scalar(1.0) * _tmp137 * _tmp143 - Scalar(1.0) * _tmp137;
  const Scalar _tmp145 = -_tmp111 * _tmp141 - Scalar(3.29616) * _tmp27 - _tmp31 * fv1;
  const Scalar _tmp146 = _tmp137 * _tmp73;
  const Scalar _tmp147 = _tmp131 * _tmp137 + Scalar(1.0);
  const Scalar _tmp148 = -Scalar(1.0) * _tmp136 * _tmp147 + Scalar(1.0) * _tmp146;
  const Scalar _tmp149 = _tmp121 * _tmp132;
  const Scalar _tmp150 = _tmp71 * (-_tmp122 * _tmp134 - _tmp130 * _tmp149 + _tmp70);
  const Scalar _tmp151 = -Scalar(1.0) * _tmp121 * _tmp137 - Scalar(1.0) * _tmp150 + Scalar(1.0);
  const Scalar _tmp152 = Scalar(1.0) * _tmp109 * (-_tmp136 * _tmp140 + _tmp137 * _tmp99) +
                         Scalar(1.0) * _tmp112 * (-_tmp136 * _tmp139 + _tmp138) +
                         Scalar(1.0) * _tmp119 * (_tmp116 * _tmp137 - _tmp135 * _tmp136) +
                         _tmp120 * _tmp151 + _tmp142 * _tmp144 + _tmp145 * _tmp148;
  const Scalar _tmp153 = std::asinh(_tmp129 * _tmp152);
  const Scalar _tmp154 = Scalar(1.0) * _tmp153;
  const Scalar _tmp155 = _tmp28 + _tmp54;
  const Scalar _tmp156 =
      (-_tmp128 * _tmp152 + _tmp129 * (_tmp144 * _tmp19 + _tmp148 * _tmp155 - _tmp151)) /
  ...
  const Scalar _tmp162 = _tmp147 * _tmp71;
  const Scalar _tmp163 = _tmp71 * fh1;
  const Scalar _tmp164 = _tmp137 * _tmp142;
  const Scalar _tmp165 = _tmp108 * _tmp140 * _tmp163 + _tmp111 * _tmp135 * _tmp163 +
                         _tmp112 * _tmp139 * _tmp71 + _tmp120 * _tmp150 - _tmp143 * _tmp164 +
                         _tmp145 * _tmp162;
  const Scalar _tmp166 = _tmp120 * _tmp123;
  const Scalar _tmp167 = _tmp64 * fh1;
  const Scalar _tmp168 = _tmp110 * _tmp112;
  const Scalar _tmp169 = _tmp103 * _tmp108 * _tmp167 + _tmp111 * _tmp118 * _tmp167 -
                         _tmp166 * _tmp90 - _tmp168 * _tmp90;
  ...
  const Scalar _tmp173 = Scalar(9.6622558468725703) * _tmp169;
  const Scalar _tmp174 =
      -_tmp171 * _tmp173 -
      Scalar(8.3196563700000006) *
          std::sqrt(
              Scalar(std::pow(Scalar(-Scalar(0.12019727204189803) * _tmp42 - 1), Scalar(2)) +
  ...
  const Scalar _tmp177 = Scalar(9.6622558468725703) * _tmp123;
  const Scalar _tmp178 = _tmp177 * _tmp90;
  const Scalar _tmp179 = std::pow(_tmp169, Scalar(-2));
  const Scalar _tmp180 = _tmp124 * _tmp179;
  const Scalar _tmp181 = _tmp137 * _tmp19;
  const Scalar _tmp182 =
      (-_tmp165 * _tmp180 + _tmp170 * (-_tmp143 * _tmp181 - _tmp150 + _tmp155 * _tmp162)) /
      std::sqrt(Scalar(std::pow(_tmp165, Scalar(2)) * _tmp179 + 1));
  const Scalar _tmp183 =
      _tmp100 * _tmp109 * _tmp95 + _tmp117 * _tmp119 * _tmp95 + _tmp166 + _tmp168;
  const Scalar _tmp184 = Scalar(1.0) / (_tmp183);
  const Scalar _tmp185 = -_tmp109 * _tmp132 * _tmp99 - _tmp112 * _tmp138 -
                         _tmp116 * _tmp119 * _tmp132 + _tmp120 * _tmp149 - _tmp145 * _tmp146 +
                         _tmp164;
  ...
  const Scalar _tmp194 = (_tmp184 * (-_tmp146 * _tmp155 - _tmp149 + _tmp181) + _tmp185 * _tmp193) /
  ...
  _res(1, 0) =
      -_tmp157 * (Scalar(0.86625939559540499) * _tmp129 + std::cosh(_tmp154) - std::cosh(_tmp161)) -
      _tmp158 *
          (-Scalar(0.86625939559540499) * _tmp128 + Scalar(1.0) * _tmp156 * std::sinh(_tmp154) -
           (-Scalar(0.1034955) * _tmp128 * _tmp160 +
            _tmp159 * (-_tmp153 * _tmp157 - _tmp156 * _tmp158)) *
               std::sinh(_tmp161));
  _res(2, 0) =
      -_tmp173 *
          (-Scalar(0.87679799772039002) * _tmp180 + Scalar(1.0) * _tmp182 * std::sinh(_tmp172) -
           (-Scalar(0.1034955) * _tmp174 * _tmp180 +
            _tmp175 * (-_tmp171 * _tmp178 - _tmp173 * _tmp182)) *
               std::sinh(_tmp176)) -
      _tmp178 * (Scalar(0.87679799772039002) * _tmp170 + std::cosh(_tmp172) - std::cosh(_tmp176));
  _res(3, 0) =
      _tmp177 * (Scalar(0.86565325453551001) * _tmp184 - std::cosh(_tmp190) + std::cosh(_tmp191)) -
      _tmp187 *
          (Scalar(0.86565325453551001) * _tmp193 + Scalar(1.0) * _tmp194 * std::sinh(_tmp191) -
