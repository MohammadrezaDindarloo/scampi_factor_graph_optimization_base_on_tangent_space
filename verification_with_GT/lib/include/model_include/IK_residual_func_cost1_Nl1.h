...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost1Nl1(const Scalar fh1, const Scalar fv1,
  ...
  const Scalar _tmp35 = -Scalar(0.010999999999999999) * _tmp23 -
  ...
  const Scalar _tmp43 = _tmp21 + _tmp29;
  ...
  const Scalar _tmp49 = _tmp22 + _tmp46;
  const Scalar _tmp50 = Scalar(1.0) / (_tmp45 + _tmp49);
  const Scalar _tmp51 = _tmp41 + _tmp7;
  ...
  const Scalar _tmp56 = _tmp49 + p_init1;
  ...
  const Scalar _tmp63 = _tmp39 + p_init0;
  const Scalar _tmp64 = _tmp63 + Scalar(-2.5202214700000001);
  const Scalar _tmp65 = _tmp43 + p_init1;
  ...
  const Scalar _tmp69 = Scalar(1.0) / (_tmp64);
  const Scalar _tmp70 = _tmp67 * _tmp69;
  const Scalar _tmp71 = _tmp70 * (_tmp39 * _tmp66 * _tmp68 - _tmp43 * _tmp64 * _tmp68);
  const Scalar _tmp72 = _tmp49 * _tmp62 - _tmp51 * _tmp61 + _tmp62 * _tmp71;
  const Scalar _tmp73 = _tmp66 * _tmp69;
  const Scalar _tmp74 = Scalar(1.0) / (-_tmp61 + _tmp62 * _tmp73);
  const Scalar _tmp75 = _tmp73 * _tmp74;
  const Scalar _tmp76 = _tmp35 + _tmp36;
  const Scalar _tmp77 = _tmp34 + _tmp76;
  const Scalar _tmp78 = _tmp73 * _tmp77;
  const Scalar _tmp79 = _tmp62 * _tmp77;
  const Scalar _tmp80 = _tmp33 + _tmp37;
  const Scalar _tmp81 = _tmp61 * _tmp80 - _tmp73 * _tmp79;
  const Scalar _tmp82 = _tmp75 * _tmp81 + _tmp78;
  const Scalar _tmp83 = -_tmp62 * _tmp80 + _tmp79;
  const Scalar _tmp84 = -_tmp52 * _tmp82 + _tmp75 * _tmp83 - _tmp77;
  const Scalar _tmp85 = _tmp33 + _tmp76;
  const Scalar _tmp86 = _tmp47 + p_init1;
  const Scalar _tmp87 = _tmp86 + Scalar(-4.7752063900000001);
  const Scalar _tmp88 = _tmp42 + p_init0;
  ...
  const Scalar _tmp93 = _tmp73 * _tmp92 - _tmp91;
  const Scalar _tmp94 = _tmp74 * _tmp93;
  const Scalar _tmp95 = -_tmp78 * _tmp92 - _tmp81 * _tmp94 + _tmp85 * _tmp91;
  const Scalar _tmp96 = -_tmp52 * _tmp95 + _tmp77 * _tmp92 - _tmp83 * _tmp94 - _tmp85 * _tmp92;
  const Scalar _tmp97 = Scalar(1.0) / (_tmp96);
  const Scalar _tmp98 = -_tmp42 * _tmp91 + _tmp47 * _tmp92 + _tmp71 * _tmp92 - _tmp72 * _tmp94;
  const Scalar _tmp99 = _tmp97 * _tmp98;
  const Scalar _tmp100 = Scalar(1.0) / (_tmp98);
  const Scalar _tmp101 = _tmp100 * _tmp96;
  const Scalar _tmp102 = _tmp101 * (-_tmp71 + _tmp72 * _tmp75 - _tmp84 * _tmp99);
  const Scalar _tmp103 = _tmp97 * (_tmp102 + _tmp84);
  const Scalar _tmp104 = _tmp48 * _tmp54;
  ...
  const Scalar _tmp112 = _tmp38 * fh1;
  const Scalar _tmp113 = _tmp110 * _tmp112 + Scalar(3.29616) * _tmp12 + _tmp19 * fv1;
  const Scalar _tmp114 = _tmp48 * _tmp55;
  const Scalar _tmp115 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp116 = _tmp40 + _tmp44 * _tmp52;
  const Scalar _tmp117 = _tmp116 * _tmp54;
  const Scalar _tmp118 = 0;
  const Scalar _tmp119 = _tmp50 * (-_tmp117 * _tmp48 - _tmp118 * _tmp95 + _tmp45);
  const Scalar _tmp120 = _tmp107 * _tmp109;
  const Scalar _tmp121 = -_tmp112 * _tmp120 - Scalar(3.29616) * _tmp27 - _tmp30 * fv1;
  const Scalar _tmp122 = _tmp53 * _tmp55 + Scalar(1.0);
  const Scalar _tmp123 = _tmp52 * _tmp55;
  const Scalar _tmp124 = Scalar(1.0) * _tmp74;
  const Scalar _tmp125 = _tmp124 * _tmp81;
  const Scalar _tmp126 = -_tmp124 * _tmp83 + _tmp125 * _tmp52;
  const Scalar _tmp127 = _tmp101 * (-_tmp124 * _tmp72 - _tmp126 * _tmp99);
  const Scalar _tmp128 = _tmp97 * (_tmp126 + _tmp127);
  const Scalar _tmp129 = _tmp104 * _tmp127 - _tmp125 - _tmp128 * _tmp95;
  const Scalar _tmp130 = _tmp120 * fh1;
  const Scalar _tmp131 = _tmp101 * _tmp55;
  const Scalar _tmp132 = Scalar(1.0) * _tmp100;
  const Scalar _tmp133 = _tmp101 * _tmp114 - _tmp132 * _tmp95;
  const Scalar _tmp134 = fh1 * (-_tmp110 * _tmp30 + _tmp120 * _tmp19);
  const Scalar _tmp135 = -_tmp128 * _tmp93 + Scalar(1.0);
  const Scalar _tmp136 = _tmp62 * _tmp74;
  const Scalar _tmp137 = _tmp62 * _tmp94;
  const Scalar _tmp138 = -_tmp103 * _tmp93 - _tmp73;
  const Scalar _tmp139 = -_tmp111 * _tmp70 * (_tmp103 * _tmp92 + _tmp136 * _tmp138 + Scalar(1.0)) -
                         _tmp115 * _tmp70 * (-_tmp118 * _tmp137 + _tmp118 * _tmp92) -
                         _tmp130 * _tmp70 * (_tmp128 * _tmp92 + _tmp135 * _tmp136) -
                         _tmp134 * _tmp70 * (-_tmp132 * _tmp137 + _tmp132 * _tmp92);
  const Scalar _tmp140 = Scalar(1.0) / (_tmp139);
  const Scalar _tmp141 = std::asinh(
      _tmp140 * (Scalar(1.0) * _tmp111 * (_tmp102 * _tmp55 - _tmp105 * _tmp106) +
                 Scalar(1.0) * _tmp113 * (_tmp114 * _tmp50 - _tmp55) +
                 Scalar(1.0) * _tmp115 * (-_tmp116 * _tmp55 - Scalar(1.0) * _tmp119 + Scalar(1.0)) +
                 Scalar(1.0) * _tmp121 * (-_tmp106 * _tmp122 + _tmp123) +
                 Scalar(1.0) * _tmp130 * (-_tmp106 * _tmp129 + _tmp127 * _tmp55) +
                 Scalar(1.0) * _tmp134 * (-_tmp106 * _tmp133 + _tmp131)));
  ...
  const Scalar _tmp145 =
      _tmp111 * _tmp138 * _tmp74 + _tmp130 * _tmp135 * _tmp74 - _tmp143 * _tmp94 - _tmp144 * _tmp94;
  const Scalar _tmp146 = Scalar(1.0) / (_tmp145);
  const Scalar _tmp147 = _tmp113 * _tmp55;
  const Scalar _tmp148 =
      std::asinh(_tmp146 * (_tmp105 * _tmp111 * _tmp50 + _tmp115 * _tmp119 +
                            _tmp121 * _tmp122 * _tmp50 + _tmp129 * _tmp130 * _tmp50 +
                            _tmp133 * _tmp134 * _tmp50 - _tmp147 * _tmp48 * _tmp50));
  const Scalar _tmp149 = Scalar(9.6622558468725703) * _tmp145;
  const Scalar _tmp150 = _tmp103 * _tmp111 + _tmp128 * _tmp130 + _tmp143 + _tmp144;
  const Scalar _tmp151 = Scalar(1.0) / (_tmp150);
  const Scalar _tmp152 =
      std::asinh(_tmp151 * (-_tmp102 * _tmp111 * _tmp54 + _tmp115 * _tmp117 - _tmp121 * _tmp123 -
                            _tmp127 * _tmp130 * _tmp54 - _tmp131 * _tmp134 + _tmp147));
  ...
  _res(1, 0) =
      -_tmp142 *
          (Scalar(0.87653584775870996) * _tmp140 + std::cosh(Scalar(1.0) * _tmp141) -
           std::cosh(
  ...
  _res(2, 0) =
      -_tmp149 *
          (Scalar(0.86625939559540499) * _tmp146 + std::cosh(Scalar(1.0) * _tmp148) -
           std::cosh(
                ...
                Scalar(4.7752063900000001) *
                    std::sqrt(Scalar(
                        ...
                        Scalar(0.32397683292140877) *
                            std::pow(Scalar(1 - Scalar(0.36791786395571047) * _tmp88),
                                     Scalar(2))))))) +
      _tmp85 + p_init2;
