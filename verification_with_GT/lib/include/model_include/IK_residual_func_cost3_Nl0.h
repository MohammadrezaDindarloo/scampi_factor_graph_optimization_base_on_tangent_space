...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl0(const Scalar fh1, const Scalar fv1,
  ...
  const Scalar _tmp40 = _tmp31 * _tmp38 - _tmp32 * _tmp39 + _tmp35 * _tmp38;
  const Scalar _tmp41 = _tmp26 * _tmp29;
  const Scalar _tmp42 = Scalar(1.0) / (_tmp38 * _tmp41 - _tmp39);
  ...
  const Scalar _tmp51 = -_tmp38 * _tmp49 + _tmp39 * _tmp50;
  const Scalar _tmp52 = Scalar(1.0) * _tmp25;
  const Scalar _tmp53 = Scalar(1.0) * _tmp16;
  const Scalar _tmp54 = (-_tmp32 + _tmp53) / (_tmp35 - _tmp52);
  const Scalar _tmp55 = _tmp38 * _tmp48 - _tmp38 * _tmp50;
  const Scalar _tmp56 = _tmp43 * _tmp55 - _tmp48 - _tmp54 * (_tmp43 * _tmp51 + _tmp49);
  const Scalar _tmp57 = -_tmp18;
  const Scalar _tmp58 = _tmp34 + _tmp57;
  const Scalar _tmp59 = _tmp58 + p_init1 + Scalar(-4.8333311099999996);
  const Scalar _tmp60 = -_tmp10 + _tmp14;
  ...
  _res(1, 0) = std::exp(_tmp30 * _tmp88 * (_tmp65 * _tmp90 - _tmp90 * _tmp91) +
                        _tmp30 * _tmp98 * (_tmp65 * _tmp97 - _tmp91 * _tmp97) +
                        _tmp86 * _tmp87 * (_tmp76 * _tmp80 + _tmp78 * _tmp79 + Scalar(1.0)) +
                        _tmp87 * _tmp96 * (_tmp79 * _tmp95 + _tmp80 * _tmp94));
  _res(2, 0) = std::exp(-_tmp100 * _tmp78 * _tmp86 - _tmp100 * _tmp95 * _tmp96 + _tmp101 * _tmp67 +
                        _tmp67 * _tmp99);
  _res(3, 0) = std::exp(-_tmp101 - _tmp102 * _tmp76 * _tmp86 - _tmp102 * _tmp94 * _tmp96 - _tmp99);
