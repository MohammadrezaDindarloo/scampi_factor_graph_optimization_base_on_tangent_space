...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl17(
  ...
  const Scalar _tmp102 = _tmp30 * (-_tmp100 * _tmp79 + _tmp101 * _tmp66);
  const Scalar _tmp103 = _tmp100 * _tmp44;
  ...
  _res(0, 0) = 0;
  _res(1, 0) =
      -_tmp102 * std::exp(_tmp102 * _tmp97 +
                          _tmp30 * _tmp87 * (_tmp76 * _tmp80 + _tmp78 * _tmp79 + Scalar(1.0)) +
                          _tmp30 * _tmp92 * (-_tmp41 * _tmp90 + _tmp66 * _tmp88) +
                          _tmp30 * _tmp96 * (_tmp79 * _tmp95 + _tmp80 * _tmp94));
  _res(2, 0) = -_tmp103 * std::exp(_tmp103 * _tmp97 - _tmp44 * _tmp78 * _tmp87 -
                                   _tmp44 * _tmp95 * _tmp96 + _tmp90 * _tmp92);
  _res(3, 0) = _tmp101 * std::exp(-_tmp101 * _tmp97 - _tmp71 * _tmp76 * _tmp87 -
                                  _tmp71 * _tmp94 * _tmp96 - _tmp88 * _tmp92);
