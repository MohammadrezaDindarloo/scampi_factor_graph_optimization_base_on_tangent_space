...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl5(
  ...
  const Scalar _tmp27 = _tmp16 + p_init0 + Scalar(1.9874742000000001);
  ...
  const Scalar _tmp32 = _tmp15 + _tmp4;
  ...
  const Scalar _tmp38 = _tmp20 + _tmp23;
  ...
  const Scalar _tmp49 = _tmp4 + _tmp41;
  const Scalar _tmp50 = _tmp49 + p_init0 + Scalar(-2.71799795);
  const Scalar _tmp51 = _tmp17 + _tmp38;
  ...
  const Scalar _tmp56 = _tmp48 * _tmp54 - _tmp49 * _tmp55 + _tmp51 * _tmp54;
  const Scalar _tmp57 = _tmp35 * _tmp36;
  const Scalar _tmp58 = _tmp40 * _tmp46;
  const Scalar _tmp59 = _tmp37 * _tmp58 - _tmp57;
  const Scalar _tmp60 = Scalar(1.0) / (_tmp54 * _tmp58 - _tmp55);
  const Scalar _tmp61 = _tmp59 * _tmp60;
  const Scalar _tmp62 = -_tmp32 * _tmp57 + _tmp34 * _tmp37 + _tmp37 * _tmp48 - _tmp56 * _tmp61;
  const Scalar _tmp63 = Scalar(1.0) / (_tmp62);
  const Scalar _tmp64 = Scalar(1.0) * _tmp63;
  const Scalar _tmp65 = _tmp54 * _tmp61;
  const Scalar _tmp66 = _tmp31 * _tmp47 * (_tmp37 * _tmp64 - _tmp64 * _tmp65);
  ...
  const Scalar _tmp69 = Scalar(0.20999999999999999) * _tmp21 + Scalar(0.20999999999999999) * _tmp22;
  const Scalar _tmp70 = _tmp68 + _tmp69;
  const Scalar _tmp71 = _tmp67 + _tmp70;
  const Scalar _tmp72 = -_tmp67 + _tmp70;
  const Scalar _tmp73 = -_tmp54 * _tmp71 + _tmp54 * _tmp72;
  const Scalar _tmp74 = _tmp67 + _tmp68 - _tmp69;
  const Scalar _tmp75 = _tmp58 * _tmp72;
  const Scalar _tmp76 = -_tmp54 * _tmp75 + _tmp55 * _tmp71;
  const Scalar _tmp77 = Scalar(1.0) * _tmp39;
  const Scalar _tmp78 = Scalar(1.0) * _tmp42;
  const Scalar _tmp79 = (-_tmp49 + _tmp78) / (_tmp51 - _tmp77);
  const Scalar _tmp80 = _tmp37 * _tmp72 - _tmp37 * _tmp74 - _tmp61 * _tmp73 -
                        _tmp79 * (-_tmp37 * _tmp75 + _tmp57 * _tmp74 - _tmp61 * _tmp76);
  const Scalar _tmp81 = Scalar(1.0) / (_tmp80);
  const Scalar _tmp82 = _tmp58 * _tmp60;
  const Scalar _tmp83 = -_tmp72 + _tmp73 * _tmp82 - _tmp79 * (_tmp75 + _tmp76 * _tmp82);
  const Scalar _tmp84 = _tmp62 * _tmp81;
  const Scalar _tmp85 = _tmp63 * _tmp80;
  const Scalar _tmp86 = _tmp83 + _tmp85 * (-_tmp48 + _tmp56 * _tmp82 - _tmp83 * _tmp84);
  const Scalar _tmp87 = _tmp81 * _tmp86;
  const Scalar _tmp88 = _tmp59 * _tmp81;
  const Scalar _tmp89 = _tmp60 * (-_tmp58 - _tmp86 * _tmp88);
  const Scalar _tmp90 = _tmp30 * _tmp47 * (_tmp37 * _tmp87 + _tmp54 * _tmp89 + Scalar(1.0));
  ...
  const Scalar _tmp95 = -_tmp73 * _tmp94 + _tmp76 * _tmp79 * _tmp94;
  const Scalar _tmp96 = _tmp85 * (-_tmp56 * _tmp94 - _tmp84 * _tmp95) + _tmp95;
  const Scalar _tmp97 = _tmp60 * (-_tmp88 * _tmp96 + Scalar(1.0));
  const Scalar _tmp98 = _tmp81 * _tmp96;
  const Scalar _tmp99 = _tmp29 * _tmp47 * (_tmp37 * _tmp98 + _tmp54 * _tmp97);
  const Scalar _tmp100 = _tmp29 * _tmp97;
  const Scalar _tmp101 = _tmp30 * _tmp89;
  const Scalar _tmp102 = _tmp91 * _tmp93;
  const Scalar _tmp103 = _tmp31 * _tmp64;
  const Scalar _tmp104 = _tmp103 * fh1;
  const Scalar _tmp105 = _tmp29 * _tmp98;
  const Scalar _tmp106 = _tmp30 * _tmp87;
  ...
  _res(1, 0) = -(-_tmp66 - _tmp90 - _tmp99) *
               std::exp(_tmp47 * _tmp91 * (_tmp37 * _tmp93 - _tmp65 * _tmp93) + _tmp66 * fh1 +
                        _tmp90 * fh1 + _tmp99 * fh1);
  _res(2, 0) = -(_tmp100 + _tmp101 - _tmp103 * _tmp61) *
               std::exp(-_tmp100 * fh1 - _tmp101 * fh1 + _tmp102 * _tmp61 + _tmp104 * _tmp61);
  _res(3, 0) =
      -(_tmp103 + _tmp105 + _tmp106) * std::exp(-_tmp102 - _tmp104 - _tmp105 * fh1 - _tmp106 * fh1);
