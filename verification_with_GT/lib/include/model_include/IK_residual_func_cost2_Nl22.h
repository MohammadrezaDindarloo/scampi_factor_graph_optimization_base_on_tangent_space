...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost2Nl22(
  ...
  const Scalar _tmp60 = _tmp42 + Scalar(-2.71799795);
  const Scalar _tmp61 = Scalar(1.0) / (_tmp60);
  const Scalar _tmp62 = _tmp45 + Scalar(-4.7752063900000001);
  const Scalar _tmp63 = _tmp61 * _tmp62;
  const Scalar _tmp64 = _tmp27 + _tmp54;
  ...
  const Scalar _tmp73 = _tmp34 + _tmp48;
  const Scalar _tmp74 = _tmp66 * _tmp70;
  const Scalar _tmp75 = -_tmp63 * _tmp72 + _tmp73 * _tmp74;
  const Scalar _tmp76 = Scalar(1.0) / (_tmp63 * _tmp71 - _tmp74);
  const Scalar _tmp77 = _tmp53 * _tmp58;
  const Scalar _tmp78 = -_tmp59 + _tmp63 * _tmp77;
  const Scalar _tmp79 = _tmp76 * _tmp78;
  const Scalar _tmp80 = _tmp39 * _tmp63;
  const Scalar _tmp81 = _tmp49 * _tmp59 - _tmp75 * _tmp79 - _tmp77 * _tmp80;
  const Scalar _tmp82 = -_tmp71 * _tmp73 + _tmp72;
  const Scalar _tmp83 = Scalar(1.0) * _tmp44;
  const Scalar _tmp84 = -_tmp83;
  const Scalar _tmp85 = Scalar(1.0) / (_tmp64 + _tmp84);
  const Scalar _tmp86 = Scalar(1.0) * _tmp41;
  const Scalar _tmp87 = -_tmp67 + _tmp86;
  const Scalar _tmp88 = _tmp85 * _tmp87;
  const Scalar _tmp89 = _tmp39 * _tmp77 - _tmp49 * _tmp77 - _tmp79 * _tmp82 - _tmp81 * _tmp88;
  const Scalar _tmp90 = Scalar(1.0) / (_tmp89);
  const Scalar _tmp91 = _tmp83 * _tmp88 + _tmp86;
  const Scalar _tmp92 = 0;
  const Scalar _tmp93 = _tmp55 + _tmp84;
  const Scalar _tmp94 = _tmp88 * _tmp93;
  const Scalar _tmp95 = Scalar(1.0) / (-_tmp51 + _tmp86 - _tmp94);
  const Scalar _tmp96 = _tmp91 * _tmp95;
  const Scalar _tmp97 = -_tmp81 * _tmp92 + _tmp84 - _tmp93 * _tmp96;
  const Scalar _tmp98 = Scalar(1.0) * _tmp85;
  const Scalar _tmp99 = Scalar(1.0) * _tmp95;
  const Scalar _tmp100 = _tmp94 * _tmp99 + Scalar(1.0);
  const Scalar _tmp101 = _tmp29 + Scalar(-4.8333311099999996);
  const Scalar _tmp102 = _tmp19 + Scalar(1.79662371);
  ...
  const Scalar _tmp106 = -_tmp104 * _tmp105 - Scalar(3.29616) * _tmp25 - _tmp28 * fv1;
  ...
  const Scalar _tmp109 = _tmp107 * _tmp61;
  const Scalar _tmp110 = _tmp109 * (_tmp108 * _tmp41 * _tmp62 - _tmp108 * _tmp44 * _tmp60);
  const Scalar _tmp111 = _tmp63 * _tmp76;
  const Scalar _tmp112 = _tmp111 * _tmp75 + _tmp80;
  const Scalar _tmp113 = _tmp111 * _tmp82 - _tmp112 * _tmp88 - _tmp39;
  const Scalar _tmp114 = _tmp110 * _tmp71 + _tmp64 * _tmp71 - _tmp67 * _tmp74;
  const Scalar _tmp115 = _tmp110 * _tmp77 - _tmp114 * _tmp79 - _tmp51 * _tmp59 + _tmp55 * _tmp77;
  const Scalar _tmp116 = _tmp115 * _tmp90;
  const Scalar _tmp117 = Scalar(1.0) / (_tmp115);
  const Scalar _tmp118 = _tmp117 * _tmp89;
  const Scalar _tmp119 = _tmp118 * (-_tmp110 + _tmp111 * _tmp114 - _tmp113 * _tmp116);
  const Scalar _tmp120 = _tmp113 + _tmp119;
  const Scalar _tmp121 = _tmp81 * _tmp90;
  const Scalar _tmp122 = _tmp93 * _tmp95;
  const Scalar _tmp123 = _tmp112 + _tmp119 * _tmp122 - _tmp120 * _tmp121;
  const Scalar _tmp124 = _tmp102 * _tmp103;
  const Scalar _tmp125 = _tmp124 * fh1;
  const Scalar _tmp126 = Scalar(1.0) * _tmp76;
  const Scalar _tmp127 = -_tmp126 * _tmp82 + _tmp75 * _tmp76 * _tmp87 * _tmp98;
  const Scalar _tmp128 = _tmp118 * (-_tmp114 * _tmp126 - _tmp116 * _tmp127);
  const Scalar _tmp129 = _tmp127 + _tmp128;
  const Scalar _tmp130 = -_tmp121 * _tmp129 + _tmp122 * _tmp128 - _tmp126 * _tmp75;
  const Scalar _tmp131 = _tmp104 * fh1;
  const Scalar _tmp132 = _tmp118 * _tmp99;
  const Scalar _tmp133 = Scalar(1.0) * _tmp117;
  const Scalar _tmp134 = _tmp93 * _tmp99;
  const Scalar _tmp135 = _tmp118 * _tmp134 - _tmp133 * _tmp81;
  const Scalar _tmp136 = fh1 * (_tmp104 * _tmp18 - _tmp124 * _tmp28);
  const Scalar _tmp137 = _tmp105 * _tmp124 + Scalar(3.29616) * _tmp15 + _tmp18 * fv1;
  const Scalar _tmp138 = _tmp77 * _tmp90;
  const Scalar _tmp139 = _tmp78 * _tmp90;
  const Scalar _tmp140 = -_tmp129 * _tmp139 + Scalar(1.0);
  const Scalar _tmp141 = _tmp71 * _tmp76;
  const Scalar _tmp142 = -_tmp120 * _tmp139 - _tmp63;
  const Scalar _tmp143 = _tmp117 * _tmp126 * _tmp78;
  const Scalar _tmp144 =
      -_tmp109 * _tmp125 * (_tmp120 * _tmp138 + _tmp141 * _tmp142 + Scalar(1.0)) -
      _tmp109 * _tmp131 * (_tmp129 * _tmp138 + _tmp140 * _tmp141) -
      _tmp109 * _tmp136 * (_tmp133 * _tmp77 - _tmp143 * _tmp71) -
      _tmp109 * _tmp47 * (-_tmp71 * _tmp79 * _tmp92 + _tmp77 * _tmp92);
  const Scalar _tmp145 = Scalar(1.0) / (_tmp144);
  const Scalar _tmp146 = std::asinh(
      _tmp145 * (Scalar(1.0) * _tmp106 * (-_tmp100 * _tmp98 + _tmp88 * _tmp99) +
                 Scalar(1.0) * _tmp125 * (_tmp119 * _tmp99 - _tmp123 * _tmp98) +
                 Scalar(1.0) * _tmp131 * (_tmp128 * _tmp99 - _tmp130 * _tmp98) +
                 Scalar(1.0) * _tmp136 * (_tmp132 - _tmp135 * _tmp98) +
                 Scalar(1.0) * _tmp137 * (_tmp134 * _tmp85 - _tmp99) +
                 Scalar(1.0) * _tmp47 * (-_tmp91 * _tmp99 - _tmp97 * _tmp98 + Scalar(1.0))));
  ...
  const Scalar _tmp149 = _tmp47 * _tmp92;
  const Scalar _tmp150 = _tmp125 * _tmp142 * _tmp76 + _tmp131 * _tmp140 * _tmp76 -
                         _tmp136 * _tmp143 - _tmp149 * _tmp79;
  const Scalar _tmp151 = Scalar(1.0) / (_tmp150);
  const Scalar _tmp152 = _tmp106 * _tmp85;
  const Scalar _tmp153 = _tmp137 * _tmp99;
  const Scalar _tmp154 =
      std::asinh(_tmp151 * (_tmp100 * _tmp152 + _tmp123 * _tmp125 * _tmp85 +
                            _tmp130 * _tmp131 * _tmp85 + _tmp135 * _tmp136 * _tmp85 -
                            _tmp153 * _tmp85 * _tmp93 + _tmp47 * _tmp85 * _tmp97));
  ...
  const Scalar _tmp157 =
      _tmp120 * _tmp125 * _tmp90 + _tmp129 * _tmp131 * _tmp90 + _tmp133 * _tmp136 + _tmp149;
  const Scalar _tmp158 = Scalar(1.0) / (_tmp157);
  const Scalar _tmp159 = std::asinh(
      _tmp158 * (-_tmp119 * _tmp125 * _tmp95 - _tmp128 * _tmp131 * _tmp95 - _tmp132 * _tmp136 -
                 _tmp152 * _tmp87 * _tmp99 + _tmp153 + _tmp47 * _tmp96));
  ...
  _res(2, 0) =
      _tmp155 *
          (-std::sinh(Scalar(1.0) * _tmp154) -
           std::sinh(Scalar(0.1034955) * _tmp151 * (-std::sqrt(_tmp148) - _tmp154 * _tmp155))) -
  ...
  _res(3, 0) =
      ...
      Scalar(8.4693136199999994) *
          std::sqrt(Scalar(Scalar(0.013941309530580858) * _tmp156 +
                           std::pow(Scalar(-Scalar(0.11807332268798426) * _tmp49 -
