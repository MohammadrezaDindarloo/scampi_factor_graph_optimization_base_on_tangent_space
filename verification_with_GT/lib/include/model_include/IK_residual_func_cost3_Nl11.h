...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl11(
  ...
  const Scalar _tmp37 = _tmp11 - _tmp15 + _tmp8;
  const Scalar _tmp38 = _tmp16 + _tmp7;
  ...
  const Scalar _tmp47 = _tmp17 * _tmp46 - _tmp38 * _tmp46;
  const Scalar _tmp48 = _tmp27 * _tmp35;
  const Scalar _tmp49 = _tmp21 + _tmp42;
  ...
  const Scalar _tmp55 = _tmp36 * _tmp54 - _tmp48;
  const Scalar _tmp56 = _tmp44 * _tmp45;
  const Scalar _tmp57 = Scalar(1.0) / (_tmp46 * _tmp54 - _tmp56);
  const Scalar _tmp58 = _tmp55 * _tmp57;
  const Scalar _tmp59 = _tmp17 * _tmp54;
  const Scalar _tmp60 = _tmp38 * _tmp56 - _tmp46 * _tmp59;
  ...
  const Scalar _tmp64 = _tmp17 * _tmp36 - _tmp36 * _tmp37 - _tmp47 * _tmp58 -
                        _tmp63 * (-_tmp36 * _tmp59 + _tmp37 * _tmp48 - _tmp58 * _tmp60);
  ...
  const Scalar _tmp71 = _tmp54 * _tmp57;
  const Scalar _tmp72 = -_tmp17 + _tmp47 * _tmp71 - _tmp63 * (_tmp59 + _tmp60 * _tmp71);
  const Scalar _tmp73 = Scalar(1.0) / (_tmp69);
  const Scalar _tmp74 = _tmp70 * (-_tmp49 * _tmp52 * _tmp73 + _tmp50 * _tmp51 * _tmp73);
  const Scalar _tmp75 = -_tmp40 * _tmp56 + _tmp43 * _tmp46 + _tmp46 * _tmp74;
  const Scalar _tmp76 = _tmp26 * _tmp36 - _tmp33 * _tmp48 + _tmp36 * _tmp74 - _tmp58 * _tmp75;
  ...
  const Scalar _tmp81 = _tmp36 * _tmp65;
  const Scalar _tmp82 = _tmp55 * _tmp65;
  const Scalar _tmp83 = -_tmp54 - _tmp80 * _tmp82;
  const Scalar _tmp84 = _tmp46 * _tmp57;
  const Scalar _tmp85 = _tmp29 + _tmp39;
  const Scalar _tmp86 = _tmp85 + p_init0 + Scalar(-2.5202214700000001);
  const Scalar _tmp87 = _tmp20 + _tmp25;
  ...
  const Scalar _tmp91 = _tmp70 * fh1;
  const Scalar _tmp92 = Scalar(1.0) * _tmp57;
  const Scalar _tmp93 = -_tmp47 * _tmp92 + _tmp60 * _tmp63 * _tmp92;
  ...
  const Scalar _tmp98 = fh1 * (_tmp85 * _tmp96 - _tmp87 * _tmp90);
  const Scalar _tmp99 = _tmp57 * fh1;
  ...
  _res(1, 0) = std::exp(_tmp0 * _tmp70 * (_tmp36 * _tmp67 - _tmp67 * _tmp68) +
                        _tmp70 * _tmp98 * (_tmp36 * _tmp97 - _tmp68 * _tmp97) +
                        _tmp90 * _tmp91 * (_tmp80 * _tmp81 + _tmp83 * _tmp84 + Scalar(1.0)) +
                        _tmp91 * _tmp96 * (_tmp81 * _tmp94 + _tmp84 * _tmp95));
  _res(2, 0) = std::exp(_tmp100 * _tmp58 + _tmp101 * _tmp58 - _tmp83 * _tmp90 * _tmp99 -
                        _tmp95 * _tmp96 * _tmp99);
  _res(3, 0) = std::exp(-_tmp100 - _tmp101 - _tmp102 * _tmp80 * _tmp90 - _tmp102 * _tmp94 * _tmp96);
