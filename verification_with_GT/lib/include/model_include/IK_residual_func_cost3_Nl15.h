...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3Nl15(
  ...
  const Scalar _tmp53 = (-_tmp30 + _tmp52) / (_tmp24 - _tmp51);
  const Scalar _tmp54 = -_tmp36 * _tmp48 + _tmp48 * _tmp50 * _tmp53;
  const Scalar _tmp55 = _tmp11 + _tmp34;
  ...
  const Scalar _tmp66 = -_tmp36 * _tmp65 -
                        _tmp53 * (-_tmp46 * _tmp63 - _tmp50 * _tmp65 + _tmp55 * _tmp61) -
  ...
  const Scalar _tmp84 = _tmp26 + _tmp39;
  ...
  const Scalar _tmp93 = -_tmp35 + _tmp36 * _tmp92 - _tmp53 * (_tmp49 + _tmp50 * _tmp92);
  const Scalar _tmp94 = _tmp76 * (-_tmp71 + _tmp72 * _tmp92 - _tmp74 * _tmp93) + _tmp93;
  const Scalar _tmp95 = -_tmp46 - _tmp79 * _tmp94;
  const Scalar _tmp96 = _tmp90 * fh1;
  const Scalar _tmp97 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp98 = _tmp51 * _tmp53 + _tmp52;
  ...
  _res(1, 0) = std::exp(_tmp70 * _tmp88 * (_tmp77 * _tmp78 + _tmp80 * _tmp81) +
                        _tmp70 * _tmp91 * (-_tmp33 * _tmp65 * _tmp89 + _tmp62 * _tmp89) +
                        _tmp70 * _tmp96 * (_tmp78 * _tmp94 + _tmp81 * _tmp95 + Scalar(1.0)) +
                        _tmp70 * _tmp97 * (_tmp100 * _tmp62 - _tmp101 * _tmp81));
  _res(2, 0) = std::exp(_tmp101 * _tmp47 * _tmp97 + _tmp102 * _tmp65 - _tmp47 * _tmp80 * _tmp88 -
                        _tmp47 * _tmp95 * _tmp96);
  _res(3, 0) =
      std::exp(-_tmp100 * _tmp97 - _tmp102 - _tmp67 * _tmp77 * _tmp88 - _tmp67 * _tmp94 * _tmp96);
