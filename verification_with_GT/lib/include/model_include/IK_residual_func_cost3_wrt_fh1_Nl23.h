...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl23(
  ...
  const Scalar _tmp31 = _tmp30 * (_tmp15 * _tmp26 * _tmp29 - _tmp16 * _tmp25 * _tmp29);
  ...
  const Scalar _tmp41 = _tmp31 * _tmp39 - _tmp33 * _tmp40 + _tmp36 * _tmp39;
  const Scalar _tmp42 = Scalar(1.0) / (_tmp27 * _tmp39 - _tmp40);
  ...
  const Scalar _tmp49 = _tmp44 + _tmp45 + _tmp46;
  const Scalar _tmp50 = -_tmp39 * _tmp48 + _tmp39 * _tmp49;
  const Scalar _tmp51 = _tmp27 * _tmp49;
  const Scalar _tmp52 = -_tmp39 * _tmp51 + _tmp40 * _tmp48;
  const Scalar _tmp53 = Scalar(1.0) * _tmp25;
  const Scalar _tmp54 = Scalar(1.0) * _tmp15;
  const Scalar _tmp55 = (-_tmp33 + _tmp54) / (_tmp36 - _tmp53);
  const Scalar _tmp56 = _tmp43 * _tmp50 - _tmp49 - _tmp55 * (_tmp43 * _tmp52 + _tmp51);
  ...
  const Scalar _tmp66 = _tmp27 * _tmp65 - _tmp64;
  const Scalar _tmp67 = _tmp42 * _tmp66;
  const Scalar _tmp68 = -_tmp44 + _tmp47;
  const Scalar _tmp69 = _tmp49 * _tmp65 - _tmp50 * _tmp67 -
                        _tmp55 * (-_tmp51 * _tmp65 - _tmp52 * _tmp67 + _tmp64 * _tmp68) -
                        _tmp65 * _tmp68;
  const Scalar _tmp70 = Scalar(1.0) / (_tmp69);
  const Scalar _tmp71 = _tmp31 * _tmp65 - _tmp41 * _tmp67 + _tmp58 * _tmp65 - _tmp61 * _tmp64;
  const Scalar _tmp72 = _tmp70 * _tmp71;
  const Scalar _tmp73 = Scalar(1.0) / (_tmp71);
  const Scalar _tmp74 = _tmp69 * _tmp73;
  const Scalar _tmp75 = _tmp56 + _tmp74 * (-_tmp31 + _tmp41 * _tmp43 - _tmp56 * _tmp72);
  const Scalar _tmp76 = _tmp66 * _tmp70;
  const Scalar _tmp77 = -_tmp27 - _tmp75 * _tmp76;
  const Scalar _tmp78 = _tmp39 * _tmp42;
  const Scalar _tmp79 = _tmp65 * _tmp70;
  const Scalar _tmp80 = _tmp24 + _tmp57;
  const Scalar _tmp81 = _tmp80 + p_init1 + Scalar(-4.8333311099999996);
  const Scalar _tmp82 = _tmp14 + _tmp60;
  ...
  const Scalar _tmp86 = _tmp30 * _tmp85 * (_tmp75 * _tmp79 + _tmp77 * _tmp78 + Scalar(1.0));
  const Scalar _tmp87 = _tmp81 * _tmp84;
  const Scalar _tmp88 = -_tmp80 * _tmp85 + _tmp82 * _tmp87;
  const Scalar _tmp89 = Scalar(1.0) * _tmp73;
  const Scalar _tmp90 = Scalar(1.0) * _tmp42;
  const Scalar _tmp91 = _tmp66 * _tmp73 * _tmp90;
  const Scalar _tmp92 = _tmp30 * _tmp88 * (-_tmp39 * _tmp91 + _tmp65 * _tmp89);
  const Scalar _tmp93 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp94 = _tmp53 * _tmp55 + _tmp54;
  const Scalar _tmp95 = 0;
  const Scalar _tmp96 = _tmp70 * _tmp95;
  const Scalar _tmp97 = _tmp76 * _tmp95;
  const Scalar _tmp98 = -_tmp50 * _tmp90 + _tmp52 * _tmp55 * _tmp90;
  const Scalar _tmp99 = _tmp74 * (-_tmp41 * _tmp90 - _tmp72 * _tmp98) + _tmp98;
  const Scalar _tmp100 = -_tmp76 * _tmp99 + Scalar(1.0);
  const Scalar _tmp101 = _tmp30 * _tmp87 * (_tmp100 * _tmp78 + _tmp79 * _tmp99);
  const Scalar _tmp102 = _tmp100 * _tmp42 * _tmp87;
  const Scalar _tmp103 = _tmp88 * _tmp91;
  const Scalar _tmp104 = _tmp42 * _tmp77 * _tmp85;
  const Scalar _tmp105 = _tmp88 * _tmp89;
  const Scalar _tmp106 = _tmp70 * _tmp87 * _tmp99;
  const Scalar _tmp107 = _tmp70 * _tmp75 * _tmp85;

  // Output terms (1)
  Eigen::Matrix<Scalar, 4, 1> _res;

  _res(0, 0) = -std::exp(-fh1);
  _res(1, 0) = -(-_tmp101 - _tmp86 - _tmp92) *
               std::exp(_tmp101 * fh1 + _tmp30 * _tmp93 * (_tmp65 * _tmp96 - _tmp78 * _tmp97) +
                        _tmp86 * fh1 + _tmp92 * fh1);
  _res(2, 0) = -(_tmp102 - _tmp103 + _tmp104) *
               std::exp(-_tmp102 * fh1 + _tmp103 * fh1 - _tmp104 * fh1 + _tmp42 * _tmp93 * _tmp97);
  _res(3, 0) = -(_tmp105 + _tmp106 + _tmp107) *
               std::exp(-_tmp105 * fh1 - _tmp106 * fh1 - _tmp107 * fh1 - _tmp93 * _tmp96);
