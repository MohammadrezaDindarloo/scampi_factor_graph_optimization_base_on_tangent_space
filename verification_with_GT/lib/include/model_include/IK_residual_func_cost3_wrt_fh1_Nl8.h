...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFh1Nl8(
  ...
  const Scalar _tmp38 = std::pow(Scalar(std::pow(_tmp33, Scalar(2)) + std::pow(_tmp37, Scalar(2))),
                                 Scalar(Scalar(-1) / Scalar(2)));
  ...
  const Scalar _tmp60 = _tmp59 * (_tmp48 * _tmp57 + _tmp52 * _tmp57 - _tmp54 * _tmp58);
  const Scalar _tmp61 = _tmp32 * _tmp39 - _tmp36 * _tmp49 + _tmp39 * _tmp48 - _tmp51 * _tmp60;
  const Scalar _tmp62 = Scalar(1.0) / (_tmp61);
  const Scalar _tmp63 = Scalar(1.0) * _tmp62;
  const Scalar _tmp64 = _tmp51 * _tmp59;
  const Scalar _tmp65 = _tmp30 * _tmp47 * (_tmp39 * _tmp63 - _tmp57 * _tmp63 * _tmp64);
  ...
  const Scalar _tmp73 = -_tmp50 * _tmp70 + _tmp58 * _tmp72;
  ...
  const Scalar _tmp78 = (-_tmp54 + _tmp77) / (_tmp52 - _tmp76);
  const Scalar _tmp79 = -_tmp57 * _tmp72 + _tmp70;
  const Scalar _tmp80 = _tmp39 * _tmp69 - _tmp39 * _tmp75 - _tmp64 * _tmp79 -
                        _tmp78 * (-_tmp39 * _tmp74 + _tmp49 * _tmp75 - _tmp64 * _tmp73);
  const Scalar _tmp81 = Scalar(1.0) / (_tmp80);
  const Scalar _tmp82 = _tmp59 * _tmp73;
  const Scalar _tmp83 = _tmp59 * _tmp79;
  const Scalar _tmp84 = Scalar(1.0) * _tmp78 * _tmp82 - Scalar(1.0) * _tmp83;
  const Scalar _tmp85 = _tmp61 * _tmp81;
  const Scalar _tmp86 = _tmp62 * _tmp80;
  const Scalar _tmp87 = _tmp84 + _tmp86 * (-Scalar(1.0) * _tmp60 - _tmp84 * _tmp85);
  const Scalar _tmp88 = _tmp81 * _tmp87;
  const Scalar _tmp89 = _tmp51 * _tmp81;
  const Scalar _tmp90 = _tmp59 * (-_tmp87 * _tmp89 + Scalar(1.0));
  const Scalar _tmp91 = _tmp28 * _tmp47 * (_tmp39 * _tmp88 + _tmp57 * _tmp90);
  const Scalar _tmp92 = Scalar(43.164000000000001) - fv1;
  const Scalar _tmp93 = _tmp76 * _tmp78 + _tmp77;
  const Scalar _tmp94 = 0;
  const Scalar _tmp95 = _tmp59 * _tmp89 * _tmp94;
  const Scalar _tmp96 = _tmp81 * _tmp94;
  const Scalar _tmp97 = _tmp50 * _tmp83 - _tmp69 - _tmp78 * (_tmp50 * _tmp82 + _tmp74);
  const Scalar _tmp98 = _tmp86 * (-_tmp48 + _tmp50 * _tmp60 - _tmp85 * _tmp97) + _tmp97;
  const Scalar _tmp99 = _tmp59 * (-_tmp50 - _tmp89 * _tmp98);
  const Scalar _tmp100 = _tmp81 * _tmp98;
  const Scalar _tmp101 = _tmp29 * _tmp47 * (_tmp100 * _tmp39 + _tmp57 * _tmp99 + Scalar(1.0));
  const Scalar _tmp102 = _tmp28 * _tmp90;
  const Scalar _tmp103 = _tmp30 * _tmp63;
  const Scalar _tmp104 = _tmp103 * fh1;
  const Scalar _tmp105 = _tmp29 * _tmp99;
  const Scalar _tmp106 = _tmp100 * _tmp29;
  ...
  _res(1, 0) = -(-_tmp101 - _tmp65 - _tmp91) *
               std::exp(_tmp101 * fh1 + _tmp47 * _tmp92 * (_tmp39 * _tmp96 - _tmp57 * _tmp95) +
                        _tmp65 * fh1 + _tmp91 * fh1);
  _res(2, 0) = -(_tmp102 - _tmp103 * _tmp64 + _tmp105) *
               std::exp(-_tmp102 * fh1 + _tmp104 * _tmp64 - _tmp105 * fh1 + _tmp92 * _tmp95);
  _res(3, 0) = -(_tmp103 + _tmp106 + _tmp107) *
               std::exp(-_tmp104 - _tmp106 * fh1 - _tmp107 * fh1 - _tmp92 * _tmp96);
