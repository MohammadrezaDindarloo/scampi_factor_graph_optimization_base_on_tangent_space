...
Eigen::Matrix<Scalar, 4, 1> IkResidualFuncCost3WrtFv1Nl12(
  ...
  const Scalar _tmp61 = _tmp17 + _tmp36;
  ...
  const Scalar _tmp82 = _tmp68 + _tmp69 + _tmp72;
  const Scalar _tmp83 = -_tmp43 * _tmp82 - _tmp53 * _tmp79 -
                        _tmp78 * (-_tmp35 * _tmp81 + _tmp44 * _tmp82 - _tmp53 * _tmp75) + _tmp81;
  ...
  const Scalar _tmp92 = _tmp48 * fh1;
  const Scalar _tmp93 = _tmp35 * _tmp52;
  const Scalar _tmp94 = -_tmp73 - _tmp78 * (_tmp35 * _tmp73 + _tmp75 * _tmp93) + _tmp79 * _tmp93;
  ...
  const Scalar _tmp98 = _tmp76 * _tmp78 + _tmp77;
  const Scalar _tmp99 = 0;
  const Scalar _tmp100 = _tmp53 * _tmp99;
  const Scalar _tmp101 = _tmp48 * (-_tmp100 * _tmp27 + _tmp43 * _tmp99);
  const Scalar _tmp102 = _tmp52 * fh1;
  const Scalar _tmp103 = _tmp97 * _tmp99;
  const Scalar _tmp104 = _tmp84 * fh1;
  ...
  _res(0, 0) = 0;
  _res(1, 0) = -_tmp101 *
               std::exp(_tmp101 * _tmp97 + _tmp48 * _tmp66 * (-_tmp27 * _tmp57 + _tmp43 * _tmp58) +
                        _tmp64 * _tmp92 * (_tmp87 * _tmp88 + _tmp90 * _tmp91) +
                        _tmp65 * _tmp92 * (_tmp88 * _tmp95 + _tmp91 * _tmp96 + Scalar(1.0)));
  _res(2, 0) = -_tmp100 * std::exp(-_tmp102 * _tmp64 * _tmp90 - _tmp102 * _tmp65 * _tmp96 +
                                   _tmp103 * _tmp53 + _tmp57 * _tmp66);
  _res(3, 0) = _tmp99 * std::exp(-_tmp103 - _tmp104 * _tmp64 * _tmp87 - _tmp104 * _tmp65 * _tmp95 -
                                 _tmp58 * _tmp66);
